...
module ::Test
    ...
    module Common
        ...
        if not defined?(::Test::Common::TestCasePrx)
            ...
            TestCasePrx_mixin::OP_startServerSide = Ice::__defineOperation('startServerSide', 'startServerSide', Ice::OperationMode::Normal, nil, [[::Test::Common::T_Config, false, 0]], [], [Ice::T_string, false, 0], [::Test::Common::T_TestCaseFailedException])
            TestCasePrx_mixin::OP_stopServerSide = Ice::__defineOperation('stopServerSide', 'stopServerSide', Ice::OperationMode::Normal, nil, [[Ice::T_bool, false, 0]], [], [Ice::T_string, false, 0], [::Test::Common::T_TestCaseFailedException])
            TestCasePrx_mixin::OP_runClientSide = Ice::__defineOperation('runClientSide', 'runClientSide', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [::Test::Common::T_Config, false, 0]], [], [Ice::T_string, false, 0], [::Test::Common::T_TestCaseFailedException])
            TestCasePrx_mixin::OP_destroy = Ice::__defineOperation('destroy', 'destroy', Ice::OperationMode::Normal, nil, [], [], nil, [])
        end
        ...
        if not defined?(::Test::Common::ControllerPrx)
            ...
            ControllerPrx_mixin::OP_runTestCase = Ice::__defineOperation('runTestCase', 'runTestCase', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0], [Ice::T_string, false, 0], [Ice::T_string, false, 0]], [], [::Test::Common::T_TestCasePrx, false, 0], [::Test::Common::T_TestCaseNotExistException])
            ControllerPrx_mixin::OP_getOptionOverrides = Ice::__defineOperation('getOptionOverrides', 'getOptionOverrides', Ice::OperationMode::Normal, nil, [], [], [::Test::Common::T_OptionOverrides, false, 0], [])
            ControllerPrx_mixin::OP_getTestSuites = Ice::__defineOperation('getTestSuites', 'getTestSuites', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], [::Test::Common::T_StringSeq, false, 0], [])
            ControllerPrx_mixin::OP_getHost = Ice::__defineOperation('getHost', 'getHost', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_bool, false, 0]], [], [Ice::T_string, false, 0], [])
        end
        ...
        if not defined?(::Test::Common::ProcessPrx)
            ...
            ProcessPrx_mixin::OP_waitReady = Ice::__defineOperation('waitReady', 'waitReady', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], nil, [::Test::Common::T_ProcessFailedException])
            ProcessPrx_mixin::OP_waitSuccess = Ice::__defineOperation('waitSuccess', 'waitSuccess', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], [Ice::T_int, false, 0], [::Test::Common::T_ProcessFailedException])
            ProcessPrx_mixin::OP_terminate = Ice::__defineOperation('terminate', 'terminate', Ice::OperationMode::Normal, nil, [], [], [Ice::T_string, false, 0], [])
        end
        ...
        if not defined?(::Test::Common::ProcessControllerPrx)
            ...
            ProcessControllerPrx_mixin::OP_start = Ice::__defineOperation('start', 'start', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0], [::Test::Common::T_StringSeq, false, 0]], [], [::Test::Common::T_ProcessPrx, false, 0], [::Test::Common::T_ProcessFailedException])
            ProcessControllerPrx_mixin::OP_getHost = Ice::__defineOperation('getHost', 'getHost', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_bool, false, 0]], [], [Ice::T_string, false, 0], [])
        end
        ...
        if not defined?(::Test::Common::BrowserProcessControllerPrx)
            ...
            BrowserProcessControllerPrx_mixin::OP_redirect = Ice::__defineOperation('redirect', 'redirect', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], nil, [])
        end
        ...
        if not defined?(::Test::Common::ProcessControllerRegistryPrx)
            ...
            ProcessControllerRegistryPrx_mixin::OP_setProcessController = Ice::__defineOperation('setProcessController', 'setProcessController', Ice::OperationMode::Normal, nil, [[::Test::Common::T_ProcessControllerPrx, false, 0]], [], nil, [])
        end
    end
end
