...
require 'Ice/LocatorRegistry.rb'
...
module ::Test
    ...
    if not defined?(::Test::TestLocatorRegistryPrx)
        ...
        TestLocatorRegistryPrx_mixin::OP_addObject = Ice::__defineOperation('addObject', 'addObject', Ice::OperationMode::Normal, nil, [[Ice::T_ObjectPrx, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::ServerManagerPrx)
        ...
        ServerManagerPrx_mixin::OP_startServer = Ice::__defineOperation('startServer', 'startServer', Ice::OperationMode::Normal, nil, [], [], nil, [])
        ServerManagerPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::HelloPrx)
        ...
        HelloPrx_mixin::OP_sayHello = Ice::__defineOperation('sayHello', 'sayHello', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::TestIntfPrx)
        ...
        TestIntfPrx_mixin::OP_getHello = Ice::__defineOperation('getHello', 'getHello', Ice::OperationMode::Normal, nil, [], [], [::Test::T_HelloPrx, false, 0], [])
        TestIntfPrx_mixin::OP_migrateHello = Ice::__defineOperation('migrateHello', 'migrateHello', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
