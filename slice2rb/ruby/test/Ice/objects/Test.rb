...
module ::Test
    ...
    if not defined?(::Test::InitialPrx)
        ...
        InitialPrx_mixin::OP_getB1 = Ice::__defineOperation('getB1', 'getB1', Ice::OperationMode::Normal, nil, [], [], [::Test::T_B, false, 0], [])
        InitialPrx_mixin::OP_getB2 = Ice::__defineOperation('getB2', 'getB2', Ice::OperationMode::Normal, nil, [], [], [::Test::T_B, false, 0], [])
        InitialPrx_mixin::OP_getC = Ice::__defineOperation('getC', 'getC', Ice::OperationMode::Normal, nil, [], [], [::Test::T_C, false, 0], [])
        InitialPrx_mixin::OP_getD = Ice::__defineOperation('getD', 'getD', Ice::OperationMode::Normal, nil, [], [], [::Test::T_D, false, 0], [])
        InitialPrx_mixin::OP_setRecursive = Ice::__defineOperation('setRecursive', 'setRecursive', Ice::OperationMode::Normal, nil, [[::Test::T_Recursive, false, 0]], [], nil, [])
        InitialPrx_mixin::OP_setCycle = Ice::__defineOperation('setCycle', 'setCycle', Ice::OperationMode::Normal, nil, [[::Test::T_Recursive, false, 0]], [], nil, [])
        InitialPrx_mixin::OP_acceptsClassCycles = Ice::__defineOperation('acceptsClassCycles', 'acceptsClassCycles', Ice::OperationMode::Normal, nil, [], [], [Ice::T_bool, false, 0], [])
        InitialPrx_mixin::OP_getMB = Ice::__defineOperation('getMB', 'getMB', Ice::OperationMode::Normal, nil, [], [], [::Test::T_B, false, 0], [])
        InitialPrx_mixin::OP_getAMDMB = Ice::__defineOperation('getAMDMB', 'getAMDMB', Ice::OperationMode::Normal, nil, [], [], [::Test::T_B, false, 0], [])
        InitialPrx_mixin::OP_getAll = Ice::__defineOperation('getAll', 'getAll', Ice::OperationMode::Normal, nil, [], [[::Test::T_B, false, 0], [::Test::T_B, false, 0], [::Test::T_C, false, 0], [::Test::T_D, false, 0]], nil, [])
        InitialPrx_mixin::OP_getK = Ice::__defineOperation('getK', 'getK', Ice::OperationMode::Normal, nil, [], [], [::Test::T_K, false, 0], [])
        InitialPrx_mixin::OP_opValue = Ice::__defineOperation('opValue', 'opValue', Ice::OperationMode::Normal, nil, [[Ice::T_Value, false, 0]], [[Ice::T_Value, false, 0]], [Ice::T_Value, false, 0], [])
        InitialPrx_mixin::OP_opValueSeq = Ice::__defineOperation('opValueSeq', 'opValueSeq', Ice::OperationMode::Normal, nil, [[::Test::T_ValueSeq, false, 0]], [[::Test::T_ValueSeq, false, 0]], [::Test::T_ValueSeq, false, 0], [])
        InitialPrx_mixin::OP_opValueMap = Ice::__defineOperation('opValueMap', 'opValueMap', Ice::OperationMode::Normal, nil, [[::Test::T_ValueMap, false, 0]], [[::Test::T_ValueMap, false, 0]], [::Test::T_ValueMap, false, 0], [])
        InitialPrx_mixin::OP_getD1 = Ice::__defineOperation('getD1', 'getD1', Ice::OperationMode::Normal, nil, [[::Test::T_D1, false, 0]], [], [::Test::T_D1, false, 0], [])
        InitialPrx_mixin::OP_throwEDerived = Ice::__defineOperation('throwEDerived', 'throwEDerived', Ice::OperationMode::Normal, nil, [], [], nil, [::Test::T_EDerived])
        InitialPrx_mixin::OP_setG = Ice::__defineOperation('setG', 'setG', Ice::OperationMode::Normal, nil, [[::Test::T_G, false, 0]], [], nil, [])
        InitialPrx_mixin::OP_opBaseSeq = Ice::__defineOperation('opBaseSeq', 'opBaseSeq', Ice::OperationMode::Normal, nil, [[::Test::T_BaseSeq, false, 0]], [[::Test::T_BaseSeq, false, 0]], [::Test::T_BaseSeq, false, 0], [])
        InitialPrx_mixin::OP_getCompact = Ice::__defineOperation('getCompact', 'getCompact', Ice::OperationMode::Normal, nil, [], [], [::Test::T_Compact, false, 0], [])
        InitialPrx_mixin::OP_opM = Ice::__defineOperation('opM', 'opM', Ice::OperationMode::Normal, nil, [[::Test::T_M, false, 0]], [[::Test::T_M, false, 0]], [::Test::T_M, false, 0], [])
        InitialPrx_mixin::OP_opF1 = Ice::__defineOperation('opF1', 'opF1', Ice::OperationMode::Normal, nil, [[::Test::T_F1, false, 0]], [[::Test::T_F1, false, 0]], [::Test::T_F1, false, 0], [])
        InitialPrx_mixin::OP_opF2 = Ice::__defineOperation('opF2', 'opF2', Ice::OperationMode::Normal, nil, [[::Test::T_F2Prx, false, 0]], [[::Test::T_F2Prx, false, 0]], [::Test::T_F2Prx, false, 0], [])
        InitialPrx_mixin::OP_opF3 = Ice::__defineOperation('opF3', 'opF3', Ice::OperationMode::Normal, nil, [[::Test::T_F3, false, 0]], [[::Test::T_F3, false, 0]], [::Test::T_F3, false, 0], [])
        InitialPrx_mixin::OP_hasF3 = Ice::__defineOperation('hasF3', 'hasF3', Ice::OperationMode::Normal, nil, [], [], [Ice::T_bool, false, 0], [])
    end
end
