...
module ::Clash
    ...
    if not defined?(::Clash::IntfPrx)
        ...
        IntfPrx_mixin::OP_context = ::Ice::__defineOperation('context', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_current = ::Ice::__defineOperation('current', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_response = ::Ice::__defineOperation('response', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_upCast = ::Ice::__defineOperation('upCast', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_typeId = ::Ice::__defineOperation('typeId', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_del = ::Ice::__defineOperation('del', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_cookie = ::Ice::__defineOperation('cookie', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_sync = ::Ice::__defineOperation('sync', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_inS = ::Ice::__defineOperation('inS', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_istr = ::Ice::__defineOperation('istr', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
    ...
    if not defined?(::Clash::Cls)
        class Cls < ::Ice::Value
            ...
            attr_accessor :s, :context, :current, :response, :upCast, :typeId, :del, :cookie, :ex, :result, :istr, :ostr, :inS, :_in, :proxy
        end
