...
module ::Test
    ...
    if not defined?(::Test::ThrowerPrx)
        ...
        ThrowerPrx_mixin::OP_throwMarshalException = ::Ice::__defineOperation('throwMarshalException', ::Ice::OperationMode::Normal, nil, [], [[::Ice::T_int, false, 0]], [::Ice::T_int, false, 0], [])
