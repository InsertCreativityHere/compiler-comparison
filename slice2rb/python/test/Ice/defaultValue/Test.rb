...
module ::Test
    ...
    if not defined?(::Test::StructNoDefaults)
        class StructNoDefaults
            include ::Ice::Inspect_mixin
            def initialize(bo=false, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str='', c1=::Test::Color::Red, bs=nil, iseq=nil, dict=nil, st=::Test::InnerStruct.new)
                @bo = bo
                @b = b
                @s = s
                @i = i
            ...
            attr_accessor :bo, :b, :s, :i, :l, :f, :d, :str, :c1, :bs, :iseq, :dict, :st
        end
