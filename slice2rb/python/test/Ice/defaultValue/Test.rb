...
module ::Test
    ...
    if not defined?(::Test::StructNoDefaults)
        class StructNoDefaults
            include Ice::Inspect_mixin
            def initialize(bo=false, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str='', c1=::Test::Color::Red, bs=nil, iseq=nil, isDict=nil, st=::Test::InnerStruct.new)
                @bo = bo
                @b = b
                @s = s
                @i = i
            ...
            attr_accessor :bo, :b, :s, :i, :l, :f, :d, :str, :c1, :bs, :iseq, :isDict, :st
        end
    ...
    if not defined?(::Test::ExceptionNoDefaults)
        ...
        T_ExceptionNoDefaults = Ice::__defineException('::Test::ExceptionNoDefaults', ExceptionNoDefaults, ::Test::T_ExceptionNoDefaultsBase, [
            ...
            ["isDict", ::Test::T_IntStringDict, false, 0]
        ])
    end
    ...
    if not defined?(::Test::ClassNoDefaults)
        class ClassNoDefaults < ::Test::ClassNoDefaultsBase
            ...
            def initialize(str='', c1=::Test::Color::Red, bs=nil, st=::Test::InnerStruct.new, isDict=nil)
                super(str, c1, bs)
                @st = st
                @isDict = isDict
            end
