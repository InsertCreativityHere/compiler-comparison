...
module ::Test
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        module InitialPrx_mixin
            ...
            def opRequiredAfterOptional(p1, p2, p3, context=nil)
                InitialPrx_mixin::OP_opRequiredAfterOptional.invoke(self, [p1, p2, p3], context)
            end

            def opOptionalAfterRequired(p1, p2, p3, context=nil)
                InitialPrx_mixin::OP_opOptionalAfterRequired.invoke(self, [p1, p2, p3], context)
            end
        ...
        InitialPrx_mixin::OP_opRequiredAfterOptional = ::Ice::__defineOperation('opRequiredAfterOptional', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0], [::Ice::T_int, true, 1], [::Ice::T_int, false, 0]], [[::Ice::T_int, false, 0], [::Ice::T_int, true, 2], [::Ice::T_int, false, 0]], nil, [])
        InitialPrx_mixin::OP_opOptionalAfterRequired = ::Ice::__defineOperation('opOptionalAfterRequired', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0], [::Ice::T_int, true, 1], [::Ice::T_int, true, 2]], [[::Ice::T_int, false, 0], [::Ice::T_int, true, 3], [::Ice::T_int, true, 4]], nil, [])
