...
module ::Test
    ...
    if not defined?(::Test::S)
        class S
            ...
            def initialize(b1=nil, b2=nil, b4=nil, s1=nil, s2=nil, s3=nil)
                @b1 = b1
                @b2 = b2
                @b4 = b4
                @s1 = s1
            ...
            attr_accessor :b1, :b2, :b4, :s1, :s2, :s3
        end
    ...
    if not defined?(::Test::E)
        class E < Ice::Value
            ...
            def initialize(boolSeq=nil, byteSeq=nil, shortSeq=nil, intSeq=nil, longSeq=nil, floatSeq=nil, doubleSeq=nil)
                @boolSeq = boolSeq
                @byteSeq = byteSeq
                @shortSeq = shortSeq
                @intSeq = intSeq
        ...
        T_E.defineClass(E, -1, false, nil, [
            ['boolSeq', ::Test::T_BoolSeq1, false, 0],
            ['byteSeq', ::Test::T_ByteSeq1, false, 0],
            ['shortSeq', ::Test::T_ShortSeq1, false, 0],
            ['intSeq', ::Test::T_IntSeq1, false, 0],
            ['longSeq', ::Test::T_LongSeq1, false, 0],
            ['floatSeq', ::Test::T_FloatSeq1, false, 0],
            ['doubleSeq', ::Test::T_DoubleSeq1, false, 0]
        ])
    end
    ...
    if not defined?(::Test::CustomPrx)
        ...
        CustomPrx_mixin::OP_opByteString1 = Ice::__defineOperation('opByteString1', 'opByteString1', Ice::OperationMode::Normal, nil, [[::Test::T_ByteString, false, 0]], [[::Test::T_ByteString, false, 0]], [::Test::T_ByteString, false, 0], [])
        CustomPrx_mixin::OP_opByteString2 = Ice::__defineOperation('opByteString2', 'opByteString2', Ice::OperationMode::Normal, nil, [[::Test::T_ByteString, false, 0]], [[::Test::T_ByteString, false, 0]], [::Test::T_ByteString, false, 0], [])
        CustomPrx_mixin::OP_opByteList1 = Ice::__defineOperation('opByteList1', 'opByteList1', Ice::OperationMode::Normal, nil, [[::Test::T_ByteList, false, 0]], [[::Test::T_ByteList, false, 0]], [::Test::T_ByteList, false, 0], [])
        CustomPrx_mixin::OP_opByteList2 = Ice::__defineOperation('opByteList2', 'opByteList2', Ice::OperationMode::Normal, nil, [[::Test::T_ByteList, false, 0]], [[::Test::T_ByteList, false, 0]], [::Test::T_ByteList, false, 0], [])
        CustomPrx_mixin::OP_opStringList1 = Ice::__defineOperation('opStringList1', 'opStringList1', Ice::OperationMode::Normal, nil, [[::Test::T_StringList, false, 0]], [[::Test::T_StringList, false, 0]], [::Test::T_StringList, false, 0], [])
        CustomPrx_mixin::OP_opStringList2 = Ice::__defineOperation('opStringList2', 'opStringList2', Ice::OperationMode::Normal, nil, [[::Test::T_StringList, false, 0]], [[::Test::T_StringList, false, 0]], [::Test::T_StringList, false, 0], [])
        CustomPrx_mixin::OP_opStringTuple1 = Ice::__defineOperation('opStringTuple1', 'opStringTuple1', Ice::OperationMode::Normal, nil, [[::Test::T_StringTuple, false, 0]], [[::Test::T_StringTuple, false, 0]], [::Test::T_StringTuple, false, 0], [])
        CustomPrx_mixin::OP_opStringTuple2 = Ice::__defineOperation('opStringTuple2', 'opStringTuple2', Ice::OperationMode::Normal, nil, [[::Test::T_StringTuple, false, 0]], [[::Test::T_StringTuple, false, 0]], [::Test::T_StringTuple, false, 0], [])
        CustomPrx_mixin::OP_sendS = Ice::__defineOperation('sendS', 'sendS', Ice::OperationMode::Normal, nil, [[::Test::T_S, false, 0]], [], nil, [])
        CustomPrx_mixin::OP_sendC = Ice::__defineOperation('sendC', 'sendC', Ice::OperationMode::Normal, nil, [[::Test::T_C, false, 0]], [], nil, [])
        CustomPrx_mixin::OP_opBoolSeq = Ice::__defineOperation('opBoolSeq', 'opBoolSeq', Ice::OperationMode::Normal, nil, [[::Test::T_BoolSeq1, false, 0]], [[::Test::T_BoolSeq2, false, 0]], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opByteSeq = Ice::__defineOperation('opByteSeq', 'opByteSeq', Ice::OperationMode::Normal, nil, [[::Test::T_ByteSeq1, false, 0]], [[::Test::T_ByteSeq2, false, 0]], [::Test::T_ByteSeq1, false, 0], [])
        CustomPrx_mixin::OP_opShortSeq = Ice::__defineOperation('opShortSeq', 'opShortSeq', Ice::OperationMode::Normal, nil, [[::Test::T_ShortSeq1, false, 0]], [[::Test::T_ShortSeq2, false, 0]], [::Test::T_ShortSeq1, false, 0], [])
        CustomPrx_mixin::OP_opIntSeq = Ice::__defineOperation('opIntSeq', 'opIntSeq', Ice::OperationMode::Normal, nil, [[::Test::T_IntSeq1, false, 0]], [[::Test::T_IntSeq2, false, 0]], [::Test::T_IntSeq1, false, 0], [])
        CustomPrx_mixin::OP_opLongSeq = Ice::__defineOperation('opLongSeq', 'opLongSeq', Ice::OperationMode::Normal, nil, [[::Test::T_LongSeq1, false, 0]], [[::Test::T_LongSeq2, false, 0]], [::Test::T_LongSeq1, false, 0], [])
        CustomPrx_mixin::OP_opFloatSeq = Ice::__defineOperation('opFloatSeq', 'opFloatSeq', Ice::OperationMode::Normal, nil, [[::Test::T_FloatSeq1, false, 0]], [[::Test::T_FloatSeq2, false, 0]], [::Test::T_FloatSeq1, false, 0], [])
        CustomPrx_mixin::OP_opDoubleSeq = Ice::__defineOperation('opDoubleSeq', 'opDoubleSeq', Ice::OperationMode::Normal, nil, [[::Test::T_DoubleSeq1, false, 0]], [[::Test::T_DoubleSeq2, false, 0]], [::Test::T_DoubleSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArrayNotExistsFactory = Ice::__defineOperation('opBogusArrayNotExistsFactory', 'opBogusArrayNotExistsFactory', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArrayThrowFactory = Ice::__defineOperation('opBogusArrayThrowFactory', 'opBogusArrayThrowFactory', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArrayType = Ice::__defineOperation('opBogusArrayType', 'opBogusArrayType', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArrayNoneFactory = Ice::__defineOperation('opBogusArrayNoneFactory', 'opBogusArrayNoneFactory', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArraySignatureFactory = Ice::__defineOperation('opBogusArraySignatureFactory', 'opBogusArraySignatureFactory', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opBogusArrayNoCallableFactory = Ice::__defineOperation('opBogusArrayNoCallableFactory', 'opBogusArrayNoCallableFactory', Ice::OperationMode::Normal, nil, [], [], [::Test::T_BoolSeq1, false, 0], [])
        CustomPrx_mixin::OP_opD = Ice::__defineOperation('opD', 'opD', Ice::OperationMode::Normal, nil, [[::Test::T_D, false, 0]], [], [::Test::T_D, false, 0], [])
        CustomPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
