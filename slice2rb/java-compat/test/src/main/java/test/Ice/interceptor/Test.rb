...
module ::Test
    ...
    if not defined?(::Test::MyObject_Mixin)
        ...
        MyObjectPrx_mixin::OP_amdBadSystemAdd = ::Ice::__defineOperation('amdBadSystemAdd', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, false, 0], [::Ice::T_int, false, 0]], [], [::Ice::T_int, false, 0], [])
    end
end
