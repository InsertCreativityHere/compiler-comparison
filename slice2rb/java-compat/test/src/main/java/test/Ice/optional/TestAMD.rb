...
module ::Test
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        InitialPrx_mixin::OP_opOneOptionalProxyReq = ::Ice::__defineOperation('opOneOptionalProxyReq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_ObjectPrx, true, 2]], [[::Ice::T_ObjectPrx, true, 3]], [::Ice::T_ObjectPrx, true, 1], [])
