...
module ::Test
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        module TestIntfPrx_mixin
            ...
            def javaException(context=nil)
                TestIntfPrx_mixin::OP_javaException.invoke(self, [], context)
            end
        ...
        TestIntfPrx_mixin::OP_javaException = ::Ice::__defineOperation('javaException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
