...
module ::Clash
    ...
    if not defined?(::Clash::IntfPrx)
        ...
        IntfPrx_mixin::OP_obj = Ice::__defineOperation('obj', 'obj', Ice::OperationMode::Normal, nil, [], [], nil, [])
    ...
    if not defined?(::Clash::Cls)
        class Cls < Ice::Value
            ...
            def initialize(s=nil, context='', current=0, response=0, typeId=0, del=0, cookie=Ice::Unset, ex='', result=0, istr='', ostr='', inS='', in='', proxy='', obj=0, getCookie=0, clone='')
                @s = s
                @context = context
                @current = current
                @response = response
            ...
            attr_accessor :s, :context, :current, :response, :typeId, :del, :cookie, :ex, :result, :istr, :ostr, :inS, :in, :proxy, :obj, :getCookie, :clone
        end
    ...
    if not defined?(::Clash::St)
        class St
            ...
            def initialize(v='', istr=0, ostr=0, rhs=0, hashCode='', clone=0)
                @v = v
                @istr = istr
                @ostr = ostr
                @rhs = rhs
            ...
            attr_accessor :v, :istr, :ostr, :rhs, :hashCode, :clone
        end
