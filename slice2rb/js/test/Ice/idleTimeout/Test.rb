...
module ::Test
    ...
    if not defined?(::Test::DelayedTestIntfPrx)
        ...
        DelayedTestIntfPrx_mixin::OP_sleep = Ice::__defineOperation('sleep', 'sleep', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::TestIntfBidirPrx)
        ...
        TestIntfBidirPrx_mixin::OP_makeSleep = Ice::__defineOperation('makeSleep', 'makeSleep', Ice::OperationMode::Normal, nil, [[Ice::T_bool, false, 0], [Ice::T_int, false, 0], [::Test::T_DelayedTestIntfPrx, false, 0]], [], nil, [])
    end
end
