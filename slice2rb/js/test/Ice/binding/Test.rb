...
module ::Test
    ...
    if not defined?(::Test::RemoteObjectAdapterPrx)
        ...
        RemoteObjectAdapterPrx_mixin::OP_getTestIntf = Ice::__defineOperation('getTestIntf', 'getTestIntf', Ice::OperationMode::Normal, nil, [], [], [::Test::T_TestIntfPrx, false, 0], [])
        RemoteObjectAdapterPrx_mixin::OP_deactivate = Ice::__defineOperation('deactivate', 'deactivate', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::RemoteCommunicatorPrx)
        ...
        RemoteCommunicatorPrx_mixin::OP_createObjectAdapter = Ice::__defineOperation('createObjectAdapter', 'createObjectAdapter', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0]], [], [::Test::T_RemoteObjectAdapterPrx, false, 0], [])
        RemoteCommunicatorPrx_mixin::OP_deactivateObjectAdapter = Ice::__defineOperation('deactivateObjectAdapter', 'deactivateObjectAdapter', Ice::OperationMode::Normal, nil, [[::Test::T_RemoteObjectAdapterPrx, false, 0]], [], nil, [])
