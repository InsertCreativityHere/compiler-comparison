...
module ::Test
    ...
    if not defined?(::Test::::MyClass_Mixin)
        ...
        MyClassPrx_mixin::OP_opWStringLiterals = ::Ice::__defineOperation('opWStringLiterals', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::::T_WStringS, false, 0], [])
    ...
    if not defined?(::Test::::Echo_Mixin)
        ...
        EchoPrx_mixin::OP_supportsCompress = ::Ice::__defineOperation('supportsCompress', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Ice::T_bool, false, 0], [])
    end
