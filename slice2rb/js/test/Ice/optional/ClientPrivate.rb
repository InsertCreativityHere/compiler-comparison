...
module ::Test
    ...
    if not defined?(::Test::Initial2Prx)
        ...
        Initial2Prx_mixin::OP_opClassAndUnknownOptional = Ice::__defineOperation('opClassAndUnknownOptional', 'opClassAndUnknownOptional', Ice::OperationMode::Normal, nil, [[::Test::T_A, false, 0], [::Test::T_VarStruct, true, 1]], [], nil, [])
        Initial2Prx_mixin::OP_opVoid = Ice::__defineOperation('opVoid', 'opVoid', Ice::OperationMode::Normal, nil, [[Ice::T_int, true, 1], [Ice::T_string, true, 2]], [], nil, [])
    end
end
