...
module ::Test
    ...
    if not defined?(::Test::::Derived_Mixin)
        ...
        class Derived < ::Test::::Base
            ...
            def initialize(boolFalse=false, boolTrue=true, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo\s\\\s\"bar\n\s\r\n\t\v\f\a\b?", noDefault='', zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, c1=::Test::Color::::Red, c2=::Test::Color::::Green, c3=::Test::Color::::Blue, nc1=::Test::Nested::Color::::Red, nc2=::Test::Nested::Color::::Green, nc3=::Test::Nested::Color::::Blue)
    ...
    if not defined?(::Test::::DerivedEx)
        class DerivedEx < ::Test::::BaseEx
            def initialize(boolFalse=false, boolTrue=true, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo\s\\\s\"bar\n\s\r\n\t\v\f\a\b?", noDefault='', zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, c1=::Test::ConstColor1, c2=::Test::ConstColor2, c3=::Test::ConstColor3, nc1=::Test::ConstNestedColor1, nc2=::Test::ConstNestedColor2, nc3=::Test::ConstNestedColor3)
                super(boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
                @c1 = c1
                @c2 = c2
                @c3 = c3
