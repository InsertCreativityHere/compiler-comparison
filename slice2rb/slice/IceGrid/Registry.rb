...
module ::IceGrid
    ...
    if not defined?(::IceGrid::QueryPrx)
        ...
        QueryPrx_mixin::OP_findObjectById = Ice::__defineOperation('findObjectById', 'findObjectById', Ice::OperationMode::Idempotent, nil, [[::Ice::T_Identity, false, 0]], [], [Ice::T_ObjectPrx, false, 0], [])
        QueryPrx_mixin::OP_findObjectByType = Ice::__defineOperation('findObjectByType', 'findObjectByType', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0]], [], [Ice::T_ObjectPrx, false, 0], [])
        QueryPrx_mixin::OP_findObjectByTypeOnLeastLoadedNode = Ice::__defineOperation('findObjectByTypeOnLeastLoadedNode', 'findObjectByTypeOnLeastLoadedNode', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [::IceGrid::T_LoadSample, false, 0]], [], [Ice::T_ObjectPrx, false, 0], [])
        QueryPrx_mixin::OP_findAllObjectsByType = Ice::__defineOperation('findAllObjectsByType', 'findAllObjectsByType', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0]], [], [::Ice::T_ObjectProxySeq, false, 0], [])
        QueryPrx_mixin::OP_findAllReplicas = Ice::__defineOperation('findAllReplicas', 'findAllReplicas', Ice::OperationMode::Idempotent, nil, [[Ice::T_ObjectPrx, false, 0]], [], [::Ice::T_ObjectProxySeq, false, 0], [])
    end
    ...
    if not defined?(::IceGrid::RegistryPrx)
        ...
        RegistryPrx_mixin::OP_createSession = Ice::__defineOperation('createSession', 'createSession', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0]], [], [::IceGrid::T_SessionPrx, false, 0], [::IceGrid::T_PermissionDeniedException])
        RegistryPrx_mixin::OP_createAdminSession = Ice::__defineOperation('createAdminSession', 'createAdminSession', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0]], [], [::IceGrid::T_AdminSessionPrx, false, 0], [::IceGrid::T_PermissionDeniedException])
        RegistryPrx_mixin::OP_createSessionFromSecureConnection = Ice::__defineOperation('createSessionFromSecureConnection', 'createSessionFromSecureConnection', Ice::OperationMode::Normal, nil, [], [], [::IceGrid::T_SessionPrx, false, 0], [::IceGrid::T_PermissionDeniedException])
        RegistryPrx_mixin::OP_createAdminSessionFromSecureConnection = Ice::__defineOperation('createAdminSessionFromSecureConnection', 'createAdminSessionFromSecureConnection', Ice::OperationMode::Normal, nil, [], [], [::IceGrid::T_AdminSessionPrx, false, 0], [::IceGrid::T_PermissionDeniedException])
        RegistryPrx_mixin::OP_getSessionTimeout = Ice::__defineOperation('getSessionTimeout', 'getSessionTimeout', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_int, false, 0], [])
    ...
    if not defined?(::IceGrid::LocatorPrx)
        ...
        LocatorPrx_mixin::OP_getLocalRegistry = Ice::__defineOperation('getLocalRegistry', 'getLocalRegistry', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_RegistryPrx, false, 0], [])
        LocatorPrx_mixin::OP_getLocalQuery = Ice::__defineOperation('getLocalQuery', 'getLocalQuery', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_QueryPrx, false, 0], [])
    end
end
