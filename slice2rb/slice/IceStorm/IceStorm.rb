...
module ::IceStorm
    ...
    if not defined?(::IceStorm::Topic_Mixin)
        ...
        TopicPrx_mixin::OP_unsubscribe = ::Ice::__defineOperation('unsubscribe', ::Ice::OperationMode::Idempotent, ::Ice::OperationMode::Nonmutating, false, nil, [[::Ice::T_ObjectPrx, false, 0]], [], nil, [])
