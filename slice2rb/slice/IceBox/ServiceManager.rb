...
module ::IceBox
    ...
    if not defined?(::IceBox::ServiceObserverPrx)
        ...
        ServiceObserverPrx_mixin::OP_servicesStarted = Ice::__defineOperation('servicesStarted', 'servicesStarted', Ice::OperationMode::Normal, nil, [[::Ice::T_StringSeq, false, 0]], [], nil, [])
        ServiceObserverPrx_mixin::OP_servicesStopped = Ice::__defineOperation('servicesStopped', 'servicesStopped', Ice::OperationMode::Normal, nil, [[::Ice::T_StringSeq, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::IceBox::ServiceManagerPrx)
        ...
        ServiceManagerPrx_mixin::OP_startService = Ice::__defineOperation('startService', 'startService', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], nil, [::IceBox::T_AlreadyStartedException, ::IceBox::T_NoSuchServiceException])
        ServiceManagerPrx_mixin::OP_stopService = Ice::__defineOperation('stopService', 'stopService', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], nil, [::IceBox::T_AlreadyStoppedException, ::IceBox::T_NoSuchServiceException])
        ServiceManagerPrx_mixin::OP_addObserver = Ice::__defineOperation('addObserver', 'addObserver', Ice::OperationMode::Normal, nil, [[::IceBox::T_ServiceObserverPrx, false, 0]], [], nil, [])
        ServiceManagerPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
