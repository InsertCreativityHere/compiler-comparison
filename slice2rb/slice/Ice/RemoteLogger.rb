...
module ::Ice
    ...
    if not defined?(::Ice::RemoteLoggerPrx)
        ...
        RemoteLoggerPrx_mixin::OP_init = Ice::__defineOperation('init', 'init', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [::Ice::T_LogMessageSeq, false, 0]], [], nil, [])
        RemoteLoggerPrx_mixin::OP_log = Ice::__defineOperation('log', 'log', Ice::OperationMode::Normal, nil, [[::Ice::T_LogMessage, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Ice::LoggerAdminPrx)
        ...
        LoggerAdminPrx_mixin::OP_attachRemoteLogger = Ice::__defineOperation('attachRemoteLogger', 'attachRemoteLogger', Ice::OperationMode::Normal, nil, [[::Ice::T_RemoteLoggerPrx, false, 0], [::Ice::T_LogMessageTypeSeq, false, 0], [::Ice::T_StringSeq, false, 0], [Ice::T_int, false, 0]], [], nil, [::Ice::T_RemoteLoggerAlreadyAttachedException])
        LoggerAdminPrx_mixin::OP_detachRemoteLogger = Ice::__defineOperation('detachRemoteLogger', 'detachRemoteLogger', Ice::OperationMode::Normal, nil, [[::Ice::T_RemoteLoggerPrx, false, 0]], [], [Ice::T_bool, false, 0], [])
        LoggerAdminPrx_mixin::OP_getLog = Ice::__defineOperation('getLog', 'getLog', Ice::OperationMode::Normal, nil, [[::Ice::T_LogMessageTypeSeq, false, 0], [::Ice::T_StringSeq, false, 0], [Ice::T_int, false, 0]], [[Ice::T_string, false, 0]], [::Ice::T_LogMessageSeq, false, 0], [])
    end
end
