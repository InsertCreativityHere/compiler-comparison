...
module ::Test
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        InitialPrx_mixin::OP_shutdown = ::Ice::__defineOperation('shutdown', ::Ice::OperationMode::Normal, true, nil, [], [], nil, [])
        InitialPrx_mixin::OP_pingPong = ::Ice::__defineOperation('pingPong', ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_Value, false, 0]], [], [::Ice::T_Value, false, 0], [])
        InitialPrx_mixin::OP_opOptionalException = ::Ice::__defineOperation('opOptionalException', ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2], [::Test::T_OneOptional, true, 3]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opDerivedException = ::Ice::__defineOperation('opDerivedException', ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2], [::Test::T_OneOptional, true, 3]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opRequiredException = ::Ice::__defineOperation('opRequiredException', ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2], [::Test::T_OneOptional, true, 3]], [], nil, [::Test::T_OptionalException])
        ...
        InitialPrx_mixin::OP_opOneOptional = ::Ice::__defineOperation('opOneOptional', ::Ice::OperationMode::Normal, true, nil, [[::Test::T_OneOptional, true, 2]], [[::Test::T_OneOptional, true, 3]], [::Test::T_OneOptional, true, 1], [])
        ...
        InitialPrx_mixin::OP_opMStruct1 = ::Ice::__defineOperation('opMStruct1', ::Ice::OperationMode::Normal, true, nil, [], [], [::Test::T_SmallStruct, true, 1], [])
        InitialPrx_mixin::OP_opMStruct2 = ::Ice::__defineOperation('opMStruct2', ::Ice::OperationMode::Normal, true, nil, [[::Test::T_SmallStruct, true, 2]], [[::Test::T_SmallStruct, true, 3]], [::Test::T_SmallStruct, true, 1], [])
        InitialPrx_mixin::OP_opMSeq1 = ::Ice::__defineOperation('opMSeq1', ::Ice::OperationMode::Normal, true, nil, [], [], [::Test::T_StringSeq, true, 1], [])
        ...
        InitialPrx_mixin::OP_opMG1 = ::Ice::__defineOperation('opMG1', ::Ice::OperationMode::Normal, true, nil, [], [], [::Test::T_G, true, 1], [])
        InitialPrx_mixin::OP_opMG2 = ::Ice::__defineOperation('opMG2', ::Ice::OperationMode::Normal, true, nil, [[::Test::T_G, true, 2]], [[::Test::T_G, true, 3]], [::Test::T_G, true, 1], [])
