...
module ::Test
    ...
    if not defined?(::Test::InitialPrx)
        ...
        InitialPrx_mixin::OP_opCustomString = ::Ice::__defineOperation('opCustomString', ::Ice::OperationMode::Normal, nil, [[::Ice::T_string, true, 2]], [[::Ice::T_string, true, 3]], [::Ice::T_string, true, 1], [])
        ...
        InitialPrx_mixin::OP_opCustomIntStringDict = ::Ice::__defineOperation('opCustomIntStringDict', ::Ice::OperationMode::Normal, nil, [[::Test::T_IntStringDict, true, 2]], [[::Test::T_IntStringDict, true, 3]], [::Test::T_IntStringDict, true, 1], [])
