...
module ::Test
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_opDerived = ::Ice::__defineOperation('opDerived', ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_Base, false, 0], [])
        TestIntfPrx_mixin::OP_throwDerived = ::Ice::__defineOperation('throwDerived', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_BaseEx])
    end
