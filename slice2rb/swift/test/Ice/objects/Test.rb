...
module ::Test
    ...
    if not defined?(::Test::TestIntfPrx)
        ...
        TestIntfPrx_mixin::OP_opDerived = Ice::__defineOperation('opDerived', 'opDerived', Ice::OperationMode::Normal, nil, [], [], [::Test::T_Base, false, 0], [])
        TestIntfPrx_mixin::OP_throwDerived = Ice::__defineOperation('throwDerived', 'throwDerived', Ice::OperationMode::Normal, nil, [], [], nil, [::Test::T_BaseEx])
    end
