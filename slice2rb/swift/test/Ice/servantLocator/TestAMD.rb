...
module ::Test
    ...
    if not defined?(::Test::TestActivation_Mixin)
        ...
        TestActivationPrx_mixin::OP_activateServantLocator = ::Ice::__defineOperation('activateServantLocator', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_bool, false, 0]], [], nil, [])
    end
end
