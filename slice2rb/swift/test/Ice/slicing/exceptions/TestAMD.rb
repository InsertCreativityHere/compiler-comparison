...
module ::Test
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_unknownDerivedAsBase = ::Ice::__defineOperation('unknownDerivedAsBase', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, ::Ice::FormatType::CompactFormat, [], [], nil, [::Test::T_Base])
