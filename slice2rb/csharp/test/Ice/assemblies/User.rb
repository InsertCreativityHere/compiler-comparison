...
module ::User
    ...
    if not defined?(::User::RegistryPrx)
        ...
        RegistryPrx_mixin::OP_getUserInfo = Ice::__defineOperation('getUserInfo', 'getUserInfo', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], [::User::T_UserInfo, false, 0], [::Core::T_ArgumentException])
    end
end
