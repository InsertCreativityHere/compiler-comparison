...
module ::Test
    ...
    if not defined?(::Test::MultiOptional_Mixin)
        ...
        class MultiOptional < ::Ice::Value
            ...
            attr_accessor :a, :b, :c, :d, :e, :f, :g, :h, :i, :j, :bs, :ss, :iid, :sid, :fs, :vs, :shs, :es, :fss, :vss, :oos, :mips, :ied, :ifsd, :ivsd, :iood, :imipd, :bos
        end
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        InitialPrx_mixin::OP_opOptionalException = ::Ice::__defineOperation('opOptionalException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opDerivedException = ::Ice::__defineOperation('opDerivedException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opRequiredException = ::Ice::__defineOperation('opRequiredException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, true, 1], [::Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
