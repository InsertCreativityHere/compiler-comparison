...
module ::Test
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_sleepAndHold = ::Ice::__defineOperation('sleepAndHold', ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0]], [], nil, [])
        TestIntfPrx_mixin::OP_interruptSleep = ::Ice::__defineOperation('interruptSleep', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        TestIntfPrx_mixin::OP_startHeartbeatCount = ::Ice::__defineOperation('startHeartbeatCount', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        TestIntfPrx_mixin::OP_waitForHeartbeatCount = ::Ice::__defineOperation('waitForHeartbeatCount', ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::RemoteObjectAdapter_Mixin)
        ...
        RemoteObjectAdapterPrx_mixin::OP_activate = ::Ice::__defineOperation('activate', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        RemoteObjectAdapterPrx_mixin::OP_hold = ::Ice::__defineOperation('hold', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
    ...
    if not defined?(::Test::RemoteCommunicator_Mixin)
        ...
        RemoteCommunicatorPrx_mixin::OP_createObjectAdapter = ::Ice::__defineOperation('createObjectAdapter', ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0], [::Ice::T_int, false, 0], [::Ice::T_int, false, 0]], [], [::Test::T_RemoteObjectAdapterPrx, false, 0], [])
