...
module ::Test
    ...
    if not defined?(::Test::MyClassPrx)
        ...
        MyClassPrx_mixin::OP_opNV = Ice::__defineOperation('opNV', 'opNV', Ice::OperationMode::Normal, nil, [[::Test::T_NV, false, 0]], [[::Test::T_NV, false, 0]], [::Test::T_NV, false, 0], [])
        MyClassPrx_mixin::OP_opNR = Ice::__defineOperation('opNR', 'opNR', Ice::OperationMode::Normal, nil, [[::Test::T_NR, false, 0]], [[::Test::T_NR, false, 0]], [::Test::T_NR, false, 0], [])
        MyClassPrx_mixin::OP_opNDV = Ice::__defineOperation('opNDV', 'opNDV', Ice::OperationMode::Normal, nil, [[::Test::T_NDV, false, 0]], [[::Test::T_NDV, false, 0]], [::Test::T_NDV, false, 0], [])
        MyClassPrx_mixin::OP_opNDR = Ice::__defineOperation('opNDR', 'opNDR', Ice::OperationMode::Normal, nil, [[::Test::T_NDR, false, 0]], [[::Test::T_NDR, false, 0]], [::Test::T_NDR, false, 0], [])
        MyClassPrx_mixin::OP_opNDAIS = Ice::__defineOperation('opNDAIS', 'opNDAIS', Ice::OperationMode::Normal, nil, [[::Test::T_NDAIS, false, 0]], [[::Test::T_NDAIS, false, 0]], [::Test::T_NDAIS, false, 0], [])
        MyClassPrx_mixin::OP_opNDGIS = Ice::__defineOperation('opNDGIS', 'opNDGIS', Ice::OperationMode::Normal, nil, [[::Test::T_NDGIS, false, 0]], [[::Test::T_NDGIS, false, 0]], [::Test::T_NDGIS, false, 0], [])
        MyClassPrx_mixin::OP_opNDASS = Ice::__defineOperation('opNDASS', 'opNDASS', Ice::OperationMode::Normal, nil, [[::Test::T_NDASS, false, 0]], [[::Test::T_NDASS, false, 0]], [::Test::T_NDASS, false, 0], [])
        MyClassPrx_mixin::OP_opNDGSS = Ice::__defineOperation('opNDGSS', 'opNDGSS', Ice::OperationMode::Normal, nil, [[::Test::T_NDGSS, false, 0]], [[::Test::T_NDGSS, false, 0]], [::Test::T_NDGSS, false, 0], [])
    end
end
