...
module ::Test
    ...
    if not defined?(::Test::TestIntfPrx)
        ...
        TestIntfPrx_mixin::OP_transient = Ice::__defineOperation('transient', 'transient', Ice::OperationMode::Normal, nil, [], [], nil, [])
        TestIntfPrx_mixin::OP_deactivate = Ice::__defineOperation('deactivate', 'deactivate', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
