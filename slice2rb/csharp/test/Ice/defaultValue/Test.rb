...
module ::Test
    ...
    if not defined?(::Test::PointProp)
        class PointProp
            ...
            def ==(other)
                return false if !other.is_a? ::Test::PointProp or
                    @x != other.x or
                    @y != other.y
                true
            end
        ...
        T_PointProp = Ice::__defineStruct('::Test::PointProp', PointProp, [
            ["x", Ice::T_int],
            ["y", Ice::T_int]
        ])
    end
    ...
    if not defined?(::Test::Struct3)
        class Struct3
            include Ice::Inspect_mixin
            def initialize(boolFalse=false, boolTrue=true, b=1, s=2, i=3, l=4, f=5.1, d=6.2, c1=::Test::Color::Red, c2=::Test::Color::Green, c3=::Test::Color::Blue, nc1=::Test::Nested::Color::Red, nc2=::Test::Nested::Color::Green, nc3=::Test::Nested::Color::Blue, zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0)
                @boolFalse = boolFalse
                @boolTrue = boolTrue
                @b = b
                @s = s
            ...
            attr_accessor :boolFalse, :boolTrue, :b, :s, :i, :l, :f, :d, :c1, :c2, :c3, :nc1, :nc2, :nc3, :zeroI, :zeroL, :zeroF, :zeroDotF, :zeroD, :zeroDotD
        end
    ...
    if not defined?(::Test::Base)
        class Base < Ice::Value
            ...
            def initialize(boolFalse=false, boolTrue=true, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo\s\\\s\"bar\n\s\r\n\t\v\f\a\b?\s\a\s\a", noDefault='', zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, st1=::Test::Struct1.new)
                @boolFalse = boolFalse
                @boolTrue = boolTrue
                @b = b
                @s = s
            ...
            attr_accessor :boolFalse, :boolTrue, :b, :s, :i, :l, :f, :d, :str, :noDefault, :zeroI, :zeroL, :zeroF, :zeroDotF, :zeroD, :zeroDotD, :st1
        end
    ...
    if not defined?(::Test::Derived)
        class Derived < ::Test::Base
            ...
            def initialize(boolFalse=false, boolTrue=true, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo\s\\\s\"bar\n\s\r\n\t\v\f\a\b?\s\a\s\a", noDefault='', zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, st1=::Test::Struct1.new, c1=::Test::Color::Red, c2=::Test::Color::Green, c3=::Test::Color::Blue, nc1=::Test::Nested::Color::Red, nc2=::Test::Nested::Color::Green, nc3=::Test::Nested::Color::Blue)
    ...
    if not defined?(::Test::T_ClassProperty)
        T_ClassProperty = Ice::__declareClass('::Test::ClassProperty')
    end
    ...
    if not defined?(::Test::ClassProperty)
        ...
        T_ClassProperty.defineClass(ClassProperty, -1, false, nil, [
            ['boolFalse', Ice::T_bool, false, 0],
            ['boolTrue', Ice::T_bool, false, 0],
            ['b', Ice::T_byte, false, 0],
            ['s', Ice::T_short, false, 0],
    ...
    if not defined?(::Test::StructProperty)
        class StructProperty
            ...
            def ==(other)
                return false if !other.is_a? ::Test::StructProperty or
                    @boolFalse != other.boolFalse or
                    @boolTrue != other.boolTrue or
                    @b != other.b or
                    @s != other.s or
        ...
        T_StructProperty = Ice::__defineStruct('::Test::StructProperty', StructProperty, [
            ["boolFalse", Ice::T_bool],
            ["boolTrue", Ice::T_bool],
            ["b", Ice::T_byte],
            ["s", Ice::T_short],
    ...
    if not defined?(::Test::ExceptionProperty)
        ...
        T_ExceptionProperty = Ice::__defineException('::Test::ExceptionProperty', ExceptionProperty, nil, [
            ["boolFalse", Ice::T_bool, false, 0],
            ["boolTrue", Ice::T_bool, false, 0],
            ["b", Ice::T_byte, false, 0],
            ["s", Ice::T_short, false, 0],
    ...
    if not defined?(::Test::InnerStruct2)
        class InnerStruct2
            include Ice::Inspect_mixin
            def initialize(a='')
                @a = a
            ...
            def ==(other)
                return false if !other.is_a? ::Test::InnerStruct2 or
                    @a != other.a
                true
            end
        ...
        T_InnerStruct2 = Ice::__defineStruct('::Test::InnerStruct2', InnerStruct2, [["a", Ice::T_string]])
    end

    if not defined?(::Test::StructNoDefaults)
        class StructNoDefaults
            include Ice::Inspect_mixin
            def initialize(bo=false, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str='', c1=::Test::Color::Red, bs=nil, iseq=nil, st=::Test::InnerStruct.new, st2=::Test::InnerStruct2.new, dict=nil)
                @bo = bo
                @b = b
                @s = s
                @i = i
            ...
            attr_accessor :bo, :b, :s, :i, :l, :f, :d, :str, :c1, :bs, :iseq, :st, :st2, :dict
        end
    ...
    if not defined?(::Test::ExceptionNoDefaults)
        ...
        T_ExceptionNoDefaults = Ice::__defineException('::Test::ExceptionNoDefaults', ExceptionNoDefaults, ::Test::T_ExceptionNoDefaultsBase, [
            ...
            ["st2", ::Test::T_InnerStruct2, false, 0],
