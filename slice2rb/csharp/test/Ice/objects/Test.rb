...
module ::Test
    ...
    if not defined?(::Test::IBase_Mixin)

        module ::Test::IBase_Mixin
        end
        ...
        if not defined?(::Test::T_IBase)
            T_IBase = ::Ice::__declareClass('::Test::IBase')
        end

        T_IBase.defineClass(IBase, -1, false, false, nil, [['id', ::Ice::T_string, false, 0]])
    end

    if not defined?(::Test::IDerived_Mixin)

        module ::Test::IDerived_Mixin
        end
        class IDerived < ::Test::IBase
        ...
        if not defined?(::Test::T_IDerived)
            T_IDerived = ::Ice::__declareClass('::Test::IDerived')
        end

        T_IDerived.defineClass(IDerived, -1, false, false, ::Test::T_IBase, [['name', ::Ice::T_string, false, 0]])
    end

    if not defined?(::Test::IDerived2_Mixin)

        module ::Test::IDerived2_Mixin
        end
        class IDerived2 < ::Test::IBase
        ...
        if not defined?(::Test::T_IDerived2)
            T_IDerived2 = ::Ice::__declareClass('::Test::IDerived2')
        end

        T_IDerived2.defineClass(IDerived2, -1, false, false, ::Test::T_IBase, [])
    end

    if not defined?(::Test::I2_Mixin)

        module ::Test::I2_Mixin
        end
        class I2 < ::Ice::Value
        end

        if not defined?(::Test::T_I2)
            T_I2 = ::Ice::__declareClass('::Test::I2')
        end

        T_I2.defineClass(I2, -1, false, false, nil, [])
    end
    ...
    if not defined?(::Test::S1)
        ...
        T_S1 = ::Ice::__defineStruct('::Test::S1', S1, [["id", ::Ice::T_int]])
    end

    if not defined?(::Test::SC1)
        class SC1
            include ::Ice::Inspect_mixin
            def initialize(id='')
                @id = id
            ...
            def ==(other)
                return false if !other.is_a? ::Test::SC1 or
                    @id != other.id
                true
            end
        ...
        T_SC1 = ::Ice::__defineStruct('::Test::SC1', SC1, [["id", ::Ice::T_string]])
    end
