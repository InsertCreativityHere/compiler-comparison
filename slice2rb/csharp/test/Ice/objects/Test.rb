...
module ::Test
    ...
    if not defined?(::Test::IBase_Mixin)
        ...
        T_IBase.defineClass(IBase, -1, false, nil, [['id', ::Ice::T_string, false, 0]])
    end
    ...
    if not defined?(::Test::IDerived_Mixin)
        ...
        T_IDerived.defineClass(IDerived, -1, false, ::Test::T_IBase, [['name', ::Ice::T_string, false, 0]])
    end
    ...
    if not defined?(::Test::IDerived2_Mixin)
        ...
        T_IDerived2.defineClass(IDerived2, -1, false, ::Test::T_IBase, [])
    end
    ...
    if not defined?(::Test::I2_Mixin)
        ...
        T_I2.defineClass(I2, -1, false, nil, [])
    end
