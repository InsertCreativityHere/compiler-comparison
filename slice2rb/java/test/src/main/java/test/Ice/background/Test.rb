...
module ::Test
    ...
    if not defined?(::Test::BackgroundControllerPrx)
        ...
        BackgroundControllerPrx_mixin::OP_initializeSocketStatus = Ice::__defineOperation('initializeSocketStatus', 'initializeSocketStatus', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], nil, [])
