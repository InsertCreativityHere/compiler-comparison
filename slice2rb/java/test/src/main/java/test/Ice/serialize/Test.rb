...
module ::Test
    ...
    if not defined?(::Test::InitialPrx)
        ...
        InitialPrx_mixin::OP_getStruct1 = Ice::__defineOperation('getStruct1', 'getStruct1', Ice::OperationMode::Normal, nil, [], [], [::Test::T_ByteS, false, 0], [])
        InitialPrx_mixin::OP_getBase = Ice::__defineOperation('getBase', 'getBase', Ice::OperationMode::Normal, nil, [], [], [::Test::T_ByteS, false, 0], [])
        InitialPrx_mixin::OP_getEx = Ice::__defineOperation('getEx', 'getEx', Ice::OperationMode::Normal, nil, [], [], [::Test::T_ByteS, false, 0], [])
