...
module ::Test
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        InitialPrx_mixin::OP_opMyInterfaceProxyReq = ::Ice::__defineOperation('opMyInterfaceProxyReq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_MyInterfacePrx, true, 2]], [[::Test::T_MyInterfacePrx, true, 3]], [::Test::T_MyInterfacePrx, true, 1], [])
