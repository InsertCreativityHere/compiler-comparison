...
module ::Test
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        InitialPrx_mixin::OP_opOneOptionalReq = ::Ice::__defineOperation('opOneOptionalReq', ::Ice::OperationMode::Normal, true, nil, [[::Test::T_OneOptional, true, 2]], [[::Test::T_OneOptional, true, 3]], [::Test::T_OneOptional, true, 1], [])
