...
module ::Clash
    ...
    if not defined?(::Clash::Cls)
        class Cls < Ice::Value
            ...
            def initialize(s=nil, context='', current=0, response=0, typeId=0, del=0, cookie=Ice::Unset, ex='', result=0, istr='', ostr='', inS='', in='', proxy='', obj=0, getCookie=0)
                @s = s
                @context = context
                @current = current
                @response = response
            ...
            attr_accessor :s, :context, :current, :response, :typeId, :del, :cookie, :ex, :result, :istr, :ostr, :inS, :in, :proxy, :obj, :getCookie
        end
    ...
    if not defined?(::Clash::St)
        class St
            ...
            def initialize(v='', istr=0, ostr=0, rhs=0, hashCode='')
                @v = v
                @istr = istr
                @ostr = ostr
                @rhs = rhs
            ...
            attr_accessor :v, :istr, :ostr, :rhs, :hashCode
        end
