...
module ::Clash
    ...
    if not defined?(::Clash::Intf_Mixin)
        ...
        module IntfPrx_mixin
            ...
            def ok(context=nil)
                IntfPrx_mixin::OP_ok.invoke(self, [], context)
            end

            def target(context=nil)
                IntfPrx_mixin::OP_target.invoke(self, [], context)
            end

            def op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_=nil)
                IntfPrx_mixin::OP_op.invoke(self, [context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok], context_)
            end
        ...
        IntfPrx_mixin::OP_ok = ::Ice::__defineOperation('ok', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        IntfPrx_mixin::OP_target = ::Ice::__defineOperation('target', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
    ...
    if not defined?(::Clash::Cls_Mixin)
        ...
        class Cls < ::Ice::Value
            ...
            def initialize(s=nil, context='', current=0, response=0, upCast='', typeId=0, del=0, cookie=::Ice::Unset, ex='', result=0, istr='', ostr='', inS='', _in='', proxy='', stream=::Ice::Unset, target='')
                @s = s
                @context = context
                @current = current
                @response = response
        ...
        T_Cls.defineClass(Cls, -1, false, false, nil, [
            ...
            ['stream', ::Ice::T_int, true, 2],
            ['target', ::Ice::T_string, false, 0]
        ])
    end
