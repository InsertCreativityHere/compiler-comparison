...
module ::Test
    ...
    if not defined?(::Test::T_StructS)
        T_StructS = ::Ice::__defineSequence('::Test::StructS', ::Test::T_Structure)
    end

    if not defined?(::Test::Struct2)
        class Struct2
            include ::Ice::Inspect_mixin
            def initialize(b=false, i=0, f=0.0, d=0.0, by=0, sh=0, l=0, ss=nil, dict=nil, seq=nil)
                @b = b
                @i = i
                @f = f
                @d = d
            ...
            attr_accessor :b, :i, :f, :d, :by, :sh, :l, :ss, :dict, :seq
        end
    ...
    if not defined?(::Test::A_Mixin)
        ...
        T_A.defineClass(A, -1, false, false, nil, [['i', ::Ice::T_int, false, 0]])
    end

    if not defined?(::Test::T_AS)
        T_AS = ::Ice::__defineSequence('::Test::AS', ::Test::T_A)
    end
    ...
    if not defined?(::Test::MyClass_Mixin)
        ...
        module MyClassPrx_mixin
            ...
            def opMyEnumS(p1, p2, context=nil)
                MyClassPrx_mixin::OP_opMyEnumS.invoke(self, [p1, p2], context)
            end

            def opMyClassS(p1, p2, context=nil)
                MyClassPrx_mixin::OP_opMyClassS.invoke(self, [p1, p2], context)
            end
            ...
            def getNSNullStringSeq(context=nil)
                MyClassPrx_mixin::OP_getNSNullStringSeq.invoke(self, [], context)
            end

            def getNSNullASeq(context=nil)
                MyClassPrx_mixin::OP_getNSNullASeq.invoke(self, [], context)
            end

            def getNSNullStructSeq(context=nil)
                MyClassPrx_mixin::OP_getNSNullStructSeq.invoke(self, [], context)
            end

            def getNSNullStringSeqSeq(context=nil)
                MyClassPrx_mixin::OP_getNSNullStringSeqSeq.invoke(self, [], context)
            end

            def getNSNullStringStringDict(context=nil)
                MyClassPrx_mixin::OP_getNSNullStringStringDict.invoke(self, [], context)
            end

            def putNSNullStringStringDict(d, context=nil)
                MyClassPrx_mixin::OP_putNSNullStringStringDict.invoke(self, [d], context)
            end

            def putNSNullShortIntDict(d, context=nil)
                MyClassPrx_mixin::OP_putNSNullShortIntDict.invoke(self, [d], context)
            end

            def putNSNullStringMyEnumDict(d, context=nil)
                MyClassPrx_mixin::OP_putNSNullStringMyEnumDict.invoke(self, [d], context)
            end
        end
        ...
        MyClassPrx_mixin::OP_opMyEnumS = ::Ice::__defineOperation('opMyEnumS', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_MyEnumS, false, 0], [::Test::T_MyEnumS, false, 0]], [[::Test::T_MyEnumS, false, 0]], [::Test::T_MyEnumS, false, 0], [])
        MyClassPrx_mixin::OP_opMyClassS = ::Ice::__defineOperation('opMyClassS', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_MyClassS, false, 0], [::Test::T_MyClassS, false, 0]], [[::Test::T_MyClassS, false, 0]], [::Test::T_MyClassS, false, 0], [])
        ...
        MyClassPrx_mixin::OP_getNSNullStringSeq = ::Ice::__defineOperation('getNSNullStringSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_StringS, false, 0], [])
        MyClassPrx_mixin::OP_getNSNullASeq = ::Ice::__defineOperation('getNSNullASeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_AS, false, 0], [])
        MyClassPrx_mixin::OP_getNSNullStructSeq = ::Ice::__defineOperation('getNSNullStructSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_StructS, false, 0], [])
        MyClassPrx_mixin::OP_getNSNullStringSeqSeq = ::Ice::__defineOperation('getNSNullStringSeqSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_StringSS, false, 0], [])
        MyClassPrx_mixin::OP_getNSNullStringStringDict = ::Ice::__defineOperation('getNSNullStringStringDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_StringStringD, false, 0], [])
        MyClassPrx_mixin::OP_putNSNullStringStringDict = ::Ice::__defineOperation('putNSNullStringStringDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_StringStringD, false, 0]], [], nil, [])
        MyClassPrx_mixin::OP_putNSNullShortIntDict = ::Ice::__defineOperation('putNSNullShortIntDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_ShortIntD, false, 0]], [], nil, [])
        MyClassPrx_mixin::OP_putNSNullStringMyEnumDict = ::Ice::__defineOperation('putNSNullStringMyEnumDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_StringMyEnumD, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::MyDerivedClass_Mixin)
        ...
        module MyDerivedClassPrx_mixin
            ...
            def opMyStruct1(c, context=nil)
                MyDerivedClassPrx_mixin::OP_opMyStruct1.invoke(self, [c], context)
            end
        end
