...
module ::Test
    ...
    if not defined?(::Test::T_ObjectSeq)
        T_ObjectSeq = ::Ice::__defineSequence('::Test::ObjectSeq', ::Ice::T_Value)
    end

    if not defined?(::Test::T_ObjectPrxSeq)
        T_ObjectPrxSeq = ::Ice::__defineSequence('::Test::ObjectPrxSeq', ::Ice::T_ObjectPrx)
    end
    ...
    if not defined?(::Test::T_BasePrxSeq)
        T_BasePrxSeq = ::Ice::__defineSequence('::Test::BasePrxSeq', ::Ice::T_ObjectPrx)
    end

    if not defined?(::Test::T_ObjectDict)
        T_ObjectDict = ::Ice::__defineDictionary('::Test::ObjectDict', ::Ice::T_string, ::Ice::T_Value)
    end

    if not defined?(::Test::T_ObjectPrxDict)
        T_ObjectPrxDict = ::Ice::__defineDictionary('::Test::ObjectPrxDict', ::Ice::T_string, ::Ice::T_ObjectPrx)
    end

    if not defined?(::Test::T_BaseDict)
        T_BaseDict = ::Ice::__defineDictionary('::Test::BaseDict', ::Ice::T_string, ::Test::T_Base)
    end

    if not defined?(::Test::T_BasePrxDict)
        T_BasePrxDict = ::Ice::__defineDictionary('::Test::BasePrxDict', ::Ice::T_string, ::Ice::T_ObjectPrx)
    end
    ...
    if not defined?(::Test::Initial_Mixin)
        ...
        module InitialPrx_mixin
            ...
            def getObjectSeq(s, context=nil)
                InitialPrx_mixin::OP_getObjectSeq.invoke(self, [s], context)
            end

            def getObjectPrxSeq(s, context=nil)
                InitialPrx_mixin::OP_getObjectPrxSeq.invoke(self, [s], context)
            end

            def getBaseSeq(s, context=nil)
                InitialPrx_mixin::OP_getBaseSeq.invoke(self, [s], context)
            end

            def getBasePrxSeq(s, context=nil)
                InitialPrx_mixin::OP_getBasePrxSeq.invoke(self, [s], context)
            end

            def getObjectDict(d, context=nil)
                InitialPrx_mixin::OP_getObjectDict.invoke(self, [d], context)
            end

            def getObjectPrxDict(d, context=nil)
                InitialPrx_mixin::OP_getObjectPrxDict.invoke(self, [d], context)
            end

            def getBaseDict(d, context=nil)
                InitialPrx_mixin::OP_getBaseDict.invoke(self, [d], context)
            end

            def getBasePrxDict(d, context=nil)
                InitialPrx_mixin::OP_getBasePrxDict.invoke(self, [d], context)
            end
        ...
        InitialPrx_mixin::OP_getObjectSeq = ::Ice::__defineOperation('getObjectSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_ObjectSeq, false, 0]], [], [::Test::T_ObjectSeq, false, 0], [])
        InitialPrx_mixin::OP_getObjectPrxSeq = ::Ice::__defineOperation('getObjectPrxSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_ObjectPrxSeq, false, 0]], [], [::Test::T_ObjectPrxSeq, false, 0], [])
        InitialPrx_mixin::OP_getBaseSeq = ::Ice::__defineOperation('getBaseSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_BaseSeq, false, 0]], [], [::Test::T_BaseSeq, false, 0], [])
        InitialPrx_mixin::OP_getBasePrxSeq = ::Ice::__defineOperation('getBasePrxSeq', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_BasePrxSeq, false, 0]], [], [::Test::T_BasePrxSeq, false, 0], [])
        InitialPrx_mixin::OP_getObjectDict = ::Ice::__defineOperation('getObjectDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_ObjectDict, false, 0]], [], [::Test::T_ObjectDict, false, 0], [])
        InitialPrx_mixin::OP_getObjectPrxDict = ::Ice::__defineOperation('getObjectPrxDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_ObjectPrxDict, false, 0]], [], [::Test::T_ObjectPrxDict, false, 0], [])
        InitialPrx_mixin::OP_getBaseDict = ::Ice::__defineOperation('getBaseDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_BaseDict, false, 0]], [], [::Test::T_BaseDict, false, 0], [])
        InitialPrx_mixin::OP_getBasePrxDict = ::Ice::__defineOperation('getBasePrxDict', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Test::T_BasePrxDict, false, 0]], [], [::Test::T_BasePrxDict, false, 0], [])
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_opDerived = ::Ice::__defineOperation('opDerived', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], [::Test::T_Base, false, 0], [])
        TestIntfPrx_mixin::OP_throwDerived = ::Ice::__defineOperation('throwDerived', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_BaseEx])
    end
