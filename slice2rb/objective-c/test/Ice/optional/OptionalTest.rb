...
module ::Test
    ...
    if not defined?(::Test::A_Mixin)
        ...
        class A < ::Ice::Value
            ...
            def initialize(requiredA=0, mc=::Ice::Unset, mb=::Ice::Unset, ma=::Ice::Unset)
                @requiredA = requiredA
                @mc = mc
                @mb = mb
                @ma = ma
            ...
            attr_accessor :requiredA, :mc, :mb, :ma
        end
    ...
    if not defined?(::Test::B_Mixin)
        ...
        class B < ::Test::A
            ...
            def initialize(requiredA=0, mc=::Ice::Unset, mb=::Ice::Unset, ma=::Ice::Unset, requiredB=0, md=::Ice::Unset)
    ...
    if not defined?(::Test::C_Mixin)
        ...
        class C < ::Test::B
            ...
            def initialize(requiredA=0, mc=::Ice::Unset, mb=::Ice::Unset, ma=::Ice::Unset, requiredB=0, md=::Ice::Unset, ss='', ms=::Ice::Unset)
    ...
    if not defined?(::Test::DerivedException)
        class DerivedException < ::Test::OptionalException
            def initialize(req=false, a=5, b=::Ice::Unset, o=::Ice::Unset, d1="d1", ss="test", o2=::Ice::Unset, d2="d2")
                super(req, a, b, o)
                @d1 = d1
                @ss = ss
                @o2 = o2
