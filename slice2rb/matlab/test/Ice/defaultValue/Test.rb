...
module ::Test
    ...
    if not defined?(::Test::T_IntSeqSeq)
        T_IntSeqSeq = Ice::__defineSequence('::Test::IntSeqSeq', ::Test::T_IntSeq)
    end

    if not defined?(::Test::T_DerivedSeq)
        T_DerivedSeq = Ice::__defineSequence('::Test::DerivedSeq', ::Test::T_Derived)
    end
    ...
    if not defined?(::Test::StructNoDefaults)
        class StructNoDefaults
            include Ice::Inspect_mixin
            def initialize(bo=false, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str='', c1=::Test::Color::Red, bs=nil, is=nil, st=::Test::InnerStruct.new, dict=nil, derivedSeq=nil, intSeqSeq=nil)
                @bo = bo
                @b = b
                @s = s
                @i = i
            ...
            def hash
                ...
                _h = 5 * _h + @st.hash
                _h = 5 * _h + @dict.hash
                _h = 5 * _h + @derivedSeq.hash
                _h = 5 * _h + @intSeqSeq.hash
                _h % 0x7fffffff
            end
            ...
            def ==(other)
                return false if !other.is_a? ::Test::StructNoDefaults or
                    ...
                    @st != other.st or
                    @dict != other.dict or
                    @derivedSeq != other.derivedSeq or
                    @intSeqSeq != other.intSeqSeq
                true
            end
            ...
            attr_accessor :bo, :b, :s, :i, :l, :f, :d, :str, :c1, :bs, :is, :st, :dict, :derivedSeq, :intSeqSeq
        end
        ...
        T_StructNoDefaults = Ice::__defineStruct('::Test::StructNoDefaults', StructNoDefaults, [
            ...
            ["derivedSeq", ::Test::T_DerivedSeq],
            ["intSeqSeq", ::Test::T_IntSeqSeq]
        ])
    end
