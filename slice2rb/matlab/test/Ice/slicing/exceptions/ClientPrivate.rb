...
module ::Test
    ...
    if not defined?(::Test::Relay_Mixin)
        ...
        RelayPrx_mixin::OP_knownPreservedAsBase = ::Ice::__defineOperation('knownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        RelayPrx_mixin::OP_knownPreservedAsKnownPreserved = ::Ice::__defineOperation('knownPreservedAsKnownPreserved', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownPreserved])
        RelayPrx_mixin::OP_unknownPreservedAsBase = ::Ice::__defineOperation('unknownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_baseAsBase = ::Ice::__defineOperation('baseAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_unknownDerivedAsBase = ::Ice::__defineOperation('unknownDerivedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownDerivedAsBase = ::Ice::__defineOperation('knownDerivedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownDerivedAsKnownDerived = ::Ice::__defineOperation('knownDerivedAsKnownDerived', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownDerived])
        TestIntfPrx_mixin::OP_unknownIntermediateAsBase = ::Ice::__defineOperation('unknownIntermediateAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownIntermediateAsBase = ::Ice::__defineOperation('knownIntermediateAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownMostDerivedAsBase = ::Ice::__defineOperation('knownMostDerivedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownIntermediateAsKnownIntermediate = ::Ice::__defineOperation('knownIntermediateAsKnownIntermediate', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownIntermediate])
        TestIntfPrx_mixin::OP_knownMostDerivedAsKnownIntermediate = ::Ice::__defineOperation('knownMostDerivedAsKnownIntermediate', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownIntermediate])
        TestIntfPrx_mixin::OP_knownMostDerivedAsKnownMostDerived = ::Ice::__defineOperation('knownMostDerivedAsKnownMostDerived', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownMostDerived])
        TestIntfPrx_mixin::OP_unknownMostDerived1AsBase = ::Ice::__defineOperation('unknownMostDerived1AsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_unknownMostDerived1AsKnownIntermediate = ::Ice::__defineOperation('unknownMostDerived1AsKnownIntermediate', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownIntermediate])
        TestIntfPrx_mixin::OP_unknownMostDerived2AsBase = ::Ice::__defineOperation('unknownMostDerived2AsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_unknownMostDerived2AsBaseCompact = ::Ice::__defineOperation('unknownMostDerived2AsBaseCompact', ::Ice::OperationMode::Normal, false, ::Ice::FormatType::CompactFormat, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownPreservedAsBase = ::Ice::__defineOperation('knownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_knownPreservedAsKnownPreserved = ::Ice::__defineOperation('knownPreservedAsKnownPreserved', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownPreserved])
        TestIntfPrx_mixin::OP_relayKnownPreservedAsBase = ::Ice::__defineOperation('relayKnownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [[::Test::T_RelayPrx, false, 0]], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_relayKnownPreservedAsKnownPreserved = ::Ice::__defineOperation('relayKnownPreservedAsKnownPreserved', ::Ice::OperationMode::Normal, false, nil, [[::Test::T_RelayPrx, false, 0]], [], nil, [::Test::T_KnownPreserved])
        TestIntfPrx_mixin::OP_unknownPreservedAsBase = ::Ice::__defineOperation('unknownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_unknownPreservedAsKnownPreserved = ::Ice::__defineOperation('unknownPreservedAsKnownPreserved', ::Ice::OperationMode::Normal, false, nil, [], [], nil, [::Test::T_KnownPreserved])
        TestIntfPrx_mixin::OP_relayUnknownPreservedAsBase = ::Ice::__defineOperation('relayUnknownPreservedAsBase', ::Ice::OperationMode::Normal, false, nil, [[::Test::T_RelayPrx, false, 0]], [], nil, [::Test::T_Base])
        TestIntfPrx_mixin::OP_relayUnknownPreservedAsKnownPreserved = ::Ice::__defineOperation('relayUnknownPreservedAsKnownPreserved', ::Ice::OperationMode::Normal, false, nil, [[::Test::T_RelayPrx, false, 0]], [], nil, [::Test::T_KnownPreserved])
