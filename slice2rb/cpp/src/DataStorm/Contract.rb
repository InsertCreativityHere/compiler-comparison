...
require 'DataStorm/SampleEvent.rb'
...
module ::DataStormContract
    ...
    if not defined?(::DataStormContract::SessionPrx)
        ...
        SessionPrx_mixin::OP_announceTopics = Ice::__defineOperation('announceTopics', 'announceTopics', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_TopicInfoSeq, false, 0], [Ice::T_bool, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_attachTopic = Ice::__defineOperation('attachTopic', 'attachTopic', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_TopicSpec, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_detachTopic = Ice::__defineOperation('detachTopic', 'detachTopic', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_attachTags = Ice::__defineOperation('attachTags', 'attachTags', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::DataStormContract::T_ElementInfoSeq, false, 0], [Ice::T_bool, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_detachTags = Ice::__defineOperation('detachTags', 'detachTags', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::Ice::T_LongSeq, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_announceElements = Ice::__defineOperation('announceElements', 'announceElements', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::DataStormContract::T_ElementInfoSeq, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_attachElements = Ice::__defineOperation('attachElements', 'attachElements', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::DataStormContract::T_ElementSpecSeq, false, 0], [Ice::T_bool, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_attachElementsAck = Ice::__defineOperation('attachElementsAck', 'attachElementsAck', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::DataStormContract::T_ElementSpecAckSeq, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_detachElements = Ice::__defineOperation('detachElements', 'detachElements', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::Ice::T_LongSeq, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_initSamples = Ice::__defineOperation('initSamples', 'initSamples', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [::DataStormContract::T_DataSamplesSeq, false, 0]], [], nil, [])
        SessionPrx_mixin::OP_disconnected = Ice::__defineOperation('disconnected', 'disconnected', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::DataStormContract::SubscriberSessionPrx)
        ...
        SubscriberSessionPrx_mixin::OP_s = Ice::__defineOperation('s', 's', Ice::OperationMode::Normal, nil, [[Ice::T_long, false, 0], [Ice::T_long, false, 0], [::DataStormContract::T_DataSample, false, 0]], [], nil, [])
    end

    if not defined?(::DataStormContract::SessionCreationError)
        class SessionCreationError
            ...
            def SessionCreationError.from_int(val)
                @@_enumerators[val]
            end
            ...
            def <=>(other)
                other.is_a?(SessionCreationError) or raise ArgumentError, "value must be a SessionCreationError"
                @value <=> other.to_i
            end
            ...
            def SessionCreationError.each(&block)
                @@_enumerators.each_value(&block)
            end

            AlreadyConnected = SessionCreationError.new("AlreadyConnected", 0)
            NodeShutdown = SessionCreationError.new("NodeShutdown", 1)
            SessionNotFound = SessionCreationError.new("SessionNotFound", 2)
            Internal = SessionCreationError.new("Internal", 3)

            @@_enumerators = {0=>AlreadyConnected, 1=>NodeShutdown, 2=>SessionNotFound, 3=>Internal}

            def SessionCreationError._enumerators
                @@_enumerators
            end
        ...
        T_SessionCreationError = Ice::__defineEnum('::DataStormContract::SessionCreationError', SessionCreationError, SessionCreationError::_enumerators)
    end

    if not defined?(::DataStormContract::SessionCreationException)
        ...
        T_SessionCreationException = Ice::__defineException('::DataStormContract::SessionCreationException', SessionCreationException, nil, [["error", ::DataStormContract::T_SessionCreationError, false, 0]])
    end
    ...
    if not defined?(::DataStormContract::NodePrx)
        ...
        NodePrx_mixin::OP_initiateCreateSession = Ice::__defineOperation('initiateCreateSession', 'initiateCreateSession', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_NodePrx, false, 0]], [], nil, [::DataStormContract::T_SessionCreationException])
        NodePrx_mixin::OP_createSession = Ice::__defineOperation('createSession', 'createSession', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_NodePrx, false, 0], [::DataStormContract::T_SubscriberSessionPrx, false, 0], [Ice::T_bool, false, 0]], [], nil, [::DataStormContract::T_SessionCreationException])
        NodePrx_mixin::OP_confirmCreateSession = Ice::__defineOperation('confirmCreateSession', 'confirmCreateSession', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_NodePrx, false, 0], [::DataStormContract::T_PublisherSessionPrx, false, 0]], [], nil, [::DataStormContract::T_SessionCreationException])
    end
    ...
    if not defined?(::DataStormContract::LookupPrx)
        ...
        LookupPrx_mixin::OP_announceTopicReader = Ice::__defineOperation('announceTopicReader', 'announceTopicReader', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [::DataStormContract::T_NodePrx, false, 0]], [], nil, [])
        LookupPrx_mixin::OP_announceTopicWriter = Ice::__defineOperation('announceTopicWriter', 'announceTopicWriter', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [::DataStormContract::T_NodePrx, false, 0]], [], nil, [])
        LookupPrx_mixin::OP_announceTopics = Ice::__defineOperation('announceTopics', 'announceTopics', Ice::OperationMode::Idempotent, nil, [[::Ice::T_StringSeq, false, 0], [::Ice::T_StringSeq, false, 0], [::DataStormContract::T_NodePrx, false, 0]], [], nil, [])
        LookupPrx_mixin::OP_createSession = Ice::__defineOperation('createSession', 'createSession', Ice::OperationMode::Normal, nil, [[::DataStormContract::T_NodePrx, false, 0]], [], [::DataStormContract::T_NodePrx, false, 0], [])
    end
end
