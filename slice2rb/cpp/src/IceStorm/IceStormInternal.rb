...
module ::IceStorm
    ...
    if not defined?(::IceStorm::TopicLinkPrx)
        ...
        TopicLinkPrx_mixin::OP_forward = Ice::__defineOperation('forward', 'forward', Ice::OperationMode::Normal, nil, [[::IceStorm::T_EventDataSeq, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::IceStorm::TopicInternalPrx)
        ...
        TopicInternalPrx_mixin::OP_getLinkProxy = Ice::__defineOperation('getLinkProxy', 'getLinkProxy', Ice::OperationMode::Idempotent, nil, [], [], [::IceStorm::T_TopicLinkPrx, false, 0], [])
        TopicInternalPrx_mixin::OP_reap = Ice::__defineOperation('reap', 'reap', Ice::OperationMode::Normal, nil, [[::Ice::T_IdentitySeq, false, 0]], [], nil, [::IceStorm::T_ReapWouldBlock])
    end
    ...
    if not defined?(::IceStorm::TopicManagerInternalPrx)
        ...
        TopicManagerInternalPrx_mixin::OP_getReplicaNode = Ice::__defineOperation('getReplicaNode', 'getReplicaNode', Ice::OperationMode::Idempotent, nil, [], [], [::IceStormElection::T_NodePrx, false, 0], [])
    end
end
