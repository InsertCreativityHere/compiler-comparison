...
module ::IceStormElection
    ...
    if not defined?(::IceStormElection::ReplicaObserverPrx)
        ...
        ReplicaObserverPrx_mixin::OP_init = Ice::__defineOperation('init', 'init', Ice::OperationMode::Normal, nil, [[::IceStormElection::T_LogUpdate, false, 0], [::IceStormElection::T_TopicContentSeq, false, 0]], [], nil, [::IceStormElection::T_ObserverInconsistencyException])
        ReplicaObserverPrx_mixin::OP_createTopic = Ice::__defineOperation('createTopic', 'createTopic', Ice::OperationMode::Normal, nil, [[::IceStormElection::T_LogUpdate, false, 0], [Ice::T_string, false, 0]], [], nil, [::IceStormElection::T_ObserverInconsistencyException])
        ReplicaObserverPrx_mixin::OP_destroyTopic = Ice::__defineOperation('destroyTopic', 'destroyTopic', Ice::OperationMode::Normal, nil, [[::IceStormElection::T_LogUpdate, false, 0], [Ice::T_string, false, 0]], [], nil, [::IceStormElection::T_ObserverInconsistencyException])
        ReplicaObserverPrx_mixin::OP_addSubscriber = Ice::__defineOperation('addSubscriber', 'addSubscriber', Ice::OperationMode::Normal, nil, [[::IceStormElection::T_LogUpdate, false, 0], [Ice::T_string, false, 0], [::IceStorm::T_SubscriberRecord, false, 0]], [], nil, [::IceStormElection::T_ObserverInconsistencyException])
        ReplicaObserverPrx_mixin::OP_removeSubscriber = Ice::__defineOperation('removeSubscriber', 'removeSubscriber', Ice::OperationMode::Normal, nil, [[::IceStormElection::T_LogUpdate, false, 0], [Ice::T_string, false, 0], [::Ice::T_IdentitySeq, false, 0]], [], nil, [::IceStormElection::T_ObserverInconsistencyException])
    end
    ...
    if not defined?(::IceStormElection::TopicManagerSyncPrx)
        ...
        TopicManagerSyncPrx_mixin::OP_getContent = Ice::__defineOperation('getContent', 'getContent', Ice::OperationMode::Normal, nil, [], [[::IceStormElection::T_LogUpdate, false, 0], [::IceStormElection::T_TopicContentSeq, false, 0]], nil, [])
    end
    ...
    if not defined?(::IceStormElection::NodePrx)
        ...
        NodePrx_mixin::OP_invitation = Ice::__defineOperation('invitation', 'invitation', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0], [Ice::T_string, false, 0]], [], nil, [])
        NodePrx_mixin::OP_ready = Ice::__defineOperation('ready', 'ready', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0], [Ice::T_string, false, 0], [Ice::T_ObjectPrx, false, 0], [Ice::T_int, false, 0], [Ice::T_long, false, 0]], [], nil, [])
        NodePrx_mixin::OP_accept = Ice::__defineOperation('accept', 'accept', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0], [Ice::T_string, false, 0], [::Ice::T_IntSeq, false, 0], [Ice::T_ObjectPrx, false, 0], [::IceStormElection::T_LogUpdate, false, 0], [Ice::T_int, false, 0]], [], nil, [])
        NodePrx_mixin::OP_areYouCoordinator = Ice::__defineOperation('areYouCoordinator', 'areYouCoordinator', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_bool, false, 0], [])
        NodePrx_mixin::OP_areYouThere = Ice::__defineOperation('areYouThere', 'areYouThere', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_int, false, 0]], [], [Ice::T_bool, false, 0], [])
        NodePrx_mixin::OP_sync = Ice::__defineOperation('sync', 'sync', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_ObjectPrx, false, 0], [])
        NodePrx_mixin::OP_nodes = Ice::__defineOperation('nodes', 'nodes', Ice::OperationMode::Idempotent, nil, [], [], [::IceStormElection::T_NodeInfoSeq, false, 0], [])
        NodePrx_mixin::OP_query = Ice::__defineOperation('query', 'query', Ice::OperationMode::Idempotent, nil, [], [], [::IceStormElection::T_QueryInfo, false, 0], [])
    end
end
