...
module ::IceGrid
    ...
    if not defined?(::IceGrid::AdapterPrx)
        ...
        AdapterPrx_mixin::OP_activate = Ice::__defineOperation('activate', 'activate', Ice::OperationMode::Normal, nil, [], [], [Ice::T_ObjectPrx, false, 0], [])
        AdapterPrx_mixin::OP_getDirectProxy = Ice::__defineOperation('getDirectProxy', 'getDirectProxy', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_ObjectPrx, false, 0], [::IceGrid::T_AdapterNotActiveException])
        AdapterPrx_mixin::OP_setDirectProxy = Ice::__defineOperation('setDirectProxy', 'setDirectProxy', Ice::OperationMode::Normal, nil, [[Ice::T_ObjectPrx, false, 0]], [], nil, [::IceGrid::T_AdapterActiveException])
    end
    ...
    if not defined?(::IceGrid::FileReaderPrx)
        ...
        FileReaderPrx_mixin::OP_getOffsetFromEnd = Ice::__defineOperation('getOffsetFromEnd', 'getOffsetFromEnd', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_int, false, 0]], [], [Ice::T_long, false, 0], [::IceGrid::T_FileNotAvailableException])
        FileReaderPrx_mixin::OP_read = Ice::__defineOperation('read', 'read', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_long, false, 0], [Ice::T_int, false, 0]], [[Ice::T_long, false, 0], [::Ice::T_StringSeq, false, 0]], [Ice::T_bool, false, 0], [::IceGrid::T_FileNotAvailableException])
    end
    ...
    if not defined?(::IceGrid::ServerPrx)
        ...
        ServerPrx_mixin::OP_start = Ice::__defineOperation('start', 'start', Ice::OperationMode::Normal, nil, [], [], nil, [::IceGrid::T_ServerStartException])
        ServerPrx_mixin::OP_stop = Ice::__defineOperation('stop', 'stop', Ice::OperationMode::Normal, nil, [], [], nil, [::IceGrid::T_ServerStopException])
        ServerPrx_mixin::OP_checkUpdate = Ice::__defineOperation('checkUpdate', 'checkUpdate', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalServerDescriptor, false, 0], [Ice::T_bool, false, 0]], [], [Ice::T_bool, false, 0], [::IceGrid::T_DeploymentException])
        ServerPrx_mixin::OP_setEnabled = Ice::__defineOperation('setEnabled', 'setEnabled', Ice::OperationMode::Normal, nil, [[Ice::T_bool, false, 0]], [], nil, [])
        ServerPrx_mixin::OP_isEnabled = Ice::__defineOperation('isEnabled', 'isEnabled', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_bool, false, 0], [])
        ServerPrx_mixin::OP_sendSignal = Ice::__defineOperation('sendSignal', 'sendSignal', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], nil, [::IceGrid::T_BadSignalException])
        ServerPrx_mixin::OP_writeMessage = Ice::__defineOperation('writeMessage', 'writeMessage', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_int, false, 0]], [], nil, [])
        ServerPrx_mixin::OP_getState = Ice::__defineOperation('getState', 'getState', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_ServerState, false, 0], [])
        ServerPrx_mixin::OP_getPid = Ice::__defineOperation('getPid', 'getPid', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_int, false, 0], [])
        ServerPrx_mixin::OP_setProcess = Ice::__defineOperation('setProcess', 'setProcess', Ice::OperationMode::Normal, nil, [[::Ice::T_ProcessPrx, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::IceGrid::ReplicaObserverPrx)
        ...
        ReplicaObserverPrx_mixin::OP_replicaInit = Ice::__defineOperation('replicaInit', 'replicaInit', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalRegistryPrxSeq, false, 0]], [], nil, [])
        ReplicaObserverPrx_mixin::OP_replicaAdded = Ice::__defineOperation('replicaAdded', 'replicaAdded', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalRegistryPrx, false, 0]], [], nil, [])
        ReplicaObserverPrx_mixin::OP_replicaRemoved = Ice::__defineOperation('replicaRemoved', 'replicaRemoved', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalRegistryPrx, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::IceGrid::NodePrx)
        ...
        NodePrx_mixin::OP_loadServer = Ice::__defineOperation('loadServer', 'loadServer', Ice::OperationMode::Idempotent, nil, [[::IceGrid::T_InternalServerDescriptor, false, 0], [Ice::T_string, false, 0]], [[::IceGrid::T_AdapterPrxDict, false, 0], [Ice::T_int, false, 0], [Ice::T_int, false, 0]], [::IceGrid::T_ServerPrx, false, 0], [::IceGrid::T_DeploymentException])
        NodePrx_mixin::OP_loadServerWithoutRestart = Ice::__defineOperation('loadServerWithoutRestart', 'loadServerWithoutRestart', Ice::OperationMode::Idempotent, nil, [[::IceGrid::T_InternalServerDescriptor, false, 0], [Ice::T_string, false, 0]], [[::IceGrid::T_AdapterPrxDict, false, 0], [Ice::T_int, false, 0], [Ice::T_int, false, 0]], [::IceGrid::T_ServerPrx, false, 0], [::IceGrid::T_DeploymentException])
        NodePrx_mixin::OP_destroyServer = Ice::__defineOperation('destroyServer', 'destroyServer', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0], [Ice::T_int, false, 0], [Ice::T_string, false, 0]], [], nil, [::IceGrid::T_DeploymentException])
        NodePrx_mixin::OP_destroyServerWithoutRestart = Ice::__defineOperation('destroyServerWithoutRestart', 'destroyServerWithoutRestart', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0], [Ice::T_int, false, 0], [Ice::T_string, false, 0]], [], nil, [::IceGrid::T_DeploymentException])
        NodePrx_mixin::OP_registerWithReplica = Ice::__defineOperation('registerWithReplica', 'registerWithReplica', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalRegistryPrx, false, 0]], [], nil, [])
        NodePrx_mixin::OP_getName = Ice::__defineOperation('getName', 'getName', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_string, false, 0], [])
        NodePrx_mixin::OP_getHostname = Ice::__defineOperation('getHostname', 'getHostname', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_string, false, 0], [])
        NodePrx_mixin::OP_getLoad = Ice::__defineOperation('getLoad', 'getLoad', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_LoadInfo, false, 0], [])
        NodePrx_mixin::OP_getProcessorSocketCount = Ice::__defineOperation('getProcessorSocketCount', 'getProcessorSocketCount', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_int, false, 0], [])
        NodePrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Idempotent, nil, [], [], nil, [])
    end
    ...
    if not defined?(::IceGrid::NodeSessionPrx)
        ...
        NodeSessionPrx_mixin::OP_keepAlive = Ice::__defineOperation('keepAlive', 'keepAlive', Ice::OperationMode::Normal, nil, [[::IceGrid::T_LoadInfo, false, 0]], [], nil, [])
        NodeSessionPrx_mixin::OP_setReplicaObserver = Ice::__defineOperation('setReplicaObserver', 'setReplicaObserver', Ice::OperationMode::Normal, nil, [[::IceGrid::T_ReplicaObserverPrx, false, 0]], [], nil, [])
        NodeSessionPrx_mixin::OP_getTimeout = Ice::__defineOperation('getTimeout', 'getTimeout', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_int, false, 0], [])
        NodeSessionPrx_mixin::OP_getObserver = Ice::__defineOperation('getObserver', 'getObserver', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_NodeObserverPrx, false, 0], [])
        NodeSessionPrx_mixin::OP_loadServers = Ice::__defineOperation('loadServers', 'loadServers', Ice::OperationMode::Idempotent, nil, [], [], nil, [])
        NodeSessionPrx_mixin::OP_getServers = Ice::__defineOperation('getServers', 'getServers', Ice::OperationMode::Idempotent, nil, [], [], [::Ice::T_StringSeq, false, 0], [])
        NodeSessionPrx_mixin::OP_waitForApplicationUpdate = Ice::__defineOperation('waitForApplicationUpdate', 'waitForApplicationUpdate', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0], [Ice::T_int, false, 0]], [], nil, [])
        NodeSessionPrx_mixin::OP_destroy = Ice::__defineOperation('destroy', 'destroy', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::IceGrid::ReplicaSessionPrx)
        ...
        ReplicaSessionPrx_mixin::OP_keepAlive = Ice::__defineOperation('keepAlive', 'keepAlive', Ice::OperationMode::Normal, nil, [], [], nil, [])
        ReplicaSessionPrx_mixin::OP_getTimeout = Ice::__defineOperation('getTimeout', 'getTimeout', Ice::OperationMode::Idempotent, nil, [], [], [Ice::T_int, false, 0], [])
        ReplicaSessionPrx_mixin::OP_setDatabaseObserver = Ice::__defineOperation('setDatabaseObserver', 'setDatabaseObserver', Ice::OperationMode::Idempotent, nil, [[::IceGrid::T_DatabaseObserverPrx, false, 0], [::IceGrid::T_StringLongDict, true, 1]], [], nil, [::IceGrid::T_ObserverAlreadyRegisteredException, ::IceGrid::T_DeploymentException])
        ReplicaSessionPrx_mixin::OP_setEndpoints = Ice::__defineOperation('setEndpoints', 'setEndpoints', Ice::OperationMode::Idempotent, nil, [[::IceGrid::T_StringObjectProxyDict, false, 0]], [], nil, [])
        ReplicaSessionPrx_mixin::OP_registerWellKnownObjects = Ice::__defineOperation('registerWellKnownObjects', 'registerWellKnownObjects', Ice::OperationMode::Idempotent, nil, [[::IceGrid::T_ObjectInfoSeq, false, 0]], [], nil, [])
        ReplicaSessionPrx_mixin::OP_setAdapterDirectProxy = Ice::__defineOperation('setAdapterDirectProxy', 'setAdapterDirectProxy', Ice::OperationMode::Idempotent, nil, [[Ice::T_string, false, 0], [Ice::T_string, false, 0], [Ice::T_ObjectPrx, false, 0]], [], nil, [::IceGrid::T_AdapterNotExistException, ::IceGrid::T_AdapterExistsException])
        ReplicaSessionPrx_mixin::OP_receivedUpdate = Ice::__defineOperation('receivedUpdate', 'receivedUpdate', Ice::OperationMode::Normal, nil, [[::IceGrid::T_TopicName, false, 0], [Ice::T_int, false, 0], [Ice::T_string, false, 0]], [], nil, [])
        ReplicaSessionPrx_mixin::OP_destroy = Ice::__defineOperation('destroy', 'destroy', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::IceGrid::InternalRegistryPrx)
        ...
        InternalRegistryPrx_mixin::OP_registerNode = Ice::__defineOperation('registerNode', 'registerNode', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalNodeInfo, false, 0], [::IceGrid::T_NodePrx, false, 0], [::IceGrid::T_LoadInfo, false, 0]], [], [::IceGrid::T_NodeSessionPrx, false, 0], [::IceGrid::T_NodeActiveException, ::IceGrid::T_PermissionDeniedException])
        InternalRegistryPrx_mixin::OP_registerReplica = Ice::__defineOperation('registerReplica', 'registerReplica', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalReplicaInfo, false, 0], [::IceGrid::T_InternalRegistryPrx, false, 0]], [], [::IceGrid::T_ReplicaSessionPrx, false, 0], [::IceGrid::T_ReplicaActiveException, ::IceGrid::T_PermissionDeniedException])
        InternalRegistryPrx_mixin::OP_registerWithReplica = Ice::__defineOperation('registerWithReplica', 'registerWithReplica', Ice::OperationMode::Normal, nil, [[::IceGrid::T_InternalRegistryPrx, false, 0]], [], nil, [])
        InternalRegistryPrx_mixin::OP_getNodes = Ice::__defineOperation('getNodes', 'getNodes', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_NodePrxSeq, false, 0], [])
        InternalRegistryPrx_mixin::OP_getReplicas = Ice::__defineOperation('getReplicas', 'getReplicas', Ice::OperationMode::Idempotent, nil, [], [], [::IceGrid::T_InternalRegistryPrxSeq, false, 0], [])
        InternalRegistryPrx_mixin::OP_getApplications = Ice::__defineOperation('getApplications', 'getApplications', Ice::OperationMode::Idempotent, nil, [], [[Ice::T_long, false, 0]], [::IceGrid::T_ApplicationInfoSeq, false, 0], [])
        InternalRegistryPrx_mixin::OP_getAdapters = Ice::__defineOperation('getAdapters', 'getAdapters', Ice::OperationMode::Idempotent, nil, [], [[Ice::T_long, false, 0]], [::IceGrid::T_AdapterInfoSeq, false, 0], [])
        InternalRegistryPrx_mixin::OP_getObjects = Ice::__defineOperation('getObjects', 'getObjects', Ice::OperationMode::Idempotent, nil, [], [[Ice::T_long, false, 0]], [::IceGrid::T_ObjectInfoSeq, false, 0], [])
        InternalRegistryPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Idempotent, nil, [], [], nil, [])
    end
end
