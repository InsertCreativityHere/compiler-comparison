...
module ::Test
    ...
    if not defined?(::Test::BackendPrx)
        ...
        BackendPrx_mixin::OP_check = Ice::__defineOperation('check', 'check', Ice::OperationMode::Normal, nil, [], [], nil, [])
        BackendPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::TestControllerPrx)
        ...
        TestControllerPrx_mixin::OP_step = Ice::__defineOperation('step', 'step', Ice::OperationMode::Normal, nil, [[::Glacier2::T_SessionPrx, false, 0], [::Test::T_TestToken, false, 0]], [[::Test::T_TestToken, false, 0]], nil, [])
        TestControllerPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::TestSessionPrx)
        ...
        TestSessionPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
