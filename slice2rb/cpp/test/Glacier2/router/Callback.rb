...
module ::Test
    ...
    if not defined?(::Test::CallbackReceiver_Mixin)
        ...
        CallbackReceiverPrx_mixin::OP_concurrentCallback = ::Ice::__defineOperation('concurrentCallback', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, false, 0]], [], [::Ice::T_int, false, 0], [])
        CallbackReceiverPrx_mixin::OP_waitCallback = ::Ice::__defineOperation('waitCallback', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        CallbackReceiverPrx_mixin::OP_callbackWithPayload = ::Ice::__defineOperation('callbackWithPayload', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_ByteSeq, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::Callback_Mixin)
        ...
        CallbackPrx_mixin::OP_initiateCallback = ::Ice::__defineOperation('initiateCallback', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
        CallbackPrx_mixin::OP_initiateCallbackEx = ::Ice::__defineOperation('initiateCallbackEx', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [::Test::T_CallbackException])
        CallbackPrx_mixin::OP_initiateConcurrentCallback = ::Ice::__defineOperation('initiateConcurrentCallback', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Ice::T_int, false, 0], [::Test::T_CallbackReceiverPrx, false, 0]], [], [::Ice::T_int, false, 0], [])
        CallbackPrx_mixin::OP_initiateWaitCallback = ::Ice::__defineOperation('initiateWaitCallback', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
        CallbackPrx_mixin::OP_initiateCallbackWithPayload = ::Ice::__defineOperation('initiateCallbackWithPayload', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, true, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
