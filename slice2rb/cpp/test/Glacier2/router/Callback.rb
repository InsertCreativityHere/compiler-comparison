...
module ::Test
    ...
    if not defined?(::Test::CallbackReceiverPrx)
        ...
        CallbackReceiverPrx_mixin::OP_callback = Ice::__defineOperation('callback', 'callback', Ice::OperationMode::Normal, nil, [], [], nil, [])
        CallbackReceiverPrx_mixin::OP_callbackEx = Ice::__defineOperation('callbackEx', 'callbackEx', Ice::OperationMode::Normal, nil, [], [], nil, [::Test::T_CallbackException])
        CallbackReceiverPrx_mixin::OP_concurrentCallback = Ice::__defineOperation('concurrentCallback', 'concurrentCallback', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], [Ice::T_int, false, 0], [])
        CallbackReceiverPrx_mixin::OP_waitCallback = Ice::__defineOperation('waitCallback', 'waitCallback', Ice::OperationMode::Normal, nil, [], [], nil, [])
        CallbackReceiverPrx_mixin::OP_callbackWithPayload = Ice::__defineOperation('callbackWithPayload', 'callbackWithPayload', Ice::OperationMode::Normal, nil, [[::Ice::T_ByteSeq, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::CallbackPrx)
        ...
        CallbackPrx_mixin::OP_initiateCallback = Ice::__defineOperation('initiateCallback', 'initiateCallback', Ice::OperationMode::Normal, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
        CallbackPrx_mixin::OP_initiateCallbackEx = Ice::__defineOperation('initiateCallbackEx', 'initiateCallbackEx', Ice::OperationMode::Normal, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [::Test::T_CallbackException])
        CallbackPrx_mixin::OP_initiateConcurrentCallback = Ice::__defineOperation('initiateConcurrentCallback', 'initiateConcurrentCallback', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0], [::Test::T_CallbackReceiverPrx, false, 0]], [], [Ice::T_int, false, 0], [])
        CallbackPrx_mixin::OP_initiateWaitCallback = Ice::__defineOperation('initiateWaitCallback', 'initiateWaitCallback', Ice::OperationMode::Normal, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
        CallbackPrx_mixin::OP_initiateCallbackWithPayload = Ice::__defineOperation('initiateCallbackWithPayload', 'initiateCallbackWithPayload', Ice::OperationMode::Normal, nil, [[::Test::T_CallbackReceiverPrx, false, 0]], [], nil, [])
        CallbackPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
