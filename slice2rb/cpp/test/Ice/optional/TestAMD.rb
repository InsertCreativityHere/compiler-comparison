...
module ::Test
    ...
    if not defined?(::Test::MyInterfacePrx)
        ...
        MyInterfacePrx_mixin::OP_op = Ice::__defineOperation('op', 'op', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
    ...
    if not defined?(::Test::InitialPrx)
        ...
        InitialPrx_mixin::OP_pingPong = Ice::__defineOperation('pingPong', 'pingPong', Ice::OperationMode::Normal, nil, [[Ice::T_Value, false, 0]], [], [Ice::T_Value, false, 0], [])
        InitialPrx_mixin::OP_opOptionalException = Ice::__defineOperation('opOptionalException', 'opOptionalException', Ice::OperationMode::Normal, nil, [[Ice::T_int, true, 1], [Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opDerivedException = Ice::__defineOperation('opDerivedException', 'opDerivedException', Ice::OperationMode::Normal, nil, [[Ice::T_int, true, 1], [Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opRequiredException = Ice::__defineOperation('opRequiredException', 'opRequiredException', Ice::OperationMode::Normal, nil, [[Ice::T_int, true, 1], [Ice::T_string, true, 2]], [], nil, [::Test::T_OptionalException])
        InitialPrx_mixin::OP_opByte = Ice::__defineOperation('opByte', 'opByte', Ice::OperationMode::Normal, nil, [[Ice::T_byte, true, 2]], [[Ice::T_byte, true, 3]], [Ice::T_byte, true, 1], [])
        InitialPrx_mixin::OP_opBool = Ice::__defineOperation('opBool', 'opBool', Ice::OperationMode::Normal, nil, [[Ice::T_bool, true, 2]], [[Ice::T_bool, true, 3]], [Ice::T_bool, true, 1], [])
        InitialPrx_mixin::OP_opShort = Ice::__defineOperation('opShort', 'opShort', Ice::OperationMode::Normal, nil, [[Ice::T_short, true, 2]], [[Ice::T_short, true, 3]], [Ice::T_short, true, 1], [])
        InitialPrx_mixin::OP_opInt = Ice::__defineOperation('opInt', 'opInt', Ice::OperationMode::Normal, nil, [[Ice::T_int, true, 2]], [[Ice::T_int, true, 3]], [Ice::T_int, true, 1], [])
        InitialPrx_mixin::OP_opLong = Ice::__defineOperation('opLong', 'opLong', Ice::OperationMode::Normal, nil, [[Ice::T_long, true, 1]], [[Ice::T_long, true, 2]], [Ice::T_long, true, 3], [])
        InitialPrx_mixin::OP_opFloat = Ice::__defineOperation('opFloat', 'opFloat', Ice::OperationMode::Normal, nil, [[Ice::T_float, true, 2]], [[Ice::T_float, true, 3]], [Ice::T_float, true, 1], [])
        InitialPrx_mixin::OP_opDouble = Ice::__defineOperation('opDouble', 'opDouble', Ice::OperationMode::Normal, nil, [[Ice::T_double, true, 2]], [[Ice::T_double, true, 3]], [Ice::T_double, true, 1], [])
        InitialPrx_mixin::OP_opString = Ice::__defineOperation('opString', 'opString', Ice::OperationMode::Normal, nil, [[Ice::T_string, true, 2]], [[Ice::T_string, true, 3]], [Ice::T_string, true, 1], [])
        InitialPrx_mixin::OP_opMyEnum = Ice::__defineOperation('opMyEnum', 'opMyEnum', Ice::OperationMode::Normal, nil, [[::Test::T_MyEnum, true, 2]], [[::Test::T_MyEnum, true, 3]], [::Test::T_MyEnum, true, 1], [])
        InitialPrx_mixin::OP_opSmallStruct = Ice::__defineOperation('opSmallStruct', 'opSmallStruct', Ice::OperationMode::Normal, nil, [[::Test::T_SmallStruct, true, 2]], [[::Test::T_SmallStruct, true, 3]], [::Test::T_SmallStruct, true, 1], [])
        InitialPrx_mixin::OP_opFixedStruct = Ice::__defineOperation('opFixedStruct', 'opFixedStruct', Ice::OperationMode::Normal, nil, [[::Test::T_FixedStruct, true, 2]], [[::Test::T_FixedStruct, true, 3]], [::Test::T_FixedStruct, true, 1], [])
        InitialPrx_mixin::OP_opVarStruct = Ice::__defineOperation('opVarStruct', 'opVarStruct', Ice::OperationMode::Normal, nil, [[::Test::T_VarStruct, true, 2]], [[::Test::T_VarStruct, true, 3]], [::Test::T_VarStruct, true, 1], [])
        InitialPrx_mixin::OP_opMyInterfaceProxy = Ice::__defineOperation('opMyInterfaceProxy', 'opMyInterfaceProxy', Ice::OperationMode::Normal, nil, [[::Test::T_MyInterfacePrx, true, 2]], [[::Test::T_MyInterfacePrx, true, 3]], [::Test::T_MyInterfacePrx, true, 1], [])
        InitialPrx_mixin::OP_opOneOptional = Ice::__defineOperation('opOneOptional', 'opOneOptional', Ice::OperationMode::Normal, nil, [[::Test::T_OneOptional, false, 0]], [[::Test::T_OneOptional, false, 0]], [::Test::T_OneOptional, false, 0], [])
        InitialPrx_mixin::OP_opByteSeq = Ice::__defineOperation('opByteSeq', 'opByteSeq', Ice::OperationMode::Normal, nil, [[::Test::T_ByteSeq, true, 2]], [[::Test::T_ByteSeq, true, 3]], [::Test::T_ByteSeq, true, 1], [])
        InitialPrx_mixin::OP_opBoolSeq = Ice::__defineOperation('opBoolSeq', 'opBoolSeq', Ice::OperationMode::Normal, nil, [[::Test::T_BoolSeq, true, 2]], [[::Test::T_BoolSeq, true, 3]], [::Test::T_BoolSeq, true, 1], [])
        InitialPrx_mixin::OP_opShortSeq = Ice::__defineOperation('opShortSeq', 'opShortSeq', Ice::OperationMode::Normal, nil, [[::Test::T_ShortSeq, true, 2]], [[::Test::T_ShortSeq, true, 3]], [::Test::T_ShortSeq, true, 1], [])
        InitialPrx_mixin::OP_opIntSeq = Ice::__defineOperation('opIntSeq', 'opIntSeq', Ice::OperationMode::Normal, nil, [[::Test::T_IntSeq, true, 2]], [[::Test::T_IntSeq, true, 3]], [::Test::T_IntSeq, true, 1], [])
        InitialPrx_mixin::OP_opLongSeq = Ice::__defineOperation('opLongSeq', 'opLongSeq', Ice::OperationMode::Normal, nil, [[::Test::T_LongSeq, true, 2]], [[::Test::T_LongSeq, true, 3]], [::Test::T_LongSeq, true, 1], [])
        InitialPrx_mixin::OP_opFloatSeq = Ice::__defineOperation('opFloatSeq', 'opFloatSeq', Ice::OperationMode::Normal, nil, [[::Test::T_FloatSeq, true, 2]], [[::Test::T_FloatSeq, true, 3]], [::Test::T_FloatSeq, true, 1], [])
        InitialPrx_mixin::OP_opDoubleSeq = Ice::__defineOperation('opDoubleSeq', 'opDoubleSeq', Ice::OperationMode::Normal, nil, [[::Test::T_DoubleSeq, true, 2]], [[::Test::T_DoubleSeq, true, 3]], [::Test::T_DoubleSeq, true, 1], [])
        InitialPrx_mixin::OP_opStringSeq = Ice::__defineOperation('opStringSeq', 'opStringSeq', Ice::OperationMode::Normal, nil, [[::Test::T_StringSeq, true, 2]], [[::Test::T_StringSeq, true, 3]], [::Test::T_StringSeq, true, 1], [])
        InitialPrx_mixin::OP_opSmallStructSeq = Ice::__defineOperation('opSmallStructSeq', 'opSmallStructSeq', Ice::OperationMode::Normal, nil, [[::Test::T_SmallStructSeq, true, 2]], [[::Test::T_SmallStructSeq, true, 3]], [::Test::T_SmallStructSeq, true, 1], [])
        InitialPrx_mixin::OP_opSmallStructList = Ice::__defineOperation('opSmallStructList', 'opSmallStructList', Ice::OperationMode::Normal, nil, [[::Test::T_SmallStructList, true, 2]], [[::Test::T_SmallStructList, true, 3]], [::Test::T_SmallStructList, true, 1], [])
        InitialPrx_mixin::OP_opFixedStructSeq = Ice::__defineOperation('opFixedStructSeq', 'opFixedStructSeq', Ice::OperationMode::Normal, nil, [[::Test::T_FixedStructSeq, true, 2]], [[::Test::T_FixedStructSeq, true, 3]], [::Test::T_FixedStructSeq, true, 1], [])
        InitialPrx_mixin::OP_opFixedStructList = Ice::__defineOperation('opFixedStructList', 'opFixedStructList', Ice::OperationMode::Normal, nil, [[::Test::T_FixedStructList, true, 2]], [[::Test::T_FixedStructList, true, 3]], [::Test::T_FixedStructList, true, 1], [])
        InitialPrx_mixin::OP_opVarStructSeq = Ice::__defineOperation('opVarStructSeq', 'opVarStructSeq', Ice::OperationMode::Normal, nil, [[::Test::T_VarStructSeq, true, 2]], [[::Test::T_VarStructSeq, true, 3]], [::Test::T_VarStructSeq, true, 1], [])
        InitialPrx_mixin::OP_opSerializable = Ice::__defineOperation('opSerializable', 'opSerializable', Ice::OperationMode::Normal, nil, [[::Test::T_Serializable, true, 2]], [[::Test::T_Serializable, true, 3]], [::Test::T_Serializable, true, 1], [])
        InitialPrx_mixin::OP_opIntIntDict = Ice::__defineOperation('opIntIntDict', 'opIntIntDict', Ice::OperationMode::Normal, nil, [[::Test::T_IntIntDict, true, 2]], [[::Test::T_IntIntDict, true, 3]], [::Test::T_IntIntDict, true, 1], [])
        InitialPrx_mixin::OP_opStringIntDict = Ice::__defineOperation('opStringIntDict', 'opStringIntDict', Ice::OperationMode::Normal, nil, [[::Test::T_StringIntDict, true, 2]], [[::Test::T_StringIntDict, true, 3]], [::Test::T_StringIntDict, true, 1], [])
        InitialPrx_mixin::OP_opClassAndUnknownOptional = Ice::__defineOperation('opClassAndUnknownOptional', 'opClassAndUnknownOptional', Ice::OperationMode::Normal, nil, [[::Test::T_A, false, 0]], [], nil, [])
        InitialPrx_mixin::OP_opG = Ice::__defineOperation('opG', 'opG', Ice::OperationMode::Normal, nil, [[::Test::T_G, false, 0]], [], [::Test::T_G, false, 0], [])
        InitialPrx_mixin::OP_opVoid = Ice::__defineOperation('opVoid', 'opVoid', Ice::OperationMode::Normal, nil, [], [], nil, [])
        InitialPrx_mixin::OP_opMStruct1 = Ice::__defineOperation('opMStruct1', 'opMStruct1', Ice::OperationMode::Normal, nil, [], [], [::Test::T_SmallStruct, true, 1], [])
        InitialPrx_mixin::OP_opMStruct2 = Ice::__defineOperation('opMStruct2', 'opMStruct2', Ice::OperationMode::Normal, nil, [[::Test::T_SmallStruct, true, 2]], [[::Test::T_SmallStruct, true, 3]], [::Test::T_SmallStruct, true, 1], [])
        InitialPrx_mixin::OP_opMSeq1 = Ice::__defineOperation('opMSeq1', 'opMSeq1', Ice::OperationMode::Normal, nil, [], [], [::Test::T_StringSeq, true, 1], [])
        InitialPrx_mixin::OP_opMSeq2 = Ice::__defineOperation('opMSeq2', 'opMSeq2', Ice::OperationMode::Normal, nil, [[::Test::T_StringSeq, true, 2]], [[::Test::T_StringSeq, true, 3]], [::Test::T_StringSeq, true, 1], [])
        InitialPrx_mixin::OP_opMDict1 = Ice::__defineOperation('opMDict1', 'opMDict1', Ice::OperationMode::Normal, nil, [], [], [::Test::T_StringIntDict, true, 1], [])
        InitialPrx_mixin::OP_opMDict2 = Ice::__defineOperation('opMDict2', 'opMDict2', Ice::OperationMode::Normal, nil, [[::Test::T_StringIntDict, true, 2]], [[::Test::T_StringIntDict, true, 3]], [::Test::T_StringIntDict, true, 1], [])
        InitialPrx_mixin::OP_supportsJavaSerializable = Ice::__defineOperation('supportsJavaSerializable', 'supportsJavaSerializable', Ice::OperationMode::Normal, nil, [], [], [Ice::T_bool, false, 0], [])
    end
end
