...
module ::Test
    ...
    if not defined?(::Test::MultiOptional)
        class MultiOptional < Ice::Value
            ...
            attr_accessor :a, :b, :c, :d, :e, :f, :g, :h, :i, :j, :bs, :ss, :iid, :sid, :fs, :vs, :shs, :es, :fss, :vss, :mips, :ied, :ifsd, :ivsd, :imipd, :bos, :ser, :defaultedString
        end
        ...
        T_MultiOptional.defineClass(MultiOptional, -1, false, nil, [
            ...
            ['defaultedString', Ice::T_string, true, 31]
        ])
    end
