...
module ::Test
    ...
    if not defined?(::Test::MyClassPrx)
        ...
        MyClassPrx_mixin::OP_opOneway = Ice::__defineOperation('opOneway', 'opOneway', Ice::OperationMode::Normal, nil, [], [], nil, [])
        MyClassPrx_mixin::OP_opString = Ice::__defineOperation('opString', 'opString', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [[Ice::T_string, false, 0]], [Ice::T_string, false, 0], [])
        MyClassPrx_mixin::OP_opException = Ice::__defineOperation('opException', 'opException', Ice::OperationMode::Normal, nil, [], [], nil, [::Test::T_MyException])
