...
module ::Test
    ...
    if not defined?(::Test::TestIntf_Mixin)
        ...
        TestIntfPrx_mixin::OP_stdException = ::Ice::__defineOperation('stdException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
        TestIntfPrx_mixin::OP_cppException = ::Ice::__defineOperation('cppException', ::Ice::OperationMode::Normal, ::Ice::OperationMode::Normal, false, nil, [], [], nil, [])
