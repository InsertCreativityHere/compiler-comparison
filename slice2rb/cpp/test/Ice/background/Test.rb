...
module ::Test
    ...
    if not defined?(::Test::BackgroundControllerPrx)
        ...
        BackgroundControllerPrx_mixin::OP_initializeSocketOperation = ::Ice::__defineOperation('initializeSocketOperation', ::Ice::OperationMode::Normal, nil, [[::Ice::T_int, false, 0]], [], nil, [])
