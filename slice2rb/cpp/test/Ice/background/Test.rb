...
module ::Test
    ...
    if not defined?(::Test::BackgroundController_Mixin)
        ...
        BackgroundControllerPrx_mixin::OP_initializeSocketOperation = ::Ice::__defineOperation('initializeSocketOperation', ::Ice::OperationMode::Normal, false, nil, [[::Ice::T_int, false, 0]], [], nil, [])
