...
module ::Test
    ...
    if not defined?(::Test::TimeoutPrx)
        ...
        TimeoutPrx_mixin::OP_op = Ice::__defineOperation('op', 'op', Ice::OperationMode::Normal, nil, [], [], nil, [])
        TimeoutPrx_mixin::OP_sendData = Ice::__defineOperation('sendData', 'sendData', Ice::OperationMode::Normal, nil, [[::Test::T_ByteSeq, false, 0]], [], nil, [])
        TimeoutPrx_mixin::OP_sleep = Ice::__defineOperation('sleep', 'sleep', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], nil, [])
    end
    ...
    if not defined?(::Test::ControllerPrx)
        ...
        ControllerPrx_mixin::OP_holdAdapter = Ice::__defineOperation('holdAdapter', 'holdAdapter', Ice::OperationMode::Normal, nil, [[Ice::T_int, false, 0]], [], nil, [])
        ControllerPrx_mixin::OP_resumeAdapter = Ice::__defineOperation('resumeAdapter', 'resumeAdapter', Ice::OperationMode::Normal, nil, [], [], nil, [])
