...
module ::Test
    ...
    if not defined?(::Test::MyObjectPrx)
        ...
        MyObjectPrx_mixin::OP_widen = Ice::__defineOperation('widen', 'widen', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], [Ice::T_string, false, 0], [::Test::T_BadEncodingException])
        MyObjectPrx_mixin::OP_narrow = Ice::__defineOperation('narrow', 'narrow', Ice::OperationMode::Normal, nil, [[Ice::T_string, false, 0]], [], [Ice::T_string, false, 0], [])
        MyObjectPrx_mixin::OP_shutdown = Ice::__defineOperation('shutdown', 'shutdown', Ice::OperationMode::Normal, nil, [], [], nil, [])
    end
end
