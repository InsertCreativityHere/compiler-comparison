...
/// \cond INTERNAL
::std::shared_ptr<::Ice::ObjectPrx>
Test::CleanerPrx::_newInstance() const
{
    return ::IceInternal::createProxy<CleanerPrx>();
}
/// \endcond
...
/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(Cleaner* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< Cleaner>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
::Ice::AsyncResultPtr
IceProxy::Test::Cleaner::_iceI_begin_cleanup(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_Cleaner_cleanup_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_Cleaner_cleanup_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_Cleaner_cleanup_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::Cleaner::end_cleanup(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_Cleaner_cleanup_name);
}

/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::Cleaner::_newInstance() const
{
    return new Cleaner;
}
/// \endcond
...
const ::std::string&
IceProxy::Test::Cleaner::ice_staticId()
{
    return ::Test::Cleaner::ice_staticId();
}
...
/// \cond INTERNAL
::Ice::Object* Test::upCast(Cleaner* p) { return p; }
...
bool
Test::Cleaner::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_Test_Cleaner_ids, iceC_Test_Cleaner_ids + 2, s);
}
...
Test::Cleaner::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_Cleaner_ids[1];
#endif
}
...
namespace
{
const ::std::string iceC_Test_Cleaner_all[] =
{
    "cleanup",
    "ice_id",
    "ice_ids",
...
Test::Cleaner::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_Cleaner_all, iceC_Test_Cleaner_all + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_Test_Cleaner_all)
    {
        case 0:
        {
            return _iceD_cleanup(in, current);
...
/// \cond STREAM
void
Test::Cleaner::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    ::Ice::StreamWriter< Cleaner, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
Test::Cleaner::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< Cleaner, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
/// \cond INTERNAL
void
Test::_icePatchObjectPtr(CleanerPtr& handle, const ::Ice::ObjectPtr& v)
{
    handle = CleanerPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(Cleaner::ice_staticId(), v);
    }
}
/// \endcond
