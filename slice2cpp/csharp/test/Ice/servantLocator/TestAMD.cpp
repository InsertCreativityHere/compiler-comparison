...
Test::AMD_TestIntf_userException::~AMD_TestIntf_userException()
{
}

Test::AMD_TestIntf_csException::~AMD_TestIntf_csException()
{
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestIntf_userException::AMD_TestIntf_userException(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestIntf_userException::ice_response()
{
    writeEmptyParams();
    completed();
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestIntf_csException::AMD_TestIntf_csException(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestIntf_csException::ice_response()
{
    writeEmptyParams();
    completed();
}
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_csException(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_csException_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_csException_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_csException_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_csException(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_TestIntf_csException_name);
}
...
Test::TestIntf::_iceD_userException(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    this->userException_async(new IceAsync::Test::AMD_TestIntf_userException(inS), current);
    return false;
}
/// \endcond
...
Test::TestIntf::_iceD_csException(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    this->csException_async(new IceAsync::Test::AMD_TestIntf_csException(inS), current);
    return false;
}
/// \endcond
