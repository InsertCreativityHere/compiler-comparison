...
namespace Test
{
    ...
    public:
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> getPriorityAsync(std::function<void(std::string)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
...
namespace Test
{
    ...
    /// A shared pointer to a Priority.
