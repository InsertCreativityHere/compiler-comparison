...
::Ice::AsyncResultPtr
IceProxy::Test::I::_iceI_begin_opCSeq(const ::Test::CSeq& iceP_c1, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
::Test::CSeq
IceProxy::Test::I::end_opCSeq(::Test::CSeq& iceP_c2, const ::Ice::AsyncResultPtr& result)
{
...
void IceProxy::Test::I::_iceI_end_opCSeq(::Test::CSeq& iceP_c2, ::Test::CSeq& ret, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_I_opCSeq_name);
    if(!result->_waitForResponse())
    {
