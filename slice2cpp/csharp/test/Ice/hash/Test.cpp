...
namespace
{
    ...
    const IceInternal::ExceptionInit<::Test::InvalidPointException> iceC_Test_InvalidPointException_init;
    const IceInternal::ExceptionInit<::Test::InvalidLengthException> iceC_Test_InvalidLengthException_init;
    const IceInternal::ExceptionInit<::Test::OtherException> iceC_Test_OtherException_init;
