...
public:
    ...
    virtual NV opNV(const NV& i, NV& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNV(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NR opNR(const NR& i, NR& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNR(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDV opNDV(const NDV& i, NDV& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDV(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDR opNDR(const NDR& i, NDR& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDR(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDAIS opNDAIS(const NDAIS& i, NDAIS& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDAIS(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDGIS opNDGIS(const NDGIS& i, NDGIS& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDGIS(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDASS opNDASS(const NDASS& i, NDASS& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDASS(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual NDGSS opNDGSS(const NDGSS& i, NDGSS& o, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opNDGSS(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
template<typename S>
struct StreamWriter< ::Test::TEstNv, S>
{
    static void write(S* ostr, const ::Test::TEstNv& v)
    {
        ostr->write(v.d);
        ostr->write(v.s);
    }
