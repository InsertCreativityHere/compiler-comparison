...
namespace
{
    ...
    const IceInternal::ClassInit<::Test::IBase> iceC_Test_IBase_init;
    const IceInternal::ClassInit<::Test::IDerived> iceC_Test_IDerived_init;
    const IceInternal::ClassInit<::Test::IDerived2> iceC_Test_IDerived2_init;
    const IceInternal::ClassInit<::Test::I2> iceC_Test_I2_init;
...
const char*
Test::IBase::ice_staticId() noexcept
{
    return "::Test::IBase";
}

const char*
Test::IBase::ice_id() const noexcept
{
    return ice_staticId();
}

void
Test::IBase::ice_printFields(std::ostream& os) const
{
    Ice::print(os << "id = ", this->id);
}

Ice::ValuePtr
Test::IBase::_iceCloneImpl() const
{
    return CloneEnabler<IBase>::clone(*this);
}
...
const char*
Test::IDerived::ice_staticId() noexcept
{
    return "::Test::IDerived";
}

const char*
Test::IDerived::ice_id() const noexcept
{
    return ice_staticId();
}

void
Test::IDerived::ice_printFields(std::ostream& os) const
{
    IBase::ice_printFields(os);
    Ice::print(os << ", name = ", this->name);
}

Ice::ValuePtr
Test::IDerived::_iceCloneImpl() const
{
    return CloneEnabler<IDerived>::clone(*this);
}
...
const char*
Test::IDerived2::ice_staticId() noexcept
{
    return "::Test::IDerived2";
}

const char*
Test::IDerived2::ice_id() const noexcept
{
    return ice_staticId();
}

Ice::ValuePtr
Test::IDerived2::_iceCloneImpl() const
{
    return CloneEnabler<IDerived2>::clone(*this);
}
...
const char*
Test::I2::ice_staticId() noexcept
{
    return "::Test::I2";
}

const char*
Test::I2::ice_id() const noexcept
{
    return ice_staticId();
}

Ice::ValuePtr
Test::I2::_iceCloneImpl() const
{
    return CloneEnabler<I2>::clone(*this);
}
...
void
Test::SC1::ice_printFields(std::ostream& os) const
{
    Ice::print(os << "id = ", this->id);
}

std::ostream&
Test::operator<<(std::ostream& os, const ::Test::SC1& value)
{
    os << "Test::SC1{";
    value.ice_printFields(os);
    os << '}';
