...
/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(IBase* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< IBase>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::IBase::_newInstance() const
{
    return new IBase;
}
/// \endcond
...
const ::std::string&
IceProxy::Test::IBase::ice_staticId()
{
    return ::Test::IBase::ice_staticId();
}

/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(IDerived* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< IDerived>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::IDerived::_newInstance() const
{
    return new IDerived;
}
/// \endcond
...
const ::std::string&
IceProxy::Test::IDerived::ice_staticId()
{
    return ::Test::IDerived::ice_staticId();
}

/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(IDerived2* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< IDerived2>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::IDerived2::_newInstance() const
{
    return new IDerived2;
}
/// \endcond

const ::std::string&
IceProxy::Test::IDerived2::ice_staticId()
{
    return ::Test::IDerived2::ice_staticId();
}

/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(I2* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< I2>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::I2::_newInstance() const
{
    return new I2;
}
/// \endcond
...
const ::std::string&
IceProxy::Test::I2::ice_staticId()
{
    return ::Test::I2::ice_staticId();
}
...
Test::IBase::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_IBase_ids[1];
#endif
}

/// \cond STREAM
void
Test::IBase::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    ::Ice::StreamWriter< IBase, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
Test::IBase::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< IBase, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
::Ice::ValueFactoryPtr
Test::IBase::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test::IBase::ice_staticId());
}
...
Test::_icePatchObjectPtr(IBasePtr& handle, const ::Ice::ObjectPtr& v)
{
    ...
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(IBase::ice_staticId(), v);
    }
}
/// \endcond
...
Test::IDerived::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_IDerived_ids[2];
#endif
}

/// \cond STREAM
void
Test::IDerived::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, false);
    ::Ice::StreamWriter< IDerived, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
    IBase::_iceWriteImpl(ostr);
}

void
Test::IDerived::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< IDerived, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
    IBase::_iceReadImpl(istr);
}
/// \endcond
...
::Ice::ValueFactoryPtr
Test::IDerived::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test::IDerived::ice_staticId());
}
...
Test::_icePatchObjectPtr(IDerivedPtr& handle, const ::Ice::ObjectPtr& v)
{
    ...
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(IDerived::ice_staticId(), v);
    }
}
/// \endcond
...
Test::IDerived2::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_IDerived2_ids[2];
#endif
}

/// \cond STREAM
void
Test::IDerived2::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, false);
    ::Ice::StreamWriter< IDerived2, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
    IBase::_iceWriteImpl(ostr);
}

void
Test::IDerived2::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< IDerived2, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
    IBase::_iceReadImpl(istr);
}
/// \endcond
...
::Ice::ValueFactoryPtr
Test::IDerived2::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test::IDerived2::ice_staticId());
}
...
Test::_icePatchObjectPtr(IDerived2Ptr& handle, const ::Ice::ObjectPtr& v)
{
    ...
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(IDerived2::ice_staticId(), v);
    }
}
/// \endcond
...
Test::I2::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_I2_ids[1];
#endif
}

/// \cond STREAM
void
Test::I2::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    ::Ice::StreamWriter< I2, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
Test::I2::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< I2, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
Test::I2::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test::I2::ice_staticId());
}
...
Test::_icePatchObjectPtr(I2Ptr& handle, const ::Ice::ObjectPtr& v)
{
    ...
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(I2::ice_staticId(), v);
    }
}
/// \endcond
