...
namespace Test
{
    ...
    public:
        ...
        /// Creates a shallow polymorphic copy of this instance.
        /// @return The cloned value.
        [[nodiscard]] IBasePtr ice_clone() const { return std::static_pointer_cast<IBase>(_iceCloneImpl()); }
    ...
    public:
        ...
        /// Creates a shallow polymorphic copy of this instance.
        /// @return The cloned value.
        [[nodiscard]] IDerivedPtr ice_clone() const { return std::static_pointer_cast<IDerived>(_iceCloneImpl()); }
    ...
    public:using IBase::IBase;
        ...
        /// Creates a shallow polymorphic copy of this instance.
        /// @return The cloned value.
        [[nodiscard]] IDerived2Ptr ice_clone() const { return std::static_pointer_cast<IDerived2>(_iceCloneImpl()); }
    ...
    public:
        ...
        /// Creates a shallow polymorphic copy of this instance.
        /// @return The cloned value.
        [[nodiscard]] I2Ptr ice_clone() const { return std::static_pointer_cast<I2>(_iceCloneImpl()); }
    ...
    /// Outputs the description of a SC1 to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const SC1& value);
...
namespace Ice
{
    ...
    {
        /// Unmarshals a ::Test::SC1 from the input stream.
