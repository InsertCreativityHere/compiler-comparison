...
::std::function<void()>
Test::TestIntfPrx::opAsyncDispatchAsync(::std::function<void()> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    return ::IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opAsyncDispatch, context);
}
...
::std::function<void()>
Test::TestIntfPrx::opWithResultAsyncDispatchAsync(::std::function<void(::std::int32_t)> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    return ::IceInternal::makeLambdaOutgoing<::std::int32_t>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opWithResultAsyncDispatch, context);
}
...
::std::function<void()>
Test::TestIntfPrx::opWithUEAsyncDispatchAsync(::std::function<void()> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    return ::IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opWithUEAsyncDispatch, context);
}
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_op(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithPayload(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithResult(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ::std::int32_t ret = this->opWithResult(incoming.current());
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithUE(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->opWithUE(incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opBatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->opBatch(incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opBatchCount(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ::std::int32_t ret = this->opBatchCount(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_waitForBatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    auto istr = incoming.startReadParams();
    ...
    incoming.endReadParams();
    bool ret = this->waitForBatch(iceP_count, incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_close(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    auto istr = incoming.startReadParams();
    CloseMode iceP_mode;
    ...
    incoming.endReadParams();
    this->close(iceP_mode, incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_startDispatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ...
    try
    {
        this->startDispatchAsync([incomingPtr] { incomingPtr->response(); }, [incomingPtr](std::exception_ptr ex) { incomingPtr->completed(ex); }, incomingPtr->current());
    }
    catch (...)
    {
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_finishDispatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->finishDispatch(incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_supportsAMD(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    bool ret = this->supportsAMD(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_supportsFunctionalTests(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    bool ret = this->supportsFunctionalTests(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opAsyncDispatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    auto incomingPtr = ::std::make_shared<::IceInternal::Incoming>(::std::move(incoming));
    try
    {
        this->opAsyncDispatchAsync([incomingPtr] { incomingPtr->response(); }, [incomingPtr](std::exception_ptr ex) { incomingPtr->completed(ex); }, incomingPtr->current());
    }
    catch (...)
    {
        incomingPtr->failed(::std::current_exception());
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithResultAsyncDispatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    auto incomingPtr = ::std::make_shared<::IceInternal::Incoming>(::std::move(incoming));
    ...
    try
    {
        this->opWithResultAsyncDispatchAsync(responseCB, [incomingPtr](std::exception_ptr ex) { incomingPtr->completed(ex); }, incomingPtr->current());
    }
    catch (...)
    {
        incomingPtr->failed(::std::current_exception());
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithUEAsyncDispatch(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    auto incomingPtr = ::std::make_shared<::IceInternal::Incoming>(::std::move(incoming));
    try
    {
        this->opWithUEAsyncDispatchAsync([incomingPtr] { incomingPtr->response(); }, [incomingPtr](std::exception_ptr ex) { incomingPtr->completed(ex); }, incomingPtr->current());
    }
    catch (...)
    {
        incomingPtr->failed(::std::current_exception());
...
Test::TestIntf::_iceD_pingBiDir(::IceInternal::Incoming& incoming)
{
    ...
    incoming.endReadParams();
    this->pingBiDir(::std::move(iceP_reply), incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
Test::TestIntf::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        case 0:
        {
            return _iceD_close(incoming);
        }
        case 1:
        {
            return _iceD_finishDispatch(incoming);
        }
        case 2:
        {
            return _iceD_ice_id(incoming);
        ...
        case 7:
        {
            return _iceD_opAsyncDispatch(incoming);
        }
        case 8:
        {
            return _iceD_opBatch(incoming);
        }
        case 9:
        {
            return _iceD_opBatchCount(incoming);
        }
        case 10:
        {
        ...
        case 11:
        {
            return _iceD_opWithResult(incoming);
        }
        case 12:
        {
            return _iceD_opWithResultAsyncDispatch(incoming);
        }
        case 13:
        {
            return _iceD_opWithUE(incoming);
        }
        case 14:
        {
            return _iceD_opWithUEAsyncDispatch(incoming);
        }
        case 15:
        {
        ...
        case 18:
        {
            return _iceD_startDispatch(incoming);
        }
        case 19:
        {
            return _iceD_supportsAMD(incoming);
        }
        case 20:
        {
            return _iceD_supportsFunctionalTests(incoming);
        }
        case 21:
        {
            return _iceD_waitForBatch(incoming);
        }
        default:
        {
            assert(false);
...
/// \cond INTERNAL
bool
Test::TestIntfController::_iceD_holdAdapter(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
...
/// \cond INTERNAL
bool
Test::TestIntfController::_iceD_resumeAdapter(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
...
/// \cond INTERNAL
bool
Test::Outer::Inner::TestIntf::_iceD_op(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    auto istr = incoming.startReadParams();
    ::std::int32_t iceP_i;
    ...
    incoming.endReadParams();
    ::std::int32_t iceP_j;
    ::std::int32_t ret = this->op(iceP_i, iceP_j, incoming.current());
    auto ostr = incoming.startWriteParams();
