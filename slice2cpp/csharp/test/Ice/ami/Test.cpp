...
Test::AMD_TestIntf_opAsyncDispatch::~AMD_TestIntf_opAsyncDispatch()
{
}

Test::AMD_TestIntf_opWithResultAsyncDispatch::~AMD_TestIntf_opWithResultAsyncDispatch()
{
}

Test::AMD_TestIntf_opWithUEAsyncDispatch::~AMD_TestIntf_opWithUEAsyncDispatch()
{
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestIntf_opAsyncDispatch::AMD_TestIntf_opAsyncDispatch(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestIntf_opAsyncDispatch::ice_response()
{
    writeEmptyParams();
    completed();
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestIntf_opWithResultAsyncDispatch::AMD_TestIntf_opWithResultAsyncDispatch(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestIntf_opWithResultAsyncDispatch::ice_response(::Ice::Int ret)
{
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestIntf_opWithUEAsyncDispatch::AMD_TestIntf_opWithUEAsyncDispatch(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestIntf_opWithUEAsyncDispatch::ice_response()
{
    writeEmptyParams();
    completed();
}
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_opAsyncDispatch(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_opAsyncDispatch_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_opAsyncDispatch_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_opAsyncDispatch_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_opAsyncDispatch(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_TestIntf_opAsyncDispatch_name);
}

::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_opWithResultAsyncDispatch(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_TestIntf_opWithResultAsyncDispatch_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_opWithResultAsyncDispatch_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_opWithResultAsyncDispatch_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_opWithResultAsyncDispatch_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
::Ice::Int
IceProxy::Test::TestIntf::end_opWithResultAsyncDispatch(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_TestIntf_opWithResultAsyncDispatch_name);
    ::Ice::Int ret;
    if(!result->_waitForResponse())
    {
        try
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_opWithUEAsyncDispatch(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_TestIntf_opWithUEAsyncDispatch_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_opWithUEAsyncDispatch_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_opWithUEAsyncDispatch_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_opWithUEAsyncDispatch_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_opWithUEAsyncDispatch(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_TestIntf_opWithUEAsyncDispatch_name);
    if(!result->_waitForResponse())
    {
        try
        {
...
Test::TestIntf::_iceD_opAsyncDispatch(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    this->opAsyncDispatch_async(new IceAsync::Test::AMD_TestIntf_opAsyncDispatch(inS), current);
    return false;
}
/// \endcond
...
Test::TestIntf::_iceD_opWithResultAsyncDispatch(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    this->opWithResultAsyncDispatch_async(new IceAsync::Test::AMD_TestIntf_opWithResultAsyncDispatch(inS), current);
    return false;
}
/// \endcond
...
Test::TestIntf::_iceD_opWithUEAsyncDispatch(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    this->opWithUEAsyncDispatch_async(new IceAsync::Test::AMD_TestIntf_opWithUEAsyncDispatch(inS), current);
    return false;
}
/// \endcond
...
Test::TestIntf::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_TestIntf_all, iceC_Test_TestIntf_all + 22, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
