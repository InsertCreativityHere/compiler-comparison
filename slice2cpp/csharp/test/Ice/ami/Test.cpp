...
{
    static const ::std::string operationName = "opAsyncDispatch";
...
{
    static const ::std::string operationName = "opWithResultAsyncDispatch";
...
{
    static const ::std::string operationName = "opWithUEAsyncDispatch";
