...
public:
    ...
    ::std::future<void> opAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<int> opWithResultAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<void> opWithUEAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
