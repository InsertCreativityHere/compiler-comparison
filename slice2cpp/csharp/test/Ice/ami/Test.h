...
public:
    ...
    virtual void opWithResultAsyncDispatchAsync(::std::function<void(int returnValue)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void opAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_opAsyncDispatch, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto opAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &TestIntfPrx::_iceI_opAsyncDispatch, context);
    }
    ...
    opAsyncDispatchAsync(::std::function<void()> response,
                         ...
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opAsyncDispatch, context);
    }

    /// \cond INTERNAL
    void _iceI_opAsyncDispatch(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond

    int opWithResultAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<int>(true, this, &TestIntfPrx::_iceI_opWithResultAsyncDispatch, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto opWithResultAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<int>>().get_future())
    {
        return _makePromiseOutgoing<int, P>(false, this, &TestIntfPrx::_iceI_opWithResultAsyncDispatch, context);
    }

    ::std::function<void()>
    opWithResultAsyncDispatchAsync(::std::function<void(int)> response,
                                   ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                   ::std::function<void(bool)> sent = nullptr,
                                   const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<int>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opWithResultAsyncDispatch, context);
    }

    /// \cond INTERNAL
    void _iceI_opWithResultAsyncDispatch(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<int>>&, const ::Ice::Context&);
    /// \endcond

    void opWithUEAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_opWithUEAsyncDispatch, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto opWithUEAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &TestIntfPrx::_iceI_opWithUEAsyncDispatch, context);
    }
    ...
    opWithUEAsyncDispatchAsync(::std::function<void()> response,
                               ...
                               const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_opWithUEAsyncDispatch, context);
    }

    /// \cond INTERNAL
    void _iceI_opWithUEAsyncDispatch(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond
...
/**
 * AMD callback class for Test::TestIntf::opAsyncDispatch_async.
 * Call the ice_response method for a successful completion, or the ice_exception
 * method in the case of an error.
 */
class AMD_TestIntf_opAsyncDispatch : public virtual ::Ice::AMDCallback
{
public:

    virtual ~AMD_TestIntf_opAsyncDispatch();
...
typedef ::IceUtil::Handle< ::Test::AMD_TestIntf_opAsyncDispatch> AMD_TestIntf_opAsyncDispatchPtr;

/**
 * AMD callback class for Test::TestIntf::opWithResultAsyncDispatch_async.
 * Call the ice_response method for a successful completion, or the ice_exception
 * method in the case of an error.
 */
class AMD_TestIntf_opWithResultAsyncDispatch : public virtual ::Ice::AMDCallback
{
public:

    virtual ~AMD_TestIntf_opWithResultAsyncDispatch();
...
typedef ::IceUtil::Handle< ::Test::AMD_TestIntf_opWithResultAsyncDispatch> AMD_TestIntf_opWithResultAsyncDispatchPtr;

/**
 * AMD callback class for Test::TestIntf::opWithUEAsyncDispatch_async.
 * Call the ice_response method for a successful completion, or the ice_exception
 * method in the case of an error.
 */
class AMD_TestIntf_opWithUEAsyncDispatch : public virtual ::Ice::AMDCallback
{
public:

    virtual ~AMD_TestIntf_opWithUEAsyncDispatch();
...
typedef ::IceUtil::Handle< ::Test::AMD_TestIntf_opWithUEAsyncDispatch> AMD_TestIntf_opWithUEAsyncDispatchPtr;
...
class AMD_TestIntf_opAsyncDispatch : public ::Test::AMD_TestIntf_opAsyncDispatch, public ::IceInternal::IncomingAsync
{
public:

    AMD_TestIntf_opAsyncDispatch(::IceInternal::Incoming&);
...
class AMD_TestIntf_opWithResultAsyncDispatch : public ::Test::AMD_TestIntf_opWithResultAsyncDispatch, public ::IceInternal::IncomingAsync
{
public:

    AMD_TestIntf_opWithResultAsyncDispatch(::IceInternal::Incoming&);
...
class AMD_TestIntf_opWithUEAsyncDispatch : public ::Test::AMD_TestIntf_opWithUEAsyncDispatch, public ::IceInternal::IncomingAsync
{
public:

    AMD_TestIntf_opWithUEAsyncDispatch(::IceInternal::Incoming&);
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::TestIntf::begin_opAsyncDispatch.
 * Create a wrapper instance by calling ::Test::newCallback_TestIntf_opAsyncDispatch.
 */
class Callback_TestIntf_opAsyncDispatch_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_TestIntf_opAsyncDispatch_Base> Callback_TestIntf_opAsyncDispatchPtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::TestIntf::begin_opWithResultAsyncDispatch.
 * Create a wrapper instance by calling ::Test::newCallback_TestIntf_opWithResultAsyncDispatch.
 */
class Callback_TestIntf_opWithResultAsyncDispatch_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_TestIntf_opWithResultAsyncDispatch_Base> Callback_TestIntf_opWithResultAsyncDispatchPtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::TestIntf::begin_opWithUEAsyncDispatch.
 * Create a wrapper instance by calling ::Test::newCallback_TestIntf_opWithUEAsyncDispatch.
 */
class Callback_TestIntf_opWithUEAsyncDispatch_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_TestIntf_opWithUEAsyncDispatch_Base> Callback_TestIntf_opWithUEAsyncDispatchPtr;
...
public:
    ...
    void opAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_opAsyncDispatch(_iceI_begin_opAsyncDispatch(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opAsyncDispatch(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opAsyncDispatch(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opAsyncDispatch(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opAsyncDispatch(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opAsyncDispatch(const ::Test::Callback_TestIntf_opAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opAsyncDispatch(const ::Ice::Context& context, const ::Test::Callback_TestIntf_opAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opAsyncDispatch(context, cb, cookie);
    }

    void end_opAsyncDispatch(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_opAsyncDispatch(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    ::Ice::Int opWithResultAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_opWithResultAsyncDispatch(_iceI_begin_opWithResultAsyncDispatch(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opWithResultAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opWithResultAsyncDispatch(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opWithResultAsyncDispatch(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithResultAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithResultAsyncDispatch(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithResultAsyncDispatch(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithResultAsyncDispatch(const ::Test::Callback_TestIntf_opWithResultAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithResultAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithResultAsyncDispatch(const ::Ice::Context& context, const ::Test::Callback_TestIntf_opWithResultAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithResultAsyncDispatch(context, cb, cookie);
    }

    ::Ice::Int end_opWithResultAsyncDispatch(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_opWithResultAsyncDispatch(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    void opWithUEAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_opWithUEAsyncDispatch(_iceI_begin_opWithUEAsyncDispatch(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opWithUEAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opWithUEAsyncDispatch(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opWithUEAsyncDispatch(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithUEAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithUEAsyncDispatch(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithUEAsyncDispatch(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithUEAsyncDispatch(const ::Test::Callback_TestIntf_opWithUEAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithUEAsyncDispatch(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opWithUEAsyncDispatch(const ::Ice::Context& context, const ::Test::Callback_TestIntf_opWithUEAsyncDispatchPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opWithUEAsyncDispatch(context, cb, cookie);
    }

    void end_opWithUEAsyncDispatch(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_opWithUEAsyncDispatch(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual void opAsyncDispatch_async(const ::Test::AMD_TestIntf_opAsyncDispatchPtr& cb, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opAsyncDispatch(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void opWithResultAsyncDispatch_async(const ::Test::AMD_TestIntf_opWithResultAsyncDispatchPtr& cb, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opWithResultAsyncDispatch(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void opWithUEAsyncDispatch_async(const ::Test::AMD_TestIntf_opWithUEAsyncDispatchPtr& cb, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opWithUEAsyncDispatch(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_TestIntf_opAsyncDispatch : public Callback_TestIntf_opAsyncDispatch_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_TestIntf_opAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opAsyncDispatch.
 */
template<class T> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opAsyncDispatch<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opAsyncDispatch<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_TestIntf_opAsyncDispatch : public Callback_TestIntf_opAsyncDispatch_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_TestIntf_opAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opAsyncDispatch.
 */
template<class T, typename CT> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opAsyncDispatch<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opAsyncDispatchPtr
newCallback_TestIntf_opAsyncDispatch(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opAsyncDispatch<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_TestIntf_opWithResultAsyncDispatch : public Callback_TestIntf_opWithResultAsyncDispatch_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_TestIntf_opWithResultAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            ret = proxy->end_opWithResultAsyncDispatch(result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opWithResultAsyncDispatch.
 */
template<class T> Callback_TestIntf_opWithResultAsyncDispatchPtr
newCallback_TestIntf_opWithResultAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithResultAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opWithResultAsyncDispatchPtr
newCallback_TestIntf_opWithResultAsyncDispatch(T* instance, void (T::*cb)(::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithResultAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_TestIntf_opWithResultAsyncDispatch : public Callback_TestIntf_opWithResultAsyncDispatch_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_TestIntf_opWithResultAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opWithResultAsyncDispatch.
 */
template<class T, typename CT> Callback_TestIntf_opWithResultAsyncDispatchPtr
newCallback_TestIntf_opWithResultAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithResultAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opWithResultAsyncDispatchPtr
newCallback_TestIntf_opWithResultAsyncDispatch(T* instance, void (T::*cb)(::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithResultAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_TestIntf_opWithUEAsyncDispatch : public Callback_TestIntf_opWithUEAsyncDispatch_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_TestIntf_opWithUEAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            proxy->end_opWithUEAsyncDispatch(result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opWithUEAsyncDispatch.
 */
template<class T> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithUEAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithUEAsyncDispatch<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithUEAsyncDispatch<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_opWithUEAsyncDispatch<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_TestIntf_opWithUEAsyncDispatch : public Callback_TestIntf_opWithUEAsyncDispatch_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_TestIntf_opWithUEAsyncDispatch(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_opWithUEAsyncDispatch.
 */
template<class T, typename CT> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithUEAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithUEAsyncDispatch<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithUEAsyncDispatch<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_opWithUEAsyncDispatchPtr
newCallback_TestIntf_opWithUEAsyncDispatch(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_opWithUEAsyncDispatch<T, CT>(instance, 0, excb, sentcb);
}
