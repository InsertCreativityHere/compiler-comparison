...
public:
    ...
    int opWithResultAsyncDispatch(const ::Ice::Context& context = ::Ice::noExplicitContext) const;

    ::std::future<int> opWithResultAsyncDispatchAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)const;
    ...
    /// \cond INTERNAL
    void _iceI_opWithResultAsyncDispatch(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<int>>&, const ::Ice::Context&) const;
    /// \endcond
