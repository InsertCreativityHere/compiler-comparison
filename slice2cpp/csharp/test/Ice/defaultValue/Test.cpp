...
#else
Test::ExceptionProperty::~ExceptionProperty() throw()
{
}
#endif
...
/// \cond INTERNAL
::Ice::Object* Test::upCast(ClassProperty* p) { return p; }

/// \endcond
::Ice::ObjectPtr
Test::ClassProperty::ice_clone() const
{
    ::Ice::Object* p = new ClassProperty(*this);
    return p;
}

namespace
{
const ::std::string iceC_Test_ClassProperty_ids[2] =
{
    "::Ice::Object",
    "::Test::ClassProperty"
};
...
bool
Test::ClassProperty::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_Test_ClassProperty_ids, iceC_Test_ClassProperty_ids + 2, s);
}

::std::vector< ::std::string>
Test::ClassProperty::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&iceC_Test_ClassProperty_ids[0], &iceC_Test_ClassProperty_ids[2]);
}

const ::std::string&
Test::ClassProperty::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}
...
Test::ClassProperty::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_ClassProperty_ids[1];
#endif
}
...
/// \cond INTERNAL
void
Test::_icePatchObjectPtr(ClassPropertyPtr& handle, const ::Ice::ObjectPtr& v)
{
