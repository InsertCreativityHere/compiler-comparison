...
const ::std::string iceC_Test_BaseInterface10_ids[3] =
{
    "::Ice::Object",
...
{
    return ::std::binary_search(iceC_Test_BaseInterface10_ids, iceC_Test_BaseInterface10_ids + 3, s);
}

::std::vector<::std::string>
Test::BaseInterface10::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector<::std::string>(&iceC_Test_BaseInterface10_ids[0], &iceC_Test_BaseInterface10_ids[3]);
}
