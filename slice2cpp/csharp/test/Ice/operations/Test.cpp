...
{
    ostr->startSlice("::Test::SomeException", -1, true);
    ::Ice::StreamWriter< SomeException, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< SomeException, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
