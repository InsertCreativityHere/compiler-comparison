...
{
    return _makePromiseOutgoing<StringS>(true, this, &MyClassPrx::_iceI_opWStringLiterals, context).get();
}

::std::future<::Test::StringS>
Test::MyClassPrx::opWStringLiteralsAsync(const ::Ice::Context& context)
{
    return _makePromiseOutgoing<StringS, ::std::promise>(false, this, &MyClassPrx::_iceI_opWStringLiterals, context);
}

::std::function<void()>
Test::MyClassPrx::opWStringLiteralsAsync(::std::function<void (::Test::StringS)> response,
                                         ::std::function<void(::std::exception_ptr)> ex,
                                         ::std::function<void(bool)> sent,
                                         const ::Ice::Context& context)
{
    return _makeLambdaOutgoing<StringS>(std::move(response), std::move(ex), std::move(sent), this, &Test::MyClassPrx::_iceI_opWStringLiterals, context);
}

/// \cond INTERNAL
void
Test::MyClassPrx::_iceI_opWStringLiterals(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<StringS>>& outAsync, const ::Ice::Context& context)
{
