...
namespace
{
    const IceInternal::ExceptionInit<::Test::SomeException> iceC_Test_SomeException_init;
...
{
    return IceInternal::makePromiseOutgoing<StringS>(true, this, &MyClassPrx::_iceI_opWStringLiterals, context).get();
}

std::future<::Test::StringS>
Test::MyClassPrx::opWStringLiteralsAsync(const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<StringS>(false, this, &MyClassPrx::_iceI_opWStringLiterals, context);
}

std::function<void()>
Test::MyClassPrx::opWStringLiteralsAsync(std::function<void(::Test::StringS)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<StringS>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyClassPrx::_iceI_opWStringLiterals, context);
}

void
Test::MyClassPrx::_iceI_opWStringLiterals(const std::shared_ptr<IceInternal::OutgoingAsyncT<StringS>>& outAsync, const Ice::Context& context) const
{
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
    request.inputStream().skipEmptyEncapsulation();
    const StringS ret = this->opWStringLiterals(request.current());
    sendResponse(Ice::makeOutgoingResponse([&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(ret);
        },
