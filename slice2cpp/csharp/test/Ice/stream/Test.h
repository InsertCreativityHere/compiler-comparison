...
using MyClassProxyList = ::std::vector<::std::shared_ptr<::Ice::ObjectPrx>>;
...
using MyClassProxyStack = ::std::vector<::std::shared_ptr<::Ice::ObjectPrx>>;
...
using MyInterfaceStack = ::std::vector<::std::shared_ptr<::Ice::Value>>;
...
typedef ::std::vector<MyClassPrx> MyClassProxyList;
...
typedef ::std::vector<MyClassPrx> MyClassProxyStack;

typedef ::std::vector<MyInterfacePrx> MyInterfaceProxyStack;

typedef ::std::vector< ::Ice::ObjectPtr> ObjectStack;

typedef ::std::vector<MyClassPtr> MyClassStack;

typedef ::std::vector<MyInterfacePtr> MyInterfaceStack;
