...
namespace
{
    const IceInternal::ClassInit<::NoNamespace::C1> iceC_NoNamespace_C1_init;
    const IceInternal::ClassInit<::NoNamespace::C2> iceC_NoNamespace_C2_init;
    const IceInternal::ExceptionInit<::NoNamespace::E1> iceC_NoNamespace_E1_init;
    const IceInternal::ExceptionInit<::NoNamespace::E2> iceC_NoNamespace_E2_init;
    const IceInternal::ExceptionInit<::NoNamespace::notify> iceC_NoNamespace_notify_init;
}
...
void
NoNamespace::C1::ice_printFields(std::ostream& os) const
{
...
void
NoNamespace::C2::ice_printFields(std::ostream& os) const
{
