...
namespace
{
    const IceInternal::ClassInit<::WithNamespace::C1> iceC_WithNamespace_C1_init;
    const IceInternal::ClassInit<::WithNamespace::C2> iceC_WithNamespace_C2_init;
    const IceInternal::ExceptionInit<::WithNamespace::E1> iceC_WithNamespace_E1_init;
    const IceInternal::ExceptionInit<::WithNamespace::E2> iceC_WithNamespace_E2_init;
}
