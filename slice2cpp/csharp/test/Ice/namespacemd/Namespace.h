...
typedef ::IceInternal::ProxyHandle< ::IceProxy::WithNamespace::C1> C1Prx;
...
typedef ::IceInternal::ProxyHandle< ::IceProxy::WithNamespace::C2> C2Prx;
...
class C2 : public virtual ::Ice::Proxy<C2, ::IceProxy::WithNamespace::C1>
{
public:
