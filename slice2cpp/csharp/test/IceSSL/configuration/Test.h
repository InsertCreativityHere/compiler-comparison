...
namespace Test
{
    ...
    public:
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> checkCipherAsync(std::string_view cipher, std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
    ...
    public:
        ...
        /// Copy constructor. Constructs with a copy of the contents of @p other.
        /// @param other The proxy to copy from.
        PingablePrx(const PingablePrx& other) noexcept : Ice::ObjectPrx{other} {} // NOLINT(modernize-use-equals-default)
...
namespace Test
{
    ...
    /// A shared pointer to a Pingable.
