...
public:
    ...
    ::std::future<::std::optional<_cpp_break>> forAsync(::std::optional<as> _cpp_goto, const ::std::optional<explicitPrx>& _cpp_if, const ::std::optional<_cpp_while>& internal, ::std::optional<::std::string_view> _cpp_namespace, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    ::std::future<::std::optional<_cpp_break>> continueAsync(::std::optional<as> _cpp_goto, const ::std::optional<explicitPrx>& _cpp_if, const ::std::optional<_cpp_while>& internal, ::std::optional<::std::string_view> _cpp_namespace, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
