...
public:
     ...
     */
    Cls(const ::std::optional<::Clash::IntfPrx>& s, ::std::string_view context, ::std::int32_t current, ::std::int16_t response, ::std::int32_t typeId, ::std::int16_t del, ::std::optional<::std::int16_t> cookie, ::std::string_view ex, ::std::int32_t result, ::std::string_view istr, ::std::string_view ostr, ::std::string_view inS, ::std::string_view in, ::std::string_view proxy, ::std::int32_t obj, ::std::int32_t getCookie, ::std::string_view clone) :
        s(s),
        context(context),
        current(current),
        response(response),
