...
std::function<void()>
Clash::IntfPrx::objAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Clash::IntfPrx::_iceI_obj, context);
}

void
Clash::IntfPrx::_iceI_obj(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>& outAsync, const Ice::Context& context) const
{
    static constexpr std::string_view operationName = "obj";
...
void
Clash::IntfPrx::op(std::string_view iceP_context, std::string_view iceP_current, std::string_view iceP_response, std::string_view iceP_ex, std::string_view iceP_sent, std::string_view iceP_cookie, std::string_view iceP_sync, std::string_view iceP_result, std::string_view iceP_istr, std::string_view iceP_ostr, std::optional<std::string_view> iceP_proxy, std::optional<std::int32_t> iceP_obj, const Ice::Context& context) const
{
...
std::function<void()>
Clash::IntfPrx::opAsync(std::string_view iceP_context, std::string_view iceP_current, std::string_view iceP_response, std::string_view iceP_ex, std::string_view iceP_sent, std::string_view iceP_cookie, std::string_view iceP_sync, std::string_view iceP_result, std::string_view iceP_istr, std::string_view iceP_ostr, std::optional<std::string_view> iceP_proxy, std::optional<std::int32_t> iceP_obj, std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Clash::IntfPrx::_iceI_op, iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_proxy, iceP_obj, context);
}
...
{
    auto result = IceInternal::makePromiseOutgoing<std::tuple<std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::optional<std::string>, std::optional<std::int32_t>>>(true, this, &IntfPrx::_iceI_opOut, context).get();
...
Clash::IntfPrx::opOutAsync(std::function<void(std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::optional<std::string>, std::optional<std::int32_t>)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    ...
    return IceInternal::makeLambdaOutgoing<std::tuple<std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::optional<std::string>, std::optional<std::int32_t>>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Clash::IntfPrx::_iceI_opOut, context);
}
...
Clash::Cls::_iceWriteImpl(Ice::OutputStream* ostr) const
{
    ...
    ostr->writeAll(this->s, this->context, this->current, this->response, this->typeId, this->del, this->ex, this->result, this->istr, this->ostr, this->inS, this->in, this->proxy, this->obj, this->getCookie, this->clone);
...
{
    ostr->startSlice(ice_staticId(), -1, true);
    ostr->writeAll(this->istr, this->ostr, this->cause);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    istr->readAll(this->istr, this->ostr, this->cause);
    istr->endSlice();
}
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    this->op(std::move(iceP_context), std::move(iceP_current), std::move(iceP_response), std::move(iceP_ex), std::move(iceP_sent), std::move(iceP_cookie), std::move(iceP_sync), std::move(iceP_result), std::move(iceP_istr), std::move(iceP_ostr), std::move(iceP_proxy), iceP_obj, request.current());
    sendResponse(Ice::makeEmptyOutgoingResponse(request.current()));
}
/// \endcond
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    std::optional<std::string> iceP_proxy;
    std::optional<std::int32_t> iceP_obj;
    this->opOut(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_proxy, iceP_obj, request.current());
...
Clash::Intf::dispatch(Ice::IncomingRequest& request, std::function<void(Ice::OutgoingResponse)> sendResponse)
{
    ...
    switch (r.first - allOperations.begin())
    {
        ...
        case 10:
        {
            _iceD_obj(request, std::move(sendResponse));
            break;
        }
        case 11:
        {
