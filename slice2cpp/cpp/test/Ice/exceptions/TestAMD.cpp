...
void
Test::ThrowerPrx::throwModA(int iceP_a, int iceP_a2, const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &ThrowerPrx::_iceI_throwModA, iceP_a, iceP_a2, context).get();
}

::std::future<void>
Test::ThrowerPrx::throwModAAsync(int iceP_a, int iceP_a2, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<void, ::std::promise>(false, this, &ThrowerPrx::_iceI_throwModA, iceP_a, iceP_a2, context);
}

::std::function<void()>
Test::ThrowerPrx::throwModAAsync(int iceP_a, int iceP_a2,
                                 ::std::function<void ()> response,
                                 ::std::function<void(::std::exception_ptr)> ex,
                                 ::std::function<void(bool)> sent,
                                 const ::Ice::Context& context)
{
    return _makeLambdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::ThrowerPrx::_iceI_throwModA, iceP_a, iceP_a2, context);
}
...
void
Test::ThrowerPrx::throwE(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &ThrowerPrx::_iceI_throwE, context).get();
}

::std::future<void>
Test::ThrowerPrx::throwEAsync(const ::Ice::Context& context)
{
    return _makePromiseOutgoing<void, ::std::promise>(false, this, &ThrowerPrx::_iceI_throwE, context);
}
...
void
Test::ThrowerPrx::throwF(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &ThrowerPrx::_iceI_throwF, context).get();
}

::std::future<void>
Test::ThrowerPrx::throwFAsync(const ::Ice::Context& context)
{
    return _makePromiseOutgoing<void, ::std::promise>(false, this, &ThrowerPrx::_iceI_throwF, context);
}
