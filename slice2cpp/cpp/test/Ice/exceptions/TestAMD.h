...
public:
    ...
    ::std::future<void> throwEAsync(const ::Ice::Context& context = ::Ice::noExplicitContext) const;

    ::std::function<void()>
    throwEAsync(::std::function<void()> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    ::std::future<void> throwFAsync(const ::Ice::Context& context = ::Ice::noExplicitContext) const;
