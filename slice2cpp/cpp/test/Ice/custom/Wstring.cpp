...
namespace
{
    const IceInternal::ExceptionInit<::Test1::WstringException> iceC_Test1_WstringException_init;
    const IceInternal::ExceptionInit<::Test2::WstringException> iceC_Test2_WstringException_init;
}
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    istr->endEncapsulation();
    this->throwExcept(std::move(iceP_reason), request.current());
