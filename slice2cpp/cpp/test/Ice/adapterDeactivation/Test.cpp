...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_transient(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->transient(incoming.current());
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_deactivate(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
...
Test::TestIntf::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 5:
        {
            return _iceD_transient(incoming);
        }
        default:
        {
            assert(false);
