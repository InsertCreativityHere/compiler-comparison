...
public:
    ...
    ::std::future<int> opWithResultAndUEAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<::std::tuple<int, int, int, int, int, int, int, int, int, int, int>> opWithArgsAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    /// \cond INTERNAL
    void _iceI_opWithArgs(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, int, int, int, int, int, int, int, int, int, int>>>&, const ::Ice::Context&);
    /// \endcond
