...
{
    auto responseCb = [response = ::std::move(response)](::std::tuple<::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t>&& result)
    {
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithResultAndUE(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ::std::int32_t ret = this->opWithResultAndUE(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opWithArgs(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ...
    this->opWithArgs(iceP_one, iceP_two, iceP_three, iceP_four, iceP_five, iceP_six, iceP_seven, iceP_eight, iceP_nine, iceP_ten, iceP_eleven, incoming.current());
    auto ostr = incoming.startWriteParams();
...
Test::TestIntf::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 9:
        {
            return _iceD_opWithArgs(incoming);
        }
        case 10:
        {
        ...
        case 12:
        {
            return _iceD_opWithResultAndUE(incoming);
        }
        case 13:
        {
