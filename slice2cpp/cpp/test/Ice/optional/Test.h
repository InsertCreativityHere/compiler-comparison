...
namespace Test
{
    ...
    /// A shared pointer to an OneOptional.
    ...
    /// A shared pointer to a MultiOptional.
...
namespace Test
{
    ...
    public:
        ...
        Ice::ValuePtr pingPong(const Ice::ValuePtr& o, const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> pingPongAsync(const Ice::ValuePtr& o, std::function<void(Ice::ValuePtr)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOptionalExceptionAsync(std::optional<std::int32_t> a, std::optional<std::string_view> b, std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opDerivedExceptionAsync(std::optional<std::int32_t> a, std::optional<std::string_view> b, std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opRequiredExceptionAsync(std::optional<std::int32_t> a, std::optional<std::string_view> b, std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opByteAsync(std::optional<std::uint8_t> p1, std::function<void(std::optional<std::uint8_t>, std::optional<std::uint8_t>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opBoolAsync(std::optional<bool> p1, std::function<void(std::optional<bool>, std::optional<bool>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opShortAsync(std::optional<std::int16_t> p1, std::function<void(std::optional<std::int16_t>, std::optional<std::int16_t>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opIntAsync(std::optional<std::int32_t> p1, std::function<void(std::optional<std::int32_t>, std::optional<std::int32_t>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opLongAsync(std::optional<std::int64_t> p1, std::function<void(std::optional<std::int64_t>, std::optional<std::int64_t>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opFloatAsync(std::optional<float> p1, std::function<void(std::optional<float>, std::optional<float>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opDoubleAsync(std::optional<double> p1, std::function<void(std::optional<double>, std::optional<double>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opStringAsync(std::optional<std::string_view> p1, std::function<void(std::optional<std::string>, std::optional<std::string>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMyEnumAsync(std::optional<MyEnum> p1, std::function<void(std::optional<::Test::MyEnum>, std::optional<::Test::MyEnum>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opSmallStructAsync(const std::optional<SmallStruct>& p1, std::function<void(std::optional<::Test::SmallStruct>, std::optional<::Test::SmallStruct>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opFixedStructAsync(const std::optional<FixedStruct>& p1, std::function<void(std::optional<::Test::FixedStruct>, std::optional<::Test::FixedStruct>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opVarStructAsync(const std::optional<VarStruct>& p1, std::function<void(std::optional<::Test::VarStruct>, std::optional<::Test::VarStruct>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMyInterfaceProxyAsync(const std::optional<MyInterfacePrx>& p1, std::function<void(std::optional<::Test::MyInterfacePrx>, std::optional<::Test::MyInterfacePrx>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOneOptionalAsync(const OneOptionalPtr& p1, std::function<void(::Test::OneOptionalPtr, ::Test::OneOptionalPtr)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        std::optional<ByteSeq> opByteSeq(std::optional<std::pair<const std::byte*, const std::byte*>> p1, std::optional<ByteSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<ByteSeq>, std::optional<ByteSeq>>> opByteSeqAsync(std::optional<std::pair<const std::byte*, const std::byte*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opByteSeqAsync(std::optional<std::pair<const std::byte*, const std::byte*>> p1, std::function<void(std::optional<std::pair<const std::byte*, const std::byte*>>, std::optional<std::pair<const std::byte*, const std::byte*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opByteSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<ByteSeq>, std::optional<ByteSeq>>>>&, std::optional<std::pair<const std::byte*, const std::byte*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opByteSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const std::byte*, const std::byte*>>, std::optional<std::pair<const std::byte*, const std::byte*>>>>>&, std::optional<std::pair<const std::byte*, const std::byte*>>, const Ice::Context&) const;

        std::optional<BoolSeq> opBoolSeq(std::optional<std::pair<const bool*, const bool*>> p1, std::optional<BoolSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<BoolSeq>, std::optional<BoolSeq>>> opBoolSeqAsync(std::optional<std::pair<const bool*, const bool*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opBoolSeqAsync(std::optional<std::pair<const bool*, const bool*>> p1, std::function<void(std::optional<std::pair<const bool*, const bool*>>, std::optional<std::pair<const bool*, const bool*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opBoolSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<BoolSeq>, std::optional<BoolSeq>>>>&, std::optional<std::pair<const bool*, const bool*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opBoolSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const bool*, const bool*>>, std::optional<std::pair<const bool*, const bool*>>>>>&, std::optional<std::pair<const bool*, const bool*>>, const Ice::Context&) const;

        std::optional<ShortSeq> opShortSeq(std::optional<std::pair<const std::int16_t*, const std::int16_t*>> p1, std::optional<ShortSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<ShortSeq>, std::optional<ShortSeq>>> opShortSeqAsync(std::optional<std::pair<const std::int16_t*, const std::int16_t*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opShortSeqAsync(std::optional<std::pair<const std::int16_t*, const std::int16_t*>> p1, std::function<void(std::optional<std::pair<const std::int16_t*, const std::int16_t*>>, std::optional<std::pair<const std::int16_t*, const std::int16_t*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opShortSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<ShortSeq>, std::optional<ShortSeq>>>>&, std::optional<std::pair<const std::int16_t*, const std::int16_t*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opShortSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const std::int16_t*, const std::int16_t*>>, std::optional<std::pair<const std::int16_t*, const std::int16_t*>>>>>&, std::optional<std::pair<const std::int16_t*, const std::int16_t*>>, const Ice::Context&) const;

        std::optional<IntSeq> opIntSeq(std::optional<std::pair<const std::int32_t*, const std::int32_t*>> p1, std::optional<IntSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<IntSeq>, std::optional<IntSeq>>> opIntSeqAsync(std::optional<std::pair<const std::int32_t*, const std::int32_t*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opIntSeqAsync(std::optional<std::pair<const std::int32_t*, const std::int32_t*>> p1, std::function<void(std::optional<std::pair<const std::int32_t*, const std::int32_t*>>, std::optional<std::pair<const std::int32_t*, const std::int32_t*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opIntSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<IntSeq>, std::optional<IntSeq>>>>&, std::optional<std::pair<const std::int32_t*, const std::int32_t*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opIntSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const std::int32_t*, const std::int32_t*>>, std::optional<std::pair<const std::int32_t*, const std::int32_t*>>>>>&, std::optional<std::pair<const std::int32_t*, const std::int32_t*>>, const Ice::Context&) const;

        std::optional<LongSeq> opLongSeq(std::optional<std::pair<const std::int64_t*, const std::int64_t*>> p1, std::optional<LongSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<LongSeq>, std::optional<LongSeq>>> opLongSeqAsync(std::optional<std::pair<const std::int64_t*, const std::int64_t*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opLongSeqAsync(std::optional<std::pair<const std::int64_t*, const std::int64_t*>> p1, std::function<void(std::optional<std::pair<const std::int64_t*, const std::int64_t*>>, std::optional<std::pair<const std::int64_t*, const std::int64_t*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opLongSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<LongSeq>, std::optional<LongSeq>>>>&, std::optional<std::pair<const std::int64_t*, const std::int64_t*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opLongSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const std::int64_t*, const std::int64_t*>>, std::optional<std::pair<const std::int64_t*, const std::int64_t*>>>>>&, std::optional<std::pair<const std::int64_t*, const std::int64_t*>>, const Ice::Context&) const;

        std::optional<FloatSeq> opFloatSeq(std::optional<std::pair<const float*, const float*>> p1, std::optional<FloatSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<FloatSeq>, std::optional<FloatSeq>>> opFloatSeqAsync(std::optional<std::pair<const float*, const float*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opFloatSeqAsync(std::optional<std::pair<const float*, const float*>> p1, std::function<void(std::optional<std::pair<const float*, const float*>>, std::optional<std::pair<const float*, const float*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opFloatSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<FloatSeq>, std::optional<FloatSeq>>>>&, std::optional<std::pair<const float*, const float*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opFloatSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const float*, const float*>>, std::optional<std::pair<const float*, const float*>>>>>&, std::optional<std::pair<const float*, const float*>>, const Ice::Context&) const;

        std::optional<DoubleSeq> opDoubleSeq(std::optional<std::pair<const double*, const double*>> p1, std::optional<DoubleSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<DoubleSeq>, std::optional<DoubleSeq>>> opDoubleSeqAsync(std::optional<std::pair<const double*, const double*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opDoubleSeqAsync(std::optional<std::pair<const double*, const double*>> p1, std::function<void(std::optional<std::pair<const double*, const double*>>, std::optional<std::pair<const double*, const double*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opDoubleSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<DoubleSeq>, std::optional<DoubleSeq>>>>&, std::optional<std::pair<const double*, const double*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opDoubleSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const double*, const double*>>, std::optional<std::pair<const double*, const double*>>>>>&, std::optional<std::pair<const double*, const double*>>, const Ice::Context&) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opStringSeqAsync(const std::optional<StringSeq>& p1, std::function<void(std::optional<::Test::StringSeq>, std::optional<::Test::StringSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        std::optional<SmallStructSeq> opSmallStructSeq(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, std::optional<SmallStructSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<SmallStructSeq>, std::optional<SmallStructSeq>>> opSmallStructSeqAsync(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opSmallStructSeqAsync(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, std::function<void(std::optional<std::pair<const ::Test::SmallStruct*, const ::Test::SmallStruct*>>, std::optional<std::pair<const ::Test::SmallStruct*, const ::Test::SmallStruct*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opSmallStructSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<SmallStructSeq>, std::optional<SmallStructSeq>>>>&, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opSmallStructSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>>>>&, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, const Ice::Context&) const;

        std::optional<SmallStructList> opSmallStructList(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, std::optional<SmallStructList>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<SmallStructList>, std::optional<SmallStructList>>> opSmallStructListAsync(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opSmallStructListAsync(std::optional<std::pair<const SmallStruct*, const SmallStruct*>> p1, std::function<void(std::optional<std::pair<const ::Test::SmallStruct*, const ::Test::SmallStruct*>>, std::optional<std::pair<const ::Test::SmallStruct*, const ::Test::SmallStruct*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opSmallStructList(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<SmallStructList>, std::optional<SmallStructList>>>>&, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opSmallStructList(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>>>>&, std::optional<std::pair<const SmallStruct*, const SmallStruct*>>, const Ice::Context&) const;

        std::optional<FixedStructSeq> opFixedStructSeq(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, std::optional<FixedStructSeq>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<FixedStructSeq>, std::optional<FixedStructSeq>>> opFixedStructSeqAsync(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opFixedStructSeqAsync(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, std::function<void(std::optional<std::pair<const ::Test::FixedStruct*, const ::Test::FixedStruct*>>, std::optional<std::pair<const ::Test::FixedStruct*, const ::Test::FixedStruct*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opFixedStructSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<FixedStructSeq>, std::optional<FixedStructSeq>>>>&, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opFixedStructSeq(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>>>>&, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, const Ice::Context&) const;

        std::optional<FixedStructList> opFixedStructList(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, std::optional<FixedStructList>& p3, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<FixedStructList>, std::optional<FixedStructList>>> opFixedStructListAsync(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opFixedStructListAsync(std::optional<std::pair<const FixedStruct*, const FixedStruct*>> p1, std::function<void(std::optional<std::pair<const ::Test::FixedStruct*, const ::Test::FixedStruct*>>, std::optional<std::pair<const ::Test::FixedStruct*, const ::Test::FixedStruct*>>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opFixedStructList(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<FixedStructList>, std::optional<FixedStructList>>>>&, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, const Ice::Context&) const;

        /// @private
        void _iceIL_opFixedStructList(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>>>>&, std::optional<std::pair<const FixedStruct*, const FixedStruct*>>, const Ice::Context&) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opVarStructSeqAsync(const std::optional<VarStructSeq>& p1, std::function<void(std::optional<::Test::VarStructSeq>, std::optional<::Test::VarStructSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opSerializableAsync(const std::optional<Serializable>& p1, std::function<void(std::optional<::Test::Serializable>, std::optional<::Test::Serializable>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opIntIntDictAsync(const std::optional<IntIntDict>& p1, std::function<void(std::optional<::Test::IntIntDict>, std::optional<::Test::IntIntDict>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opStringIntDictAsync(const std::optional<StringIntDict>& p1, std::function<void(std::optional<::Test::StringIntDict>, std::optional<::Test::StringIntDict>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opClassAndUnknownOptionalAsync(const APtr& p, std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        GPtr opG(const GPtr& g, const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)

        [[nodiscard]] std::future<GPtr> opGAsync(const GPtr& g, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opGAsync(const GPtr& g, std::function<void(::Test::GPtr)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opVoidAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opVoid(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>&, const Ice::Context&) const;

        std::optional<SmallStruct> opMStruct1(const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)

        [[nodiscard]] std::future<std::optional<SmallStruct>> opMStruct1Async(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMStruct1Async(std::function<void(std::optional<::Test::SmallStruct>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMStruct2Async(const std::optional<SmallStruct>& p1, std::function<void(std::optional<::Test::SmallStruct>, std::optional<::Test::SmallStruct>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        std::optional<StringSeq> opMSeq1(const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)

        [[nodiscard]] std::future<std::optional<StringSeq>> opMSeq1Async(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMSeq1Async(std::function<void(std::optional<::Test::StringSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMSeq2Async(const std::optional<StringSeq>& p1, std::function<void(std::optional<::Test::StringSeq>, std::optional<::Test::StringSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        std::optional<StringIntDict> opMDict1(const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)

        [[nodiscard]] std::future<std::optional<StringIntDict>> opMDict1Async(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMDict1Async(std::function<void(std::optional<::Test::StringIntDict>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opMDict2Async(const std::optional<StringIntDict>& p1, std::function<void(std::optional<::Test::StringIntDict>, std::optional<::Test::StringIntDict>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        bool supportsJavaSerializable(const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)

        [[nodiscard]] std::future<bool> supportsJavaSerializableAsync(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> supportsJavaSerializableAsync(std::function<void(bool)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
...
namespace Test
{
    ...
    public:
        ...
        [[nodiscard]] OneOptionalPtr ice_clone() const { return std::static_pointer_cast<OneOptional>(_iceCloneImpl()); }
    ...
    /// Outputs the description of a SmallStruct to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const SmallStruct& value);
    ...
    /// Outputs the description of a FixedStruct to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const FixedStruct& value);
    ...
    /// Outputs the description of a VarStruct to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const VarStruct& value);
    ...
    public:
        ...
        MultiOptional(std::optional<std::uint8_t> a, std::optional<bool> b, std::optional<std::int16_t> c, std::optional<std::int32_t> d, std::optional<std::int64_t> e, std::optional<float> f, std::optional<double> g, std::optional<std::string> h, std::optional<::Test::MyEnum> i, std::optional<::Test::MyInterfacePrx> j, std::optional<::Test::ByteSeq> bs, std::optional<::Test::StringSeq> ss, std::optional<::Test::IntIntDict> iid, std::optional<::Test::StringIntDict> sid, std::optional<::Test::FixedStruct> fs, std::optional<::Test::VarStruct> vs, std::optional<::Test::ShortSeq> shs, std::optional<::Test::MyEnumSeq> es, std::optional<::Test::FixedStructSeq> fss, std::optional<::Test::VarStructSeq> vss, std::optional<::Test::MyInterfacePrxSeq> mips, std::optional<::Test::IntEnumDict> ied, std::optional<::Test::IntFixedStructDict> ifsd, std::optional<::Test::IntVarStructDict> ivsd, std::optional<::Test::IntMyInterfacePrxDict> imipd, std::optional<::Test::BoolSeq> bos, std::optional<::Test::Serializable> ser, std::optional<std::string> defaultedString) noexcept :
            ...
            bos(std::move(bos)),
            ser(std::move(ser)),
            defaultedString(std::move(defaultedString))
        {
        }
        ...
        std::optional<std::string> defaultedString{""};
    ...
    public:
        ...
        /// Creates a shallow polymorphic copy of this instance.
        /// @return The cloned value.
        [[nodiscard]] WDPtr ice_clone() const { return std::static_pointer_cast<WD>(_iceCloneImpl()); }
    ...
    public:
        ...
        /// @return The string `"::Test::OptionalException"`.
        static const char* ice_staticId() noexcept;
    ...
    public:
        ...
        void ice_printFields(std::ostream& os) const override;
        /// Gets the type ID of the associated Slice exception.
        /// @return The string `"::Test::RequiredException"`.
        static const char* ice_staticId() noexcept;
    ...
    /// Outputs the description of a G1 to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const G1& value);
    ...
    /// Outputs the description of a G2 to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const G2& value);
...
namespace Test
{
    ...
    public:
        ...
        public:
            ...
            PingPongMarshaledResult(const Ice::ValuePtr& returnValue, const Ice::Current& current);
        };

        virtual PingPongMarshaledResult pingPong(Ice::ValuePtr o, const Ice::Current& current) = 0;

        /// @private
        void _iceD_pingPong(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);

        virtual void opOptionalException(std::optional<std::int32_t> a, std::optional<std::string> b, const Ice::Current& current) = 0;

        /// @private
        void _iceD_opOptionalException(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);

        virtual void opDerivedException(std::optional<std::int32_t> a, std::optional<std::string> b, const Ice::Current& current) = 0;

        /// @private
        void _iceD_opDerivedException(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);

        virtual void opRequiredException(std::optional<std::int32_t> a, std::optional<std::string> b, const Ice::Current& current) = 0;
        ...
        virtual void opClassAndUnknownOptional(APtr p, const Ice::Current& current) = 0;

        /// @private
        void _iceD_opClassAndUnknownOptional(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);

        virtual GPtr opG(GPtr g, const Ice::Current& current) = 0;
...
namespace Ice
{
    ...
    {
        /// Unmarshals a ::Test::SmallStruct from the input stream.
    ...
    {
        /// Unmarshals a ::Test::FixedStruct from the input stream.
    ...
    {
        /// Unmarshals a ::Test::VarStruct from the input stream.
    ...
    {
        /// Unmarshals a ::Test::G1 from the input stream.
    ...
    {
        /// Unmarshals a ::Test::G2 from the input stream.
