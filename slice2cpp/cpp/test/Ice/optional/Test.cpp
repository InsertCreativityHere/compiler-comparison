...
IceProxy::Test::Initial::_iceI_begin_opCustomString(const std::optional<Util::string_view>& iceP_p1, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ...
    try
    {
        result->prepare(iceC_Test_Initial_opCustomString_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(2, iceP_p1);
        result->endWriteParams();
        result->invoke(iceC_Test_Initial_opCustomString_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
IceProxy::Test::Initial::_iceI_begin_opCustomIntStringDict(const std::optional< ::std::map< ::Ice::Int, ::Util::string_view> >& iceP_p1, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ...
    try
    {
        result->prepare(iceC_Test_Initial_opCustomIntStringDict_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(2, iceP_p1);
        result->endWriteParams();
        result->invoke(iceC_Test_Initial_opCustomIntStringDict_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
Test::Initial::_iceD_opSmallStructSeq(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    if(iceP_p1_tmp_)
    {
        ...
        if(!iceP_p1_tmp_->empty())
        {
            ...
            iceP_p1->second = iceP_p1->first + iceP_p1_tmp_->size();
        }
        else
        {
            iceP_p1->first = iceP_p1->second = 0;
        }
    }
    inS.endReadParams();
    std::optional<SmallStructSeq> iceP_p3;
