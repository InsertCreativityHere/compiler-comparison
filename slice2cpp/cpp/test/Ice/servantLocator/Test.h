...
public:
    ...
    ::std::future<void> stdExceptionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    ::std::future<void> cppExceptionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext) const;
