...
public:
    ...
    ::std::future<void> stdExceptionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<void> cppExceptionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
