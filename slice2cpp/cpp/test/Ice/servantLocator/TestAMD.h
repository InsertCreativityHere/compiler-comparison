...
namespace Test
{
    ...
    public:
        ...
        virtual void impossibleExceptionAsync(bool shouldThrow, std::function<void(std::string_view returnValue)> response, std::function<void(std::exception_ptr)> exception, const Ice::Current& current) = 0;

        /// @private
        void _iceD_impossibleException(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);

        virtual void intfUserExceptionAsync(bool shouldThrow, std::function<void(std::string_view returnValue)> response, std::function<void(std::exception_ptr)> exception, const Ice::Current& current) = 0;
