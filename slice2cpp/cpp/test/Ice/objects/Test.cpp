...
const ::IceInternal::DefaultValueFactoryInit<::Test::N> iceC_Test_N_init("::Test::N");
...
const ::std::string iceC_Test_Initial_opN_name = "opN";
...
/// \cond INTERNAL
bool
Test::Initial::_iceD_opN(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    ::std::shared_ptr<N> iceP_p1;
    istr->readAll(iceP_p1);
    istr->readPendingValues();
    inS.endReadParams();
    ::std::shared_ptr<N> ret = this->opN(::std::move(iceP_p1), current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    ostr->writePendingValues();
    inS.endWriteParams();
...
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_Initial_ops, iceC_Test_Initial_ops + 41, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
...
Test::N::ice_staticId()
{
    static const ::std::string typeId = "::Test::N";
    return typeId;
}
...
/// \cond INTERNAL
void
Test::InitialPrx::_iceI_opN(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<::Test::N>>>& outAsync, const ::std::shared_ptr<N>& iceP_p1, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_Test_Initial_opN_name);
    outAsync->invoke(iceC_Test_Initial_opN_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_opDerived(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<::Test::Base>>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_throwDerived(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Context& context)
{
...
Test::BaseEx::BaseEx(const ::std::string& reason) :
    ::Ice::UserException(),
    reason(reason)
{
}
...
/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::Test::upCast(N* p) { return p; }

void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< N>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::Test::N::_newInstance() const
{
    return new N;
}
/// \endcond
...
const ::std::string&
IceProxy::Test::N::ice_staticId()
{
    return ::Test::N::ice_staticId();
}
...
::Ice::AsyncResultPtr
IceProxy::Test::Initial::_iceI_begin_opN(const ::Test::NPtr& iceP_p1, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_Initial_opN_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_Initial_opN_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_Initial_opN_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_p1);
        ostr->writePendingValues();
        result->endWriteParams();
        result->invoke(iceC_Test_Initial_opN_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
::Test::NPtr
IceProxy::Test::Initial::end_opN(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_Initial_opN_name);
    ::Test::NPtr ret;
    if(!result->_waitForResponse())
    {
        try
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_opDerived(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_TestIntf_opDerived_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_opDerived_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_opDerived_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_opDerived_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
::Test::BasePtr
IceProxy::Test::TestIntf::end_opDerived(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_TestIntf_opDerived_name);
    ::Test::BasePtr ret;
    if(!result->_waitForResponse())
    {
        try
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_throwDerived(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_TestIntf_throwDerived_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_throwDerived_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_throwDerived_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_throwDerived_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_throwDerived(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_TestIntf_throwDerived_name);
    if(!result->_waitForResponse())
    {
        try
        {
...
Test::AbstractBase::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_AbstractBase_ids[1];
#endif
}
...
/// \cond INTERNAL
::Ice::Object* Test::upCast(N* p) { return p; }
...
#endif
::Ice::ObjectPtr
Test::N::ice_clone() const
{
    ::Ice::Object* p = new N(*this);
    return p;
}
#if defined(_MSC_VER) && (_MSC_VER >= 1900)
#   pragma warning(pop)
...
namespace
{
const ::std::string iceC_Test_N_ids[2] =
{
    "::Ice::Object",
    "::Test::N"
};
...
bool
Test::N::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_Test_N_ids, iceC_Test_N_ids + 2, s);
}

::std::vector< ::std::string>
Test::N::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&iceC_Test_N_ids[0], &iceC_Test_N_ids[2]);
}

const ::std::string&
Test::N::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}
...
Test::N::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_N_ids[1];
#endif
}

void
Test::N::_iceGcVisitMembers(::IceInternal::GCVisitor& v_)
{
    if(i)
    {
        if((::Test::upCast(i.get())->_iceGcVisit(v_)))
        {
            i = 0;
        }
    }
...
/// \cond STREAM
void
Test::N::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    ::Ice::StreamWriter< N, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
Test::N::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< N, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
Test::N::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test::N::ice_staticId());
}

/// \cond INTERNAL
void
Test::_icePatchObjectPtr(NPtr& handle, const ::Ice::ObjectPtr& v)
{
    handle = NPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(N::ice_staticId(), v);
    }
}
/// \endcond
...
Test::Compact::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_Compact_ids[1];
#endif
}
...
Test::CompactExt::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_CompactExt_ids[2];
#endif
}
...
Test::Inner::A::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_Inner_A_ids[1];
#endif
}
...
Test::Inner::Sub::A::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_Inner_Sub_A_ids[1];
#endif
}
...
Test::Initial::_iceD_opN(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readPendingValues();
    inS.endReadParams();
    NPtr ret = this->opN(iceP_p1, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    ostr->writePendingValues();
    inS.endWriteParams();
...
Test::Initial::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_Initial_all, iceC_Test_Initial_all + 41, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
...
Test::TestIntf::_iceD_opDerived(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::Normal, current.mode);
    inS.readEmptyParams();
    BasePtr ret = this->opDerived(current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    ostr->writePendingValues();
    inS.endWriteParams();
...
Test::AlsoEmpty::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_AlsoEmpty_ids[1];
#endif
}
...
Test::UnexpectedObjectExceptionTest::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_UnexpectedObjectExceptionTest_ids[1];
#endif
}
...
Test::COneMember::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_COneMember_ids[1];
#endif
}
...
Test::CTwoMembers::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_Test_CTwoMembers_ids[1];
#endif
}
