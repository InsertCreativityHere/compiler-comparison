...
Test::TestIntfPrx::opDerived(const ::Ice::Context& context)
{
...
Test::TestIntfPrx::opDerivedAsync(const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_opDerived(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<Base>>>& outAsync, const ::Ice::Context& context)
{
...
void
Test::TestIntfPrx::throwDerived(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_throwDerived, context).get();
}

::std::future<void>
Test::TestIntfPrx::throwDerivedAsync(const ::Ice::Context& context)
{
