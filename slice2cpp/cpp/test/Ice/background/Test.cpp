...
void
Test::BackgroundControllerPrx::initializeSocketOperation(int iceP_status, const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &BackgroundControllerPrx::_iceI_initializeSocketOperation, iceP_status, context).get();
}

::std::future<void>
Test::BackgroundControllerPrx::initializeSocketOperationAsync(int iceP_status, const ::Ice::Context& context)
{
