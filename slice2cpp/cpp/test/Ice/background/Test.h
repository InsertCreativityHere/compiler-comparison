...
class ICE_CLASS(TEST_API) BackgroundPrx : public ::Ice::Proxy<BackgroundPrx, ::Ice::ObjectPrx>
{
public:
...
class ICE_CLASS(TEST_API) BackgroundControllerPrx : public ::Ice::Proxy<BackgroundControllerPrx, ::Ice::ObjectPrx>
{
public:
