...
namespace Test
{
    ...
    /// Outputs the description of a ClassStruct to a stream, including all its fields.
    /// @param os The output stream.
    /// @param value The instance to output.
    /// @return The output stream.
    std::ostream& operator<<(std::ostream& os, const ClassStruct& value);
...
namespace Ice
{
    ...
    {
        /// Unmarshals a ::Test::ClassStruct from the input stream.
