...
namespace
{
    const IceInternal::ClassInit<::Test::OptionalClass> iceC_Test_OptionalClass_init;
    const IceInternal::ClassInit<::Test::MyClass> iceC_Test_MyClass_init;
    const IceInternal::ExceptionInit<::Test::MyException> iceC_Test_MyException_init;
    const IceInternal::ExceptionInit<::Test::Sub::NestedException> iceC_Test_Sub_NestedException_init;
    const IceInternal::ExceptionInit<::Test2::Sub2::NestedException2> iceC_Test2_Sub2_NestedException2_init;
}
