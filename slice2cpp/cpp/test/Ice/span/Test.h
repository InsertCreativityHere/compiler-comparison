...
namespace Test
{
    ...
    public:
        ...
        std::function<void()> opByteSpanAsync(std::span<const std::byte> dataIn, std::function<void(::Test::ByteSeq, ::Test::ByteSeq)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opShortSpanAsync(std::span<const std::int16_t> dataIn, std::function<void(::Test::ShortSeq, ::Test::ShortSeq)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        StringSeq opStringSpan(std::span<const std::string_view> dataIn, StringSeq& dataOut, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<StringSeq, StringSeq>> opStringSpanAsync(std::span<const std::string_view> dataIn, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opStringSpanAsync(std::span<const std::string_view> dataIn, std::function<void(::Test::StringSeq, ::Test::StringSeq)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opStringSpan(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<StringSeq, StringSeq>>>&, std::span<const std::string_view>, const Ice::Context&) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOptionalByteSpanAsync(std::optional<std::span<const std::byte>> dataIn, std::function<void(std::optional<::Test::ByteSeq>, std::optional<::Test::ByteSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOptionalShortSpanAsync(std::optional<std::span<const std::int16_t>> dataIn, std::function<void(std::optional<::Test::ShortSeq>, std::optional<::Test::ShortSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        std::optional<StringSeq> opOptionalStringSpan(std::optional<std::span<const std::string_view>> dataIn, std::optional<StringSeq>& dataOut, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::optional<StringSeq>, std::optional<StringSeq>>> opOptionalStringSpanAsync(std::optional<std::span<const std::string_view>> dataIn, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOptionalStringSpanAsync(std::optional<std::span<const std::string_view>> dataIn, std::function<void(std::optional<::Test::StringSeq>, std::optional<::Test::StringSeq>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opOptionalStringSpan(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::optional<StringSeq>, std::optional<StringSeq>>>>&, std::optional<std::span<const std::string_view>>, const Ice::Context&) const;
