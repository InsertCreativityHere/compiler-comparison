...
public:
    ...
    virtual void opStringSpanAsync(StringSeq dataIn, ::std::function<void(std::span<std::string> returnValue, std::span<std::string> dataOut)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    ...
    virtual void opOptionalStringSpanAsync(::std::optional<StringSeq> dataIn, ::std::function<void(::std::optional<std::span<std::string>> returnValue, ::std::optional<std::span<std::string>> dataOut)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
