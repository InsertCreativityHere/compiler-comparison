...
/// \cond INTERNAL
bool
Test::Single::_iceD_event(::IceInternal::Incoming& incoming)
{
    ...
    this->event(iceP_i, incoming.current());
...
/// \cond INTERNAL
bool
Test::Single::_iceDispatch(::IceInternal::Incoming& incoming)
{
