...
public:
    ...
    {
        return _makeLamdaOutgoing<::std::shared_ptr<::Test::AlsoEmpty>>(std::move(response), std::move(ex), std::move(sent), this, &Test::UnexpectedObjectExceptionTestPrx::_iceI_op, context);
    }
...
public:
    ...
    ::Test::AlsoEmptyPtr op(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
    ...
    ::Test::AlsoEmptyPtr end_op(const ::Ice::AsyncResultPtr& result);
...
public:
    ...
    typedef void (T::*Response)(const AlsoEmptyPtr&);
...
newCallback_UnexpectedObjectExceptionTest_op(const IceUtil::Handle<T>& instance, void (T::*cb)(const AlsoEmptyPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
 ...
 */
template<class T> Callback_UnexpectedObjectExceptionTest_opPtr
newCallback_UnexpectedObjectExceptionTest_op(T* instance, void (T::*cb)(const AlsoEmptyPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_UnexpectedObjectExceptionTest_op<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Response)(const AlsoEmptyPtr&, const CT&);
...
newCallback_UnexpectedObjectExceptionTest_op(const IceUtil::Handle<T>& instance, void (T::*cb)(const AlsoEmptyPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
 ...
 */
template<class T, typename CT> Callback_UnexpectedObjectExceptionTest_opPtr
newCallback_UnexpectedObjectExceptionTest_op(T* instance, void (T::*cb)(const AlsoEmptyPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_UnexpectedObjectExceptionTest_op<T, CT>(instance, cb, excb, sentcb);
}
