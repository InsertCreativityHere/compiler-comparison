...
namespace
{
    const IceInternal::ClassInit<::Test::SBase> iceC_Test_SBase_init;
    const IceInternal::ClassInit<::Test::SBSKnownDerived> iceC_Test_SBSKnownDerived_init;
    const IceInternal::ClassInit<::Test::B> iceC_Test_B_init;
    const IceInternal::ClassInit<::Test::D1> iceC_Test_D1_init;
    const IceInternal::ClassInit<::Test::SS1> iceC_Test_SS1_init;
    const IceInternal::ClassInit<::Test::SS2> iceC_Test_SS2_init;
    const IceInternal::ExceptionInit<::Test::BaseException> iceC_Test_BaseException_init;
    const IceInternal::ExceptionInit<::Test::DerivedException> iceC_Test_DerivedException_init;
    const IceInternal::ClassInit<::Test::PBase> iceC_Test_PBase_init;
    const IceInternal::ClassInit<::Test::Preserved> iceC_Test_Preserved_init;
    const IceInternal::ClassInit<::Test::PDerived> iceC_Test_PDerived_init;
    const IceInternal::ClassInit<::Test::CompactPDerived> iceC_Test_CompactPDerived_init{56};
    const IceInternal::ClassInit<::Test::PNode> iceC_Test_PNode_init;
    const IceInternal::ClassInit<::Test::Hidden> iceC_Test_Hidden_init;
    const IceInternal::ClassInit<::Test::Forward> iceC_Test_Forward_init;
}
...
void
Test::CompactPDerived::ice_printFields(std::ostream& os) const
{
    Preserved::ice_printFields(os);
    Ice::print(os << ", pb = ", this->pb);
}
