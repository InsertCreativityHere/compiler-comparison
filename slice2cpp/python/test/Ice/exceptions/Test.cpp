...
std::int32_t
Test::ThrowerPrx::throwMarshalException(std::int32_t& iceP_p, const Ice::Context& context) const
{
    auto result = IceInternal::makePromiseOutgoing<std::tuple<std::int32_t, std::int32_t>>(true, this, &ThrowerPrx::_iceI_throwMarshalException, context).get();
    iceP_p = std::get<1>(result);
    return std::get<0>(result);
}

std::future<std::tuple<std::int32_t, std::int32_t>>
Test::ThrowerPrx::throwMarshalExceptionAsync(const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<std::tuple<std::int32_t, std::int32_t>>(false, this, &ThrowerPrx::_iceI_throwMarshalException, context);
}

std::function<void()>
Test::ThrowerPrx::throwMarshalExceptionAsync(std::function<void(std::int32_t, std::int32_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    auto responseCb = [response = std::move(response)](std::tuple<std::int32_t, std::int32_t>&& result) mutable
    {
        std::apply(std::move(response), std::move(result));
    };
    return IceInternal::makeLambdaOutgoing<std::tuple<std::int32_t, std::int32_t>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Test::ThrowerPrx::_iceI_throwMarshalException, context);
}
...
{
    static constexpr std::string_view operationName = "throwMarshalException";
...
std::function<void()>
Test::ThrowerPrx::throwRequestFailedExceptionAsync(std::string_view iceP_type, const ::Ice::Identity& iceP_id, std::string_view iceP_facet, std::string_view iceP_operation, std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::ThrowerPrx::_iceI_throwRequestFailedException, iceP_type, iceP_id, iceP_facet, iceP_operation, context);
}
...
Test::Thrower::dispatch(Ice::IncomingRequest& request, std::function<void(Ice::OutgoingResponse)> sendResponse)
{
    ...
    switch (r.first - allOperations.begin())
    {
        ...
        case 20:
        {
            _iceD_throwMarshalException(request, std::move(sendResponse));
            break;
        }
        case 21:
        {
...
void
Test::Thrower::_iceD_throwMarshalException(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
...
void
Test::Thrower::_iceD_throwRequestFailedException(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
