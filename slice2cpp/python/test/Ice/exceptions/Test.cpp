...
int
Test::ThrowerPrx::throwMarshalException(int& iceP_p, const ::Ice::Context& context)
{
...
Test::ThrowerPrx::throwMarshalExceptionAsync(const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Test::ThrowerPrx::_iceI_throwMarshalException(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, int>>>& outAsync, const ::Ice::Context& context)
{
