...
/// \cond INTERNAL
bool
Test::Thrower::_iceD_throwMarshalException(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    int iceP_p;
    int ret = this->throwMarshalException(iceP_p, current);
    auto ostr = inS.startWriteParams();
...
Test::Thrower::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - iceC_Test_Thrower_ops)
    {
        ...
        case 19:
        {
            return _iceD_throwMarshalException(in, current);
        }
        case 20:
        {
...
/// \cond INTERNAL
void
Test::ThrowerPrx::_iceI_throwMarshalException(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<Thrower::ThrowMarshalExceptionResult>>& outAsync, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_Test_Thrower_throwMarshalException_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        {
            Thrower::ThrowMarshalExceptionResult v;
...
::Ice::AsyncResultPtr
IceProxy::Test::Thrower::_iceI_begin_throwMarshalException(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_Thrower_throwMarshalException_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_Thrower_throwMarshalException_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_Thrower_throwMarshalException_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_Thrower_throwMarshalException_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
::Ice::Int
IceProxy::Test::Thrower::end_throwMarshalException(::Ice::Int& iceP_p, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_Thrower_throwMarshalException_name);
    ::Ice::Int ret;
    if(!result->_waitForResponse())
    {
        try
...
void IceProxy::Test::Thrower::_iceI_end_throwMarshalException(::Ice::Int& iceP_p, ::Ice::Int& ret, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_Thrower_throwMarshalException_name);
    if(!result->_waitForResponse())
    {
...
Test::Thrower::_iceD_throwMarshalException(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.readEmptyParams();
    ::Ice::Int iceP_p;
    ::Ice::Int ret = this->throwMarshalException(iceP_p, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(iceP_p);
    ostr->write(ret);
    inS.endWriteParams();
...
Test::Thrower::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_Thrower_all, iceC_Test_Thrower_all + 26, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
