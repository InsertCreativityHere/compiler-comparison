...
/// \cond INTERNAL
bool
Test::Thrower::_iceD_throwMarshalException(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ::std::int32_t iceP_p;
    ::std::int32_t ret = this->throwMarshalException(iceP_p, incoming.current());
    auto ostr = incoming.startWriteParams();
...
Test::Thrower::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 19:
        {
            return _iceD_throwMarshalException(incoming);
        }
        case 20:
        {
