...
::std::function<void()>
Test::ThrowerPrx::throwMarshalExceptionAsync(::std::function<void(::std::int32_t, ::std::int32_t)> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    auto responseCb = [response = ::std::move(response)](::std::tuple<::std::int32_t, ::std::int32_t>&& result)
    {
        ::std::apply(::std::move(response), ::std::move(result));
    };
    return ::IceInternal::makeLambdaOutgoing<::std::tuple<::std::int32_t, ::std::int32_t>>(std::move(responseCb), std::move(ex), std::move(sent), this, &Test::ThrowerPrx::_iceI_throwMarshalException, context);
}
...
Test::Thrower::_iceD_throwMarshalException(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.readEmptyParams();
    ::std::int32_t iceP_p;
    ::std::int32_t ret = this->throwMarshalException(iceP_p, current);
    auto ostr = inS.startWriteParams();
