...
public:
    ...
    ::std::future<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::int32_t>> opRequiredAfterOptionalAsync(::std::int32_t p1, ::std::optional<::std::int32_t> p2, ::std::int32_t p3, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    ::std::future<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::optional<::std::int32_t>>> opOptionalAfterRequiredAsync(::std::int32_t p1, ::std::optional<::std::int32_t> p2, ::std::optional<::std::int32_t> p3, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
