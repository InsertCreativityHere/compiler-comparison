...
public:
    ...
    /**
     * Encapsulates the results of a call to opRequiredAfterOptional.
     */
    struct OpRequiredAfterOptionalResult
    {
        int p4;
        Ice::optional<int> p5;
        int p6;
    ...
    virtual void opRequiredAfterOptional(int p1, Ice::optional<int> p2, int p3, int& p4, Ice::optional<int>& p5, int& p6, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_opRequiredAfterOptional(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    /**
     * Encapsulates the results of a call to opOptionalAfterRequired.
     */
    struct OpOptionalAfterRequiredResult
    {
        int p4;
        Ice::optional<int> p5;
        Ice::optional<int> p6;
    ...
    virtual void opOptionalAfterRequired(int p1, Ice::optional<int> p2, Ice::optional<int> p3, int& p4, Ice::optional<int>& p5, Ice::optional<int>& p6, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void opRequiredAfterOptional(int p1, const Ice::optional<int>& p2, int p3, int& p4, Ice::optional<int>& p5, int& p6, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<Initial::OpRequiredAfterOptionalResult>(true, this, &InitialPrx::_iceI_opRequiredAfterOptional, p1, p2, p3, context).get();
        p4 = _result.p4;
        p5 = _result.p5;
        p6 = _result.p6;
    }
    ...
    template<template<typename> class P = ::std::promise>
    auto opRequiredAfterOptionalAsync(int p1, const Ice::optional<int>& p2, int p3, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<Initial::OpRequiredAfterOptionalResult>>().get_future())
    {
        return _makePromiseOutgoing<Initial::OpRequiredAfterOptionalResult, P>(false, this, &InitialPrx::_iceI_opRequiredAfterOptional, p1, p2, p3, context);
    }

    ::std::function<void()>
    opRequiredAfterOptionalAsync(int p1, const Ice::optional<int>& p2, int p3,
                                 ::std::function<void(int, Ice::optional<int>, int)> response,
                                 ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                 ::std::function<void(bool)> sent = nullptr,
                                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](Initial::OpRequiredAfterOptionalResult&& _result)
        {
            response(_result.p4, _result.p5, _result.p6);
        };
        return _makeLambdaOutgoing<Initial::OpRequiredAfterOptionalResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, p1, p2, p3, context);
    }

    /// \cond INTERNAL
    void _iceI_opRequiredAfterOptional(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<Initial::OpRequiredAfterOptionalResult>>&, int, const Ice::optional<int>&, int, const ::Ice::Context&);
    /// \endcond

    void opOptionalAfterRequired(int p1, const Ice::optional<int>& p2, const Ice::optional<int>& p3, int& p4, Ice::optional<int>& p5, Ice::optional<int>& p6, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<Initial::OpOptionalAfterRequiredResult>(true, this, &InitialPrx::_iceI_opOptionalAfterRequired, p1, p2, p3, context).get();
        p4 = _result.p4;
        p5 = _result.p5;
        p6 = _result.p6;
    }
    ...
    template<template<typename> class P = ::std::promise>
    auto opOptionalAfterRequiredAsync(int p1, const Ice::optional<int>& p2, const Ice::optional<int>& p3, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<Initial::OpOptionalAfterRequiredResult>>().get_future())
    {
        return _makePromiseOutgoing<Initial::OpOptionalAfterRequiredResult, P>(false, this, &InitialPrx::_iceI_opOptionalAfterRequired, p1, p2, p3, context);
    }

    ::std::function<void()>
    opOptionalAfterRequiredAsync(int p1, const Ice::optional<int>& p2, const Ice::optional<int>& p3,
                                 ::std::function<void(int, Ice::optional<int>, Ice::optional<int>)> response,
                                 ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                 ::std::function<void(bool)> sent = nullptr,
                                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](Initial::OpOptionalAfterRequiredResult&& _result)
        {
            response(_result.p4, _result.p5, _result.p6);
        };
        return _makeLambdaOutgoing<Initial::OpOptionalAfterRequiredResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, p1, p2, p3, context);
    }

    /// \cond INTERNAL
    void _iceI_opOptionalAfterRequired(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<Initial::OpOptionalAfterRequiredResult>>&, int, const Ice::optional<int>&, const Ice::optional<int>&, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::Initial::begin_opRequiredAfterOptional.
 * Create a wrapper instance by calling ::Test::newCallback_Initial_opRequiredAfterOptional.
 */
class Callback_Initial_opRequiredAfterOptional_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Initial_opRequiredAfterOptional_Base> Callback_Initial_opRequiredAfterOptionalPtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::Initial::begin_opOptionalAfterRequired.
 * Create a wrapper instance by calling ::Test::newCallback_Initial_opOptionalAfterRequired.
 */
class Callback_Initial_opOptionalAfterRequired_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Initial_opOptionalAfterRequired_Base> Callback_Initial_opOptionalAfterRequiredPtr;
...
public:
    ...
    void opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, ::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, ::Ice::Int& p6, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_opRequiredAfterOptional(p4, p5, p6, _iceI_begin_opRequiredAfterOptional(p1, p2, p3, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opRequiredAfterOptional(p1, p2, p3, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opRequiredAfterOptional(p1, p2, p3, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opRequiredAfterOptional(p1, p2, p3, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, const ::Test::Callback_Initial_opRequiredAfterOptionalPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opRequiredAfterOptional(p1, p2, p3, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, const ::Ice::Context& context, const ::Test::Callback_Initial_opRequiredAfterOptionalPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opRequiredAfterOptional(p1, p2, p3, context, cb, cookie);
    }

    void end_opRequiredAfterOptional(::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, ::Ice::Int& p6, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_opRequiredAfterOptional(::Ice::Int& iceP_p4, IceUtil::Optional< ::Ice::Int>& iceP_p5, ::Ice::Int& iceP_p6, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_opRequiredAfterOptional(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    void opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, ::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, IceUtil::Optional< ::Ice::Int>& p6, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_opOptionalAfterRequired(p4, p5, p6, _iceI_begin_opOptionalAfterRequired(p1, p2, p3, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opOptionalAfterRequired(p1, p2, p3, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opOptionalAfterRequired(p1, p2, p3, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opOptionalAfterRequired(p1, p2, p3, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, const ::Test::Callback_Initial_opOptionalAfterRequiredPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opOptionalAfterRequired(p1, p2, p3, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, const ::Ice::Context& context, const ::Test::Callback_Initial_opOptionalAfterRequiredPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opOptionalAfterRequired(p1, p2, p3, context, cb, cookie);
    }

    void end_opOptionalAfterRequired(::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, IceUtil::Optional< ::Ice::Int>& p6, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_opOptionalAfterRequired(::Ice::Int& iceP_p4, IceUtil::Optional< ::Ice::Int>& iceP_p5, IceUtil::Optional< ::Ice::Int>& iceP_p6, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_opOptionalAfterRequired(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual void opRequiredAfterOptional(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, ::Ice::Int p3, ::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, ::Ice::Int& p6, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opRequiredAfterOptional(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void opOptionalAfterRequired(::Ice::Int p1, const IceUtil::Optional< ::Ice::Int>& p2, const IceUtil::Optional< ::Ice::Int>& p3, ::Ice::Int& p4, IceUtil::Optional< ::Ice::Int>& p5, IceUtil::Optional< ::Ice::Int>& p6, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opOptionalAfterRequired(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_Initial_opRequiredAfterOptional : public Callback_Initial_opRequiredAfterOptional_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int);

    CallbackNC_Initial_opRequiredAfterOptional(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            proxy->end_opRequiredAfterOptional(iceP_p4, iceP_p5, iceP_p6, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(iceP_p4, iceP_p5, iceP_p6);
        }
    }
    /// \endcond
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_opRequiredAfterOptional.
 */
template<class T> Callback_Initial_opRequiredAfterOptionalPtr
newCallback_Initial_opRequiredAfterOptional(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_opRequiredAfterOptional<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Initial_opRequiredAfterOptionalPtr
newCallback_Initial_opRequiredAfterOptional(T* instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_opRequiredAfterOptional<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Initial_opRequiredAfterOptional : public Callback_Initial_opRequiredAfterOptional_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int, const CT&);

    Callback_Initial_opRequiredAfterOptional(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(iceP_p4, iceP_p5, iceP_p6, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_opRequiredAfterOptional.
 */
template<class T, typename CT> Callback_Initial_opRequiredAfterOptionalPtr
newCallback_Initial_opRequiredAfterOptional(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_opRequiredAfterOptional<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Initial_opRequiredAfterOptionalPtr
newCallback_Initial_opRequiredAfterOptional(T* instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, ::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_opRequiredAfterOptional<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_Initial_opOptionalAfterRequired : public Callback_Initial_opOptionalAfterRequired_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&);

    CallbackNC_Initial_opOptionalAfterRequired(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            proxy->end_opOptionalAfterRequired(iceP_p4, iceP_p5, iceP_p6, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_opOptionalAfterRequired.
 */
template<class T> Callback_Initial_opOptionalAfterRequiredPtr
newCallback_Initial_opOptionalAfterRequired(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_opOptionalAfterRequired<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Initial_opOptionalAfterRequiredPtr
newCallback_Initial_opOptionalAfterRequired(T* instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_opOptionalAfterRequired<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Initial_opOptionalAfterRequired : public Callback_Initial_opOptionalAfterRequired_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&, const CT&);

    Callback_Initial_opOptionalAfterRequired(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_opOptionalAfterRequired.
 */
template<class T, typename CT> Callback_Initial_opOptionalAfterRequiredPtr
newCallback_Initial_opOptionalAfterRequired(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_opOptionalAfterRequired<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Initial_opOptionalAfterRequiredPtr
newCallback_Initial_opOptionalAfterRequired(T* instance, void (T::*cb)(::Ice::Int, const IceUtil::Optional< ::Ice::Int>&, const IceUtil::Optional< ::Ice::Int>&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_opOptionalAfterRequired<T, CT>(instance, cb, excb, sentcb);
}
