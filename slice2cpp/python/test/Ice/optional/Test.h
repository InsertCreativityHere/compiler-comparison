...
public:
    ...
    ::std::future<::std::tuple<int, std::optional<int>, int>> opRequiredAfterOptionalAsync(int p1, const std::optional<int>& p2, int p3, const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    /// \cond INTERNAL
    void _iceI_opRequiredAfterOptional(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, std::optional<int>, int>>>&, int, const std::optional<int>&, int, const ::Ice::Context&);
    /// \endcond
    ...
    ::std::future<::std::tuple<int, std::optional<int>, std::optional<int>>> opOptionalAfterRequiredAsync(int p1, const std::optional<int>& p2, const std::optional<int>& p3, const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    /// \cond INTERNAL
    void _iceI_opOptionalAfterRequired(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, std::optional<int>, std::optional<int>>>>&, int, const std::optional<int>&, const std::optional<int>&, const ::Ice::Context&);
    /// \endcond
