...
public:
    ...
    ::std::function<void()> // NOLINT(modernize-use-nodiscard)
    opRequiredAfterOptionalAsync(::std::int32_t p1, ::std::optional<::std::int32_t> p2, ::std::int32_t p3, ::std::function<void(::std::int32_t, ::std::optional<::std::int32_t>, ::std::int32_t)> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    ::std::function<void()> // NOLINT(modernize-use-nodiscard)
    opOptionalAfterRequiredAsync(::std::int32_t p1, ::std::optional<::std::int32_t> p2, ::std::optional<::std::int32_t> p3, ::std::function<void(::std::int32_t, ::std::optional<::std::int32_t>, ::std::optional<::std::int32_t>)> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
