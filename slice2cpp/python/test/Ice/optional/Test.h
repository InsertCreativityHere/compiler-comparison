...
namespace Test
{
    ...
    public:
        ...
        void opRequiredAfterOptional(std::int32_t p1, std::optional<std::int32_t> p2, std::int32_t p3, std::int32_t& p4, std::optional<std::int32_t>& p5, std::int32_t& p6, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::int32_t, std::optional<std::int32_t>, std::int32_t>> opRequiredAfterOptionalAsync(std::int32_t p1, std::optional<std::int32_t> p2, std::int32_t p3, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opRequiredAfterOptionalAsync(std::int32_t p1, std::optional<std::int32_t> p2, std::int32_t p3, std::function<void(std::int32_t, std::optional<std::int32_t>, std::int32_t)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opRequiredAfterOptional(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::int32_t, std::optional<std::int32_t>, std::int32_t>>>&, std::int32_t, std::optional<std::int32_t>, std::int32_t, const Ice::Context&) const;

        void opOptionalAfterRequired(std::int32_t p1, std::optional<std::int32_t> p2, std::optional<std::int32_t> p3, std::int32_t& p4, std::optional<std::int32_t>& p5, std::optional<std::int32_t>& p6, const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<std::tuple<std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>>> opOptionalAfterRequiredAsync(std::int32_t p1, std::optional<std::int32_t> p2, std::optional<std::int32_t> p3, const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> opOptionalAfterRequiredAsync(std::int32_t p1, std::optional<std::int32_t> p2, std::optional<std::int32_t> p3, std::function<void(std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>)> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_opOptionalAfterRequired(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::tuple<std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>>>>&, std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>, const Ice::Context&) const;
...
namespace Test
{
    ...
    public:
        ...
        /// @private
        void _iceD_opRequiredAfterOptional(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);
        ...
        /// @private
        void _iceD_opOptionalAfterRequired(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);
