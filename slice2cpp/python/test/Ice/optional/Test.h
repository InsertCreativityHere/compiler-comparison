...
public:
    ...
    ::std::function<void()>
    opRequiredAfterOptionalAsync(::std::int32_t p1, const ::std::optional<::std::int32_t>& p2, ::std::int32_t p3,
    ...
    ::std::function<void()>
    opOptionalAfterRequiredAsync(::std::int32_t p1, const ::std::optional<::std::int32_t>& p2, const ::std::optional<::std::int32_t>& p3,
