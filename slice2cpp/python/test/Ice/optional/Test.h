...
public:
                                 ...
                                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        ...
        return _makeLamdaOutgoing<Initial::OpRequiredAfterOptionalResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, p1, p2, p3, context);
    }
                                 ...
                                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        ...
        return _makeLamdaOutgoing<Initial::OpOptionalAfterRequiredResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, p1, p2, p3, context);
    }
