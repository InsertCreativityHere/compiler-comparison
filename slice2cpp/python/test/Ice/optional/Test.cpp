...
std::function<void()>
Test::InitialPrx::opRequiredAfterOptionalAsync(std::int32_t iceP_p1, std::optional<std::int32_t> iceP_p2, std::int32_t iceP_p3, std::function<void(std::int32_t, std::optional<std::int32_t>, std::int32_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    auto responseCb = [response = std::move(response)](std::tuple<std::int32_t, std::optional<std::int32_t>, std::int32_t>&& result) mutable
    {
        std::apply(std::move(response), std::move(result));
    };
    return IceInternal::makeLambdaOutgoing<std::tuple<std::int32_t, std::optional<std::int32_t>, std::int32_t>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}
...
{
    auto responseCb = [response = std::move(response)](std::tuple<std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>>&& result) mutable
    {
        std::apply(std::move(response), std::move(result));
    };
    return IceInternal::makeLambdaOutgoing<std::tuple<std::int32_t, std::optional<std::int32_t>, std::optional<std::int32_t>>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opRequiredAfterOptional(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    _iceCheckMode(Ice::OperationMode::Normal, request.current().mode);
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opOptionalAfterRequired(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    _iceCheckMode(Ice::OperationMode::Normal, request.current().mode);
