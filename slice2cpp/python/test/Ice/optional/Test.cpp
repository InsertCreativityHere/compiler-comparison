...
void
Test::InitialPrx::opRequiredAfterOptional(int iceP_p1, const std::optional<int>& iceP_p2, int iceP_p3, int& iceP_p4, std::optional<int>& iceP_p5, int& iceP_p6, const ::Ice::Context& context)
{
    auto _result = _makePromiseOutgoing<::std::tuple<int, std::optional<int>, int>>(true, this, &InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context).get();
    iceP_p4 = ::std::get<0>(_result);
    iceP_p5 = ::std::get<1>(_result);
    iceP_p6 = ::std::get<2>(_result);
}

::std::future<::std::tuple<int, std::optional<int>, int>>
Test::InitialPrx::opRequiredAfterOptionalAsync(int iceP_p1, const std::optional<int>& iceP_p2, int iceP_p3, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<::std::tuple<int, std::optional<int>, int>, ::std::promise>(false, this, &InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}

::std::function<void()>
Test::InitialPrx::opRequiredAfterOptionalAsync(int iceP_p1, const std::optional<int>& iceP_p2, int iceP_p3,
                                               ::std::function<void (int, std::optional<int>, int)> response,
                                               ::std::function<void(::std::exception_ptr)> ex,
                                               ::std::function<void(bool)> sent,
                                               const ::Ice::Context& context)
{
    auto _responseCb = [response](::std::tuple<int, std::optional<int>, int>&& _result)
    {
        response(::std::get<0>(_result), ::std::get<1>(_result), ::std::get<2>(_result));
    };
    return _makeLambdaOutgoing<::std::tuple<int, std::optional<int>, int>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}

/// \cond INTERNAL
void
Test::InitialPrx::_iceI_opRequiredAfterOptional(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, std::optional<int>, int>>>& outAsync, int iceP_p1, const std::optional<int>& iceP_p2, int iceP_p3, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_Test_Initial_opRequiredAfterOptional_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        [](::Ice::InputStream* istr)
        {
            ::std::tuple<int, std::optional<int>, int> v;
...
void
Test::InitialPrx::opOptionalAfterRequired(int iceP_p1, const std::optional<int>& iceP_p2, const std::optional<int>& iceP_p3, int& iceP_p4, std::optional<int>& iceP_p5, std::optional<int>& iceP_p6, const ::Ice::Context& context)
{
    auto _result = _makePromiseOutgoing<::std::tuple<int, std::optional<int>, std::optional<int>>>(true, this, &InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context).get();
    iceP_p4 = ::std::get<0>(_result);
    iceP_p5 = ::std::get<1>(_result);
    iceP_p6 = ::std::get<2>(_result);
}

::std::future<::std::tuple<int, std::optional<int>, std::optional<int>>>
Test::InitialPrx::opOptionalAfterRequiredAsync(int iceP_p1, const std::optional<int>& iceP_p2, const std::optional<int>& iceP_p3, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<::std::tuple<int, std::optional<int>, std::optional<int>>, ::std::promise>(false, this, &InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}

::std::function<void()>
Test::InitialPrx::opOptionalAfterRequiredAsync(int iceP_p1, const std::optional<int>& iceP_p2, const std::optional<int>& iceP_p3,
                                               ::std::function<void (int, std::optional<int>, std::optional<int>)> response,
                                               ::std::function<void(::std::exception_ptr)> ex,
                                               ::std::function<void(bool)> sent,
                                               const ::Ice::Context& context)
{
    auto _responseCb = [response](::std::tuple<int, std::optional<int>, std::optional<int>>&& _result)
    {
        response(::std::get<0>(_result), ::std::get<1>(_result), ::std::get<2>(_result));
    };
    return _makeLambdaOutgoing<::std::tuple<int, std::optional<int>, std::optional<int>>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}

/// \cond INTERNAL
void
Test::InitialPrx::_iceI_opOptionalAfterRequired(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<int, std::optional<int>, std::optional<int>>>>& outAsync, int iceP_p1, const std::optional<int>& iceP_p2, const std::optional<int>& iceP_p3, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_Test_Initial_opOptionalAfterRequired_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        [](::Ice::InputStream* istr)
        {
            ::std::tuple<int, std::optional<int>, std::optional<int>> v;
