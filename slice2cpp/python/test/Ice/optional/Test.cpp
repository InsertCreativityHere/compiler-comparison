...
{
    auto _result = _makePromiseOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, ::std::int32_t>>(true, this, &InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context).get();
...
{
    return _makePromiseOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, ::std::int32_t>, ::std::promise>(false, this, &InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}

::std::function<void()>
Test::InitialPrx::opRequiredAfterOptionalAsync(::std::int32_t iceP_p1, const std::optional<::std::int32_t>& iceP_p2, ::std::int32_t iceP_p3,
                                               ::std::function<void (::std::int32_t, std::optional<::std::int32_t>, ::std::int32_t)> response,
                                               ::std::function<void(::std::exception_ptr)> ex,
                                               ::std::function<void(bool)> sent,
                                               const ::Ice::Context& context) const
{
    auto _responseCb = [response](::std::tuple<::std::int32_t, std::optional<::std::int32_t>, ::std::int32_t>&& _result)
    {
        response(::std::get<0>(_result), ::std::get<1>(_result), ::std::get<2>(_result));
    };
    return _makeLambdaOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, ::std::int32_t>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}
...
{
    auto _result = _makePromiseOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, std::optional<::std::int32_t>>>(true, this, &InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context).get();
    iceP_p4 = ::std::get<0>(_result);
    iceP_p5 = ::std::get<1>(_result);
    iceP_p6 = ::std::get<2>(_result);
}
...
{
    return _makePromiseOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, std::optional<::std::int32_t>>, ::std::promise>(false, this, &InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}
...
Test::InitialPrx::opOptionalAfterRequiredAsync(::std::int32_t iceP_p1, const std::optional<::std::int32_t>& iceP_p2, const std::optional<::std::int32_t>& iceP_p3,
                                               ...
                                               const ::Ice::Context& context) const
{
    auto _responseCb = [response](::std::tuple<::std::int32_t, std::optional<::std::int32_t>, std::optional<::std::int32_t>>&& _result)
    {
        response(::std::get<0>(_result), ::std::get<1>(_result), ::std::get<2>(_result));
    };
    return _makeLambdaOutgoing<::std::tuple<::std::int32_t, std::optional<::std::int32_t>, std::optional<::std::int32_t>>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}
