...
{
    auto _result = ::IceInternal::makePromiseOutgoing<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::int32_t>>(true, this, &InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context).get();
...
Test::InitialPrx::opRequiredAfterOptionalAsync(::std::int32_t iceP_p1, const ::std::optional<::std::int32_t>& iceP_p2, ::std::int32_t iceP_p3,
                                               ...
                                               const ::Ice::Context& context) const
{
    auto _responseCb = [_response = ::std::move(response)](::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::int32_t>&& _result)
    {
        ::std::apply(::std::move(_response), ::std::move(_result));
    };
    return ::IceInternal::makeLambdaOutgoing<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::int32_t>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opRequiredAfterOptional, iceP_p1, iceP_p2, iceP_p3, context);
}
...
{
    auto _result = ::IceInternal::makePromiseOutgoing<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::optional<::std::int32_t>>>(true, this, &InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context).get();
    iceP_p4 = ::std::get<0>(_result);
    iceP_p5 = ::std::get<1>(_result);
    iceP_p6 = ::std::get<2>(_result);
}
...
Test::InitialPrx::opOptionalAfterRequiredAsync(::std::int32_t iceP_p1, const ::std::optional<::std::int32_t>& iceP_p2, const ::std::optional<::std::int32_t>& iceP_p3,
                                               ...
                                               const ::Ice::Context& context) const
{
    auto _responseCb = [_response = ::std::move(response)](::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::optional<::std::int32_t>>&& _result)
    {
        ::std::apply(::std::move(_response), ::std::move(_result));
    };
    return ::IceInternal::makeLambdaOutgoing<::std::tuple<::std::int32_t, ::std::optional<::std::int32_t>, ::std::optional<::std::int32_t>>>(std::move(_responseCb), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_opOptionalAfterRequired, iceP_p1, iceP_p2, iceP_p3, context);
}
