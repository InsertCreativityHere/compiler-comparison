...
namespace Test
{
    ...
    struct StructNoDefaults
    {
        ...
        {
            return std::tie(bo, b, s, i, l, f, d, str, c1, bs, iseq, isDict, st);
        }
    ...
    public:
        ...
        /// One-shot constructor to initialize all data members.
        ExceptionNoDefaults(std::string str, Color c1, ByteSeq bs, InnerStruct st, IntStringDict isDict) noexcept :
        ...
        {
            return std::tie(str, c1, bs, st, isDict);
        }
    ...
    public:
        ...
        /// One-shot constructor to initialize all data members.
        ClassNoDefaults(std::string str, ::Test::Color c1, ::Test::ByteSeq bs, ::Test::InnerStruct st, ::Test::IntStringDict isDict) noexcept :
...
namespace Ice
{
    ...
    struct StreamReader<::Test::StructNoDefaults>
    {
        ...
        {
            istr->readAll(v.bo, v.b, v.s, v.i, v.l, v.f, v.d, v.str, v.c1, v.bs, v.iseq, v.isDict, v.st);
        }
    };
    /// @endcond
}
