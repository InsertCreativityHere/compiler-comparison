...
namespace
{
    const IceInternal::ClassInit<::Test::Base> iceC_Test_Base_init;
    const IceInternal::ClassInit<::Test::Derived> iceC_Test_Derived_init;
    const IceInternal::ExceptionInit<::Test::BaseEx> iceC_Test_BaseEx_init;
    const IceInternal::ExceptionInit<::Test::DerivedEx> iceC_Test_DerivedEx_init;
    const IceInternal::ExceptionInit<::Test::ExceptionNoDefaultsBase> iceC_Test_ExceptionNoDefaultsBase_init;
    const IceInternal::ExceptionInit<::Test::ExceptionNoDefaults> iceC_Test_ExceptionNoDefaults_init;
    const IceInternal::ClassInit<::Test::ClassNoDefaultsBase> iceC_Test_ClassNoDefaultsBase_init;
    const IceInternal::ClassInit<::Test::ClassNoDefaults> iceC_Test_ClassNoDefaults_init;
}
...
void
Test::ExceptionNoDefaultsBase::ice_printFields(std::ostream& os) const
{
    Ice::print(os << "str = ", this->str);
    Ice::print(os << ", c1 = ", this->c1);
    Ice::print(os << ", bs = ", this->bs);
...
void
Test::ExceptionNoDefaults::ice_printFields(std::ostream& os) const
{
    ExceptionNoDefaultsBase::ice_printFields(os);
    Ice::print(os << ", st = ", this->st);
    Ice::print(os << ", isDict = ", this->isDict);
}
...
{
    ostr->startSlice(ice_staticId(), -1, false);
    ostr->writeAll(this->st, this->isDict);
    ostr->endSlice();
...
{
    istr->startSlice();
    istr->readAll(this->st, this->isDict);
    istr->endSlice();
