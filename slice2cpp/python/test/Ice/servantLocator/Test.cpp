...
const ::std::string iceC_Test_TestIntf_pythonException_name = "pythonException";
...
void
Test::TestIntfPrx::pythonException(const ::Ice::Context& context) const
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_pythonException, context).get();
}

::std::future<void>
Test::TestIntfPrx::pythonExceptionAsync(const ::Ice::Context& context) const
{
    return _makePromiseOutgoing<void, ::std::promise>(false, this, &TestIntfPrx::_iceI_pythonException, context);
}

::std::function<void()>
Test::TestIntfPrx::pythonExceptionAsync(::std::function<void ()> response,
                                        ::std::function<void(::std::exception_ptr)> ex,
                                        ::std::function<void(bool)> sent,
                                        const ::Ice::Context& context) const
{
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_pythonException(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Context& context) const
{
    outAsync->invoke(iceC_Test_TestIntf_pythonException_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
