...
void
Test::TestIntfPrx::pythonException(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_pythonException, context).get();
}

::std::future<void>
Test::TestIntfPrx::pythonExceptionAsync(const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_pythonException(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Context& context)
{
