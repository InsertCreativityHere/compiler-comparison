...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_pythonException(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_pythonException_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_pythonException_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_TestIntf_pythonException_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_pythonException(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_TestIntf_pythonException_name);
}
