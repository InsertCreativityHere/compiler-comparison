...
namespace Test
{
    ...
    public:
        ...
        void pythonException(const Ice::Context& context = Ice::noExplicitContext) const;

        [[nodiscard]] std::future<void> pythonExceptionAsync(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> pythonExceptionAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;

        /// @private
        void _iceI_pythonException(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>&, const Ice::Context&) const;
...
namespace Test
{
    ...
    public:
        ...
        virtual void pythonException(const Ice::Current& current) = 0;

        /// @private
        void _iceD_pythonException(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);
