...
public:
    ...
    /// \cond INTERNAL
    bool _iceD_pythonException(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    void pythonException(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_pythonException, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto pythonExceptionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &TestIntfPrx::_iceI_pythonException, context);
    }

    ::std::function<void()>
    pythonExceptionAsync(::std::function<void()> response,
                         ::std::function<void(::std::exception_ptr)> ex = nullptr,
                         ::std::function<void(bool)> sent = nullptr,
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::TestIntfPrx::_iceI_pythonException, context);
    }

    /// \cond INTERNAL
    void _iceI_pythonException(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::TestIntf::begin_pythonException.
 * Create a wrapper instance by calling ::Test::newCallback_TestIntf_pythonException.
 */
class Callback_TestIntf_pythonException_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_TestIntf_pythonException_Base> Callback_TestIntf_pythonExceptionPtr;
...
public:
    ...
    void pythonException(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_pythonException(_iceI_begin_pythonException(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_pythonException(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_pythonException(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pythonException(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pythonException(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pythonException(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pythonException(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pythonException(const ::Test::Callback_TestIntf_pythonExceptionPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pythonException(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pythonException(const ::Ice::Context& context, const ::Test::Callback_TestIntf_pythonExceptionPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pythonException(context, cb, cookie);
    }

    void end_pythonException(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_pythonException(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual void pythonException(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_pythonException(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_TestIntf_pythonException : public Callback_TestIntf_pythonException_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_TestIntf_pythonException(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_pythonException.
 */
template<class T> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pythonException<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pythonException<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pythonException<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pythonException<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_TestIntf_pythonException : public Callback_TestIntf_pythonException_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_TestIntf_pythonException(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_pythonException.
 */
template<class T, typename CT> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pythonException<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pythonException<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pythonException<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pythonExceptionPtr
newCallback_TestIntf_pythonException(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pythonException<T, CT>(instance, 0, excb, sentcb);
}
