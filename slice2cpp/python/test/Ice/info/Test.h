...
public:
    ...
    ::std::future<::Ice::Context> getEndpointInfoAsContextAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<::Ice::Context> getConnectionInfoAsContextAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
