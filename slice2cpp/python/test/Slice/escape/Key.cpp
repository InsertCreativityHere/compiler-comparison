...
{
    static constexpr std::array<std::string_view, 6> allOperations{"elif", "finally", "ice_id", "ice_ids", "ice_isA", "ice_ping"};
...
{
    static constexpr std::array<std::string_view, 5> allOperations{"ice_id", "ice_ids", "ice_isA", "ice_ping", "raise"};
