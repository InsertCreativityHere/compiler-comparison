...
namespace and
{
    ...
    public:
        ...
        for(std::int32_t foo, std::optional<::and::execPrx> from) noexcept :
            foo(foo),
            from(std::move(from))
        {
        }
        ...
        [[nodiscard]] std::tuple<const std::int32_t&, const std::optional<::and::execPrx>&> ice_tuple() const
        {
...
namespace Ice
{
    ...
    {
        /// Unmarshals a ::and::continue from the input stream.
