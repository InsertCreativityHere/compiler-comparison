...
namespace
{
    const IceInternal::ClassInit<::Clash::Cls> iceC_Clash_Cls_init;
    const IceInternal::ExceptionInit<::Clash::Ex> iceC_Clash_Ex_init;
}
...
{
    static constexpr std::array<std::string_view, 16> allOperations{"context", "cookie", "current", "del", "ice_id", "ice_ids", "ice_isA", "ice_ping", "inS", "istr", "op", "opOut", "response", "sync", "typeId", "upCast"};
