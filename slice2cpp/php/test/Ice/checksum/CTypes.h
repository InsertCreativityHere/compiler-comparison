...
public:
    ...
    baseOpAsync(::std::function<void()> response,
                ...
                const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::BaseInterface11Prx::_iceI_baseOp, context);
    }
    ...
    baseOp2Async(int i,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<::std::string>(std::move(response), std::move(ex), std::move(sent), this, &Test::BaseInterface11Prx::_iceI_baseOp2, i, context);
    }
