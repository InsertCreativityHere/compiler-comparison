...
std::function<void()>
Test::MyClassPrx::opContextAsync(std::function<void(::Test::StringStringD)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<StringStringD>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyClassPrx::_iceI_opContext, context);
}
...
std::function<void()>
Test::MyDerivedClassPrx::opMyStruct1Async(const MyStruct1& iceP_s, std::function<void(::Test::MyStruct1)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<MyStruct1>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyDerivedClassPrx::_iceI_opMyStruct1, iceP_s, context);
}
...
::Test::MyClass1Ptr
Test::MyDerivedClassPrx::opMyClass1(const MyClass1Ptr& iceP_c, const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<MyClass1Ptr>(true, this, &MyDerivedClassPrx::_iceI_opMyClass1, iceP_c, context).get();
}

std::future<::Test::MyClass1Ptr>
Test::MyDerivedClassPrx::opMyClass1Async(const MyClass1Ptr& iceP_c, const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<MyClass1Ptr>(false, this, &MyDerivedClassPrx::_iceI_opMyClass1, iceP_c, context);
}

std::function<void()>
Test::MyDerivedClassPrx::opMyClass1Async(const MyClass1Ptr& iceP_c, std::function<void(::Test::MyClass1Ptr)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<MyClass1Ptr>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyDerivedClassPrx::_iceI_opMyClass1, iceP_c, context);
}

void
Test::MyDerivedClassPrx::_iceI_opMyClass1(const std::shared_ptr<IceInternal::OutgoingAsyncT<MyClass1Ptr>>& outAsync, const MyClass1Ptr& iceP_c, const Ice::Context& context) const
{
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
    request.inputStream().skipEmptyEncapsulation();
    const StringStringD ret = this->opContext(request.current());
    sendResponse(Ice::makeOutgoingResponse([&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(ret);
        },
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    istr->readAll(iceP_s);
    istr->endEncapsulation();
    const MyStruct1 ret = this->opMyStruct1(std::move(iceP_s), request.current());
    sendResponse(Ice::makeOutgoingResponse([&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(ret);
        },
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    istr->readPendingValues();
    istr->endEncapsulation();
    const MyClass1Ptr ret = this->opMyClass1(std::move(iceP_c), request.current());
    sendResponse(Ice::makeOutgoingResponse([&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(ret);
            ostr->writePendingValues();
