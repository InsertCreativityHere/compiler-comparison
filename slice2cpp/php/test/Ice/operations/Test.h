...
public:
    ...
    ::std::future<StringStringD> opContextAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    /// \cond INTERNAL
    void _iceI_opContext(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<StringStringD>>&, const ::Ice::Context&);
    /// \endcond
...
public:
    ...
    ::std::future<MyStruct1> opMyStruct1Async(const MyStruct1& s, const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<::std::shared_ptr<MyClass1>> opMyClass1Async(const ::std::shared_ptr<MyClass1>& c, const ::Ice::Context& context = ::Ice::noExplicitContext);
