...
public:
    ...
    opContextAsync(::std::function<void(::Test::StringStringD)> response,
                   ...
                   const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::Test::StringStringD>(std::move(response), std::move(ex), std::move(sent), this, &Test::MyClassPrx::_iceI_opContext, context);
    }
...
public:
    ...
    opMyStruct1Async(const MyStruct1& s,
                     ...
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::Test::MyStruct1>(std::move(response), std::move(ex), std::move(sent), this, &Test::MyDerivedClassPrx::_iceI_opMyStruct1, s, context);
    }
