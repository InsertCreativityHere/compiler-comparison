...
public:
    ...
    {
        return _makePromiseOutgoing<::Test::Context>(true, this, &MyClassPrx::_iceI_getContext, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getContextAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::Test::Context>>().get_future())
    {
        return _makePromiseOutgoing<::Test::Context, P>(false, this, &MyClassPrx::_iceI_getContext, context);
    }
    ...
    getContextAsync(::std::function<void(::Test::Context)> response,
                    ...
                    const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<::Test::Context>(std::move(response), std::move(ex), std::move(sent), this, &Test::MyClassPrx::_iceI_getContext, context);
    }

    /// \cond INTERNAL
    void _iceI_getContext(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::Test::Context>>&, const ::Ice::Context&);
    /// \endcond
...
public:
    ...
    ::Test::Context getContext(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
    ...
    ::Test::Context end_getContext(const ::Ice::AsyncResultPtr& result);
...
public:
    ...
    virtual Context getContext(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getContext(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const Context&);
...
newCallback_MyClass_getContext(const IceUtil::Handle<T>& instance, void (T::*cb)(const Context&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
 ...
 */
template<class T> Callback_MyClass_getContextPtr
newCallback_MyClass_getContext(T* instance, void (T::*cb)(const Context&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MyClass_getContext<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const Context&, const CT&);
...
newCallback_MyClass_getContext(const IceUtil::Handle<T>& instance, void (T::*cb)(const Context&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
 ...
 */
template<class T, typename CT> Callback_MyClass_getContextPtr
newCallback_MyClass_getContext(T* instance, void (T::*cb)(const Context&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MyClass_getContext<T, CT>(instance, cb, excb, sentcb);
}
