...
{
    static constexpr std::array<std::string_view, 7> allOperations{"getConnectionInfoAsContext", "getEndpointInfoAsContext", "ice_id", "ice_ids", "ice_isA", "ice_ping", "shutdown"};
