...
namespace Test
{
    ...
    public:
        ...
        [[nodiscard]] std::future<void> interruptAsync(const Ice::Context& context = Ice::noExplicitContext) const;

        // NOLINTNEXTLINE(modernize-use-nodiscard)
        std::function<void()> interruptAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception = nullptr, std::function<void(bool)> sent = nullptr, const Ice::Context& context = Ice::noExplicitContext) const;
...
namespace Test
{
    ...
    public:
        ...
        /// @return The string `"::Test::InterruptedException"`.
        static const char* ice_staticId() noexcept;
    ...
    public:
        /// Gets the type ID of the associated Slice exception.
        /// @return The string `"::Test::CannotInterruptException"`.
        static const char* ice_staticId() noexcept;
