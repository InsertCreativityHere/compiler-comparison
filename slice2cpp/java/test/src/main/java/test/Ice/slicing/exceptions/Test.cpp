...
namespace
{
    ...
    const IceInternal::ExceptionInit<::Test::KnownPreserved> iceC_Test_KnownPreserved_init;
    const IceInternal::ExceptionInit<::Test::KnownPreservedDerived> iceC_Test_KnownPreservedDerived_init;
}
