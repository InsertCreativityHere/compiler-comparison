...
public:
    ...
    ::std::optional<OneOptionalPtr> opOneOptionalReq(const ::std::optional<OneOptionalPtr>& p1, ::std::optional<OneOptionalPtr>& p3, const ::Ice::Context& context = ::Ice::noExplicitContext) const;

    ::std::future<::std::tuple<::std::optional<OneOptionalPtr>, ::std::optional<OneOptionalPtr>>> opOneOptionalReqAsync(const ::std::optional<OneOptionalPtr>& p1, const ::Ice::Context& context = ::Ice::noExplicitContext) const;

    ::std::function<void()>
    opOneOptionalReqAsync(const ::std::optional<OneOptionalPtr>& p1, ::std::function<void(::std::optional<::Test::OneOptionalPtr>, ::std::optional<::Test::OneOptionalPtr>)> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;

    /// \cond INTERNAL
    void _iceI_opOneOptionalReq(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<::std::optional<OneOptionalPtr>, ::std::optional<OneOptionalPtr>>>>&, const ::std::optional<OneOptionalPtr>&, const ::Ice::Context&) const;
    /// \endcond
...
public:
    ...
    virtual ::std::optional<OneOptionalPtr> opOneOptionalReq(::std::optional<OneOptionalPtr> p1, ::std::optional<OneOptionalPtr>& p3, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
