...
std::function<void()>
Test::TestIntfPrx::opBoolAsync(bool iceP_b, std::function<void(bool)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<bool>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opBool, iceP_b, context);
}
...
std::function<void()>
Test::TestIntfPrx::opByteAsync(std::uint8_t iceP_b, std::function<void(std::uint8_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<std::uint8_t>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opByte, iceP_b, context);
}
...
std::function<void()>
Test::TestIntfPrx::opShortAsync(std::int16_t iceP_s, std::function<void(std::int16_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<std::int16_t>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opShort, iceP_s, context);
}
...
std::function<void()>
Test::TestIntfPrx::opIntAsync(std::int32_t iceP_i, std::function<void(std::int32_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<std::int32_t>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opInt, iceP_i, context);
}
...
std::function<void()>
Test::TestIntfPrx::opLongAsync(std::int64_t iceP_l, std::function<void(std::int64_t)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<std::int64_t>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opLong, iceP_l, context);
}
...
std::function<void()>
Test::TestIntfPrx::opFloatAsync(float iceP_f, std::function<void(float)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<float>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opFloat, iceP_f, context);
}
...
std::function<void()>
Test::TestIntfPrx::opDoubleAsync(double iceP_d, std::function<void(double)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<double>(std::move(response), std::move(exception), std::move(sent), this, &Test::TestIntfPrx::_iceI_opDouble, iceP_d, context);
}
...
{
    static constexpr std::array<std::string_view, 27> allOperations{"abortConnection", "closeConnection", "finishDispatch", "ice_id", "ice_ids", "ice_isA", "ice_ping", "op", "opBatch", "opBatchCount", "opBool", "opByte", "opDouble", "opFloat", "opInt", "opLong", "opShort", "opWithPayload", "opWithResult", "opWithUE", "pingBiDir", "shutdown", "sleep", "startDispatch", "supportsBackPressureTests", "supportsFunctionalTests", "waitForBatch"};
