...
/// \cond INTERNAL
bool
Test::TestIntf::_iceD_opIdempotent(::IceInternal::Incoming& incoming)
{
...
/// \cond INTERNAL
bool
Test::TestIntfController::_iceD_interrupt(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->interrupt(incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
Test::TestIntfController::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 5:
        {
            return _iceD_interrupt(incoming);
        }
        case 6:
        {
