...
void
Test::TestIntfPrx::opIdempotent(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_opIdempotent, context).get();
}

::std::future<void>
Test::TestIntfPrx::opIdempotentAsync(const ::Ice::Context& context)
{
...
void
Test::TestIntfPrx::sleep(int iceP_to, const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_sleep, iceP_to, context).get();
}

::std::future<void>
Test::TestIntfPrx::sleepAsync(int iceP_to, const ::Ice::Context& context)
{
...
void
Test::TestIntfControllerPrx::interrupt(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfControllerPrx::_iceI_interrupt, context).get();
}

::std::future<void>
Test::TestIntfControllerPrx::interruptAsync(const ::Ice::Context& context)
{
