...
/// \cond INTERNAL
bool
Test::BackgroundController::_iceD_initializeSocketStatus(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    auto istr = incoming.startReadParams();
    ...
    incoming.endReadParams();
    this->initializeSocketStatus(iceP_status, incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
Test::BackgroundController::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 7:
        {
            return _iceD_initializeSocketStatus(incoming);
        }
        case 8:
        {
