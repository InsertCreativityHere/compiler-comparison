...
const ::std::string iceC_Test_BackgroundController_initializeSocketStatus_name = "initializeSocketStatus";
...
/// \cond INTERNAL
bool
Test::BackgroundController::_iceD_initializeSocketStatus(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    int iceP_status;
    ...
    inS.endReadParams();
    this->initializeSocketStatus(iceP_status, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
...
Test::BackgroundController::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - iceC_Test_BackgroundController_ops)
    {
        ...
        case 7:
        {
            return _iceD_initializeSocketStatus(in, current);
        }
        case 8:
        {
...
/// \cond INTERNAL
void
Test::BackgroundControllerPrx::_iceI_initializeSocketStatus(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, int iceP_status, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Test_BackgroundController_initializeSocketStatus_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
...
::Ice::AsyncResultPtr
IceProxy::Test::BackgroundController::_iceI_begin_initializeSocketStatus(::Ice::Int iceP_status, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_BackgroundController_initializeSocketStatus_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_BackgroundController_initializeSocketStatus_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_status);
        result->endWriteParams();
        result->invoke(iceC_Test_BackgroundController_initializeSocketStatus_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::BackgroundController::end_initializeSocketStatus(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_BackgroundController_initializeSocketStatus_name);
}
...
Test::BackgroundController::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_BackgroundController_all, iceC_Test_BackgroundController_all + 15, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
