...
public:
    ...
    virtual void opOneOptionalReqAsync(::std::optional<OneOptionalPtr> p1, ::std::function<void(const ::std::optional<OneOptionalPtr>& returnValue, const ::std::optional<OneOptionalPtr>& p3)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
