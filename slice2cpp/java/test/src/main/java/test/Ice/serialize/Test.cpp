...
/// \cond INTERNAL
bool
Test::Initial::_iceD_getStruct1(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ByteS ret = this->getStruct1(incoming.current());
...
/// \cond INTERNAL
bool
Test::Initial::_iceD_getBase(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ByteS ret = this->getBase(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
/// \cond INTERNAL
bool
Test::Initial::_iceD_getEx(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    ByteS ret = this->getEx(incoming.current());
    auto ostr = incoming.startWriteParams();
    ostr->writeAll(ret);
    incoming.endWriteParams();
    return true;
...
Test::Initial::_iceDispatch(::IceInternal::Incoming& incoming)
{
    ...
    switch(r.first - allOperations)
    {
        case 0:
        {
            return _iceD_getBase(incoming);
        }
        case 1:
        {
            return _iceD_getEx(incoming);
        }
        case 2:
        {
            return _iceD_getStruct1(incoming);
        }
        case 3:
        {
