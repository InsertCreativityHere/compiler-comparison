...
public:
    ...
    /// \cond INTERNAL
    bool _iceD_throwTest1Notify(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    void throwTest1Notify(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &InitialPrx::_iceI_throwTest1Notify, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto throwTest1NotifyAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &InitialPrx::_iceI_throwTest1Notify, context);
    }
    ...
    throwTest1NotifyAsync(::std::function<void()> response,
                          ...
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Test::InitialPrx::_iceI_throwTest1Notify, context);
    }

    /// \cond INTERNAL
    void _iceI_throwTest1Notify(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::Initial::begin_throwTest1Notify.
 * Create a wrapper instance by calling ::Test::newCallback_Initial_throwTest1Notify.
 */
class Callback_Initial_throwTest1Notify_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Initial_throwTest1Notify_Base> Callback_Initial_throwTest1NotifyPtr;
...
public:
    ...
    void throwTest1Notify(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_throwTest1Notify(_iceI_begin_throwTest1Notify(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_throwTest1Notify(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_throwTest1Notify(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_throwTest1Notify(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_throwTest1Notify(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_throwTest1Notify(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_throwTest1Notify(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_throwTest1Notify(const ::Test::Callback_Initial_throwTest1NotifyPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_throwTest1Notify(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_throwTest1Notify(const ::Ice::Context& context, const ::Test::Callback_Initial_throwTest1NotifyPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_throwTest1Notify(context, cb, cookie);
    }

    void end_throwTest1Notify(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_throwTest1Notify(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual void throwTest1Notify(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_throwTest1Notify(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_Initial_throwTest1Notify : public Callback_Initial_throwTest1Notify_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_Initial_throwTest1Notify(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            proxy->end_throwTest1Notify(result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_throwTest1Notify.
 */
template<class T> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_throwTest1Notify<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_throwTest1Notify<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_throwTest1Notify<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Initial_throwTest1Notify<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Initial_throwTest1Notify : public Callback_Initial_throwTest1Notify_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_Initial_throwTest1Notify(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Initial::begin_throwTest1Notify.
 */
template<class T, typename CT> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_throwTest1Notify<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_throwTest1Notify<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_throwTest1Notify<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Initial_throwTest1NotifyPtr
newCallback_Initial_throwTest1Notify(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Initial_throwTest1Notify<T, CT>(instance, 0, excb, sentcb);
}
