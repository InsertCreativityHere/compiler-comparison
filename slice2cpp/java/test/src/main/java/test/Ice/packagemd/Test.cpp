...
void
Test::InitialPrx::throwTest1Notify(const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &InitialPrx::_iceI_throwTest1Notify, context).get();
}

::std::future<void>
Test::InitialPrx::throwTest1NotifyAsync(const ::Ice::Context& context)
{
    return _makePromiseOutgoing<void, ::std::promise>(false, this, &InitialPrx::_iceI_throwTest1Notify, context);
}

::std::function<void()>
Test::InitialPrx::throwTest1NotifyAsync(::std::function<void ()> response,
                                        ::std::function<void(::std::exception_ptr)> ex,
                                        ::std::function<void(bool)> sent,
                                        const ::Ice::Context& context)
{
