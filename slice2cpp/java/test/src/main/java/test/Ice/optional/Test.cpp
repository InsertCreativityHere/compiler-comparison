...
Test::Initial::_iceD_opOneOptionalProxyReq(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    std::optional<::std::shared_ptr<::Ice::ObjectPrx>> iceP_p3;
    std::optional<::std::shared_ptr<::Ice::ObjectPrx>> ret = this->opOneOptionalProxyReq(::std::move(iceP_p1), iceP_p3, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1, 3}, ret, iceP_p3);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opOneOptionalProxyReq(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    std::optional<OneOptionalPrx> iceP_p3;
    std::optional<OneOptionalPrx> ret = this->opOneOptionalProxyReq(iceP_p1, iceP_p3, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(1, ret);
    ostr->write(3, iceP_p3);
    inS.endWriteParams();
