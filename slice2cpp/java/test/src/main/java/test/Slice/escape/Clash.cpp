...
Clash::Cls::_iceWriteImpl(Ice::OutputStream* ostr) const
{
    ...
    ostr->writeAll(this->s, this->context, this->current, this->response, this->typeId, this->del, this->ex, this->result, this->istr, this->ostr, this->inS, this->in, this->proxy, this->obj, this->getCookie);
...
{
    istr->startSlice();
    istr->readAll(this->s, this->context, this->current, this->response, this->typeId, this->del, this->ex, this->result, this->istr, this->ostr, this->inS, this->in, this->proxy, this->obj, this->getCookie);
