...
namespace
{
    const IceInternal::ClassInit<::abstract::notify> iceC_abstract_notify_init;
    const IceInternal::ExceptionInit<::abstract::hashCode> iceC_abstract_hashCode_init;
    const IceInternal::ExceptionInit<::abstract::clone> iceC_abstract_clone_init;
}
...
::abstract::assert
abstract::finalizePrx::notify(const break& iceP_notifyAll, const notifyPtr& iceP_null, const std::optional<finalizePrx>& iceP_package, const std::optional<defaultPrx>& iceP_return, std::int32_t iceP_super, const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<assert>(true, this, &finalizePrx::_iceI_notify, iceP_notifyAll, iceP_null, iceP_package, iceP_return, iceP_super, context).get();
}

std::future<::abstract::assert>
abstract::finalizePrx::notifyAsync(const break& iceP_notifyAll, const notifyPtr& iceP_null, const std::optional<finalizePrx>& iceP_package, const std::optional<defaultPrx>& iceP_return, std::int32_t iceP_super, const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<assert>(false, this, &finalizePrx::_iceI_notify, iceP_notifyAll, iceP_null, iceP_package, iceP_return, iceP_super, context);
}

std::function<void()>
abstract::finalizePrx::notifyAsync(const break& iceP_notifyAll, const notifyPtr& iceP_null, const std::optional<finalizePrx>& iceP_package, const std::optional<defaultPrx>& iceP_return, std::int32_t iceP_super, std::function<void(::abstract::assert)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<assert>(std::move(response), std::move(exception), std::move(sent), this, &abstract::finalizePrx::_iceI_notify, iceP_notifyAll, iceP_null, iceP_package, iceP_return, iceP_super, context);
}

void
abstract::finalizePrx::_iceI_notify(const std::shared_ptr<IceInternal::OutgoingAsyncT<assert>>& outAsync, const break& iceP_notifyAll, const notifyPtr& iceP_null, const std::optional<finalizePrx>& iceP_package, const std::optional<defaultPrx>& iceP_return, std::int32_t iceP_super, const Ice::Context& context) const
{
    ...
    outAsync->invoke(
        ...
        [&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_notifyAll, iceP_null, iceP_package, iceP_return, iceP_super);
...
const char*
abstract::notify::ice_staticId() noexcept
{
    return "::abstract::notify";
}

const char*
abstract::notify::ice_id() const noexcept
{
    return ice_staticId();
}

void
abstract::notify::ice_printFields(std::ostream& os) const
{
...
Ice::ValuePtr
abstract::notify::_iceCloneImpl() const
{
    return CloneEnabler<notify>::clone(*this);
}

void
abstract::notify::_iceWriteImpl(Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    ostr->writeAll(this->if, this->equals);
    ostr->endSlice();
}

void
abstract::notify::_iceReadImpl(Ice::InputStream* istr)
{
    istr->startSlice();
    istr->readAll(this->if, this->equals);
    istr->endSlice();
}
...
void
abstract::clone::ice_printFields(std::ostream& os) const
{
...
const char*
abstract::clone::ice_staticId() noexcept
{
    return "::abstract::clone";
}

const char*
abstract::clone::ice_id() const noexcept
{
    return ice_staticId();
}

void
abstract::clone::ice_throw() const
{
    throw *this;
}

void
abstract::clone::_writeImpl(Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, false);
    ostr->writeAll(this->native);
    ostr->endSlice();
    hashCode::_writeImpl(ostr);
}

void
abstract::clone::_readImpl(Ice::InputStream* istr)
{
    istr->startSlice();
    istr->readAll(this->native);
    istr->endSlice();
...
{
    static constexpr std::array<std::string_view, 7> allOperations{"checkedCast", "do", "ice_id", "ice_ids", "ice_isA", "ice_ping", "notify"};
...
void
abstract::finalize::_iceD_notify(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
    ...
    istr->readAll(iceP_notifyAll, iceP_null, iceP_package, iceP_return, iceP_super);
    istr->readPendingValues();
    istr->endEncapsulation();
    const assert ret = this->notify(iceP_notifyAll, std::move(iceP_null), std::move(iceP_package), std::move(iceP_return), iceP_super, request.current());
