...
::Ice::AsyncResultPtr
IceProxy::Test::Interface1::_iceI_begin_method(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_Interface1_method_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_Interface1_method_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Test_Interface1_method_name);
    }
...
void
IceProxy::Test::Interface1::end_method(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_Interface1_method_name);
}
...
namespace
{
const ::std::string iceC_Test_Interface1_all[] =
{
    "ice_id",
    "ice_ids",
    "ice_isA",
...
Test::Interface1::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Test_Interface1_all, iceC_Test_Interface1_all + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_Test_Interface1_all)
    {
        case 0:
        {
            return _iceD_ice_id(in, current);
...
/// \cond INTERNAL
::Ice::Object* Test2::upCast(Class1* p) { return p; }
...
namespace
{
const ::std::string iceC_Test2_Class1_ids[2] =
{
    "::Ice::Object",
    "::Test2::Class1"
};
...
bool
Test2::Class1::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_Test2_Class1_ids, iceC_Test2_Class1_ids + 2, s);
}

::std::vector< ::std::string>
Test2::Class1::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&iceC_Test2_Class1_ids[0], &iceC_Test2_Class1_ids[2]);
}

const ::std::string&
Test2::Class1::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}
...
::Ice::ValueFactoryPtr
Test2::Class1::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::Test2::Class1::ice_staticId());
}

/// \cond INTERNAL
void
Test2::_icePatchObjectPtr(Class1Ptr& handle, const ::Ice::ObjectPtr& v)
{
