...
namespace
{
    const IceInternal::ClassInit<::Test2::Class1> iceC_Test2_Class1_init;
}
...
std::function<void()>
Test::Interface1Prx::methodAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::Interface1Prx::_iceI_method, context);
}
...
{
    static constexpr std::array<std::string_view, 5> allOperations{"ice_id", "ice_ids", "ice_isA", "ice_ping", "method"};
