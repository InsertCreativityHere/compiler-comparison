...
namespace
{
    const IceInternal::ClassInit<::Test::Common::Config> iceC_Test_Common_Config_init;
    const IceInternal::ClassInit<::Test::Common::OptionOverrides> iceC_Test_Common_OptionOverrides_init;
    const IceInternal::ExceptionInit<::Test::Common::TestCaseNotExistException> iceC_Test_Common_TestCaseNotExistException_init;
    const IceInternal::ExceptionInit<::Test::Common::TestCaseFailedException> iceC_Test_Common_TestCaseFailedException_init;
    const IceInternal::ExceptionInit<::Test::Common::ProcessFailedException> iceC_Test_Common_ProcessFailedException_init;
}
