...
const ::std::string iceC_Clash_Intf_ok_name = "ok";
const ::std::string iceC_Clash_Intf_target_name = "target";
...
/// \cond INTERNAL
bool
Clash::Intf::_iceD_ok(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    this->ok(current);
...
/// \cond INTERNAL
bool
Clash::Intf::_iceD_target(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    this->target(current);
...
Clash::Intf::_iceD_op(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    Ice::optional<::std::string> iceP_ok;
    istr->readAll(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target);
    istr->readAll({1, 2}, iceP_proxy, iceP_ok);
    inS.endReadParams();
    this->op(::std::move(iceP_context), ::std::move(iceP_current), ::std::move(iceP_response), ::std::move(iceP_ex), ::std::move(iceP_sent), ::std::move(iceP_cookie), ::std::move(iceP_sync), ::std::move(iceP_result), ::std::move(iceP_istr), ::std::move(iceP_ostr), ::std::move(iceP_target), ::std::move(iceP_proxy), ::std::move(iceP_ok), current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
...
Clash::Intf::_iceD_opOut(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    Ice::optional<::std::string> iceP_proxy;
    Ice::optional<::std::string> iceP_ok;
    this->opOut(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target);
    ostr->writeAll({1, 2}, iceP_proxy, iceP_ok);
    inS.endWriteParams();
    return true;
}
/// \endcond
...
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Clash_Intf_ops, iceC_Clash_Intf_ops + 18, current.operation);
    if(r.first == r.second)
    {
    ...
    switch(r.first - iceC_Clash_Intf_ops)
    {
        ...
        case 15:
        {
            return _iceD_target(in, current);
        }
        case 16:
        {
...
/// \cond INTERNAL
void
Clash::IntfPrx::_iceI_ok(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Clash_Intf_ok_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
/// \cond INTERNAL
void
Clash::IntfPrx::_iceI_target(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Clash_Intf_target_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
Clash::IntfPrx::_iceI_opOut(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<Intf::OpOutResult>>& outAsync, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_Clash_Intf_opOut_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        {
            Intf::OpOutResult v;
            istr->readAll(v.context, v.current, v.response, v.ex, v.sent, v.cookie, v.sync, v.result, v.istr, v.ostr, v.target);
            istr->readAll({1, 2}, v.proxy, v.ok);
            return v;
        });
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::Clash::Intf::_iceI_begin_ok(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Clash_Intf_ok_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Clash_Intf_ok_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Clash_Intf_ok_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Clash::Intf::end_ok(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Clash_Intf_ok_name);
}

::Ice::AsyncResultPtr
IceProxy::Clash::Intf::_iceI_begin_target(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Clash_Intf_target_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Clash_Intf_target_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Clash_Intf_target_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Clash::Intf::end_target(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Clash_Intf_target_name);
}

::Ice::AsyncResultPtr
IceProxy::Clash::Intf::_iceI_begin_op(const ::std::string& iceP_context, const ::std::string& iceP_current, const ::std::string& iceP_response, const ::std::string& iceP_ex, const ::std::string& iceP_sent, const ::std::string& iceP_cookie, const ::std::string& iceP_sync, const ::std::string& iceP_result, const ::std::string& iceP_istr, const ::std::string& iceP_ostr, const ::std::string& iceP_target, const IceUtil::Optional< ::std::string>& iceP_proxy, const IceUtil::Optional< ::std::string>& iceP_ok, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
Clash::Intf::_iceD_op(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(2, iceP_ok);
    inS.endReadParams();
    this->op(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
...
Clash::Intf::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Clash_Intf_all, iceC_Clash_Intf_all + 18, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
