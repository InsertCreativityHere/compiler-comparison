...
public:
    ...
    virtual void ok(const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_ok(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void target(const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_target(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void op(::std::string context, ::std::string current, ::std::string response, ::std::string ex, ::std::string sent, ::std::string cookie, ::std::string sync, ::std::string result, ::std::string istr, ::std::string ostr, ::std::string target, Ice::optional<::std::string> proxy, Ice::optional<::std::string> ok, const ::Ice::Current& current_) = 0;
    /// \cond INTERNAL
    ...
    struct OpOutResult
    {
        ...
        Ice::optional<::std::string> ok;
    };

    virtual void opOut(::std::string& context, ::std::string& current, ::std::string& response, ::std::string& ex, ::std::string& sent, ::std::string& cookie, ::std::string& sync, ::std::string& result, ::std::string& istr, ::std::string& ostr, ::std::string& target, Ice::optional<::std::string>& proxy, Ice::optional<::std::string>& ok, const ::Ice::Current& current_) = 0;
    /// \cond INTERNAL
...
public:
     ...
     * One-shot constructor to initialize all data members.
     */
    Cls(const ::std::shared_ptr<::Clash::IntfPrx>& s, const ::std::string& context, int current, short response, const ::std::string& upCast, int typeId, short del, const Ice::optional<short>& cookie, const ::std::string& ex, int result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& inS, const ::std::string& in, const ::std::string& proxy, const Ice::optional<int>& stream, const ::std::string& target) :
        s(s),
        context(context),
        current(current),
        response(response),
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const ::std::shared_ptr<::Clash::IntfPrx>&, const ::std::string&, const int&, const short&, const ::std::string&, const int&, const short&, const Ice::optional<short>&, const ::std::string&, const int&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const Ice::optional<int>&, const ::std::string&> ice_tuple() const
    {
        return std::tie(s, context, current, response, upCast, typeId, del, cookie, ex, result, istr, ostr, inS, in, proxy, stream, target);
    }
...
public:
    ...
    void ok(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &IntfPrx::_iceI_ok, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto okAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &IntfPrx::_iceI_ok, context);
    }

    ::std::function<void()>
    okAsync(::std::function<void()> response,
            ::std::function<void(::std::exception_ptr)> ex = nullptr,
            ::std::function<void(bool)> sent = nullptr,
            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
    ...
    /// \cond INTERNAL
    void _iceI_ok(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond

    void target(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &IntfPrx::_iceI_target, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto targetAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &IntfPrx::_iceI_target, context);
    }

    ::std::function<void()>
    targetAsync(::std::function<void()> response,
                ::std::function<void(::std::exception_ptr)> ex = nullptr,
                ::std::function<void(bool)> sent = nullptr,
                const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
    ...
    /// \cond INTERNAL
    void _iceI_target(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::Ice::Context&);
    /// \endcond

    void op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const Ice::optional<::std::string>& proxy, const Ice::optional<::std::string>& ok, const ::Ice::Context& context_ = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &IntfPrx::_iceI_op, context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_).get();
    }
    ...
    auto opAsync(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const Ice::optional<::std::string>& proxy, const Ice::optional<::std::string>& ok, const ::Ice::Context& context_ = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &IntfPrx::_iceI_op, context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_);
    }

    ::std::function<void()>
    opAsync(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const Ice::optional<::std::string>& proxy, const Ice::optional<::std::string>& ok,
    ...
    /// \cond INTERNAL
    void _iceI_op(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const Ice::optional<::std::string>&, const Ice::optional<::std::string>&, const ::Ice::Context&);
    /// \endcond

    void opOut(::std::string& context, ::std::string& current, ::std::string& response, ::std::string& ex, ::std::string& sent, ::std::string& cookie, ::std::string& sync, ::std::string& result, ::std::string& istr, ::std::string& ostr, ::std::string& target, Ice::optional<::std::string>& proxy, Ice::optional<::std::string>& ok, const ::Ice::Context& context_ = ::Ice::noExplicitContext)
    {
    ...
    ::std::function<void()>
    opOutAsync(::std::function<void(::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, ::std::string, Ice::optional<::std::string>, Ice::optional<::std::string>)> response,
               ::std::function<void(::std::exception_ptr)> ex = nullptr,
               ::std::function<void(bool)> sent = nullptr,
               const ::Ice::Context& context_ = ::Ice::noExplicitContext)
    {
...
struct StreamWriter<::Clash::Cls, S>
{
    ...
    {
        ostr->writeAll(v.s, v.context, v.current, v.response, v.upCast, v.typeId, v.del, v.ex, v.result, v.istr, v.ostr, v.inS, v.in, v.proxy, v.target);
        ostr->writeAll({1, 2}, v.cookie, v.stream);
    }
};
...
struct StreamReader<::Clash::Cls, S>
{
    ...
    {
        istr->readAll(v.s, v.context, v.current, v.response, v.upCast, v.typeId, v.del, v.ex, v.result, v.istr, v.ostr, v.inS, v.in, v.proxy, v.target);
        istr->readAll({1, 2}, v.cookie, v.stream);
    }
};
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Clash::Intf::begin_ok.
 * Create a wrapper instance by calling ::Clash::newCallback_Intf_ok.
 */
class Callback_Intf_ok_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Intf_ok_Base> Callback_Intf_okPtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Clash::Intf::begin_target.
 * Create a wrapper instance by calling ::Clash::newCallback_Intf_target.
 */
class Callback_Intf_target_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Intf_target_Base> Callback_Intf_targetPtr;
...
public:
    ...
    void ok(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_ok(_iceI_begin_ok(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_ok(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_ok(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_ok(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ok(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ok(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ok(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ok(const ::Clash::Callback_Intf_okPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ok(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ok(const ::Ice::Context& context, const ::Clash::Callback_Intf_okPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ok(context, cb, cookie);
    }

    void end_ok(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_ok(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    void target(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_target(_iceI_begin_target(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_target(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_target(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_target(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_target(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_target(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_target(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_target(const ::Clash::Callback_Intf_targetPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_target(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_target(const ::Ice::Context& context, const ::Clash::Callback_Intf_targetPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_target(context, cb, cookie);
    }

    void end_target(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_target(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    void op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Ice::Context& context_ = ::Ice::noExplicitContext)
    {
        end_op(_iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, ::IceInternal::dummyCallback, 0, true));
    }
    ...
    {
        return _iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie_ = 0)
    {
        return _iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, ::Ice::noExplicitContext, cb, cookie_);
    }

    ::Ice::AsyncResultPtr begin_op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Ice::Context& context_, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie_ = 0)
    {
        return _iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, cb, cookie_);
    }

    ::Ice::AsyncResultPtr begin_op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Clash::Callback_Intf_opPtr& cb, const ::Ice::LocalObjectPtr& cookie_ = 0)
    {
        return _iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, ::Ice::noExplicitContext, cb, cookie_);
    }

    ::Ice::AsyncResultPtr begin_op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Ice::Context& context_, const ::Clash::Callback_Intf_opPtr& cb, const ::Ice::LocalObjectPtr& cookie_ = 0)
    {
        return _iceI_begin_op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, cb, cookie_);
    }
...
private:
    ...
    ::Ice::AsyncResultPtr _iceI_begin_op(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    void opOut(::std::string& context, ::std::string& current, ::std::string& response, ::std::string& ex, ::std::string& sent, ::std::string& cookie, ::std::string& sync, ::std::string& result, ::std::string& istr, ::std::string& ostr, ::std::string& target, IceUtil::Optional< ::std::string>& proxy, IceUtil::Optional< ::std::string>& ok, const ::Ice::Context& context_ = ::Ice::noExplicitContext)
    {
        end_opOut(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, _iceI_begin_opOut(context_, ::IceInternal::dummyCallback, 0, true));
    }
    ...
    void end_opOut(::std::string& context, ::std::string& current, ::std::string& response, ::std::string& ex, ::std::string& sent, ::std::string& cookie, ::std::string& sync, ::std::string& result, ::std::string& istr, ::std::string& ostr, ::std::string& target, IceUtil::Optional< ::std::string>& proxy, IceUtil::Optional< ::std::string>& ok, const ::Ice::AsyncResultPtr& result_);
    /// \cond INTERNAL

    void _iceI_end_opOut(::std::string& iceP_context, ::std::string& iceP_current, ::std::string& iceP_response, ::std::string& iceP_ex, ::std::string& iceP_sent, ::std::string& iceP_cookie, ::std::string& iceP_sync, ::std::string& iceP_result, ::std::string& iceP_istr, ::std::string& iceP_ostr, ::std::string& iceP_target, IceUtil::Optional< ::std::string>& iceP_proxy, IceUtil::Optional< ::std::string>& iceP_ok, const ::Ice::AsyncResultPtr&);
    /// \endcond
...
public:
    ...
    virtual void ok(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_ok(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void target(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_target(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void op(const ::std::string& context, const ::std::string& current, const ::std::string& response, const ::std::string& ex, const ::std::string& sent, const ::std::string& cookie, const ::std::string& sync, const ::std::string& result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& target, const IceUtil::Optional< ::std::string>& proxy, const IceUtil::Optional< ::std::string>& ok, const ::Ice::Current& current_ = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_op(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void opOut(::std::string& context, ::std::string& current, ::std::string& response, ::std::string& ex, ::std::string& sent, ::std::string& cookie, ::std::string& sync, ::std::string& result, ::std::string& istr, ::std::string& ostr, ::std::string& target, IceUtil::Optional< ::std::string>& proxy, IceUtil::Optional< ::std::string>& ok, const ::Ice::Current& current_ = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opOut(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
     ...
     * One-shot constructor to initialize all data members.
     */
    Cls(const ::Clash::IntfPrx& s, const ::std::string& context, ::Ice::Int current, ::Ice::Short response, const ::std::string& upCast, ::Ice::Int typeId, ::Ice::Short del, const IceUtil::Optional< ::Ice::Short>& cookie, const ::std::string& ex, ::Ice::Int result, const ::std::string& istr, const ::std::string& ostr, const ::std::string& inS, const ::std::string& in, const ::std::string& proxy, const IceUtil::Optional< ::Ice::Int>& stream, const ::std::string& target) :
        s(s),
        context(context),
        current(current),
        response(response),
...
public:
    ...
    ::std::string in;
    ::std::string proxy;
    IceUtil::Optional< ::Ice::Int> stream;
    ::std::string target;
};
/// \cond INTERNAL
 ...
 */
template<class T>
class CallbackNC_Intf_ok : public Callback_Intf_ok_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_Intf_ok(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Clash::Intf::begin_ok.
 */
template<class T> Callback_Intf_okPtr
newCallback_Intf_ok(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_ok<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_okPtr
newCallback_Intf_ok(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_ok<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_okPtr
newCallback_Intf_ok(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_ok<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_okPtr
newCallback_Intf_ok(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_ok<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Intf_ok : public Callback_Intf_ok_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_Intf_ok(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Clash::Intf::begin_ok.
 */
template<class T, typename CT> Callback_Intf_okPtr
newCallback_Intf_ok(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_ok<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_okPtr
newCallback_Intf_ok(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_ok<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_okPtr
newCallback_Intf_ok(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_ok<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_okPtr
newCallback_Intf_ok(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_ok<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_Intf_target : public Callback_Intf_target_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_Intf_target(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Clash::Intf::begin_target.
 */
template<class T> Callback_Intf_targetPtr
newCallback_Intf_target(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_target<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_targetPtr
newCallback_Intf_target(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_target<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_targetPtr
newCallback_Intf_target(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_target<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Intf_targetPtr
newCallback_Intf_target(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_target<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Intf_target : public Callback_Intf_target_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_Intf_target(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Clash::Intf::begin_target.
 */
template<class T, typename CT> Callback_Intf_targetPtr
newCallback_Intf_target(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_target<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_targetPtr
newCallback_Intf_target(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_target<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_targetPtr
newCallback_Intf_target(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_target<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Intf_targetPtr
newCallback_Intf_target(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_target<T, CT>(instance, 0, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&);
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        IceUtil::Optional< ::std::string> iceP_ok;
        try
        {
            proxy->end_opOut(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok, result);
        }
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok);
        }
    }
    /// \endcond
...
newCallback_Intf_opOut(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
 ...
 */
template<class T> Callback_Intf_opOutPtr
newCallback_Intf_opOut(T* instance, void (T::*cb)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Intf_opOut<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&, const CT&);
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
...
newCallback_Intf_opOut(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
 ...
 */
template<class T, typename CT> Callback_Intf_opOutPtr
newCallback_Intf_opOut(T* instance, void (T::*cb)(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const IceUtil::Optional< ::std::string>&, const IceUtil::Optional< ::std::string>&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Intf_opOut<T, CT>(instance, cb, excb, sentcb);
}
