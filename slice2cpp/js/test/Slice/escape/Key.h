...
public:
    ...
    {
        return _makeLamdaOutgoing<int>(std::move(response), std::move(ex), std::move(sent), this, &await::casePrx::_iceI_catch, checked, context);
    }
...
public:
    ...
    defaultAsync(::std::function<void()> response,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &await::typeofPrx::_iceI_default, context);
    }
...
public:
    ...
    forAsync(const Ice::optional<var>& _cpp_goto, const Ice::optional<::std::shared_ptr<::Ice::Value>>& _cpp_if, const Ice::optional<_cpp_while>& internal, const Ice::optional<::std::string>& _cpp_namespace, const Ice::optional<::std::shared_ptr<explicitPrx>>& null,
             ...
             const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<Ice::optional<::await::_cpp_break>>(std::move(response), std::move(ex), std::move(sent), this, &await::optionalParamsPrx::_iceI_for, _cpp_goto, _cpp_if, internal, _cpp_namespace, null, context);
    }
    ...
    continueAsync(const Ice::optional<var>& _cpp_goto, const Ice::optional<::std::shared_ptr<::Ice::Value>>& _cpp_if, const Ice::optional<_cpp_while>& internal, const Ice::optional<::std::string>& _cpp_namespace, const Ice::optional<::std::shared_ptr<explicitPrx>>& null,
                  ...
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<Ice::optional<::await::_cpp_break>>(std::move(response), std::move(ex), std::move(sent), this, &await::optionalParamsPrx::_iceI_continue, _cpp_goto, _cpp_if, internal, _cpp_namespace, null, context);
    }
            ...
            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        ...
        return _makeLamdaOutgoing<optionalParams::InResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &await::optionalParamsPrx::_iceI_in, context);
    }
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        ...
        return _makeLamdaOutgoing<optionalParams::ForeachResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &await::optionalParamsPrx::_iceI_foreach, context);
    }
...
public:
    ...
    opAsync(::std::function<void()> response,
            ...
            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &await::System::TestPrx::_iceI_op, context);
    }
...
public:
    ...
    virtual var in(const _cpp_break& internal, const deletePtr& is, const explicitPtr& lock, const casePrx& _cpp_namespace, const typeofPrx& _cpp_new, const deletePtr& null, const explicitPrx& _cpp_operator, ::Ice::Int override, ::Ice::Int params, ::Ice::Int _cpp_private) = 0;
};
