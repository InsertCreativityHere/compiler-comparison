...
public:
     ...
     */
    _cpp_delete(int _cpp_if, const ::std::optional<::await::casePrx>& _cpp_else, int _cpp_export) :
        _cpp_if(_cpp_if),
        _cpp_else(_cpp_else),
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const int&, const ::std::optional<::await::casePrx>&, const int&> ice_tuple() const
    {
...
public:
    ...
    virtual var in(_cpp_break internal, ::std::shared_ptr<delete> is, ::std::optional<explicitPrx> lock, ::std::optional<casePrx> _cpp_namespace, ::std::optional<typeofPrx> _cpp_new, ::std::shared_ptr<delete> null, ::std::optional<explicitPrx> _cpp_operator, int override, int params, int _cpp_private, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_in(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
