...
std::function<void()>
Test::MyClassPrx::opDoubleMarshalingAsync(double iceP_p1, const DoubleS& iceP_p2, std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyClassPrx::_iceI_opDoubleMarshaling, iceP_p1, iceP_p2, context);
}
...
{
    static constexpr std::string_view operationName = "opDoubleMarshaling";
...
std::function<void()>
Test::MyClassPrx::opWStringLiteralsAsync(std::function<void(::Test::WStringS)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<WStringS>(std::move(response), std::move(exception), std::move(sent), this, &Test::MyClassPrx::_iceI_opWStringLiterals, context);
}
...
{
    static constexpr std::string_view operationName = "opWStringLiterals";
...
void
Test::APrx::opA(const Ice::Context& context) const
{
    IceInternal::makePromiseOutgoing<void>(true, this, &APrx::_iceI_opA, context).get();
}

std::future<void>
Test::APrx::opAAsync(const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<void>(false, this, &APrx::_iceI_opA, context);
}

std::function<void()>
Test::APrx::opAAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::APrx::_iceI_opA, context);
}

void
Test::APrx::_iceI_opA(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>& outAsync, const Ice::Context& context) const
{
...
void
Test::BPrx::opB(const Ice::Context& context) const
{
    IceInternal::makePromiseOutgoing<void>(true, this, &BPrx::_iceI_opB, context).get();
}

std::future<void>
Test::BPrx::opBAsync(const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<void>(false, this, &BPrx::_iceI_opB, context);
}

std::function<void()>
Test::BPrx::opBAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::BPrx::_iceI_opB, context);
}

void
Test::BPrx::_iceI_opB(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>& outAsync, const Ice::Context& context) const
{
...
void
Test::CPrx::opC(const Ice::Context& context) const
{
    IceInternal::makePromiseOutgoing<void>(true, this, &CPrx::_iceI_opC, context).get();
}

std::future<void>
Test::CPrx::opCAsync(const Ice::Context& context) const
{
    return IceInternal::makePromiseOutgoing<void>(false, this, &CPrx::_iceI_opC, context);
}

std::function<void()>
Test::CPrx::opCAsync(std::function<void()> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<void>(std::move(response), std::move(exception), std::move(sent), this, &Test::CPrx::_iceI_opC, context);
}

void
Test::CPrx::_iceI_opC(const std::shared_ptr<IceInternal::OutgoingAsyncT<void>>& outAsync, const Ice::Context& context) const
{
...
Test::MyClass::dispatch(Ice::IncomingRequest& request, std::function<void(Ice::OutgoingResponse)> sendResponse)
{
    ...
    switch (r.first - allOperations.begin())
    {
        ...
        case 21:
        {
            _iceD_opDoubleMarshaling(request, std::move(sendResponse));
            break;
        }
        case 22:
        {
        ...
        case 71:
        {
            _iceD_opWStringLiterals(request, std::move(sendResponse));
            break;
        }
        case 72:
        {
    ...
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    ...
    istr->readAll(iceP_p1, iceP_p2);
    istr->endEncapsulation();
    this->opDoubleMarshaling(iceP_p1, std::move(iceP_p2), request.current());
    sendResponse(Ice::makeEmptyOutgoingResponse(request.current()));
}
...
void
Test::MyClass::_iceD_opWStringLiterals(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    checkNonIdempotent(request.current());
    request.inputStream().skipEmptyEncapsulation();
    const WStringS ret = this->opWStringLiterals(request.current());
    sendResponse(Ice::makeOutgoingResponse([&](Ice::OutputStream* ostr)
        {
            ostr->writeAll(ret);
        },
...
{
    static constexpr std::array<std::string_view, 7> allOperations{"ice_id", "ice_ids", "ice_isA", "ice_ping", "opA", "opB", "opC"};
