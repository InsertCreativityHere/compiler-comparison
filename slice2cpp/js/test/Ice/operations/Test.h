...
public:
    ...
    auto supportsCompressAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &EchoPrx::_iceI_supportsCompress, context);
    }
    ...
    supportsCompressAsync(::std::function<void(bool)> response,
                          ...
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(std::move(response), std::move(ex), std::move(sent), this, &Test::EchoPrx::_iceI_supportsCompress, context);
    }
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::Echo::begin_supportsCompress.
 * Create a wrapper instance by calling ::Test::newCallback_Echo_supportsCompress.
 */
class Callback_Echo_supportsCompress_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Echo_supportsCompress_Base> Callback_Echo_supportsCompressPtr;
...
public:
    ...
    ::Ice::AsyncResultPtr begin_supportsCompress(const ::Test::Callback_Echo_supportsCompressPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_supportsCompress(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_supportsCompress(const ::Ice::Context& context, const ::Test::Callback_Echo_supportsCompressPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_supportsCompress(context, cb, cookie);
    }
 ...
 */
template<class T>
class CallbackNC_Echo_supportsCompress : public Callback_Echo_supportsCompress_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_Echo_supportsCompress(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        EchoPrx proxy = EchoPrx::uncheckedCast(result->getProxy());
        bool ret;
        try
        {
            ret = proxy->end_supportsCompress(result);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Echo::begin_supportsCompress.
 */
template<class T> Callback_Echo_supportsCompressPtr
newCallback_Echo_supportsCompress(const IceUtil::Handle<T>& instance, void (T::*cb)(bool), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Echo_supportsCompress<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_Echo_supportsCompressPtr
newCallback_Echo_supportsCompress(T* instance, void (T::*cb)(bool), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Echo_supportsCompress<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Echo_supportsCompress : public Callback_Echo_supportsCompress_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_Echo_supportsCompress(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::Echo::begin_supportsCompress.
 */
template<class T, typename CT> Callback_Echo_supportsCompressPtr
newCallback_Echo_supportsCompress(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Echo_supportsCompress<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_Echo_supportsCompressPtr
newCallback_Echo_supportsCompress(T* instance, void (T::*cb)(bool, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Echo_supportsCompress<T, CT>(instance, cb, excb, sentcb);
}
