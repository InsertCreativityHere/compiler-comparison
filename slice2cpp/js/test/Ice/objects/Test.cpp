...
/// \cond INTERNAL
bool
Test::I::_iceD_doI(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->doI(incoming.current());
...
/// \cond INTERNAL
bool
Test::J::_iceD_doJ(::IceInternal::Incoming& incoming)
{
    _iceCheckMode(::Ice::OperationMode::Normal, incoming.current().mode);
    incoming.readEmptyParams();
    this->doJ(incoming.current());
    incoming.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
bool
Test::J::_iceDispatch(::IceInternal::Incoming& incoming)
{
