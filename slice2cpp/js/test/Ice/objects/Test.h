...
public:
    ...
    ::std::function<void()>
    doIAsync(::std::function<void()> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
...
public:
    ...
    ::std::function<void()>
    doJAsync(::std::function<void()> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
...
public:
    ...
    B(::std::shared_ptr<::Test::B> theB, ::std::shared_ptr<::Test::C> theC, bool preMarshalInvoked, bool postUnmarshalInvoked, ::std::shared_ptr<::Test::A> theA) :
        Ice::ValueHelper<B, A>(::std::move(theB), ::std::move(theC), preMarshalInvoked, postUnmarshalInvoked),
        theA(::std::move(theA))
    {
    }
...
public:
    ...
    G(::Test::S theS, ::std::string str) :
        Ice::ValueHelper<G, Base>(::std::move(theS), ::std::move(str))
    {
    }
...
public:
    ...
    D1(::std::shared_ptr<::Test::A1> a1, ::std::shared_ptr<::Test::A1> a2, ::std::shared_ptr<::Test::A1> a3, ::std::shared_ptr<::Test::A1> a4) :
        Ice::ValueHelper<D1, B1>(::std::move(a1), ::std::move(a2)),
        a3(::std::move(a3)),
        a4(::std::move(a4))
    {
    }
