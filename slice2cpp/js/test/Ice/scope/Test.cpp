...
{
    static constexpr ::std::array<::std::string_view, 14> allOperations{"ice_id", "ice_ids", "ice_isA", "ice_ping", "opC", "opC1", "opCMap", "opCSeq", "opE1", "opS", "opS1", "opSMap", "opSSeq", "shutdown"};
