...
const ::std::string iceC_Test_TestIntf_pingBidDir_name = "pingBidDir";
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_pingBidDir(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Identity& iceP_id, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Test_TestIntf_pingBidDir_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_pingBidDir(const ::Ice::Identity& iceP_id, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Test_TestIntf_pingBidDir_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Test_TestIntf_pingBidDir_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_id);
        result->endWriteParams();
        result->invoke(iceC_Test_TestIntf_pingBidDir_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Test::TestIntf::end_pingBidDir(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Test_TestIntf_pingBidDir_name);
}
...
Test::TestIntf::_iceD_pingBidDir(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_id);
    inS.endReadParams();
    this->pingBidDir(iceP_id, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
