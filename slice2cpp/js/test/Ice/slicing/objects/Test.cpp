...
Test::TestIntf::_iceD_SBaseAsObject(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::Ice::ValuePtr ret = this->SBaseAsObject(current);
...
Test::TestIntf::_iceD_SUnknownAsObject(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.readEmptyParams();
    inS.setFormat(::Ice::SlicedFormat);
    ::Ice::ValuePtr ret = this->SUnknownAsObject(current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    ostr->writePendingValues();
    inS.endWriteParams();
...
/// \cond INTERNAL
::Ice::Value* Test::upCast(CompactPDerived* p) { return p; }
...
{
    ::Ice::Value* p = new CompactPDerived(*this);
    return p;
}
#if defined(_MSC_VER)
#   pragma warning(pop)
...
/// \cond INTERNAL
void
Test::_icePatchValuePtr(CompactPDerivedPtr& handle, const ::Ice::ValuePtr& v)
{
