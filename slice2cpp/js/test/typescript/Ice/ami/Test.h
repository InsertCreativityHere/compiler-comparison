...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::TestIntf::begin_pingBidDir.
 * Create a wrapper instance by calling ::Test::newCallback_TestIntf_pingBidDir.
 */
class Callback_TestIntf_pingBidDir_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_TestIntf_pingBidDir_Base> Callback_TestIntf_pingBidDirPtr;
...
public:
    ...
    void pingBidDir(const ::Ice::Identity& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_pingBidDir(_iceI_begin_pingBidDir(id, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_pingBidDir(const ::Ice::Identity& id, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_pingBidDir(id, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pingBidDir(const ::Ice::Identity& id, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pingBidDir(id, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pingBidDir(const ::Ice::Identity& id, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pingBidDir(id, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pingBidDir(const ::Ice::Identity& id, const ::Test::Callback_TestIntf_pingBidDirPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pingBidDir(id, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_pingBidDir(const ::Ice::Identity& id, const ::Ice::Context& context, const ::Test::Callback_TestIntf_pingBidDirPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_pingBidDir(id, context, cb, cookie);
    }

    void end_pingBidDir(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_pingBidDir(const ::Ice::Identity&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual void pingBidDir(const ::Ice::Identity& id, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_pingBidDir(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_TestIntf_pingBidDir : public Callback_TestIntf_pingBidDir_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_TestIntf_pingBidDir(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_pingBidDir.
 */
template<class T> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pingBidDir<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pingBidDir<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pingBidDir<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_TestIntf_pingBidDir<T>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_TestIntf_pingBidDir : public Callback_TestIntf_pingBidDir_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_TestIntf_pingBidDir(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::TestIntf::begin_pingBidDir.
 */
template<class T, typename CT> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pingBidDir<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pingBidDir<T, CT>(instance, 0, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pingBidDir<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_TestIntf_pingBidDirPtr
newCallback_TestIntf_pingBidDir(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_TestIntf_pingBidDir<T, CT>(instance, 0, excb, sentcb);
}
