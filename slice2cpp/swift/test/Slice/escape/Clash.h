...
namespace Clash
{
    ...
    public:
        ...
        Cls(std::optional<::Clash::IntfPrx> s, std::string context, std::int32_t current, std::int16_t response, std::string upCast, std::int32_t typeId, std::int16_t del, std::optional<std::int16_t> cookie, std::string ex, std::int32_t result, std::string istr, std::string ostr, std::string inS, std::string proxy) noexcept :
            s(std::move(s)),
        ...
        [[nodiscard]] std::tuple<const std::optional<::Clash::IntfPrx>&, const std::string&, const std::int32_t&, const std::int16_t&, const std::string&, const std::int32_t&, const std::int16_t&, const std::optional<std::int16_t>&, const std::string&, const std::int32_t&, const std::string&, const std::string&, const std::string&, const std::string&> ice_tuple() const
        {
            return std::tie(s, context, current, response, upCast, typeId, del, cookie, ex, result, istr, ostr, inS, proxy);
        }
    ...
    struct St
    {
        ...
        [[nodiscard]] std::tuple<const std::string&, const std::int16_t&, const std::int32_t&, const std::int32_t&> ice_tuple() const
        {
