...
Clash::Cls::_iceWriteImpl(Ice::OutputStream* ostr) const
{
    ...
    ostr->writeAll(this->s, this->context, this->current, this->response, this->upCast, this->typeId, this->del, this->ex, this->result, this->istr, this->ostr, this->inS, this->proxy);
...
{
    istr->startSlice();
    istr->readAll(this->s, this->context, this->current, this->response, this->upCast, this->typeId, this->del, this->ex, this->result, this->istr, this->ostr, this->inS, this->proxy);
