...
::Test::S1Seq
Test::IPrx::opS1Seq(const S1Seq& iceP_S1Seq, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<S1Seq>(true, this, &IPrx::_iceI_opS1Seq, iceP_S1Seq, context).get();
}

::std::future<::Test::S1Seq>
Test::IPrx::opS1SeqAsync(const S1Seq& iceP_S1Seq, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<S1Seq, ::std::promise>(false, this, &IPrx::_iceI_opS1Seq, iceP_S1Seq, context);
}

::std::function<void()>
Test::IPrx::opS1SeqAsync(const S1Seq& iceP_S1Seq,
                         ::std::function<void (::Test::S1Seq)> response,
                         ::std::function<void(::std::exception_ptr)> ex,
                         ::std::function<void(bool)> sent,
                         const ::Ice::Context& context)
{
    return _makeLambdaOutgoing<S1Seq>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Seq, iceP_S1Seq, context);
}

/// \cond INTERNAL
void
Test::IPrx::_iceI_opS1Seq(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<S1Seq>>& outAsync, const S1Seq& iceP_S1Seq, const ::Ice::Context& context)
{
...
::Test::S1Map
Test::IPrx::opS1Map(const S1Map& iceP_S1Map, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<S1Map>(true, this, &IPrx::_iceI_opS1Map, iceP_S1Map, context).get();
}

::std::future<::Test::S1Map>
Test::IPrx::opS1MapAsync(const S1Map& iceP_S1Map, const ::Ice::Context& context)
{
    return _makePromiseOutgoing<S1Map, ::std::promise>(false, this, &IPrx::_iceI_opS1Map, iceP_S1Map, context);
}

::std::function<void()>
Test::IPrx::opS1MapAsync(const S1Map& iceP_S1Map,
                         ::std::function<void (::Test::S1Map)> response,
                         ::std::function<void(::std::exception_ptr)> ex,
                         ::std::function<void(bool)> sent,
                         const ::Ice::Context& context)
{
    return _makeLambdaOutgoing<S1Map>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Map, iceP_S1Map, context);
}

/// \cond INTERNAL
void
Test::IPrx::_iceI_opS1Map(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<S1Map>>& outAsync, const S1Map& iceP_S1Map, const ::Ice::Context& context)
{
