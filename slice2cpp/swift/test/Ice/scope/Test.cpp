...
::Test::S1Seq
Test::IPrx::opS1Seq(const S1Seq& iceP_S1Seq, const Ice::Context& context) const
{
...
std::function<void()>
Test::IPrx::opS1SeqAsync(const S1Seq& iceP_S1Seq, std::function<void(::Test::S1Seq)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<S1Seq>(std::move(response), std::move(exception), std::move(sent), this, &Test::IPrx::_iceI_opS1Seq, iceP_S1Seq, context);
}
...
::Test::S1Map
Test::IPrx::opS1Map(const S1Map& iceP_S1Map, const Ice::Context& context) const
{
...
std::function<void()>
Test::IPrx::opS1MapAsync(const S1Map& iceP_S1Map, std::function<void(::Test::S1Map)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    return IceInternal::makeLambdaOutgoing<S1Map>(std::move(response), std::move(exception), std::move(sent), this, &Test::IPrx::_iceI_opS1Map, iceP_S1Map, context);
}
...
{
    ostr->startSlice(ice_staticId(), -1, true);
    ostr->writeAll(this->E1, this->S1, this->C1, this->S1Seq, this->S1Map);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    istr->readAll(this->E1, this->S1, this->C1, this->S1Seq, this->S1Map);
    istr->endSlice();
}
