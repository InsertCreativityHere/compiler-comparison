...
public:
    ...
    S1Seq opS1Seq(const S1Seq& S1Seq, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::Test::S1Seq>(true, this, &IPrx::_iceI_opS1Seq, S1Seq, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto opS1SeqAsync(const S1Seq& S1Seq, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::Test::S1Seq>>().get_future())
    {
        return _makePromiseOutgoing<::Test::S1Seq, P>(false, this, &IPrx::_iceI_opS1Seq, S1Seq, context);
    }
    ...
    opS1SeqAsync(const S1Seq& S1Seq,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<::Test::S1Seq>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Seq, S1Seq, context);
    }

    /// \cond INTERNAL
    void _iceI_opS1Seq(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::Test::S1Seq>>&, const S1Seq&, const ::Ice::Context&);
    /// \endcond

    S1Map opS1Map(const S1Map& S1Map, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::Test::S1Map>(true, this, &IPrx::_iceI_opS1Map, S1Map, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto opS1MapAsync(const S1Map& S1Map, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::Test::S1Map>>().get_future())
    {
        return _makePromiseOutgoing<::Test::S1Map, P>(false, this, &IPrx::_iceI_opS1Map, S1Map, context);
    }
    ...
    opS1MapAsync(const S1Map& S1Map,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLambdaOutgoing<::Test::S1Map>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Map, S1Map, context);
    }

    /// \cond INTERNAL
    void _iceI_opS1Map(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::Test::S1Map>>&, const S1Map&, const ::Ice::Context&);
    /// \endcond
...
typedef ::std::map< ::std::string, S1> S1Map;
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::I::begin_opS1Seq.
 * Create a wrapper instance by calling ::Test::newCallback_I_opS1Seq.
 */
class Callback_I_opS1Seq_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_I_opS1Seq_Base> Callback_I_opS1SeqPtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Test::I::begin_opS1Map.
 * Create a wrapper instance by calling ::Test::newCallback_I_opS1Map.
 */
class Callback_I_opS1Map_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_I_opS1Map_Base> Callback_I_opS1MapPtr;
...
public:
    ...
    ::Test::S1Seq opS1Seq(const ::Test::S1Seq& S1Seq, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_opS1Seq(_iceI_begin_opS1Seq(S1Seq, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opS1Seq(const ::Test::S1Seq& S1Seq, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opS1Seq(S1Seq, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opS1Seq(const ::Test::S1Seq& S1Seq, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Seq(S1Seq, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Seq(const ::Test::S1Seq& S1Seq, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Seq(S1Seq, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Seq(const ::Test::S1Seq& S1Seq, const ::Test::Callback_I_opS1SeqPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Seq(S1Seq, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Seq(const ::Test::S1Seq& S1Seq, const ::Ice::Context& context, const ::Test::Callback_I_opS1SeqPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Seq(S1Seq, context, cb, cookie);
    }

    ::Test::S1Seq end_opS1Seq(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_opS1Seq(const ::Test::S1Seq&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    ::Test::S1Map opS1Map(const ::Test::S1Map& S1Map, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_opS1Map(_iceI_begin_opS1Map(S1Map, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_opS1Map(const ::Test::S1Map& S1Map, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_opS1Map(S1Map, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_opS1Map(const ::Test::S1Map& S1Map, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Map(S1Map, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Map(const ::Test::S1Map& S1Map, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Map(S1Map, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Map(const ::Test::S1Map& S1Map, const ::Test::Callback_I_opS1MapPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Map(S1Map, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_opS1Map(const ::Test::S1Map& S1Map, const ::Ice::Context& context, const ::Test::Callback_I_opS1MapPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_opS1Map(S1Map, context, cb, cookie);
    }

    ::Test::S1Map end_opS1Map(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_opS1Map(const ::Test::S1Map&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual S1Seq opS1Seq(const S1Seq& S1Seq, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opS1Seq(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual S1Map opS1Map(const S1Map& S1Map, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_opS1Map(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
     ...
     * One-shot constructor to initialize all data members.
     */
    C2(::Test::E1 E1, const ::Test::S1& S1, const ::Test::C1Ptr& C1, const ::Test::S1Seq& S1Seq, const ::Test::S1Map& S1Map) :
        E1(E1),
        S1(S1),
        C1(C1),
        S1Seq(S1Seq),
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const ::Test::E1&, const ::Test::S1&, const ::Test::C1Ptr&, const ::Test::S1Seq&, const ::Test::S1Map&> ice_tuple() const
    {
        return std::tie(E1, S1, C1, S1Seq, S1Map);
    }
 ...
 */
template<class T>
class CallbackNC_I_opS1Seq : public Callback_I_opS1Seq_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const S1Seq&);

    CallbackNC_I_opS1Seq(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::I::begin_opS1Seq.
 */
template<class T> Callback_I_opS1SeqPtr
newCallback_I_opS1Seq(const IceUtil::Handle<T>& instance, void (T::*cb)(const S1Seq&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_I_opS1Seq<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_I_opS1SeqPtr
newCallback_I_opS1Seq(T* instance, void (T::*cb)(const S1Seq&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_I_opS1Seq<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_I_opS1Seq : public Callback_I_opS1Seq_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const S1Seq&, const CT&);

    Callback_I_opS1Seq(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::I::begin_opS1Seq.
 */
template<class T, typename CT> Callback_I_opS1SeqPtr
newCallback_I_opS1Seq(const IceUtil::Handle<T>& instance, void (T::*cb)(const S1Seq&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_I_opS1Seq<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_I_opS1SeqPtr
newCallback_I_opS1Seq(T* instance, void (T::*cb)(const S1Seq&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_I_opS1Seq<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_I_opS1Map : public Callback_I_opS1Map_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const S1Map&);

    CallbackNC_I_opS1Map(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::I::begin_opS1Map.
 */
template<class T> Callback_I_opS1MapPtr
newCallback_I_opS1Map(const IceUtil::Handle<T>& instance, void (T::*cb)(const S1Map&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_I_opS1Map<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_I_opS1MapPtr
newCallback_I_opS1Map(T* instance, void (T::*cb)(const S1Map&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_I_opS1Map<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_I_opS1Map : public Callback_I_opS1Map_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const S1Map&, const CT&);

    Callback_I_opS1Map(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Test::I::begin_opS1Map.
 */
template<class T, typename CT> Callback_I_opS1MapPtr
newCallback_I_opS1Map(const IceUtil::Handle<T>& instance, void (T::*cb)(const S1Map&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_I_opS1Map<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_I_opS1MapPtr
newCallback_I_opS1Map(T* instance, void (T::*cb)(const S1Map&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_I_opS1Map<T, CT>(instance, cb, excb, sentcb);
}
