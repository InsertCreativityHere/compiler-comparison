...
public:
    ...
    S1Seq opS1Seq(const S1Seq& S1Seq, const ::Ice::Context& context = ::Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)
    ...
    S1Map opS1Map(const S1Map& S1Map, const ::Ice::Context& context = ::Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)
...
struct S2
{
    ...
    /// Obtains a tuple containing all of the struct's data members.
    /// @return The data members in a tuple.
    [[nodiscard]] std::tuple<const ::Test::E1&, const ::Test::S1&, const ::Test::C1Ptr&, const ::Test::S1Seq&, const ::Test::S1Map&> ice_tuple() const
    {
...
public:
    ...
    /// One-shot constructor to initialize all data members.
    C2(::Test::E1 E1, ::Test::S1 S1, ::Test::C1Ptr C1, ::Test::S1Seq S1Seq, ::Test::S1Map S1Map) noexcept :
        E1(E1),
        S1(::std::move(S1)),
        C1(::std::move(C1)),
...
public:
    ...
    /// \cond INTERNAL
    void _iceD_opS1Seq(::Ice::IncomingRequest&, ::std::function<void(::Ice::OutgoingResponse)>);
    /// \endcond

    virtual S1Map opS1Map(S1Map S1Map, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    void _iceD_opS1Map(::Ice::IncomingRequest&, ::std::function<void(::Ice::OutgoingResponse)>);
    /// \endcond
