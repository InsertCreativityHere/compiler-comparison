...
public:
    ...
    opS1SeqAsync(const S1Seq& S1Seq,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::Test::S1Seq>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Seq, S1Seq, context);
    }
    ...
    opS1MapAsync(const S1Map& S1Map,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::Test::S1Map>(std::move(response), std::move(ex), std::move(sent), this, &Test::IPrx::_iceI_opS1Map, S1Map, context);
    }
