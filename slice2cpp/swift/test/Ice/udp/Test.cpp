...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::_iceI_begin_pingBiDir(const ::Ice::Identity& iceP_reply, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
