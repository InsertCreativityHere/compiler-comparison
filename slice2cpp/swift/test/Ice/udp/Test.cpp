...
void
Test::TestIntfPrx::pingBiDir(const ::Ice::Identity& iceP_reply, const ::Ice::Context& context)
{
    _makePromiseOutgoing<void>(true, this, &TestIntfPrx::_iceI_pingBiDir, iceP_reply, context).get();
}

::std::future<void>
Test::TestIntfPrx::pingBiDirAsync(const ::Ice::Identity& iceP_reply, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Test::TestIntfPrx::_iceI_pingBiDir(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::Ice::Identity& iceP_reply, const ::Ice::Context& context)
{
