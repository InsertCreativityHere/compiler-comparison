...
public:
    ...
    ::std::future<void> throwEAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    ::std::future<void> throwFAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
