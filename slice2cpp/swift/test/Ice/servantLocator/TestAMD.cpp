...
Test::AMD_TestActivation_activateServantLocator::~AMD_TestActivation_activateServantLocator()
{
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_TestActivation_activateServantLocator::AMD_TestActivation_activateServantLocator(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_TestActivation_activateServantLocator::ice_response()
{
    writeEmptyParams();
    completed();
}
...
Test::TestActivation::_iceD_activateServantLocator(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    this->activateServantLocator_async(new IceAsync::Test::AMD_TestActivation_activateServantLocator(inS), iceP_activate, current);
    return false;
}
/// \endcond
