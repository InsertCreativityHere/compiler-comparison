...
/**
 * AMD callback class for Test::TestActivation::activateServantLocator_async.
 * Call the ice_response method for a successful completion, or the ice_exception
 * method in the case of an error.
 */
class AMD_TestActivation_activateServantLocator : public virtual ::Ice::AMDCallback
{
public:

    virtual ~AMD_TestActivation_activateServantLocator();
...
typedef ::IceUtil::Handle< ::Test::AMD_TestActivation_activateServantLocator> AMD_TestActivation_activateServantLocatorPtr;
...
class AMD_TestActivation_activateServantLocator : public ::Test::AMD_TestActivation_activateServantLocator, public ::IceInternal::IncomingAsync
{
public:

    AMD_TestActivation_activateServantLocator(::IceInternal::Incoming&);
...
public:
    ...
    virtual void activateServantLocator_async(const ::Test::AMD_TestActivation_activateServantLocatorPtr& cb, bool activate, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_activateServantLocator(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
