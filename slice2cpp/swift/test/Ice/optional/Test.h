...
public:
    ...
    ::std::function<void()>
    opCustomStringAsync(const ::std::optional<Util::string_view>& p1, ::std::function<void(::std::optional<Util::string_view>, ::std::optional<Util::string_view>)> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    /// \cond INTERNAL
    void _iceIL_opCustomString(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<::std::optional<Util::string_view>, ::std::optional<Util::string_view>>>>&, const ::std::optional<Util::string_view>&, const ::Ice::Context&) const;
    /// \endcond
    ...
    ::std::function<void()>
    opCustomIntStringDictAsync(const ::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>& p1, ::std::function<void(::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>, ::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>)> response, ::std::function<void(::std::exception_ptr)> ex = nullptr, ::std::function<void(bool)> sent = nullptr, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
    ...
    /// \cond INTERNAL
    void _iceIL_opCustomIntStringDict(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>, ::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>>>>&, const ::std::optional<::std::map< ::Ice::Int, ::Util::string_view>>&, const ::Ice::Context&) const;
    /// \endcond
