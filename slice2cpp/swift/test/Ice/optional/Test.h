...
public:
    ...
    ::std::future<::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>> opCustomIntStringDictAsync(const ::std::optional<IntStringDict>& p1, const ::Ice::Context& context = ::Ice::noExplicitContext) const;
