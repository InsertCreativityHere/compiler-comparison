...
std::function<void()>
Test::InitialPrx::opCustomStringAsync(std::optional<std::string_view> iceP_p1, std::function<void(std::optional<std::string>, std::optional<std::string>)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    auto responseCb = [response = std::move(response)](std::tuple<std::optional<std::string>, std::optional<std::string>>&& result) mutable
    {
        std::apply(std::move(response), std::move(result));
    };
    return IceInternal::makeLambdaOutgoing<std::tuple<std::optional<std::string>, std::optional<std::string>>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Test::InitialPrx::_iceI_opCustomString, iceP_p1, context);
}
...
std::function<void()>
Test::InitialPrx::opCustomIntStringDictAsync(const std::optional<IntStringDict>& iceP_p1, std::function<void(std::optional<::Test::IntStringDict>, std::optional<::Test::IntStringDict>)> response, std::function<void(std::exception_ptr)> exception, std::function<void(bool)> sent, const Ice::Context& context) const
{
    auto responseCb = [response = std::move(response)](std::tuple<std::optional<IntStringDict>, std::optional<IntStringDict>>&& result) mutable
    {
        std::apply(std::move(response), std::move(result));
    };
    return IceInternal::makeLambdaOutgoing<std::tuple<std::optional<IntStringDict>, std::optional<IntStringDict>>>(std::move(responseCb), std::move(exception), std::move(sent), this, &Test::InitialPrx::_iceI_opCustomIntStringDict, iceP_p1, context);
}
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opCustomString(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    _iceCheckMode(Ice::OperationMode::Normal, request.current().mode);
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opCustomIntStringDict(
    Ice::IncomingRequest& request,
    std::function<void(Ice::OutgoingResponse)> sendResponse) // NOLINT(performance-unnecessary-value-param)
{
    _iceCheckMode(Ice::OperationMode::Normal, request.current().mode);
