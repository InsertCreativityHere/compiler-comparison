...
::std::optional<::std::string>
Test::InitialPrx::opCustomString(::std::optional<::std::string_view> iceP_p1, ::std::optional<::std::string>& iceP_p3, const ::Ice::Context& context) const
{
...
::std::future<::std::tuple<::std::optional<::std::string>, ::std::optional<::std::string>>>
Test::InitialPrx::opCustomStringAsync(::std::optional<::std::string_view> iceP_p1, const ::Ice::Context& context) const
{
...
::std::function<void()>
Test::InitialPrx::opCustomStringAsync(::std::optional<::std::string_view> iceP_p1, ::std::function<void(::std::optional<::std::string>, ::std::optional<::std::string>)> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    auto responseCb = [response = ::std::move(response)](::std::tuple<::std::optional<::std::string>, ::std::optional<::std::string>>&& result)
    {
        ::std::apply(::std::move(response), ::std::move(result));
    };
    return ::IceInternal::makeLambdaOutgoing<::std::tuple<::std::optional<::std::string>, ::std::optional<::std::string>>>(::std::move(responseCb), ::std::move(ex), ::std::move(sent), this, &Test::InitialPrx::_iceI_opCustomString, iceP_p1, context);
}

void
Test::InitialPrx::_iceI_opCustomString(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<::std::optional<::std::string>, ::std::optional<::std::string>>>>& outAsync, ::std::optional<::std::string_view> iceP_p1, const ::Ice::Context& context) const
{
...
Test::InitialPrx::opCustomIntStringDict(const ::std::optional<IntStringDict>& iceP_p1, ::std::optional<IntStringDict>& iceP_p3, const ::Ice::Context& context) const
{
    auto result = ::IceInternal::makePromiseOutgoing<::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>>(true, this, &InitialPrx::_iceI_opCustomIntStringDict, iceP_p1, context).get();
    iceP_p3 = ::std::move(::std::get<1>(result));
    return ::std::move(::std::get<0>(result));
}

::std::future<::std::tuple<::std::optional<::Test::IntStringDict>, ::std::optional<::Test::IntStringDict>>>
Test::InitialPrx::opCustomIntStringDictAsync(const ::std::optional<IntStringDict>& iceP_p1, const ::Ice::Context& context) const
{
    return ::IceInternal::makePromiseOutgoing<::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>>(false, this, &InitialPrx::_iceI_opCustomIntStringDict, iceP_p1, context);
}

::std::function<void()>
Test::InitialPrx::opCustomIntStringDictAsync(const ::std::optional<IntStringDict>& iceP_p1, ::std::function<void(::std::optional<::Test::IntStringDict>, ::std::optional<::Test::IntStringDict>)> response, ::std::function<void(::std::exception_ptr)> ex, ::std::function<void(bool)> sent, const ::Ice::Context& context) const
{
    auto responseCb = [response = ::std::move(response)](::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>&& result)
    {
        ::std::apply(::std::move(response), ::std::move(result));
    };
    return ::IceInternal::makeLambdaOutgoing<::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>>(::std::move(responseCb), ::std::move(ex), ::std::move(sent), this, &Test::InitialPrx::_iceI_opCustomIntStringDict, iceP_p1, context);
}

void
Test::InitialPrx::_iceI_opCustomIntStringDict(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>>>>& outAsync, const ::std::optional<IntStringDict>& iceP_p1, const ::Ice::Context& context) const
{
    ...
    outAsync->invoke(operationName, ::Ice::OperationMode::Normal, ::std::nullopt, context,
        ...
        [](::Ice::InputStream* istr)
        {
            ::std::tuple<::std::optional<IntStringDict>, ::std::optional<IntStringDict>> v;
            istr->readAll({1, 3}, ::std::get<0>(v), ::std::get<1>(v));
            return v;
        });
}
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opCustomString(::Ice::IncomingRequest& request, ::std::function<void(::Ice::OutgoingResponse)> sendResponse)
{
    _iceCheckMode(::Ice::OperationMode::Normal, request.current().mode);
    auto istr = &request.inputStream();
    istr->startEncapsulation();
    ...
    istr->endEncapsulation();
    ::std::optional<::std::string> iceP_p3;
    const ::std::optional<::std::string> ret = this->opCustomString(::std::move(iceP_p1), iceP_p3, request.current());
    sendResponse(::Ice::makeOutgoingResponse([&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll({1, 3}, ret, iceP_p3);
        },
...
/// \cond INTERNAL
void
Test::Initial::_iceD_opCustomIntStringDict(::Ice::IncomingRequest& request, ::std::function<void(::Ice::OutgoingResponse)> sendResponse)
{
    _iceCheckMode(::Ice::OperationMode::Normal, request.current().mode);
    auto istr = &request.inputStream();
    istr->startEncapsulation();
    ::std::optional<IntStringDict> iceP_p1;
    istr->readAll({2}, iceP_p1);
    istr->endEncapsulation();
    ::std::optional<IntStringDict> iceP_p3;
    const ::std::optional<IntStringDict> ret = this->opCustomIntStringDict(::std::move(iceP_p1), iceP_p3, request.current());
    sendResponse(::Ice::makeOutgoingResponse([&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll({1, 3}, ret, iceP_p3);
        },
...
Test::Initial::dispatch(::Ice::IncomingRequest& request, ::std::function<void(::Ice::OutgoingResponse)> sendResponse)
{
    ...
    switch(r.first - allOperations)
    {
        ...
        case 9:
        {
            _iceD_opCustomIntStringDict(request, ::std::move(sendResponse));
            break;
        }
        case 10:
        {
            _iceD_opCustomString(request, ::std::move(sendResponse));
            break;
        }
        case 11:
        {
