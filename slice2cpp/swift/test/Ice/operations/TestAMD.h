...
public:
    ...
    ::std::future<StringS> opWStringLiteralsAsync(const ::Ice::Context& context = ::Ice::noExplicitContext);
    ...
    /// \cond INTERNAL
    void _iceI_opWStringLiterals(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<StringS>>&, const ::Ice::Context&);
    /// \endcond
