...
public:
    ...
    virtual void opMyClass1Async(MyClass1Ptr opMyClass1, ::std::function<void(const MyClass1Ptr& returnValue)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
