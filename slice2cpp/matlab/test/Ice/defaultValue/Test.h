...
namespace Test
{
    ...
    using IntSeqSeq = std::vector<IntSeq>;

    using DerivedSeq = std::vector<DerivedPtr>;
...
namespace Test
{
    ...
    struct StructNoDefaults
    {
        ...
        ::Test::DerivedSeq derivedSeq;

        ::Test::IntSeqSeq intSeqSeq;

        /// Creates a tuple with all the fields of this struct.
        /// @return A tuple with all the fields of this struct.
        [[nodiscard]] std::tuple<const bool&, const std::uint8_t&, const std::int16_t&, const std::int32_t&, const std::int64_t&, const float&, const double&, const std::string&, const ::Test::Color&, const ::Test::ByteSeq&, const ::Test::IntSeq&, const ::Test::InnerStruct&, const ::Test::IntStringDict&, const ::Test::DerivedSeq&, const ::Test::IntSeqSeq&> ice_tuple() const
        {
            return std::tie(bo, b, s, i, l, f, d, str, c1, bs, is, st, dict, derivedSeq, intSeqSeq);
        }
...
namespace Ice
{
    ...
    {
        static constexpr StreamHelperCategory helper = StreamHelperCategoryStruct;
        static constexpr int minWireSize = 39;
        static constexpr bool fixedLength = false;
    };
    ...
    struct StreamReader<::Test::StructNoDefaults>
    {
        ...
        {
            istr->readAll(v.bo, v.b, v.s, v.i, v.l, v.f, v.d, v.str, v.c1, v.bs, v.is, v.st, v.dict, v.derivedSeq, v.intSeqSeq);
        }
    };
    /// @endcond
}
