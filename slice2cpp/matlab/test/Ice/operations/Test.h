...
namespace Test
{
    ...
    const std::string s13 = "\360\237\215\2140123"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s14 = "\360\237\215\214abcd"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s15 = "\360\237\215\214ABCD"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s16 = "\177abcd"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s17 = "\177ABCD"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s18 = "\0011238"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)

    const std::string s19 = "abc\0011238\babcd"; // NOLINT(cert-err58-cpp, modernize-raw-string-literal)
