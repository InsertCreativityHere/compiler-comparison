...
namespace
{
    const IceInternal::ClassInit<::LocalTest::C1> iceC_LocalTest_C1_init;
    const IceInternal::ClassInit<::LocalTest::CB1> iceC_LocalTest_CB1_init;
    const IceInternal::ClassInit<::LocalTest::CB2> iceC_LocalTest_CB2_init;
    const IceInternal::ClassInit<::LocalTest::CB3> iceC_LocalTest_CB3_init;
    const IceInternal::ClassInit<::LocalTest::CB4> iceC_LocalTest_CB4_init;
    const IceInternal::ClassInit<::LocalTest::CB5> iceC_LocalTest_CB5_init;
    const IceInternal::ClassInit<::LocalTest::CB6> iceC_LocalTest_CB6_init;
    const IceInternal::ClassInit<::LocalTest::CB7> iceC_LocalTest_CB7_init;
    const IceInternal::ClassInit<::LocalTest::CB8> iceC_LocalTest_CB8_init;
}
