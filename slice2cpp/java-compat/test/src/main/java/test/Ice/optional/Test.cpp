...
Test::Initial::_iceD_opMStruct1(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    Ice::optional<SmallStruct> ret = this->opMStruct1(current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1}, ret);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMStruct2(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll({2}, iceP_p1);
    inS.endReadParams();
    Ice::optional<SmallStruct> iceP_p2;
    Ice::optional<SmallStruct> ret = this->opMStruct2(::std::move(iceP_p1), iceP_p2, current);
    auto ostr = inS.startWriteParams();
...
Test::Initial::_iceD_opMSeq1(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    Ice::optional<StringSeq> ret = this->opMSeq1(current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1}, ret);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMSeq2(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll({2}, iceP_p1);
    inS.endReadParams();
    Ice::optional<StringSeq> iceP_p2;
    Ice::optional<StringSeq> ret = this->opMSeq2(::std::move(iceP_p1), iceP_p2, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1, 3}, ret, iceP_p2);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMDict1(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    Ice::optional<StringIntDict> ret = this->opMDict1(current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1}, ret);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMDict2(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll({2}, iceP_p1);
    inS.endReadParams();
    Ice::optional<StringIntDict> iceP_p2;
    Ice::optional<StringIntDict> ret = this->opMDict2(::std::move(iceP_p1), iceP_p2, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1, 3}, ret, iceP_p2);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMG1(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    Ice::optional<::std::shared_ptr<G>> ret = this->opMG1(current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1}, ret);
    inS.endWriteParams();
    return true;
...
Test::Initial::_iceD_opMG2(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll({2}, iceP_p1);
    inS.endReadParams();
    Ice::optional<::std::shared_ptr<G>> iceP_p2;
    Ice::optional<::std::shared_ptr<G>> ret = this->opMG2(::std::move(iceP_p1), iceP_p2, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll({1, 3}, ret, iceP_p2);
    inS.endWriteParams();
    return true;
