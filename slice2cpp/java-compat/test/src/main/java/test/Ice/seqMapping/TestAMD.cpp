...
Test::MyClass::_iceD_opSerialSmallJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->opSerialSmallJavaAsync(::std::move(iceP_i), responseCB, inA->exception(), current);
    return false;
}
/// \endcond
...
Test::MyClass::_iceD_opSerialLargeJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->opSerialLargeJavaAsync(::std::move(iceP_i), responseCB, inA->exception(), current);
    return false;
}
/// \endcond
...
Test::MyClass::_iceD_opSerialStructJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->opSerialStructJavaAsync(::std::move(iceP_i), responseCB, inA->exception(), current);
    return false;
}
/// \endcond
...
Test::AMD_MyClass_opSerialSmallJava::~AMD_MyClass_opSerialSmallJava()
{
}

Test::AMD_MyClass_opSerialLargeJava::~AMD_MyClass_opSerialLargeJava()
{
}

Test::AMD_MyClass_opSerialStructJava::~AMD_MyClass_opSerialStructJava()
{
}
...
/// \cond INTERNAL
IceAsync::Test::AMD_MyClass_opSerialSmallJava::AMD_MyClass_opSerialSmallJava(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_MyClass_opSerialSmallJava::ice_response(const ::Test::SerialSmall& ret, const ::Test::SerialSmall& o)
{
...
/// \cond INTERNAL
IceAsync::Test::AMD_MyClass_opSerialLargeJava::AMD_MyClass_opSerialLargeJava(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_MyClass_opSerialLargeJava::ice_response(const ::Test::SerialLarge& ret, const ::Test::SerialLarge& o)
{
    ::Ice::OutputStream* ostr = startWriteParams();
    ostr->write(o);
    ostr->write(ret);
...
/// \cond INTERNAL
IceAsync::Test::AMD_MyClass_opSerialStructJava::AMD_MyClass_opSerialStructJava(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Test::AMD_MyClass_opSerialStructJava::ice_response(const ::Test::SerialStruct& ret, const ::Test::SerialStruct& o)
{
    ::Ice::OutputStream* ostr = startWriteParams();
    ostr->write(o);
    ostr->write(ret);
...
Test::MyClass::_iceD_opSerialSmallJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_i);
    inS.endReadParams();
    this->opSerialSmallJava_async(new IceAsync::Test::AMD_MyClass_opSerialSmallJava(inS), iceP_i, current);
    return false;
}
/// \endcond
...
Test::MyClass::_iceD_opSerialLargeJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_i);
    inS.endReadParams();
    this->opSerialLargeJava_async(new IceAsync::Test::AMD_MyClass_opSerialLargeJava(inS), iceP_i, current);
    return false;
}
/// \endcond
...
Test::MyClass::_iceD_opSerialStructJava(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_i);
    inS.endReadParams();
    this->opSerialStructJava_async(new IceAsync::Test::AMD_MyClass_opSerialStructJava(inS), iceP_i, current);
    return false;
}
/// \endcond
