...
{
    /// <summary>Provides methods to marshal and unmarshal a <c>StringLogUpdateDict</c>.</summary>
    /// <remarks>The Slice compiler generated this dictionary helper class from Slice dictionary <c>::IceStormElection::StringLogUpdateDict</c>.</remarks>
    public sealed class StringLogUpdateDictHelper
    {
        ...
        public static void write(Ice.OutputStream ostr, global::System.Collections.Generic.Dictionary<string, LogUpdate> v)
        {
            if (v is null)
            {
                ostr.writeSize(0);
            ...
            else
            {
                ...
                foreach (global::System.Collections.Generic.KeyValuePair<string, LogUpdate> e in v)
                {
                    ...
                    LogUpdate.ice_write(ostr, e.Value);
                }
            }
        }
...
namespace IceStorm
{
    /// <summary>Provides methods to marshal and unmarshal a <c>SubscriberRecordDict</c>.</summary>
    /// <remarks>The Slice compiler generated this dictionary helper class from Slice dictionary <c>::IceStorm::SubscriberRecordDict</c>.</remarks>
    public sealed class SubscriberRecordDictHelper
    {
        /// <summary>Marshals a value into an output stream.</summary>
        /// <param name="ostr">The output stream.</param>
        /// <param name="v">The value to marshal.</param>
        public static void write(Ice.OutputStream ostr, global::System.Collections.Generic.Dictionary<SubscriberRecordKey, SubscriberRecord> v)
        {
            if (v is null)
            {
                ostr.writeSize(0);
    ...
    /// <remarks>The Slice compiler generated this record class from Slice struct <c>::IceStorm::AllData</c>.</remarks>
    public sealed partial record class AllData
    {
        ...
        {
            global::IceStormElection.StringLogUpdateDictHelper.write(ostr, v.llus);
            SubscriberRecordDictHelper.write(ostr, v.subscribers);
        }
