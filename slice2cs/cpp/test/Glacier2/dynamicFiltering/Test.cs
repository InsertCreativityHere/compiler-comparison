...
namespace Test
{
    ...
    public sealed partial class TestControllerPrxHelper : Ice.ObjectPrxHelperBase, TestControllerPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>TestController</c>.</returns>
        public static async global::System.Threading.Tasks.Task<TestControllerPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new TestControllerPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>TestController</c>.</returns>
        public static global::System.Threading.Tasks.Task<TestControllerPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
    ...
    public sealed partial class TestSessionPrxHelper : Ice.ObjectPrxHelperBase, TestSessionPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>TestSession</c>.</returns>
        public static async global::System.Threading.Tasks.Task<TestSessionPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new TestSessionPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>TestSession</c>.</returns>
        public static global::System.Threading.Tasks.Task<TestSessionPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::TestController</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>TestController</c>.</remarks>
    public abstract partial class TestControllerDisp_ : Ice.ObjectImpl, TestController
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::TestController</c>.</returns>
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::TestSession</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>TestSession</c>.</remarks>
    public abstract partial class TestSessionDisp_ : Ice.ObjectImpl, TestSession
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::TestSession</c>.</returns>
