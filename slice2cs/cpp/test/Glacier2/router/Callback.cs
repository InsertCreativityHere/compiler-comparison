...
namespace Test
{
    ...
    public sealed partial class CallbackReceiverPrxHelper : Ice.ObjectPrxHelperBase, CallbackReceiverPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>CallbackReceiver</c>.</returns>
        public static async global::System.Threading.Tasks.Task<CallbackReceiverPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new CallbackReceiverPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>CallbackReceiver</c>.</returns>
        public static global::System.Threading.Tasks.Task<CallbackReceiverPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::CallbackReceiver</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>CallbackReceiver</c>.</remarks>
    public abstract partial class CallbackReceiverDisp_ : Ice.ObjectImpl, CallbackReceiver
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::CallbackReceiver</c>.</returns>
