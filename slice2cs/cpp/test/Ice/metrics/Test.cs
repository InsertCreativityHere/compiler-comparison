...
namespace Test
{
    ...
    public sealed partial class MetricsPrxHelper : Ice.ObjectPrxHelperBase, MetricsPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Metrics</c>.</returns>
        public static async global::System.Threading.Tasks.Task<MetricsPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new MetricsPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Metrics</c>.</returns>
        public static global::System.Threading.Tasks.Task<MetricsPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Metrics</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Metrics</c>.</remarks>
    public abstract partial class MetricsDisp_ : Ice.ObjectImpl, Metrics
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Metrics</c>.</returns>
