...
namespace Test
{
    ...
    public sealed partial class BackgroundPrxHelper : Ice.ObjectPrxHelperBase, BackgroundPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Background</c>.</returns>
        public static async global::System.Threading.Tasks.Task<BackgroundPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new BackgroundPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Background</c>.</returns>
        public static global::System.Threading.Tasks.Task<BackgroundPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
    ...
    public sealed partial class BackgroundControllerPrxHelper : Ice.ObjectPrxHelperBase, BackgroundControllerPrx
    {
        ...
        private void _iceI_initializeSocketOperation(int iceP_status, global::System.Collections.Generic.Dictionary<string, string>? context, bool synchronous, Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>BackgroundController</c>.</returns>
        public static async global::System.Threading.Tasks.Task<BackgroundControllerPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new BackgroundControllerPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>BackgroundController</c>.</returns>
        public static global::System.Threading.Tasks.Task<BackgroundControllerPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Background</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Background</c>.</remarks>
    public abstract partial class BackgroundDisp_ : Ice.ObjectImpl, Background
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Background</c>.</returns>
    ...
    public partial interface BackgroundController : Ice.Object
    {
        ...
        void initializeSocketOperation(int status, Ice.Current current);

        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected static global::System.Threading.Tasks.ValueTask<Ice.OutgoingResponse> iceD_initializeSocketOperationAsync(
            BackgroundController obj,
            Ice.IncomingRequest request)
        {
            Ice.CurrentExtensions.checkNonIdempotent(request.current);
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::BackgroundController</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>BackgroundController</c>.</remarks>
    public abstract partial class BackgroundControllerDisp_ : Ice.ObjectImpl, BackgroundController
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::BackgroundController</c>.</returns>
        ...
        public abstract void initializeSocketOperation(int status, Ice.Current current);
