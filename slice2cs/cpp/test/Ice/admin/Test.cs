...
namespace Test
{
    ...
    public partial interface RemoteCommunicator : Ice.Object
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.8.0-alpha.0")]
        void addUpdateCallback(Ice.Current current);

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.8.0-alpha.0")]
        void removeUpdateCallback(Ice.Current current);
...
namespace Test
{
    ...
    public sealed class RemoteCommunicatorPrxHelper : Ice.ObjectPrxHelperBase, RemoteCommunicatorPrx
    {
        ...
        private void _iceI_addUpdateCallback(global::System.Collections.Generic.Dictionary<string, string>? context, bool synchronous, Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
        ...
        private void _iceI_removeUpdateCallback(global::System.Collections.Generic.Dictionary<string, string>? context, bool synchronous, Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
    ...
    public sealed class RemoteCommunicatorFactoryPrxHelper : Ice.ObjectPrxHelperBase, RemoteCommunicatorFactoryPrx
    {
        ...
        public static RemoteCommunicatorFactoryPrx? checkedCast(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null)
        {
            ...
            try
            {
                if (bb is not null && bb.ice_isA(ice_staticId(), ctx))
                {
                    return new RemoteCommunicatorFactoryPrxHelper(bb);
                }
            }
            catch (Ice.FacetNotExistException)
            {
        ...
        public static RemoteCommunicatorFactoryPrx? uncheckedCast(Ice.ObjectPrx? b, string f) =>
            b is not null ? new RemoteCommunicatorFactoryPrxHelper(b.ice_facet(f)) : null;
...
namespace Test
{
    ...
    public abstract class RemoteCommunicatorDisp_ : Ice.ObjectImpl, RemoteCommunicator
    {
        ...
        public abstract void addUpdateCallback(Ice.Current current);

        public abstract void removeUpdateCallback(Ice.Current current);
...
namespace Test
{
    public partial interface RemoteCommunicator
    {
        ...
        protected static global::System.Threading.Tasks.ValueTask<Ice.OutgoingResponse> iceD_addUpdateCallbackAsync(
            RemoteCommunicator obj,
            Ice.IncomingRequest request)
        {
            Ice.ObjectImpl.iceCheckMode(Ice.OperationMode.Normal, request.current.mode);
        ...
        protected static global::System.Threading.Tasks.ValueTask<Ice.OutgoingResponse> iceD_removeUpdateCallbackAsync(
            RemoteCommunicator obj,
            Ice.IncomingRequest request)
        {
            Ice.ObjectImpl.iceCheckMode(Ice.OperationMode.Normal, request.current.mode);
