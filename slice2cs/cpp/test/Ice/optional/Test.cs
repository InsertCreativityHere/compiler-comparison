...
namespace Test
{
    ...
    public partial class MultiOptional : Ice.Value
    {
        ...
        protected override void iceWriteImpl(Ice.OutputStream ostr_)
        {
            ...
            ostr_.writeString(31, defaultedString);
            ostr_.endSlice();
        }
        ...
        protected override void iceReadImpl(Ice.InputStream istr_)
        {
            ...
            defaultedString = istr_.readString(31);
            istr_.endSlice();
        }
    }
...
namespace Test
{
    public readonly record struct Initial_PingPongMarshaledResult : Ice.MarshaledResult
    {
        public Initial_PingPongMarshaledResult(Ice.Value? ret, Ice.Current current)
        {
...
namespace Test
{
    ...
    public partial interface Initial : Ice.Object
    {
        ...
        Initial_PingPongMarshaledResult pingPong(Ice.Value? o, Ice.Current current);
            ...
            Ice.IncomingRequest request)
        {
            ...
            {
                ostr.writeSize(1);
                SmallStruct.ice_write(ostr, ret.Value);
            }
            if (iceP_p3 is not null && ostr.writeOptional(3, Ice.OptionalFormat.VSize))
            {
                ostr.writeSize(1);
                SmallStruct.ice_write(ostr, iceP_p3.Value);
            }
            ostr.endEncapsulation();
            return new(new Ice.OutgoingResponse(ostr));
        }
            ...
            Ice.IncomingRequest request)
        {
            ...
            {
                ostr.writeSize(4);
                FixedStruct.ice_write(ostr, ret.Value);
            }
            if (iceP_p3 is not null && ostr.writeOptional(3, Ice.OptionalFormat.VSize))
            {
                ostr.writeSize(4);
                FixedStruct.ice_write(ostr, iceP_p3.Value);
            }
            ostr.endEncapsulation();
            return new(new Ice.OutgoingResponse(ostr));
        }
    ...
    public abstract partial class InitialDisp_ : Initial
    {
        ...
        public abstract Initial_PingPongMarshaledResult pingPong(Ice.Value? o, Ice.Current current);
