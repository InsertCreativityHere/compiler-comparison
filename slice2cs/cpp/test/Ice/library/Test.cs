...
namespace Test
{
    /// <remarks>The Slice compiler generated this exception class from Slice exception <c>::Test::UserError</c>.</remarks>
    [Ice.SliceTypeId("::Test::UserError")]
    public partial class UserError : Ice.UserException
    {
        public string message = "";

        /// <summary>Initializes a new instance of the <see cref="UserError" /> class.</summary>
