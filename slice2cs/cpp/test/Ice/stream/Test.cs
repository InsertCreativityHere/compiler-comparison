...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this record struct from Slice struct <c>::Test::ClassStruct</c>.</remarks>
    public partial record struct ClassStruct
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ClassStruct" /> struct.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="ClassStruct" /> struct from an input stream.</summary>
        public ClassStruct(Ice.InputStream istr)
        {
            this.i = istr.readInt();
            ice_initialize();
        }
        ...
        /// <param name="ostr">The output stream.</param>
        /// <param name="v">The value to marshal.</param>
        public static void ice_write(Ice.OutputStream ostr, ClassStruct v)
        {
            ostr.writeInt(v.i);
        }
        ...
        /// <param name="istr">The input stream.</param>
        /// <returns>The unmarshaled value.</returns>
        public static ClassStruct ice_read(Ice.InputStream istr) => new(istr);
    }
    ...
    /// <summary>Provides methods to marshal and unmarshal a <c>LargeStructS</c>.</summary>
    /// <remarks>The Slice compiler generated this sequence helper class from Slice sequence <c>::Test::LargeStructS</c>.</remarks>
    public sealed class LargeStructSHelper
    {
        /// <summary>Marshals a value into an output stream.</summary>
        /// <param name="ostr">The output stream.</param>
        /// <param name="v">The value to marshal.</param>
        public static void write(Ice.OutputStream ostr, LargeStruct[] v)
        {
            if (v is null)
            {
                ostr.writeSize(0);
        ...
        /// <param name="istr">The input stream.</param>
        /// <returns>The unmarshaled value.</returns>
        public static LargeStruct[] read(Ice.InputStream istr)
        {
            LargeStruct[] v;
            {
                int szx = istr.readAndCheckSeqSize(32);
                v = new LargeStruct[szx];
                for (int ix = 0; ix < szx; ++ix)
                {
                    v[ix] = new LargeStruct(istr);
                }
            }
            return v;
        }
    ...
    /// <summary>Provides methods to marshal and unmarshal a <c>LargeStructSS</c>.</summary>
    /// <remarks>The Slice compiler generated this sequence helper class from Slice sequence <c>::Test::LargeStructSS</c>.</remarks>
    public sealed class LargeStructSSHelper
    {
        /// <summary>Marshals a value into an output stream.</summary>
        /// <param name="ostr">The output stream.</param>
        /// <param name="v">The value to marshal.</param>
        public static void write(Ice.OutputStream ostr, LargeStruct[][] v)
        {
            ...
            else
            {
                ...
                for (int ix = 0; ix < v.Length; ++ix)
                {
                    LargeStructSHelper.write(ostr, v[ix]);
                }
            }
        }
        ...
        public static LargeStruct[][] read(Ice.InputStream istr)
        {
            LargeStruct[][] v;
            {
                ...
                for (int ix = 0; ix < szx; ++ix)
                {
                    v[ix] = LargeStructSHelper.read(istr);
                }
            }
            return v;
        }
    ...
    namespace Sub
    {
        /// <remarks>The Slice compiler generated this enum from Slice enumeration <c>::Test::Sub::NestedEnum</c>.</remarks>
        ...
        /// <summary>Provides methods to marshal and unmarshal a <see cref="NestedEnum" />.</summary>
        /// <remarks>The Slice compiler generated this enum helper class from Slice enumeration <c>::Test::Sub::NestedEnum</c>.</remarks>
        ...
        /// <remarks>The Slice compiler generated this record class from Slice struct <c>::Test::Sub::NestedStruct</c>.</remarks>
        public sealed partial record class NestedStruct
        {
            ...
            /// <summary>Initializes a new instance of the <see cref="NestedStruct" /> class.</summary>
            public NestedStruct()
            {
                ice_initialize();
            }
            ...
            /// <summary>Initializes a new instance of the <see cref="NestedStruct" /> class from an input stream.</summary>
        ...
        /// <remarks>The Slice compiler generated this exception class from Slice exception <c>::Test::Sub::NestedException</c>.</remarks>
        [Ice.SliceTypeId("::Test::Sub::NestedException")]
        public partial class NestedException : Ice.UserException
        {
            public string str = "";

            /// <summary>Initializes a new instance of the <see cref="NestedException" /> class.</summary>
...
namespace Test2
{
    namespace Sub2
    {
        /// <remarks>The Slice compiler generated this enum from Slice enumeration <c>::Test2::Sub2::NestedEnum2</c>.</remarks>
        ...
        /// <summary>Provides methods to marshal and unmarshal a <see cref="NestedEnum2" />.</summary>
        /// <remarks>The Slice compiler generated this enum helper class from Slice enumeration <c>::Test2::Sub2::NestedEnum2</c>.</remarks>
        ...
        /// <remarks>The Slice compiler generated this record class from Slice struct <c>::Test2::Sub2::NestedStruct2</c>.</remarks>
        public sealed partial record class NestedStruct2
        {
            ...
            /// <summary>Initializes a new instance of the <see cref="NestedStruct2" /> class.</summary>
            ...
            /// <summary>Initializes a new instance of the <see cref="NestedStruct2" /> class from an input stream.</summary>
        ...
        /// <remarks>The Slice compiler generated this exception class from Slice exception <c>::Test2::Sub2::NestedException2</c>.</remarks>
        [Ice.SliceTypeId("::Test2::Sub2::NestedException2")]
        public partial class NestedException2 : Ice.UserException
        {
            public string str = "";

            /// <summary>Initializes a new instance of the <see cref="NestedException2" /> class.</summary>
