...
namespace Test1
{
    ...
    public sealed partial class WstringClassPrxHelper : Ice.ObjectPrxHelperBase, WstringClassPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>WstringClass</c>.</returns>
        public static async global::System.Threading.Tasks.Task<WstringClassPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new WstringClassPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>WstringClass</c>.</returns>
        public static global::System.Threading.Tasks.Task<WstringClassPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Test1
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test1::WstringClass</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>WstringClass</c>.</remarks>
    public abstract partial class WstringClassDisp_ : Ice.ObjectImpl, WstringClass
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test1::WstringClass</c>.</returns>
...
namespace Test2
{
    ...
    /// <summary>Implements <see cref="Ice.Object.dispatchAsync" /> for the operations of Slice interface <c>WstringClass</c>.</summary>
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test2::WstringClass</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>WstringClass</c>.</remarks>
    public abstract partial class WstringClassDisp_ : Ice.ObjectImpl, WstringClass
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
