...
namespace IceGrid
{
    ...
    {
        public ApplicationDescriptor parse(
            string xmlFile,
            AdminPrx? adminProxy,
            global::System.Collections.Generic.Dictionary<string, string>? context = null)
        {
        ...
        private global::System.Threading.Tasks.Task<ApplicationDescriptor> _iceI_parseAsync(
            string iceP_xmlFile,
        ...
        public static FileParserPrx? checkedCast(
            Ice.ObjectPrx? proxy,
            global::System.Collections.Generic.Dictionary<string, string>? context = null) =>
            proxy is not null && proxy.ice_isA(ice_staticId(), context) ? new FileParserPrxHelper(proxy) : null;
        ...
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>FileParser</c>.</returns>
        public static async global::System.Threading.Tasks.Task<FileParserPrx?> checkedCastAsync(
            Ice.ObjectPrx proxy,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default) =>
            await proxy.ice_isAAsync(ice_staticId(), context, progress, cancel).ConfigureAwait(false) ? new FileParserPrxHelper(proxy) : null;
        ...
        /// <param name="cancel">The cancellation token.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>FileParser</c>.</returns>
        public static global::System.Threading.Tasks.Task<FileParserPrx?> checkedCastAsync(
            Ice.ObjectPrx proxy,
            string facet,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
        ...
        public static FileParserPrx? uncheckedCast(Ice.ObjectPrx? proxy) =>
            proxy is not null ? new FileParserPrxHelper(proxy) : null;
        ...
        /// <returns>A proxy with the requested type, or null if the source proxy is null.</returns>
        [return: global::System.Diagnostics.CodeAnalysis.NotNullIfNotNull(nameof(proxy))]
        public static FileParserPrx? uncheckedCast(Ice.ObjectPrx? proxy, string facet) =>
...
namespace IceGrid
{
    ...
    /// <remarks>The Slice compiler generated this skeleton class from Slice interface <c>::IceGrid::FileParser</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>FileParser</c>.</remarks>
    public abstract partial class FileParserDisp_ : FileParser
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::IceGrid::FileParser</c>.</returns>
        public static string ice_staticId() => "::IceGrid::FileParser";
