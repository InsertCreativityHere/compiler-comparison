...
namespace IceGrid
{
    ...
    public sealed partial class UserAccountMapperPrxHelper : Ice.ObjectPrxHelperBase, UserAccountMapperPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>UserAccountMapper</c>.</returns>
        public static async global::System.Threading.Tasks.Task<UserAccountMapperPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new UserAccountMapperPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>UserAccountMapper</c>.</returns>
        public static global::System.Threading.Tasks.Task<UserAccountMapperPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace IceGrid
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::IceGrid::UserAccountMapper</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>UserAccountMapper</c>.</remarks>
    public abstract partial class UserAccountMapperDisp_ : Ice.ObjectImpl, UserAccountMapper
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::IceGrid::UserAccountMapper</c>.</returns>
