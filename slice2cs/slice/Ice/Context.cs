...
[assembly:Ice.Slice("Context.ice")]
...
namespace Ice
{
    /// <summary>Provides methods to marshal and unmarshal a <c>Context</c>.</summary>
    /// <remarks>The Slice compiler generated this dictionary helper class from Slice dictionary <c>::Ice::Context</c>.</remarks>
