...
namespace IceMX
{
    ...
    public sealed partial class MetricsAdminPrxHelper : Ice.ObjectPrxHelperBase, MetricsAdminPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>MetricsAdmin</c>.</returns>
        public static async global::System.Threading.Tasks.Task<MetricsAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new MetricsAdminPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>MetricsAdmin</c>.</returns>
        public static global::System.Threading.Tasks.Task<MetricsAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace IceMX
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::IceMX::MetricsAdmin</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>MetricsAdmin</c>.</remarks>
    public abstract partial class MetricsAdminDisp_ : Ice.ObjectImpl, MetricsAdmin
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::IceMX::MetricsAdmin</c>.</returns>
