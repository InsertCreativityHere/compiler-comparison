...
namespace Ice
{
    ...
    public sealed partial class PropertiesAdminPrxHelper : Ice.ObjectPrxHelperBase, PropertiesAdminPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>PropertiesAdmin</c>.</returns>
        public static async global::System.Threading.Tasks.Task<PropertiesAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new PropertiesAdminPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>PropertiesAdmin</c>.</returns>
        public static global::System.Threading.Tasks.Task<PropertiesAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Ice
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Ice::PropertiesAdmin</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>PropertiesAdmin</c>.</remarks>
    public abstract partial class PropertiesAdminDisp_ : Ice.ObjectImpl, PropertiesAdmin
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Ice::PropertiesAdmin</c>.</returns>
