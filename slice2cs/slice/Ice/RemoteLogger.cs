...
namespace Ice
{
    ...
    public sealed partial class RemoteLoggerPrxHelper : Ice.ObjectPrxHelperBase, RemoteLoggerPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>RemoteLogger</c>.</returns>
        public static async global::System.Threading.Tasks.Task<RemoteLoggerPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new RemoteLoggerPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>RemoteLogger</c>.</returns>
        public static global::System.Threading.Tasks.Task<RemoteLoggerPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
    ...
    public sealed partial class LoggerAdminPrxHelper : Ice.ObjectPrxHelperBase, LoggerAdminPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>LoggerAdmin</c>.</returns>
        public static async global::System.Threading.Tasks.Task<LoggerAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new LoggerAdminPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>LoggerAdmin</c>.</returns>
        public static global::System.Threading.Tasks.Task<LoggerAdminPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Ice
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Ice::RemoteLogger</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>RemoteLogger</c>.</remarks>
    public abstract partial class RemoteLoggerDisp_ : Ice.ObjectImpl, RemoteLogger
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Ice::RemoteLogger</c>.</returns>
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Ice::LoggerAdmin</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>LoggerAdmin</c>.</remarks>
    public abstract partial class LoggerAdminDisp_ : Ice.ObjectImpl, LoggerAdmin
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Ice::LoggerAdmin</c>.</returns>
