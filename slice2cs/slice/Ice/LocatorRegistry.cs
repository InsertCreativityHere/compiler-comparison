...
namespace Ice
{
    ...
    public sealed partial class LocatorRegistryPrxHelper : Ice.ObjectPrxHelperBase, LocatorRegistryPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>LocatorRegistry</c>.</returns>
        public static async global::System.Threading.Tasks.Task<LocatorRegistryPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new LocatorRegistryPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>LocatorRegistry</c>.</returns>
        public static global::System.Threading.Tasks.Task<LocatorRegistryPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Ice
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Ice::LocatorRegistry</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>LocatorRegistry</c>.</remarks>
    public abstract partial class LocatorRegistryDisp_ : Ice.ObjectImpl, LocatorRegistry
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Ice::LocatorRegistry</c>.</returns>
