...
namespace Glacier2
{
    ...
    public sealed partial class PermissionsVerifierPrxHelper : Ice.ObjectPrxHelperBase, PermissionsVerifierPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>PermissionsVerifier</c>.</returns>
        public static async global::System.Threading.Tasks.Task<PermissionsVerifierPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new PermissionsVerifierPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>PermissionsVerifier</c>.</returns>
        public static global::System.Threading.Tasks.Task<PermissionsVerifierPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
    ...
    public sealed partial class SSLPermissionsVerifierPrxHelper : Ice.ObjectPrxHelperBase, SSLPermissionsVerifierPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>SSLPermissionsVerifier</c>.</returns>
        public static async global::System.Threading.Tasks.Task<SSLPermissionsVerifierPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new SSLPermissionsVerifierPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>SSLPermissionsVerifier</c>.</returns>
        public static global::System.Threading.Tasks.Task<SSLPermissionsVerifierPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Glacier2
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Glacier2::PermissionsVerifier</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>PermissionsVerifier</c>.</remarks>
    public abstract partial class PermissionsVerifierDisp_ : Ice.ObjectImpl, PermissionsVerifier
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Glacier2::PermissionsVerifier</c>.</returns>
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Glacier2::SSLPermissionsVerifier</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>SSLPermissionsVerifier</c>.</remarks>
    public abstract partial class SSLPermissionsVerifierDisp_ : Ice.ObjectImpl, SSLPermissionsVerifier
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Glacier2::SSLPermissionsVerifier</c>.</returns>
