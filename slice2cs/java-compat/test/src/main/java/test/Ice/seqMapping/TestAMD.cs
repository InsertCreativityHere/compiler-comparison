...
namespace Test
{
    ...
    public partial class Bar : global::Ice.UserException
    {
        ...
        {
            info.AddValue("SLmem", this.SLmem, typeof(byte[]));
            info.AddValue("SLSmem", this.SLSmem, typeof(byte[][]));
...
namespace Test
{
    ...
    public interface MyClassOperations_
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.7.10")]
        global::System.Threading.Tasks.Task<MyClass_OpSerialSmallJavaResult> opSerialSmallJavaAsync(byte[] i, global::Ice.Current current = null);

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.7.10")]
        global::System.Threading.Tasks.Task<MyClass_OpSerialLargeJavaResult> opSerialLargeJavaAsync(byte[] i, global::Ice.Current current = null);

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.7.10")]
        global::System.Threading.Tasks.Task<MyClass_OpSerialStructJavaResult> opSerialStructJavaAsync(byte[] i, global::Ice.Current current = null);
    }
}
...
namespace Test
{
    ...
    public abstract class MyClassDisp_ : global::Ice.ObjectImpl, MyClass
    {
        ...
        public abstract global::System.Threading.Tasks.Task<MyClass_OpSerialSmallJavaResult> opSerialSmallJavaAsync(byte[] i, global::Ice.Current current = null);

        public abstract global::System.Threading.Tasks.Task<MyClass_OpSerialLargeJavaResult> opSerialLargeJavaAsync(byte[] i, global::Ice.Current current = null);

        public abstract global::System.Threading.Tasks.Task<MyClass_OpSerialStructJavaResult> opSerialStructJavaAsync(byte[] i, global::Ice.Current current = null);
        ...
        iceD_opSerialSmallJava(MyClass obj, global::IceInternal.Incoming inS, global::Ice.Current current)
        {
            ...
            inS.endReadParams();
            return inS.setResultTask<MyClass_OpSerialSmallJavaResult>(obj.opSerialSmallJavaAsync(iceP_i, current),
                (ostr, ret) =>
                {
        ...
        iceD_opSerialLargeJava(MyClass obj, global::IceInternal.Incoming inS, global::Ice.Current current)
        {
            ...
            inS.endReadParams();
            return inS.setResultTask<MyClass_OpSerialLargeJavaResult>(obj.opSerialLargeJavaAsync(iceP_i, current),
                (ostr, ret) =>
                {
        ...
        iceD_opSerialStructJava(MyClass obj, global::IceInternal.Incoming inS, global::Ice.Current current)
        {
            ...
            inS.endReadParams();
            return inS.setResultTask<MyClass_OpSerialStructJavaResult>(obj.opSerialStructJavaAsync(iceP_i, current),
                (ostr, ret) =>
                {
