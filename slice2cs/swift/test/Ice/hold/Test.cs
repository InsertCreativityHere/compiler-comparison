...
namespace Test
{
    ...
    public sealed partial class HoldPrxHelper : Ice.ObjectPrxHelperBase, HoldPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Hold</c>.</returns>
        public static async global::System.Threading.Tasks.Task<HoldPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new HoldPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Hold</c>.</returns>
        public static global::System.Threading.Tasks.Task<HoldPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Hold</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Hold</c>.</remarks>
    public abstract partial class HoldDisp_ : Ice.ObjectImpl, Hold
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Hold</c>.</returns>
