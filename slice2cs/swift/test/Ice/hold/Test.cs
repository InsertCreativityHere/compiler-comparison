...
namespace Test
{
    /// <remarks>The Slice compiler generated this client-side interface from Slice interface <c>::Test::Hold</c>.
    /// Use the methods of this interface to invoke operations on a remote Ice object that implements <c>Hold</c>.</remarks>
    public partial interface HoldPrx : Ice.ObjectPrx
    {
        /// <summary>Puts the adapter on hold, and optionally reactivates it.</summary>
        ...
        global::System.Threading.Tasks.Task putOnHoldAsync(
            int delay,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default);

        /// <summary>Starts a background task that calls waitForHold and activate on the adapter.</summary>
        /// <param name="context">The request context.</param>
        void waitForHold(
            global::System.Collections.Generic.Dictionary<string, string>? context = null);
        ...
        /// <param name="cancel">A cancellation token that receives the cancellation requests.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        global::System.Threading.Tasks.Task waitForHoldAsync(
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default);
    ...
    /// <summary>Helper class for proxy <see cref="HoldPrx" />.</summary>
    /// <remarks>The Slice compiler generated this proxy helper class from Slice interface <c>::Test::Hold</c>.</remarks>
    public sealed partial class HoldPrxHelper : Ice.ObjectPrxHelperBase, HoldPrx
    {
        ...
        public global::System.Threading.Tasks.Task putOnHoldAsync(
            int delay,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default)
        ...
        private global::System.Threading.Tasks.Task _iceI_putOnHoldAsync(
            int iceP_delay,
        ...
        public global::System.Threading.Tasks.Task waitForHoldAsync(
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default)
        {
        ...
        private global::System.Threading.Tasks.Task _iceI_waitForHoldAsync(
            global::System.Collections.Generic.Dictionary<string, string>? context,
            global::System.IProgress<bool>? progress,
            global::System.Threading.CancellationToken cancel,
            bool synchronous)
        ...
        private void _iceI_waitForHold(
            global::System.Collections.Generic.Dictionary<string, string>? context,
            bool synchronous,
            Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
        ...
        /// <summary>Downcasts a proxy to a <see cref="HoldPrx" /> after checking that the target object implements Slice interface <c>Hold</c>.</summary>
        /// <param name="proxy">The source proxy.</param>
        /// <param name="context">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Hold</c>.</returns>
        public static HoldPrx? checkedCast(
            Ice.ObjectPrx? proxy,
            global::System.Collections.Generic.Dictionary<string, string>? context = null) =>
            proxy is not null && proxy.ice_isA(ice_staticId(), context) ? new HoldPrxHelper(proxy) : null;

        /// <summary>Downcasts a proxy to a <see cref="HoldPrx" /> after checking that the target facet implements Slice interface <c>Hold</c>.</summary>
        /// <param name="proxy">The source proxy.</param>
        /// <param name="facet">The facet.</param>
        /// <param name="context">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Hold</c>.</returns>
        public static HoldPrx? checkedCast(
            Ice.ObjectPrx? proxy,
            string facet,
            global::System.Collections.Generic.Dictionary<string, string>? context = null) =>
        ...
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Hold</c>.</returns>
        public static async global::System.Threading.Tasks.Task<HoldPrx?> checkedCastAsync(
            Ice.ObjectPrx proxy,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
            global::System.Threading.CancellationToken cancel = default) =>
            await proxy.ice_isAAsync(ice_staticId(), context, progress, cancel).ConfigureAwait(false) ? new HoldPrxHelper(proxy) : null;
        ...
        /// <param name="cancel">The cancellation token.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Hold</c>.</returns>
        public static global::System.Threading.Tasks.Task<HoldPrx?> checkedCastAsync(
            Ice.ObjectPrx proxy,
            string facet,
            global::System.Collections.Generic.Dictionary<string, string>? context = null,
            global::System.IProgress<bool>? progress = null,
        ...
        /// <summary>Downcasts a proxy to a <see cref="HoldPrx" />. This method does not perform any check.</summary>
        /// <param name="proxy">The source proxy.</param>
        ...
        public static HoldPrx? uncheckedCast(Ice.ObjectPrx? proxy) =>
            proxy is not null ? new HoldPrxHelper(proxy) : null;

        /// <summary>Downcasts a proxy to a <see cref="HoldPrx" /> after changing its facet. This method does not perform any check.</summary>
        /// <param name="proxy">The source proxy.</param>
        /// <param name="facet">The facet.</param>
        /// <returns>A proxy with the requested type, or null if the source proxy is null.</returns>
        [return: global::System.Diagnostics.CodeAnalysis.NotNullIfNotNull(nameof(proxy))]
        public static HoldPrx? uncheckedCast(Ice.ObjectPrx? proxy, string facet) =>
            uncheckedCast(proxy?.ice_facet(facet));

        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Hold</c>.</returns>
...
namespace Test
{
    /// <remarks>The Slice compiler generated this server-side interface from Slice interface <c>::Test::Hold</c>.
    /// Your servant class implements this interface by deriving from <see cref="HoldDisp_" /> or from the Disp_ class for a derived interface.</remarks>
    ...
    /// <summary>Implements <see cref="Ice.Object.dispatchAsync" /> for the operations of Slice interface <c>Hold</c>.</summary>
    /// <remarks>The Slice compiler generated this skeleton class from Slice interface <c>::Test::Hold</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Hold</c>.</remarks>
    public abstract partial class HoldDisp_ : Hold
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Hold</c>.</returns>
        public static string ice_staticId() => "::Test::Hold";
