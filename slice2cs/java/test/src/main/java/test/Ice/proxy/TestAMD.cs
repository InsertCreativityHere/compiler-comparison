...
namespace Test
{
    ...
    public sealed partial class MyOtherDerivedClassPrxHelper : Ice.ObjectPrxHelperBase, MyOtherDerivedClassPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>MyOtherDerivedClass</c>.</returns>
        public static async global::System.Threading.Tasks.Task<MyOtherDerivedClassPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new MyOtherDerivedClassPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>MyOtherDerivedClass</c>.</returns>
        public static global::System.Threading.Tasks.Task<MyOtherDerivedClassPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
    ...
    public sealed partial class DiamondClassPrxHelper : Ice.ObjectPrxHelperBase, DiamondClassPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>DiamondClass</c>.</returns>
        public static async global::System.Threading.Tasks.Task<DiamondClassPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new DiamondClassPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>DiamondClass</c>.</returns>
        public static global::System.Threading.Tasks.Task<DiamondClassPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::MyOtherDerivedClass</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>MyOtherDerivedClass</c>.</remarks>
    public abstract partial class MyOtherDerivedClassDisp_ : Ice.ObjectImpl, MyOtherDerivedClass
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::MyOtherDerivedClass</c>.</returns>
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::DiamondClass</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>DiamondClass</c>.</remarks>
    public abstract partial class DiamondClassDisp_ : Ice.ObjectImpl, DiamondClass
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::DiamondClass</c>.</returns>
