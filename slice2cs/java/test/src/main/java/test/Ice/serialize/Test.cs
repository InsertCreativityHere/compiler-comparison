...
namespace Test
{
    ...
    public partial class Ex : global::Ice.UserException
    {
        ...
        {
            this.s = (Struct1)info.GetValue("s", typeof(Struct1));
            this.b = (@Base)info.GetValue("b", typeof(@Base));
        }
        ...
        {
            int h_ = 5381;
            global::IceInternal.HashUtil.hashAdd(ref h_, "::Test::Ex");
        ...
        {
            info.AddValue("s", this.s, typeof(Struct1));
            info.AddValue("b", this.b, typeof(@Base));
