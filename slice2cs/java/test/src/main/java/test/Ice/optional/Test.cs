...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this class from Slice class <c>::Test::OptionalWithCustom</c>.</remarks>
    ...
    public partial class OptionalWithCustom : Ice.Value
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="OptionalWithCustom" /> class.</summary>
        ...
        /// <summary>Gets the type ID of the associated Slice class.</summary>
        /// <returns>The string <c>::Test::OptionalWithCustom</c>.</returns>
