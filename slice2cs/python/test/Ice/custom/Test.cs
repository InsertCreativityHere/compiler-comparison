...
namespace Test
{
    ...
    public sealed partial record class S
    {
        ...
        public static void ice_write(Ice.OutputStream ostr, S v)
        {
            ...
            ByteListHelper.write(ostr, v.b3);
            ...
            StringTupleHelper.write(ostr, v.s4);
        }
    ...
    public sealed partial class CustomPrxHelper : Ice.ObjectPrxHelperBase, CustomPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Custom</c>.</returns>
        public static async global::System.Threading.Tasks.Task<CustomPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new CustomPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Custom</c>.</returns>
        public static global::System.Threading.Tasks.Task<CustomPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Custom</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Custom</c>.</remarks>
    public abstract partial class CustomDisp_ : Ice.ObjectImpl, Custom
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Custom</c>.</returns>
