...
namespace Ice.objects.Test
{
    ...
    public sealed partial class F2PrxHelper : Ice.ObjectPrxHelperBase, F2Prx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>F2</c>.</returns>
        public static async global::System.Threading.Tasks.Task<F2Prx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new F2PrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>F2</c>.</returns>
        public static global::System.Threading.Tasks.Task<F2Prx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Ice.objects.Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::F2</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>F2</c>.</remarks>
    public abstract partial class F2Disp_ : Ice.ObjectImpl, F2
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::F2</c>.</returns>
