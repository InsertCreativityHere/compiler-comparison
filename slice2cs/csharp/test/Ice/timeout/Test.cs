...
namespace Ice.timeout.Test
{
    ...
    public sealed partial class TimeoutPrxHelper : Ice.ObjectPrxHelperBase, TimeoutPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Timeout</c>.</returns>
        public static async global::System.Threading.Tasks.Task<TimeoutPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new TimeoutPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Timeout</c>.</returns>
        public static global::System.Threading.Tasks.Task<TimeoutPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Ice.timeout.Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Timeout</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Timeout</c>.</remarks>
    public abstract partial class TimeoutDisp_ : Ice.ObjectImpl, Timeout
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Timeout</c>.</returns>
