...
namespace Ice.servantLocator.Test
{
    ...
    public sealed partial class TestActivationPrxHelper : Ice.ObjectPrxHelperBase, TestActivationPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>TestActivation</c>.</returns>
        public static async global::System.Threading.Tasks.Task<TestActivationPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new TestActivationPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>TestActivation</c>.</returns>
        public static global::System.Threading.Tasks.Task<TestActivationPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Ice.servantLocator.Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::TestActivation</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>TestActivation</c>.</remarks>
    public abstract partial class TestActivationDisp_ : Ice.ObjectImpl, TestActivation
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::TestActivation</c>.</returns>
