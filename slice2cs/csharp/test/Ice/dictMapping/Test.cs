...
namespace Ice.dictMapping.Test
{
    ...
    /// <remarks>The Slice compiler generated this record class from Slice struct <c>::Test::TEstNv</c>.</remarks>
    public sealed partial record class TEstNv
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="TEstNv" /> class.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="TEstNv" /> class from an input stream.</summary>
        ...
        {
            NVHelper.write(ostr, v.d);
            IntSeqHelper.write(ostr, v.s);
        }
