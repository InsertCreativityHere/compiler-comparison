...
namespace Ice.binding.Test
{
    ...
    public sealed partial class RemoteObjectAdapterPrxHelper : Ice.ObjectPrxHelperBase, RemoteObjectAdapterPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>RemoteObjectAdapter</c>.</returns>
        public static async global::System.Threading.Tasks.Task<RemoteObjectAdapterPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new RemoteObjectAdapterPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>RemoteObjectAdapter</c>.</returns>
        public static global::System.Threading.Tasks.Task<RemoteObjectAdapterPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
...
namespace Ice.binding.Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::RemoteObjectAdapter</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>RemoteObjectAdapter</c>.</remarks>
    public abstract partial class RemoteObjectAdapterDisp_ : Ice.ObjectImpl, RemoteObjectAdapter
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::RemoteObjectAdapter</c>.</returns>
