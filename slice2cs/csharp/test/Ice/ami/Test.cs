...
namespace Ice.ami.Test
{
    ...
    public sealed partial class PingReplyPrxHelper : Ice.ObjectPrxHelperBase, PingReplyPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>PingReply</c>.</returns>
        public static async global::System.Threading.Tasks.Task<PingReplyPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new PingReplyPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>PingReply</c>.</returns>
        public static global::System.Threading.Tasks.Task<PingReplyPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Ice.ami.Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::PingReply</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>PingReply</c>.</remarks>
    public abstract partial class PingReplyDisp_ : Ice.ObjectImpl, PingReply
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::PingReply</c>.</returns>
    ...
    namespace Outer
    {
        namespace Inner
        {
            ...
            /// <summary>Implements <see cref="Ice.Object.dispatchAsync" /> for the operations of Slice interface <c>TestIntf</c>.</summary>
            /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Outer::Inner::TestIntf</c>.
            /// Your servant class derives from this abstract class to implement Slice interface <c>TestIntf</c>.</remarks>
            public abstract partial class TestIntfDisp_ : Ice.ObjectImpl, TestIntf
            {
                /// <summary>Gets the type ID of the associated Slice interface.</summary>
