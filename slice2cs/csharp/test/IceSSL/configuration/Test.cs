...
namespace Test
{
    ...
    public sealed partial class ServerPrxHelper : Ice.ObjectPrxHelperBase, ServerPrx
    {
        ...
        private void _iceI_checkCipher(string iceP_cipher, global::System.Collections.Generic.Dictionary<string, string>? context, bool synchronous, Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
                _checkCipher_name,
    ...
    public sealed partial class PingablePrxHelper : Ice.ObjectPrxHelperBase, PingablePrx
    {
        ...
        public static PingablePrx? checkedCast(Ice.ObjectPrx? b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            b is not null && b.ice_isA(ice_staticId(), ctx) ? new PingablePrxHelper(b) : null;
        ...
        public static PingablePrx? checkedCast(Ice.ObjectPrx? b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCast(b?.ice_facet(f), ctx);
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Pingable</c>.</returns>
        public static async global::System.Threading.Tasks.Task<PingablePrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new PingablePrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Pingable</c>.</returns>
        public static global::System.Threading.Tasks.Task<PingablePrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            checkedCastAsync(b.ice_facet(f), ctx);
        ...
        /// <returns>A proxy with the requested type, or null if the source proxy is null.</returns>
        [return: global::System.Diagnostics.CodeAnalysis.NotNullIfNotNull(nameof(b))]
        public static PingablePrx? uncheckedCast(Ice.ObjectPrx? b) =>
            b is not null ? new PingablePrxHelper(b) : null;
        ...
        /// <returns>A proxy with the requested type, or null if the source proxy is null.</returns>
        [return: global::System.Diagnostics.CodeAnalysis.NotNullIfNotNull(nameof(b))]
        public static PingablePrx? uncheckedCast(Ice.ObjectPrx? b, string f) =>
            uncheckedCast(b?.ice_facet(f));
...
namespace Test
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Test::Pingable</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Pingable</c>.</remarks>
    public abstract partial class PingableDisp_ : Ice.ObjectImpl, Pingable
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Test::Pingable</c>.</returns>
