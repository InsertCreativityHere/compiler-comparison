...
namespace Test
{
    ...
    public sealed partial record class S2
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="S2" /> class.</summary>
        public S2(bool bo, byte by, short sh, int i, long l, float f, double d, string str, string[] ss, global::System.Collections.Generic.List<int> il, global::System.Collections.Generic.Dictionary<string, string> sd, S1 s, C? cls, Ice.ObjectPrx? prx)
        {
            this.bo = bo;
            this.by = by;
            this.sh = sh;
