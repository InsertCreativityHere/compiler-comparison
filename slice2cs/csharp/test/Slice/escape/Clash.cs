...
namespace Clash
{
    ...
    public sealed partial class IntfPrxHelper : Ice.ObjectPrxHelperBase, IntfPrx
    {
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target object does not implement Slice interface <c>Intf</c>.</returns>
        public static async global::System.Threading.Tasks.Task<IntfPrx?> checkedCastAsync(Ice.ObjectPrx b, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
            await b.ice_isAAsync(ice_staticId(), ctx).ConfigureAwait(false) ? new IntfPrxHelper(b) : null;
        ...
        /// <param name="ctx">The request context.</param>
        /// <returns>A proxy with the requested type, or null if the target facet does not implement Slice interface <c>Intf</c>.</returns>
        public static global::System.Threading.Tasks.Task<IntfPrx?> checkedCastAsync(Ice.ObjectPrx b, string f, global::System.Collections.Generic.Dictionary<string, string>? ctx = null) =>
...
namespace Clash
{
    ...
    /// <remarks>The Slice compiler generated this dispatch helper class from Slice interface <c>::Clash::Intf</c>.
    /// Your servant class derives from this abstract class to implement Slice interface <c>Intf</c>.</remarks>
    public abstract partial class IntfDisp_ : Ice.ObjectImpl, Intf
    {
        /// <summary>Gets the type ID of the associated Slice interface.</summary>
        /// <returns>The string <c>::Clash::Intf</c>.</returns>
