...
namespace Clash
{
    ...
    public sealed partial class St : global::System.ICloneable, global::System.IEquatable<St>
    {
        ...
        public bool Equals(St other)
        {
            ...
            if (this.hashCode is null)
            {
                if (other.hashCode is not null)
                {
                    return false;
                }
            }
            ...
            if (!this.ice_clone_.Equals(other.ice_clone_))
            {
                return false;
            }
            return true;
...
namespace Clash
{
    ...
    public sealed class IntfPrxHelper : global::Ice.ObjectPrxHelperBase, IntfPrx
    {
        ...
        private void _iceI_obj(global::System.Collections.Generic.Dictionary<string, string> context, bool synchronous, global::Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
                _obj_name,
        ...
        private void _iceI_op(string iceP_context, string iceP_current, string iceP_response, string iceP_ex, string iceP_sent, string iceP_cookie, string iceP_sync, string iceP_result, string iceP_istr, string iceP_ostr, global::Ice.Optional<string> iceP_proxy, global::Ice.Optional<int> iceP_obj, global::System.Collections.Generic.Dictionary<string, string> context, bool synchronous, global::Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
                _op_name,
...
namespace Clash
{
    ...
    public abstract class IntfDisp_ : global::Ice.ObjectImpl, Intf
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static global::System.Threading.Tasks.Task<global::Ice.OutputStream>
        iceD_obj(Intf obj, global::Ice.Internal.Incoming inS, global::Ice.Current current)
        {
            global::Ice.ObjectImpl.iceCheckMode(global::Ice.OperationMode.Normal, current.mode);
            inS.readEmptyParams();
            obj.obj(current);
