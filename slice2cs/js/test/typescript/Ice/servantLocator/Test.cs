...
namespace Test
{
    ...
    public partial interface TestIntf : Ice.Object
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.8.0-alpha.0")]
        void jsException(Ice.Current current);
...
namespace Test
{
    ...
    public sealed class TestIntfPrxHelper : Ice.ObjectPrxHelperBase, TestIntfPrx
    {
        ...
        private void _iceI_jsException(global::System.Collections.Generic.Dictionary<string, string>? context, bool synchronous, Ice.Internal.OutgoingAsyncCompletionCallback completed)
        {
            var outAsync = getOutgoingAsync<object>(completed);
            outAsync.invoke(
                _jsException_name,
...
namespace Test
{
    ...
    public abstract class TestIntfDisp_ : Ice.ObjectImpl, TestIntf
    {
        ...
        public abstract void jsException(Ice.Current current);
...
namespace Test
{
    public partial interface TestIntf
    {
        ...
        protected static global::System.Threading.Tasks.ValueTask<Ice.OutgoingResponse> iceD_jsExceptionAsync(
            TestIntf obj,
            Ice.IncomingRequest request)
        {
            Ice.ObjectImpl.iceCheckMode(Ice.OperationMode.Normal, request.current.mode);
