...
namespace Test
{
    ...
    public partial class Exception1 : global::Ice.UserException
    {
        ...
        {
            this.isa = info.GetInt32("isa");
            this.reason = info.GetInt32("reason");
            this.raise = info.GetInt32("raise");
            this.name = info.GetInt32("name");
            this.callStackReturnAddresses = info.GetInt32("callStackReturnAddresses");
            this.userInfo = info.GetInt32("userInfo");
            this.reserved = info.GetInt32("reserved");
        }
        ...
        public override int GetHashCode()
        {
            ...
            global::IceInternal.HashUtil.hashAdd(ref h_, raise);
            global::IceInternal.HashUtil.hashAdd(ref h_, name);
            global::IceInternal.HashUtil.hashAdd(ref h_, callStackReturnAddresses);
            global::IceInternal.HashUtil.hashAdd(ref h_, userInfo);
            global::IceInternal.HashUtil.hashAdd(ref h_, reserved);
            return h_;
        }
        ...
        public override bool Equals(object other)
        {
            ...
            if(!this.callStackReturnAddresses.Equals(o.callStackReturnAddresses))
            {
                return false;
            }
            if(!this.userInfo.Equals(o.userInfo))
            {
                return false;
            }
            if(!this.reserved.Equals(o.reserved))
            {
                return false;
            }
            return true;
        ...
        {
            info.AddValue("isa", this.isa);
            info.AddValue("reason", this.reason);
            info.AddValue("raise", this.raise);
            info.AddValue("name", this.name);
            info.AddValue("callStackReturnAddresses", this.callStackReturnAddresses);
            info.AddValue("userInfo", this.userInfo);
            info.AddValue("reserved", this.reserved);
...
namespace Test
{
    ...
    public sealed class Intf1PrxHelper : global::Ice.ObjectPrxHelperBase, Intf1Prx
    {
        ...
        public Intf1PrxHelper(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : base(info, context)
        {
        }
    ...
    public sealed class Intf2PrxHelper : global::Ice.ObjectPrxHelperBase, Intf2Prx
    {
        ...
        public Intf2PrxHelper(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : base(info, context)
        {
        }
