...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_InitialPrx, 'opOneOptionalProxyReq', 0, 0, 0, array(array($Ice__t_ObjectPrx, 2)), array(array($Ice__t_ObjectPrx, 3)), array($Ice__t_ObjectPrx, 1), null);
