...
namespace Test
{
    global $Test__t_ObjectSeq;

    if(!isset($Test__t_ObjectSeq))
    {
        global $Ice__t_Value;
        $Test__t_ObjectSeq = IcePHP_defineSequence('::Test::ObjectSeq', $Ice__t_Value);
    }
}

namespace Test
{
    global $Test__t_ObjectPrxSeq;

    if(!isset($Test__t_ObjectPrxSeq))
    {
        global $Ice__t_ObjectPrx;
        $Test__t_ObjectPrxSeq = IcePHP_defineSequence('::Test::ObjectPrxSeq', $Ice__t_ObjectPrx);
    }
}
...
namespace Test
{
    global $Test__t_BasePrxSeq;

    if(!isset($Test__t_BasePrxSeq))
    {
        global $Ice__t_ObjectPrx;
        $Test__t_BasePrxSeq = IcePHP_defineSequence('::Test::BasePrxSeq', $Ice__t_ObjectPrx);
    }
}

namespace Test
{
    global $Test__t_ObjectDict;

    if(!isset($Test__t_ObjectDict))
    {
        global $IcePHP__t_string;
        global $Ice__t_Value;
        $Test__t_ObjectDict = IcePHP_defineDictionary('::Test::ObjectDict', $IcePHP__t_string, $Ice__t_Value);
    }
}

namespace Test
{
    global $Test__t_ObjectPrxDict;

    if(!isset($Test__t_ObjectPrxDict))
    {
        global $IcePHP__t_string;
        global $Ice__t_ObjectPrx;
        $Test__t_ObjectPrxDict = IcePHP_defineDictionary('::Test::ObjectPrxDict', $IcePHP__t_string, $Ice__t_ObjectPrx);
    }
}

namespace Test
{
    global $Test__t_BaseDict;

    if(!isset($Test__t_BaseDict))
    {
        global $IcePHP__t_string;
        global $Test__t_Base;
        $Test__t_BaseDict = IcePHP_defineDictionary('::Test::BaseDict', $IcePHP__t_string, $Test__t_Base);
    }
}

namespace Test
{
    global $Test__t_BasePrxDict;

    if(!isset($Test__t_BasePrxDict))
    {
        global $IcePHP__t_string;
        global $Ice__t_ObjectPrx;
        $Test__t_BasePrxDict = IcePHP_defineDictionary('::Test::BasePrxDict', $IcePHP__t_string, $Ice__t_ObjectPrx);
    }
}
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_InitialPrx, 'getObjectSeq', 0, 0, 0, array(array($Test__t_ObjectSeq)), null, array($Test__t_ObjectSeq), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getObjectPrxSeq', 0, 0, 0, array(array($Test__t_ObjectPrxSeq)), null, array($Test__t_ObjectPrxSeq), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getBaseSeq', 0, 0, 0, array(array($Test__t_BaseSeq)), null, array($Test__t_BaseSeq), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getBasePrxSeq', 0, 0, 0, array(array($Test__t_BasePrxSeq)), null, array($Test__t_BasePrxSeq), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getObjectDict', 0, 0, 0, array(array($Test__t_ObjectDict)), null, array($Test__t_ObjectDict), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getObjectPrxDict', 0, 0, 0, array(array($Test__t_ObjectPrxDict)), null, array($Test__t_ObjectPrxDict), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getBaseDict', 0, 0, 0, array(array($Test__t_BaseDict)), null, array($Test__t_BaseDict), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getBasePrxDict', 0, 0, 0, array(array($Test__t_BasePrxDict)), null, array($Test__t_BasePrxDict), null);
