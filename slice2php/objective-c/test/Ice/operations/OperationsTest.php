...
namespace Test
{
    global $Test__t_StructS;

    if(!isset($Test__t_StructS))
    {
        global $Test__t_Structure;
        $Test__t_StructS = IcePHP_defineSequence('::Test::StructS', $Test__t_Structure);
    }
}
...
namespace Test
{
    ...
    class Struct2
    {
        public function __construct($b=false, $i=0, $f=0.0, $d=0.0, $by=0, $sh=0, $l=0, $ss=null, $dict=null, $seq=null)
        {
            $this->b = $b;
            $this->i = $i;
            $this->f = $f;
    ...
    $Test__t_Struct2 = IcePHP_defineStruct('::Test::Struct2', '\\Test\\Struct2', array(
        ...
        array('ss', $Test__t_StructS),
        array('dict', $Test__t_ByteBoolD),
        array('seq', $Test__t_MyEnumSS)));
}
...
namespace Test
{
    ...
    {
        global $Test__t_A;
        $Test__t_AS = IcePHP_defineSequence('::Test::AS', $Test__t_A);
    }
}
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyEnumS', 0, 0, 0, array(array($Test__t_MyEnumS), array($Test__t_MyEnumS)), array(array($Test__t_MyEnumS)), array($Test__t_MyEnumS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyClassS', 0, 0, 0, array(array($Test__t_MyClassS), array($Test__t_MyClassS)), array(array($Test__t_MyClassS)), array($Test__t_MyClassS), null);
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getNSNullStringSeq', 0, 0, 0, null, null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getNSNullASeq', 0, 0, 0, null, null, array($Test__t_AS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getNSNullStructSeq', 0, 0, 0, null, null, array($Test__t_StructS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getNSNullStringSeqSeq', 0, 0, 0, null, null, array($Test__t_StringSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getNSNullStringStringDict', 0, 0, 0, null, null, array($Test__t_StringStringD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'putNSNullStringStringDict', 0, 0, 0, array(array($Test__t_StringStringD)), null, null, null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'putNSNullShortIntDict', 0, 0, 0, array(array($Test__t_ShortIntD)), null, null, null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'putNSNullStringMyEnumDict', 0, 0, 0, array(array($Test__t_StringMyEnumD)), null, null, null);
}
