...
namespace Test
{
    ...
    {
        public function __construct($requiredA=0, $mc=\Ice\None, $mb=\Ice\None, $ma=\Ice\None)
        {
...
namespace Test
{
    ...
    {
        public function __construct($requiredA=0, $mc=\Ice\None, $mb=\Ice\None, $ma=\Ice\None, $requiredB=0, $md=\Ice\None)
        {
            parent::__construct($requiredA, $mc, $mb, $ma);
...
namespace Test
{
    ...
    {
        public function __construct($requiredA=0, $mc=\Ice\None, $mb=\Ice\None, $ma=\Ice\None, $requiredB=0, $md=\Ice\None, $ss='', $ms=\Ice\None)
        {
            parent::__construct($requiredA, $mc, $mb, $ma, $requiredB, $md);
            $this->ss = $ss;
            $this->ms = $ms;
        }
...
namespace Test
{
    ...
    {
        public function __construct($req=false, $a=5, $b=\Ice\None, $o=\Ice\None, $d1="d1", $ss="test", $o2=\Ice\None, $d2="d2")
        {
