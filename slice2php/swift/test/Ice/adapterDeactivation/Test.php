...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'transient', 'transient', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'deactivate', 'deactivate', 0, -1, null, null, null, null);
}
