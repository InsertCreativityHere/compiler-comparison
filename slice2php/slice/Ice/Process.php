...
namespace
{
    require_once 'LocatorRegistry.php';
}
...
namespace Ice
{
    ...
    IcePHP_defineOperation($Ice__t_ProcessPrx, 'shutdown', 'shutdown', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Ice__t_ProcessPrx, 'writeMessage', 'writeMessage', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_int)), null, null, null);
}
?>
