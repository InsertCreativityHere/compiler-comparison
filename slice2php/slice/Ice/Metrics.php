...
namespace IceMX
{
    ...
    global $IcePHP__t_int;
    $IceMX__t_Metrics = IcePHP_defineClass('::IceMX::Metrics', '\\IceMX\\Metrics', -1, $Ice__t_Value, array(
...
namespace IceMX
{
    ...
    global $IceMX__t_MetricsFailuresSeq;
    global $IceMX__t_MetricsFailures;
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'getMetricsViewNames', 'getMetricsViewNames', 0, -1, null, array(array($Ice__t_StringSeq)), array($Ice__t_StringSeq), null);
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'enableMetricsView', 'enableMetricsView', 0, -1, array(array($IcePHP__t_string)), null, null, array($IceMX__t_UnknownMetricsView));
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'disableMetricsView', 'disableMetricsView', 0, -1, array(array($IcePHP__t_string)), null, null, array($IceMX__t_UnknownMetricsView));
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'getMetricsView', 'getMetricsView', 0, 1, array(array($IcePHP__t_string)), array(array($IcePHP__t_long)), array($IceMX__t_MetricsView), array($IceMX__t_UnknownMetricsView));
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'getMapMetricsFailures', 'getMapMetricsFailures', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_string)), null, array($IceMX__t_MetricsFailuresSeq), array($IceMX__t_UnknownMetricsView));
    IcePHP_defineOperation($IceMX__t_MetricsAdminPrx, 'getMetricsFailures', 'getMetricsFailures', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string)), null, array($IceMX__t_MetricsFailures), array($IceMX__t_UnknownMetricsView));
}
...
namespace IceMX
{
    ...
    global $IceMX__t_Metrics;
    global $IcePHP__t_int;
    $IceMX__t_ThreadMetrics = IcePHP_defineClass('::IceMX::ThreadMetrics', '\\IceMX\\ThreadMetrics', -1, $IceMX__t_Metrics, array(
...
namespace IceMX
{
    ...
    global $IcePHP__t_int;
    global $IcePHP__t_long;
    $IceMX__t_DispatchMetrics = IcePHP_defineClass('::IceMX::DispatchMetrics', '\\IceMX\\DispatchMetrics', -1, $IceMX__t_Metrics, array(
...
namespace IceMX
{
    ...
    global $IceMX__t_Metrics;
    global $IcePHP__t_long;
    $IceMX__t_ChildInvocationMetrics = IcePHP_defineClass('::IceMX::ChildInvocationMetrics', '\\IceMX\\ChildInvocationMetrics', -1, $IceMX__t_Metrics, array(
        array('size', $IcePHP__t_long, false, 0),
        array('replySize', $IcePHP__t_long, false, 0)));
}
...
namespace IceMX
{
    ...
    global $IceMX__t_ChildInvocationMetrics;
    $IceMX__t_CollocatedMetrics = IcePHP_defineClass('::IceMX::CollocatedMetrics', '\\IceMX\\CollocatedMetrics', -1, $IceMX__t_ChildInvocationMetrics, null);
}
...
namespace IceMX
{
    ...
    global $IceMX__t_ChildInvocationMetrics;
    $IceMX__t_RemoteMetrics = IcePHP_defineClass('::IceMX::RemoteMetrics', '\\IceMX\\RemoteMetrics', -1, $IceMX__t_ChildInvocationMetrics, null);
}
...
namespace IceMX
{
    ...
    global $IcePHP__t_int;
    global $IceMX__t_MetricsMap;
    $IceMX__t_InvocationMetrics = IcePHP_defineClass('::IceMX::InvocationMetrics', '\\IceMX\\InvocationMetrics', -1, $IceMX__t_Metrics, array(
...
namespace IceMX
{
    ...
    global $IceMX__t_Metrics;
    global $IcePHP__t_long;
    $IceMX__t_ConnectionMetrics = IcePHP_defineClass('::IceMX::ConnectionMetrics', '\\IceMX\\ConnectionMetrics', -1, $IceMX__t_Metrics, array(
