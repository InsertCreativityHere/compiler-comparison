...
namespace IceStorm
{
    ...
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getName', 2, -1, null, null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getPublisher', 2, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getNonReplicatedPublisher', 2, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'subscribeAndGetPublisher', 0, -1, array(array($IceStorm__t_QoS), array($Ice__t_ObjectPrx)), null, array($Ice__t_ObjectPrx), array($IceStorm__t_AlreadySubscribed, $IceStorm__t_InvalidSubscriber, $IceStorm__t_BadQoS));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'unsubscribe', 2, -1, array(array($Ice__t_ObjectPrx)), null, null, null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'link', 0, -1, array(array($IceStorm__t_TopicPrx), array($IcePHP__t_int)), null, null, array($IceStorm__t_LinkExists));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'unlink', 0, -1, array(array($IceStorm__t_TopicPrx)), null, null, array($IceStorm__t_NoSuchLink));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getLinkInfoSeq', 2, -1, null, null, array($IceStorm__t_LinkInfoSeq), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getSubscribers', 0, -1, null, null, array($Ice__t_IdentitySeq), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'destroy', 0, -1, null, null, null, null);
}
...
namespace IceStorm
{
    ...
    global $IceStorm__t_TopicManagerPrx;
    IcePHP_defineOperation($IceStorm__t_FinderPrx, 'getTopicManager', 0, -1, null, null, array($IceStorm__t_TopicManagerPrx), null);
}
?>
