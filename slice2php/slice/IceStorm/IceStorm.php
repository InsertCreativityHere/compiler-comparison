...
namespace IceStorm
{
    ...
    class TopicPrxHelper
    {
        ...
        {
            return $proxy->ice_checkedCast('::IceStorm::Topic', ...$args);
        }
    ...
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getName', 'getName', 2, -1, null, null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getPublisher', 'getPublisher', 2, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getNonReplicatedPublisher', 'getNonReplicatedPublisher', 2, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'subscribeAndGetPublisher', 'subscribeAndGetPublisher', 0, -1, array(array($IceStorm__t_QoS), array($Ice__t_ObjectPrx)), null, array($Ice__t_ObjectPrx), array($IceStorm__t_AlreadySubscribed, $IceStorm__t_BadQoS));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'unsubscribe', 'unsubscribe', 2, -1, array(array($Ice__t_ObjectPrx)), null, null, null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'link', 'link', 0, -1, array(array($IceStorm__t_TopicPrx), array($IcePHP__t_int)), null, null, array($IceStorm__t_LinkExists));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'unlink', 'unlink', 0, -1, array(array($IceStorm__t_TopicPrx)), null, null, array($IceStorm__t_NoSuchLink));
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getLinkInfoSeq', 'getLinkInfoSeq', 2, -1, null, null, array($IceStorm__t_LinkInfoSeq), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'getSubscribers', 'getSubscribers', 0, -1, null, null, array($Ice__t_IdentitySeq), null);
    IcePHP_defineOperation($IceStorm__t_TopicPrx, 'destroy', 'destroy', 0, -1, null, null, null, null);
    ...
    class TopicManagerPrxHelper
    {
        ...
        public static function checkedCast($proxy, ...$args)
        {
            return $proxy->ice_checkedCast('::IceStorm::TopicManager', ...$args);
        }
    ...
    global $IceStorm__t_TopicPrx;
    global $IceStorm__t_TopicDict;
    IcePHP_defineOperation($IceStorm__t_TopicManagerPrx, 'create', 'create', 0, -1, array(array($IcePHP__t_string)), null, array($IceStorm__t_TopicPrx), array($IceStorm__t_TopicExists));
    IcePHP_defineOperation($IceStorm__t_TopicManagerPrx, 'retrieve', 'retrieve', 2, -1, array(array($IcePHP__t_string)), null, array($IceStorm__t_TopicPrx), array($IceStorm__t_NoSuchTopic));
    IcePHP_defineOperation($IceStorm__t_TopicManagerPrx, 'retrieveAll', 'retrieveAll', 2, -1, null, null, array($IceStorm__t_TopicDict), null);
    ...
    class FinderPrxHelper
    {
        ...
        public static function checkedCast($proxy, ...$args)
        {
            return $proxy->ice_checkedCast('::IceStorm::Finder', ...$args);
        }
    ...
    global $IceStorm__t_TopicManagerPrx;
    IcePHP_defineOperation($IceStorm__t_FinderPrx, 'getTopicManager', 'getTopicManager', 0, -1, null, null, array($IceStorm__t_TopicManagerPrx), null);
}
