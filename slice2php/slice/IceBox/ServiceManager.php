...
namespace IceBox
{
    ...
    IcePHP_defineOperation($IceBox__t_ServiceObserverPrx, 'servicesStarted', 'servicesStarted', 0, -1, array(array($Ice__t_StringSeq)), null, null, null);
    IcePHP_defineOperation($IceBox__t_ServiceObserverPrx, 'servicesStopped', 'servicesStopped', 0, -1, array(array($Ice__t_StringSeq)), null, null, null);
    ...
    global $IceBox__t_ServiceObserverPrx;
    IcePHP_defineOperation($IceBox__t_ServiceManagerPrx, 'startService', 'startService', 0, -1, array(array($IcePHP__t_string)), null, null, array($IceBox__t_AlreadyStartedException, $IceBox__t_NoSuchServiceException));
    IcePHP_defineOperation($IceBox__t_ServiceManagerPrx, 'stopService', 'stopService', 0, -1, array(array($IcePHP__t_string)), null, null, array($IceBox__t_AlreadyStoppedException, $IceBox__t_NoSuchServiceException));
    IcePHP_defineOperation($IceBox__t_ServiceManagerPrx, 'addObserver', 'addObserver', 0, -1, array(array($IceBox__t_ServiceObserverPrx)), null, null, null);
    IcePHP_defineOperation($IceBox__t_ServiceManagerPrx, 'shutdown', 'shutdown', 0, -1, null, null, null, null);
}
