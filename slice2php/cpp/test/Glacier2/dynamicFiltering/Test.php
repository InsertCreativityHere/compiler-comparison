...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_BackendPrx, 'check', 0, 0, 0, null, null, null, null);
...
namespace Test
{
    ...
    class TestControllerPrxHelper
    {
        public static function checkedCast($proxy, $facetOrContext=null, $context=null)
        {
            return $proxy->ice_checkedCast('::Test::TestController', $facetOrContext, $context);
        }
    ...
    global $Test__t_TestToken;
    IcePHP_defineOperation($Test__t_TestControllerPrx, 'step', 0, 0, 0, array(array($Glacier2__t_SessionPrx), array($Test__t_TestToken)), array(array($Test__t_TestToken)), null, null);
    IcePHP_defineOperation($Test__t_TestControllerPrx, 'shutdown', 0, 0, 0, null, null, null, null);
}
...
namespace Test
{
    ...
    class TestSessionPrxHelper
    {
        public static function checkedCast($proxy, $facetOrContext=null, $context=null)
        {
            return $proxy->ice_checkedCast('::Test::TestSession', $facetOrContext, $context);
        }
    ...
    IcePHP_defineOperation($Test__t_TestSessionPrx, 'shutdown', 0, 0, 0, null, null, null, null);
}
?>
