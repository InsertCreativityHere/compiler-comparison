...
namespace Test1
{
    ...
    class WstringClassPrxHelper
    {
        ...
        {
            return $proxy->ice_checkedCast('::Test1::WstringClass', ...$args);
        }
    ...
    global $IcePHP__t_string;
    global $Test1__t_WstringStruct;
    IcePHP_defineOperation($Test1__t_WstringClassPrx, 'opString', 'opString', 0, -1, array(array($IcePHP__t_string)), array(array($IcePHP__t_string)), array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test1__t_WstringClassPrx, 'opStruct', 'opStruct', 0, -1, array(array($Test1__t_WstringStruct)), array(array($Test1__t_WstringStruct)), array($Test1__t_WstringStruct), null);
    IcePHP_defineOperation($Test1__t_WstringClassPrx, 'throwExcept', 'throwExcept', 0, -1, array(array($IcePHP__t_string)), null, null, array($Test1__t_WstringException));
}
...
namespace Test2
{
    ...
    class WstringClassPrxHelper
    {
        ...
        public static function checkedCast($proxy, ...$args)
        {
            return $proxy->ice_checkedCast('::Test2::WstringClass', ...$args);
        }
    ...
    global $IcePHP__t_string;
    global $Test2__t_WstringStruct;
    IcePHP_defineOperation($Test2__t_WstringClassPrx, 'opString', 'opString', 0, -1, array(array($IcePHP__t_string)), array(array($IcePHP__t_string)), array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test2__t_WstringClassPrx, 'opStruct', 'opStruct', 0, -1, array(array($Test2__t_WstringStruct)), array(array($Test2__t_WstringStruct)), array($Test2__t_WstringStruct), null);
    IcePHP_defineOperation($Test2__t_WstringClassPrx, 'throwExcept', 'throwExcept', 0, -1, array(array($IcePHP__t_string)), null, null, array($Test2__t_WstringException));
}
