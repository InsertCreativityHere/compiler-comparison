...
namespace Test
{
    global $Test__t_BoolDequeList;

    if(!isset($Test__t_BoolDequeList))
    {
        global $Test__t_BoolSeq;
        $Test__t_BoolDequeList = IcePHP_defineSequence('::Test::BoolDequeList', $Test__t_BoolSeq);
    }
}
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolDequeList', 0, 0, 0, array(array($Test__t_BoolDequeList)), array(array($Test__t_BoolDequeList)), array($Test__t_BoolDequeList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolDequeListArray', 0, 0, 0, array(array($Test__t_BoolDequeList)), array(array($Test__t_BoolDequeList)), array($Test__t_BoolDequeList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolDequeListRange', 0, 0, 0, array(array($Test__t_BoolDequeList)), array(array($Test__t_BoolDequeList)), array($Test__t_BoolDequeList), null);
