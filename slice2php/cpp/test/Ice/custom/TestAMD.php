...
namespace Test
{
    ...
    global $Ice__t_Value;
    $Test__t_C = IcePHP_defineClass('::Test::C', '\\Test\\C', -1, $Ice__t_Value, null);
    ...
    global $Ice__t_Value;
    global $Test__t_IntStringDict;
    $Test__t_DictClass = IcePHP_defineClass('::Test::DictClass', '\\Test\\DictClass', -1, $Ice__t_Value, array(
    ...
    global $Test__t_ShortBuffer;
    global $Test__t_BufferStruct;
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opShortArray', 'opShortArray', 0, -1, array(array($Test__t_ShortSeq)), array(array($Test__t_ShortSeq)), array($Test__t_ShortSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDoubleArray', 'opDoubleArray', 0, -1, array(array($IcePHP__t_bool), array($Test__t_DoubleSeq)), array(array($Test__t_DoubleSeq)), array($Test__t_DoubleSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolArray', 'opBoolArray', 0, -1, array(array($Test__t_BoolSeq)), array(array($Test__t_BoolSeq)), array($Test__t_BoolSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opByteArray', 'opByteArray', 0, -1, array(array($Test__t_ByteList)), array(array($Test__t_ByteList)), array($Test__t_ByteList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opVariableArray', 'opVariableArray', 0, -1, array(array($Test__t_VariableList)), array(array($Test__t_VariableList)), array($Test__t_VariableList), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolList', 'opBoolList', 0, -1, array(array($Test__t_BoolList)), array(array($Test__t_BoolList)), array($Test__t_BoolList), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opByteList', 'opByteList', 0, -1, array(array($Test__t_ByteList)), array(array($Test__t_ByteList)), array($Test__t_ByteList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opMyByteSeq', 'opMyByteSeq', 0, -1, array(array($Test__t_ByteSeq)), array(array($Test__t_ByteSeq)), array($Test__t_ByteSeq), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opStringList', 'opStringList', 0, -1, array(array($Test__t_StringList)), array(array($Test__t_StringList)), array($Test__t_StringList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opFixedSeq', 'opFixedSeq', 0, -1, array(array($Test__t_FixedSeq)), array(array($Test__t_FixedSeq)), array($Test__t_FixedSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opFixedList', 'opFixedList', 0, -1, array(array($Test__t_FixedList)), array(array($Test__t_FixedList)), array($Test__t_FixedList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opVariableSeq', 'opVariableSeq', 0, -1, array(array($Test__t_VariableSeq)), array(array($Test__t_VariableSeq)), array($Test__t_VariableSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opVariableList', 'opVariableList', 0, -1, array(array($Test__t_VariableList)), array(array($Test__t_VariableList)), array($Test__t_VariableList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opStringStringDictSeq', 'opStringStringDictSeq', 0, -1, array(array($Test__t_StringStringDictSeq)), array(array($Test__t_StringStringDictSeq)), array($Test__t_StringStringDictSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opStringStringDictList', 'opStringStringDictList', 0, -1, array(array($Test__t_StringStringDictList)), array(array($Test__t_StringStringDictList)), array($Test__t_StringStringDictList), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opEList', 'opEList', 0, -1, array(array($Test__t_EList)), array(array($Test__t_EList)), array($Test__t_EList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDPrxSeq', 'opDPrxSeq', 0, -1, array(array($Test__t_DPrxSeq)), array(array($Test__t_DPrxSeq)), array($Test__t_DPrxSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDPrxList', 'opDPrxList', 0, -1, array(array($Test__t_DPrxList)), array(array($Test__t_DPrxList)), array($Test__t_DPrxList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opCSeq', 'opCSeq', 0, -1, array(array($Test__t_CSeq)), array(array($Test__t_CSeq)), array($Test__t_CSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opCList', 'opCList', 0, -1, array(array($Test__t_CList)), array(array($Test__t_CList)), array($Test__t_CList), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOutArrayByteSeq', 'opOutArrayByteSeq', 0, -1, array(array($Test__t_ByteSeq)), array(array($Test__t_ByteSeq)), null, null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opIntStringDict', 'opIntStringDict', 0, -1, array(array($Test__t_IntStringDict)), array(array($Test__t_IntStringDict)), array($Test__t_IntStringDict), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opVarDict', 'opVarDict', 0, -1, array(array($Test__t_StringIntDict)), array(array($Test__t_StringIntDict)), array($Test__t_LongLongDict), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opShortBuffer', 'opShortBuffer', 0, -1, array(array($Test__t_ShortBuffer)), array(array($Test__t_ShortBuffer)), array($Test__t_ShortBuffer), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBoolBuffer', 'opBoolBuffer', 0, -1, array(array($Test__t_BoolSeq)), array(array($Test__t_BoolSeq)), array($Test__t_BoolSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opBufferStruct', 'opBufferStruct', 0, -1, array(array($Test__t_BufferStruct)), null, array($Test__t_BufferStruct), null);
