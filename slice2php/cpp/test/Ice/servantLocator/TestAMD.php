...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'stdException', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'cppException', 0, -1, null, null, null, null);
