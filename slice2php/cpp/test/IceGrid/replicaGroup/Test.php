...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'getReplicaId', 'getReplicaId', 0, -1, null, null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'getReplicaIdAndShutdown', 'getReplicaIdAndShutdown', 0, -1, null, null, array($IcePHP__t_string), null);
}
?>
