...
namespace IceGrid
{
    ...
    $IceGrid__t_InternalDbEnvDescriptor = IcePHP_defineClass('::IceGrid::InternalDbEnvDescriptor', '\\IceGrid\\InternalDbEnvDescriptor', -1, $Ice__t_Value, array(
    ...
    $IceGrid__t_InternalAdapterDescriptor = IcePHP_defineClass('::IceGrid::InternalAdapterDescriptor', '\\IceGrid\\InternalAdapterDescriptor', -1, $Ice__t_Value, array(
    ...
    global $IceGrid__t_InternalDbEnvDescriptorSeq;
    global $IceGrid__t_PropertyDescriptorSeqDict;
    $IceGrid__t_InternalServerDescriptor = IcePHP_defineClass('::IceGrid::InternalServerDescriptor', '\\IceGrid\\InternalServerDescriptor', -1, $Ice__t_Value, array(
        array('id', $IcePHP__t_string, false, 0),
    ...
    global $Ice__t_ObjectPrx;
    IcePHP_defineOperation($IceGrid__t_AdapterPrx, 'activate', 'activate', 0, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceGrid__t_AdapterPrx, 'getDirectProxy', 'getDirectProxy', 2, -1, null, null, array($Ice__t_ObjectPrx), array($IceGrid__t_AdapterNotActiveException));
    IcePHP_defineOperation($IceGrid__t_AdapterPrx, 'setDirectProxy', 'setDirectProxy', 0, -1, array(array($Ice__t_ObjectPrx)), null, null, array($IceGrid__t_AdapterActiveException));
    ...
    global $Ice__t_StringSeq;
    global $IcePHP__t_bool;
    IcePHP_defineOperation($IceGrid__t_FileReaderPrx, 'getOffsetFromEnd', 'getOffsetFromEnd', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_int)), null, array($IcePHP__t_long), array($IceGrid__t_FileNotAvailableException));
    IcePHP_defineOperation($IceGrid__t_FileReaderPrx, 'read', 'read', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_long), array($IcePHP__t_int)), array(array($IcePHP__t_long), array($Ice__t_StringSeq)), array($IcePHP__t_bool), array($IceGrid__t_FileNotAvailableException));
    ...
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'start', 'start', 0, -1, null, null, null, array($IceGrid__t_ServerStartException));
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'stop', 'stop', 0, -1, null, null, null, array($IceGrid__t_ServerStopException));
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'checkUpdate', 'checkUpdate', 0, -1, array(array($IceGrid__t_InternalServerDescriptor), array($IcePHP__t_bool)), null, array($IcePHP__t_bool), array($IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'setEnabled', 'setEnabled', 0, -1, array(array($IcePHP__t_bool)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'isEnabled', 'isEnabled', 2, -1, null, null, array($IcePHP__t_bool), null);
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'sendSignal', 'sendSignal', 0, -1, array(array($IcePHP__t_string)), null, null, array($IceGrid__t_BadSignalException));
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'writeMessage', 'writeMessage', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_int)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'getState', 'getState', 2, -1, null, null, array($IceGrid__t_ServerState), null);
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'getPid', 'getPid', 2, -1, null, null, array($IcePHP__t_int), null);
    IcePHP_defineOperation($IceGrid__t_ServerPrx, 'setProcess', 'setProcess', 0, -1, array(array($Ice__t_ProcessPrx)), null, null, null);
    ...
    global $IceGrid__t_InternalRegistryPrxSeq;
    global $IceGrid__t_InternalRegistryPrx;
    IcePHP_defineOperation($IceGrid__t_ReplicaObserverPrx, 'replicaInit', 'replicaInit', 0, -1, array(array($IceGrid__t_InternalRegistryPrxSeq)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaObserverPrx, 'replicaAdded', 'replicaAdded', 0, -1, array(array($IceGrid__t_InternalRegistryPrx)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaObserverPrx, 'replicaRemoved', 'replicaRemoved', 0, -1, array(array($IceGrid__t_InternalRegistryPrx)), null, null, null);
    ...
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'loadServer', 'loadServer', 2, -1, array(array($IceGrid__t_InternalServerDescriptor), array($IcePHP__t_string)), array(array($IceGrid__t_AdapterPrxDict), array($IcePHP__t_int), array($IcePHP__t_int)), array($IceGrid__t_ServerPrx), array($IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'loadServerWithoutRestart', 'loadServerWithoutRestart', 2, -1, array(array($IceGrid__t_InternalServerDescriptor), array($IcePHP__t_string)), array(array($IceGrid__t_AdapterPrxDict), array($IcePHP__t_int), array($IcePHP__t_int)), array($IceGrid__t_ServerPrx), array($IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'destroyServer', 'destroyServer', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_int), array($IcePHP__t_string)), null, null, array($IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'destroyServerWithoutRestart', 'destroyServerWithoutRestart', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_int), array($IcePHP__t_string)), null, null, array($IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'registerWithReplica', 'registerWithReplica', 0, -1, array(array($IceGrid__t_InternalRegistryPrx)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'getName', 'getName', 2, -1, null, null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'getHostname', 'getHostname', 2, -1, null, null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'getLoad', 'getLoad', 2, -1, null, null, array($IceGrid__t_LoadInfo), null);
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'getProcessorSocketCount', 'getProcessorSocketCount', 2, -1, null, null, array($IcePHP__t_int), null);
    IcePHP_defineOperation($IceGrid__t_NodePrx, 'shutdown', 'shutdown', 2, -1, null, null, null, null);
    ...
    global $Ice__t_StringSeq;
    global $IcePHP__t_string;
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'keepAlive', 'keepAlive', 0, -1, array(array($IceGrid__t_LoadInfo)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'setReplicaObserver', 'setReplicaObserver', 0, -1, array(array($IceGrid__t_ReplicaObserverPrx)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'getTimeout', 'getTimeout', 2, -1, null, null, array($IcePHP__t_int), null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'getObserver', 'getObserver', 2, -1, null, null, array($IceGrid__t_NodeObserverPrx), null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'loadServers', 'loadServers', 2, -1, null, null, null, null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'getServers', 'getServers', 2, -1, null, null, array($Ice__t_StringSeq), null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'waitForApplicationUpdate', 'waitForApplicationUpdate', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_int)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_NodeSessionPrx, 'destroy', 'destroy', 0, -1, null, null, null, null);
    ...
    global $Ice__t_ObjectPrx;
    global $IceGrid__t_TopicName;
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'keepAlive', 'keepAlive', 0, -1, null, null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'getTimeout', 'getTimeout', 2, -1, null, null, array($IcePHP__t_int), null);
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'setDatabaseObserver', 'setDatabaseObserver', 2, -1, array(array($IceGrid__t_DatabaseObserverPrx), array($IceGrid__t_StringLongDict, 1)), null, null, array($IceGrid__t_ObserverAlreadyRegisteredException, $IceGrid__t_DeploymentException));
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'setEndpoints', 'setEndpoints', 2, -1, array(array($IceGrid__t_StringObjectProxyDict)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'registerWellKnownObjects', 'registerWellKnownObjects', 2, -1, array(array($IceGrid__t_ObjectInfoSeq)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'setAdapterDirectProxy', 'setAdapterDirectProxy', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($Ice__t_ObjectPrx)), null, null, array($IceGrid__t_AdapterNotExistException, $IceGrid__t_AdapterExistsException));
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'receivedUpdate', 'receivedUpdate', 0, -1, array(array($IceGrid__t_TopicName), array($IcePHP__t_int), array($IcePHP__t_string)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_ReplicaSessionPrx, 'destroy', 'destroy', 0, -1, null, null, null, null);
    ...
    global $IcePHP__t_string;
    global $IcePHP__t_int;
    $IceGrid__t_InternalNodeInfo = IcePHP_defineClass('::IceGrid::InternalNodeInfo', '\\IceGrid\\InternalNodeInfo', -1, $Ice__t_Value, array(
        array('name', $IcePHP__t_string, false, 0),
    ...
    global $Ice__t_Value;
    global $IcePHP__t_string;
    $IceGrid__t_InternalReplicaInfo = IcePHP_defineClass('::IceGrid::InternalReplicaInfo', '\\IceGrid\\InternalReplicaInfo', -1, $Ice__t_Value, array(
        array('name', $IcePHP__t_string, false, 0),
        array('hostname', $IcePHP__t_string, false, 0)));
    ...
    global $IceGrid__t_ObjectInfoSeq;
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'registerNode', 'registerNode', 0, -1, array(array($IceGrid__t_InternalNodeInfo), array($IceGrid__t_NodePrx), array($IceGrid__t_LoadInfo)), null, array($IceGrid__t_NodeSessionPrx), array($IceGrid__t_NodeActiveException, $IceGrid__t_PermissionDeniedException));
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'registerReplica', 'registerReplica', 0, -1, array(array($IceGrid__t_InternalReplicaInfo), array($IceGrid__t_InternalRegistryPrx)), null, array($IceGrid__t_ReplicaSessionPrx), array($IceGrid__t_ReplicaActiveException, $IceGrid__t_PermissionDeniedException));
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'registerWithReplica', 'registerWithReplica', 0, -1, array(array($IceGrid__t_InternalRegistryPrx)), null, null, null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'getNodes', 'getNodes', 2, -1, null, null, array($IceGrid__t_NodePrxSeq), null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'getReplicas', 'getReplicas', 2, -1, null, null, array($IceGrid__t_InternalRegistryPrxSeq), null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'getApplications', 'getApplications', 2, -1, null, array(array($IcePHP__t_long)), array($IceGrid__t_ApplicationInfoSeq), null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'getAdapters', 'getAdapters', 2, -1, null, array(array($IcePHP__t_long)), array($IceGrid__t_AdapterInfoSeq), null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'getObjects', 'getObjects', 2, -1, null, array(array($IcePHP__t_long)), array($IceGrid__t_ObjectInfoSeq), null);
    IcePHP_defineOperation($IceGrid__t_InternalRegistryPrx, 'shutdown', 'shutdown', 2, -1, null, null, null, null);
}
