...
namespace
{
    ...
    require_once 'DataStorm/SampleEvent.php';
}
...
namespace DataStormContract
{
    ...
    global $DataStormContract__t_ClearHistoryPolicy;
    $DataStormContract__t_ElementConfig = IcePHP_defineClass('::DataStormContract::ElementConfig', '\\DataStormContract\\ElementConfig', 1, $Ice__t_Value, array(
    ...
    global $DataStormContract__t_ElementSpecAckSeq;
    global $DataStormContract__t_DataSamplesSeq;
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'announceTopics', 'announceTopics', 0, -1, array(array($DataStormContract__t_TopicInfoSeq), array($IcePHP__t_bool)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'attachTopic', 'attachTopic', 0, -1, array(array($DataStormContract__t_TopicSpec)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'detachTopic', 'detachTopic', 0, -1, array(array($IcePHP__t_long)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'attachTags', 'attachTags', 0, -1, array(array($IcePHP__t_long), array($DataStormContract__t_ElementInfoSeq), array($IcePHP__t_bool)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'detachTags', 'detachTags', 0, -1, array(array($IcePHP__t_long), array($Ice__t_LongSeq)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'announceElements', 'announceElements', 0, -1, array(array($IcePHP__t_long), array($DataStormContract__t_ElementInfoSeq)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'attachElements', 'attachElements', 0, -1, array(array($IcePHP__t_long), array($DataStormContract__t_ElementSpecSeq), array($IcePHP__t_bool)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'attachElementsAck', 'attachElementsAck', 0, -1, array(array($IcePHP__t_long), array($DataStormContract__t_ElementSpecAckSeq)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'detachElements', 'detachElements', 0, -1, array(array($IcePHP__t_long), array($Ice__t_LongSeq)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'initSamples', 'initSamples', 0, -1, array(array($IcePHP__t_long), array($DataStormContract__t_DataSamplesSeq)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_SessionPrx, 'disconnected', 'disconnected', 0, -1, null, null, null, null);
    ...
    global $IcePHP__t_long;
    global $DataStormContract__t_DataSample;
    IcePHP_defineOperation($DataStormContract__t_SubscriberSessionPrx, 's', 's', 0, -1, array(array($IcePHP__t_long), array($IcePHP__t_long), array($DataStormContract__t_DataSample)), null, null, null);

    global $DataStormContract__t_SessionCreationError;
    class SessionCreationError
    {
        const AlreadyConnected = 0;
        const NodeShutdown = 1;
        const SessionNotFound = 2;
        const Internal = 3;
    }

    $DataStormContract__t_SessionCreationError = IcePHP_defineEnum('::DataStormContract::SessionCreationError', array('AlreadyConnected', 0, 'NodeShutdown', 1, 'SessionNotFound', 2, 'Internal', 3));

    global $DataStormContract__t_SessionCreationException;
    class SessionCreationException extends \Ice\UserException
    {
        public function ice_id()
        {
        ...
        {
            global $DataStormContract__t_SessionCreationException;
            return IcePHP_stringifyException($this, $DataStormContract__t_SessionCreationException);
        }
    ...
    $DataStormContract__t_SessionCreationException = IcePHP_defineException('::DataStormContract::SessionCreationException', '\\DataStormContract\\SessionCreationException', null, array(
        array('error', $DataStormContract__t_SessionCreationError, false, 0)));
    ...
    global $IcePHP__t_bool;
    global $DataStormContract__t_PublisherSessionPrx;
    IcePHP_defineOperation($DataStormContract__t_NodePrx, 'initiateCreateSession', 'initiateCreateSession', 0, -1, array(array($DataStormContract__t_NodePrx)), null, null, array($DataStormContract__t_SessionCreationException));
    IcePHP_defineOperation($DataStormContract__t_NodePrx, 'createSession', 'createSession', 0, -1, array(array($DataStormContract__t_NodePrx), array($DataStormContract__t_SubscriberSessionPrx), array($IcePHP__t_bool)), null, null, array($DataStormContract__t_SessionCreationException));
    IcePHP_defineOperation($DataStormContract__t_NodePrx, 'confirmCreateSession', 'confirmCreateSession', 0, -1, array(array($DataStormContract__t_NodePrx), array($DataStormContract__t_PublisherSessionPrx)), null, null, array($DataStormContract__t_SessionCreationException));
    ...
    IcePHP_defineOperation($DataStormContract__t_LookupPrx, 'announceTopicReader', 'announceTopicReader', 2, -1, array(array($IcePHP__t_string), array($DataStormContract__t_NodePrx)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_LookupPrx, 'announceTopicWriter', 'announceTopicWriter', 2, -1, array(array($IcePHP__t_string), array($DataStormContract__t_NodePrx)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_LookupPrx, 'announceTopics', 'announceTopics', 2, -1, array(array($Ice__t_StringSeq), array($Ice__t_StringSeq), array($DataStormContract__t_NodePrx)), null, null, null);
    IcePHP_defineOperation($DataStormContract__t_LookupPrx, 'createSession', 'createSession', 0, -1, array(array($DataStormContract__t_NodePrx)), null, array($DataStormContract__t_NodePrx), null);
}
