...
namespace IceStorm
{
    ...
    global $IceStorm__t_EventDataSeq;
    IcePHP_defineOperation($IceStorm__t_TopicLinkPrx, 'forward', 'forward', 0, -1, array(array($IceStorm__t_EventDataSeq)), null, null, null);
}
...
namespace IceStorm
{
    ...
    IcePHP_defineOperation($IceStorm__t_TopicInternalPrx, 'getLinkProxy', 'getLinkProxy', 2, -1, null, null, array($IceStorm__t_TopicLinkPrx), null);
    IcePHP_defineOperation($IceStorm__t_TopicInternalPrx, 'reap', 'reap', 0, -1, array(array($Ice__t_IdentitySeq)), null, null, array($IceStorm__t_ReapWouldBlock));
}
...
namespace IceStorm
{
    ...
    IcePHP_defineOperation($IceStorm__t_TopicManagerInternalPrx, 'getReplicaNode', 'getReplicaNode', 2, -1, null, null, array($IceStormElection__t_NodePrx), null);
}
?>
