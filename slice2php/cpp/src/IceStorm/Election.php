...
namespace IceStormElection
{
    ...
    IcePHP_defineOperation($IceStormElection__t_ReplicaObserverPrx, 'init', 'init', 0, -1, array(array($IceStormElection__t_LogUpdate), array($IceStormElection__t_TopicContentSeq)), null, null, array($IceStormElection__t_ObserverInconsistencyException));
    IcePHP_defineOperation($IceStormElection__t_ReplicaObserverPrx, 'createTopic', 'createTopic', 0, -1, array(array($IceStormElection__t_LogUpdate), array($IcePHP__t_string)), null, null, array($IceStormElection__t_ObserverInconsistencyException));
    IcePHP_defineOperation($IceStormElection__t_ReplicaObserverPrx, 'destroyTopic', 'destroyTopic', 0, -1, array(array($IceStormElection__t_LogUpdate), array($IcePHP__t_string)), null, null, array($IceStormElection__t_ObserverInconsistencyException));
    IcePHP_defineOperation($IceStormElection__t_ReplicaObserverPrx, 'addSubscriber', 'addSubscriber', 0, -1, array(array($IceStormElection__t_LogUpdate), array($IcePHP__t_string), array($IceStorm__t_SubscriberRecord)), null, null, array($IceStormElection__t_ObserverInconsistencyException));
    IcePHP_defineOperation($IceStormElection__t_ReplicaObserverPrx, 'removeSubscriber', 'removeSubscriber', 0, -1, array(array($IceStormElection__t_LogUpdate), array($IcePHP__t_string), array($Ice__t_IdentitySeq)), null, null, array($IceStormElection__t_ObserverInconsistencyException));
}
...
namespace IceStormElection
{
    ...
    global $IceStormElection__t_LogUpdate;
    global $IceStormElection__t_TopicContentSeq;
    IcePHP_defineOperation($IceStormElection__t_TopicManagerSyncPrx, 'getContent', 'getContent', 0, -1, null, array(array($IceStormElection__t_LogUpdate), array($IceStormElection__t_TopicContentSeq)), null, null);
}
...
namespace IceStormElection
{
    ...
    global $IceStormElection__t_NodeInfoSeq;
    global $IceStormElection__t_QueryInfo;
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'invitation', 'invitation', 0, -1, array(array($IcePHP__t_int), array($IcePHP__t_string)), null, null, null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'ready', 'ready', 0, -1, array(array($IcePHP__t_int), array($IcePHP__t_string), array($Ice__t_ObjectPrx), array($IcePHP__t_int), array($IcePHP__t_long)), null, null, null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'accept', 'accept', 0, -1, array(array($IcePHP__t_int), array($IcePHP__t_string), array($Ice__t_IntSeq), array($Ice__t_ObjectPrx), array($IceStormElection__t_LogUpdate), array($IcePHP__t_int)), null, null, null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'areYouCoordinator', 'areYouCoordinator', 2, -1, null, null, array($IcePHP__t_bool), null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'areYouThere', 'areYouThere', 2, -1, array(array($IcePHP__t_string), array($IcePHP__t_int)), null, array($IcePHP__t_bool), null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'sync', 'sync', 2, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'nodes', 'nodes', 2, -1, null, null, array($IceStormElection__t_NodeInfoSeq), null);
    IcePHP_defineOperation($IceStormElection__t_NodePrx, 'query', 'query', 2, -1, null, null, array($IceStormElection__t_QueryInfo), null);
}
?>
