...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_EchoPrx, 'supportsCompress', 'supportsCompress', 0, -1, null, null, array($IcePHP__t_bool), null);
}
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyObjectPrx, 'getName', 'getName', 0, -1, null, null, array($IcePHP__t_string), null);
