...
namespace Test
{
    ...
    class Struct1
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=254, $s=16000, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010?", $c1=\Test\Color::red, $c2=\Test\Color::green, $c3=\Test\Color::blue, $nc1=\Test\Nested\Color::red, $nc2=\Test\Nested\Color::green, $nc3=\Test\Nested\Color::blue, $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0)
        {
...
namespace Test
{
    ...
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=1, $s=2, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010?", $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0)
        {
            $this->boolFalse = $boolFalse;
            $this->boolTrue = $boolTrue;
            $this->b = $b;
...
namespace Test
{
    ...
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=1, $s=2, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010?", $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0, $c1=\Test\Color::red, $c2=\Test\Color::green, $c3=\Test\Color::blue, $nc1=\Test\Nested\Color::red, $nc2=\Test\Nested\Color::green, $nc3=\Test\Nested\Color::blue)
        {
...
namespace Test
{
    ...
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=1, $s=2, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010?", $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0, $c1=\Test\ConstColor1, $c2=\Test\ConstColor2, $c3=\Test\ConstColor3, $nc1=\Test\ConstNestedColor1, $nc2=\Test\ConstNestedColor2, $nc3=\Test\ConstNestedColor3)
        {
            parent::__construct($boolFalse, $boolTrue, $b, $s, $i, $l, $f, $d, $str, $noDefault, $zeroI, $zeroL, $zeroF, $zeroDotF, $zeroD, $zeroDotD);
            $this->c1 = $c1;
            $this->c2 = $c2;
