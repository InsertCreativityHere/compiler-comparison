...
namespace Clash
{
    ...
    IcePHP_defineOperation($Clash__t_IntfPrx, 'obj', 0, 0, 0, null, null, null, null);
    IcePHP_defineOperation($Clash__t_IntfPrx, 'op', 0, 0, 0, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string, 1), array($IcePHP__t_int, 2)), null, null, null);
    IcePHP_defineOperation($Clash__t_IntfPrx, 'opOut', 0, 0, 0, null, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string, 1), array($IcePHP__t_int, 2)), null, null);
}
