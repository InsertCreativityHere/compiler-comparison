...
namespace _abstract
{
    ...
    global $IcePHP__t_int;
    IcePHP_defineOperation($abstract__t_catchPrx, 'checkedCast', 0, -1, array(array($IcePHP__t_int)), array(array($IcePHP__t_int)), null, null);
}
