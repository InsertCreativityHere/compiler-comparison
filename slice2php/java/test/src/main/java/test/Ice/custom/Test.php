...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opIntSeq', 0, 0, array(array($Test__t_IntSeq)), array(array($Test__t_IntSeq)), array($Test__t_IntSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opLongSeq', 0, 0, array(array($Test__t_LongSeq)), array(array($Test__t_LongSeq)), array($Test__t_LongSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opFloatSeq', 0, 0, array(array($Test__t_FloatSeq)), array(array($Test__t_FloatSeq)), array($Test__t_FloatSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDoubleSeq', 0, 0, array(array($Test__t_DoubleSeq)), array(array($Test__t_DoubleSeq)), array($Test__t_DoubleSeq), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opSSeq', 0, 0, array(array($Test__t_SSeq)), array(array($Test__t_SSeq)), array($Test__t_SSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDSeq', 0, 0, array(array($Test__t_DSeq)), array(array($Test__t_DSeq)), array($Test__t_DSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opStringSeqSeq', 0, 0, array(array($Test__t_StringSeqSeq)), array(array($Test__t_StringSeqSeq)), array($Test__t_StringSeqSeq), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opByteBufferSeq', 0, 0, array(array($Test__t_ByteBuffer)), array(array($Test__t_ByteBuffer)), array($Test__t_ByteBuffer), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opShortBufferSeq', 0, 0, array(array($Test__t_ShortBuffer)), array(array($Test__t_ShortBuffer)), array($Test__t_ShortBuffer), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opIntBufferSeq', 0, 0, array(array($Test__t_IntBuffer)), array(array($Test__t_IntBuffer)), array($Test__t_IntBuffer), null);
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptIntSeq', 0, 0, array(array($Test__t_IntSeq, 2)), array(array($Test__t_IntSeq, 3)), array($Test__t_IntSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptLongSeq', 0, 0, array(array($Test__t_LongSeq, 2)), array(array($Test__t_LongSeq, 3)), array($Test__t_LongSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptFloatSeq', 0, 0, array(array($Test__t_FloatSeq, 2)), array(array($Test__t_FloatSeq, 3)), array($Test__t_FloatSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptDoubleSeq', 0, 0, array(array($Test__t_DoubleSeq, 2)), array(array($Test__t_DoubleSeq, 3)), array($Test__t_DoubleSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptStringSeq', 0, 0, array(array($Test__t_StringSeq, 2)), array(array($Test__t_StringSeq, 3)), array($Test__t_StringSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptESeq', 0, 0, array(array($Test__t_ESeq, 2)), array(array($Test__t_ESeq, 3)), array($Test__t_ESeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptSSeq', 0, 0, array(array($Test__t_SSeq, 2)), array(array($Test__t_SSeq, 3)), array($Test__t_SSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptDSeq', 0, 0, array(array($Test__t_DSeq, 2)), array(array($Test__t_DSeq, 3)), array($Test__t_DSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptStringSeqSeq', 0, 0, array(array($Test__t_StringSeqSeq, 2)), array(array($Test__t_StringSeqSeq, 3)), array($Test__t_StringSeqSeq, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptByteBufferSeq', 0, 0, array(array($Test__t_ByteBuffer, 2)), array(array($Test__t_ByteBuffer, 3)), array($Test__t_ByteBuffer, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptShortBufferSeq', 0, 0, array(array($Test__t_ShortBuffer, 2)), array(array($Test__t_ShortBuffer, 3)), array($Test__t_ShortBuffer, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptIntBufferSeq', 0, 0, array(array($Test__t_IntBuffer, 2)), array(array($Test__t_IntBuffer, 3)), array($Test__t_IntBuffer, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptLongBufferSeq', 0, 0, array(array($Test__t_LongBuffer, 2)), array(array($Test__t_LongBuffer, 3)), array($Test__t_LongBuffer, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptFloatBufferSeq', 0, 0, array(array($Test__t_FloatBuffer, 2)), array(array($Test__t_FloatBuffer, 3)), array($Test__t_FloatBuffer, 1), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opOptDoubleBufferSeq', 0, 0, array(array($Test__t_DoubleBuffer, 2)), array(array($Test__t_DoubleBuffer, 3)), array($Test__t_DoubleBuffer, 1), null);
