...
namespace Test
{
    ...
    $Test__t_ConcreteClass = IcePHP_defineClass('::Test::ConcreteClass', '\\Test\\ConcreteClass', -1, $Ice__t_Value, array(
    ...
    global $Test__t_ConcreteClass;
    IcePHP_defineOperation($Test__t_InitialPrx, 'getConcreteClass', 'getConcreteClass', 0, -1, null, null, array($Test__t_ConcreteClass), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'throwException', 'throwException', 0, -1, null, null, null, array($Test__t_E));
