...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'transient', 0, 0, null, null, null, null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'deactivate', 0, 0, null, null, null, null);
}
?>
