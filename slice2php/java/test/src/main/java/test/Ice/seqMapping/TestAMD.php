...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opSerialSmallJava', 'opSerialSmallJava', 0, -1, array(array($Test__t_SerialSmall)), array(array($Test__t_SerialSmall)), array($Test__t_SerialSmall), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opSerialLargeJava', 'opSerialLargeJava', 0, -1, array(array($Test__t_SerialLarge)), array(array($Test__t_SerialLarge)), array($Test__t_SerialLarge), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opSerialStructJava', 'opSerialStructJava', 0, -1, array(array($Test__t_SerialStruct)), array(array($Test__t_SerialStruct)), array($Test__t_SerialStruct), null);
}
...
namespace Test
{
    ...
    global $Test__t_SerialLarge;
    global $Test__t_SLS;
    $Test__t_Baz = IcePHP_defineClass('::Test::Baz', '\\Test\\Baz', -1, $Ice__t_Value, array(
        array('SLmem', $Test__t_SerialLarge, false, 0),
        array('SLSmem', $Test__t_SLS, false, 0)));
}
?>
