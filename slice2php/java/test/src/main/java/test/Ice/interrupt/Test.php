...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opIdempotent', 'opIdempotent', 2, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'sleep', 'sleep', 0, -1, array(array($IcePHP__t_int)), null, null, array($Test__t_InterruptedException));
    ...
    IcePHP_defineOperation($Test__t_TestIntfControllerPrx, 'interrupt', 'interrupt', 0, -1, null, null, null, array($Test__t_CannotInterruptException));
}
