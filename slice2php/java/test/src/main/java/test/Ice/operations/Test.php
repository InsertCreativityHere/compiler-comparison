...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'supportsCompress', 0, 0, 0, null, null, array($IcePHP__t_bool), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opVoid', 0, 0, 0, null, null, null, null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByte', 0, 0, 0, array(array($IcePHP__t_byte), array($IcePHP__t_byte)), array(array($IcePHP__t_byte)), array($IcePHP__t_byte), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opBool', 0, 0, 0, array(array($IcePHP__t_bool), array($IcePHP__t_bool)), array(array($IcePHP__t_bool)), array($IcePHP__t_bool), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortIntLong', 0, 0, 0, array(array($IcePHP__t_short), array($IcePHP__t_int), array($IcePHP__t_long)), array(array($IcePHP__t_short), array($IcePHP__t_int), array($IcePHP__t_long)), array($IcePHP__t_long), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opFloatDouble', 0, 0, 0, array(array($IcePHP__t_float), array($IcePHP__t_double)), array(array($IcePHP__t_float), array($IcePHP__t_double)), array($IcePHP__t_double), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opString', 0, 0, 0, array(array($IcePHP__t_string), array($IcePHP__t_string)), array(array($IcePHP__t_string)), array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyEnum', 0, 0, 0, array(array($Test__t_MyEnum)), array(array($Test__t_MyEnum)), array($Test__t_MyEnum), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyClass', 0, 0, 0, array(array($Test__t_MyClassPrx)), array(array($Test__t_MyClassPrx), array($Test__t_MyClassPrx)), array($Test__t_MyClassPrx), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStruct', 0, 0, 0, array(array($Test__t_Structure), array($Test__t_Structure)), array(array($Test__t_Structure)), array($Test__t_Structure), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteS', 0, 0, 0, array(array($Test__t_ByteS), array($Test__t_ByteS)), array(array($Test__t_ByteS)), array($Test__t_ByteS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opBoolS', 0, 0, 0, array(array($Test__t_BoolS), array($Test__t_BoolS)), array(array($Test__t_BoolS)), array($Test__t_BoolS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortIntLongS', 0, 0, 0, array(array($Test__t_ShortS), array($Test__t_IntS), array($Test__t_LongS)), array(array($Test__t_ShortS), array($Test__t_IntS), array($Test__t_LongS)), array($Test__t_LongS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opFloatDoubleS', 0, 0, 0, array(array($Test__t_FloatS), array($Test__t_DoubleS)), array(array($Test__t_FloatS), array($Test__t_DoubleS)), array($Test__t_DoubleS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringS', 0, 0, 0, array(array($Test__t_StringS), array($Test__t_StringS)), array(array($Test__t_StringS)), array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteSS', 0, 0, 0, array(array($Test__t_ByteSS), array($Test__t_ByteSS)), array(array($Test__t_ByteSS)), array($Test__t_ByteSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opBoolSS', 0, 0, 0, array(array($Test__t_BoolSS), array($Test__t_BoolSS)), array(array($Test__t_BoolSS)), array($Test__t_BoolSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortIntLongSS', 0, 0, 0, array(array($Test__t_ShortSS), array($Test__t_IntSS), array($Test__t_LongSS)), array(array($Test__t_ShortSS), array($Test__t_IntSS), array($Test__t_LongSS)), array($Test__t_LongSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opFloatDoubleSS', 0, 0, 0, array(array($Test__t_FloatSS), array($Test__t_DoubleSS)), array(array($Test__t_FloatSS), array($Test__t_DoubleSS)), array($Test__t_DoubleSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringSS', 0, 0, 0, array(array($Test__t_StringSS), array($Test__t_StringSS)), array(array($Test__t_StringSS)), array($Test__t_StringSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringSSS', 0, 0, 0, array(array($Test__t_StringSSS), array($Test__t_StringSSS)), array(array($Test__t_StringSSS)), array($Test__t_StringSSS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteBoolD', 0, 0, 0, array(array($Test__t_ByteBoolD), array($Test__t_ByteBoolD)), array(array($Test__t_ByteBoolD)), array($Test__t_ByteBoolD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortIntD', 0, 0, 0, array(array($Test__t_ShortIntD), array($Test__t_ShortIntD)), array(array($Test__t_ShortIntD)), array($Test__t_ShortIntD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opLongFloatD', 0, 0, 0, array(array($Test__t_LongFloatD), array($Test__t_LongFloatD)), array(array($Test__t_LongFloatD)), array($Test__t_LongFloatD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringStringD', 0, 0, 0, array(array($Test__t_StringStringD), array($Test__t_StringStringD)), array(array($Test__t_StringStringD)), array($Test__t_StringStringD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringMyEnumD', 0, 0, 0, array(array($Test__t_StringMyEnumD), array($Test__t_StringMyEnumD)), array(array($Test__t_StringMyEnumD)), array($Test__t_StringMyEnumD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyEnumStringD', 0, 0, 0, array(array($Test__t_MyEnumStringD), array($Test__t_MyEnumStringD)), array(array($Test__t_MyEnumStringD)), array($Test__t_MyEnumStringD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyStructMyEnumD', 0, 0, 0, array(array($Test__t_MyStructMyEnumD), array($Test__t_MyStructMyEnumD)), array(array($Test__t_MyStructMyEnumD)), array($Test__t_MyStructMyEnumD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteBoolDS', 0, 0, 0, array(array($Test__t_ByteBoolDS), array($Test__t_ByteBoolDS)), array(array($Test__t_ByteBoolDS)), array($Test__t_ByteBoolDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortIntDS', 0, 0, 0, array(array($Test__t_ShortIntDS), array($Test__t_ShortIntDS)), array(array($Test__t_ShortIntDS)), array($Test__t_ShortIntDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opLongFloatDS', 0, 0, 0, array(array($Test__t_LongFloatDS), array($Test__t_LongFloatDS)), array(array($Test__t_LongFloatDS)), array($Test__t_LongFloatDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringStringDS', 0, 0, 0, array(array($Test__t_StringStringDS), array($Test__t_StringStringDS)), array(array($Test__t_StringStringDS)), array($Test__t_StringStringDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringMyEnumDS', 0, 0, 0, array(array($Test__t_StringMyEnumDS), array($Test__t_StringMyEnumDS)), array(array($Test__t_StringMyEnumDS)), array($Test__t_StringMyEnumDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyEnumStringDS', 0, 0, 0, array(array($Test__t_MyEnumStringDS), array($Test__t_MyEnumStringDS)), array(array($Test__t_MyEnumStringDS)), array($Test__t_MyEnumStringDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMyStructMyEnumDS', 0, 0, 0, array(array($Test__t_MyStructMyEnumDS), array($Test__t_MyStructMyEnumDS)), array(array($Test__t_MyStructMyEnumDS)), array($Test__t_MyStructMyEnumDS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteByteSD', 0, 0, 0, array(array($Test__t_ByteByteSD), array($Test__t_ByteByteSD)), array(array($Test__t_ByteByteSD)), array($Test__t_ByteByteSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opBoolBoolSD', 0, 0, 0, array(array($Test__t_BoolBoolSD), array($Test__t_BoolBoolSD)), array(array($Test__t_BoolBoolSD)), array($Test__t_BoolBoolSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opShortShortSD', 0, 0, 0, array(array($Test__t_ShortShortSD), array($Test__t_ShortShortSD)), array(array($Test__t_ShortShortSD)), array($Test__t_ShortShortSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opIntIntSD', 0, 0, 0, array(array($Test__t_IntIntSD), array($Test__t_IntIntSD)), array(array($Test__t_IntIntSD)), array($Test__t_IntIntSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opLongLongSD', 0, 0, 0, array(array($Test__t_LongLongSD), array($Test__t_LongLongSD)), array(array($Test__t_LongLongSD)), array($Test__t_LongLongSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringFloatSD', 0, 0, 0, array(array($Test__t_StringFloatSD), array($Test__t_StringFloatSD)), array(array($Test__t_StringFloatSD)), array($Test__t_StringFloatSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringDoubleSD', 0, 0, 0, array(array($Test__t_StringDoubleSD), array($Test__t_StringDoubleSD)), array(array($Test__t_StringDoubleSD)), array($Test__t_StringDoubleSD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringStringSD', 0, 0, 0, array(array($Test__t_StringStringSD), array($Test__t_StringStringSD)), array(array($Test__t_StringStringSD)), array($Test__t_StringStringSD), null);
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteSOneway', 0, 0, 0, array(array($Test__t_ByteS)), null, null, null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteSOnewayCallCount', 0, 0, 0, null, null, array($IcePHP__t_int), null);
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opLong1', 0, 0, 0, array(array($IcePHP__t_long)), null, array($IcePHP__t_long), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opFloat1', 0, 0, 0, array(array($IcePHP__t_float)), null, array($IcePHP__t_float), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opDouble1', 0, 0, 0, array(array($IcePHP__t_double)), null, array($IcePHP__t_double), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opString1', 0, 0, 0, array(array($IcePHP__t_string)), null, array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringS1', 0, 0, 0, array(array($Test__t_StringS)), null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteBoolD1', 0, 0, 0, array(array($Test__t_ByteBoolD)), null, array($Test__t_ByteBoolD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringS2', 0, 0, 0, array(array($Test__t_StringS)), null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opByteBoolD2', 0, 0, 0, array(array($Test__t_ByteBoolD)), null, array($Test__t_ByteBoolD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opStringLiterals', 0, 0, 0, null, null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opWStringLiterals', 0, 0, 0, null, null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMStruct1', 0, 0, 0, null, null, array($Test__t_Structure), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMStruct2', 0, 0, 0, array(array($Test__t_Structure)), array(array($Test__t_Structure)), array($Test__t_Structure), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMSeq1', 0, 0, 0, null, null, array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMSeq2', 0, 0, 0, array(array($Test__t_StringS)), array(array($Test__t_StringS)), array($Test__t_StringS), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMDict1', 0, 0, 0, null, null, array($Test__t_StringStringD), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opMDict2', 0, 0, 0, array(array($Test__t_StringStringD)), array(array($Test__t_StringStringD)), array($Test__t_StringStringD), null);
}
...
namespace Test
{
    ...
    global $Test__t_MyClass1;
    global $Test__t_MyStruct1;
    IcePHP_defineOperation($Test__t_MyDerivedClassPrx, 'opDerived', 0, 0, 0, null, null, null, null);
    IcePHP_defineOperation($Test__t_MyDerivedClassPrx, 'opMyClass1', 0, 0, 0, array(array($Test__t_MyClass1)), null, array($Test__t_MyClass1), null);
    IcePHP_defineOperation($Test__t_MyDerivedClassPrx, 'opMyStruct1', 0, 0, 0, array(array($Test__t_MyStruct1)), null, array($Test__t_MyStruct1), null);
}
