...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opOneway', 'opOneway', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opString', 'opString', 0, -1, array(array($IcePHP__t_string)), array(array($IcePHP__t_string)), array($IcePHP__t_string), null);
    IcePHP_defineOperation($Test__t_MyClassPrx, 'opException', 'opException', 0, -1, null, null, null, array($Test__t_MyException));
