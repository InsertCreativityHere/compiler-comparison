...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyClassPrx, 'getContext', 'getContext', 0, -1, null, null, array($Ice__t_Context), null);
}
...
namespace Test
{
    ...
    global $Ice__t_ObjectPrx;
    IcePHP_defineOperation($Test__t_MyDerivedClassPrx, 'echo', 'echo', 0, -1, array(array($Ice__t_ObjectPrx)), null, array($Ice__t_ObjectPrx), null);
}
