...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opInt', 0, -1, array(array($IcePHP__t_int)), null, array($IcePHP__t_int), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opLong', 0, -1, array(array($IcePHP__t_long)), null, array($IcePHP__t_long), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opFloat', 0, -1, array(array($IcePHP__t_float)), null, array($IcePHP__t_float), null);
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'opDouble', 0, -1, array(array($IcePHP__t_double)), null, array($IcePHP__t_double), null);
...
namespace Test\Outer\Inner
{
    ...
    global $IcePHP__t_int;
    IcePHP_defineOperation($Test_Outer_Inner__t_TestIntfPrx, 'op', 0, -1, array(array($IcePHP__t_int)), array(array($IcePHP__t_int)), array($IcePHP__t_int), null);
}
?>
