...
namespace Test
{
    ...
    global $Test__t_ByteS;
    IcePHP_defineOperation($Test__t_InitialPrx, 'getStruct1', 0, -1, null, null, array($Test__t_ByteS), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getBase', 0, -1, null, null, array($Test__t_ByteS), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'getEx', 0, -1, null, null, array($Test__t_ByteS), null);
