...
namespace Test\Common
{
    ...
    global $IcePHP__t_bool;
    global $Test_Common__t_StringSeq;
    $Test_Common__t_Config = IcePHP_defineClass('::Test::Common::Config', '\\Test\\Common\\Config', -1, $Ice__t_Value, array(
    ...
    global $Test_Common__t_StringSeq;
    global $Test_Common__t_BoolSeq;
    $Test_Common__t_OptionOverrides = IcePHP_defineClass('::Test::Common::OptionOverrides', '\\Test\\Common\\OptionOverrides', -1, $Ice__t_Value, array(
    ...
    global $IcePHP__t_string;
    global $IcePHP__t_bool;
    IcePHP_defineOperation($Test_Common__t_TestCasePrx, 'startServerSide', 'startServerSide', 0, -1, array(array($Test_Common__t_Config)), null, array($IcePHP__t_string), array($Test_Common__t_TestCaseFailedException));
    IcePHP_defineOperation($Test_Common__t_TestCasePrx, 'stopServerSide', 'stopServerSide', 0, -1, array(array($IcePHP__t_bool)), null, array($IcePHP__t_string), array($Test_Common__t_TestCaseFailedException));
    IcePHP_defineOperation($Test_Common__t_TestCasePrx, 'runClientSide', 'runClientSide', 0, -1, array(array($IcePHP__t_string), array($Test_Common__t_Config)), null, array($IcePHP__t_string), array($Test_Common__t_TestCaseFailedException));
    IcePHP_defineOperation($Test_Common__t_TestCasePrx, 'destroy', 'destroy', 0, -1, null, null, null, null);
    ...
    global $Test_Common__t_StringSeq;
    global $IcePHP__t_bool;
    IcePHP_defineOperation($Test_Common__t_ControllerPrx, 'runTestCase', 'runTestCase', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string), array($IcePHP__t_string)), null, array($Test_Common__t_TestCasePrx), array($Test_Common__t_TestCaseNotExistException));
    IcePHP_defineOperation($Test_Common__t_ControllerPrx, 'getOptionOverrides', 'getOptionOverrides', 0, -1, null, null, array($Test_Common__t_OptionOverrides), null);
    IcePHP_defineOperation($Test_Common__t_ControllerPrx, 'getTestSuites', 'getTestSuites', 0, -1, array(array($IcePHP__t_string)), null, array($Test_Common__t_StringSeq), null);
    IcePHP_defineOperation($Test_Common__t_ControllerPrx, 'getHost', 'getHost', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_bool)), null, array($IcePHP__t_string), null);
    ...
    global $IcePHP__t_string;
    IcePHP_defineOperation($Test_Common__t_ProcessPrx, 'waitReady', 'waitReady', 0, -1, array(array($IcePHP__t_int)), null, null, array($Test_Common__t_ProcessFailedException));
    IcePHP_defineOperation($Test_Common__t_ProcessPrx, 'waitSuccess', 'waitSuccess', 0, -1, array(array($IcePHP__t_int)), null, array($IcePHP__t_int), array($Test_Common__t_ProcessFailedException));
    IcePHP_defineOperation($Test_Common__t_ProcessPrx, 'terminate', 'terminate', 0, -1, null, null, array($IcePHP__t_string), null);
    ...
    global $Test_Common__t_ProcessPrx;
    global $IcePHP__t_bool;
    IcePHP_defineOperation($Test_Common__t_ProcessControllerPrx, 'start', 'start', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_string), array($Test_Common__t_StringSeq)), null, array($Test_Common__t_ProcessPrx), array($Test_Common__t_ProcessFailedException));
    IcePHP_defineOperation($Test_Common__t_ProcessControllerPrx, 'getHost', 'getHost', 0, -1, array(array($IcePHP__t_string), array($IcePHP__t_bool)), null, array($IcePHP__t_string), null);
    ...
    global $IcePHP__t_string;
    IcePHP_defineOperation($Test_Common__t_BrowserProcessControllerPrx, 'redirect', 'redirect', 0, -1, array(array($IcePHP__t_string)), null, null, null);
    ...
    global $Test_Common__t_ProcessControllerPrx;
    IcePHP_defineOperation($Test_Common__t_ProcessControllerRegistryPrx, 'setProcessController', 'setProcessController', 0, -1, array(array($Test_Common__t_ProcessControllerPrx)), null, null, null);
}
