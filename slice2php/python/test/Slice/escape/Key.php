...
namespace and
{
    ...
    $and__t_continue = IcePHP_defineStruct('::and::continue', '\\and\\continue', array(
...
namespace and
{
    ...
    global $IcePHP__t_int;
    IcePHP_defineOperation($and__t_delPrx, 'elif', 'elif', 0, -1, array(array($IcePHP__t_int)), array(array($IcePHP__t_int)), null, null);
}
...
namespace and
{
    ...
    IcePHP_defineOperation($and__t_execPrx, 'finally', 'finally', 0, -1, null, null, null, null);
}
...
namespace and
{
    ...
    global $IcePHP__t_int;
    global $and__t_execPrx;
    $and__t_for = IcePHP_defineClass('::and::for', '\\and\\for', -1, $Ice__t_Value, array(
...
namespace and
{
    ...
    $and__t_is = IcePHP_defineException('::and::is', '\\and\\is', null, array(
...
namespace and
{
    ...
    $and__t_not = IcePHP_defineException('::and::not', '\\and\\not', $and__t_is, array(
...
namespace and
{
    ...
    global $IcePHP__t_int;
    global $and__t_assert;
    IcePHP_defineOperation($and__t_ifPrx, 'raise', 'raise', 0, -1, array(array($and__t_continue), array($and__t_for), array($and__t_delPrx), array($and__t_execPrx), array($and__t_ifPrx), array($IcePHP__t_int)), null, array($and__t_assert), array($and__t_is));
}
