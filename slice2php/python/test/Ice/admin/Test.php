...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_RemoteCommunicatorPrx, 'getAdmin', 'getAdmin', 0, -1, null, null, array($Ice__t_ObjectPrx), null);
    IcePHP_defineOperation($Test__t_RemoteCommunicatorPrx, 'getChanges', 'getChanges', 0, -1, null, null, array($Ice__t_PropertyDict), null);
    IcePHP_defineOperation($Test__t_RemoteCommunicatorPrx, 'shutdown', 'shutdown', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_RemoteCommunicatorPrx, 'waitForShutdown', 'waitForShutdown', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_RemoteCommunicatorPrx, 'destroy', 'destroy', 0, -1, null, null, null, null);
}
...
namespace Test
{
    ...
    global $Ice__t_PropertyDict;
    global $Test__t_RemoteCommunicatorPrx;
    IcePHP_defineOperation($Test__t_RemoteCommunicatorFactoryPrx, 'createCommunicator', 'createCommunicator', 0, -1, array(array($Ice__t_PropertyDict)), null, array($Test__t_RemoteCommunicatorPrx), null);
    IcePHP_defineOperation($Test__t_RemoteCommunicatorFactoryPrx, 'shutdown', 'shutdown', 0, -1, null, null, null, null);
}
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestFacetPrx, 'op', 'op', 0, -1, null, null, null, null);
}
?>
