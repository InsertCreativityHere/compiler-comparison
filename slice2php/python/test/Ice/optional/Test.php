...
namespace Test
{
    ...
    $Test__t_OneOptional = IcePHP_defineClass('::Test::OneOptional', '\\Test\\OneOptional', -1, $Ice__t_Value, array(
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_MyInterfacePrx, 'op', 'op', 0, -1, null, null, null, null);
}
...
namespace Test
{
    ...
    global $Test__t_BoolSeq;
    global $Test__t_Serializable;
    $Test__t_MultiOptional = IcePHP_defineClass('::Test::MultiOptional', '\\Test\\MultiOptional', -1, $Ice__t_Value, array(
...
namespace Test
{
    ...
    global $Test__t_B;
    global $IcePHP__t_string;
    $Test__t_C = IcePHP_defineClass('::Test::C', '\\Test\\C', -1, $Test__t_B, array(
...
namespace Test
{
    ...
    global $IcePHP__t_int;
    global $IcePHP__t_string;
    $Test__t_WD = IcePHP_defineClass('::Test::WD', '\\Test\\WD', -1, $Ice__t_Value, array(
        array('a', $IcePHP__t_int, true, 1),
...
namespace Test
{
    ...
    global $Test__t_E;
    global $Test__t_FixedStruct;
    $Test__t_F = IcePHP_defineClass('::Test::F', '\\Test\\F', -1, $Test__t_E, array(
...
namespace Test
{
    ...
    global $Test__t_G1;
    global $Test__t_G2;
    $Test__t_G = IcePHP_defineClass('::Test::G', '\\Test\\G', -1, $Ice__t_Value, array(
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_InitialPrx, 'pingPong', 'pingPong', 0, -1, array(array($Ice__t_Value)), null, array($Ice__t_Value), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opOptionalException', 'opOptionalException', 0, -1, array(array($IcePHP__t_int, 1), array($IcePHP__t_string, 2)), null, null, array($Test__t_OptionalException));
    IcePHP_defineOperation($Test__t_InitialPrx, 'opDerivedException', 'opDerivedException', 0, -1, array(array($IcePHP__t_int, 1), array($IcePHP__t_string, 2)), null, null, array($Test__t_OptionalException));
    IcePHP_defineOperation($Test__t_InitialPrx, 'opRequiredException', 'opRequiredException', 0, -1, array(array($IcePHP__t_int, 1), array($IcePHP__t_string, 2)), null, null, array($Test__t_OptionalException));
    IcePHP_defineOperation($Test__t_InitialPrx, 'opByte', 'opByte', 0, -1, array(array($IcePHP__t_byte, 2)), array(array($IcePHP__t_byte, 3)), array($IcePHP__t_byte, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opBool', 'opBool', 0, -1, array(array($IcePHP__t_bool, 2)), array(array($IcePHP__t_bool, 3)), array($IcePHP__t_bool, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opShort', 'opShort', 0, -1, array(array($IcePHP__t_short, 2)), array(array($IcePHP__t_short, 3)), array($IcePHP__t_short, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opInt', 'opInt', 0, -1, array(array($IcePHP__t_int, 2)), array(array($IcePHP__t_int, 3)), array($IcePHP__t_int, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opLong', 'opLong', 0, -1, array(array($IcePHP__t_long, 1)), array(array($IcePHP__t_long, 2)), array($IcePHP__t_long, 3), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opFloat', 'opFloat', 0, -1, array(array($IcePHP__t_float, 2)), array(array($IcePHP__t_float, 3)), array($IcePHP__t_float, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opDouble', 'opDouble', 0, -1, array(array($IcePHP__t_double, 2)), array(array($IcePHP__t_double, 3)), array($IcePHP__t_double, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opString', 'opString', 0, -1, array(array($IcePHP__t_string, 2)), array(array($IcePHP__t_string, 3)), array($IcePHP__t_string, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMyEnum', 'opMyEnum', 0, -1, array(array($Test__t_MyEnum, 2)), array(array($Test__t_MyEnum, 3)), array($Test__t_MyEnum, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opSmallStruct', 'opSmallStruct', 0, -1, array(array($Test__t_SmallStruct, 2)), array(array($Test__t_SmallStruct, 3)), array($Test__t_SmallStruct, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opFixedStruct', 'opFixedStruct', 0, -1, array(array($Test__t_FixedStruct, 2)), array(array($Test__t_FixedStruct, 3)), array($Test__t_FixedStruct, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opVarStruct', 'opVarStruct', 0, -1, array(array($Test__t_VarStruct, 2)), array(array($Test__t_VarStruct, 3)), array($Test__t_VarStruct, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMyInterfaceProxy', 'opMyInterfaceProxy', 0, -1, array(array($Test__t_MyInterfacePrx, 2)), array(array($Test__t_MyInterfacePrx, 3)), array($Test__t_MyInterfacePrx, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opOneOptional', 'opOneOptional', 0, -1, array(array($Test__t_OneOptional)), array(array($Test__t_OneOptional)), array($Test__t_OneOptional), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opByteSeq', 'opByteSeq', 0, -1, array(array($Test__t_ByteSeq, 2)), array(array($Test__t_ByteSeq, 3)), array($Test__t_ByteSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opBoolSeq', 'opBoolSeq', 0, -1, array(array($Test__t_BoolSeq, 2)), array(array($Test__t_BoolSeq, 3)), array($Test__t_BoolSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opShortSeq', 'opShortSeq', 0, -1, array(array($Test__t_ShortSeq, 2)), array(array($Test__t_ShortSeq, 3)), array($Test__t_ShortSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opIntSeq', 'opIntSeq', 0, -1, array(array($Test__t_IntSeq, 2)), array(array($Test__t_IntSeq, 3)), array($Test__t_IntSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opLongSeq', 'opLongSeq', 0, -1, array(array($Test__t_LongSeq, 2)), array(array($Test__t_LongSeq, 3)), array($Test__t_LongSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opFloatSeq', 'opFloatSeq', 0, -1, array(array($Test__t_FloatSeq, 2)), array(array($Test__t_FloatSeq, 3)), array($Test__t_FloatSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opDoubleSeq', 'opDoubleSeq', 0, -1, array(array($Test__t_DoubleSeq, 2)), array(array($Test__t_DoubleSeq, 3)), array($Test__t_DoubleSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opStringSeq', 'opStringSeq', 0, -1, array(array($Test__t_StringSeq, 2)), array(array($Test__t_StringSeq, 3)), array($Test__t_StringSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opSmallStructSeq', 'opSmallStructSeq', 0, -1, array(array($Test__t_SmallStructSeq, 2)), array(array($Test__t_SmallStructSeq, 3)), array($Test__t_SmallStructSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opSmallStructList', 'opSmallStructList', 0, -1, array(array($Test__t_SmallStructList, 2)), array(array($Test__t_SmallStructList, 3)), array($Test__t_SmallStructList, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opFixedStructSeq', 'opFixedStructSeq', 0, -1, array(array($Test__t_FixedStructSeq, 2)), array(array($Test__t_FixedStructSeq, 3)), array($Test__t_FixedStructSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opFixedStructList', 'opFixedStructList', 0, -1, array(array($Test__t_FixedStructList, 2)), array(array($Test__t_FixedStructList, 3)), array($Test__t_FixedStructList, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opVarStructSeq', 'opVarStructSeq', 0, -1, array(array($Test__t_VarStructSeq, 2)), array(array($Test__t_VarStructSeq, 3)), array($Test__t_VarStructSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opSerializable', 'opSerializable', 0, -1, array(array($Test__t_Serializable, 2)), array(array($Test__t_Serializable, 3)), array($Test__t_Serializable, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opIntIntDict', 'opIntIntDict', 0, -1, array(array($Test__t_IntIntDict, 2)), array(array($Test__t_IntIntDict, 3)), array($Test__t_IntIntDict, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opStringIntDict', 'opStringIntDict', 0, -1, array(array($Test__t_StringIntDict, 2)), array(array($Test__t_StringIntDict, 3)), array($Test__t_StringIntDict, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opClassAndUnknownOptional', 'opClassAndUnknownOptional', 0, -1, array(array($Test__t_A)), null, null, null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opRequiredAfterOptional', 'opRequiredAfterOptional', 0, -1, array(array($IcePHP__t_int), array($IcePHP__t_int, 1), array($IcePHP__t_int)), array(array($IcePHP__t_int), array($IcePHP__t_int, 2), array($IcePHP__t_int)), null, null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opOptionalAfterRequired', 'opOptionalAfterRequired', 0, -1, array(array($IcePHP__t_int), array($IcePHP__t_int, 1), array($IcePHP__t_int, 2)), array(array($IcePHP__t_int), array($IcePHP__t_int, 3), array($IcePHP__t_int, 4)), null, null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opG', 'opG', 0, -1, array(array($Test__t_G)), null, array($Test__t_G), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opVoid', 'opVoid', 0, -1, null, null, null, null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMStruct1', 'opMStruct1', 0, -1, null, null, array($Test__t_SmallStruct, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMStruct2', 'opMStruct2', 0, -1, array(array($Test__t_SmallStruct, 2)), array(array($Test__t_SmallStruct, 3)), array($Test__t_SmallStruct, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMSeq1', 'opMSeq1', 0, -1, null, null, array($Test__t_StringSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMSeq2', 'opMSeq2', 0, -1, array(array($Test__t_StringSeq, 2)), array(array($Test__t_StringSeq, 3)), array($Test__t_StringSeq, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMDict1', 'opMDict1', 0, -1, null, null, array($Test__t_StringIntDict, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'opMDict2', 'opMDict2', 0, -1, array(array($Test__t_StringIntDict, 2)), array(array($Test__t_StringIntDict, 3)), array($Test__t_StringIntDict, 1), null);
    IcePHP_defineOperation($Test__t_InitialPrx, 'supportsJavaSerializable', 'supportsJavaSerializable', 0, -1, null, null, array($IcePHP__t_bool), null);
}
?>
