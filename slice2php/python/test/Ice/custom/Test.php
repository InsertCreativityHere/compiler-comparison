...
namespace Test
{
    ...
    global $Test__t_DoubleSeq2;
    global $Test__t_D;
    IcePHP_defineOperation($Test__t_CustomPrx, 'opByteString1', 0, 0, array(array($Test__t_ByteString)), array(array($Test__t_ByteString)), array($Test__t_ByteString), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opByteString2', 0, 0, array(array($Test__t_ByteString)), array(array($Test__t_ByteString)), array($Test__t_ByteString), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opByteList1', 0, 0, array(array($Test__t_ByteList)), array(array($Test__t_ByteList)), array($Test__t_ByteList), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opByteList2', 0, 0, array(array($Test__t_ByteList)), array(array($Test__t_ByteList)), array($Test__t_ByteList), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opStringList1', 0, 0, array(array($Test__t_StringList)), array(array($Test__t_StringList)), array($Test__t_StringList), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opStringList2', 0, 0, array(array($Test__t_StringList)), array(array($Test__t_StringList)), array($Test__t_StringList), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opStringTuple1', 0, 0, array(array($Test__t_StringTuple)), array(array($Test__t_StringTuple)), array($Test__t_StringTuple), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opStringTuple2', 0, 0, array(array($Test__t_StringTuple)), array(array($Test__t_StringTuple)), array($Test__t_StringTuple), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'sendS', 0, 0, array(array($Test__t_S)), null, null, null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'sendC', 0, 0, array(array($Test__t_C)), null, null, null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBoolSeq', 0, 0, array(array($Test__t_BoolSeq1)), array(array($Test__t_BoolSeq2)), array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opByteSeq', 0, 0, array(array($Test__t_ByteSeq1)), array(array($Test__t_ByteSeq2)), array($Test__t_ByteSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opShortSeq', 0, 0, array(array($Test__t_ShortSeq1)), array(array($Test__t_ShortSeq2)), array($Test__t_ShortSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opIntSeq', 0, 0, array(array($Test__t_IntSeq1)), array(array($Test__t_IntSeq2)), array($Test__t_IntSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opLongSeq', 0, 0, array(array($Test__t_LongSeq1)), array(array($Test__t_LongSeq2)), array($Test__t_LongSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opFloatSeq', 0, 0, array(array($Test__t_FloatSeq1)), array(array($Test__t_FloatSeq2)), array($Test__t_FloatSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opDoubleSeq', 0, 0, array(array($Test__t_DoubleSeq1)), array(array($Test__t_DoubleSeq2)), array($Test__t_DoubleSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArrayNotExistsFactory', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArrayThrowFactory', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArrayType', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArrayNoneFactory', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArraySignatureFactory', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opBogusArrayNoCallableFactory', 0, 0, null, null, array($Test__t_BoolSeq1), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'opD', 0, 0, array(array($Test__t_D)), null, array($Test__t_D), null);
    IcePHP_defineOperation($Test__t_CustomPrx, 'shutdown', 0, 0, null, null, null, null);
}
?>
