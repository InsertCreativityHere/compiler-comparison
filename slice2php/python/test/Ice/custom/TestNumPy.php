...
namespace Test\NumPy
{
    ...
    global $Test_NumPy__t_Complex128Seq;
    global $Test_NumPy__t_D;
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opBoolSeq', 0, 0, array(array($Test_NumPy__t_BoolSeq1)), array(array($Test_NumPy__t_BoolSeq2)), array($Test_NumPy__t_BoolSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opByteSeq', 0, 0, array(array($Test_NumPy__t_ByteSeq1)), array(array($Test_NumPy__t_ByteSeq2)), array($Test_NumPy__t_ByteSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opShortSeq', 0, 0, array(array($Test_NumPy__t_ShortSeq1)), array(array($Test_NumPy__t_ShortSeq2)), array($Test_NumPy__t_ShortSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opIntSeq', 0, 0, array(array($Test_NumPy__t_IntSeq1)), array(array($Test_NumPy__t_IntSeq2)), array($Test_NumPy__t_IntSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opLongSeq', 0, 0, array(array($Test_NumPy__t_LongSeq1)), array(array($Test_NumPy__t_LongSeq2)), array($Test_NumPy__t_LongSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opFloatSeq', 0, 0, array(array($Test_NumPy__t_FloatSeq1)), array(array($Test_NumPy__t_FloatSeq2)), array($Test_NumPy__t_FloatSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opDoubleSeq', 0, 0, array(array($Test_NumPy__t_DoubleSeq1)), array(array($Test_NumPy__t_DoubleSeq2)), array($Test_NumPy__t_DoubleSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opComplex128Seq', 0, 0, array(array($Test_NumPy__t_Complex128Seq)), null, array($Test_NumPy__t_Complex128Seq), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opBoolMatrix', 0, 0, null, null, array($Test_NumPy__t_BoolSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opByteMatrix', 0, 0, null, null, array($Test_NumPy__t_ByteSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opShortMatrix', 0, 0, null, null, array($Test_NumPy__t_ShortSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opIntMatrix', 0, 0, null, null, array($Test_NumPy__t_IntSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opLongMatrix', 0, 0, null, null, array($Test_NumPy__t_LongSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opFloatMatrix', 0, 0, null, null, array($Test_NumPy__t_FloatSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opDoubleMatrix', 0, 0, null, null, array($Test_NumPy__t_DoubleSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opBogusNumpyArrayType', 0, 0, null, null, array($Test_NumPy__t_BoolSeq1), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'opD', 0, 0, array(array($Test_NumPy__t_D)), null, array($Test_NumPy__t_D), null);
    IcePHP_defineOperation($Test_NumPy__t_CustomPrx, 'shutdown', 0, 0, null, null, null, null);
}
?>
