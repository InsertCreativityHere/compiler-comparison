...
namespace Test
{
    ...
    {
        public function __construct($bo=false, $b=0, $s=0, $i=0, $l=0, $f=0.0, $d=0.0, $str='', $c1=\Test\Color::red, $bs=null, $iseq=null, $isDict=null, $st=null)
        {
            $this->bo = $bo;
            $this->b = $b;
            $this->s = $s;
    ...
    $Test__t_StructNoDefaults = IcePHP_defineStruct('::Test::StructNoDefaults', '\\Test\\StructNoDefaults', array(
        ...
        array('isDict', $Test__t_IntStringDict),
    ...
    {
        public function __construct($str='', $c1=\Test\Color::red, $bs=null, $st=null, $isDict=null)
        {
