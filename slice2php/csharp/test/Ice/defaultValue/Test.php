...
namespace Test
{
    ...
    class Point
    {
        public function __construct($x=0, $y=42)
        {
            $this->x = $x;
            $this->y = $y;
        }
    ...
    class PointProp
    {
        ...
        {
            global $Test__t_PointProp;
            return IcePHP_stringify($this, $Test__t_PointProp);
        }
    ...
    global $IcePHP__t_int;
    $Test__t_PointProp = IcePHP_defineStruct('::Test::PointProp', '\\Test\\PointProp', array(
        array('x', $IcePHP__t_int),
        array('y', $IcePHP__t_int)));
    ...
    class Base extends \Ice\Value
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=1, $s=2, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010? \007 \007", $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0, $st1=null)
        {
            ...
            $this->zeroD = $zeroD;
            $this->zeroDotD = $zeroDotD;
            $this->st1 = is_null($st1) ? new \Test\Struct1 : $st1;
        }
    ...
    $Test__t_Base = IcePHP_defineClass('::Test::Base', '\\Test\\Base', -1, $Ice__t_Value, array(
        ...
        array('st1', $Test__t_Struct1, false, 0)));
    ...
    {
        public function __construct($boolFalse=false, $boolTrue=true, $b=1, $s=2, $i=3, $l=4, $f=5.1, $d=6.2, $str="foo \\ \"bar\n \r\n\t\v\f\007\010? \007 \007", $noDefault='', $zeroI=0, $zeroL=0, $zeroF=0, $zeroDotF=0, $zeroD=0, $zeroDotD=0, $st1=null, $c1=\Test\Color::red, $c2=\Test\Color::green, $c3=\Test\Color::blue, $nc1=\Test\Nested\Color::red, $nc2=\Test\Nested\Color::green, $nc3=\Test\Nested\Color::blue)
        {
            parent::__construct($boolFalse, $boolTrue, $b, $s, $i, $l, $f, $d, $str, $noDefault, $zeroI, $zeroL, $zeroF, $zeroDotF, $zeroD, $zeroDotD, $st1);
            $this->c1 = $c1;
            $this->c2 = $c2;
            $this->c3 = $c3;
            $this->nc1 = $nc1;
    ...
    global $IcePHP__t_double;
    global $IcePHP__t_string;
    $Test__t_ClassProperty = IcePHP_defineClass('::Test::ClassProperty', '\\Test\\ClassProperty', -1, $Ice__t_Value, array(
        array('boolFalse', $IcePHP__t_bool, false, 0),
        array('boolTrue', $IcePHP__t_bool, false, 0),
        array('b', $IcePHP__t_byte, false, 0),
        array('s', $IcePHP__t_short, false, 0),
    ...
    $Test__t_ExceptionProperty = IcePHP_defineException('::Test::ExceptionProperty', '\\Test\\ExceptionProperty', null, array(
        array('boolFalse', $IcePHP__t_bool, false, 0),
        array('boolTrue', $IcePHP__t_bool, false, 0),
        array('b', $IcePHP__t_byte, false, 0),
        array('s', $IcePHP__t_short, false, 0),
