...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_PriorityPrx, 'shutdown', 0, 0, 0, null, null, null, null);
    IcePHP_defineOperation($Test__t_PriorityPrx, 'getPriority', 0, 0, 0, null, null, array($IcePHP__t_string), null);
}
?>
