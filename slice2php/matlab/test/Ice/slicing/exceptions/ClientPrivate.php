...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_RelayPrx, 'knownPreservedAsBase', 0, -1, null, null, null, array($Test__t_Base));
...
namespace Test
{
    ...
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'unknownMostDerived2AsBaseCompact', 0, 0, null, null, null, array($Test__t_Base));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'knownPreservedAsBase', 0, -1, null, null, null, array($Test__t_Base));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'knownPreservedAsKnownPreserved', 0, -1, null, null, null, array($Test__t_KnownPreserved));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'relayKnownPreservedAsBase', 0, -1, array(array($Test__t_RelayPrx)), null, null, array($Test__t_Base));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'relayKnownPreservedAsKnownPreserved', 0, -1, array(array($Test__t_RelayPrx)), null, null, array($Test__t_KnownPreserved));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'unknownPreservedAsBase', 0, -1, null, null, null, array($Test__t_Base));
    IcePHP_defineOperation($Test__t_TestIntfPrx, 'unknownPreservedAsKnownPreserved', 0, -1, null, null, null, array($Test__t_KnownPreserved));
