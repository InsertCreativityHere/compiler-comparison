...
namespace Test
{
    ...
    global $Test__t_IntSeqSeq;

    if(!isset($Test__t_IntSeqSeq))
    {
        global $Test__t_IntSeq;
        $Test__t_IntSeqSeq = IcePHP_defineSequence('::Test::IntSeqSeq', $Test__t_IntSeq);
    }

    global $Test__t_DerivedSeq;

    if(!isset($Test__t_DerivedSeq))
    {
        global $Test__t_Derived;
        $Test__t_DerivedSeq = IcePHP_defineSequence('::Test::DerivedSeq', $Test__t_Derived);
    }
    ...
    {
        public function __construct($bo=false, $b=0, $s=0, $i=0, $l=0, $f=0.0, $d=0.0, $str='', $c1=\Test\Color::red, $bs=null, $is=null, $st=null, $dict=null, $derivedSeq=null, $intSeqSeq=null)
        {
            $this->bo = $bo;
            $this->b = $b;
            $this->s = $s;
    ...
    $Test__t_StructNoDefaults = IcePHP_defineStruct('::Test::StructNoDefaults', '\\Test\\StructNoDefaults', array(
        ...
        array('derivedSeq', $Test__t_DerivedSeq),
        array('intSeqSeq', $Test__t_IntSeqSeq)));
