...
public final class StructNoDefaults implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public StructNoDefaults(boolean bo, byte b, short s, int i, long l, float f, double d, java.lang.String str, Color c1, byte[] bs, int[] iseq, java.util.Map<java.lang.Integer, java.lang.String> isDict, InnerStruct st) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
    ...
    public boolean equals(java.lang.Object rhs) {
        ...
        if (r != null) {
            ...
            if (this.isDict != r.isDict) {
                if (this.isDict == null || r.isDict == null || !this.isDict.equals(r.isDict)) {
                    return false;
                }
            }
            if (this.st != r.st) {
    ...
    public int hashCode() {
        ...
        h_ = com.zeroc.Ice.HashUtil.hashAdd(h_, isDict);
    ...
    public void ice_writeMembers(com.zeroc.Ice.OutputStream ostr) {
        ...
        IntStringDictHelper.write(ostr, this.isDict);
    ...
    public void ice_readMembers(com.zeroc.Ice.InputStream istr) {
        ...
        this.isDict = IntStringDictHelper.read(istr);
    ...
    private static final long serialVersionUID = -1201064667939118249L;
}
