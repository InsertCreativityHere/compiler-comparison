...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void pythonException(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> pythonExceptionAsync(java.util.Map<String, String> context)
    {
        return _iceI_pythonExceptionAsync(context, false);
    }

    /**
     * Invokes the pythonException operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_pythonExceptionAsync(java.util.Map<String, String> context, boolean sync)
    {
