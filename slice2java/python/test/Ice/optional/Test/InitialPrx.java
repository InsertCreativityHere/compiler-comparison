...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpRequiredAfterOptionalResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opRequiredAfterOptional", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpOptionalAfterRequiredResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opOptionalAfterRequired", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_p1);
                     ostr.writeInt(1, iceP_p2);
