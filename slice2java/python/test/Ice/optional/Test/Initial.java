...
public interface Initial extends com.zeroc.Ice.Object {
    ...
    public static class OpByteResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByte(1, this.returnValue);
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readByte(1);
    ...
    public static class OpBoolResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeBool(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readBool(1);
    ...
    public static class OpShortResult {
        ...
        /**
         * Marshals the result for the opShort operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeShort(1, this.returnValue);
            ostr.writeShort(3, this.p3);
        }

        /**
         * Unmarshals the result of the opShort operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readShort(1);
    ...
    public static class OpIntResult {
        ...
        /**
         * Marshals the result for the opInt operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeInt(1, this.returnValue);
            ostr.writeInt(3, this.p3);
        }

        /**
         * Unmarshals the result of the opInt operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readInt(1);
    ...
    public static class OpLongResult {
        ...
        /**
         * Marshals the result for the opLong operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeLong(2, this.p3);
            ostr.writeLong(3, this.returnValue);
        }

        /**
         * Unmarshals the result of the opLong operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.p3 = istr.readLong(2);
            this.returnValue = istr.readLong(3);
        }
    }
    ...
    public static class OpFloatResult {
        ...
        /**
         * Marshals the result for the opFloat operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeFloat(1, this.returnValue);
            ostr.writeFloat(3, this.p3);
        }

        /**
         * Unmarshals the result of the opFloat operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readFloat(1);
    ...
    public static class OpDoubleResult {
        ...
        /**
         * Marshals the result for the opDouble operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeDouble(1, this.returnValue);
            ostr.writeDouble(3, this.p3);
        }

        /**
         * Unmarshals the result of the opDouble operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readDouble(1);
    ...
    public static class OpStringResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeString(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readString(1);
    ...
    public static class OpMyEnumResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            MyEnum.ice_write(ostr, 1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = MyEnum.ice_read(istr, 1);
    ...
    public static class OpSmallStructResult {
        ...
        /**
         * Marshals the result for the opSmallStruct operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            SmallStruct.ice_write(ostr, 1, this.returnValue);
            SmallStruct.ice_write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opSmallStruct operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = SmallStruct.ice_read(istr, 1);
    ...
    public static class OpFixedStructResult {
        ...
        /**
         * Marshals the result for the opFixedStruct operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            FixedStruct.ice_write(ostr, 1, this.returnValue);
            FixedStruct.ice_write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opFixedStruct operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = FixedStruct.ice_read(istr, 1);
    ...
    public static class OpVarStructResult {
        ...
        /**
         * Marshals the result for the opVarStruct operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            VarStruct.ice_write(ostr, 1, this.returnValue);
            VarStruct.ice_write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opVarStruct operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = VarStruct.ice_read(istr, 1);
    ...
    public static class OpMyInterfaceProxyResult {
        ...
        /**
         * Marshals the result for the opMyInterfaceProxy operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeProxy(1, this.returnValue);
            ostr.writeProxy(3, this.p3);
        }

        /**
         * Unmarshals the result of the opMyInterfaceProxy operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readProxy(1, MyInterfacePrx::uncheckedCast);
    ...
    public static class OpOneOptionalResult {
        ...
        /**
         * Marshals the result for the opOneOptional operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
        ...
        /**
         * Unmarshals the result of the opOneOptional operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            istr.readValue(v -> this.p3 = v, OneOptional.class);
            istr.readValue(v -> this.returnValue = v, OneOptional.class);
        }
    }
    ...
    public static class OpByteSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readByteSeq(1);
    ...
    public static class OpBoolSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeBoolSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readBoolSeq(1);
    ...
    public static class OpShortSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeShortSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readShortSeq(1);
    ...
    public static class OpIntSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeIntSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readIntSeq(1);
    ...
    public static class OpLongSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeLongSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readLongSeq(1);
    ...
    public static class OpFloatSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeFloatSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readFloatSeq(1);
    ...
    public static class OpDoubleSeqResult {
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeDoubleSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readDoubleSeq(1);
    ...
    public static class OpStringSeqResult {
        ...
        public OpStringSeqResult(java.util.Optional<java.lang.String[]> returnValue, java.util.Optional<java.lang.String[]> p3) {
            this.returnValue = returnValue;
            this.p3 = p3;
        }

        public OpStringSeqResult(java.lang.String[] returnValue, java.lang.String[] p3) {
            this.returnValue = java.util.Optional.ofNullable(returnValue);
            this.p3 = java.util.Optional.ofNullable(p3);
        }
         ...
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeStringSeq(1, this.returnValue);
         ...
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readStringSeq(1);
    ...
    public static class OpSmallStructSeqResult {
        ...
        /**
         * Marshals the result for the opSmallStructSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            SmallStructSeqHelper.write(ostr, 1, this.returnValue);
            SmallStructSeqHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opSmallStructSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = SmallStructSeqHelper.read(istr, 1);
    ...
    public static class OpSmallStructListResult {
        ...
        /**
         * Marshals the result for the opSmallStructList operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            SmallStructListHelper.write(ostr, 1, this.returnValue);
            SmallStructListHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opSmallStructList operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = SmallStructListHelper.read(istr, 1);
    ...
    public static class OpFixedStructSeqResult {
        ...
        /**
         * Marshals the result for the opFixedStructSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            FixedStructSeqHelper.write(ostr, 1, this.returnValue);
            FixedStructSeqHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opFixedStructSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = FixedStructSeqHelper.read(istr, 1);
    ...
    public static class OpFixedStructListResult {
        ...
        /**
         * Marshals the result for the opFixedStructList operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            FixedStructListHelper.write(ostr, 1, this.returnValue);
            FixedStructListHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opFixedStructList operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = FixedStructListHelper.read(istr, 1);
    ...
    public static class OpVarStructSeqResult {
        ...
        /**
         * Marshals the result for the opVarStructSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            VarStructSeqHelper.write(ostr, 1, this.returnValue);
            VarStructSeqHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opVarStructSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = VarStructSeqHelper.read(istr, 1);
    ...
    public static class OpSerializableResult {
        ...
        /**
         * Marshals the result for the opSerializable operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteSeq(1, this.returnValue);
        ...
        /**
         * Unmarshals the result of the opSerializable operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readByteSeq(1);
    ...
    public static class OpIntIntDictResult {
        ...
        /**
         * Marshals the result for the opIntIntDict operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            IntIntDictHelper.write(ostr, 1, this.returnValue);
            IntIntDictHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opIntIntDict operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = IntIntDictHelper.read(istr, 1);
    ...
    public static class OpStringIntDictResult {
        ...
        /**
         * Marshals the result for the opStringIntDict operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            StringIntDictHelper.write(ostr, 1, this.returnValue);
            StringIntDictHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opStringIntDict operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = StringIntDictHelper.read(istr, 1);
            this.p3 = StringIntDictHelper.read(istr, 3);
        }
    }

    /**
     * Holds the result of operation opRequiredAfterOptional.
     */
    public static class OpRequiredAfterOptionalResult {
        public int p4;

        public java.util.OptionalInt p5;
         ...
         * Default constructor.
         */
        public OpRequiredAfterOptionalResult() {
        }

        public OpRequiredAfterOptionalResult(int p4, java.util.OptionalInt p5, int p6) {
            this.p4 = p4;
            this.p5 = p5;
            this.p6 = p6;
        }

        public OpRequiredAfterOptionalResult(int p4, int p5, int p6) {
            this.p4 = p4;
            this.p5 = java.util.OptionalInt.of(p5);
            this.p6 = p6;
        }

        /**
         * Marshals the result for the opRequiredAfterOptional operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeInt(this.p4);
            ostr.writeInt(this.p6);
            ostr.writeInt(2, this.p5);
        }

        /**
         * Unmarshals the result of the opRequiredAfterOptional operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.p4 = istr.readInt();
            this.p6 = istr.readInt();
            this.p5 = istr.readInt(2);
        }
    }

    /**
     * Holds the result of operation opOptionalAfterRequired.
     */
    public static class OpOptionalAfterRequiredResult {
        public int p4;

        public java.util.OptionalInt p5;

        public java.util.OptionalInt p6;

        /**
         * Default constructor.
         */
        public OpOptionalAfterRequiredResult() {
        }

        public OpOptionalAfterRequiredResult(int p4, java.util.OptionalInt p5, java.util.OptionalInt p6) {
            this.p4 = p4;
            this.p5 = p5;
            this.p6 = p6;
        }

        public OpOptionalAfterRequiredResult(int p4, int p5, int p6) {
            this.p4 = p4;
            this.p5 = java.util.OptionalInt.of(p5);
            this.p6 = java.util.OptionalInt.of(p6);
        }

        /**
         * Marshals the result for the opOptionalAfterRequired operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeInt(this.p4);
            ostr.writeInt(3, this.p5);
            ostr.writeInt(4, this.p6);
        }

        /**
         * Unmarshals the result of the opOptionalAfterRequired operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.p4 = istr.readInt();
            this.p5 = istr.readInt(3);
            this.p6 = istr.readInt(4);
        }
    }
    ...
    public static class OpMSeq1MarshaledResult implements com.zeroc.Ice.MarshaledResult {
        public OpMSeq1MarshaledResult(java.util.Optional<java.lang.String[]> returnValue, com.zeroc.Ice.Current current) {
            _ostr = current.startReplyStream();
            _ostr.startEncapsulation(current.encoding, null);
    ...
    public static class OpMSeq2Result {
        ...
        public java.util.Optional<java.lang.String[]> p2;
        ...
        public OpMSeq2Result(java.util.Optional<java.lang.String[]> returnValue, java.util.Optional<java.lang.String[]> p2) {
            this.returnValue = returnValue;
            this.p2 = p2;
        }
    ...
    public static class OpMSeq2MarshaledResult implements com.zeroc.Ice.MarshaledResult {
        public OpMSeq2MarshaledResult(java.util.Optional<java.lang.String[]> returnValue, java.util.Optional<java.lang.String[]> p2, com.zeroc.Ice.Current current) {
            _ostr = current.startReplyStream();
            _ostr.startEncapsulation(current.encoding, null);
            _ostr.writeStringSeq(1, returnValue);
    ...
    Initial.OpStringSeqResult opStringSeq(java.util.Optional<java.lang.String[]> p1, com.zeroc.Ice.Current current);
    ...
    Initial.OpRequiredAfterOptionalResult opRequiredAfterOptional(int p1, java.util.OptionalInt p2, int p3, com.zeroc.Ice.Current current);

    Initial.OpOptionalAfterRequiredResult opOptionalAfterRequired(int p1, java.util.OptionalInt p2, java.util.OptionalInt p3, com.zeroc.Ice.Current current);
    ...
    Initial.OpMSeq2MarshaledResult opMSeq2(java.util.Optional<java.lang.String[]> p1, com.zeroc.Ice.Current current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_pingPong(Initial obj, com.zeroc.Ice.IncomingRequest request) {
        ...
        com.zeroc.Ice.Value ret = obj.pingPong(iceP_o, request.current);
    ...
    /**
     * Dispatches the operation opSerializable.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opRequiredAfterOptional.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opRequiredAfterOptional(Initial obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        int iceP_p1;
        java.util.OptionalInt iceP_p2;
        int iceP_p3;
        iceP_p1 = istr.readInt();
        iceP_p3 = istr.readInt();
        iceP_p2 = istr.readInt(1);
        istr.endEncapsulation();
        Initial.OpRequiredAfterOptionalResult ret = obj.opRequiredAfterOptional(iceP_p1, iceP_p2, iceP_p3, request.current);
        var ostr = request.current.startReplyStream();
        ostr.startEncapsulation(request.current.encoding, null);
        ret.write(ostr);
        ostr.endEncapsulation();
    ...
    /**
     * Dispatches the operation opOptionalAfterRequired.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opOptionalAfterRequired(Initial obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        int iceP_p1;
        java.util.OptionalInt iceP_p2;
        java.util.OptionalInt iceP_p3;
        iceP_p1 = istr.readInt();
        iceP_p2 = istr.readInt(1);
        iceP_p3 = istr.readInt(2);
        istr.endEncapsulation();
        Initial.OpOptionalAfterRequiredResult ret = obj.opOptionalAfterRequired(iceP_p1, iceP_p2, iceP_p3, request.current);
        var ostr = request.current.startReplyStream();
        ostr.startEncapsulation(request.current.encoding, null);
        ret.write(ostr);
        ostr.endEncapsulation();
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            ...
            case "opRequiredAfterOptional" -> Initial._iceD_opRequiredAfterOptional(this, request);
            case "opOptionalAfterRequired" -> Initial._iceD_opOptionalAfterRequired(this, request);
