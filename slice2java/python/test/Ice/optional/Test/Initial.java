...
public interface Initial extends com.zeroc.Ice.Object
{
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opRequiredAfterOptional(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_p1;
        ...
        inS.endReadParams();
        Initial.OpRequiredAfterOptionalResult ret = obj.opRequiredAfterOptional(iceP_p1, iceP_p2, iceP_p3, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ret.write(ostr);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opOptionalAfterRequired(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_p1;
        ...
        inS.endReadParams();
        Initial.OpOptionalAfterRequiredResult ret = obj.opOptionalAfterRequired(iceP_p1, iceP_p2, iceP_p3, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ret.write(ostr);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (current.operation)
        {
            ...
            case "opSerializable" -> Initial._iceD_opSerializable(this, in, current);
            ...
            case "opRequiredAfterOptional" -> Initial._iceD_opRequiredAfterOptional(this, in, current);
            case "opOptionalAfterRequired" -> Initial._iceD_opOptionalAfterRequired(this, in, current);
