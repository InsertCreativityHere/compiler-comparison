...
public interface Custom extends com.zeroc.Ice.Object {
    ...
    public static class OpByteString1Result {
        ...
        /**
         * Marshals the result for the opByteString1 operation.
        ...
        /**
         * Unmarshals the result of the opByteString1 operation.
    ...
    public static class OpByteString2Result {
        ...
        /**
         * Marshals the result for the opByteString2 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteSeq(this.b2);
        ...
        /**
         * Unmarshals the result of the opByteString2 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.b2 = istr.readByteSeq();
    ...
    public static class OpByteList1Result {
        ...
        /**
         * Marshals the result for the opByteList1 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteSeq(this.b2);
        ...
        /**
         * Unmarshals the result of the opByteList1 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.b2 = istr.readByteSeq();
    ...
    public static class OpByteList2Result {
        ...
        /**
         * Marshals the result for the opByteList2 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteSeq(this.b2);
        ...
        /**
         * Unmarshals the result of the opByteList2 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.b2 = istr.readByteSeq();
    ...
    public static class OpStringList1Result {
        ...
        public OpStringList1Result(java.lang.String[] returnValue, java.lang.String[] s2) {
            this.returnValue = returnValue;
            this.s2 = s2;
        }

        /**
         * Marshals the result for the opStringList1 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
        ...
        /**
         * Unmarshals the result of the opStringList1 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
    ...
    public static class OpStringList2Result {
        ...
        public OpStringList2Result(java.lang.String[] returnValue, java.lang.String[] s2) {
            this.returnValue = returnValue;
            this.s2 = s2;
        }

        /**
         * Marshals the result for the opStringList2 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeStringSeq(this.s2);
        ...
        /**
         * Unmarshals the result of the opStringList2 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.s2 = istr.readStringSeq();
    ...
    public static class OpStringTuple1Result {
        ...
        public OpStringTuple1Result(java.lang.String[] returnValue, java.lang.String[] s2) {
            this.returnValue = returnValue;
            this.s2 = s2;
        }

        /**
         * Marshals the result for the opStringTuple1 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeStringSeq(this.s2);
        ...
        /**
         * Unmarshals the result of the opStringTuple1 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.s2 = istr.readStringSeq();
    ...
    public static class OpStringTuple2Result {
        ...
        public OpStringTuple2Result(java.lang.String[] returnValue, java.lang.String[] s2) {
            this.returnValue = returnValue;
            this.s2 = s2;
        }

        /**
         * Marshals the result for the opStringTuple2 operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeStringSeq(this.s2);
        ...
        /**
         * Unmarshals the result of the opStringTuple2 operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.s2 = istr.readStringSeq();
    ...
    Custom.OpStringList1Result opStringList1(java.lang.String[] s1, com.zeroc.Ice.Current current);

    Custom.OpStringList2Result opStringList2(java.lang.String[] s1, com.zeroc.Ice.Current current);

    Custom.OpStringTuple1Result opStringTuple1(java.lang.String[] s1, com.zeroc.Ice.Current current);

    Custom.OpStringTuple2Result opStringTuple2(java.lang.String[] s1, com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation opByteString1.
     *
    ...
    /**
     * Dispatches the operation opByteString2.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opByteList1.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opByteList2.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opStringList1.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opStringList2.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opStringTuple1.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opStringTuple2.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation sendS.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation sendC.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArrayNotExistsFactory.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArrayThrowFactory.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArrayType.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArrayNoneFactory.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArraySignatureFactory.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opBogusArrayNoCallableFactory.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
