...
public interface Thrower extends com.zeroc.Ice.Object {
    ...
    public static class ThrowMarshalExceptionResult {
        ...
        /**
         * Marshals the result for the throwMarshalException operation.
        ...
        /**
         * Unmarshals the result of the throwMarshalException operation.
    ...
    void throwRequestFailedException(java.lang.String type, com.zeroc.Ice.Identity id, java.lang.String facet, java.lang.String operation, com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation throwMarshalException.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation throwRequestFailedException.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_throwRequestFailedException(Thrower obj, com.zeroc.Ice.IncomingRequest request) {
        ...
        java.lang.String iceP_facet;
        java.lang.String iceP_operation;
