...
public interface ThrowerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Thrower.ThrowMarshalExceptionResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "throwMarshalException", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "throwRequestFailedException", null, sync, null);
        f.invoke(false, context, null, ostr -> {
