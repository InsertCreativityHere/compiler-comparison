...
public interface ThrowerPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Thrower.ThrowMarshalExceptionResult> _iceI_throwMarshalExceptionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Thrower.ThrowMarshalExceptionResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "throwMarshalException", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, null, istr -> {
