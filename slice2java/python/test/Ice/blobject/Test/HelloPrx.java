...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default void sayHello(int delay, java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<Void> sayHelloAsync(int delay, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_sayHelloAsync(delay, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_sayHelloAsync(int iceP_delay, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    default int add(int s1, int s2, java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> addAsync(int s1, int s2, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_addAsync(s1, s2, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_addAsync(int iceP_s1, int iceP_s2, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    default void raiseUE(java.util.Map<java.lang.String, java.lang.String> context)
        throws UE {
        try {
    ...
    default java.util.concurrent.CompletableFuture<Void> raiseUEAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_raiseUEAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_raiseUEAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_raiseUE = {
        UE.class
    };
