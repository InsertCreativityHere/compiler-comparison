...
public interface Initial extends com.zeroc.Ice.Object
{
    ...
    /** @hidden */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_throwTest1Def(Initial obj, com.zeroc.Ice.IncomingRequest request)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, request.current.mode);
        request.inputStream.skipEmptyEncapsulation();
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (request.current.operation)
        {
            ...
            case "throwTest1Def" -> Initial._iceD_throwTest1Def(this, request);
