...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test1.C1> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest1C2AsC1", null, sync, null);
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test1.C2> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest1C2AsC2", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_throwTest1DefAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "throwTest1Def", null, sync, _iceE_throwTest1Def);
        f.invoke(true, context, null, null, null);
        return f;
    }
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test2.C1> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest2C2AsC1", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test2.C2> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest2C2AsC2", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test3.C1> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest3C2AsC1", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test3.C2> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getTest3C2AsC2", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
