...
public interface B extends com.zeroc.Ice.Object {
    BPrx opB(BPrx b, com.zeroc.Ice.Current current);
     ...
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opB(B obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        BPrx iceP_b;
        iceP_b = BPrx.uncheckedCast(istr.readProxy());
        istr.endEncapsulation();
        BPrx ret = obj.opB(iceP_b, request.current);
