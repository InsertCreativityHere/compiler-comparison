...
public final class St implements java.lang.Cloneable, java.io.Serializable {
    ...
    /**
     * Constructs a {@code St} with values for all fields not marked optional in the Slice definition for {@code ::Test::St}.
     */
    ...
    public int hashCode() {
        int h_ = 5381;
        h_ = com.zeroc.Ice.HashUtil.hashAdd(h_, "::Test::St");
    ...
    private static final long serialVersionUID = 1597335053897737228L;
}
