...
@com.zeroc.Ice.SliceTypeId(value = "::Test::Cls")
public class Cls extends com.zeroc.Ice.Value {
    ...
    /**
     * Constructs a {@code Cls} with values for all fields not marked optional in the Slice definition for {@code ::Test::Cls}.
     */
    public Cls(IntfPrx s, java.lang.String context, int current, short response, java.lang.String upCast, int typeId, short del, java.lang.String ex, int result, java.lang.String istr, java.lang.String ostr, java.lang.String inS, java.lang.String in, java.lang.String proxy) {
        this.s = s;
     ...
     */
    public Cls(IntfPrx s, java.lang.String context, int current, short response, java.lang.String upCast, int typeId, short del, short cookie, java.lang.String ex, int result, java.lang.String istr, java.lang.String ostr, java.lang.String inS, java.lang.String in, java.lang.String proxy) {
        this.s = s;
        this.context = context;
        this.current = current;
        this.response = response;
    ...
    private static final long serialVersionUID = -421085532014878247L;
}
