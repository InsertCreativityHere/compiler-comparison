...
public interface Awaitable extends com.zeroc.Ice.Object {
     ...
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_op(Awaitable obj, com.zeroc.Ice.IncomingRequest request) {
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            case "op" -> Awaitable._iceD_op(this, request);
