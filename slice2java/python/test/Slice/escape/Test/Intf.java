...
public interface Intf extends com.zeroc.Ice.Object {
    ...
    void opField(field name, field value, com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation opField.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opField(Intf obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        final com.zeroc.Ice.Holder<field> icePP_name = new com.zeroc.Ice.Holder<>();
        final com.zeroc.Ice.Holder<field> icePP_value = new com.zeroc.Ice.Holder<>();
        istr.readValue(v -> icePP_name.value = v, field.class);
        istr.readValue(v -> icePP_value.value = v, field.class);
        istr.readPendingValues();
        istr.endEncapsulation();
        field iceP_name = icePP_name.value;
        field iceP_value = icePP_value.value;
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            ...
            case "opField" -> Intf._iceD_opField(this, request);
