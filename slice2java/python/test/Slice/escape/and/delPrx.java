...
public interface delPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int elif(int else, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> elifAsync(int else, java.util.Map<String, String> context)
    {
        return _iceI_elifAsync(else, context, false);
    }

    /**
     * Invokes the elif operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
