...
public interface printPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default printPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (printPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default printPrx ice_adapterId(String newAdapterId)
    {
        return (printPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default printPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (printPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default printPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (printPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default printPrx ice_invocationTimeout(int newTimeout)
    {
        return (printPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default printPrx ice_connectionCached(boolean newCache)
    {
        return (printPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default printPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (printPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default printPrx ice_secure(boolean b)
    {
        return (printPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default printPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (printPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default printPrx ice_preferSecure(boolean b)
    {
        return (printPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default printPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (printPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default printPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (printPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default printPrx ice_collocationOptimized(boolean b)
    {
        return (printPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default printPrx ice_twoway()
    {
        return (printPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default printPrx ice_oneway()
    {
        return (printPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default printPrx ice_batchOneway()
    {
        return (printPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default printPrx ice_datagram()
    {
        return (printPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default printPrx ice_batchDatagram()
    {
        return (printPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default printPrx ice_compress(boolean co)
    {
        return (printPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default printPrx ice_timeout(int t)
    {
        return (printPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default printPrx ice_connectionId(String connectionId)
    {
        return (printPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default printPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (printPrx)_ice_fixed(connection);
    }
