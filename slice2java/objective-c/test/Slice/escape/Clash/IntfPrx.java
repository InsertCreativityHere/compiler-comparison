...
public interface IntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void ok()
    {
        ok(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void ok(java.util.Map<String, String> context)
    {
        _iceI_okAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> okAsync()
    {
        return _iceI_okAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> okAsync(java.util.Map<String, String> context)
    {
        return _iceI_okAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_okAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "ok", null, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }
    ...
    default void target()
    {
        target(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void target(java.util.Map<String, String> context)
    {
        _iceI_targetAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> targetAsync()
    {
        return _iceI_targetAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> targetAsync(java.util.Map<String, String> context)
    {
        return _iceI_targetAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_targetAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "target", null, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }

    default void op(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, String proxy, String ok)
    {
        op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void op(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, String proxy, String ok, java.util.Map<String, String> context_)
    {
        _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, true).waitForResponse();
    }

    default void op(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, java.util.Optional<java.lang.String> proxy, java.util.Optional<java.lang.String> ok)
    {
        op(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void op(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, java.util.Optional<java.lang.String> proxy, java.util.Optional<java.lang.String> ok, java.util.Map<String, String> context_)
    {
        _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> opAsync(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, String proxy, String ok)
    {
        return _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> opAsync(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, String proxy, String ok, java.util.Map<String, String> context_)
    {
        return _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, false);
    }
    ...
    default java.util.concurrent.CompletableFuture<Void> opAsync(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, java.util.Optional<java.lang.String> proxy, java.util.Optional<java.lang.String> ok)
    {
        return _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> opAsync(String context, String current, String response, String ex, String sent, String cookie, String sync, String result, String istr, String ostr, String target, java.util.Optional<java.lang.String> proxy, java.util.Optional<java.lang.String> ok, java.util.Map<String, String> context_)
    {
        return _iceI_opAsync(context, current, response, ex, sent, cookie, sync, result, istr, ostr, target, proxy, ok, context_, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_opAsync(String iceP_context, String iceP_current, String iceP_response, String iceP_ex, String iceP_sent, String iceP_cookie, String iceP_sync, String iceP_result, String iceP_istr, String iceP_ostr, String iceP_target, java.util.Optional<java.lang.String> iceP_proxy, java.util.Optional<java.lang.String> iceP_ok, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "op", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeString(iceP_context);
