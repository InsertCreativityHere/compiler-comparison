...
public interface TestIntfControllerPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (TestIntfControllerPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_adapterId(String newAdapterId)
    {
        return (TestIntfControllerPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (TestIntfControllerPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (TestIntfControllerPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_invocationTimeout(int newTimeout)
    {
        return (TestIntfControllerPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_connectionCached(boolean newCache)
    {
        return (TestIntfControllerPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (TestIntfControllerPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_secure(boolean b)
    {
        return (TestIntfControllerPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (TestIntfControllerPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_preferSecure(boolean b)
    {
        return (TestIntfControllerPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (TestIntfControllerPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (TestIntfControllerPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_collocationOptimized(boolean b)
    {
        return (TestIntfControllerPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_twoway()
    {
        return (TestIntfControllerPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_oneway()
    {
        return (TestIntfControllerPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_batchOneway()
    {
        return (TestIntfControllerPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_datagram()
    {
        return (TestIntfControllerPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_batchDatagram()
    {
        return (TestIntfControllerPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_compress(boolean co)
    {
        return (TestIntfControllerPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_timeout(int t)
    {
        return (TestIntfControllerPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_connectionId(String connectionId)
    {
        return (TestIntfControllerPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default TestIntfControllerPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (TestIntfControllerPrx)_ice_fixed(connection);
    }
