...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default SS sequenceTest(SS1 p1, SS2 p2)
    {
        return sequenceTest(p1, p2, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default SS sequenceTest(SS1 p1, SS2 p2, java.util.Map<String, String> context)
    {
        return _iceI_sequenceTestAsync(p1, p2, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<SS> sequenceTestAsync(SS1 p1, SS2 p2)
    {
        return _iceI_sequenceTestAsync(p1, p2, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<SS> sequenceTestAsync(SS1 p1, SS2 p2, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<SS> _iceI_sequenceTestAsync(SS1 iceP_p1, SS2 iceP_p2, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<SS> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sequenceTest", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.SlicedFormat, ostr -> {
                     ostr.writeValue(iceP_p1);
                     ostr.writeValue(iceP_p2);
                     ostr.writePendingValues();
