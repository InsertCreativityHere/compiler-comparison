...
public interface MyDerivedClass extends MyClass
{
    ...
    MyStruct1 opMyStruct1(MyStruct1 c, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMyStruct1(MyDerivedClass obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        MyStruct1 iceP_c;
        iceP_c = MyStruct1.ice_read(istr);
        inS.endReadParams();
        MyStruct1 ret = obj.opMyStruct1(iceP_c, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return MyClass._iceD_getNSNullASeq(this, in, current);
            }
            case 1:
            {
                return MyClass._iceD_getNSNullStringSeq(this, in, current);
            }
            case 2:
            {
                return MyClass._iceD_getNSNullStringSeqSeq(this, in, current);
            }
            case 3:
            {
                return MyClass._iceD_getNSNullStringStringDict(this, in, current);
            }
            case 4:
            {
                return MyClass._iceD_getNSNullStructSeq(this, in, current);
            }
            case 5:
            {
            ...
            case 48:
            {
                return MyClass._iceD_opMyClassS(this, in, current);
            }
            case 49:
            {
            ...
            case 51:
            {
                return MyClass._iceD_opMyEnumS(this, in, current);
            }
            case 52:
            {
            ...
            case 83:
            {
                return MyClass._iceD_putNSNullShortIntDict(this, in, current);
            }
            case 84:
            {
                return MyClass._iceD_putNSNullStringMyEnumDict(this, in, current);
            }
            case 85:
            {
                return MyClass._iceD_putNSNullStringStringDict(this, in, current);
            }
            case 86:
            {
