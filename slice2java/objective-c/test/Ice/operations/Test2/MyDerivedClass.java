...
public interface MyDerivedClass extends Test.MyClass
{
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return Test.MyClass._iceD_getNSNullASeq(this, in, current);
            }
            case 1:
            {
                return Test.MyClass._iceD_getNSNullStringSeq(this, in, current);
            }
            case 2:
            {
                return Test.MyClass._iceD_getNSNullStringSeqSeq(this, in, current);
            }
            case 3:
            {
                return Test.MyClass._iceD_getNSNullStringStringDict(this, in, current);
            }
            case 4:
            {
                return Test.MyClass._iceD_getNSNullStructSeq(this, in, current);
            }
            case 5:
            {
            ...
            case 46:
            {
                return Test.MyClass._iceD_opMyClassS(this, in, current);
            }
            case 47:
            {
            ...
            case 49:
            {
                return Test.MyClass._iceD_opMyEnumS(this, in, current);
            }
            case 50:
            {
            ...
            case 80:
            {
                return Test.MyClass._iceD_putNSNullShortIntDict(this, in, current);
            }
            case 81:
            {
                return Test.MyClass._iceD_putNSNullStringMyEnumDict(this, in, current);
            }
            case 82:
            {
                return Test.MyClass._iceD_putNSNullStringStringDict(this, in, current);
            }
            case 83:
            {
