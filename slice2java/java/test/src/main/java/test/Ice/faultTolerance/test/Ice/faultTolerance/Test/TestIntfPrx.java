...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the abort operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
    ...
    /**
     * Invokes the idempotentAbort operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
    ...
    /**
     * Invokes the pid operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
