...
{
    default void transientOp()
    {
        transientOp(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void transientOp(java.util.Map<String, String> context)
    {
        _iceI_transientOpAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> transientOpAsync()
    {
        return _iceI_transientOpAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> transientOpAsync(java.util.Map<String, String> context)
    {
        return _iceI_transientOpAsync(context, false);
    }

    /**
     * Invokes the transient operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_transientOpAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "transient", com.zeroc.Ice.OperationMode.Normal, sync, null);
