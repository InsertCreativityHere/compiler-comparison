...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default MyClass.OpSerialSmallJavaResult opSerialSmallJava(test.Ice.seqMapping.Serialize.Small i, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<MyClass.OpSerialSmallJavaResult> opSerialSmallJavaAsync(test.Ice.seqMapping.Serialize.Small i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialSmallJavaAsync(i, context, false);
    }

    /**
     * Invokes the opSerialSmallJava operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    default MyClass.OpSerialLargeJavaResult opSerialLargeJava(test.Ice.seqMapping.Serialize.Large i, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<MyClass.OpSerialLargeJavaResult> opSerialLargeJavaAsync(test.Ice.seqMapping.Serialize.Large i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialLargeJavaAsync(i, context, false);
    }

    /**
     * Invokes the opSerialLargeJava operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_i parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
    ...
    default MyClass.OpSerialStructJavaResult opSerialStructJava(test.Ice.seqMapping.Serialize.Struct i, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<MyClass.OpSerialStructJavaResult> opSerialStructJavaAsync(test.Ice.seqMapping.Serialize.Struct i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialStructJavaAsync(i, context, false);
    }

    /**
     * Invokes the opSerialStructJava operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_i parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
