...
public interface TestIntf extends com.zeroc.Ice.Object {
    ...
    public static class OpAArrayResult {
        ...
        /**
         * Marshals the result for the opAArray operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            AArrayHelper.write(ostr, this.outSeq);
            AArrayHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opAArray operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = AArrayHelper.read(istr);
            this.returnValue = AArrayHelper.read(istr);
        }
    }
    ...
    public static class OpAListResult {
        ...
        /**
         * Marshals the result for the opAList operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            AListHelper.write(ostr, this.outSeq);
            AListHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opAList operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = AListHelper.read(istr);
            this.returnValue = AListHelper.read(istr);
        }
    }
    ...
    public static class OpBoolSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            BoolSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = BoolSeqHelper.read(istr);
        }
    }
    ...
    public static class OpByteSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            ByteSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = ByteSeqHelper.read(istr);
        }
    }
    ...
    public static class OpShortSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            ShortSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = ShortSeqHelper.read(istr);
        }
    }
    ...
    public static class OpIntSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            IntSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = IntSeqHelper.read(istr);
        }
    }
    ...
    public static class OpLongSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            LongSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = LongSeqHelper.read(istr);
        }
    }
    ...
    public static class OpFloatSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            FloatSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = FloatSeqHelper.read(istr);
        }
    }
    ...
    public static class OpDoubleSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            DoubleSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = DoubleSeqHelper.read(istr);
        }
    }
    ...
    public static class OpStringSeqResult {
        ...
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ...
            StringSeqHelper.write(ostr, this.returnValue);
        }
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = StringSeqHelper.read(istr);
        }
    }
    ...
    public static class OpSSeqResult {
        ...
        /**
         * Marshals the result for the opSSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            SSeqHelper.write(ostr, this.outSeq);
            SSeqHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opSSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = SSeqHelper.read(istr);
            this.returnValue = SSeqHelper.read(istr);
        }
    }
    ...
    public static class OpDSeqResult {
        ...
        /**
         * Marshals the result for the opDSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            DSeqHelper.write(ostr, this.outSeq);
            DSeqHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opDSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = DSeqHelper.read(istr);
            this.returnValue = DSeqHelper.read(istr);
        }
    }
    ...
    public static class OpStringSeqSeqResult {
        ...
        /**
         * Marshals the result for the opStringSeqSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            StringSeqSeqHelper.write(ostr, this.outSeq);
            StringSeqSeqHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opStringSeqSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = StringSeqSeqHelper.read(istr);
            this.returnValue = StringSeqSeqHelper.read(istr);
        }
    }
    ...
    public static class OpByteBufferSeqResult {
        ...
        /**
         * Marshals the result for the opByteBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeByteBuffer(this.outSeq);
            ostr.writeByteBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opByteBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readByteBuffer();
            this.returnValue = istr.readByteBuffer();
        }
    }
    ...
    public static class OpShortBufferSeqResult {
        ...
        /**
         * Marshals the result for the opShortBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeShortBuffer(this.outSeq);
            ostr.writeShortBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opShortBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readShortBuffer();
            this.returnValue = istr.readShortBuffer();
        }
    }
    ...
    public static class OpIntBufferSeqResult {
        ...
        /**
         * Marshals the result for the opIntBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeIntBuffer(this.outSeq);
            ostr.writeIntBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opIntBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readIntBuffer();
            this.returnValue = istr.readIntBuffer();
        }
    }
    ...
    public static class OpLongBufferSeqResult {
        ...
        /**
         * Marshals the result for the opLongBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeLongBuffer(this.outSeq);
            ostr.writeLongBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opLongBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readLongBuffer();
            this.returnValue = istr.readLongBuffer();
        }
    }
    ...
    public static class OpFloatBufferSeqResult {
        ...
        /**
         * Marshals the result for the opFloatBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeFloatBuffer(this.outSeq);
            ostr.writeFloatBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opFloatBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readFloatBuffer();
            this.returnValue = istr.readFloatBuffer();
        }
    }
    ...
    public static class OpDoubleBufferSeqResult {
        ...
        /**
         * Marshals the result for the opDoubleBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeDoubleBuffer(this.outSeq);
            ostr.writeDoubleBuffer(this.returnValue);
        }

        /**
         * Unmarshals the result of the opDoubleBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.outSeq = istr.readDoubleBuffer();
            this.returnValue = istr.readDoubleBuffer();
        }
    }
    ...
    public static class OpOptASeqResult {
        ...
        /**
         * Marshals the result for the opOptASeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ASeqHelper.write(ostr, 1, this.returnValue);
            ASeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptASeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = ASeqHelper.read(istr, 1);
    ...
    public static class OpOptAArrayResult {
        ...
        /**
         * Marshals the result for the opOptAArray operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            AArrayHelper.write(ostr, 1, this.returnValue);
            AArrayHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptAArray operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = AArrayHelper.read(istr, 1);
    ...
    public static class OpOptAListResult {
        ...
        /**
         * Marshals the result for the opOptAList operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            AListHelper.write(ostr, 1, this.returnValue);
            AListHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptAList operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = AListHelper.read(istr, 1);
    ...
    public static class OpOptBoolSeqResult {
        ...
        /**
         * Marshals the result for the opOptBoolSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            BoolSeqHelper.write(ostr, 1, this.returnValue);
            BoolSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptBoolSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = BoolSeqHelper.read(istr, 1);
    ...
    public static class OpOptByteSeqResult {
        ...
        /**
         * Marshals the result for the opOptByteSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ByteSeqHelper.write(ostr, 1, this.returnValue);
            ByteSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptByteSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = ByteSeqHelper.read(istr, 1);
    ...
    public static class OpOptShortSeqResult {
        ...
        /**
         * Marshals the result for the opOptShortSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ShortSeqHelper.write(ostr, 1, this.returnValue);
            ShortSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptShortSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = ShortSeqHelper.read(istr, 1);
    ...
    public static class OpOptIntSeqResult {
        ...
        /**
         * Marshals the result for the opOptIntSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            IntSeqHelper.write(ostr, 1, this.returnValue);
            IntSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptIntSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = IntSeqHelper.read(istr, 1);
    ...
    public static class OpOptLongSeqResult {
        ...
        /**
         * Marshals the result for the opOptLongSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            LongSeqHelper.write(ostr, 1, this.returnValue);
            LongSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptLongSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = LongSeqHelper.read(istr, 1);
    ...
    public static class OpOptFloatSeqResult {
        ...
        /**
         * Marshals the result for the opOptFloatSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            FloatSeqHelper.write(ostr, 1, this.returnValue);
            FloatSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptFloatSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = FloatSeqHelper.read(istr, 1);
    ...
    public static class OpOptDoubleSeqResult {
        ...
        /**
         * Marshals the result for the opOptDoubleSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            DoubleSeqHelper.write(ostr, 1, this.returnValue);
            DoubleSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptDoubleSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = DoubleSeqHelper.read(istr, 1);
    ...
    public static class OpOptStringSeqResult {
        ...
        /**
         * Marshals the result for the opOptStringSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            StringSeqHelper.write(ostr, 1, this.returnValue);
            StringSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptStringSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = StringSeqHelper.read(istr, 1);
    ...
    public static class OpOptESeqResult {
        ...
        /**
         * Marshals the result for the opOptESeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ESeqHelper.write(ostr, 1, this.returnValue);
            ESeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptESeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = ESeqHelper.read(istr, 1);
    ...
    public static class OpOptSSeqResult {
        ...
        /**
         * Marshals the result for the opOptSSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            SSeqHelper.write(ostr, 1, this.returnValue);
            SSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptSSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = SSeqHelper.read(istr, 1);
    ...
    public static class OpOptDSeqResult {
        ...
        /**
         * Marshals the result for the opOptDSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            DSeqHelper.write(ostr, 1, this.returnValue);
            DSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptDSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = DSeqHelper.read(istr, 1);
    ...
    public static class OpOptStringSeqSeqResult {
        ...
        /**
         * Marshals the result for the opOptStringSeqSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            StringSeqSeqHelper.write(ostr, 1, this.returnValue);
            StringSeqSeqHelper.write(ostr, 3, this.outSeq);
        }

        /**
         * Unmarshals the result of the opOptStringSeqSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = StringSeqSeqHelper.read(istr, 1);
    ...
    public static class OpOptByteBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptByteBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                ostr.writeByteBuffer(this.returnValue.get());
            }
        ...
        /**
         * Unmarshals the result of the opOptByteBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                ...
                this.returnValue = java.util.Optional.of(optSeq);
            } else {
                this.returnValue = java.util.Optional.empty();
            }
    ...
    public static class OpOptShortBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptShortBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.returnValue.get() == null ? 0 : this.returnValue.get().remaining() / 2;
                ostr.writeSize(optSize > 254 ? optSize * 2 + 5 : optSize * 2 + 1);
                ostr.writeShortBuffer(this.returnValue.get());
            }
            if (this.outSeq != null && this.outSeq.isPresent() && ostr.writeOptional(3, com.zeroc.Ice.OptionalFormat.VSize)) {
        ...
        /**
         * Unmarshals the result of the opOptShortBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
    ...
    public static class OpOptIntBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptIntBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.returnValue.get() == null ? 0 : this.returnValue.get().remaining() / 4;
                ostr.writeSize(optSize > 254 ? optSize * 4 + 5 : optSize * 4 + 1);
                ostr.writeIntBuffer(this.returnValue.get());
            }
            if (this.outSeq != null && this.outSeq.isPresent() && ostr.writeOptional(3, com.zeroc.Ice.OptionalFormat.VSize)) {
        ...
        /**
         * Unmarshals the result of the opOptIntBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
    ...
    public static class OpOptLongBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptLongBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.returnValue.get() == null ? 0 : this.returnValue.get().remaining() / 8;
                ostr.writeSize(optSize > 254 ? optSize * 8 + 5 : optSize * 8 + 1);
                ostr.writeLongBuffer(this.returnValue.get());
            }
            if (this.outSeq != null && this.outSeq.isPresent() && ostr.writeOptional(3, com.zeroc.Ice.OptionalFormat.VSize)) {
        ...
        /**
         * Unmarshals the result of the opOptLongBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
    ...
    public static class OpOptFloatBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptFloatBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.returnValue.get() == null ? 0 : this.returnValue.get().remaining() / 4;
                ostr.writeSize(optSize > 254 ? optSize * 4 + 5 : optSize * 4 + 1);
                ostr.writeFloatBuffer(this.returnValue.get());
            }
            if (this.outSeq != null && this.outSeq.isPresent() && ostr.writeOptional(3, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.outSeq.get() == null ? 0 : this.outSeq.get().remaining() / 4;
                ostr.writeSize(optSize > 254 ? optSize * 4 + 5 : optSize * 4 + 1);
        ...
        /**
         * Unmarshals the result of the opOptFloatBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
    ...
    public static class OpOptDoubleBufferSeqResult {
        ...
        /**
         * Marshals the result for the opOptDoubleBufferSeq operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            if (this.returnValue != null && this.returnValue.isPresent() && ostr.writeOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.returnValue.get() == null ? 0 : this.returnValue.get().remaining() / 8;
                ostr.writeSize(optSize > 254 ? optSize * 8 + 5 : optSize * 8 + 1);
                ostr.writeDoubleBuffer(this.returnValue.get());
            }
            if (this.outSeq != null && this.outSeq.isPresent() && ostr.writeOptional(3, com.zeroc.Ice.OptionalFormat.VSize)) {
                final int optSize = this.outSeq.get() == null ? 0 : this.outSeq.get().remaining() / 8;
                ostr.writeSize(optSize > 254 ? optSize * 8 + 5 : optSize * 8 + 1);
        ...
        /**
         * Unmarshals the result of the opOptDoubleBufferSeq operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            if (istr.readOptional(1, com.zeroc.Ice.OptionalFormat.VSize)) {
    ...
    /**
     * Dispatches the operation opASeq.
     *
    ...
    /**
     * Dispatches the operation opAArray.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opAList.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opSSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opDSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opStringSeqSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opByteBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opShortBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opIntBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opLongBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opFloatBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opDoubleBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptASeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptAArray.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptAList.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptBoolSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptByteSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptShortSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptIntSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptLongSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptFloatSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptDoubleSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptStringSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptESeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptSSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptDSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptStringSeqSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptByteBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptShortBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptIntBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptLongBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptFloatBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opOptDoubleBufferSeq.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
