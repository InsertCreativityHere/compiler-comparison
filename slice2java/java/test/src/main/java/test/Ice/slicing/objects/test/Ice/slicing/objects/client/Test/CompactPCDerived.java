...
public class CompactPCDerived extends CompactPDerived {
    ...
    /**
     * Constructs a {@code CompactPCDerived}.
     */
    ...
    /**
     * Constructs a {@code CompactPCDerived} with values for all its fields.
     */
    public CompactPCDerived(int pi, java.lang.String ps, PBase pb, PBase[] pbs) {
        super(pi, ps, pb);
        this.pbs = pbs;
    }
    ...
    private static final long serialVersionUID = 3191956997237170678L;
}
