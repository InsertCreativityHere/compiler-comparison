...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<HelloPrx> _iceI_getHelloAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<HelloPrx> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getHello", null, sync, null);
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<HelloPrx> _iceI_getReplicatedHelloAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<HelloPrx> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getReplicatedHello", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, null, istr -> {
                     HelloPrx ret;
                     ret = HelloPrx.uncheckedCast(istr.readProxy());
                     return ret;
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_migrateHelloAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "migrateHello", null, sync, null);
        f.invoke(false, context, com.zeroc.Ice.FormatType.DefaultFormat, null, null);
        return f;
    }
