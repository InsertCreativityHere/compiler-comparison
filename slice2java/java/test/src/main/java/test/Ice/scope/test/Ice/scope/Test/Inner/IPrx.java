...
{
    default I.OpSResult opS(test.Ice.scope.Test.Inner.Inner2.S s1)
    {
        return opS(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpSResult opS(test.Ice.scope.Test.Inner.Inner2.S s1, java.util.Map<String, String> context)
    {
        return _iceI_opSAsync(s1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpSResult> opSAsync(test.Ice.scope.Test.Inner.Inner2.S s1)
    {
        return _iceI_opSAsync(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpSResult> opSAsync(test.Ice.scope.Test.Inner.Inner2.S s1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpSResult> _iceI_opSAsync(test.Ice.scope.Test.Inner.Inner2.S iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, ostr -> {
                     test.Ice.scope.Test.Inner.Inner2.S.ice_write(ostr, iceP_s1);
                 }, istr -> {
    ...
    default I.OpSSeqResult opSSeq(test.Ice.scope.Test.Inner.Inner2.S[] s1)
    {
        return opSSeq(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpSSeqResult opSSeq(test.Ice.scope.Test.Inner.Inner2.S[] s1, java.util.Map<String, String> context)
    {
        return _iceI_opSSeqAsync(s1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpSSeqResult> opSSeqAsync(test.Ice.scope.Test.Inner.Inner2.S[] s1)
    {
        return _iceI_opSSeqAsync(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpSSeqResult> opSSeqAsync(test.Ice.scope.Test.Inner.Inner2.S[] s1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpSSeqResult> _iceI_opSSeqAsync(test.Ice.scope.Test.Inner.Inner2.S[] iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<I.OpSSeqResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opSSeq", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, ostr -> {
                     test.Ice.scope.Test.Inner.Inner2.SSeqHelper.write(ostr, iceP_s1);
                 }, istr -> {
    ...
    default I.OpSMapResult opSMap(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.S> s1)
    {
        return opSMap(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpSMapResult opSMap(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.S> s1, java.util.Map<String, String> context)
    {
        return _iceI_opSMapAsync(s1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpSMapResult> opSMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.S> s1)
    {
        return _iceI_opSMapAsync(s1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpSMapResult> opSMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.S> s1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpSMapResult> _iceI_opSMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.S> iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<I.OpSMapResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opSMap", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, ostr -> {
                     test.Ice.scope.Test.Inner.Inner2.SMapHelper.write(ostr, iceP_s1);
                 }, istr -> {
    ...
    default I.OpCResult opC(test.Ice.scope.Test.Inner.Inner2.C c1)
    {
        return opC(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpCResult opC(test.Ice.scope.Test.Inner.Inner2.C c1, java.util.Map<String, String> context)
    {
        return _iceI_opCAsync(c1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpCResult> opCAsync(test.Ice.scope.Test.Inner.Inner2.C c1)
    {
        return _iceI_opCAsync(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpCResult> opCAsync(test.Ice.scope.Test.Inner.Inner2.C c1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpCResult> _iceI_opCAsync(test.Ice.scope.Test.Inner.Inner2.C iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default I.OpCSeqResult opCSeq(test.Ice.scope.Test.Inner.Inner2.C[] c1)
    {
        return opCSeq(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpCSeqResult opCSeq(test.Ice.scope.Test.Inner.Inner2.C[] c1, java.util.Map<String, String> context)
    {
        return _iceI_opCSeqAsync(c1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpCSeqResult> opCSeqAsync(test.Ice.scope.Test.Inner.Inner2.C[] c1)
    {
        return _iceI_opCSeqAsync(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpCSeqResult> opCSeqAsync(test.Ice.scope.Test.Inner.Inner2.C[] c1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpCSeqResult> _iceI_opCSeqAsync(test.Ice.scope.Test.Inner.Inner2.C[] iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<I.OpCSeqResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCSeq", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, ostr -> {
                     test.Ice.scope.Test.Inner.Inner2.CSeqHelper.write(ostr, iceP_c1);
                     ostr.writePendingValues();
                 }, istr -> {
    ...
    default I.OpCMapResult opCMap(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.C> c1)
    {
        return opCMap(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default I.OpCMapResult opCMap(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.C> c1, java.util.Map<String, String> context)
    {
        return _iceI_opCMapAsync(c1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<I.OpCMapResult> opCMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.C> c1)
    {
        return _iceI_opCMapAsync(c1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<I.OpCMapResult> opCMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.C> c1, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<I.OpCMapResult> _iceI_opCMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.Inner.Inner2.C> iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<I.OpCMapResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCMap", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, ostr -> {
                     test.Ice.scope.Test.Inner.Inner2.CMapHelper.write(ostr, iceP_c1);
                     ostr.writePendingValues();
                 }, istr -> {
