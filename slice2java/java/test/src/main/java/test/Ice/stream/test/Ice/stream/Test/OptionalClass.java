...
public class OptionalClass extends com.zeroc.Ice.Value {
    ...
    private java.lang.String[] stringSeq14;
    private boolean _stringSeq14;

    public java.lang.String[] getStringSeq14() {
        if (!_stringSeq14) {
    ...
    public void setStringSeq14(java.lang.String[] stringSeq14) {
        _stringSeq14 = true;
    ...
    public void optionalStringSeq14(java.util.Optional<java.lang.String[]> v) {
        if (v == null || !v.isPresent()) {
            _stringSeq14 = false;
        } else {
            _stringSeq14 = true;
    ...
    public java.util.Optional<java.lang.String[]> optionalStringSeq14() {
        if (_stringSeq14) {
    ...
    public java.lang.String getStringSeq14(int index) {
        if (!_stringSeq14) {
            throw new java.util.NoSuchElementException("stringSeq14 is not set");
        }
    ...
    public void setStringSeq14(int index, java.lang.String val) {
        if (!_stringSeq14) {
            throw new java.util.NoSuchElementException("stringSeq14 is not set");
        }
    ...
    /**
     * Constructs a {@code OptionalClass}.
     */
    ...
    /**
     * Constructs a {@code OptionalClass} with values for all fields not marked optional in the Slice definition for {@code ::Test::OptionalClass}.
     */
    ...
    /**
     * Constructs a {@code OptionalClass} with values for all its fields.
     */
    public OptionalClass(boolean bo, byte by, short sh, int i, LargeStruct s, MyEnum[] enumS4, java.util.Map<java.lang.Byte, java.lang.Boolean> byteBoolD6, java.util.Map<java.lang.Short, java.lang.Integer> shortIntD7, MyEnum enum8, int[] intSeq12, byte[] byteSeq13, java.lang.String[] stringSeq14, Point p15) {
        this.bo = bo;
        this.by = by;
        setSh(sh);
        setI(i);
    ...
    private static final long serialVersionUID = 6513074457321551519L;
}
