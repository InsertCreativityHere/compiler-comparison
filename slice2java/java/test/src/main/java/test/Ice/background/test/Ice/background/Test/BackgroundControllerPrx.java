...
public interface BackgroundControllerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void initializeSocketStatus(int status, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> initializeSocketStatusAsync(int status, java.util.Map<String, String> context)
    {
        return _iceI_initializeSocketStatusAsync(status, context, false);
    }

    /**
     * Invokes the initializeSocketStatus operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
