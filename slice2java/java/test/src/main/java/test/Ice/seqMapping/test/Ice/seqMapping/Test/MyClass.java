...
public interface MyClass extends com.zeroc.Ice.Object {
    ...
    public static class OpSerialSmallJavaResult {
        ...
        /**
         * Marshals the result for the opSerialSmallJava operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeSerializable(this.o);
            ostr.writeSerializable(this.returnValue);
        }

        /**
         * Unmarshals the result of the opSerialSmallJava operation.
        ...
        public void read(com.zeroc.Ice.InputStream istr) {
            ...
            this.returnValue = istr.readSerializable(test.Ice.seqMapping.Serialize.Small.class);
        }
    }
    ...
    public static class OpSerialLargeJavaResult {
        ...
        /**
         * Marshals the result for the opSerialLargeJava operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeSerializable(this.o);
        ...
        /**
         * Unmarshals the result of the opSerialLargeJava operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = istr.readSerializable(test.Ice.seqMapping.Serialize.Large.class);
            this.returnValue = istr.readSerializable(test.Ice.seqMapping.Serialize.Large.class);
        }
    }
    ...
    public static class OpSerialStructJavaResult {
        ...
        /**
         * Marshals the result for the opSerialStructJava operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeSerializable(this.o);
        ...
        /**
         * Unmarshals the result of the opSerialStructJava operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = istr.readSerializable(test.Ice.seqMapping.Serialize.Struct.class);
            this.returnValue = istr.readSerializable(test.Ice.seqMapping.Serialize.Struct.class);
        }
    }
    ...
    /**
     * Dispatches the operation opSerialSmallJava.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opSerialLargeJava.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opSerialStructJava.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
