...
public final class IntVarStructDictHelper {
    /**
     * Marshals a dictionary of {@code IntVarStructDict} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code IntVarStructDict} from an input stream.
     *
    ...
    public static java.util.Map<java.lang.Integer, VarStruct> read(com.zeroc.Ice.InputStream istr) {
        ...
        v = new java.util.HashMap<java.lang.Integer, test.Ice.optional.Test.VarStruct>();
    ...
    /**
     * Marshals an optional dictionary of {@code IntVarStructDict} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code IntVarStructDict} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
