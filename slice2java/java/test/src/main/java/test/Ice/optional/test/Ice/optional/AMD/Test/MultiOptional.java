...
public class MultiOptional extends com.zeroc.Ice.Value {
     ...
     */
    public MultiOptional(byte a, boolean b, short c, int d, long e, float f, double g, java.lang.String h, MyEnum i, MyInterfacePrx j, byte[] bs, java.lang.String[] ss, java.util.Map<java.lang.Integer, java.lang.Integer> iid, java.util.Map<java.lang.String, java.lang.Integer> sid, FixedStruct fs, VarStruct vs, short[] shs, MyEnum[] es, FixedStruct[] fss, VarStruct[] vss, MyInterfacePrx[] mips, java.util.Map<java.lang.Integer, MyEnum> ied, java.util.Map<java.lang.Integer, FixedStruct> ifsd, java.util.Map<java.lang.Integer, VarStruct> ivsd, java.util.Map<java.lang.Integer, MyInterfacePrx> imipd, boolean[] bos, test.Ice.optional.SerializableClass ser) {
        setA(a);
        setB(b);
        setC(c);
        setD(d);
    ...
    private static final long serialVersionUID = 5272697061574490112L;
}
