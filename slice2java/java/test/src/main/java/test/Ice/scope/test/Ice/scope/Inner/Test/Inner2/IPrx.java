...
public interface IPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpSResult> _iceI_opSAsync(test.Ice.scope.Test.S iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpSSeqResult> _iceI_opSSeqAsync(test.Ice.scope.Test.S[] iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpSMapResult> _iceI_opSMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.S> iceP_s1, java.util.Map<String, String> context, boolean sync)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpCResult> _iceI_opCAsync(test.Ice.scope.Test.C iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpCSeqResult> _iceI_opCSeqAsync(test.Ice.scope.Test.C[] iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<I.OpCMapResult> _iceI_opCMapAsync(java.util.Map<java.lang.String, test.Ice.scope.Test.C> iceP_c1, java.util.Map<String, String> context, boolean sync)
    {
