...
public final class SLSDHelper {
    /**
     * Marshals a dictionary of {@code SLSD} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code SLSD} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code SLSD} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code SLSD} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
