...
public final class LongLongSDHelper {
    /**
     * Marshals a dictionary of {@code LongLongSD} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code LongLongSD} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code LongLongSD} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code LongLongSD} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
