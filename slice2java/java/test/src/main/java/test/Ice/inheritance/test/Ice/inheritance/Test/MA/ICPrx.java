...
public interface ICPrx extends test.Ice.inheritance.Test.MB.IB1Prx, test.Ice.inheritance.Test.MB.IB2Prx {
    default ICPrx icop(ICPrx p) {
        return icop(p, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default ICPrx icop(ICPrx p, java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<ICPrx> icopAsync(ICPrx p, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_icopAsync(p, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<ICPrx> _iceI_icopAsync(ICPrx iceP_p, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<ICPrx> f = new com.zeroc.Ice.OutgoingAsync<>(this, "icop", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    static ICPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ICPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ICPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ICPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static ICPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _ICPrxI(obj.ice_facet(facet));
    }

    @Override
    ICPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    ICPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    ICPrx ice_connectionId(java.lang.String connectionId);
