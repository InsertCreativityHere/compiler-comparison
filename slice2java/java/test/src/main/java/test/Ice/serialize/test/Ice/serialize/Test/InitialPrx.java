...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default byte[] getStruct1(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<byte[]> getStruct1Async(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getStruct1Async(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<byte[]> _iceI_getStruct1Async(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<byte[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getStruct1", com.zeroc.Ice.OperationMode.Normal, sync, null);
    ...
    default byte[] getBase(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<byte[]> getBaseAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getBaseAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<byte[]> _iceI_getBaseAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<byte[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getBase", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     byte[] ret;
                     ret = istr.readByteSeq();
                     return ret;
    ...
    default byte[] getEx(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<byte[]> getExAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getExAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<byte[]> _iceI_getExAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<byte[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getEx", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     byte[] ret;
                     ret = istr.readByteSeq();
                     return ret;
