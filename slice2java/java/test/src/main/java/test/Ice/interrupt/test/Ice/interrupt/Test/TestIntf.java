...
public interface TestIntf extends com.zeroc.Ice.Object {
     ...
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opIdempotent(TestIntf obj, com.zeroc.Ice.IncomingRequest request) {
        request.inputStream.skipEmptyEncapsulation();
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            ...
            case "opIdempotent" -> TestIntf._iceD_opIdempotent(this, request);
