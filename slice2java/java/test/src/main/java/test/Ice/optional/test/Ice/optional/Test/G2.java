...
public final class G2 implements java.lang.Cloneable, java.io.Serializable {
    public long a;

    /**
     * Constructs a {@code G2}.
     */
    public G2() {
    }

    /**
     * Constructs a {@code G2} with values for all fields not marked optional in the Slice definition for {@code ::Test::G2}.
     */
    public G2(long a) {
        this.a = a;
    }
    ...
    /**
     * Marshals a {@code G2} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code G2} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code G2} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code G2}
     */
    ...
    /**
     * Marshals an optional {@code G2} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code G2} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = 4781665932157192323L;
}
