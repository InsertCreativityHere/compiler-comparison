...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default ConcreteClass getConcreteClass(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<ConcreteClass> getConcreteClassAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getConcreteClassAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<ConcreteClass> _iceI_getConcreteClassAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<ConcreteClass> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getConcreteClass", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     final com.zeroc.Ice.Holder<ConcreteClass> ret = new com.zeroc.Ice.Holder<>();
    ...
    default void throwException(java.util.Map<java.lang.String, java.lang.String> context)
        throws E {
        try {
    ...
    default java.util.concurrent.CompletableFuture<Void> throwExceptionAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_throwExceptionAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_throwExceptionAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "throwException", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_throwException);
        f.invoke(true, context, null, null, null);
        return f;
    }

    /** @hidden */
    static final java.lang.Class<?>[] _iceE_throwException = {
        E.class
    };
