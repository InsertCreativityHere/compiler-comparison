...
public final class ColorPalette implements java.lang.Cloneable, java.io.Serializable {
    public java.util.Map<java.lang.Integer, Color> colors;

    /**
     * Constructs a {@code ColorPalette}.
     */
    public ColorPalette() {
    }

    /**
     * Constructs a {@code ColorPalette} with values for all fields not marked optional in the Slice definition for {@code ::Test::ColorPalette}.
     */
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code ColorPalette}
     */
    ...
    private static final long serialVersionUID = -3961469237207046085L;
}
