...
public interface TestIntf extends com.zeroc.Ice.Object {
    void transientOp(com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation transientOp.
     *
     ...
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_transientOp(TestIntf obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        request.inputStream.skipEmptyEncapsulation();
        obj.transientOp(request.current);
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            case "transient" -> TestIntf._iceD_transientOp(this, request);
