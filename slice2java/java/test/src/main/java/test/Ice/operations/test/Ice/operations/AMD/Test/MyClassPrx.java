...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opDoubleMarshaling", null, sync, null);
        f.invoke(false, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<String[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opWStringLiterals", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     String[] ret;
                     ret = istr.readStringSeq();
                     return ret;
