...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the opDoubleMarshaling operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_p1 parameter
     * @param iceP_p2 parameter
     * @param context the request context
    ...
    /**
     * Invokes the opWStringLiterals operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
