...
public final class LargeStruct implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public LargeStruct(boolean bo, byte by, short sh, int i, long l, float f, double d, java.lang.String str, MyEnum e, MyInterfacePrx p, test.Ice.stream.Serialize.Small ss) {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
        this.i = i;
    ...
    private static final long serialVersionUID = 7008977280828436738L;
}
