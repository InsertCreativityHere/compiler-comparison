...
public final class VarStruct implements java.lang.Cloneable, java.io.Serializable {
    public java.lang.String m;

    /**
     * Constructs a {@code VarStruct}.
     */
    public VarStruct() {
        this.m = "";
    }
    ...
    /**
     * Constructs a {@code VarStruct} with values for all fields not marked optional in the Slice definition for {@code ::Test::VarStruct}.
     */
    public VarStruct(java.lang.String m) {
        this.m = m;
    }
    ...
    /**
     * Marshals a {@code VarStruct} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code VarStruct} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code VarStruct} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code VarStruct}
     */
    ...
    /**
     * Marshals an optional {@code VarStruct} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code VarStruct} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = -7242126792192475825L;
}
