...
public class Derived extends Base {
     ...
     */
    public Derived(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, java.lang.String noDefault, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD, Color c1, Color c2, Color c3, test.Ice.defaultValue.Test.Nested.Color nc1, test.Ice.defaultValue.Test.Nested.Color nc2, test.Ice.defaultValue.Test.Nested.Color nc3) {
    ...
    private static final long serialVersionUID = 5644214695977984049L;
}
