...
/**
 * Helper class for marshaling/unmarshaling escaped_goto.
 */
public final class escaped_gotoHelper {
    /**
     * Marshals a dictionary of {@code escaped_goto} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code escaped_goto} from an input stream.
     *
    ...
    public static java.util.Map<java.lang.String, _assert> read(com.zeroc.Ice.InputStream istr) {
        ...
        v = new java.util.HashMap<java.lang.String, test.escaped_abstract._assert>();
    ...
    /**
     * Marshals an optional dictionary of {@code escaped_goto} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Map<java.lang.String, _assert> v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            escaped_gotoHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional dictionary of {@code escaped_goto} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
    ...
    public static java.util.Optional<java.util.Map<java.lang.String, _assert>> read(com.zeroc.Ice.InputStream istr, int tag) {
        if (istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            istr.skip(4);
            java.util.Map<java.lang.String, _assert> v;
            v = escaped_gotoHelper.read(istr);
