...
public final class S2 implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public S2(boolean bo, byte by, short sh, int i, long l, float f, double d, java.lang.String str, java.lang.String[] ss, java.util.List<java.lang.Integer> il, java.util.Map<java.lang.String, java.lang.String> sd, S1 s, C cls, com.zeroc.Ice.ObjectPrx prx) {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
        this.i = i;
    ...
    private static final long serialVersionUID = -8061095923656754157L;
}
