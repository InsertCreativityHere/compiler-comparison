...
public final class StringDictHelper {
    /**
     * Marshals a dictionary of {@code StringDict} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code StringDict} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code StringDict} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code StringDict} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
