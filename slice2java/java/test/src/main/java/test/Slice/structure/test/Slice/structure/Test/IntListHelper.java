...
public final class IntListHelper {
    /**
     * Marshals a list of {@code IntList} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code IntList} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code IntList} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    /**
     * Unmarshals an optional list of {@code IntList} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
