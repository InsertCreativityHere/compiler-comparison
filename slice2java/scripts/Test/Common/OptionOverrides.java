...
public class OptionOverrides extends com.zeroc.Ice.Value {
    ...
    public void setProtocol(int index, java.lang.String val) {
        if (!_protocol) {
            throw new java.util.NoSuchElementException("protocol is not set");
        }
    ...
    /**
     * Constructs a {@code OptionOverrides}.
     */
    public OptionOverrides() {
    }

    /**
     * Constructs a {@code OptionOverrides} with values for all its fields.
     */
    public OptionOverrides(java.lang.String[] protocol, boolean[] mx, boolean[] serialize, boolean[] compress, boolean[] ipv6) {
    ...
    private static final long serialVersionUID = 5189595044483676866L;
}
