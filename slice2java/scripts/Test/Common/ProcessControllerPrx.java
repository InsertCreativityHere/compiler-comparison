...
public interface ProcessControllerPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default ProcessControllerPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (ProcessControllerPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_adapterId(String newAdapterId)
    {
        return (ProcessControllerPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (ProcessControllerPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (ProcessControllerPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_invocationTimeout(int newTimeout)
    {
        return (ProcessControllerPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_connectionCached(boolean newCache)
    {
        return (ProcessControllerPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (ProcessControllerPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_secure(boolean b)
    {
        return (ProcessControllerPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (ProcessControllerPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_preferSecure(boolean b)
    {
        return (ProcessControllerPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (ProcessControllerPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (ProcessControllerPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_collocationOptimized(boolean b)
    {
        return (ProcessControllerPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_twoway()
    {
        return (ProcessControllerPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_oneway()
    {
        return (ProcessControllerPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_batchOneway()
    {
        return (ProcessControllerPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_datagram()
    {
        return (ProcessControllerPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_batchDatagram()
    {
        return (ProcessControllerPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_compress(boolean co)
    {
        return (ProcessControllerPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_timeout(int t)
    {
        return (ProcessControllerPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_connectionId(String connectionId)
    {
        return (ProcessControllerPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default ProcessControllerPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (ProcessControllerPrx)_ice_fixed(connection);
    }
