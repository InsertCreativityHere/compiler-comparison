...
public class Config extends com.zeroc.Ice.Value {
    ...
    private java.lang.String[] cprops;
    private boolean _cprops;

    public java.lang.String[] getCprops() {
        if (!_cprops) {
    ...
    public void setCprops(java.lang.String[] cprops) {
        _cprops = true;
        this.cprops = cprops;
    }
    ...
    public void optionalCprops(java.util.Optional<java.lang.String[]> v) {
        if (v == null || !v.isPresent()) {
            _cprops = false;
        } else {
            _cprops = true;
    ...
    public java.util.Optional<java.lang.String[]> optionalCprops() {
        if (_cprops) {
    ...
    public java.lang.String getCprops(int index) {
        if (!_cprops) {
            throw new java.util.NoSuchElementException("cprops is not set");
        }
    ...
    public void setCprops(int index, java.lang.String val) {
        if (!_cprops) {
            throw new java.util.NoSuchElementException("cprops is not set");
        }
    ...
    private java.lang.String[] sprops;
    private boolean _sprops;

    public java.lang.String[] getSprops() {
        if (!_sprops) {
    ...
    public void setSprops(java.lang.String[] sprops) {
        _sprops = true;
        this.sprops = sprops;
    }
    ...
    public void optionalSprops(java.util.Optional<java.lang.String[]> v) {
        if (v == null || !v.isPresent()) {
            _sprops = false;
        } else {
            _sprops = true;
    ...
    public java.util.Optional<java.lang.String[]> optionalSprops() {
        if (_sprops) {
    ...
    public java.lang.String getSprops(int index) {
        if (!_sprops) {
            throw new java.util.NoSuchElementException("sprops is not set");
        }
    ...
    public void setSprops(int index, java.lang.String val) {
        if (!_sprops) {
            throw new java.util.NoSuchElementException("sprops is not set");
        }
    ...
    /**
     * Constructs a {@code Config} with values for all its fields.
     */
    public Config(java.lang.String protocol, boolean mx, boolean serialize, boolean compress, boolean ipv6, java.lang.String[] cprops, java.lang.String[] sprops) {
    ...
    private static final long serialVersionUID = 1961763271972917018L;
}
