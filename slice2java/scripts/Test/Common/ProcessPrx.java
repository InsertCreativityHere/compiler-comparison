...
public interface ProcessPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default void waitReady(int timeout, java.util.Map<java.lang.String, java.lang.String> context)
        throws ProcessFailedException {
        try {
    ...
    default java.util.concurrent.CompletableFuture<Void> waitReadyAsync(int timeout, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_waitReadyAsync(timeout, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_waitReadyAsync(int iceP_timeout, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "waitReady", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_waitReady);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_waitReady = {
    ...
    default int waitSuccess(int timeout, java.util.Map<java.lang.String, java.lang.String> context)
        throws ProcessFailedException {
        try {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> waitSuccessAsync(int timeout, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_waitSuccessAsync(timeout, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_waitSuccessAsync(int iceP_timeout, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<java.lang.Integer> f = new com.zeroc.Ice.OutgoingAsync<>(this, "waitSuccess", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_waitSuccess);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_timeout);
                 }, istr -> {
                     int ret;
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_waitSuccess = {
        ProcessFailedException.class
    };

    default java.lang.String terminate() {
        return terminate(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.lang.String terminate(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> terminateAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_terminateAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.String> _iceI_terminateAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<java.lang.String> f = new com.zeroc.Ice.OutgoingAsync<>(this, "terminate", com.zeroc.Ice.OperationMode.Normal, sync, null);
