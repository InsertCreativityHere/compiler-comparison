...
public final class StructNoDefaults implements java.lang.Cloneable, java.io.Serializable {
    public boolean bo;
    ...
    public Derived[] derivedSeq;

    public int[][] intSeqSeq;

    /**
     * Constructs a {@code StructNoDefaults}.
     */
    ...
    /**
     * Constructs a {@code StructNoDefaults} with values for all fields not marked optional in the Slice definition for {@code ::Test::StructNoDefaults}.
     */
    public StructNoDefaults(boolean bo, byte b, short s, int i, long l, float f, double d, java.lang.String str, Color c1, byte[] bs, int[] is, InnerStruct st, java.util.Map<java.lang.Integer, java.lang.String> dict, Derived[] derivedSeq, int[][] intSeqSeq) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
        ...
        this.st = st;
        this.dict = dict;
        this.derivedSeq = derivedSeq;
        this.intSeqSeq = intSeqSeq;
    }
    ...
    public boolean equals(java.lang.Object rhs) {
        ...
        if (r != null) {
            ...
            if (!java.util.Arrays.equals(this.derivedSeq, r.derivedSeq)) {
                return false;
            }
            if (!java.util.Arrays.equals(this.intSeqSeq, r.intSeqSeq)) {
                return false;
            }
    ...
    public int hashCode() {
        ...
        h_ = com.zeroc.Ice.HashUtil.hashAdd(h_, derivedSeq);
        h_ = com.zeroc.Ice.HashUtil.hashAdd(h_, intSeqSeq);
        return h_;
    }
    ...
    public void ice_writeMembers(com.zeroc.Ice.OutputStream ostr) {
        ...
        DerivedSeqHelper.write(ostr, this.derivedSeq);
        IntSeqSeqHelper.write(ostr, this.intSeqSeq);
    }
    ...
    public void ice_readMembers(com.zeroc.Ice.InputStream istr) {
        ...
        this.derivedSeq = DerivedSeqHelper.read(istr);
        this.intSeqSeq = IntSeqSeqHelper.read(istr);
    }
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code StructNoDefaults}
     */
    ...
    private static final long serialVersionUID = -4768369861046440896L;
}
