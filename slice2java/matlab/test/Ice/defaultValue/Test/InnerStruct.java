...
public final class InnerStruct implements java.lang.Cloneable, java.io.Serializable {
    public int a;

    /**
     * Constructs a {@code InnerStruct}.
     */
    public InnerStruct() {
    }

    /**
     * Constructs a {@code InnerStruct} with values for all fields not marked optional in the Slice definition for {@code ::Test::InnerStruct}.
     */
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code InnerStruct}
     */
    ...
    private static final long serialVersionUID = 8188286593442376703L;
}
