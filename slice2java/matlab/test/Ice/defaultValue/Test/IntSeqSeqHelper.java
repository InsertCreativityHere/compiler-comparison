...
/**
 * Helper class for marshaling/unmarshaling IntSeqSeq.
 */
public final class IntSeqSeqHelper {
    /**
     * Marshals a list of {@code IntSeqSeq} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code IntSeqSeq} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code IntSeqSeq} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, int[][] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            IntSeqSeqHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code IntSeqSeq} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
