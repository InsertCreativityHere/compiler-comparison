...
public final class S6 implements java.lang.Cloneable, java.io.Serializable {
    public java.util.Map<java.lang.Integer, S1> s1dict;

    /**
     * Constructs a {@code S6}.
     */
    public S6() {
    }

    /**
     * Constructs a {@code S6} with values for all fields not marked optional in the Slice definition for {@code ::LocalTest::S6}.
     */
    ...
    /**
     * Marshals a {@code S6} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code S6} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code S6} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code S6}
     */
    ...
    /**
     * Marshals an optional {@code S6} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code S6} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = 1471930943347521207L;
}
