...
public final class S8 implements java.lang.Cloneable, java.io.Serializable {
    public S1[][] s1seqseq;

    /**
     * Constructs a {@code S8}.
     */
    public S8() {
    }

    /**
     * Constructs a {@code S8} with values for all fields not marked optional in the Slice definition for {@code ::LocalTest::S8}.
     */
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code S8}
     */
    ...
    private static final long serialVersionUID = 2319481885059101751L;
}
