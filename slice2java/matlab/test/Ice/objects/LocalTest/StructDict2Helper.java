...
public final class StructDict2Helper {
    /**
     * Marshals a dictionary of {@code StructDict2} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code StructDict2} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code StructDict2} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code StructDict2} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
