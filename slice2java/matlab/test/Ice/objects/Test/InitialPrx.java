...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Test.Inner.A> _iceI_getInnerAAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Test.Inner.A> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getInnerA", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     final com.zeroc.IceInternal.Holder<Test.Inner.A> ret = new com.zeroc.IceInternal.Holder<>();
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Test.Inner.Sub.A> _iceI_getInnerSubAAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Test.Inner.Sub.A> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getInnerSubA", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     final com.zeroc.IceInternal.Holder<Test.Inner.Sub.A> ret = new com.zeroc.IceInternal.Holder<>();
