...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default Test.Inner.A getInnerA(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.Inner.A> getInnerAAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<Test.Inner.A> _iceI_getInnerAAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    default Test.Inner.Sub.A getInnerSubA(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.Inner.Sub.A> getInnerSubAAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.Ice.OutgoingAsync<Test.Inner.Sub.A> _iceI_getInnerSubAAsync(java.util.Map<String, String> context, boolean sync)
    {
