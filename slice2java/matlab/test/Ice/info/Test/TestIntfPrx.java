...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.Map<java.lang.String, java.lang.String> getEndpointInfoAsContext()
    {
        return getEndpointInfoAsContext(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.util.Map<java.lang.String, java.lang.String> getEndpointInfoAsContext(java.util.Map<String, String> context)
    {
        return _iceI_getEndpointInfoAsContextAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getEndpointInfoAsContextAsync()
    {
        return _iceI_getEndpointInfoAsContextAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getEndpointInfoAsContextAsync(java.util.Map<String, String> context)
    {
        return _iceI_getEndpointInfoAsContextAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> _iceI_getEndpointInfoAsContextAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getEndpointInfoAsContext", null, sync, null);
    ...
    default java.util.Map<java.lang.String, java.lang.String> getConnectionInfoAsContext()
    {
        return getConnectionInfoAsContext(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.util.Map<java.lang.String, java.lang.String> getConnectionInfoAsContext(java.util.Map<String, String> context)
    {
        return _iceI_getConnectionInfoAsContextAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getConnectionInfoAsContextAsync()
    {
        return _iceI_getConnectionInfoAsContextAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getConnectionInfoAsContextAsync(java.util.Map<String, String> context)
    {
        return _iceI_getConnectionInfoAsContextAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> _iceI_getConnectionInfoAsContextAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getConnectionInfoAsContext", null, sync, null);
        f.invoke(true, context, com.zeroc.Ice.FormatType.DefaultFormat, null, istr -> {
                     java.util.Map<java.lang.String, java.lang.String> ret;
                     ret = com.zeroc.Ice.ContextHelper.read(istr);
                     return ret;
