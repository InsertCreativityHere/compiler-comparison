...
public interface Initial2Prx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default Initial2Prx ice_context(java.util.Map<String, String> newContext)
    {
        return (Initial2Prx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_adapterId(String newAdapterId)
    {
        return (Initial2Prx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (Initial2Prx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_locatorCacheTimeout(int newTimeout)
    {
        return (Initial2Prx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_invocationTimeout(int newTimeout)
    {
        return (Initial2Prx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_connectionCached(boolean newCache)
    {
        return (Initial2Prx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (Initial2Prx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_secure(boolean b)
    {
        return (Initial2Prx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (Initial2Prx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_preferSecure(boolean b)
    {
        return (Initial2Prx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (Initial2Prx)_ice_router(router);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (Initial2Prx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_collocationOptimized(boolean b)
    {
        return (Initial2Prx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_twoway()
    {
        return (Initial2Prx)_ice_twoway();
    }
     ...
     **/
    @Override
    default Initial2Prx ice_oneway()
    {
        return (Initial2Prx)_ice_oneway();
    }
     ...
     **/
    @Override
    default Initial2Prx ice_batchOneway()
    {
        return (Initial2Prx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default Initial2Prx ice_datagram()
    {
        return (Initial2Prx)_ice_datagram();
    }
     ...
     **/
    @Override
    default Initial2Prx ice_batchDatagram()
    {
        return (Initial2Prx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default Initial2Prx ice_compress(boolean co)
    {
        return (Initial2Prx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_timeout(int t)
    {
        return (Initial2Prx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_connectionId(String connectionId)
    {
        return (Initial2Prx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default Initial2Prx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (Initial2Prx)_ice_fixed(connection);
    }
