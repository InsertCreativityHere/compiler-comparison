...
public interface TopicManager extends com.zeroc.Ice.Object
{
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        {
            case "create" -> TopicManager._iceD_create(this, in, current);
            case "retrieve" -> TopicManager._iceD_retrieve(this, in, current);
            case "retrieveAll" -> TopicManager._iceD_retrieveAll(this, in, current);
