...
public interface TopicManagerPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default TopicPrx create(java.lang.String name)
        throws TopicExists {
     ...
     * @throws com.zeroc.IceStorm.TopicExists Thrown when a topic with the same name already exists.
     */
    default TopicPrx create(java.lang.String name, java.util.Map<java.lang.String, java.lang.String> context)
        throws TopicExists {
        try {
     ...
     * @return A proxy to the new topic object. The returned proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<TopicPrx> createAsync(java.lang.String name) {
     ...
     * @return A proxy to the new topic object. The returned proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<TopicPrx> createAsync(java.lang.String name, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_createAsync(name, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<TopicPrx> _iceI_createAsync(java.lang.String iceP_name, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<TopicPrx> f = new com.zeroc.Ice.OutgoingAsync<>(this, "create", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_create);
     ...
     * @return A proxy to the topic object. The returned proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<TopicPrx> retrieveAsync(java.lang.String name) {
     ...
     * @return A proxy to the topic object. The returned proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<TopicPrx> retrieveAsync(java.lang.String name, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_retrieveAsync(name, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<TopicPrx> _iceI_retrieveAsync(java.lang.String iceP_name, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_retrieve = {
        NoSuchTopic.class
    };
     ...
     * @return A dictionary of string, topic proxy pairs.
     */
    default java.util.Map<java.lang.String, TopicPrx> retrieveAll(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A dictionary of string, topic proxy pairs.
     */
    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, TopicPrx>> retrieveAllAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_retrieveAllAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.util.Map<java.lang.String, TopicPrx>> _iceI_retrieveAllAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    static TopicManagerPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static TopicManagerPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _TopicManagerPrxI(obj.ice_facet(facet));
    }

    @Override
    TopicManagerPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    TopicManagerPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    TopicManagerPrx ice_connectionId(java.lang.String connectionId);
