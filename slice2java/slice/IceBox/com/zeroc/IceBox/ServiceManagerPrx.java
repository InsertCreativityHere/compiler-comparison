...
public interface ServiceManagerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the startService operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    /**
     * Invokes the stopService operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_service parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
    ...
    /**
     * Invokes the addObserver operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
