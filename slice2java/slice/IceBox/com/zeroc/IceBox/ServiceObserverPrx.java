...
public interface ServiceObserverPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default void servicesStarted(java.lang.String[] services) {
     ...
     */
    default void servicesStarted(java.lang.String[] services, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     */
    default java.util.concurrent.CompletableFuture<Void> servicesStartedAsync(java.lang.String[] services) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> servicesStartedAsync(java.lang.String[] services, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_servicesStartedAsync(services, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_servicesStartedAsync(java.lang.String[] iceP_services, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "servicesStarted", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    default void servicesStopped(java.lang.String[] services) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void servicesStopped(java.lang.String[] services, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> servicesStoppedAsync(java.lang.String[] services) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> servicesStoppedAsync(java.lang.String[] services, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_servicesStoppedAsync(services, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_servicesStoppedAsync(java.lang.String[] iceP_services, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "servicesStopped", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeStringSeq(iceP_services);
                 }, null);
        return f;
     ...
     */
    static ServiceObserverPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ServiceObserverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ServiceObserverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ServiceObserverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static ServiceObserverPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _ServiceObserverPrxI(obj.ice_facet(facet));
    }

    @Override
    ServiceObserverPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    ServiceObserverPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    ServiceObserverPrx ice_connectionId(java.lang.String connectionId);
