...
public interface PermissionsVerifierPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default java.util.concurrent.CompletableFuture<PermissionsVerifier.CheckPermissionsResult> checkPermissionsAsync(java.lang.String userId, java.lang.String password) {
     ...
     * @return A future that will be completed with an instance of PermissionsVerifier.CheckPermissionsResult.
     */
    default java.util.concurrent.CompletableFuture<PermissionsVerifier.CheckPermissionsResult> checkPermissionsAsync(java.lang.String userId, java.lang.String password, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_checkPermissionsAsync(userId, password, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<PermissionsVerifier.CheckPermissionsResult> _iceI_checkPermissionsAsync(java.lang.String iceP_userId, java.lang.String iceP_password, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_checkPermissions = {
     ...
     */
    static PermissionsVerifierPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static PermissionsVerifierPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static PermissionsVerifierPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static PermissionsVerifierPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static PermissionsVerifierPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _PermissionsVerifierPrxI(obj.ice_facet(facet));
    }

    @Override
    PermissionsVerifierPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    PermissionsVerifierPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    PermissionsVerifierPrx ice_connectionId(java.lang.String connectionId);
