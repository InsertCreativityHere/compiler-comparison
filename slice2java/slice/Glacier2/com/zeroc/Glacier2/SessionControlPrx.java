...
public interface SessionControlPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @return A proxy to a StringSet object. This proxy is never null.
     */
    default StringSetPrx categories(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to a StringSet object. This proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<StringSetPrx> categoriesAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_categoriesAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<StringSetPrx> _iceI_categoriesAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @return A proxy to StringSet object. This proxy is never null.
     */
    default StringSetPrx adapterIds(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to StringSet object. This proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<StringSetPrx> adapterIdsAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_adapterIdsAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<StringSetPrx> _iceI_adapterIdsAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @return A proxy to an IdentitySet object. This proxy is never null.
     */
    default IdentitySetPrx identities(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to an IdentitySet object. This proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<IdentitySetPrx> identitiesAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_identitiesAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<IdentitySetPrx> _iceI_identitiesAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    static SessionControlPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SessionControlPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SessionControlPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SessionControlPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static SessionControlPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _SessionControlPrxI(obj.ice_facet(facet));
    }

    @Override
    SessionControlPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    SessionControlPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    SessionControlPrx ice_connectionId(java.lang.String connectionId);
