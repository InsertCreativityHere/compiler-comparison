...
public interface SSLPermissionsVerifierPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<SSLPermissionsVerifier.AuthorizeResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "authorize", com.zeroc.Ice.OperationMode.Nonmutating, sync, _iceE_authorize);
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (SSLPermissionsVerifierPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_adapterId(String newAdapterId)
    {
        return (SSLPermissionsVerifierPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (SSLPermissionsVerifierPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (SSLPermissionsVerifierPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_invocationTimeout(int newTimeout)
    {
        return (SSLPermissionsVerifierPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_connectionCached(boolean newCache)
    {
        return (SSLPermissionsVerifierPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (SSLPermissionsVerifierPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_secure(boolean b)
    {
        return (SSLPermissionsVerifierPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (SSLPermissionsVerifierPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_preferSecure(boolean b)
    {
        return (SSLPermissionsVerifierPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (SSLPermissionsVerifierPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (SSLPermissionsVerifierPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_collocationOptimized(boolean b)
    {
        return (SSLPermissionsVerifierPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_twoway()
    {
        return (SSLPermissionsVerifierPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_oneway()
    {
        return (SSLPermissionsVerifierPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_batchOneway()
    {
        return (SSLPermissionsVerifierPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_datagram()
    {
        return (SSLPermissionsVerifierPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_batchDatagram()
    {
        return (SSLPermissionsVerifierPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_compress(boolean co)
    {
        return (SSLPermissionsVerifierPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_timeout(int t)
    {
        return (SSLPermissionsVerifierPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_connectionId(String connectionId)
    {
        return (SSLPermissionsVerifierPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default SSLPermissionsVerifierPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (SSLPermissionsVerifierPrx)_ice_fixed(connection);
    }
