...
public class RandomLoadBalancingPolicy extends LoadBalancingPolicy {
    /**
     * Constructs a {@code RandomLoadBalancingPolicy}.
     */
    ...
    /**
     * Constructs a {@code RandomLoadBalancingPolicy} with values for all its fields.
     *
     * @param nReplicas The number of replicas that will be used to gather the endpoints of a replica group.
     */
    public RandomLoadBalancingPolicy(java.lang.String nReplicas) {
        super(nReplicas);
    }
    ...
    private static final long serialVersionUID = -6960230600991845761L;
}
