 ...
 */
public final class NodeUpdateDescriptor implements java.lang.Cloneable, java.io.Serializable {
    /**
     ...
     */
    public java.lang.String[] removeServers;
    ...
    /**
     * Constructs a {@code NodeUpdateDescriptor}.
     */
    ...
    /**
     * Constructs a {@code NodeUpdateDescriptor} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::NodeUpdateDescriptor}.
     *
     ...
     */
    public NodeUpdateDescriptor(java.lang.String name, BoxedString description, java.util.Map<java.lang.String, java.lang.String> variables, java.lang.String[] removeVariables, java.util.Map<java.lang.String, PropertySetDescriptor> propertySets, java.lang.String[] removePropertySets, java.util.List<ServerInstanceDescriptor> serverInstances, java.util.List<ServerDescriptor> servers, java.lang.String[] removeServers, BoxedString loadFactor) {
        this.name = name;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code NodeUpdateDescriptor}
     */
    ...
    private static final long serialVersionUID = 3471281425155625359L;
}
