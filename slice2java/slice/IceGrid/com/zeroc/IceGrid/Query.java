...
public interface Query extends com.zeroc.Ice.Object {
     ...
     */
    com.zeroc.Ice.ObjectPrx findObjectByType(java.lang.String type, com.zeroc.Ice.Current current);
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    com.zeroc.Ice.ObjectPrx findObjectByTypeOnLeastLoadedNode(java.lang.String type, LoadSample sample, com.zeroc.Ice.Current current);
     ...
     */
    com.zeroc.Ice.ObjectPrx[] findAllObjectsByType(java.lang.String type, com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation findObjectByType.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation findObjectByTypeOnLeastLoadedNode.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation findAllObjectsByType.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation findAllReplicas.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
