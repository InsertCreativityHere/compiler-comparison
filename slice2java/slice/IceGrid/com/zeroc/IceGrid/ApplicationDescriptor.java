 ...
 */
public final class ApplicationDescriptor implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code ApplicationDescriptor}.
     */
    ...
    /**
     * Constructs a {@code ApplicationDescriptor} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::ApplicationDescriptor}.
     *
     ...
     */
    public ApplicationDescriptor(java.lang.String name, java.util.Map<java.lang.String, java.lang.String> variables, java.util.List<ReplicaGroupDescriptor> replicaGroups, java.util.Map<java.lang.String, TemplateDescriptor> serverTemplates, java.util.Map<java.lang.String, TemplateDescriptor> serviceTemplates, java.util.Map<java.lang.String, NodeDescriptor> nodes, DistributionDescriptor distrib, java.lang.String description, java.util.Map<java.lang.String, PropertySetDescriptor> propertySets) {
        this.name = name;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code ApplicationDescriptor}
     */
    ...
    private static final long serialVersionUID = 2993882907587546792L;
}
