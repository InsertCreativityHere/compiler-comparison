 ...
 */
public final class ServiceInstanceDescriptor implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code ServiceInstanceDescriptor}.
     */
    ...
    /**
     * Constructs a {@code ServiceInstanceDescriptor} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::ServiceInstanceDescriptor}.
     *
     * @param template The template used by this instance.
     * @param parameterValues The template parameter values.
     * @param descriptor The service definition if the instance isn't a template instance (i.e.: if the template attribute is empty).
     * @param propertySet The property set.
     */
    public ServiceInstanceDescriptor(java.lang.String template, java.util.Map<java.lang.String, java.lang.String> parameterValues, ServiceDescriptor descriptor, PropertySetDescriptor propertySet) {
    ...
    /**
     * Marshals a {@code ServiceInstanceDescriptor} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code ServiceInstanceDescriptor} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code ServiceInstanceDescriptor} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code ServiceInstanceDescriptor}
     */
    ...
    /**
     * Marshals an optional {@code ServiceInstanceDescriptor} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code ServiceInstanceDescriptor} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = -3963322944518631172L;
}
