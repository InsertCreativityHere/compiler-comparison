...
public interface ApplicationObserverPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the applicationInit operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    /**
     * Invokes the applicationAdded operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_serial parameter
    ...
    /**
     * Invokes the applicationRemoved operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_serial parameter
    ...
    /**
     * Invokes the applicationUpdated operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_serial parameter
     * @param iceP_desc parameter
     * @param context the request context
