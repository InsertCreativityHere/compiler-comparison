...
public interface FileParserPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default ApplicationDescriptor parse(java.lang.String xmlFile, AdminPrx adminProxy)
     ...
     * @throws com.zeroc.IceGrid.ParseException Thrown when an error occurs during parsing.
     */
    default ApplicationDescriptor parse(java.lang.String xmlFile, AdminPrx adminProxy, java.util.Map<java.lang.String, java.lang.String> context)
        throws ParseException {
        try {
     ...
     * @return The application descriptor.
     */
    default java.util.concurrent.CompletableFuture<ApplicationDescriptor> parseAsync(java.lang.String xmlFile, AdminPrx adminProxy) {
     ...
     * @return The application descriptor.
     */
    default java.util.concurrent.CompletableFuture<ApplicationDescriptor> parseAsync(java.lang.String xmlFile, AdminPrx adminProxy, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_parseAsync(xmlFile, adminProxy, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<ApplicationDescriptor> _iceI_parseAsync(java.lang.String iceP_xmlFile, AdminPrx iceP_adminProxy, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_parse = {
     ...
     */
    static FileParserPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileParserPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileParserPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileParserPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static FileParserPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _FileParserPrxI(obj.ice_facet(facet));
    }

    @Override
    FileParserPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    FileParserPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    FileParserPrx ice_connectionId(java.lang.String connectionId);
