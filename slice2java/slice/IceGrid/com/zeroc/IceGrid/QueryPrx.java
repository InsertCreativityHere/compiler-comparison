...
public interface QueryPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default com.zeroc.Ice.ObjectPrx findObjectById(com.zeroc.Ice.Identity id, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> findObjectByIdAsync(com.zeroc.Ice.Identity id, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_findObjectByIdAsync(id, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx> _iceI_findObjectByIdAsync(com.zeroc.Ice.Identity iceP_id, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default com.zeroc.Ice.ObjectPrx findObjectByType(java.lang.String type) {
     ...
     * @return A proxy to a well-known object with the specified type, or null if no such object is registered.
     */
    default com.zeroc.Ice.ObjectPrx findObjectByType(java.lang.String type, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to a well-known object with the specified type, or null if no such object is registered.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> findObjectByTypeAsync(java.lang.String type) {
     ...
     * @return A proxy to a well-known object with the specified type, or null if no such object is registered.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> findObjectByTypeAsync(java.lang.String type, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_findObjectByTypeAsync(type, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx> _iceI_findObjectByTypeAsync(java.lang.String iceP_type, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default com.zeroc.Ice.ObjectPrx findObjectByTypeOnLeastLoadedNode(java.lang.String type, LoadSample sample) {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default com.zeroc.Ice.ObjectPrx findObjectByTypeOnLeastLoadedNode(java.lang.String type, LoadSample sample, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> findObjectByTypeOnLeastLoadedNodeAsync(java.lang.String type, LoadSample sample) {
     ...
     * @return A proxy to the well-known object, or null if no such object is registered.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> findObjectByTypeOnLeastLoadedNodeAsync(java.lang.String type, LoadSample sample, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_findObjectByTypeOnLeastLoadedNodeAsync(type, sample, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx> _iceI_findObjectByTypeOnLeastLoadedNodeAsync(java.lang.String iceP_type, LoadSample iceP_sample, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default com.zeroc.Ice.ObjectPrx[] findAllObjectsByType(java.lang.String type) {
     ...
     * @return A list of proxies to the well-known objects with the specified type. Can be empty.
     */
    default com.zeroc.Ice.ObjectPrx[] findAllObjectsByType(java.lang.String type, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A list of proxies to the well-known objects with the specified type. Can be empty.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx[]> findAllObjectsByTypeAsync(java.lang.String type) {
     ...
     * @return A list of proxies to the well-known objects with the specified type. Can be empty.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx[]> findAllObjectsByTypeAsync(java.lang.String type, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_findAllObjectsByTypeAsync(type, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx[]> _iceI_findAllObjectsByTypeAsync(java.lang.String iceP_type, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx[]> _iceI_findAllReplicasAsync(com.zeroc.Ice.ObjectPrx iceP_proxy, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    static QueryPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static QueryPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static QueryPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static QueryPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static QueryPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _QueryPrxI(obj.ice_facet(facet));
    }

    @Override
    QueryPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    QueryPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    QueryPrx ice_connectionId(java.lang.String connectionId);
