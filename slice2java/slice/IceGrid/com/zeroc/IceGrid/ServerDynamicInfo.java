 ...
 */
public final class ServerDynamicInfo implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code ServerDynamicInfo}.
     */
    ...
    /**
     * Constructs a {@code ServerDynamicInfo} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::ServerDynamicInfo}.
     *
     ...
     */
    public ServerDynamicInfo(java.lang.String id, ServerState state, int pid, boolean enabled) {
        this.id = id;
        this.state = state;
        this.pid = pid;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code ServerDynamicInfo}
     */
    ...
    private static final long serialVersionUID = 3581378330427815070L;
}
