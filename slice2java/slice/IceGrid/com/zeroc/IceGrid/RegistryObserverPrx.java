...
public interface RegistryObserverPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the registryInit operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param iceP_registries parameter
    ...
    /**
     * Invokes the registryUp operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param iceP_registryReplica parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
    ...
    /**
     * Invokes the registryDown operation with the given parameters on this proxy and returns a future that will be completed with the result.
