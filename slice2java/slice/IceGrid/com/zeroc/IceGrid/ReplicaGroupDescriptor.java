 ...
 */
public final class ReplicaGroupDescriptor implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code ReplicaGroupDescriptor}.
     */
    ...
    /**
     * Constructs a {@code ReplicaGroupDescriptor} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::ReplicaGroupDescriptor}.
     *
     ...
     */
    public ReplicaGroupDescriptor(java.lang.String id, LoadBalancingPolicy loadBalancing, java.lang.String proxyOptions, java.util.List<ObjectDescriptor> objects, java.lang.String description, java.lang.String filter) {
        this.id = id;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code ReplicaGroupDescriptor}
     */
    ...
    private static final long serialVersionUID = -5408510409134524464L;
}
