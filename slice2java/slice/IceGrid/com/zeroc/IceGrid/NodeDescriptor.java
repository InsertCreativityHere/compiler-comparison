 ...
 */
public final class NodeDescriptor implements java.lang.Cloneable, java.io.Serializable {
    /**
     ...
     */
    public java.lang.String loadFactor;
    ...
    /**
     * Constructs a {@code NodeDescriptor}.
     */
    ...
    /**
     * Constructs a {@code NodeDescriptor} with values for all fields not marked optional in the Slice definition for {@code ::IceGrid::NodeDescriptor}.
     *
     * @param variables The variables defined for the node.
     * @param serverInstances The server instances (template instances).
     * @param servers Servers that are not template instances.
     * @param loadFactor Load factor of the node.
     * @param description The description of this node.
     * @param propertySets Property set descriptors.
     */
    public NodeDescriptor(java.util.Map<java.lang.String, java.lang.String> variables, java.util.List<ServerInstanceDescriptor> serverInstances, java.util.List<ServerDescriptor> servers, java.lang.String loadFactor, java.lang.String description, java.util.Map<java.lang.String, PropertySetDescriptor> propertySets) {
    ...
    /**
     * Marshals a {@code NodeDescriptor} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code NodeDescriptor} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code NodeDescriptor} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code NodeDescriptor}
     */
    ...
    /**
     * Marshals an optional {@code NodeDescriptor} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code NodeDescriptor} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = 6622627365173294636L;
}
