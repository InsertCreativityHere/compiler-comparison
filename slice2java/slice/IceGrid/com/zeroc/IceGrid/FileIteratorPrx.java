...
public interface FileIteratorPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @throws com.zeroc.IceGrid.FileNotAvailableException Thrown when the implementation failed to read from the file.
     */
    default FileIterator.ReadResult read(int size, java.util.Map<java.lang.String, java.lang.String> context)
        throws FileNotAvailableException {
        try {
     ...
     * @return A future that will be completed with an instance of FileIterator.ReadResult.
     */
    default java.util.concurrent.CompletableFuture<FileIterator.ReadResult> readAsync(int size, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_readAsync(size, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<FileIterator.ReadResult> _iceI_readAsync(int iceP_size, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<FileIterator.ReadResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "read", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_read);
     ...
     */
    static FileIteratorPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileIteratorPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileIteratorPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileIteratorPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static FileIteratorPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _FileIteratorPrxI(obj.ice_facet(facet));
    }

    @Override
    FileIteratorPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    FileIteratorPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    FileIteratorPrx ice_connectionId(java.lang.String connectionId);
