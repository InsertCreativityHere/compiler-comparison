...
public interface LookupReplyPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the foundObjectById operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    /**
     * Invokes the foundAdapterById operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_id parameter
     * @param iceP_prx parameter
