...
public final class MetricsViewHelper
{
    public static void write(com.zeroc.Ice.OutputStream ostr, java.util.Map<java.lang.String, Metrics[]> v)
    {
        ...
        else
        {
            ...
            for(java.util.Map.Entry<java.lang.String, Metrics[]> e : v.entrySet())
            {
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Optional<java.util.Map<java.lang.String, Metrics[]>> v)
    {
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Map<java.lang.String, Metrics[]> v)
    {
    ...
    public static java.util.Optional<java.util.Map<java.lang.String, Metrics[]>> read(com.zeroc.Ice.InputStream istr, int tag)
    {
