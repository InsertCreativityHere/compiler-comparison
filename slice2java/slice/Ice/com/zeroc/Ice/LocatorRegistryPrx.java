...
public interface LocatorRegistryPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the setAdapterDirectProxy operation with the given parameters on this proxy and returns a future that will be completed with the result.
    ...
    /**
     * Invokes the setReplicatedAdapterDirectProxy operation with the given parameters on this proxy and returns a future that will be completed with the result.
    ...
    /**
     * Invokes the setServerProcessProxy operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param iceP_id parameter
     * @param iceP_proxy parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
