...
public interface RouterFinderPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @return The router proxy. This proxy is never null.
     */
    default RouterPrx getRouter(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return The router proxy. This proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<RouterPrx> getRouterAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getRouterAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<RouterPrx> _iceI_getRouterAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<RouterPrx> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getRouter", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    static RouterFinderPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static RouterFinderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static RouterFinderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static RouterFinderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static RouterFinderPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _RouterFinderPrxI(obj.ice_facet(facet));
    }

    @Override
    RouterFinderPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    RouterFinderPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    RouterFinderPrx ice_connectionId(java.lang.String connectionId);
