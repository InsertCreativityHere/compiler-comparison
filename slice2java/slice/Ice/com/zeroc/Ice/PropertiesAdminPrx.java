...
public interface PropertiesAdminPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the getPropertiesForPrefix operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    /**
     * Invokes the setProperties operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
