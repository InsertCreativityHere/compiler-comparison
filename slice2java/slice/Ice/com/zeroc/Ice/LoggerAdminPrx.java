...
public interface LoggerAdminPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the attachRemoteLogger operation with the given parameters on this proxy and returns a future that will be completed with the result.
    ...
    /**
     * Invokes the detachRemoteLogger operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param iceP_prx parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
    ...
    /**
     * Invokes the getLog operation with the given parameters on this proxy and returns a future that will be completed with the result.
     * @param iceP_messageTypes parameter
     * @param iceP_traceCategories parameter
     * @param iceP_messageMax parameter
     * @param context the request context
