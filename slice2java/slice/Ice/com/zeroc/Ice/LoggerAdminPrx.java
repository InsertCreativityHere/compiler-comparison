...
public interface LoggerAdminPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * object.
     */
    default void attachRemoteLogger(RemoteLoggerPrx prx, LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax)
     ...
     * object.
     */
    default void attachRemoteLogger(RemoteLoggerPrx prx, LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax, java.util.Map<java.lang.String, java.lang.String> context)
        throws RemoteLoggerAlreadyAttachedException {
        try {
     ...
     */
    default java.util.concurrent.CompletableFuture<Void> attachRemoteLoggerAsync(RemoteLoggerPrx prx, LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> attachRemoteLoggerAsync(RemoteLoggerPrx prx, LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_attachRemoteLoggerAsync(prx, messageTypes, traceCategories, messageMax, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_attachRemoteLoggerAsync(RemoteLoggerPrx iceP_prx, LogMessageType[] iceP_messageTypes, java.lang.String[] iceP_traceCategories, int iceP_messageMax, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "attachRemoteLogger", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_attachRemoteLogger);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_attachRemoteLogger = {
    ...
    private com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> _iceI_detachRemoteLoggerAsync(RemoteLoggerPrx iceP_prx, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.Ice.OutgoingAsync<>(this, "detachRemoteLogger", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeProxy(iceP_prx);
                 }, istr -> {
                     boolean ret;
     ...
     */
    default LoggerAdmin.GetLogResult getLog(LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax) {
     ...
     * @return An instance of LoggerAdmin.GetLogResult.
     */
    default LoggerAdmin.GetLogResult getLog(LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     */
    default java.util.concurrent.CompletableFuture<LoggerAdmin.GetLogResult> getLogAsync(LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax) {
     ...
     * @return A future that will be completed with an instance of LoggerAdmin.GetLogResult.
     */
    default java.util.concurrent.CompletableFuture<LoggerAdmin.GetLogResult> getLogAsync(LogMessageType[] messageTypes, java.lang.String[] traceCategories, int messageMax, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getLogAsync(messageTypes, traceCategories, messageMax, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<LoggerAdmin.GetLogResult> _iceI_getLogAsync(LogMessageType[] iceP_messageTypes, java.lang.String[] iceP_traceCategories, int iceP_messageMax, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<LoggerAdmin.GetLogResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getLog", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     LogMessageTypeSeqHelper.write(ostr, iceP_messageTypes);
                     ostr.writeStringSeq(iceP_traceCategories);
                     ostr.writeInt(iceP_messageMax);
     ...
     */
    static LoggerAdminPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static LoggerAdminPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
        return (obj != null && obj.ice_isA(ice_staticId(), context)) ? new _LoggerAdminPrxI(obj) : null;
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static LoggerAdminPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static LoggerAdminPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static LoggerAdminPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _LoggerAdminPrxI(obj.ice_facet(facet));
    }

    @Override
    LoggerAdminPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    LoggerAdminPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    LoggerAdminPrx ice_connectionId(java.lang.String connectionId);
