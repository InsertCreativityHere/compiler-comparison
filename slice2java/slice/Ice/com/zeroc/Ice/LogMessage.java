 ...
 */
public final class LogMessage implements java.lang.Cloneable, java.io.Serializable {
    /**
     * The type of message sent to the {@link com.zeroc.Ice.RemoteLoggerPrx}.
     */
    public LogMessageType type;

    /**
     * The date and time when the {@link com.zeroc.Ice.RemoteLoggerPrx} received this message, expressed as the number of
     ...
     */
    public java.lang.String traceCategory;
    ...
    /**
     * Constructs a {@code LogMessage} with values for all fields not marked optional in the Slice definition for {@code ::Ice::LogMessage}.
     *
     ...
     */
    public LogMessage(LogMessageType type, long timestamp, java.lang.String traceCategory, java.lang.String message) {
        this.type = type;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code LogMessage}
     */
    ...
    private static final long serialVersionUID = 1334869107391016468L;
}
