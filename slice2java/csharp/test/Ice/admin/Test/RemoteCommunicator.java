...
public interface RemoteCommunicator extends com.zeroc.Ice.Object
{
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        {
            case "getAdmin" -> RemoteCommunicator._iceD_getAdmin(this, in, current);
            case "getChanges" -> RemoteCommunicator._iceD_getChanges(this, in, current);
            case "print" -> RemoteCommunicator._iceD_print(this, in, current);
            case "trace" -> RemoteCommunicator._iceD_trace(this, in, current);
            case "warning" -> RemoteCommunicator._iceD_warning(this, in, current);
            case "error" -> RemoteCommunicator._iceD_error(this, in, current);
            case "shutdown" -> RemoteCommunicator._iceD_shutdown(this, in, current);
            case "waitForShutdown" -> RemoteCommunicator._iceD_waitForShutdown(this, in, current);
