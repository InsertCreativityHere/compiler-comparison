...
public class OptionalEx0 extends com.zeroc.Ice.UserException
{
    public OptionalEx0()
    {
        this.firstName = "";
    ...
    public OptionalEx0(Throwable cause)
    {
        super(cause);
        this.firstName = "";
        this.secondName = "";
    ...
    public OptionalEx0(String firstName)
    {
    ...
    public OptionalEx0(String firstName, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        this.secondName = "";
    ...
    public OptionalEx0(String firstName, String secondName, String emailAddress)
    {
        this.firstName = firstName;
    ...
    public OptionalEx0(String firstName, String secondName, String emailAddress, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        setSecondName(secondName);
    ...
    /** @hidden */
    public static final long serialVersionUID = -2547528953350900663L;
}
