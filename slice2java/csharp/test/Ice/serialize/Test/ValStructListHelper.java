...
/**
 * Helper class for marshaling/unmarshaling ValStructList.
 **/
public final class ValStructListHelper
{
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, ValStruct[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            ValStructListHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }
    ...
    public static java.util.Optional<ValStruct[]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            ValStruct[] v;
            v = ValStructListHelper.read(istr);
