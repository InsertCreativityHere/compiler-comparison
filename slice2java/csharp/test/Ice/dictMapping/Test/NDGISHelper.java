...
/**
 * Helper class for marshaling/unmarshaling NDGIS.
 */
public final class NDGISHelper {
    /**
     * Marshals a dictionary of {@code NDGIS} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code NDGIS} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code NDGIS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Map<java.lang.String, int[]> v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            NDGISHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional dictionary of {@code NDGIS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
