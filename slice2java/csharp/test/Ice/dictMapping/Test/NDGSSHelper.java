...
public final class NDGSSHelper {
    /**
     * Marshals a dictionary of {@code NDGSS} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code NDGSS} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code NDGSS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Map<java.lang.String, java.lang.String[]> v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            NDGSSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional dictionary of {@code NDGSS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
