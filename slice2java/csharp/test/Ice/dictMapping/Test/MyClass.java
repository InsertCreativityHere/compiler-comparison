...
public interface MyClass extends com.zeroc.Ice.Object {
    ...
    public static class OpNRResult {
        ...
        /**
         * Marshals the result for the opNR operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NRHelper.write(ostr, this.o);
            NRHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNR operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NRHelper.read(istr);
            this.returnValue = NRHelper.read(istr);
        }
    }
    ...
    public static class OpNDVResult {
        ...
        /**
         * Marshals the result for the opNDV operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDVHelper.write(ostr, this.o);
            NDVHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDV operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDVHelper.read(istr);
            this.returnValue = NDVHelper.read(istr);
        }
    }
    ...
    public static class OpNDRResult {
        ...
        /**
         * Marshals the result for the opNDR operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDRHelper.write(ostr, this.o);
            NDRHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDR operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDRHelper.read(istr);
            this.returnValue = NDRHelper.read(istr);
        }
    }
    ...
    public static class OpNDAISResult {
        ...
        /**
         * Marshals the result for the opNDAIS operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDAISHelper.write(ostr, this.o);
            NDAISHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDAIS operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDAISHelper.read(istr);
            this.returnValue = NDAISHelper.read(istr);
        }
    }
    ...
    public static class OpNDGISResult {
        ...
        /**
         * Marshals the result for the opNDGIS operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDGISHelper.write(ostr, this.o);
            NDGISHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDGIS operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDGISHelper.read(istr);
            this.returnValue = NDGISHelper.read(istr);
        }
    }
    ...
    public static class OpNDASSResult {
        ...
        public OpNDASSResult(java.util.Map<java.lang.String, java.lang.String[]> returnValue, java.util.Map<java.lang.String, java.lang.String[]> o) {
            this.returnValue = returnValue;
            this.o = o;
        }

        /**
         * Marshals the result for the opNDASS operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDASSHelper.write(ostr, this.o);
            NDASSHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDASS operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDASSHelper.read(istr);
            this.returnValue = NDASSHelper.read(istr);
        }
    }
    ...
    public static class OpNDGSSResult {
        ...
        public OpNDGSSResult(java.util.Map<java.lang.String, java.lang.String[]> returnValue, java.util.Map<java.lang.String, java.lang.String[]> o) {
            this.returnValue = returnValue;
            this.o = o;
        }

        /**
         * Marshals the result for the opNDGSS operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            NDGSSHelper.write(ostr, this.o);
            NDGSSHelper.write(ostr, this.returnValue);
        }

        /**
         * Unmarshals the result of the opNDGSS operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.o = NDGSSHelper.read(istr);
            this.returnValue = NDGSSHelper.read(istr);
        }
    }
    ...
    java.util.concurrent.CompletionStage<MyClass.OpNDASSResult> opNDASSAsync(java.util.Map<java.lang.String, java.lang.String[]> i, com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<MyClass.OpNDGSSResult> opNDGSSAsync(java.util.Map<java.lang.String, java.lang.String[]> i, com.zeroc.Ice.Current current);
