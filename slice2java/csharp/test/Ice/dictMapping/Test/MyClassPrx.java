...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNVResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNV", null, sync, null);
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNRResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNR", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDVResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDV", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDRResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDR", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDAISResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDAIS", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDGISResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDGIS", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDASSResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDASS", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<MyClass.OpNDGSSResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opNDGSS", null, sync, null);
        f.invoke(true, context, null, ostr -> {
