...
public final class StructProperty implements java.lang.Cloneable, java.io.Serializable {
    ...
    /**
     * Constructs a {@code StructProperty}.
     */
    ...
    /**
     * Constructs a {@code StructProperty} with values for all fields not marked optional in the Slice definition for {@code ::Test::StructProperty}.
     */
    public StructProperty(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, java.lang.String noDefault, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code StructProperty}
     */
    ...
    private static final long serialVersionUID = 5771544995598478840L;
}
