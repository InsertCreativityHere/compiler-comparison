...
public final class Struct4 implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public Struct4(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, Color c1, Color c2, Color c3, Test.Nested.Color nc1, Test.Nested.Color nc2, Test.Nested.Color nc3, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
    ...
    private static final long serialVersionUID = -2888186550452234375L;
}
