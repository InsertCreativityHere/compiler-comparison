...
@com.zeroc.Ice.SliceTypeId(value = "::Test::ExceptionProperty")
public class ExceptionProperty extends com.zeroc.Ice.UserException {
    ...
    /**
     * Constructs a {@code ExceptionProperty}.
     */
    ...
    /**
     * Constructs a {@code ExceptionProperty} with values for all its fields.
     */
    public ExceptionProperty(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, java.lang.String noDefault, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
    ...
    private static final long serialVersionUID = -9101888075725323848L;
}
