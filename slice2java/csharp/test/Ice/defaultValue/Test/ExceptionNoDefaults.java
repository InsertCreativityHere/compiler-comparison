...
public class ExceptionNoDefaults extends ExceptionNoDefaultsBase {
     ...
     */
    public ExceptionNoDefaults(java.lang.String str, Color c1, byte[] bs, InnerStruct st, InnerStruct2 st2, java.util.Map<java.lang.Integer, java.lang.String> dict) {
        super(str, c1, bs);
        this.st = st;
        this.st2 = st2;
        this.dict = dict;
    ...
    private static final long serialVersionUID = -8225334018439182935L;
}
