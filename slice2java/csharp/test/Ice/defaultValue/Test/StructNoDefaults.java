...
public final class StructNoDefaults implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public StructNoDefaults(boolean bo, byte b, short s, int i, long l, float f, double d, java.lang.String str, Color c1, byte[] bs, int[] iseq, InnerStruct st, InnerStruct2 st2, java.util.Map<java.lang.Integer, java.lang.String> dict) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
    ...
    public boolean equals(java.lang.Object rhs) {
        ...
        if (r != null) {
            ...
            if (this.st2 != r.st2) {
                if (this.st2 == null || r.st2 == null || !this.st2.equals(r.st2)) {
                    return false;
                }
            }
            if (this.dict != r.dict) {
    ...
    public int hashCode() {
        ...
        h_ = com.zeroc.Ice.HashUtil.hashAdd(h_, st2);
    ...
    private static final long serialVersionUID = 4881455719765321293L;
}
