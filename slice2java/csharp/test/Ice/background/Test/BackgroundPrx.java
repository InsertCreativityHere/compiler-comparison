...
public interface BackgroundPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default BackgroundPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (BackgroundPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_adapterId(String newAdapterId)
    {
        return (BackgroundPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (BackgroundPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (BackgroundPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_invocationTimeout(int newTimeout)
    {
        return (BackgroundPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_connectionCached(boolean newCache)
    {
        return (BackgroundPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (BackgroundPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_secure(boolean b)
    {
        return (BackgroundPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (BackgroundPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_preferSecure(boolean b)
    {
        return (BackgroundPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (BackgroundPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (BackgroundPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_collocationOptimized(boolean b)
    {
        return (BackgroundPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_twoway()
    {
        return (BackgroundPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_oneway()
    {
        return (BackgroundPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_batchOneway()
    {
        return (BackgroundPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_datagram()
    {
        return (BackgroundPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_batchDatagram()
    {
        return (BackgroundPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_compress(boolean co)
    {
        return (BackgroundPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_timeout(int t)
    {
        return (BackgroundPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_connectionId(String connectionId)
    {
        return (BackgroundPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default BackgroundPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (BackgroundPrx)_ice_fixed(connection);
    }
