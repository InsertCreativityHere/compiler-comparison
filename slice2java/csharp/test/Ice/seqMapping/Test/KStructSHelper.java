...
/**
 * Helper class for marshaling/unmarshaling KStructS.
 */
public final class KStructSHelper {
    /**
     * Marshals a list of {@code KStructS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code KStructS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code KStructS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, S[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.VSize)) {
            ...
            KStructSHelper.write(ostr, v);
        }
    }

    /**
     * Unmarshals an optional list of {@code KStructS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
