...
/**
 * Helper class for marshaling/unmarshaling KObjectPrxS.
 */
public final class KObjectPrxSHelper {
    /**
     * Marshals a list of {@code KObjectPrxS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code KObjectPrxS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code KObjectPrxS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, com.zeroc.Ice.ObjectPrx[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            KObjectPrxSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code KObjectPrxS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
