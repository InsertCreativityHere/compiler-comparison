...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default MyClass.OpSerialSmallCSharpResult opSerialSmallCSharp(byte[] i)
    {
        return opSerialSmallCSharp(i, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default MyClass.OpSerialSmallCSharpResult opSerialSmallCSharp(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialSmallCSharpAsync(i, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialSmallCSharpResult> opSerialSmallCSharpAsync(byte[] i)
    {
        return _iceI_opSerialSmallCSharpAsync(i, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialSmallCSharpResult> opSerialSmallCSharpAsync(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialSmallCSharpAsync(i, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialSmallCSharpResult> _iceI_opSerialSmallCSharpAsync(byte[] iceP_i, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialSmallCSharpResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opSerialSmallCSharp", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeByteSeq(iceP_i);
                 }, istr -> {
                     MyClass.OpSerialSmallCSharpResult ret = new MyClass.OpSerialSmallCSharpResult();
                     ret.read(istr);
                     return ret;
                 });
        return f;
    ...
    default MyClass.OpSerialLargeCSharpResult opSerialLargeCSharp(byte[] i)
    {
        return opSerialLargeCSharp(i, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default MyClass.OpSerialLargeCSharpResult opSerialLargeCSharp(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialLargeCSharpAsync(i, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialLargeCSharpResult> opSerialLargeCSharpAsync(byte[] i)
    {
        return _iceI_opSerialLargeCSharpAsync(i, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialLargeCSharpResult> opSerialLargeCSharpAsync(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialLargeCSharpAsync(i, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialLargeCSharpResult> _iceI_opSerialLargeCSharpAsync(byte[] iceP_i, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialLargeCSharpResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opSerialLargeCSharp", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeByteSeq(iceP_i);
                 }, istr -> {
                     MyClass.OpSerialLargeCSharpResult ret = new MyClass.OpSerialLargeCSharpResult();
                     ret.read(istr);
                     return ret;
                 });
        return f;
    ...
    default MyClass.OpSerialStructCSharpResult opSerialStructCSharp(byte[] i)
    {
        return opSerialStructCSharp(i, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default MyClass.OpSerialStructCSharpResult opSerialStructCSharp(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialStructCSharpAsync(i, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialStructCSharpResult> opSerialStructCSharpAsync(byte[] i)
    {
        return _iceI_opSerialStructCSharpAsync(i, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<MyClass.OpSerialStructCSharpResult> opSerialStructCSharpAsync(byte[] i, java.util.Map<String, String> context)
    {
        return _iceI_opSerialStructCSharpAsync(i, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialStructCSharpResult> _iceI_opSerialStructCSharpAsync(byte[] iceP_i, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<MyClass.OpSerialStructCSharpResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opSerialStructCSharp", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeByteSeq(iceP_i);
                 }, istr -> {
                     MyClass.OpSerialStructCSharpResult ret = new MyClass.OpSerialStructCSharpResult();
                     ret.read(istr);
                     return ret;
                 });
        return f;
