...
/**
 * Helper class for marshaling/unmarshaling QIPrxS.
 */
public final class QIPrxSHelper {
    /**
     * Marshals a list of {@code QIPrxS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code QIPrxS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code QIPrxS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, IPrx[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            QIPrxSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code QIPrxS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
