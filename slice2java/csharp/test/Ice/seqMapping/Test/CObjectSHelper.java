...
/**
 * Helper class for marshaling/unmarshaling CObjectS.
 */
public final class CObjectSHelper {
    /**
     * Marshals a list of {@code CObjectS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code CObjectS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code CObjectS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, com.zeroc.Ice.Value[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            CObjectSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code CObjectS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
