...
/**
 * Helper class for marshaling/unmarshaling LObjectS.
 **/
public final class LObjectSHelper
{
    /**
     * Marshals a list of {@code LObjectS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code LObjectS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code LObjectS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, com.zeroc.Ice.Value[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            LObjectSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code LObjectS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
