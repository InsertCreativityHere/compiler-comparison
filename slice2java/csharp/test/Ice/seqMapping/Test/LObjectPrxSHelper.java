...
/**
 * Helper class for marshaling/unmarshaling LObjectPrxS.
 */
public final class LObjectPrxSHelper {
    /**
     * Marshals a list of {@code LObjectPrxS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code LObjectPrxS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code LObjectPrxS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, com.zeroc.Ice.ObjectPrx[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            LObjectPrxSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code LObjectPrxS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
