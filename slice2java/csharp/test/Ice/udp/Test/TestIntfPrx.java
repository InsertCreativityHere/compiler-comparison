...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the sendByteSeq operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    /**
     * Invokes the pingBiDir operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
