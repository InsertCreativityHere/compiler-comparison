...
public interface TestIntf extends com.zeroc.Ice.Object {
    ...
    /**
     * Dispatches the operation opAsyncDispatch.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opAsyncDispatch(TestIntf obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        request.inputStream.skipEmptyEncapsulation();
        var result = obj.opAsyncDispatchAsync(request.current);
        return result.thenApply(r -> request.current.createEmptyOutgoingResponse());
    }

    /**
     * Dispatches the operation opWithResultAsyncDispatch.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opWithResultAsyncDispatch(TestIntf obj, com.zeroc.Ice.IncomingRequest request) {
        request.current.checkNonIdempotent();
        request.inputStream.skipEmptyEncapsulation();
        var result = obj.opWithResultAsyncDispatchAsync(request.current);
    ...
    /**
     * Dispatches the operation opWithUEAsyncDispatch.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
     ...
     * @hidden
     */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opWithUEAsyncDispatch(TestIntf obj, com.zeroc.Ice.IncomingRequest request)
        throws com.zeroc.Ice.UserException {
        request.current.checkNonIdempotent();
        request.inputStream.skipEmptyEncapsulation();
        var result = obj.opWithUEAsyncDispatchAsync(request.current);
        return result.thenApply(r -> request.current.createEmptyOutgoingResponse());
    }
