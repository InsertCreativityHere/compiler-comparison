...
/**
 * Helper class for marshaling/unmarshaling MyInterfaceStack.
 **/
public final class MyInterfaceStackHelper
{
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, com.zeroc.Ice.Value[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            MyInterfaceStackHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }
    ...
    public static java.util.Optional<com.zeroc.Ice.Value[]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            v = MyInterfaceStackHelper.read(istr);
