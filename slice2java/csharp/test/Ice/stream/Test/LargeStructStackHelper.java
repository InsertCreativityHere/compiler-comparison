...
/**
 * Helper class for marshaling/unmarshaling LargeStructStack.
 */
public final class LargeStructStackHelper {
    /**
     * Marshals a list of {@code LargeStructStack} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code LargeStructStack} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code LargeStructStack} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, LargeStruct[] v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            LargeStructStackHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code LargeStructStack} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
    ...
    public static java.util.Optional<LargeStruct[]> read(com.zeroc.Ice.InputStream istr, int tag) {
        if (istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            istr.skip(4);
            LargeStruct[] v;
            v = LargeStructStackHelper.read(istr);
