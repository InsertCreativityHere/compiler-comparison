...
/**
 * Helper class for marshaling/unmarshaling SmallStructStack.
 **/
public final class SmallStructStackHelper
{
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, SmallStruct[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            SmallStructStackHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }
    ...
    public static java.util.Optional<SmallStruct[]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            SmallStruct[] v;
            v = SmallStructStackHelper.read(istr);
