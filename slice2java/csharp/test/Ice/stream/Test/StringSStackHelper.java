...
/**
 * Helper class for marshaling/unmarshaling StringSStack.
 **/
public final class StringSStackHelper
{
    /**
     * Marshals a list of {@code StringSStack} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code StringSStack} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code StringSStack} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, String[][] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            StringSStackHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code StringSStack} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
    ...
    public static java.util.Optional<String[][]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            String[][] v;
            v = StringSStackHelper.read(istr);
