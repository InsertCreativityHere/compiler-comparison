...
public interface HoldPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "putOnHold", com.zeroc.Ice.OperationMode.Normal, sync, null);
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "waitForHold", com.zeroc.Ice.OperationMode.Normal, sync, null);
    ...
    /**
     * Invokes the setOneway operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "setOneway", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
    ...
    /**
     * Invokes the set operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_value parameter
     * @param iceP_delay parameter
     * @param context the request context
    ...
    {
        com.zeroc.Ice.OutgoingAsync<java.lang.Integer> f = new com.zeroc.Ice.OutgoingAsync<>(this, "set", com.zeroc.Ice.OperationMode.Normal, sync, null);
