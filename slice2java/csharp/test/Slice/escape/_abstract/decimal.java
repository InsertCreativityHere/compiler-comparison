...
public interface decimal extends com.zeroc.Ice.Object
{
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_default(decimal obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        obj._default(current);
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        {
            case "default" -> decimal._iceD_default(this, in, current);
