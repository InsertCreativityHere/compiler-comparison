...
public interface optionalParams extends com.zeroc.Ice.Object
{
    ...
    public static class InResult
    {
        ...
        public InResult(java.util.Optional<_break> returnValue, java.util.Optional<as> _goto, java.util.Optional<explicitPrx> _if, java.util.Optional<java.util.Map<java.lang.String, _break>> internal, java.util.Optional<java.lang.String> context)
        {
        ...
        public InResult(_break returnValue, as _goto, explicitPrx _if, java.util.Map<java.lang.String, _break> internal, String context)
        {
    ...
    public static class ForeachResult
    {
        ...
        public ForeachResult(java.util.Optional<_break> returnValue, java.util.Optional<as> _goto, java.util.Optional<explicitPrx> _if, java.util.Optional<java.util.Map<java.lang.String, _break>> internal, java.util.Optional<java.lang.String> context)
        {
            this.returnValue = returnValue;
            this._goto = _goto;
            this._if = _if;
        ...
        public ForeachResult(_break returnValue, as _goto, explicitPrx _if, java.util.Map<java.lang.String, _break> internal, String context)
        {
            this.returnValue = java.util.Optional.ofNullable(returnValue);
            this._goto = java.util.Optional.ofNullable(_goto);
            this._if = java.util.Optional.ofNullable(_if);
    ...
    java.util.Optional<_break> _for(java.util.Optional<as> _goto, java.util.Optional<explicitPrx> _if, java.util.Optional<java.util.Map<java.lang.String, _break>> internal, java.util.Optional<java.lang.String> context, com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<java.util.Optional<_break>> continueAsync(java.util.Optional<as> _goto, java.util.Optional<explicitPrx> _if, java.util.Optional<java.util.Map<java.lang.String, _break>> internal, java.util.Optional<java.lang.String> context, com.zeroc.Ice.Current current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_for(optionalParams obj, com.zeroc.Ice.IncomingRequest request)
    {
        ...
        java.util.Optional<_break> ret = obj._for(iceP_goto, iceP_if, iceP_internal, iceP_context, request.current);
