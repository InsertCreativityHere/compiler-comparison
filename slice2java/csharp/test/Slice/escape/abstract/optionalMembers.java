...
public class optionalMembers extends com.zeroc.Ice.Value {
    ...
    /**
     * Constructs a {@code optionalMembers}.
     */
    ...
    /**
     * Constructs a {@code optionalMembers} with values for all its fields.
     */
    public optionalMembers(break for, as goto, explicitPrx if, java.util.Map<java.lang.String, break> internal, java.lang.String namespace) {
        setFor(for);
        setGoto(goto);
        setIf(if);
    ...
    private static final long serialVersionUID = 7698878720851136456L;
}
