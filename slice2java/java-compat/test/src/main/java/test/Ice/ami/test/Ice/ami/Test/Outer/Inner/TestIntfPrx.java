...
{
    default TestIntf.OpResult op(int i)
    {
        return op(i, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default TestIntf.OpResult op(int i, java.util.Map<String, String> context)
    {
        return _iceI_opAsync(i, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<TestIntf.OpResult> opAsync(int i)
    {
        return _iceI_opAsync(i, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<TestIntf.OpResult> opAsync(int i, java.util.Map<String, String> context)
    {
        return _iceI_opAsync(i, context, false);
    }
