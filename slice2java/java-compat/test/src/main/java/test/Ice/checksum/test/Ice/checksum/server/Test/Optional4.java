...
public class Optional4 extends com.zeroc.Ice.Value
{
    public Optional4()
    {
        this.firstName = "";
    ...
    public Optional4(String firstName)
    {
    ...
    public Optional4(String firstName, String secondName, String emailAddress)
    {
        this.firstName = firstName;
    ...
    public Optional4 clone()
    {
        return (Optional4)super.clone();
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = -2438656464845143542L;
