...
public interface Initial extends com.zeroc.Ice.Object
{
    ...
    java.util.concurrent.CompletionStage<java.util.Optional<SmallStruct>> opMStruct1Async(com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<Initial.OpMStruct2Result> opMStruct2Async(java.util.Optional<SmallStruct> p1, com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<java.util.Optional<String[]>> opMSeq1Async(com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<Initial.OpMSeq2Result> opMSeq2Async(java.util.Optional<String[]> p1, com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<java.util.Optional<java.util.Map<java.lang.String, java.lang.Integer>>> opMDict1Async(com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<Initial.OpMDict2Result> opMDict2Async(java.util.Optional<java.util.Map<java.lang.String, java.lang.Integer>> p1, com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<java.util.Optional<G>> opMG1Async(com.zeroc.Ice.Current current);

    java.util.concurrent.CompletionStage<Initial.OpMG2Result> opMG2Async(java.util.Optional<G> p1, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMStruct1(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        return inS.setResultFuture(obj.opMStruct1Async(current), (ostr, ret) ->
            {
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMStruct2(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_p1 = SmallStruct.ice_read(istr, 2);
        inS.endReadParams();
        return inS.setResultFuture(obj.opMStruct2Async(iceP_p1, current), (ostr, ret) ->
            {
                ret.write(ostr);
            });
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMSeq1(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        return inS.setResultFuture(obj.opMSeq1Async(current), (ostr, ret) ->
            {
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMSeq2(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_p1 = istr.readStringSeq(2);
        inS.endReadParams();
        return inS.setResultFuture(obj.opMSeq2Async(iceP_p1, current), (ostr, ret) ->
            {
                ret.write(ostr);
            });
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMDict1(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        return inS.setResultFuture(obj.opMDict1Async(current), (ostr, ret) ->
            {
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMDict2(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_p1 = StringIntDictHelper.read(istr, 2);
        inS.endReadParams();
        return inS.setResultFuture(obj.opMDict2Async(iceP_p1, current), (ostr, ret) ->
            {
                ret.write(ostr);
            });
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMG1(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        return inS.setResultFuture(obj.opMG1Async(current), (ostr, ret) ->
            {
                ostr.writeValue(1, ret);
            });
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_opMG2(Initial obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        return inS.setResultFuture(obj.opMG2Async(iceP_p1, current), (ostr, ret) ->
            {
                ret.write(ostr);
            });
    }
