...
public class Optional1 extends com.zeroc.Ice.Value
{
    public Optional1()
    {
        this.firstName = "";
    ...
    public Optional1(String firstName)
    {
    ...
    public Optional1(String firstName, String emailAddress, String secondName)
    {
        this.firstName = firstName;
    ...
    public Optional1 clone()
    {
        return (Optional1)super.clone();
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = -7858016353815374737L;
