...
{
    default void _transient()
    {
        _transient(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void _transient(java.util.Map<String, String> context)
    {
        _iceI_transientAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> transientAsync()
    {
        return _iceI_transientAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> transientAsync(java.util.Map<String, String> context)
    {
        return _iceI_transientAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_transientAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "transient", null, sync, null);
