...
{
    default int case(int clone)
    {
        return case(clone, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int case(int clone, java.util.Map<String, String> context)
    {
        return _iceI_caseAsync(clone, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> caseAsync(int clone)
    {
        return _iceI_caseAsync(clone, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> caseAsync(int clone, java.util.Map<String, String> context)
    {
        return _iceI_caseAsync(clone, context, false);
    }
     ...
     *
     * @param iceP_clone parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_caseAsync(int iceP_clone, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default END instance_variables()
    {
        return instance_variables(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default END instance_variables(java.util.Map<String, String> context)
    {
        return _iceI_instance_variablesAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<END> instance_variablesAsync()
    {
        return _iceI_instance_variablesAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<END> instance_variablesAsync(java.util.Map<String, String> context)
    {
        return _iceI_instance_variablesAsync(context, false);
    }

    /**
     * Invokes the instance_variables operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<END> _iceI_instance_variablesAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<END> f = new com.zeroc.Ice.OutgoingAsync<>(this, "instance_variables", com.zeroc.Ice.OperationMode.Normal, sync, null);
