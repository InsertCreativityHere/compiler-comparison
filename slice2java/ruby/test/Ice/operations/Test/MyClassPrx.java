...
public interface MyClassPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<MyClass.OpMyStructMyEnumDSResult> _iceI_opMyStructMyEnumDSAsync(java.util.Map<MyStruct, MyEnum>[] iceP_p1, java.util.Map<MyStruct, MyEnum>[] iceP_p2, java.util.Map<String, String> context, boolean sync)
    {
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opIdempotent", com.zeroc.Ice.OperationMode.Nonmutating, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }
