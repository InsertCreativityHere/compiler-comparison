...
public final class StringMyEnumDHelper {
    /**
     * Marshals a dictionary of {@code StringMyEnumD} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code StringMyEnumD} from an input stream.
     *
    ...
    public static java.util.Map<java.lang.String, MyEnum> read(com.zeroc.Ice.InputStream istr) {
        ...
        v = new java.util.HashMap<java.lang.String, Test.MyEnum>();
    ...
    /**
     * Marshals an optional dictionary of {@code StringMyEnumD} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    /**
     * Unmarshals an optional dictionary of {@code StringMyEnumD} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
