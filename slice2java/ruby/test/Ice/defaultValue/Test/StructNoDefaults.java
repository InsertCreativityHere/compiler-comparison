                                         ...
                                         java.io.Serializable
{
    ...
    public StructNoDefaults(boolean bo, byte b, short s, int i, long l, float f, double d, String str, Color c1, byte[] bs, int[] is, java.util.Map<java.lang.Integer, java.lang.String> dict, InnerStruct st)
    {
        this.bo = bo;
        this.b = b;
        this.s = s;
    ...
    /** @hidden */
    private static final long serialVersionUID = -3996914451524248863L;
}
