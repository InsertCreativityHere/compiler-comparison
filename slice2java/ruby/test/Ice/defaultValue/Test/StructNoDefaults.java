...
public final class StructNoDefaults implements java.lang.Cloneable, java.io.Serializable {
     ...
     */
    public StructNoDefaults(boolean bo, byte b, short s, int i, long l, float f, double d, java.lang.String str, Color c1, byte[] bs, int[] is, java.util.Map<java.lang.Integer, java.lang.String> dict, InnerStruct st) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
    ...
    private static final long serialVersionUID = 1535057542868298105L;
}
