...
public class OptionalEx1 extends com.zeroc.Ice.UserException
{
    ...
    public OptionalEx1(String firstName, String secondName, String emailAddress)
    {
        this.firstName = firstName;
    ...
    public OptionalEx1(String firstName, String secondName, String emailAddress, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        setSecondName(secondName);
    ...
    /** @hidden */
    public static final long serialVersionUID = -7480319726901465752L;
}
