...
public interface ThrowerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void throwDispatchException(byte replyStatus, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> throwDispatchExceptionAsync(byte replyStatus, java.util.Map<String, String> context)
    {
