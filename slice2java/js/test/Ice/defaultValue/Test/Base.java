...
public class Base extends com.zeroc.Ice.Value {
     ...
     */
    public Base(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, java.lang.String noDefault, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
    ...
    private static final long serialVersionUID = 7531286629191930077L;
}
