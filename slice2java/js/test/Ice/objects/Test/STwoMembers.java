...
public final class STwoMembers implements java.lang.Cloneable, java.io.Serializable {
    public Empty e1;

    public Empty e2;

    /**
     * Constructs a {@code STwoMembers}.
     */
    public STwoMembers() {
    }

    /**
     * Constructs a {@code STwoMembers} with values for all fields not marked optional in the Slice definition for {@code ::Test::STwoMembers}.
     */
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code STwoMembers}
     */
    ...
    private static final long serialVersionUID = 4203176727968134509L;
}
