...
public interface SessionPrx extends com.zeroc.Glacier2.SessionPrx
{
    ...
    {
        _iceI_destroySessionAsync(context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "destroySession", null, sync, null);
