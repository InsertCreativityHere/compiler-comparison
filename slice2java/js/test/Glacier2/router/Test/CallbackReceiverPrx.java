...
public interface CallbackReceiverPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default void callback(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<Void> callbackAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_callbackAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_callbackAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    default void callbackEx(java.util.Map<java.lang.String, java.lang.String> context)
        throws CallbackException {
        try {
    ...
    default java.util.concurrent.CompletableFuture<Void> callbackExAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_callbackExAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_callbackExAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_callbackEx = {
     ...
     */
    static CallbackReceiverPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static CallbackReceiverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static CallbackReceiverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static CallbackReceiverPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static CallbackReceiverPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _CallbackReceiverPrxI(obj.ice_facet(facet));
    }

    @Override
    CallbackReceiverPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    CallbackReceiverPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    CallbackReceiverPrx ice_connectionId(java.lang.String connectionId);
