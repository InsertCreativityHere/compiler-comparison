...
public interface TestIntf extends com.zeroc.Ice.Object
{
    ...
    void jsException(com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_jsException(TestIntf obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (current.operation)
        {
            ...
            case "jsException" -> TestIntf._iceD_jsException(this, in, current);
