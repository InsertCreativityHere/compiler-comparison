...
public interface MyDerivedClass extends MyClass {
    ...
    MyStruct1 opMyStruct1(MyStruct1 s, com.zeroc.Ice.Current current);

    MyClass1 opMyClass1(MyClass1 c, com.zeroc.Ice.Current current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opMyStruct1(MyDerivedClass obj, com.zeroc.Ice.IncomingRequest request) {
        ...
        MyStruct1 iceP_s;
        iceP_s = MyStruct1.ice_read(istr);
        istr.endEncapsulation();
        MyStruct1 ret = obj.opMyStruct1(iceP_s, request.current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_opMyClass1(MyDerivedClass obj, com.zeroc.Ice.IncomingRequest request) {
        ...
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        final com.zeroc.Ice.Holder<MyClass1> icePP_c = new com.zeroc.Ice.Holder<>();
        istr.readValue(v -> icePP_c.value = v, MyClass1.class);
        istr.readPendingValues();
        istr.endEncapsulation();
        MyClass1 iceP_c = icePP_c.value;
        MyClass1 ret = obj.opMyClass1(iceP_c, request.current);
        var ostr = request.current.startReplyStream();
        ostr.startEncapsulation(request.current.encoding, null);
        ostr.writeValue(ret);
