...
public interface MyInterfacePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default MyInterface.OpMyStructResult opMyStruct(Test.Inner.MyStruct s1, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<MyInterface.OpMyStructResult> opMyStructAsync(Test.Inner.MyStruct s1, java.util.Map<String, String> context)
    {
