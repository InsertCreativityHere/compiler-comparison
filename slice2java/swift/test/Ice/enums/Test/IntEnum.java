...
public enum IntEnum {
    ...
    /**
     * Returns the {@code IntEnum} enumerator corresponding to the given integer value.
     *
     * @param v the value to match
     * @return the {@code IntEnum} enumerator corresponding to the given integer value, or {@code null} if no such enumerator exists
     */
    ...
    /**
     * Marshals this {@code IntEnum} into an output stream.
     *
    ...
    /**
     * Marshals an {@code IntEnum} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code IntEnum} to marshal
     */
    ...
    /**
     * Unmarshals an {@code IntEnum} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code IntEnum}
     */
    ...
    /**
     * Marshals an optional {@code IntEnum} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code IntEnum} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
