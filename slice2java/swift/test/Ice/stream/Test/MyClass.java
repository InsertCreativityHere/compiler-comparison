...
public class MyClass extends com.zeroc.Ice.Value {
     ...
     */
    public MyClass(MyClass c, com.zeroc.Ice.Value o, LargeStruct s, boolean[] seq1, byte[] seq2, short[] seq3, int[] seq4, long[] seq5, float[] seq6, double[] seq7, java.lang.String[] seq8, MyEnum[] seq9, MyClass[] seq10, java.util.Map<java.lang.String, MyClass> d) {
        this.c = c;
        this.o = o;
        this.s = s;
        this.seq1 = seq1;
    ...
    private static final long serialVersionUID = 3720201387703274764L;
}
