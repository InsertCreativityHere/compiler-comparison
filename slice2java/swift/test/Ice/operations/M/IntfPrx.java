...
public interface IntfPrx extends com.zeroc.Ice.ObjectPrx
{
    default void opIntf()
    {
        opIntf(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void opIntf(java.util.Map<String, String> context)
    {
        _iceI_opIntfAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> opIntfAsync()
    {
        return _iceI_opIntfAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> opIntfAsync(java.util.Map<String, String> context)
    {
        return _iceI_opIntfAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_opIntfAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opIntf", null, sync, null);
