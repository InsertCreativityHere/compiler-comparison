...
public final class Struct2 implements java.lang.Cloneable, java.io.Serializable {
    ...
    /**
     * Constructs a {@code Struct2} with values for all fields not marked optional in the Slice definition for {@code ::Test::Struct2}.
     */
    public Struct2(boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, Color c1, Color c2, Color c3, Test.Nested.Color nc1, Test.Nested.Color nc2, Test.Nested.Color nc3, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
    ...
    /**
     * Marshals a {@code Struct2} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code Struct2} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code Struct2} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code Struct2}
     */
    ...
    /**
     * Marshals an optional {@code Struct2} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code Struct2} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = -438358149744178416L;
}
