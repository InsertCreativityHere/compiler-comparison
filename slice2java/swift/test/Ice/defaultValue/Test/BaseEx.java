...
public class BaseEx extends com.zeroc.Ice.UserException {
     ...
     */
    public BaseEx(boolean boolFalse, boolean boolTrue, byte b, short s, int i, long l, float f, double d, java.lang.String str, java.lang.String noDefault, int zeroI, long zeroL, float zeroF, float zeroDotF, double zeroD, double zeroDotD) {
    ...
    private static final long serialVersionUID = 6113877327839127456L;
}
