...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test.Inner.A> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getInnerA", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Test.Inner.Sub.A> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getInnerSubA", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
