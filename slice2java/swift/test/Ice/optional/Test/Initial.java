...
public interface Initial extends com.zeroc.Ice.Object {
    ...
    public static class OpCustomStringResult {
        ...
        public OpCustomStringResult(java.lang.String returnValue, java.lang.String p3) {
            this.returnValue = java.util.Optional.ofNullable(returnValue);
            this.p3 = java.util.Optional.ofNullable(p3);
        }

        /**
         * Marshals the result for the opCustomString operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            ostr.writeString(1, this.returnValue);
        ...
        /**
         * Unmarshals the result of the opCustomString operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = istr.readString(1);
    ...
    public static class OpCustomIntStringDictResult {
        ...
        /**
         * Marshals the result for the opCustomIntStringDict operation.
         * @param ostr the output stream to write this result to
         */
        public void write(com.zeroc.Ice.OutputStream ostr) {
            IntStringDictHelper.write(ostr, 1, this.returnValue);
            IntStringDictHelper.write(ostr, 3, this.p3);
        }

        /**
         * Unmarshals the result of the opCustomIntStringDict operation.
         * @param istr the input stream to read this result from
         */
        public void read(com.zeroc.Ice.InputStream istr) {
            this.returnValue = IntStringDictHelper.read(istr, 1);
    ...
    /**
     * Dispatches the operation opCustomString.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    /**
     * Dispatches the operation opCustomIntStringDict.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
