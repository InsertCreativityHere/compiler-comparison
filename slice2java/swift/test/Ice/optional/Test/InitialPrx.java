...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default Initial.OpCustomStringResult opCustomString(String p1)
    {
        return opCustomString(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Initial.OpCustomStringResult opCustomString(String p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomStringAsync(p1, context, true).waitForResponse();
    }

    default Initial.OpCustomStringResult opCustomString(java.util.Optional<java.lang.String> p1)
    {
        return opCustomString(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Initial.OpCustomStringResult opCustomString(java.util.Optional<java.lang.String> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomStringAsync(p1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomStringResult> opCustomStringAsync(String p1)
    {
        return _iceI_opCustomStringAsync(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomStringResult> opCustomStringAsync(String p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomStringAsync(p1, context, false);
    }

    /**
     * Invokes the opCustomString operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_p1 parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Initial.OpCustomStringResult> _iceI_opCustomStringAsync(String iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomStringResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomString", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(2, iceP_p1);
                 }, istr -> {
                     Initial.OpCustomStringResult ret = new Initial.OpCustomStringResult();
                     ret.read(istr);
                     return ret;
                 });
        return f;
    ...
    default java.util.concurrent.CompletableFuture<Initial.OpCustomStringResult> opCustomStringAsync(java.util.Optional<java.lang.String> p1)
    {
        return _iceI_opCustomStringAsync(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomStringResult> opCustomStringAsync(java.util.Optional<java.lang.String> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomStringAsync(p1, context, false);
    }
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Initial.OpCustomStringResult> _iceI_opCustomStringAsync(java.util.Optional<java.lang.String> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomStringResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomString", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(2, iceP_p1);
    ...
    default Initial.OpCustomIntStringDictResult opCustomIntStringDict(java.util.Map<java.lang.Integer, java.lang.String> p1)
    {
        return opCustomIntStringDict(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Initial.OpCustomIntStringDictResult opCustomIntStringDict(java.util.Map<java.lang.Integer, java.lang.String> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomIntStringDictAsync(p1, context, true).waitForResponse();
    }

    default Initial.OpCustomIntStringDictResult opCustomIntStringDict(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> p1)
    {
        return opCustomIntStringDict(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Initial.OpCustomIntStringDictResult opCustomIntStringDict(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomIntStringDictAsync(p1, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomIntStringDictResult> opCustomIntStringDictAsync(java.util.Map<java.lang.Integer, java.lang.String> p1)
    {
        return _iceI_opCustomIntStringDictAsync(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomIntStringDictResult> opCustomIntStringDictAsync(java.util.Map<java.lang.Integer, java.lang.String> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomIntStringDictAsync(p1, context, false);
    }

    /**
     * Invokes the opCustomIntStringDict operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_p1 parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Initial.OpCustomIntStringDictResult> _iceI_opCustomIntStringDictAsync(java.util.Map<java.lang.Integer, java.lang.String> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomIntStringDictResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomIntStringDict", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     IntStringDictHelper.write(ostr, 2, iceP_p1);
                 }, istr -> {
                     Initial.OpCustomIntStringDictResult ret = new Initial.OpCustomIntStringDictResult();
                     ret.read(istr);
                     return ret;
                 });
        return f;
    ...
    default java.util.concurrent.CompletableFuture<Initial.OpCustomIntStringDictResult> opCustomIntStringDictAsync(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> p1)
    {
        return _iceI_opCustomIntStringDictAsync(p1, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Initial.OpCustomIntStringDictResult> opCustomIntStringDictAsync(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> p1, java.util.Map<String, String> context)
    {
        return _iceI_opCustomIntStringDictAsync(p1, context, false);
    }
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Initial.OpCustomIntStringDictResult> _iceI_opCustomIntStringDictAsync(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomIntStringDictResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomIntStringDict", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(true, context, null, ostr -> {
                     IntStringDictHelper.write(ostr, 2, iceP_p1);
