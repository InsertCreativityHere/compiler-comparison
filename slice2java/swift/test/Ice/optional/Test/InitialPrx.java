...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomStringResult> _iceI_opCustomStringAsync(String iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomStringResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCustomString", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(2, iceP_p1);
                 }, istr -> {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomStringResult> _iceI_opCustomStringAsync(java.util.Optional<java.lang.String> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomStringResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCustomString", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(2, iceP_p1);
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomIntStringDictResult> _iceI_opCustomIntStringDictAsync(java.util.Map<java.lang.Integer, java.lang.String> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomIntStringDictResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCustomIntStringDict", null, sync, null);
        f.invoke(true, context, null, ostr -> {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomIntStringDictResult> _iceI_opCustomIntStringDictAsync(java.util.Optional<java.util.Map<java.lang.Integer, java.lang.String>> iceP_p1, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Initial.OpCustomIntStringDictResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "opCustomIntStringDict", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     IntStringDictHelper.write(ostr, 2, iceP_p1);
