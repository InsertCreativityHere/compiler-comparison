...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomStringResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomString", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(2, iceP_p1);
                 }, istr -> {
    ...
    {
        com.zeroc.Ice.OutgoingAsync<Initial.OpCustomIntStringDictResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "opCustomIntStringDict", null, sync, null);
        f.invoke(true, context, null, ostr -> {
