...
public class Cls extends com.zeroc.Ice.Value
{
     ...
     */
    public Cls(IntfPrx s, String context, int current, short response, String upCast, int typeId, short del, String ex, int result, String istr, String ostr, String inS, String proxy)
    {
        this.s = s;
    ...
    private static final long serialVersionUID = -1685065823524376035L;
}
