...
public interface breakPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int case(int class, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> caseAsync(int class, java.util.Map<String, String> context)
    {
        return _iceI_caseAsync(class, context, false);
    }

    /**
     * Invokes the case operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_class parameter
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_caseAsync(int iceP_class, java.util.Map<String, String> context, boolean sync)
    {
