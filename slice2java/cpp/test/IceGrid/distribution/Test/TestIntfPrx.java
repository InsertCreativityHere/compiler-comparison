...
{
    default String getServerFile(String path)
    {
        return getServerFile(path, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getServerFile(String path, java.util.Map<String, String> context)
    {
        return _iceI_getServerFileAsync(path, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getServerFileAsync(String path)
    {
        return _iceI_getServerFileAsync(path, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getServerFileAsync(String path, java.util.Map<String, String> context)
    {
        return _iceI_getServerFileAsync(path, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getServerFileAsync(String iceP_path, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getServerFile", null, sync, null);
    ...
    default String getApplicationFile(String path)
    {
        return getApplicationFile(path, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getApplicationFile(String path, java.util.Map<String, String> context)
    {
        return _iceI_getApplicationFileAsync(path, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getApplicationFileAsync(String path)
    {
        return _iceI_getApplicationFileAsync(path, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getApplicationFileAsync(String path, java.util.Map<String, String> context)
    {
        return _iceI_getApplicationFileAsync(path, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getApplicationFileAsync(String iceP_path, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getApplicationFile", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_path);
                 }, istr -> {
                     String ret;
