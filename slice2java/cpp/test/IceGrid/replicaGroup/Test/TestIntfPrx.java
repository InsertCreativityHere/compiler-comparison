...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default String getReplicaId(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> getReplicaIdAsync(java.util.Map<String, String> context)
    {
        return _iceI_getReplicaIdAsync(context, false);
    }

    /**
     * Invokes the getReplicaId operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.String> _iceI_getReplicaIdAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    default String getReplicaIdAndShutdown()
    {
        return getReplicaIdAndShutdown(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getReplicaIdAndShutdown(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> getReplicaIdAndShutdownAsync(java.util.Map<String, String> context)
    {
        return _iceI_getReplicaIdAndShutdownAsync(context, false);
    }

    /**
     * Invokes the getReplicaIdAndShutdown operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.String> _iceI_getReplicaIdAndShutdownAsync(java.util.Map<String, String> context, boolean sync)
    {
