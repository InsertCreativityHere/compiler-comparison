...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getAdapterId(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getAdapterId(java.util.Map<String, String> context)
    {
        return _iceI_getAdapterIdAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getAdapterIdAsync()
    {
        return _iceI_getAdapterIdAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getAdapterIdAsync(java.util.Map<String, String> context)
    {
        return _iceI_getAdapterIdAsync(context, false);
    }

    /**
     * Invokes the getAdapterId operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.String> _iceI_getAdapterIdAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<java.lang.String> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getAdapterId", com.zeroc.Ice.OperationMode.Normal, sync, null);
