...
public interface CallbackPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default int getCount(java.util.Map<java.lang.String, java.lang.String> context) {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> getCountAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getCountAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_getCountAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
