...
public interface HoldPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default void putOnHold(int delay, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> putOnHoldAsync(int delay, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_putOnHoldAsync(delay, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_putOnHoldAsync(int iceP_delay, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void waitForHold(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> waitForHoldAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_waitForHoldAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_waitForHoldAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void setOneway(int value, int expected, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setOnewayAsync(int value, int expected, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_setOnewayAsync(value, expected, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_setOnewayAsync(int iceP_value, int iceP_expected, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @return The previous value.
     */
    default int set(int value, int delay, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return The previous value.
     */
    default java.util.concurrent.CompletableFuture<java.lang.Integer> setAsync(int value, int delay, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_setAsync(value, delay, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_setAsync(int iceP_value, int iceP_delay, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    static HoldPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static HoldPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static HoldPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static HoldPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static HoldPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _HoldPrxI(obj.ice_facet(facet));
    }

    @Override
    HoldPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    HoldPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    HoldPrx ice_connectionId(java.lang.String connectionId);
