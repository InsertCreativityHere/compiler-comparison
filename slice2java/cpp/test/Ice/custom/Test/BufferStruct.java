...
public final class BufferStruct implements java.lang.Cloneable, java.io.Serializable {
    public byte[] byteBuf;
    ...
    /**
     * Constructs a {@code BufferStruct}.
     */
    public BufferStruct() {
    }

    /**
     * Constructs a {@code BufferStruct} with values for all fields not marked optional in the Slice definition for {@code ::Test::BufferStruct}.
     */
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code BufferStruct}
     */
    ...
    private static final long serialVersionUID = 3533601500860040526L;
}
