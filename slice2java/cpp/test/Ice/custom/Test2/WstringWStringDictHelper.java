...
public final class WstringWStringDictHelper {
    /**
     * Marshals a dictionary of {@code WstringWStringDict} into an output stream.
     *
    ...
    /**
     * Unmarshals a dictionary of {@code WstringWStringDict} from an input stream.
     *
    ...
    /**
     * Marshals an optional dictionary of {@code WstringWStringDict} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the dictionary to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Map<java.lang.String, java.lang.String> v) {
        if (ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            ...
            WstringWStringDictHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional dictionary of {@code WstringWStringDict} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the dictionary
    ...
    public static java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> read(com.zeroc.Ice.InputStream istr, int tag) {
        if (istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize)) {
            istr.skip(4);
            java.util.Map<java.lang.String, java.lang.String> v;
            v = WstringWStringDictHelper.read(istr);
