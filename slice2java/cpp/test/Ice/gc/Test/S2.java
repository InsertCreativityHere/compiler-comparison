...
{
    public java.util.Map<java.lang.Integer, C2> theC2Dict;

    public S2()
    {
    }

    public S2(java.util.Map<java.lang.Integer, C2> theC2Dict)
    {
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        if(r != null)
        {
            if(this.theC2Dict != r.theC2Dict)
            {
                if(this.theC2Dict == null || r.theC2Dict == null || !this.theC2Dict.equals(r.theC2Dict))
                {
                    return false;
                }
            }
    ...
    public int hashCode()
    {
        ...
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, theC2Dict);
        return h_;
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = 5159583189605894281L;
}
