...
public interface InitialPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default Test.MA.IAPrx iaop(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.MA.IAPrx> iaopAsync(java.util.Map<String, String> context)
    {
    ...
    default Test.MB.IB1Prx ib1op(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.MB.IB1Prx> ib1opAsync(java.util.Map<String, String> context)
    {
    ...
    default Test.MB.IB2Prx ib2op(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.MB.IB2Prx> ib2opAsync(java.util.Map<String, String> context)
    {
    ...
    default Test.MA.ICPrx icop(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Test.MA.ICPrx> icopAsync(java.util.Map<String, String> context)
    {
