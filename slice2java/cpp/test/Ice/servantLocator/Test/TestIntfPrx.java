...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void stdException()
    {
        stdException(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void stdException(java.util.Map<String, String> context)
    {
        _iceI_stdExceptionAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> stdExceptionAsync()
    {
        return _iceI_stdExceptionAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> stdExceptionAsync(java.util.Map<String, String> context)
    {
        return _iceI_stdExceptionAsync(context, false);
    }

    /**
     * Invokes the stdException operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_stdExceptionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "stdException", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }

    default void cppException()
    {
        cppException(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void cppException(java.util.Map<String, String> context)
    {
        _iceI_cppExceptionAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> cppExceptionAsync()
    {
        return _iceI_cppExceptionAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> cppExceptionAsync(java.util.Map<String, String> context)
    {
        return _iceI_cppExceptionAsync(context, false);
    }

    /**
     * Invokes the cppException operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_cppExceptionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "cppException", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }
