...
public class MultiOptional extends com.zeroc.Ice.Value {
    ...
    public void setSs(int index, java.lang.String val) {
        if (!_ss) {
            throw new java.util.NoSuchElementException("ss is not set");
        }
        this.ss[index] = val;
    ...
    /**
     * Constructs a {@code MultiOptional}.
     */
    ...
    /**
     * Constructs a {@code MultiOptional} with values for all its fields.
     */
    public MultiOptional(byte a, boolean b, short c, int d, long e, float f, double g, java.lang.String h, MyEnum i, MyInterfacePrx j, byte[] bs, java.lang.String[] ss, java.util.Map<java.lang.Integer, java.lang.Integer> iid, java.util.Map<java.lang.String, java.lang.Integer> sid, FixedStruct fs, VarStruct vs, short[] shs, MyEnum[] es, FixedStruct[] fss, VarStruct[] vss, MyInterfacePrx[] mips, java.util.Map<java.lang.Integer, MyEnum> ied, java.util.Map<java.lang.Integer, FixedStruct> ifsd, java.util.Map<java.lang.Integer, VarStruct> ivsd, java.util.Map<java.lang.Integer, MyInterfacePrx> imipd, boolean[] bos, byte[] ser) {
        setA(a);
        setB(b);
        setC(c);
        setD(d);
    ...
    private static final long serialVersionUID = 3094780520485261245L;
}
