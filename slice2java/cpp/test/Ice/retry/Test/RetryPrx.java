...
public interface RetryPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_sleepAsync(int iceP_delay, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "sleep", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(false, context, null, ostr -> {
