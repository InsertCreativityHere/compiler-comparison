...
public interface RemoteCommunicator extends com.zeroc.Ice.Object
{
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_addUpdateCallback(RemoteCommunicator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        obj.addUpdateCallback(current);
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_removeUpdateCallback(RemoteCommunicator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        obj.removeUpdateCallback(current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (current.operation)
        {
            ...
            case "addUpdateCallback" -> RemoteCommunicator._iceD_addUpdateCallback(this, in, current);
            case "removeUpdateCallback" -> RemoteCommunicator._iceD_removeUpdateCallback(this, in, current);
