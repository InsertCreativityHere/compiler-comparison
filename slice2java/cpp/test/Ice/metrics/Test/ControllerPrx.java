...
public interface ControllerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the hold operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_holdAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    /**
     * Invokes the resume operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_resumeAsync(java.util.Map<String, String> context, boolean sync)
    {
