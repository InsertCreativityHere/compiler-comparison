...
/**
 * Helper class for marshaling/unmarshaling LargeStructS.
 **/
public final class LargeStructSHelper
{
    /**
     * Marshals a list of {@code LargeStructS} into an output stream.
     *
    ...
    /**
     * Unmarshals a list of {@code LargeStructS} from an input stream.
     *
    ...
    /**
     * Marshals an optional list of {@code LargeStructS} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
     * @param v the list to marshal
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, LargeStruct[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            LargeStructSHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }

    /**
     * Unmarshals an optional list of {@code LargeStructS} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
     * @return the list
    ...
    public static java.util.Optional<LargeStruct[]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            LargeStruct[] v;
            v = LargeStructSHelper.read(istr);
