...
public final class LargeStruct implements java.lang.Cloneable, java.io.Serializable {
    public boolean bo;
    ...
    /**
     * Constructs a {@code LargeStruct} with values for all fields not marked optional in the Slice definition for {@code ::Test::LargeStruct}.
     */
    public LargeStruct(boolean bo, byte by, short sh, int i, long l, float f, double d, java.lang.String str, MyEnum e, MyInterfacePrx p) {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
        this.i = i;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code LargeStruct}
     */
    ...
    private static final long serialVersionUID = -7258905698663938445L;
}
