...
public interface TestIntf extends com.zeroc.Ice.Object
{
    ...
    int resetMaxConcurrentDispatches(com.zeroc.Ice.Current current);
    ...
    /** @hidden */
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_resetMaxConcurrentDispatches(TestIntf obj, com.zeroc.Ice.IncomingRequest request)
    {
        request.current.checkNonIdempotent();
        request.inputStream.skipEmptyEncapsulation();
        int ret = obj.resetMaxConcurrentDispatches(request.current);
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (request.current.operation)
        {
            ...
            case "resetMaxConcurrentDispatches" -> TestIntf._iceD_resetMaxConcurrentDispatches(this, request);
