...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int resetMaxConcurrentDispatches()
    {
        return resetMaxConcurrentDispatches(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int resetMaxConcurrentDispatches(java.util.Map<String, String> context)
    {
        return _iceI_resetMaxConcurrentDispatchesAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> resetMaxConcurrentDispatchesAsync()
    {
        return _iceI_resetMaxConcurrentDispatchesAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> resetMaxConcurrentDispatchesAsync(java.util.Map<String, String> context)
    {
        return _iceI_resetMaxConcurrentDispatchesAsync(context, false);
    }

    /**
     * Invokes the resetMaxConcurrentDispatches operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.Integer> _iceI_resetMaxConcurrentDispatchesAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<java.lang.Integer> f = new com.zeroc.Ice.OutgoingAsync<>(this, "resetMaxConcurrentDispatches", com.zeroc.Ice.OperationMode.Normal, sync, null);
