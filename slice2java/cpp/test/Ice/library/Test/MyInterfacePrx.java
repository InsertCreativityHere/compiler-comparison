...
public interface MyInterfacePrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default void op(boolean throwIt, java.util.Map<java.lang.String, java.lang.String> context)
        throws UserError {
        try {
    ...
    default java.util.concurrent.CompletableFuture<Void> opAsync(boolean throwIt, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_opAsync(throwIt, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_opAsync(boolean iceP_throwIt, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "op", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_op);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_op = {
        UserError.class
    };
