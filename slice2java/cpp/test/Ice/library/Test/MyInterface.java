...
public interface MyInterface extends com.zeroc.Ice.Object
{
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_op(MyInterface obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        {
            case "op" -> MyInterface._iceD_op(this, in, current);
