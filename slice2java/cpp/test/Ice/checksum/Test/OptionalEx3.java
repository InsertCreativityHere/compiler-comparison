...
public class OptionalEx3 extends com.zeroc.Ice.UserException
{
    ...
    public OptionalEx3(String firstName, String secondName, String emailAddress, String phoneNumber)
    {
        this.firstName = firstName;
    ...
    public OptionalEx3(String firstName, String secondName, String emailAddress, String phoneNumber, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        setSecondName(secondName);
    ...
    /** @hidden */
    public static final long serialVersionUID = 4255274530784811986L;
}
