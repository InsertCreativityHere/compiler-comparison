...
public class OptionalEx4 extends com.zeroc.Ice.UserException
{
    public OptionalEx4()
    {
        this.firstName = "";
    ...
    public OptionalEx4(Throwable cause)
    {
        super(cause);
        this.firstName = "";
        this.secondName = "";
    ...
    public OptionalEx4(String firstName)
    {
    ...
    public OptionalEx4(String firstName, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        this.emailAddress = "";
    ...
    public OptionalEx4(String firstName, String secondName, String emailAddress)
    {
        this.firstName = firstName;
    ...
    public OptionalEx4(String firstName, String secondName, String emailAddress, Throwable cause)
    {
        super(cause);
        this.firstName = firstName;
        setSecondName(secondName);
    ...
    protected void _readImpl(com.zeroc.Ice.InputStream istr_)
    {
        ...
        if(_secondName = istr_.readOptional(2, com.zeroc.Ice.OptionalFormat.VSize))
        {
    ...
    /** @hidden */
    public static final long serialVersionUID = -1868460709803683123L;
}
