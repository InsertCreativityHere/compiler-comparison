...
{
    default RemoteObjectAdapterPrx createObjectAdapter(int acmTimeout, int close, int heartbeat)
    {
        return createObjectAdapter(acmTimeout, close, heartbeat, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default RemoteObjectAdapterPrx createObjectAdapter(int acmTimeout, int close, int heartbeat, java.util.Map<String, String> context)
    {
        return _iceI_createObjectAdapterAsync(acmTimeout, close, heartbeat, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<RemoteObjectAdapterPrx> createObjectAdapterAsync(int acmTimeout, int close, int heartbeat)
    {
        return _iceI_createObjectAdapterAsync(acmTimeout, close, heartbeat, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<RemoteObjectAdapterPrx> createObjectAdapterAsync(int acmTimeout, int close, int heartbeat, java.util.Map<String, String> context)
    {
        return _iceI_createObjectAdapterAsync(acmTimeout, close, heartbeat, context, false);
    }

    /**
     * @hidden
     * @param iceP_acmTimeout -
     * @param iceP_close -
     * @param iceP_heartbeat -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<RemoteObjectAdapterPrx> _iceI_createObjectAdapterAsync(int iceP_acmTimeout, int iceP_close, int iceP_heartbeat, java.util.Map<String, String> context, boolean sync)
    {
