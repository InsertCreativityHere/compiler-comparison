...
public interface ControllerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void holdAdapter(int to, java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> holdAdapterAsync(int to, java.util.Map<String, String> context)
    {
