...
public interface ThrowerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void throwE(java.util.Map<String, String> context)
        throws E
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<Void> throwEAsync(java.util.Map<String, String> context)
    {
        return _iceI_throwEAsync(context, false);
    }

    /**
     * Invokes the throwE operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_throwEAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    /** @hidden */
    static final Class<?>[] _iceE_throwE =
    {
        E.class
    };
