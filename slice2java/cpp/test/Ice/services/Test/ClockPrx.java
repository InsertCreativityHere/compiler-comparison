...
public interface ClockPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Invokes the tick operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param iceP_time parameter
