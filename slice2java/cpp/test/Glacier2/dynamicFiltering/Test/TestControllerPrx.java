...
public interface TestControllerPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default TestControllerPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (TestControllerPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_adapterId(String newAdapterId)
    {
        return (TestControllerPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (TestControllerPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (TestControllerPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_invocationTimeout(int newTimeout)
    {
        return (TestControllerPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_connectionCached(boolean newCache)
    {
        return (TestControllerPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (TestControllerPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_secure(boolean b)
    {
        return (TestControllerPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (TestControllerPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_preferSecure(boolean b)
    {
        return (TestControllerPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (TestControllerPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (TestControllerPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_collocationOptimized(boolean b)
    {
        return (TestControllerPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_twoway()
    {
        return (TestControllerPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_oneway()
    {
        return (TestControllerPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_batchOneway()
    {
        return (TestControllerPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_datagram()
    {
        return (TestControllerPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_batchDatagram()
    {
        return (TestControllerPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_compress(boolean co)
    {
        return (TestControllerPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_timeout(int t)
    {
        return (TestControllerPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_connectionId(String connectionId)
    {
        return (TestControllerPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default TestControllerPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (TestControllerPrx)_ice_fixed(connection);
    }
