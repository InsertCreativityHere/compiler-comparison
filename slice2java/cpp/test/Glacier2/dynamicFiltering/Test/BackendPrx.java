...
public interface BackendPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void check(java.util.Map<String, String> context)
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> checkAsync(java.util.Map<String, String> context)
    {
        return _iceI_checkAsync(context, false);
    }

    /**
     * Invokes the check operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_checkAsync(java.util.Map<String, String> context, boolean sync)
    {
