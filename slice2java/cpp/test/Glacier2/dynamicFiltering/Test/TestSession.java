...
public interface TestSession extends com.zeroc.Glacier2.Session
{
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_shutdown(TestSession obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        throws com.zeroc.Ice.UserException
    {
        return switch (current.operation)
        {
            ...
            case "shutdown" -> TestSession._iceD_shutdown(this, in, current);
