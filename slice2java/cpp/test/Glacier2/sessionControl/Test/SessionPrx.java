...
public interface SessionPrx extends com.zeroc.Glacier2.SessionPrx
{
    ...
    /**
     * Invokes the destroyFromClient operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<Void> _iceI_destroyFromClientAsync(java.util.Map<String, String> context, boolean sync)
    {
