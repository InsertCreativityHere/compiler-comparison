...
public interface Session extends com.zeroc.Glacier2.Session {
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_destroyFromClient(Session obj, com.zeroc.Ice.IncomingRequest request) {
        ...
        var result = obj.destroyFromClientAsync(request.current);
    ...
    default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> dispatch(com.zeroc.Ice.IncomingRequest request)
        ...
        return switch (request.current.operation) {
            ...
            case "destroyFromClient" -> Session._iceD_destroyFromClient(this, request);
            case "shutdown" -> Session._iceD_shutdown(this, request);
