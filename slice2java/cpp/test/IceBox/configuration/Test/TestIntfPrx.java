...
public interface TestIntfPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getProperty(name, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getProperty(String name, java.util.Map<String, String> context)
    {
        return _iceI_getPropertyAsync(name, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getPropertyAsync(String name)
    {
        return _iceI_getPropertyAsync(name, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getPropertyAsync(String name, java.util.Map<String, String> context)
    {
        return _iceI_getPropertyAsync(name, context, false);
    }

    /**
     * Invokes the getProperty operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     ...
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<java.lang.String> _iceI_getPropertyAsync(String iceP_name, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<java.lang.String> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getProperty", com.zeroc.Ice.OperationMode.Normal, sync, null);
    ...
    {
        return getArgs(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String[] getArgs(java.util.Map<String, String> context)
    {
        return _iceI_getArgsAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String[]> getArgsAsync()
    {
        return _iceI_getArgsAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> getArgsAsync(java.util.Map<String, String> context)
    {
        return _iceI_getArgsAsync(context, false);
    }

    /**
     * Invokes the getArgs operation on this proxy with the given parameters and returns a future that will be completed with the result.
     *
     * @param context the request context
     * @param sync {@code true} if the operation is synchronous, {@code false} otherwise
     * @return a CompletableFuture that will be completed with the result of the operation
     * @hidden
     **/
    default com.zeroc.Ice.OutgoingAsync<String[]> _iceI_getArgsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.Ice.OutgoingAsync<String[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getArgs", com.zeroc.Ice.OperationMode.Normal, sync, null);
