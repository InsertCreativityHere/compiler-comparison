                                 ...
                                 ReplicaObserverPrx
{
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Node.LoadServerResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "loadServer", com.zeroc.Ice.OperationMode.Nonmutating, sync, _iceE_loadServer);
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Node.LoadServerWithoutRestartResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "loadServerWithoutRestart", com.zeroc.Ice.OperationMode.Nonmutating, sync, _iceE_loadServerWithoutRestart);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeValue(iceP_svr);
                     ostr.writeString(iceP_replicaName);
                     ostr.writePendingValues();
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "destroyServer", com.zeroc.Ice.OperationMode.Nonmutating, sync, _iceE_destroyServer);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "destroyServerWithoutRestart", com.zeroc.Ice.OperationMode.Nonmutating, sync, _iceE_destroyServerWithoutRestart);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_name);
                     ostr.writeString(iceP_uuid);
                     ostr.writeInt(iceP_revision);
