...
public interface Adapter extends com.zeroc.Ice.Object
{
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        {
            case "activate" -> Adapter._iceD_activate(this, in, current);
            case "getDirectProxy" -> Adapter._iceD_getDirectProxy(this, in, current);
            case "setDirectProxy" -> Adapter._iceD_setDirectProxy(this, in, current);
