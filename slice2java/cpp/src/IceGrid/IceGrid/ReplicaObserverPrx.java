...
public interface ReplicaObserverPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default void replicaInit(InternalRegistryPrx[] replicas, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> replicaInitAsync(InternalRegistryPrx[] replicas, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_replicaInitAsync(replicas, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_replicaInitAsync(InternalRegistryPrx[] iceP_replicas, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "replicaInit", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void replicaAdded(InternalRegistryPrx replica, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> replicaAddedAsync(InternalRegistryPrx replica, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_replicaAddedAsync(replica, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_replicaAddedAsync(InternalRegistryPrx iceP_replica, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "replicaAdded", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void replicaRemoved(InternalRegistryPrx replica, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> replicaRemovedAsync(InternalRegistryPrx replica, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_replicaRemovedAsync(replica, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_replicaRemovedAsync(InternalRegistryPrx iceP_replica, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "replicaRemoved", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeProxy(iceP_replica);
                 }, null);
        return f;
