...
public interface ReplicaSessionPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default void setDatabaseObserver(DatabaseObserverPrx dbObs, java.util.Map<java.lang.String, java.lang.Long> serials)
        throws com.zeroc.IceGrid.ObserverAlreadyRegisteredException, com.zeroc.IceGrid.DeploymentException {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void setDatabaseObserver(DatabaseObserverPrx dbObs, java.util.Map<java.lang.String, java.lang.Long> serials, java.util.Map<java.lang.String, java.lang.String> context)
        throws com.zeroc.IceGrid.ObserverAlreadyRegisteredException, com.zeroc.IceGrid.DeploymentException {
        try {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void setDatabaseObserver(DatabaseObserverPrx dbObs, java.util.Optional<java.util.Map<java.lang.String, java.lang.Long>> serials, java.util.Map<java.lang.String, java.lang.String> context)
        throws com.zeroc.IceGrid.ObserverAlreadyRegisteredException, com.zeroc.IceGrid.DeploymentException {
        try {
            _iceI_setDatabaseObserverAsync(dbObs, serials, context, true).waitForResponseOrUserEx();
        } catch (com.zeroc.IceGrid.ObserverAlreadyRegisteredException ex) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setDatabaseObserverAsync(DatabaseObserverPrx dbObs, java.util.Map<java.lang.String, java.lang.Long> serials, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setDatabaseObserverAsync(DatabaseObserverPrx dbObs, java.util.Optional<java.util.Map<java.lang.String, java.lang.Long>> serials, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_setDatabaseObserverAsync(dbObs, serials, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_setDatabaseObserverAsync(DatabaseObserverPrx iceP_dbObs, java.util.Map<java.lang.String, java.lang.Long> iceP_serials, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_setDatabaseObserverAsync(DatabaseObserverPrx iceP_dbObs, java.util.Optional<java.util.Map<java.lang.String, java.lang.Long>> iceP_serials, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "setDatabaseObserver", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setDatabaseObserver);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeProxy(iceP_dbObs);
                     StringLongDictHelper.write(ostr, 1, iceP_serials);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_setDatabaseObserver = {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void setEndpoints(java.util.Map<java.lang.String, com.zeroc.Ice.ObjectPrx> endpoints, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setEndpointsAsync(java.util.Map<java.lang.String, com.zeroc.Ice.ObjectPrx> endpoints, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_setEndpointsAsync(endpoints, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_setEndpointsAsync(java.util.Map<java.lang.String, com.zeroc.Ice.ObjectPrx> iceP_endpoints, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void registerWellKnownObjects(com.zeroc.IceGrid.ObjectInfo[] objects, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> registerWellKnownObjectsAsync(com.zeroc.IceGrid.ObjectInfo[] objects, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_registerWellKnownObjectsAsync(objects, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_registerWellKnownObjectsAsync(com.zeroc.IceGrid.ObjectInfo[] iceP_objects, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default void setAdapterDirectProxy(java.lang.String adapterId, java.lang.String replicaGroupId, com.zeroc.Ice.ObjectPrx proxy)
        throws com.zeroc.IceGrid.AdapterNotExistException, AdapterExistsException {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void setAdapterDirectProxy(java.lang.String adapterId, java.lang.String replicaGroupId, com.zeroc.Ice.ObjectPrx proxy, java.util.Map<java.lang.String, java.lang.String> context)
        throws com.zeroc.IceGrid.AdapterNotExistException, AdapterExistsException {
        try {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setAdapterDirectProxyAsync(java.lang.String adapterId, java.lang.String replicaGroupId, com.zeroc.Ice.ObjectPrx proxy) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> setAdapterDirectProxyAsync(java.lang.String adapterId, java.lang.String replicaGroupId, com.zeroc.Ice.ObjectPrx proxy, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_setAdapterDirectProxyAsync(adapterId, replicaGroupId, proxy, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_setAdapterDirectProxyAsync(java.lang.String iceP_adapterId, java.lang.String iceP_replicaGroupId, com.zeroc.Ice.ObjectPrx iceP_proxy, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default void receivedUpdate(TopicName name, int serial, java.lang.String failure) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void receivedUpdate(TopicName name, int serial, java.lang.String failure, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> receivedUpdateAsync(TopicName name, int serial, java.lang.String failure) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> receivedUpdateAsync(TopicName name, int serial, java.lang.String failure, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_receivedUpdateAsync(name, serial, failure, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_receivedUpdateAsync(TopicName iceP_name, int iceP_serial, java.lang.String iceP_failure, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "receivedUpdate", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
     ...
     */
    static ReplicaSessionPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ReplicaSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ReplicaSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static ReplicaSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static ReplicaSessionPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _ReplicaSessionPrxI(obj.ice_facet(facet));
    }

    @Override
    ReplicaSessionPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    ReplicaSessionPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    ReplicaSessionPrx ice_connectionId(java.lang.String connectionId);
