...
public interface FileReaderPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default long getOffsetFromEnd(java.lang.String filename, int lines)
     ...
     */
    default long getOffsetFromEnd(java.lang.String filename, int lines, java.util.Map<java.lang.String, java.lang.String> context)
        throws com.zeroc.IceGrid.FileNotAvailableException {
        try {
     ...
     */
    default java.util.concurrent.CompletableFuture<java.lang.Long> getOffsetFromEndAsync(java.lang.String filename, int lines) {
     ...
     * @return A future that will be completed with the result.
     */
    default java.util.concurrent.CompletableFuture<java.lang.Long> getOffsetFromEndAsync(java.lang.String filename, int lines, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getOffsetFromEndAsync(filename, lines, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<java.lang.Long> _iceI_getOffsetFromEndAsync(java.lang.String iceP_filename, int iceP_lines, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_getOffsetFromEnd = {
     ...
     */
    default FileReader.ReadResult read(java.lang.String filename, long pos, int size)
        throws com.zeroc.IceGrid.FileNotAvailableException {
     ...
     * @return An instance of FileReader.ReadResult.
     */
    default FileReader.ReadResult read(java.lang.String filename, long pos, int size, java.util.Map<java.lang.String, java.lang.String> context)
        throws com.zeroc.IceGrid.FileNotAvailableException {
        try {
     ...
     */
    default java.util.concurrent.CompletableFuture<FileReader.ReadResult> readAsync(java.lang.String filename, long pos, int size) {
     ...
     * @return A future that will be completed with an instance of FileReader.ReadResult.
     */
    default java.util.concurrent.CompletableFuture<FileReader.ReadResult> readAsync(java.lang.String filename, long pos, int size, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_readAsync(filename, pos, size, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<FileReader.ReadResult> _iceI_readAsync(java.lang.String iceP_filename, long iceP_pos, int iceP_size, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_read = {
        com.zeroc.IceGrid.FileNotAvailableException.class
    };
     ...
     */
    static FileReaderPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileReaderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileReaderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static FileReaderPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static FileReaderPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _FileReaderPrxI(obj.ice_facet(facet));
    }

    @Override
    FileReaderPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    FileReaderPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    FileReaderPrx ice_connectionId(java.lang.String connectionId);
