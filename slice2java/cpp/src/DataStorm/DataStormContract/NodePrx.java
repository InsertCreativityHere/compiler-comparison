...
public interface NodePrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @see Lookup::announceTopicReader
     */
    default void initiateCreateSession(NodePrx publisher, java.util.Map<java.lang.String, java.lang.String> context)
        throws SessionCreationException {
        try {
            _iceI_initiateCreateSessionAsync(publisher, context, true).waitForResponseOrUserEx();
     ...
     * @see Lookup::announceTopicReader
     */
    default java.util.concurrent.CompletableFuture<Void> initiateCreateSessionAsync(NodePrx publisher, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_initiateCreateSessionAsync(publisher, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_initiateCreateSessionAsync(NodePrx iceP_publisher, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "initiateCreateSession", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_initiateCreateSession);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_initiateCreateSession = {
     ...
     * @throws DataStormContract.SessionCreationException Thrown when the session cannot be created.
     */
    default void createSession(NodePrx subscriber, SubscriberSessionPrx session, boolean fromRelay, java.util.Map<java.lang.String, java.lang.String> context)
        throws SessionCreationException {
        try {
            _iceI_createSessionAsync(subscriber, session, fromRelay, context, true).waitForResponseOrUserEx();
        } catch (SessionCreationException ex) {
            throw ex;
        } catch (com.zeroc.Ice.UserException ex) {
            throw com.zeroc.Ice.UnknownUserException.fromTypeId(ex.ice_id());
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> createSessionAsync(NodePrx subscriber, SubscriberSessionPrx session, boolean fromRelay, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_createSessionAsync(subscriber, session, fromRelay, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_createSessionAsync(NodePrx iceP_subscriber, SubscriberSessionPrx iceP_session, boolean iceP_fromRelay, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "createSession", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_createSession);
        f.invoke(true, context, null, ostr -> {
     ...
     * @throws DataStormContract.SessionCreationException Thrown when the session cannot be created.
     */
    default void confirmCreateSession(NodePrx publisher, PublisherSessionPrx session, java.util.Map<java.lang.String, java.lang.String> context)
        throws SessionCreationException {
        try {
            _iceI_confirmCreateSessionAsync(publisher, session, context, true).waitForResponseOrUserEx();
        } catch (SessionCreationException ex) {
            throw ex;
        } catch (com.zeroc.Ice.UserException ex) {
            throw com.zeroc.Ice.UnknownUserException.fromTypeId(ex.ice_id());
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> confirmCreateSessionAsync(NodePrx publisher, PublisherSessionPrx session, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_confirmCreateSessionAsync(publisher, session, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_confirmCreateSessionAsync(NodePrx iceP_publisher, PublisherSessionPrx iceP_session, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "confirmCreateSession", com.zeroc.Ice.OperationMode.Normal, sync, _iceE_confirmCreateSession);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeProxy(iceP_publisher);
                     ostr.writeProxy(iceP_session);
                 }, null);
    ...
    /** @hidden */
    static final java.lang.Class<?>[] _iceE_confirmCreateSession = {
        SessionCreationException.class
    };
     ...
     */
    static NodePrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static NodePrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static NodePrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static NodePrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static NodePrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _NodePrxI(obj.ice_facet(facet));
    }

    @Override
    NodePrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    NodePrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    NodePrx ice_connectionId(java.lang.String connectionId);
