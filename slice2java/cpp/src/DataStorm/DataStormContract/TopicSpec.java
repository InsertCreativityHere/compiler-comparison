 ...
 */
public final class TopicSpec implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code TopicSpec} with values for all fields not marked optional in the Slice definition for {@code ::DataStormContract::TopicSpec}.
     *
     * @param id The unique identifier for the topic.
     * @param name The name of the topic.
     * @param elements The topic's keys and filters.
     * @param tags The topic update tags.
     */
    public TopicSpec(long id, java.lang.String name, ElementInfo[] elements, ElementInfo[] tags) {
        this.id = id;
        this.name = name;
    ...
    /**
     * Marshals a {@code TopicSpec} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code TopicSpec} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code TopicSpec} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code TopicSpec}
     */
    ...
    /**
     * Marshals an optional {@code TopicSpec} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code TopicSpec} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = 4935255981629619220L;
}
