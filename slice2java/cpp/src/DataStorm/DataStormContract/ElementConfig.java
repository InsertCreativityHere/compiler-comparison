 ...
 */
@com.zeroc.Ice.SliceTypeId(value = "::DataStormContract::ElementConfig")
...
public class ElementConfig extends com.zeroc.Ice.Value {
    ...
    /**
     * Constructs a {@code ElementConfig}.
     */
    ...
    /**
     * Constructs a {@code ElementConfig} with values for all its fields.
     *
     ...
     */
    public ElementConfig(java.lang.String facet, FilterInfo sampleFilter, java.lang.String name, int priority, int sampleCount, int sampleLifetime, ClearHistoryPolicy clearHistory) {
        setFacet(facet);
    ...
    private static final long serialVersionUID = 2793070542856678744L;
}
