 ...
 */
@com.zeroc.Ice.SliceTypeId(value = "::DataStormContract::Lookup")
public interface LookupPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default void announceTopicReader(java.lang.String topic, NodePrx subscriber) {
     ...
     */
    default void announceTopicReader(java.lang.String topic, NodePrx subscriber, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicReaderAsync(java.lang.String topic, NodePrx subscriber) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicReaderAsync(java.lang.String topic, NodePrx subscriber, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_announceTopicReaderAsync(topic, subscriber, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_announceTopicReaderAsync(java.lang.String iceP_topic, NodePrx iceP_subscriber, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default void announceTopicWriter(java.lang.String topic, NodePrx node) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void announceTopicWriter(java.lang.String topic, NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicWriterAsync(java.lang.String topic, NodePrx node) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicWriterAsync(java.lang.String topic, NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_announceTopicWriterAsync(topic, node, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_announceTopicWriterAsync(java.lang.String iceP_topic, NodePrx iceP_node, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     */
    default void announceTopics(java.lang.String[] readers, java.lang.String[] writers, NodePrx node) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void announceTopics(java.lang.String[] readers, java.lang.String[] writers, NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicsAsync(java.lang.String[] readers, java.lang.String[] writers, NodePrx node) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicsAsync(java.lang.String[] readers, java.lang.String[] writers, NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_announceTopicsAsync(readers, writers, node, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_announceTopicsAsync(java.lang.String[] iceP_readers, java.lang.String[] iceP_writers, NodePrx iceP_node, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
     ...
     * @return A proxy to this node. The proxy is never null.
     */
    default NodePrx createSession(NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy to this node. The proxy is never null.
     */
    default java.util.concurrent.CompletableFuture<NodePrx> createSessionAsync(NodePrx node, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_createSessionAsync(node, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<NodePrx> _iceI_createSessionAsync(NodePrx iceP_node, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<NodePrx> f = new com.zeroc.Ice.OutgoingAsync<>(this, "createSession", com.zeroc.Ice.OperationMode.Normal, sync, null);
