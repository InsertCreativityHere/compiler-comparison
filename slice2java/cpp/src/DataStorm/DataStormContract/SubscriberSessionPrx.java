 ...
 */
@com.zeroc.Ice.SliceTypeId(value = "::DataStormContract::SubscriberSession")
public interface SubscriberSessionPrx extends SessionPrx {
     ...
     */
    default void s(long topicId, long elementId, DataSample sample, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> sAsync(long topicId, long elementId, DataSample sample, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_sAsync(topicId, elementId, sample, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_sAsync(long iceP_topicId, long iceP_elementId, DataSample iceP_sample, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "s", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    static SubscriberSessionPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SubscriberSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SubscriberSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static SubscriberSessionPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static SubscriberSessionPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _SubscriberSessionPrxI(obj.ice_facet(facet));
    }

    @Override
    SubscriberSessionPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    SubscriberSessionPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    SubscriberSessionPrx ice_connectionId(java.lang.String connectionId);
