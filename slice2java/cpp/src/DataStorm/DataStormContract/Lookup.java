...
public interface Lookup extends com.zeroc.Ice.Object {
     ...
     */
    void announceTopicReader(java.lang.String topic, NodePrx subscriber, com.zeroc.Ice.Current current);
     ...
     * @param current The Current object of the incoming request.
     */
    void announceTopicWriter(java.lang.String topic, NodePrx node, com.zeroc.Ice.Current current);
     ...
     * @param current The Current object of the incoming request.
     */
    void announceTopics(java.lang.String[] readers, java.lang.String[] writers, NodePrx node, com.zeroc.Ice.Current current);
    ...
    /**
     * Dispatches the operation announceTopicReader.
     *
    ...
    /**
     * Dispatches the operation announceTopicWriter.
     *
     * @param obj the servant object
     * @param request the incoming request
     * @return a {@code CompletionStage} that will complete when the dispatch is done
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutgoingResponse> _iceD_announceTopics(Lookup obj, com.zeroc.Ice.IncomingRequest request) {
        com.zeroc.Ice.InputStream istr = request.inputStream;
        istr.startEncapsulation();
        java.lang.String[] iceP_readers;
        java.lang.String[] iceP_writers;
        NodePrx iceP_node;
