...
public interface SessionPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @see attachTopic
     */
    default void announceTopics(TopicInfo[] topics, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @see attachTopic
     */
    default java.util.concurrent.CompletableFuture<Void> announceTopicsAsync(TopicInfo[] topics, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_announceTopicsAsync(topics, initialize, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_announceTopicsAsync(TopicInfo[] iceP_topics, boolean iceP_initialize, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "announceTopics", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void attachTopic(TopicSpec topic, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> attachTopicAsync(TopicSpec topic, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_attachTopicAsync(topic, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_attachTopicAsync(TopicSpec iceP_topic, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "attachTopic", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void detachTopic(long topicId, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> detachTopicAsync(long topicId, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_detachTopicAsync(topicId, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_detachTopicAsync(long iceP_topicId, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "detachTopic", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void attachTags(long topicId, ElementInfo[] tags, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> attachTagsAsync(long topicId, ElementInfo[] tags, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_attachTagsAsync(topicId, tags, initialize, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_attachTagsAsync(long iceP_topicId, ElementInfo[] iceP_tags, boolean iceP_initialize, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "attachTags", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void detachTags(long topicId, long[] tags, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> detachTagsAsync(long topicId, long[] tags, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_detachTagsAsync(topicId, tags, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_detachTagsAsync(long iceP_topicId, long[] iceP_tags, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "detachTags", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @see attachElements
     */
    default void announceElements(long topicId, ElementInfo[] elements, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @see attachElements
     */
    default java.util.concurrent.CompletableFuture<Void> announceElementsAsync(long topicId, ElementInfo[] elements, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_announceElementsAsync(topicId, elements, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_announceElementsAsync(long iceP_topicId, ElementInfo[] iceP_elements, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "announceElements", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void attachElements(long topicId, ElementSpec[] elements, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> attachElementsAsync(long topicId, ElementSpec[] elements, boolean initialize, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_attachElementsAsync(topicId, elements, initialize, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_attachElementsAsync(long iceP_topicId, ElementSpec[] iceP_elements, boolean iceP_initialize, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "attachElements", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> attachElementsAckAsync(long topicId, ElementSpecAck[] elements, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_attachElementsAckAsync(topicId, elements, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_attachElementsAckAsync(long iceP_topicId, ElementSpecAck[] iceP_elements, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "attachElementsAck", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void detachElements(long topicId, long[] elements, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> detachElementsAsync(long topicId, long[] elements, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_detachElementsAsync(topicId, elements, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_detachElementsAsync(long iceP_topicId, long[] iceP_elements, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "detachElements", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> initSamplesAsync(long topicId, DataSamples[] samples, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_initSamplesAsync(topicId, samples, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_initSamplesAsync(long iceP_topicId, DataSamples[] iceP_samples, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "initSamples", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_topicId);
     ...
     * @param context The Context map to send with the invocation.
     */
    default void disconnected(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> disconnectedAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_disconnectedAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_disconnectedAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "disconnected", com.zeroc.Ice.OperationMode.Normal, sync, null);
