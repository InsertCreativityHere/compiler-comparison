 ...
 */
public final class LinkRecord implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code LinkRecord}.
     */
    public LinkRecord() {
    }

    /**
     * Constructs a {@code LinkRecord} with values for all fields not marked optional in the Slice definition for {@code ::IceStorm::LinkRecord}.
     *
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code LinkRecord}
     */
    ...
    private static final long serialVersionUID = -1129311346814354496L;
}
