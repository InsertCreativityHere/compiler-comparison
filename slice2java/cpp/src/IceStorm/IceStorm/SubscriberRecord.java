 ...
 */
public final class SubscriberRecord implements java.lang.Cloneable, java.io.Serializable {
    /**
    ...
    /**
     * Constructs a {@code SubscriberRecord}.
     */
    ...
    /**
     * Constructs a {@code SubscriberRecord} with values for all fields not marked optional in the Slice definition for {@code ::IceStorm::SubscriberRecord}.
     *
     ...
     */
    public SubscriberRecord(java.lang.String topicName, com.zeroc.Ice.Identity id, boolean link, com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> theQoS, int cost, com.zeroc.IceStorm.TopicPrx theTopic) {
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code SubscriberRecord}
     */
    ...
    private static final long serialVersionUID = 5424723867661048466L;
}
