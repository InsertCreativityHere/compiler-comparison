 ...
 */
public final class SubscriberRecordKey implements java.lang.Cloneable, java.io.Serializable {
    /**
     * The topic identity.
     */
    ...
    /**
     * Constructs a {@code SubscriberRecordKey}.
     */
    ...
    /**
     * Constructs a {@code SubscriberRecordKey} with values for all fields not marked optional in the Slice definition for {@code ::IceStorm::SubscriberRecordKey}.
     *
     * @param topic The topic identity.
    ...
    /**
     * Marshals a {@code SubscriberRecordKey} into an output stream.
     *
     * @param ostr the output stream
     * @param v the {@code SubscriberRecordKey} to marshal; can be null
     */
    ...
    /**
     * Unmarshals a {@code SubscriberRecordKey} from an input stream.
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code SubscriberRecordKey}
     */
    ...
    /**
     * Marshals an optional {@code SubscriberRecordKey} into an output stream.
     *
     * @param ostr the output stream
     * @param tag the tag
    ...
    /**
     * Unmarshals an optional {@code SubscriberRecordKey} from an input stream.
     *
     * @param istr the input stream
     * @param tag the tag
    ...
    private static final long serialVersionUID = 7207757197833429840L;
}
