...
public interface NodePrx extends com.zeroc.Ice.ObjectPrx {
     ...
     */
    default void invitation(int j, java.lang.String gn) {
     ...
     */
    default void invitation(int j, java.lang.String gn, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     */
    default java.util.concurrent.CompletableFuture<Void> invitationAsync(int j, java.lang.String gn) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> invitationAsync(int j, java.lang.String gn, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_invitationAsync(j, gn, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_invitationAsync(int iceP_j, java.lang.String iceP_gn, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "invitation", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    default void ready(int j, java.lang.String gn, com.zeroc.Ice.ObjectPrx coordinator, int max, long generation) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void ready(int j, java.lang.String gn, com.zeroc.Ice.ObjectPrx coordinator, int max, long generation, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> readyAsync(int j, java.lang.String gn, com.zeroc.Ice.ObjectPrx coordinator, int max, long generation) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> readyAsync(int j, java.lang.String gn, com.zeroc.Ice.ObjectPrx coordinator, int max, long generation, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_readyAsync(j, gn, coordinator, max, generation, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_readyAsync(int iceP_j, java.lang.String iceP_gn, com.zeroc.Ice.ObjectPrx iceP_coordinator, int iceP_max, long iceP_generation, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "ready", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_j);
                     ostr.writeString(iceP_gn);
     ...
     * @param max The highest priority node seen by this replica group.
     */
    default void accept(int j, java.lang.String gn, int[] forwardedInvites, com.zeroc.Ice.ObjectPrx observer, LogUpdate llu, int max) {
     ...
     * @param context The Context map to send with the invocation.
     */
    default void accept(int j, java.lang.String gn, int[] forwardedInvites, com.zeroc.Ice.ObjectPrx observer, LogUpdate llu, int max, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> acceptAsync(int j, java.lang.String gn, int[] forwardedInvites, com.zeroc.Ice.ObjectPrx observer, LogUpdate llu, int max) {
     ...
     * @return A future that will be completed when the invocation completes.
     */
    default java.util.concurrent.CompletableFuture<Void> acceptAsync(int j, java.lang.String gn, int[] forwardedInvites, com.zeroc.Ice.ObjectPrx observer, LogUpdate llu, int max, java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_acceptAsync(j, gn, forwardedInvites, observer, llu, max, context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<Void> _iceI_acceptAsync(int iceP_j, java.lang.String iceP_gn, int[] iceP_forwardedInvites, com.zeroc.Ice.ObjectPrx iceP_observer, LogUpdate iceP_llu, int iceP_max, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<Void> f = new com.zeroc.Ice.OutgoingAsync<>(this, "accept", com.zeroc.Ice.OperationMode.Normal, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_j);
                     ostr.writeString(iceP_gn);
    ...
    private com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> _iceI_areYouCoordinatorAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.Ice.OutgoingAsync<>(this, "areYouCoordinator", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    private com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> _iceI_areYouThereAsync(java.lang.String iceP_gn, int iceP_j, java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.Ice.OutgoingAsync<>(this, "areYouThere", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
     ...
     * @return The sync object.
     */
    default com.zeroc.Ice.ObjectPrx sync(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return The sync object.
     */
    default java.util.concurrent.CompletableFuture<com.zeroc.Ice.ObjectPrx> syncAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_syncAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx> _iceI_syncAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<com.zeroc.Ice.ObjectPrx> f = new com.zeroc.Ice.OutgoingAsync<>(this, "sync", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
     ...
     * @return The set of configured nodes and the associated priority.
     */
    default NodeInfo[] nodes(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return The set of configured nodes and the associated priority.
     */
    default java.util.concurrent.CompletableFuture<NodeInfo[]> nodesAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_nodesAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<NodeInfo[]> _iceI_nodesAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<NodeInfo[]> f = new com.zeroc.Ice.OutgoingAsync<>(this, "nodes", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     NodeInfo[] ret;
     ...
     * @return The query information.
     */
    default QueryInfo query(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return The query information.
     */
    default java.util.concurrent.CompletableFuture<QueryInfo> queryAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_queryAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<QueryInfo> _iceI_queryAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<QueryInfo> f = new com.zeroc.Ice.OutgoingAsync<>(this, "query", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     QueryInfo ret;
