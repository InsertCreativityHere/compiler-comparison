...
public interface TopicManagerSyncPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (TopicManagerSyncPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_adapterId(String newAdapterId)
    {
        return (TopicManagerSyncPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (TopicManagerSyncPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (TopicManagerSyncPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_invocationTimeout(int newTimeout)
    {
        return (TopicManagerSyncPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_connectionCached(boolean newCache)
    {
        return (TopicManagerSyncPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (TopicManagerSyncPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_secure(boolean b)
    {
        return (TopicManagerSyncPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (TopicManagerSyncPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_preferSecure(boolean b)
    {
        return (TopicManagerSyncPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (TopicManagerSyncPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (TopicManagerSyncPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_collocationOptimized(boolean b)
    {
        return (TopicManagerSyncPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_twoway()
    {
        return (TopicManagerSyncPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_oneway()
    {
        return (TopicManagerSyncPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_batchOneway()
    {
        return (TopicManagerSyncPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_datagram()
    {
        return (TopicManagerSyncPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_batchDatagram()
    {
        return (TopicManagerSyncPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_compress(boolean co)
    {
        return (TopicManagerSyncPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_timeout(int t)
    {
        return (TopicManagerSyncPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_connectionId(String connectionId)
    {
        return (TopicManagerSyncPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default TopicManagerSyncPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (TopicManagerSyncPrx)_ice_fixed(connection);
    }
