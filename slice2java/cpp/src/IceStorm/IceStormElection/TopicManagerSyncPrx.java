 ...
 */
@com.zeroc.Ice.SliceTypeId(value = "::IceStormElection::TopicManagerSync")
public interface TopicManagerSyncPrx extends com.zeroc.Ice.ObjectPrx {
     ...
     * @return An instance of TopicManagerSync.GetContentResult.
     */
    default TopicManagerSync.GetContentResult getContent(java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A future that will be completed with an instance of TopicManagerSync.GetContentResult.
     */
    default java.util.concurrent.CompletableFuture<TopicManagerSync.GetContentResult> getContentAsync(java.util.Map<java.lang.String, java.lang.String> context) {
        return _iceI_getContentAsync(context, false);
    }

    private com.zeroc.Ice.OutgoingAsync<TopicManagerSync.GetContentResult> _iceI_getContentAsync(java.util.Map<java.lang.String, java.lang.String> context, boolean sync) {
        com.zeroc.Ice.OutgoingAsync<TopicManagerSync.GetContentResult> f = new com.zeroc.Ice.OutgoingAsync<>(this, "getContent", com.zeroc.Ice.OperationMode.Normal, sync, null);
     ...
     */
    static TopicManagerSyncPrx createProxy(com.zeroc.Ice.Communicator communicator, java.lang.String proxyString) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerSyncPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerSyncPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     */
    static TopicManagerSyncPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet, java.util.Map<java.lang.String, java.lang.String> context) {
     ...
     * @return A proxy for this type.
     */
    static TopicManagerSyncPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, java.lang.String facet) {
        return (obj == null) ? null : new _TopicManagerSyncPrxI(obj.ice_facet(facet));
    }

    @Override
    TopicManagerSyncPrx ice_context(java.util.Map<java.lang.String, java.lang.String> newContext);

    @Override
    TopicManagerSyncPrx ice_adapterId(java.lang.String newAdapterId);
    ...
    @Override
    TopicManagerSyncPrx ice_connectionId(java.lang.String connectionId);
