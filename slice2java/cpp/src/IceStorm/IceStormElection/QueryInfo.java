...
public final class QueryInfo implements java.lang.Cloneable, java.io.Serializable {
    /**
     * The node id.
     */
    public int id;
    ...
    /**
     * Constructs a {@code QueryInfo} with values for all fields not marked optional in the Slice definition for {@code ::IceStormElection::QueryInfo}.
     *
     ...
     */
    public QueryInfo(int id, int coord, java.lang.String group, com.zeroc.Ice.ObjectPrx replica, NodeState state, GroupInfo[] up, int max) {
        this.id = id;
        this.coord = coord;
        this.group = group;
     ...
     *
     * @param istr the input stream 
     * @return the unmarshaled {@code QueryInfo}
     */
    ...
    private static final long serialVersionUID = -1829381350760834804L;
}
