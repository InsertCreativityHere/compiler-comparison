...
private final class MyOtherDerivedClassPrxI: Ice.ObjectPrxI, MyOtherDerivedClassPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
private final class DiamondClassPrxI: Ice.ObjectPrxI, DiamondClassPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
extension MyOtherDerivedClass {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<MyOtherDerivedClassTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: MyOtherDerivedClass, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "shutdown":
            try await servant._iceD_shutdown(request)
        case "getContext":
...
extension DiamondClass {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<DiamondClassTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: DiamondClass, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "shutdown":
            try await servant._iceD_shutdown(request)
        case "getContext":
