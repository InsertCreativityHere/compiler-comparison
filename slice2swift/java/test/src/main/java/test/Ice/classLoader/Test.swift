...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_ConcreteClass() -> AnyObject.Type {
        ConcreteClass.self
    }
}
...
public extension InitialPrx {
    func getConcreteClass(context: Ice.Context? = nil) async throws -> ConcreteClass? {
        ...
        func read(istr: Ice.InputStream) throws -> sending ConcreteClass? {
            nonisolated(unsafe) var iceP_returnValue: ConcreteClass?
    ...
    func throwException(context: Ice.Context? = nil) async throws {
