...
public struct BaseSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending BaseS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = BaseS(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BaseS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `BaseS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `BaseS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct StringBaseDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringBaseD {
        let sz = try Swift.Int(istr.readSize())
        var v = StringBaseD()
        nonisolated(unsafe) let e = Ice.DictEntryArray<Swift.String, Base?>(size: sz)
        for i in 0 ..< sz {
            let key: Swift.String = try istr.read()
            v[key] = nil as Base?
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringBaseD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `StringBaseD` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `StringBaseD?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
open class Base: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        try istr.read(Base.self) { iceP_self.b = $0 }
        try istr.read() { iceP_self.o = $0 }
        iceP_self.s = try istr.read()
        iceP_self.seq1 = try istr.read()
        iceP_self.seq2 = try istr.read()
        iceP_self.seq3 = try MyEnumSHelper.read(from: istr)
        iceP_self.seq4 = try BaseSHelper.read(from: istr)
        iceP_self.d1 = try ByteBoolDHelper.read(from: istr)
        iceP_self.d2 = try ShortIntDHelper.read(from: istr)
        iceP_self.d3 = try StringMyEnumDHelper.read(from: istr)
        iceP_self.d4 = try StringBaseDHelper.read(from: istr)
        try istr.endSlice()
    }
...
open class Derived: Base {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.p = try istr.read(Ice.ObjectPrx.self)
        try istr.endSlice()
...
public extension InitialPrx {
    func getStruct1(context: Ice.Context? = nil) async throws -> ByteS {
        ...
        func read(istr: Ice.InputStream) throws -> sending ByteS {
