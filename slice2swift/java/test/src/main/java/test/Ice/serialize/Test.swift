...
public extension InitialPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<ByteS>` - The result of the operation
    func getStruct1Async(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ByteS> {
        return _impl._invokeAsync(operation: "getStruct1",
                                  mode: .Normal,
                                  read: { istr in
                                      let iceP_returnValue: ByteS = try istr.read()
                                      return iceP_returnValue
    ...
    ///
    /// - returns: `PromiseKit.Promise<ByteS>` - The result of the operation
    func getBaseAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ByteS> {
        return _impl._invokeAsync(operation: "getBase",
                                  mode: .Normal,
                                  read: { istr in
                                      let iceP_returnValue: ByteS = try istr.read()
                                      return iceP_returnValue
    ...
    ///
    /// - returns: `PromiseKit.Promise<ByteS>` - The result of the operation
    func getExAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ByteS> {
        return _impl._invokeAsync(operation: "getEx",
                                  mode: .Normal,
                                  read: { istr in
                                      let iceP_returnValue: ByteS = try istr.read()
                                      return iceP_returnValue
...
public struct InitialDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "getBase":
            return try servant._iceD_getBase(incoming: request, current: current)
        case "getEx":
            return try servant._iceD_getEx(incoming: request, current: current)
        case "getStruct1":
            return try servant._iceD_getStruct1(incoming: request, current: current)
        case "ice_id":
...
public protocol Initial {
    ...
    ///
    /// - returns: `ByteS`
    func getStruct1(current: Ice.Current) throws -> ByteS

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ByteS`
    func getBase(current: Ice.Current) throws -> ByteS

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ByteS`
    func getEx(current: Ice.Current) throws -> ByteS
...
public extension Initial {
    func _iceD_getStruct1(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        let iceP_returnValue = try self.getStruct1(current: current)
    ...
    func _iceD_getBase(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        let iceP_returnValue = try self.getBase(current: current)
    ...
    func _iceD_getEx(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        let iceP_returnValue = try self.getEx(current: current)
