...
private final class BackgroundPrxI: Ice.ObjectPrxI, BackgroundPrx, @unchecked Sendable {
...
private final class BackgroundControllerPrxI: Ice.ObjectPrxI, BackgroundControllerPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension BackgroundControllerPrx {
    func pauseCall(_ iceP_call: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    func resumeCall(_ iceP_call: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    func initializeSocketStatus(_ iceP_status: Swift.Int32, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "initializeSocketStatus",
                                       mode: .normal,
                                       write: { ostr in
    ...
    func initializeException(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func readReady(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func readException(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func writeReady(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func writeException(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func buffered(_ iceP_enable: Swift.Bool, context: Ice.Context? = nil) async throws {
...
public protocol Background: Ice.Dispatcher {
...
public protocol BackgroundController: Ice.Dispatcher {
...
extension Background {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<BackgroundTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Background, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension BackgroundController {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<BackgroundControllerTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: BackgroundController, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "pauseCall":
