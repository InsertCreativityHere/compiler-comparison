...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_InterruptedException() -> AnyObject.Type {
        InterruptedException.self
    }
}

open class InterruptedException: Ice.UserException, @unchecked Sendable {
    /// - Returns: The Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test::InterruptedException" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: InterruptedException.ice_staticId(), compactId: -1, last: true)
        ostr.endSlice()
    }
    ...
    func sleep(_ iceP_to: Swift.Int32, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "sleep",
                                       ...
                                       userException:{ ex in
                                           do  {
                                               throw ex
                                           } catch let error as InterruptedException {
                                               throw error
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CannotInterruptException() -> AnyObject.Type {
        CannotInterruptException.self
    }
}

open class CannotInterruptException: Ice.UserException, @unchecked Sendable {
    /// - Returns: The Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test::CannotInterruptException" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: CannotInterruptException.ice_staticId(), compactId: -1, last: true)
        ostr.endSlice()
    }
...
public extension TestIntfControllerPrx {
    ...
    func interrupt(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "interrupt",
                                       mode: .normal,
                                       userException:{ ex in
                                           do  {
                                               throw ex
                                           } catch let error as CannotInterruptException {
                                               throw error
                                           } catch is Ice.UserException {}
                                       },
                                       context: context)
