...
/// :nodoc:
public class InterruptedException_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
        return InterruptedException.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test_InterruptedException() -> Ice.UserExceptionTypeResolver {
        return InterruptedException_TypeResolver()
    }
}
...
/// :nodoc:
public class CannotInterruptException_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
        return CannotInterruptException.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test_CannotInterruptException() -> Ice.UserExceptionTypeResolver {
        return CannotInterruptException_TypeResolver()
    }
}
...
public extension TestIntfControllerPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func interrupt(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "interrupt",
                          mode: .Normal,
                          userException:{ ex in
                              do  {
                                  throw ex
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func interruptAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "interrupt",
                                  mode: .Normal,
                                  userException:{ ex in
                                      do  {
                                          throw ex
...
public struct TestIntfControllerDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        ...
        case "interrupt":
            servant._iceD_interrupt(request)
        case "resumeAdapter":
...
extension TestIntfController {
    ...
    public func _iceD_interrupt(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            _ = try request.inputStream.skipEmptyEncapsulation()
