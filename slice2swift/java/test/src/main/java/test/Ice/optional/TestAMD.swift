...
public protocol Initial {
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: OneOptional?, p3: OneOptional?)>` - The result of the operation
    func opOneOptionalReqAsync(p1: OneOptional?, current: Ice.Current) -> PromiseKit.Promise<(returnValue: OneOptional?, p3: OneOptional?)>
...
public extension Initial {
    ...
    func _iceD_opOneOptionalReq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opOneOptionalReqAsync(p1: iceP_p1, current: current)) { (ostr, retVals) in
            let (iceP_returnValue, iceP_p3) = retVals
            ostr.write(tag: 1, value: iceP_returnValue)
            ostr.write(tag: 3, value: iceP_p3)
        }
