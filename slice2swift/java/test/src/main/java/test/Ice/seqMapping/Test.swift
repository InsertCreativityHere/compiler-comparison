...
public extension MyClassPrx {
    ...
    func opSerialSmallJava(_ iceP_i: SerialSmall, context: Ice.Context? = nil) async throws -> (returnValue: SerialSmall, o: SerialSmall) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SerialSmall, o: SerialSmall) {
    ...
    func opSerialLargeJava(_ iceP_i: SerialLarge, context: Ice.Context? = nil) async throws -> (returnValue: SerialLarge, o: SerialLarge) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SerialLarge, o: SerialLarge) {
    ...
    func opSerialStructJava(_ iceP_i: SerialStruct, context: Ice.Context? = nil) async throws -> (returnValue: SerialStruct, o: SerialStruct) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SerialStruct, o: SerialStruct) {
...
public struct SLSHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending SLS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SLS? {
...
public struct SLSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SLSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = SLSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SLSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SLDHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending SLD {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SLD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SLSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SLSD {
        let sz = try Swift.Int(istr.readSize())
        var v = SLSD()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SLSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending Foo? {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Bar() -> AnyObject.Type {
        Bar.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Baz() -> AnyObject.Type {
        Baz.self
    }
}
...
open class Baz: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.SLmem = try istr.read()
        iceP_self.SLSmem = try SLSHelper.read(from: istr)
        try istr.endSlice()
    }
