...
private final class TimeoutPrxI: Ice.ObjectPrxI, TimeoutPrx, @unchecked Sendable {
...
public extension TimeoutPrx {
    ...
    func sendData(_ iceP_seq: ByteSeq, context: Ice.Context? = nil) async throws {
...
public extension ControllerPrx {
    func holdAdapter(_ iceP_to: Swift.Int32, context: Ice.Context? = nil) async throws {
...
public protocol Timeout: Ice.Dispatcher {
...
extension Timeout {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TimeoutTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Timeout, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
