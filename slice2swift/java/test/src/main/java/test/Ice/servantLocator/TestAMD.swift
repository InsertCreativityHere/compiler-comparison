...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_TestIntfUserException() -> AnyObject.Type {
        TestIntfUserException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_TestImpossibleException() -> AnyObject.Type {
        TestImpossibleException.self
    }
}
...
public extension TestIntfPrx {
    func requestFailedException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "requestFailedException",
                                       mode: .normal,
                                       context: context)
    }

    func unknownUserException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "unknownUserException",
                                       mode: .normal,
                                       context: context)
    }

    func unknownLocalException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "unknownLocalException",
                                       mode: .normal,
                                       context: context)
    }

    func unknownException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "unknownException",
                                       mode: .normal,
                                       context: context)
    }

    func localException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "localException",
                                       mode: .normal,
                                       context: context)
    }

    func javaException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "javaException",
                                       mode: .normal,
                                       context: context)
    }

    func unknownExceptionWithServantException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "unknownExceptionWithServantException",
                                       mode: .normal,
                                       context: context)
    }

    func impossibleException(_ iceP_shouldThrow: Swift.Bool, context: Ice.Context? = nil) async throws -> Swift.String {
        return try await _impl._invoke(operation: "impossibleException",
                                       mode: .normal,
                                       write: { ostr in
                                           ostr.write(iceP_shouldThrow)
                                       },
                                       read: read,
                                       userException:{ ex in
                                           do  {
    ...
    func intfUserException(_ iceP_shouldThrow: Swift.Bool, context: Ice.Context? = nil) async throws -> Swift.String {
    ...
    func asyncResponse(context: Ice.Context? = nil) async throws {
    ...
    func asyncException(context: Ice.Context? = nil) async throws {
...
private final class TestActivationPrxI: Ice.ObjectPrxI, TestActivationPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TestActivationPrx {
    func activateServantLocator(_ iceP_activate: Swift.Bool, context: Ice.Context? = nil) async throws {
...
public protocol TestIntf: Ice.Dispatcher {
    ...
    func impossibleException(shouldThrow: Swift.Bool, current: Ice.Current) async throws -> Swift.String

    func intfUserException(shouldThrow: Swift.Bool, current: Ice.Current) async throws -> Swift.String
...
public protocol TestActivation: Ice.Dispatcher {
...
extension TestIntf {
    ...
    public func _iceD_impossibleException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let iceP_shouldThrow: Swift.Bool = try istr.read()
        let result = try await self.impossibleException(shouldThrow: iceP_shouldThrow, current: request.current)
    ...
    public func _iceD_intfUserException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        _ = try istr.startEncapsulation()
        let iceP_shouldThrow: Swift.Bool = try istr.read()
        let result = try await self.intfUserException(shouldThrow: iceP_shouldThrow, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
        }
...
extension TestActivation {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestActivationTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestActivation, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
