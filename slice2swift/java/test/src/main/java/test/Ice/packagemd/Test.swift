...
public extension InitialPrx {
    func getTest1C2AsC1(context: Ice.Context? = nil) async throws -> Test1.C1? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test1.C1? {
            nonisolated(unsafe) var iceP_returnValue: Test1.C1?
    ...
    func getTest1C2AsC2(context: Ice.Context? = nil) async throws -> Test1.C2? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test1.C2? {
            nonisolated(unsafe) var iceP_returnValue: Test1.C2?
    ...
    func throwTest1E2AsE1(context: Ice.Context? = nil) async throws {
    ...
    func throwTest1E2AsE2(context: Ice.Context? = nil) async throws {
    ...
    func throwTest1Notify(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "throwTest1Notify",
                                       mode: .normal,
                                       userException:{ ex in
                                           do  {
                                               throw ex
                                           } catch let error as Test1.notify {
                                               throw error
                                           } catch is Ice.UserException {}
                                       },
                                       context: context)
    ...
    func getTest2C2AsC1(context: Ice.Context? = nil) async throws -> Test2.C1? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test2.C1? {
            nonisolated(unsafe) var iceP_returnValue: Test2.C1?
    ...
    func getTest2C2AsC2(context: Ice.Context? = nil) async throws -> Test2.C2? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test2.C2? {
            nonisolated(unsafe) var iceP_returnValue: Test2.C2?
    ...
    func throwTest2E2AsE1(context: Ice.Context? = nil) async throws {
    ...
    func throwTest2E2AsE2(context: Ice.Context? = nil) async throws {
    ...
    func getTest3C2AsC1(context: Ice.Context? = nil) async throws -> Test3.C1? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test3.C1? {
            nonisolated(unsafe) var iceP_returnValue: Test3.C1?
    ...
    func getTest3C2AsC2(context: Ice.Context? = nil) async throws -> Test3.C2? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Test3.C2? {
            nonisolated(unsafe) var iceP_returnValue: Test3.C2?
    ...
    func throwTest3E2AsE1(context: Ice.Context? = nil) async throws {
    ...
    func throwTest3E2AsE2(context: Ice.Context? = nil) async throws {
...
public protocol Initial: Ice.Dispatcher {
    ...
    func throwTest1Notify(current: Ice.Current) async throws
...
extension Initial {
    ...
    public static func dispatch(_ servant: Initial, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "throwTest1Notify":
            try await servant._iceD_throwTest1Notify(request)
        case "getTest2C2AsC1":
    ...
    public func _iceD_throwTest1Notify(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.throwTest1Notify(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
