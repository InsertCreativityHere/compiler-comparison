...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_UserEx() -> AnyObject.Type {
        UserEx.self
    }
}
...
private final class MetricsPrxI: Ice.ObjectPrxI, MetricsPrx, @unchecked Sendable {
...
public extension MetricsPrx {
    ...
    func fail(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "fail",
                                       mode: .idempotent,
                                       context: context)
    }

    func opWithUserException(context: Ice.Context? = nil) async throws {
    ...
    func opWithRequestFailedException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "opWithRequestFailedException",
                                       mode: .normal,
                                       context: context)
    }

    func opWithLocalException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "opWithLocalException",
                                       mode: .normal,
                                       context: context)
    }

    func opWithUnknownException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "opWithUnknownException",
                                       mode: .normal,
                                       context: context)
    }

    func opByteS(_ iceP_bs: ByteSeq, context: Ice.Context? = nil) async throws {
...
public extension ControllerPrx {
    func hold(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "hold",
                                       mode: .normal,
                                       context: context)
    }

    func resume(context: Ice.Context? = nil) async throws {
...
public protocol Metrics: Ice.Dispatcher {
...
extension Metrics {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<MetricsTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Metrics, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
