...
private final class TestLocatorPrxI: Ice.ObjectPrxI, TestLocatorPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
///
/// - Throws: `Ice.LocalException` if a communication error occurs.
public func checkedCast(prx: Ice.ObjectPrx, type: TestLocatorPrx.Protocol, facet: Swift.String? = nil, context: Ice.Context? = nil) async throws -> TestLocatorPrx? {
    return try await TestLocatorPrxI.checkedCast(prx: prx, facet: facet, context: context) as TestLocatorPrxI?
}
...
extension TestLocator {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestLocatorTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestLocator, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "findObjectById":
