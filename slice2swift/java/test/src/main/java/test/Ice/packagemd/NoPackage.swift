...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_C1() -> AnyObject.Type {
        C1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_C2() -> AnyObject.Type {
        C2.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_E1() -> AnyObject.Type {
        E1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_E2() -> AnyObject.Type {
        E2.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_notify() -> AnyObject.Type {
        notify.self
    }
}

open class notify: Ice.UserException, @unchecked Sendable {
    public var i: Swift.Int32 = 0
    ...
    /// - Returns: The Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test1::notify" }
