...
open class OptionalClass: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.s = try istr.read(tag: 3)
        iceP_self.enumS4 = try MyEnumSHelper.read(from: istr, tag: 4)
        iceP_self.byteBoolD6 = try ByteBoolDHelper.read(from: istr, tag: 6)
        iceP_self.shortIntD7 = try ShortIntDHelper.read(from: istr, tag: 7)
        iceP_self.enum8 = try istr.read(tag: 8)
        iceP_self.intSeq12 = try istr.read(tag: 12)
        iceP_self.byteSeq13 = try istr.read(tag: 13)
        iceP_self.stringSeq14 = try istr.read(tag: 14)
        iceP_self.p15 = try istr.read(tag: 15)
        try istr.endSlice()
    }
...
open class MyClass: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.prx = try istr.read(MyInterfacePrx.self)
