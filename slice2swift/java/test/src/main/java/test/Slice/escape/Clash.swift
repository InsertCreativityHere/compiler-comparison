...
public extension IntfPrx {
    ...
    func obj(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "obj",
                                       mode: .normal,
                                       context: context)
    }

    func op(context iceP_context: Swift.String, current iceP_current: Swift.String, response iceP_response: Swift.String, ex iceP_ex: Swift.String, sent iceP_sent: Swift.String, cookie iceP_cookie: Swift.String, sync iceP_sync: Swift.String, result iceP_result: Swift.String, istr iceP_istr: Swift.String, ostr iceP_ostr: Swift.String, proxy iceP_proxy: Swift.String? = nil, obj iceP_obj: Swift.Int32? = nil, context: Ice.Context? = nil) async throws {
    ...
    func opOut(context: Ice.Context? = nil) async throws -> (context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, proxy: Swift.String?, obj: Swift.Int32?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, proxy: Swift.String?, obj: Swift.Int32?) {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Clash_Cls() -> AnyObject.Type {
        Cls.self
    }
}
...
open class Cls: Ice.Value {
    ...
    public init(s: IntfPrx?, context: Swift.String, current: Swift.Int32, response: Swift.Int16, typeId: Swift.Int32, del: Swift.Int16, cookie: Swift.Int16?, ex: Swift.String, result: Swift.Int32, istr: Swift.String, ostr: Swift.String, inS: Swift.String, in: Swift.String, proxy: Swift.String, obj: Swift.Int32, getCookie: Swift.Int32) {
        self.s = s
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.obj = try istr.read()
        iceP_self.getCookie = try istr.read()
...
public struct St: Swift.Hashable, Swift.Sendable {
    ...
    public init(v: Swift.String, istr: Swift.Int16, ostr: Swift.Int32, rhs: Swift.Int32, hashCode: Swift.String) {
        self.v = v
        self.istr = istr
        self.ostr = ostr
        self.rhs = rhs
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Clash_Ex() -> AnyObject.Type {
        Ex.self
    }
}
...
extension Intf {
    ...
    public static func dispatch(_ servant: Intf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "obj":
            try await servant._iceD_obj(request)
        case "op":
    ...
    public func _iceD_obj(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.obj(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
    ...
    public func _iceD_op(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let iceP_proxy: Swift.String? = try istr.read(tag: 1)
        let iceP_obj: Swift.Int32? = try istr.read(tag: 2)
        try await self.op(context: iceP_context, current: iceP_current, response: iceP_response, ex: iceP_ex, sent: iceP_sent, cookie: iceP_cookie, sync: iceP_sync, result: iceP_result, istr: iceP_istr, ostr: iceP_ostr, proxy: iceP_proxy, obj: iceP_obj, current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
    ...
    public func _iceD_opOut(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_proxy, iceP_obj) = value
            ostr.write(iceP_context)
            ostr.write(iceP_current)
            ostr.write(iceP_response)
            ostr.write(iceP_ex)
