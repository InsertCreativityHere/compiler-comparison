...
private final class Interface2PrxI: Ice.ObjectPrxI, Interface2Prx, @unchecked Sendable {
...
public extension Interface2Prx {
    func method(context: Ice.Context? = nil) async throws {
...
extension Interface2 {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Interface2, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
