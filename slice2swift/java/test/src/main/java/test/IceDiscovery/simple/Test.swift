...
public extension ControllerPrx {
    func activateObjectAdapter(name iceP_name: Swift.String, adapterId iceP_adapterId: Swift.String, replicaGroupId iceP_replicaGroupId: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    func deactivateObjectAdapter(_ iceP_name: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    func addObject(oaName iceP_oaName: Swift.String, id iceP_id: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    func removeObject(oaName iceP_oaName: Swift.String, id iceP_id: Swift.String, context: Ice.Context? = nil) async throws {
