...
public extension Ice.ClassResolver {
    @objc static func IceServantLocatorAMDTest_TestIntfUserException() -> Ice.UserExceptionTypeResolver {
...
public extension Ice.ClassResolver {
    @objc static func IceServantLocatorAMDTest_TestImpossibleException() -> Ice.UserExceptionTypeResolver {
...
public protocol TestActivation {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func activateServantLocatorAsync(activate: Swift.Bool, current: Ice.Current) -> PromiseKit.Promise<Swift.Void>
}
