...
public extension Ice.ClassResolver {
    @objc static func IceServantLocatorTest_TestIntfUserException() -> Ice.UserExceptionTypeResolver {
...
public extension Ice.ClassResolver {
    @objc static func IceServantLocatorTest_TestImpossibleException() -> Ice.UserExceptionTypeResolver {
