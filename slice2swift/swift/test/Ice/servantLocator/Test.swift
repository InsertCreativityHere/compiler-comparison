...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceServantLocator_Test_TestIntfUserException() -> AnyObject.Type {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceServantLocator_Test_TestImpossibleException() -> AnyObject.Type {
...
public extension TestIntfPrx {
    ...
    func userException(context: Ice.Context? = nil) async throws {
