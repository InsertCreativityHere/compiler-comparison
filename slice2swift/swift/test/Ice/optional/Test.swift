...
public extension Ice.ClassResolver {
    @objc static func IceOptionalTest_Recursive() -> Ice.ValueTypeResolver {
...
public extension Initial {
    ...
    func _iceD_opCustomString(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_p3) = try self.opCustomString(p1: iceP_p1, current: current)
    ...
    func _iceD_opMyInterfaceProxy(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_p3) = try self.opMyInterfaceProxy(p1: iceP_p1, current: current)
    ...
    func _iceD_opCustomIntStringDict(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_p3) = try self.opCustomIntStringDict(p1: iceP_p1, current: current)
