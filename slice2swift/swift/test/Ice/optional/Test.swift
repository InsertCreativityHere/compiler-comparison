...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_OneOptional() -> AnyObject.Type {
        OneOptional.self
    }
}
...
open class OneOptional: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.a = try istr.read(tag: 1)
        try istr.endSlice()
    }
...
private final class MyInterfacePrxI: Ice.ObjectPrxI, MyInterfacePrx, @unchecked Sendable {
...
public enum MyEnum: Swift.UInt8, Swift.Sendable {
    case MyEnumMember = 0
    public init() {
        self = .MyEnumMember
    }
...
public struct SmallStruct: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending SmallStruct {
        var v = SmallStruct()
        v.m = try self.read()
        return v
    }
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SmallStruct? {
...
public struct FixedStruct: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending FixedStruct {
        var v = FixedStruct()
        v.m = try self.read()
        return v
    }
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending FixedStruct? {
        guard try readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try skipSize()
...
public struct VarStruct: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending VarStruct {
        var v = VarStruct()
        v.m = try self.read()
        return v
    }
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending VarStruct? {
...
public struct MyEnumSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumSeq? {
...
public struct SmallStructSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SmallStructSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SmallStructSeq? {
...
public struct SmallStructListHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SmallStructList {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SmallStructList? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        return try read(from: istr)
...
public struct FixedStructSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending FixedStructSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending FixedStructSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct FixedStructListHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending FixedStructList {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending FixedStructList? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct VarStructSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending VarStructSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = VarStructSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending VarStructSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyInterfacePrxSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyInterfacePrxSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyInterfacePrxSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntIntDictHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending IntIntDict {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntIntDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct StringIntDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringIntDict {
        let sz = try Swift.Int(istr.readSize())
        var v = StringIntDict()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringIntDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntEnumDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntEnumDict {
        let sz = try Swift.Int(istr.readSize())
        var v = IntEnumDict()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntEnumDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntFixedStructDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntFixedStructDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntFixedStructDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct IntVarStructDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntVarStructDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntVarStructDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntMyInterfacePrxDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntMyInterfacePrxDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntMyInterfacePrxDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntStringDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntStringDict {
        let sz = try Swift.Int(istr.readSize())
        var v = IntStringDict()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntStringDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_MultiOptional() -> AnyObject.Type {
        MultiOptional.self
    }
}
...
open class MultiOptional: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        nonisolated(unsafe) let iceP_self = self
        iceP_self.a = try istr.read(tag: 1)
        iceP_self.b = try istr.read(tag: 2)
        iceP_self.c = try istr.read(tag: 3)
        iceP_self.d = try istr.read(tag: 4)
        iceP_self.e = try istr.read(tag: 5)
        iceP_self.f = try istr.read(tag: 6)
        iceP_self.g = try istr.read(tag: 7)
        iceP_self.h = try istr.read(tag: 8)
        iceP_self.i = try istr.read(tag: 9)
        iceP_self.j = try istr.read(tag: 10, type: MyInterfacePrx.self)
        iceP_self.bs = try istr.read(tag: 12)
        iceP_self.ss = try istr.read(tag: 13)
        iceP_self.iid = try IntIntDictHelper.read(from: istr, tag: 14)
        iceP_self.sid = try StringIntDictHelper.read(from: istr, tag: 15)
        iceP_self.fs = try istr.read(tag: 16)
        iceP_self.vs = try istr.read(tag: 17)
        iceP_self.shs = try istr.read(tag: 18)
        iceP_self.es = try MyEnumSeqHelper.read(from: istr, tag: 19)
        iceP_self.fss = try FixedStructSeqHelper.read(from: istr, tag: 20)
        iceP_self.vss = try VarStructSeqHelper.read(from: istr, tag: 21)
        iceP_self.mips = try MyInterfacePrxSeqHelper.read(from: istr, tag: 23)
        iceP_self.ied = try IntEnumDictHelper.read(from: istr, tag: 24)
        iceP_self.ifsd = try IntFixedStructDictHelper.read(from: istr, tag: 25)
        iceP_self.ivsd = try IntVarStructDictHelper.read(from: istr, tag: 26)
        iceP_self.imipd = try IntMyInterfacePrxDictHelper.read(from: istr, tag: 28)
        iceP_self.bos = try istr.read(tag: 29)
        iceP_self.ser = try istr.read(tag: 30)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_A() -> AnyObject.Type {
        A.self
    }
}
...
open class A: Ice.Value {
    ...
    public init(requiredA: Swift.Int32 = 0, ma: Swift.Int32?, mb: Swift.Int32?, mc: Swift.Int32?) {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.requiredA = try istr.read()
        iceP_self.ma = try istr.read(tag: 1)
        iceP_self.mb = try istr.read(tag: 50)
        iceP_self.mc = try istr.read(tag: 500)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_B() -> AnyObject.Type {
        B.self
    }
}
...
open class B: A {
    ...
    public init(requiredA: Swift.Int32 = 0, ma: Swift.Int32?, mb: Swift.Int32?, mc: Swift.Int32?, requiredB: Swift.Int32 = 0, md: Swift.Int32?) {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.requiredB = try istr.read()
        iceP_self.md = try istr.read(tag: 10)
        try istr.endSlice()
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_C() -> AnyObject.Type {
        C.self
    }
}
...
open class C: B {
    ...
    public init(requiredA: Swift.Int32 = 0, ma: Swift.Int32?, mb: Swift.Int32?, mc: Swift.Int32?, requiredB: Swift.Int32 = 0, md: Swift.Int32?, ss: Swift.String, ms: Swift.String?) {
        self.ss = ss
        self.ms = ms
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.ss = try istr.read()
        iceP_self.ms = try istr.read(tag: 890)
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_WD() -> AnyObject.Type {
        WD.self
    }
}
...
open class WD: Ice.Value {
    ...
    public init(a: Swift.Int32? = 5, s: Swift.String? = "test") {
        self.a = a
        self.s = s
    }
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        nonisolated(unsafe) let iceP_self = self
        iceP_self.a = try istr.read(tag: 1)
        iceP_self.s = try istr.read(tag: 2)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_OptionalException() -> AnyObject.Type {
        OptionalException.self
    }
}
...
open class OptionalException: Ice.UserException, @unchecked Sendable {
    ...
    public init(req: Swift.Bool = false, a: Swift.Int32? = 5, b: Swift.String?) {
        self.req = req
        self.a = a
        self.b = b
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_DerivedException() -> AnyObject.Type {
        DerivedException.self
    }
}
...
open class DerivedException: OptionalException, @unchecked Sendable {
    ...
    public init(req: Swift.Bool = false, a: Swift.Int32? = 5, b: Swift.String?, d1: Swift.String, ss: Swift.String? = "test", d2: Swift.String) {
        self.d1 = d1
        self.ss = ss
        self.d2 = d2
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_RequiredException() -> AnyObject.Type {
        RequiredException.self
    }
}
...
open class RequiredException: OptionalException, @unchecked Sendable {
    ...
    public init(req: Swift.Bool = false, a: Swift.Int32? = 5, b: Swift.String?, ss: Swift.String = "test") {
        self.ss = ss
        super.init(req: req, a: a, b: b)
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_E() -> AnyObject.Type {
        E.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_F() -> AnyObject.Type {
        F.self
    }
}
...
open class F: E {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.fsf = try istr.read(tag: 1)
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public struct G1: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending G1? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct G2: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending G2? {
        guard try readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try skipSize()
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOptional_Test_G() -> AnyObject.Type {
        G.self
    }
}
...
open class G: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.gg2 = try istr.read()
        iceP_self.gg1 = try istr.read()
        iceP_self.gg2Opt = try istr.read(tag: 0)
        iceP_self.gg1Opt = try istr.read(tag: 1)
        try istr.endSlice()
    }
...
public extension InitialPrx {
    ...
    func pingPong(_ iceP_o: Ice.Value?, context: Ice.Context? = nil) async throws -> Ice.Value? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Ice.Value? {
            nonisolated(unsafe) var iceP_returnValue: Ice.Value?
    ...
    func opOptionalException(a iceP_a: Swift.Int32? = nil, b iceP_b: Swift.String? = nil, context: Ice.Context? = nil) async throws {
    ...
    func opDerivedException(a iceP_a: Swift.Int32? = nil, b iceP_b: Swift.String? = nil, context: Ice.Context? = nil) async throws {
    ...
    func opRequiredException(a iceP_a: Swift.Int32? = nil, b iceP_b: Swift.String? = nil, context: Ice.Context? = nil) async throws {
    ...
    func opByte(_ iceP_p1: Swift.UInt8? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.UInt8?, p3: Swift.UInt8?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.UInt8?, p3: Swift.UInt8?) {
    ...
    func opBool(_ iceP_p1: Swift.Bool? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Bool?, p3: Swift.Bool?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Bool?, p3: Swift.Bool?) {
    ...
    func opShort(_ iceP_p1: Swift.Int16? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Int16?, p3: Swift.Int16?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Int16?, p3: Swift.Int16?) {
    ...
    func opInt(_ iceP_p1: Swift.Int32? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Int32?, p3: Swift.Int32?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Int32?, p3: Swift.Int32?) {
    ...
    func opLong(_ iceP_p1: Swift.Int64? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Int64?, p3: Swift.Int64?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Int64?, p3: Swift.Int64?) {
    ...
    func opFloat(_ iceP_p1: Swift.Float? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Float?, p3: Swift.Float?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Float?, p3: Swift.Float?) {
    ...
    func opDouble(_ iceP_p1: Swift.Double? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Double?, p3: Swift.Double?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Double?, p3: Swift.Double?) {
    ...
    func opString(_ iceP_p1: Swift.String? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.String?, p3: Swift.String?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.String?, p3: Swift.String?) {
    ...
    func opCustomString(_ iceP_p1: Swift.String? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Swift.String?, p3: Swift.String?) {
        return try await _impl._invoke(operation: "opCustomString",
                                       mode: .normal,
                                       write: { ostr in
                                           ostr.write(tag: 2, value: iceP_p1)
                                       },
    ...
    func opMyEnum(_ iceP_p1: MyEnum? = nil, context: Ice.Context? = nil) async throws -> (returnValue: MyEnum?, p3: MyEnum?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyEnum?, p3: MyEnum?) {
    ...
    func opSmallStruct(_ iceP_p1: SmallStruct? = nil, context: Ice.Context? = nil) async throws -> (returnValue: SmallStruct?, p3: SmallStruct?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SmallStruct?, p3: SmallStruct?) {
    ...
    func opFixedStruct(_ iceP_p1: FixedStruct? = nil, context: Ice.Context? = nil) async throws -> (returnValue: FixedStruct?, p3: FixedStruct?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: FixedStruct?, p3: FixedStruct?) {
    ...
    func opVarStruct(_ iceP_p1: VarStruct? = nil, context: Ice.Context? = nil) async throws -> (returnValue: VarStruct?, p3: VarStruct?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: VarStruct?, p3: VarStruct?) {
    ...
    func opMyInterfaceProxy(_ iceP_p1: MyInterfacePrx? = nil, context: Ice.Context? = nil) async throws -> (returnValue: MyInterfacePrx?, p3: MyInterfacePrx?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyInterfacePrx?, p3: MyInterfacePrx?) {
    ...
    func opOneOptional(_ iceP_p1: OneOptional?, context: Ice.Context? = nil) async throws -> (returnValue: OneOptional?, p3: OneOptional?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: OneOptional?, p3: OneOptional?) {
            nonisolated(unsafe) var iceP_p3: OneOptional?
            try istr.read(OneOptional.self) { iceP_p3 = $0 }
            nonisolated(unsafe) var iceP_returnValue: OneOptional?
    ...
    func opByteSeq(_ iceP_p1: ByteSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: ByteSeq?, p3: ByteSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteSeq?, p3: ByteSeq?) {
    ...
    func opBoolSeq(_ iceP_p1: BoolSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: BoolSeq?, p3: BoolSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BoolSeq?, p3: BoolSeq?) {
    ...
    func opShortSeq(_ iceP_p1: ShortSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: ShortSeq?, p3: ShortSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortSeq?, p3: ShortSeq?) {
    ...
    func opIntSeq(_ iceP_p1: IntSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: IntSeq?, p3: IntSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntSeq?, p3: IntSeq?) {
    ...
    func opLongSeq(_ iceP_p1: LongSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: LongSeq?, p3: LongSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongSeq?, p3: LongSeq?) {
    ...
    func opFloatSeq(_ iceP_p1: FloatSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: FloatSeq?, p3: FloatSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: FloatSeq?, p3: FloatSeq?) {
    ...
    func opDoubleSeq(_ iceP_p1: DoubleSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: DoubleSeq?, p3: DoubleSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: DoubleSeq?, p3: DoubleSeq?) {
    ...
    func opStringSeq(_ iceP_p1: StringSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: StringSeq?, p3: StringSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringSeq?, p3: StringSeq?) {
    ...
    func opSmallStructSeq(_ iceP_p1: SmallStructSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: SmallStructSeq?, p3: SmallStructSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SmallStructSeq?, p3: SmallStructSeq?) {
    ...
    func opSmallStructList(_ iceP_p1: SmallStructList? = nil, context: Ice.Context? = nil) async throws -> (returnValue: SmallStructList?, p3: SmallStructList?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SmallStructList?, p3: SmallStructList?) {
    ...
    func opFixedStructSeq(_ iceP_p1: FixedStructSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: FixedStructSeq?, p3: FixedStructSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: FixedStructSeq?, p3: FixedStructSeq?) {
    ...
    func opFixedStructList(_ iceP_p1: FixedStructList? = nil, context: Ice.Context? = nil) async throws -> (returnValue: FixedStructList?, p3: FixedStructList?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: FixedStructList?, p3: FixedStructList?) {
    ...
    func opVarStructSeq(_ iceP_p1: VarStructSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: VarStructSeq?, p3: VarStructSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: VarStructSeq?, p3: VarStructSeq?) {
    ...
    func opSerializable(_ iceP_p1: Serializable? = nil, context: Ice.Context? = nil) async throws -> (returnValue: Serializable?, p3: Serializable?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Serializable?, p3: Serializable?) {
    ...
    func opIntIntDict(_ iceP_p1: IntIntDict? = nil, context: Ice.Context? = nil) async throws -> (returnValue: IntIntDict?, p3: IntIntDict?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntIntDict?, p3: IntIntDict?) {
    ...
    func opStringIntDict(_ iceP_p1: StringIntDict? = nil, context: Ice.Context? = nil) async throws -> (returnValue: StringIntDict?, p3: StringIntDict?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringIntDict?, p3: StringIntDict?) {
    ...
    func opCustomIntStringDict(_ iceP_p1: IntStringDict? = nil, context: Ice.Context? = nil) async throws -> (returnValue: IntStringDict?, p3: IntStringDict?) {
        return try await _impl._invoke(operation: "opCustomIntStringDict",
                                       mode: .normal,
                                       write: { ostr in
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntStringDict?, p3: IntStringDict?) {
    ...
    func opClassAndUnknownOptional(_ iceP_p: A?, context: Ice.Context? = nil) async throws {
    ...
    func opG(_ iceP_g: G?, context: Ice.Context? = nil) async throws -> G? {
        ...
        func read(istr: Ice.InputStream) throws -> sending G? {
            nonisolated(unsafe) var iceP_returnValue: G?
    ...
    func opVoid(context: Ice.Context? = nil) async throws {
    ...
    func opMStruct1(context: Ice.Context? = nil) async throws -> SmallStruct? {
        ...
        func read(istr: Ice.InputStream) throws -> sending SmallStruct? {
            let iceP_returnValue: SmallStruct? = try istr.read(tag: 1)
            return iceP_returnValue
        }
    }
    ...
    func opMStruct2(_ iceP_p1: SmallStruct? = nil, context: Ice.Context? = nil) async throws -> (returnValue: SmallStruct?, p2: SmallStruct?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SmallStruct?, p2: SmallStruct?) {
            let iceP_returnValue: SmallStruct? = try istr.read(tag: 1)
    ...
    func opMSeq1(context: Ice.Context? = nil) async throws -> StringSeq? {
        ...
        func read(istr: Ice.InputStream) throws -> sending StringSeq? {
            let iceP_returnValue: StringSeq? = try istr.read(tag: 1)
            return iceP_returnValue
        }
    }
    ...
    func opMSeq2(_ iceP_p1: StringSeq? = nil, context: Ice.Context? = nil) async throws -> (returnValue: StringSeq?, p2: StringSeq?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringSeq?, p2: StringSeq?) {
            let iceP_returnValue: StringSeq? = try istr.read(tag: 1)
    ...
    func opMDict1(context: Ice.Context? = nil) async throws -> StringIntDict? {
        ...
        func read(istr: Ice.InputStream) throws -> sending StringIntDict? {
            let iceP_returnValue: StringIntDict? = try StringIntDictHelper.read(from: istr, tag: 1)
            return iceP_returnValue
        }
    }
    ...
    func opMDict2(_ iceP_p1: StringIntDict? = nil, context: Ice.Context? = nil) async throws -> (returnValue: StringIntDict?, p2: StringIntDict?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringIntDict?, p2: StringIntDict?) {
            let iceP_returnValue: StringIntDict? = try StringIntDictHelper.read(from: istr, tag: 1)
...
public protocol MyInterface: Ice.Dispatcher {
...
public protocol Initial: Ice.Dispatcher {
    ...
    func pingPong(o: sending Ice.Value?, current: Ice.Current) async throws -> Ice.Value?
    ...
    func opCustomString(p1: Swift.String?, current: Ice.Current) async throws -> (returnValue: Swift.String?, p3: Swift.String?)
    ...
    func opOneOptional(p1: sending OneOptional?, current: Ice.Current) async throws -> (returnValue: OneOptional?, p3: OneOptional?)
    ...
    func opCustomIntStringDict(p1: IntStringDict?, current: Ice.Current) async throws -> (returnValue: IntStringDict?, p3: IntStringDict?)

    func opClassAndUnknownOptional(p: sending A?, current: Ice.Current) async throws

    func opG(g: sending G?, current: Ice.Current) async throws -> G?
...
extension MyInterface {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<MyInterfaceTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: MyInterface, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension Initial {
    ...
    public static func dispatch(_ servant: Initial, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "opCustomString":
            try await servant._iceD_opCustomString(request)
        case "opMyEnum":
        ...
        case "opCustomIntStringDict":
            try await servant._iceD_opCustomIntStringDict(request)
    ...
    public func _iceD_pingPong(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        nonisolated(unsafe) var iceP_o: Ice.Value?
    ...
    public func _iceD_opCustomString(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_p1: Swift.String? = try istr.read(tag: 2)
        let result = try await self.opCustomString(p1: iceP_p1, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_p3) = value
            ostr.write(tag: 1, value: iceP_returnValue)
            ostr.write(tag: 3, value: iceP_p3)
    ...
    public func _iceD_opOneOptional(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_p1: OneOptional?
    ...
    public func _iceD_opCustomIntStringDict(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_p1: IntStringDict? = try IntStringDictHelper.read(from: istr, tag: 2)
        let result = try await self.opCustomIntStringDict(p1: iceP_p1, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_p3) = value
    ...
    public func _iceD_opClassAndUnknownOptional(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_p: A?
    ...
    public func _iceD_opG(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_g: G?
