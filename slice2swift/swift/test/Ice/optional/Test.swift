...
public struct InitialDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        ...
        case "opCustomIntStringDict":
            servant._iceD_opCustomIntStringDict(request)
        case "opCustomString":
            servant._iceD_opCustomString(request)
...
extension Initial {
    ...
    public func _iceD_opCustomString(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            let istr = request.inputStream
            _ = try istr.startEncapsulation()
            let iceP_p1: Swift.String? = try istr.read(tag: 2)
    ...
    public func _iceD_opCustomIntStringDict(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            let istr = request.inputStream
            _ = try istr.startEncapsulation()
