...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOperations_Test_SomeException() -> AnyObject.Type {
        SomeException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceOperations_Test_MyClass1() -> AnyObject.Type {
        MyClass1.self
    }
}
...
private final class Test2MyDerivedClassPrxI: Ice.ObjectPrxI, Test2MyDerivedClassPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
///
/// - Throws: `Ice.LocalException` if a communication error occurs.
public func checkedCast(prx: Ice.ObjectPrx, type: Test2MyDerivedClassPrx.Protocol, facet: Swift.String? = nil, context: Ice.Context? = nil) async throws -> Test2MyDerivedClassPrx? {
    return try await Test2MyDerivedClassPrxI.checkedCast(prx: prx, facet: facet, context: context) as Test2MyDerivedClassPrxI?
}
...
extension Test2MyDerivedClass {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<Test2MyDerivedClassTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Test2MyDerivedClass, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "shutdown":
            try await servant._iceD_shutdown(request)
        case "supportsCompress":
