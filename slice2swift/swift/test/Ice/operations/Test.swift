...
public extension Ice.ClassResolver {
    @objc static func IceOperationsM_A() -> Ice.ValueTypeResolver {
...
public extension Ice.ClassResolver {
    @objc static func IceOperationsM_B() -> Ice.ValueTypeResolver {
...
public struct Test2MyDerivedClassDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        switch current.operation {
        case "ice_id":
            return try (servant as? Object ?? Test2MyDerivedClassDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            return try (servant as? Object ?? Test2MyDerivedClassDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            return try (servant as? Object ?? Test2MyDerivedClassDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            return try (servant as? Object ?? Test2MyDerivedClassDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        case "opBool":
            return try servant._iceD_opBool(incoming: request, current: current)
        case "opBoolBoolSD":
            return try servant._iceD_opBoolBoolSD(incoming: request, current: current)
...
public extension MyClass {
    ...
    func _iceD_supportsCompress(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let iceP_returnValue = try self.supportsCompress(current: current)
...
/// Makes sure that proxy operations are correctly generated when extending an interface from
/// a different module (ICE-7639).
public extension Test2MyDerivedClass {}
...
public extension MIntf {
    func _iceD_opIntf(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        try self.opIntf(current: current)
