...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_D3() -> AnyObject.Type {
        D3.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_PCUnknown() -> AnyObject.Type {
        PCUnknown.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_PCDerived() -> AnyObject.Type {
        PCDerived.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_PCDerived2() -> AnyObject.Type {
        PCDerived2.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_PCDerived3() -> AnyObject.Type {
        PCDerived3.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceSlicingObjectsClient_Test_CompactPCDerived() -> AnyObject.Type {
        CompactPCDerived.self
    }

    @objc static func resolveTypeIdIceSlicingObjectsClient_57() -> AnyObject.Type {
        CompactPCDerived.self
    }
}
