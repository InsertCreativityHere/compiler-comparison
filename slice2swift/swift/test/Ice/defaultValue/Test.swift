...
public struct Struct4: Swift.Hashable, Swift.Sendable {
    public var foo: Swift.String = "foo"
    public var bar: Swift.String = ""

    public init() {}

    public init(foo: Swift.String = "foo", bar: Swift.String) {
        self.foo = foo
        self.bar = bar
    }
}
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending Struct4 {
        var v = Struct4()
        v.foo = try self.read()
        v.bar = try self.read()
        return v
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending Struct4? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceDefaultValue_Test_Base() -> AnyObject.Type {
        Base.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceDefaultValue_Test_Derived() -> AnyObject.Type {
        Derived.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceDefaultValue_Test_BaseEx() -> AnyObject.Type {
        BaseEx.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceDefaultValue_Test_DerivedEx() -> AnyObject.Type {
        DerivedEx.self
    }
}
