...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceStream_Test_OptionalClass() -> AnyObject.Type {
        OptionalClass.self
    }
}
...
public struct LargeStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LargeStructS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LargeStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LargeStructSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LargeStructSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = LargeStructSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LargeStructSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceStream_Test_MyClass() -> AnyObject.Type {
        MyClass.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceStream_Test_MyException() -> AnyObject.Type {
        MyException.self
    }
}
...
public enum SubNestedEnum: Swift.UInt8, Swift.Sendable {
    case nestedEnum1 = 0
    case nestedEnum2 = 1
    case nestedEnum3 = 2
    public init() {
...
public struct SubNestedStruct: Swift.Sendable {
    public var bo: Swift.Bool = false
    public var by: Swift.UInt8 = 0
    public var sh: Swift.Int16 = 0
    public var i: Swift.Int32 = 0
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending SubNestedStruct {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SubNestedStruct? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceStream_Test_Sub_NestedException() -> AnyObject.Type {
...
public enum Test2Sub2NestedEnum2: Swift.UInt8, Swift.Sendable {
    case nestedEnum4 = 0
    case nestedEnum5 = 1
    case nestedEnum6 = 2
    public init() {
...
/// An `Ice.InputStream` extension to read `Test2Sub2NestedEnum2` enumerated values from the stream.
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - Returns:  The enumerated value.
    ...
    ///
    /// - Returns: The enumerated value.
    func read(tag: Swift.Int32) throws -> Test2Sub2NestedEnum2? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
        return try read() as Test2Sub2NestedEnum2
    }
}

/// An `Ice.OutputStream` extension to write `Test2Sub2NestedEnum2` enumerated values to the stream.
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// - Parameter v: The enumerator to write.
    func write(_ v: Test2Sub2NestedEnum2) {
        write(enum: v.rawValue, maxValue: 2)
    }
    ...
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The enumerator to write.
    func write(tag: Swift.Int32, value: Test2Sub2NestedEnum2?) {
        guard let v = value else {
            return
        }
        write(tag: tag, val: v.rawValue, maxValue: 2)
...
public struct Test2Sub2NestedStruct2: Swift.Sendable {
    public var bo: Swift.Bool = false
    public var by: Swift.UInt8 = 0
    public var sh: Swift.Int16 = 0
    public var i: Swift.Int32 = 0
    ...
    public var d: Swift.Double = 0.0
    public var str: Swift.String = ""
    public var e: Test2Sub2NestedEnum2 = .nestedEnum4
...
/// An `Ice.InputStream` extension to read `Test2Sub2NestedStruct2` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `Test2Sub2NestedStruct2` structured value from the stream.
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending Test2Sub2NestedStruct2 {
        var v = Test2Sub2NestedStruct2()
        v.bo = try self.read()
        v.by = try self.read()
        v.sh = try self.read()
        v.i = try self.read()
    ...
    /// Read an optional `Test2Sub2NestedStruct2?` structured value from the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending Test2Sub2NestedStruct2? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as Test2Sub2NestedStruct2
    }
}

/// An `Ice.OutputStream` extension to write `Test2Sub2NestedStruct2` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `Test2Sub2NestedStruct2` structured value to the stream.
    ///
    /// - Parameter v: The value to write to the stream.
    func write(_ v: Test2Sub2NestedStruct2) {
        self.write(v.bo)
        self.write(v.by)
        self.write(v.sh)
        self.write(v.i)
    ...
    /// Write an optional `Test2Sub2NestedStruct2?` structured value to the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The value to write to the stream.
    func write(tag: Swift.Int32, value: Test2Sub2NestedStruct2?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeIdIceStream_Test2_Sub2_NestedException2() -> AnyObject.Type {
        Test2Sub2NestedException2.self
    }
}

open class Test2Sub2NestedException2: Ice.UserException, @unchecked Sendable {
    public var str: Swift.String = ""
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: Test2Sub2NestedException2.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.str)
        ostr.endSlice()
    }
