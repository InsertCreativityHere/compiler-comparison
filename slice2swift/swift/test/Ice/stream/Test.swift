...
public extension Ice.ClassResolver {
    @objc static func IceStremTest_MyException() -> Ice.UserExceptionTypeResolver {
...
public extension Ice.ClassResolver {
    @objc static func IceStremTest_Sub_NestedException() -> Ice.UserExceptionTypeResolver {
...
public enum Test2Sub2NestedEnum2: Swift.UInt8 {
    /// nestedEnum4
    case nestedEnum4 = 0
    /// nestedEnum5
    case nestedEnum5 = 1
...
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - returns: `Test2Sub2NestedEnum2` - The enumarated value.
    ...
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Test2Sub2NestedEnum2` - The enumerated value.
...
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// parameter _: `Test2Sub2NestedEnum2` - The enumerator to write.
...
public extension Ice.InputStream {
    ...
    ///
    /// - returns: `Test2Sub2NestedStruct2` - The structured value read from the stream.
    func read() throws -> Test2Sub2NestedStruct2 {
    ...
    ///
    /// - returns: `Test2Sub2NestedStruct2?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> Test2Sub2NestedStruct2? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.OutputStream {
    ...
    ///
    /// - parameter _: `Test2Sub2NestedStruct2` - The value to write to the stream.
    ...
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `Test2Sub2NestedStruct2?` - The value to write to the stream.
...
public extension Ice.ClassResolver {
    @objc static func IceStremTest2_Sub2_NestedException2() -> Ice.UserExceptionTypeResolver {
        return Test2Sub2NestedException2_TypeResolver()
    }
}
...
public extension Ice.ClassResolver {
    @objc static func IceStremTest_OptionalClass() -> Ice.ValueTypeResolver {
...
public extension Ice.ClassResolver {
    @objc static func IceStremTest_MyClass() -> Ice.ValueTypeResolver {
