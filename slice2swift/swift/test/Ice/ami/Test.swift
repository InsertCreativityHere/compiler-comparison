...
public extension TestIntfPrx {
    ...
    func opWithArgs(context: Ice.Context? = nil) async throws -> (one: Swift.Int32, two: Swift.Int32, three: Swift.Int32, four: Swift.Int32, five: Swift.Int32, six: Swift.Int32, seven: Swift.Int32, eight: Swift.Int32, nine: Swift.Int32, ten: Swift.Int32, eleven: Swift.Int32) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (one: Swift.Int32, two: Swift.Int32, three: Swift.Int32, four: Swift.Int32, five: Swift.Int32, six: Swift.Int32, seven: Swift.Int32, eight: Swift.Int32, nine: Swift.Int32, ten: Swift.Int32, eleven: Swift.Int32) {
...
extension TestIntf {
    ...
    public static func dispatch(_ servant: TestIntf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "opWithResultAndUE":
            try await servant._iceD_opWithResultAndUE(request)
        case "opBatch":
            try await servant._iceD_opBatch(request)
        case "opWithArgs":
            try await servant._iceD_opWithArgs(request)
        case "opBatchCount":
    ...
    public func _iceD_opWithResultAndUE(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        let result = try await self.opWithResultAndUE(current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
        }
    ...
    public func _iceD_opWithArgs(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        let result = try await self.opWithArgs(current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_one, iceP_two, iceP_three, iceP_four, iceP_five, iceP_six, iceP_seven, iceP_eight, iceP_nine, iceP_ten, iceP_eleven) = value
            ostr.write(iceP_one)
            ostr.write(iceP_two)
