...
public struct ByteEnumSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending ByteEnumSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ByteEnumSeq? {
...
public struct ShortEnumSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ShortEnumSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = ShortEnumSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ShortEnumSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntEnumSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntEnumSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = IntEnumSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntEnumSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SimpleEnumSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SimpleEnumSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = SimpleEnumSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SimpleEnumSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension TestIntfPrx {
    ...
    func opByteSeq(_ iceP_b1: ByteEnumSeq, context: Ice.Context? = nil) async throws -> (returnValue: ByteEnumSeq, b2: ByteEnumSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteEnumSeq, b2: ByteEnumSeq) {
    ...
    func opShortSeq(_ iceP_s1: ShortEnumSeq, context: Ice.Context? = nil) async throws -> (returnValue: ShortEnumSeq, s2: ShortEnumSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortEnumSeq, s2: ShortEnumSeq) {
    ...
    func opIntSeq(_ iceP_i1: IntEnumSeq, context: Ice.Context? = nil) async throws -> (returnValue: IntEnumSeq, i2: IntEnumSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntEnumSeq, i2: IntEnumSeq) {
    ...
    func opSimpleSeq(_ iceP_s1: SimpleEnumSeq, context: Ice.Context? = nil) async throws -> (returnValue: SimpleEnumSeq, s2: SimpleEnumSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SimpleEnumSeq, s2: SimpleEnumSeq) {
