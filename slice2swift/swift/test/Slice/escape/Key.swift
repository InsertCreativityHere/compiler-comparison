...
public enum `continue`: Swift.UInt8, Swift.Sendable {
...
public struct `guard`: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending `guard` {
        var v = `guard`()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending `guard`? {
...
open class `switch`: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.`remappedExport` = try istr.read(breakPrx.self)
        iceP_self.remappedVolatile = try istr.read()
        try istr.endSlice()
    }
...
private final class doPrxI: Ice.ObjectPrxI, doPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension doPrx {
    func `public`(context: Ice.Context? = nil) async throws {
    ...
    func goto(`if` iceP_if: `continue`, d iceP_d: `guard`, `private` iceP_private: `switch`?, mutable iceP_mutable: doPrx?, foo iceP_foo: breakPrx?, not iceP_not: `switch`?, or iceP_or: Swift.Int64, context: Ice.Context? = nil) async throws -> `guard` {
        ...
        func read(istr: Ice.InputStream) throws -> sending `guard` {
...
public struct fileprivateHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending `fileprivate` {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending `fileprivate`? {
...
public protocol `do`: `break` {
    ...
    func goto(`if`: `continue`, d: `guard`, `private`: sending `switch`?, mutable: doPrx?, foo: breakPrx?, not: sending `switch`?, or: Swift.Int64, current: Ice.Current) async throws -> `guard`
}
...
extension `do` {
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: `do`, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "case":
            try await servant._iceD_case(request)
        case "public":
    ...
    public func _iceD_goto(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        nonisolated(unsafe) var iceP_private: `switch`?
        ...
        nonisolated(unsafe) var iceP_not: `switch`?
