...
open class Cls: Ice.Value {
    ...
    public init(s: IntfPrx?, context: Swift.String, current: Swift.Int32, response: Swift.Int16, upCast: Swift.String, typeId: Swift.Int32, del: Swift.Int16, cookie: Swift.Int16?, ex: Swift.String, result: Swift.Int32, istr: Swift.String, ostr: Swift.String, inS: Swift.String, proxy: Swift.String) {
        self.s = s
