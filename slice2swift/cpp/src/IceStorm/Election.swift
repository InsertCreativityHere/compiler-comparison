...
public struct TopicContent: Swift.Sendable {
    /// The topic identity.
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending TopicContent {
        var v = TopicContent()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending TopicContent? {
...
public struct TopicContentSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending TopicContentSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending TopicContentSeq? {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceStormElection_ObserverInconsistencyException() -> AnyObject.Type {
        ObserverInconsistencyException.self
    }
}
...
public extension ReplicaObserverPrx {
    ...
    ///
    /// - Throws:
    ///   - ObserverInconsistencyException Raised if an inconsistency was detected.
    func init(llu iceP_llu: LogUpdate, content iceP_content: TopicContentSeq, context: Ice.Context? = nil) async throws {
    ...
    /// - Throws:
    ///   - ObserverInconsistencyException Raised if an inconsistency was detected.
    func createTopic(llu iceP_llu: LogUpdate, name iceP_name: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    /// - Throws:
    ///   - ObserverInconsistencyException Raised if an inconsistency was detected.
    func destroyTopic(llu iceP_llu: LogUpdate, name iceP_name: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    /// - Throws:
    ///   - ObserverInconsistencyException Raised if an inconsistency was detected.
    func addSubscriber(llu iceP_llu: LogUpdate, topic iceP_topic: Swift.String, record iceP_record: IceStorm.SubscriberRecord, context: Ice.Context? = nil) async throws {
    ...
    /// - Parameters:
    ///   - iceP_llu: The log update token.
    ///   - iceP_topic: The topic name.
    ///   - iceP_subscribers: The identities of the subscribers to remove.
    ///   - context: Optional request context.
    ///
    /// - Throws:
    ///   - ObserverInconsistencyException Raised if an inconsistency was detected.
    func removeSubscriber(llu iceP_llu: LogUpdate, topic iceP_topic: Swift.String, subscribers iceP_subscribers: Ice.IdentitySeq, context: Ice.Context? = nil) async throws {
...
private final class TopicManagerSyncPrxI: Ice.ObjectPrxI, TopicManagerSyncPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TopicManagerSyncPrx {
    ...
    func getContent(context: Ice.Context? = nil) async throws -> (llu: LogUpdate, content: TopicContentSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (llu: LogUpdate, content: TopicContentSeq) {
...
/// The node state.
public enum NodeState: Swift.UInt8, Swift.Sendable {
...
public struct NodeInfoSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NodeInfoSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NodeInfoSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
/// The group info.
public struct GroupInfo: Swift.Hashable, Swift.Sendable {
    /// The identity of the node.
    public var id: Swift.Int32 = 0
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending GroupInfo {
        var v = GroupInfo()
        v.id = try self.read()
        v.llu = try self.read()
        return v
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending GroupInfo? {
...
public struct GroupInfoSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending GroupInfoSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending GroupInfoSeq? {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending QueryInfo {
        var v = QueryInfo()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending QueryInfo? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension NodePrx {
    ...
    ///   - context: Optional request context.
    func invitation(j iceP_j: Swift.Int32, gn iceP_gn: Swift.String, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func ready(j iceP_j: Swift.Int32, gn iceP_gn: Swift.String, coordinator iceP_coordinator: Ice.ObjectPrx?, max iceP_max: Swift.Int32, generation iceP_generation: Swift.Int64, context: Ice.Context? = nil) async throws {
    ...
    ///   - iceP_max: The highest priority node seen by this replica group.
    ///   - context: Optional request context.
    func accept(j iceP_j: Swift.Int32, gn iceP_gn: Swift.String, forwardedInvites iceP_forwardedInvites: Ice.IntSeq, observer iceP_observer: Ice.ObjectPrx?, llu iceP_llu: LogUpdate, max iceP_max: Swift.Int32, context: Ice.Context? = nil) async throws {
    ...
    func nodes(context: Ice.Context? = nil) async throws -> NodeInfoSeq {
        ...
        func read(istr: Ice.InputStream) throws -> sending NodeInfoSeq {
    ...
    func query(context: Ice.Context? = nil) async throws -> QueryInfo {
        ...
        func read(istr: Ice.InputStream) throws -> sending QueryInfo {
...
/// Interface used to sync topics.
public protocol TopicManagerSync: Ice.Dispatcher {
    /// Retrieve the topic content.
    ///
...
extension TopicManagerSync {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TopicManagerSyncTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TopicManagerSync, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "getContent":
