...
/// The event data.
public struct EventData: Swift.Sendable {
    /// The operation name.
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending EventData {
        var v = EventData()
        v.op = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending EventData? {
...
public struct EventDataSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending EventDataSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending EventDataSeq? {
...
private final class TopicLinkPrxI: Ice.ObjectPrxI, TopicLinkPrx, @unchecked Sendable {
...
public extension TopicLinkPrx {
    ...
    func forward(_ iceP_events: EventDataSeq, context: Ice.Context? = nil) async throws {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceStorm_ReapWouldBlock() -> AnyObject.Type {
        ReapWouldBlock.self
    }
}
...
private final class TopicInternalPrxI: Ice.ObjectPrxI, TopicInternalPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TopicInternalPrx {
    ...
    func getLinkProxy(context: Ice.Context? = nil) async throws -> TopicLinkPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending TopicLinkPrx? {
    ...
    func reap(_ iceP_id: Ice.IdentitySeq, context: Ice.Context? = nil) async throws {
...
private final class TopicManagerInternalPrxI: Ice.ObjectPrxI, TopicManagerInternalPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TopicManagerInternalPrx {
    ...
    func getReplicaNode(context: Ice.Context? = nil) async throws -> IceStormElection.NodePrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending IceStormElection.NodePrx? {
...
/// The TopicLink interface. This is used to forward events between federated Topic instances.
public protocol TopicLink: Ice.Dispatcher {
    /// Forward a sequence of events.
    ///
    /// - Parameters:
...
extension TopicLink {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TopicLinkTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TopicLink, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension TopicInternal {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TopicInternalTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TopicInternal, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "getName":
...
extension TopicManagerInternal {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TopicManagerInternalTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TopicManagerInternal, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "create":
