...
public struct SubscriberRecordKey: Swift.Hashable, Swift.Sendable {
    /// The topic identity.
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending SubscriberRecordKey {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SubscriberRecordKey? {
...
public struct SubscriberRecord: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending SubscriberRecord {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SubscriberRecord? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct SubscriberRecordSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending SubscriberRecordSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SubscriberRecordSeq? {
