...
public enum ClearHistoryPolicy: Swift.UInt8, Swift.Sendable {
...
public struct DataSample: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending DataSample {
        var v = DataSample()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending DataSample? {
...
public struct DataSampleSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending DataSampleSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending DataSampleSeq? {
...
public struct DataSamples: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending DataSamples {
        var v = DataSamples()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending DataSamples? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct DataSamplesSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending DataSamplesSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending DataSamplesSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ElementInfo {
        var v = ElementInfo()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ElementInfo? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ElementInfoSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ElementInfoSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ElementInfoSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending TopicInfo {
        var v = TopicInfo()
        v.name = try self.read()
        v.ids = try self.read()
        return v
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending TopicInfo? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct TopicInfoSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending TopicInfoSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending TopicInfoSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
/// and tags.
public struct TopicSpec: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending TopicSpec {
        var v = TopicSpec()
        v.id = try self.read()
        v.name = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending TopicSpec? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct FilterInfo: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending FilterInfo {
        var v = FilterInfo()
        v.name = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending FilterInfo? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_DataStormContract_ElementConfig() -> AnyObject.Type {
        ElementConfig.self
    }
...
open class ElementConfig: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.facet = try istr.read(tag: 1)
        iceP_self.sampleFilter = try istr.read(tag: 2)
        iceP_self.name = try istr.read(tag: 3)
        iceP_self.priority = try istr.read(tag: 4)
        iceP_self.sampleCount = try istr.read(tag: 10)
        iceP_self.sampleLifetime = try istr.read(tag: 11)
        iceP_self.clearHistory = try istr.read(tag: 12)
        try istr.endSlice()
    }
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ElementData {
        nonisolated(unsafe) let v = ElementData()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ElementData? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ElementDataSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ElementDataSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 10)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ElementDataSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ElementSpec {
        nonisolated(unsafe) let v = ElementSpec()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ElementSpec? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ElementSpecSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ElementSpecSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ElementSpecSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public final class ElementDataAck {
    /// The unique identifier for the data reader or data writer.
    public var id: Swift.Int64 = 0
    /// The configuration settings for the data reader or data writer.
    public var config: ElementConfig? = nil
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ElementDataAck {
        nonisolated(unsafe) let v = ElementDataAck()
        v.id = try self.read()
        try self.read(ElementConfig.self) { v.config = $0 }
        v.lastIds = try LongLongDictHelper.read(from: self)
        v.samples = try DataSampleSeqHelper.read(from: self)
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ElementDataAck? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ElementDataAckSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ElementDataAckSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ElementDataAckSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public final class ElementSpecAck {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ElementSpecAck {
        nonisolated(unsafe) let v = ElementSpecAck()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ElementSpecAck? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ElementSpecAckSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ElementSpecAckSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 20)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ElementSpecAckSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension SessionPrx {
    ...
    func announceTopics(topics iceP_topics: TopicInfoSeq, initialize iceP_initialize: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func attachTopic(_ iceP_topic: TopicSpec, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func detachTopic(_ iceP_topicId: Swift.Int64, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func attachTags(topicId iceP_topicId: Swift.Int64, tags iceP_tags: ElementInfoSeq, initialize iceP_initialize: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func detachTags(topicId iceP_topicId: Swift.Int64, tags iceP_tags: Ice.LongSeq, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func announceElements(topicId iceP_topicId: Swift.Int64, elements iceP_elements: ElementInfoSeq, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func attachElements(topicId iceP_topicId: Swift.Int64, elements iceP_elements: ElementSpecSeq, initialize iceP_initialize: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func attachElementsAck(topicId iceP_topicId: Swift.Int64, elements iceP_elements: ElementSpecAckSeq, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func detachElements(topicId iceP_topicId: Swift.Int64, elements iceP_elements: Ice.LongSeq, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func initSamples(topicId iceP_topicId: Swift.Int64, samples iceP_samples: DataSamplesSeq, context: Ice.Context? = nil) async throws {
    ...
    func disconnected(context: Ice.Context? = nil) async throws {
...
private final class PublisherSessionPrxI: Ice.ObjectPrxI, PublisherSessionPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
private final class SubscriberSessionPrxI: Ice.ObjectPrxI, SubscriberSessionPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension SubscriberSessionPrx {
    ...
    ///   - context: Optional request context.
    func s(topicId iceP_topicId: Swift.Int64, elementId iceP_elementId: Swift.Int64, sample iceP_sample: DataSample, context: Ice.Context? = nil) async throws {
...
public enum SessionCreationError: Swift.UInt8, Swift.Sendable {
...
/// An `Ice.InputStream` extension to read `SessionCreationError` enumerated values from the stream.
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - Returns:  The enumerated value.
    func read() throws -> SessionCreationError {
        let rawValue: Swift.UInt8 = try read(enumMaxValue: 3)
        guard let val = SessionCreationError(rawValue: rawValue) else {
            throw Ice.MarshalException("invalid enum value")
        }
        return val
    }
    ...
    ///
    /// - Returns: The enumerated value.
    func read(tag: Swift.Int32) throws -> SessionCreationError? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
        return try read() as SessionCreationError
    }
}

/// An `Ice.OutputStream` extension to write `SessionCreationError` enumerated values to the stream.
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// - Parameter v: The enumerator to write.
    func write(_ v: SessionCreationError) {
    ...
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The enumerator to write.
    func write(tag: Swift.Int32, value: SessionCreationError?) {
        guard let v = value else {
            return
        }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_DataStormContract_SessionCreationException() -> AnyObject.Type {
        SessionCreationException.self
    }
}

/// Throws when the session cannot be created.
open class SessionCreationException: Ice.UserException, @unchecked Sendable {
    public var error: SessionCreationError = .AlreadyConnected

    public required init() {}

    public init(error: SessionCreationError) {
        self.error = error
    }

    /// - Returns: The Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::DataStormContract::SessionCreationException" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: SessionCreationException.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.error)
        ostr.endSlice()
    }

    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        self.error = try istr.read()
        try istr.endSlice()
    }
}
...
public extension NodePrx {
    ...
    ///
    /// - Throws:
    ///   - SessionCreationException Thrown when the session cannot be created.
    func initiateCreateSession(_ iceP_publisher: NodePrx?, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "initiateCreateSession",
                                       ...
                                       userException:{ ex in
                                           do  {
                                               throw ex
                                           } catch let error as SessionCreationException {
                                               throw error
    ...
    ///
    /// - Parameters:
    ///   - iceP_subscriber: The subscriber node initiating the session. This proxy is never null.
    ///   - iceP_session: The subscriber session being created. This proxy is never null.
    ///   - iceP_fromRelay: Indicates whether the session is being created from a relay node.
    ///   - context: Optional request context.
    ///
    /// - Throws:
    ///   - SessionCreationException Thrown when the session cannot be created.
    func createSession(subscriber iceP_subscriber: NodePrx?, session iceP_session: SubscriberSessionPrx?, fromRelay iceP_fromRelay: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    /// - Throws:
    ///   - SessionCreationException Thrown when the session cannot be created.
    func confirmCreateSession(publisher iceP_publisher: NodePrx?, session iceP_session: PublisherSessionPrx?, context: Ice.Context? = nil) async throws {
...
public extension LookupPrx {
    ...
    ///   - context: Optional request context.
    func announceTopicReader(topic iceP_topic: Swift.String, subscriber iceP_subscriber: NodePrx?, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func announceTopicWriter(topic iceP_topic: Swift.String, node iceP_node: NodePrx?, context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func announceTopics(readers iceP_readers: Ice.StringSeq, writers iceP_writers: Ice.StringSeq, node iceP_node: NodePrx?, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "announceTopics",
                                       mode: .idempotent,
                                       write: { ostr in
    ...
    func createSession(_ iceP_node: NodePrx?, context: Ice.Context? = nil) async throws -> NodePrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending NodePrx? {
...
public protocol Session: Ice.Dispatcher {
    ...
    ///   - current: The Current object for the dispatch.
    func attachElements(topicId: Swift.Int64, elements: sending ElementSpecSeq, initialize: Swift.Bool, current: Ice.Current) async throws
    ...
    ///   - current: The Current object for the dispatch.
    func attachElementsAck(topicId: Swift.Int64, elements: sending ElementSpecAckSeq, current: Ice.Current) async throws
...
extension PublisherSession {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<PublisherSessionTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: PublisherSession, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "announceTopics":
            try await servant._iceD_announceTopics(request)
        case "attachTopic":
...
extension SubscriberSession {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<SubscriberSessionTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: SubscriberSession, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "announceTopics":
            try await servant._iceD_announceTopics(request)
        case "attachTopic":
