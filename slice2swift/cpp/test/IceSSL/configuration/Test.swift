...
public extension ServerPrx {
    func noCert(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "noCert",
                                       mode: .normal,
                                       context: context)
    }

    func checkCert(subjectDN iceP_subjectDN: Swift.String, issuerDN iceP_issuerDN: Swift.String, context: Ice.Context? = nil) async throws {
...
public struct PropertiesHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending Properties {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending Properties? {
    ...
    /// Write a `Properties` dictionary to the stream.
    ///
    ...
    /// Write an optional `Properties?` dictionary to the stream.
    ///
    /// - Parameters:
...
private final class ServerFactoryPrxI: Ice.ObjectPrxI, ServerFactoryPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension ServerFactoryPrx {
    func createServer(_ iceP_props: Properties, context: Ice.Context? = nil) async throws -> ServerPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending ServerPrx? {
            let iceP_returnValue: ServerPrx? = try istr.read(ServerPrx.self)
            return iceP_returnValue
        }
    }

    func destroyServer(_ iceP_srv: ServerPrx?, context: Ice.Context? = nil) async throws {
...
public protocol Server: Ice.Dispatcher {
...
public protocol ServerFactory: Ice.Dispatcher {
...
extension ServerFactory {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<ServerFactoryTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: ServerFactory, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "createServer":
