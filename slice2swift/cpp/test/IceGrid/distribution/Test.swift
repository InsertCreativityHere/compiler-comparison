...
public extension TestIntfPrx {
    ...
    func getServerFile(_ iceP_path: Swift.String, context: Ice.Context? = nil) throws -> Swift.String {
        return try _impl._invoke(operation: "getServerFile",
                                 mode: .Normal,
                                 write: { ostr in
    ...
    func getServerFileAsync(_ iceP_path: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.String> {
        return _impl._invokeAsync(operation: "getServerFile",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_path)
                                  },
    ...
    ///
    /// - returns: `Swift.String`
    func getApplicationFile(_ iceP_path: Swift.String, context: Ice.Context? = nil) throws -> Swift.String {
        return try _impl._invoke(operation: "getApplicationFile",
                                 mode: .Normal,
                                 write: { ostr in
                                     ostr.write(iceP_path)
                                 },
    ...
    ///
    /// - returns: `PromiseKit.Promise<Swift.String>` - The result of the operation
    func getApplicationFileAsync(_ iceP_path: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.String> {
        return _impl._invokeAsync(operation: "getApplicationFile",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_path)
                                  },
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "getApplicationFile":
            return try servant._iceD_getApplicationFile(incoming: request, current: current)
        case "getServerFile":
            return try servant._iceD_getServerFile(incoming: request, current: current)
        case "ice_id":
...
public protocol TestIntf {
    ///
    /// - parameter path: `Swift.String`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `Swift.String`
    func getServerFile(path: Swift.String, current: Ice.Current) throws -> Swift.String
    ...
    ///
    /// - returns: `Swift.String`
    func getApplicationFile(path: Swift.String, current: Ice.Current) throws -> Swift.String
}
...
public extension TestIntf {
    func _iceD_getServerFile(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_path: Swift.String = try inS.read { istr in
            let iceP_path: Swift.String = try istr.read()
            return iceP_path
        }

        let iceP_returnValue = try self.getServerFile(path: iceP_path, current: current)
    ...
    func _iceD_getApplicationFile(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_path: Swift.String = try inS.read { istr in
            let iceP_path: Swift.String = try istr.read()
            return iceP_path
        }

        let iceP_returnValue = try self.getApplicationFile(path: iceP_path, current: current)
