...
public extension RemoteCommunicatorPrx {
    ...
    func getChanges(context: Ice.Context? = nil) async throws -> Ice.PropertyDict {
        ...
        func read(istr: Ice.InputStream) throws -> sending Ice.PropertyDict {
            let iceP_returnValue: Ice.PropertyDict = try Ice.PropertyDictHelper.read(from: istr)
            return iceP_returnValue
        }
    }

    func addUpdateCallback(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "addUpdateCallback",
                                       mode: .normal,
                                       context: context)
    }

    func removeUpdateCallback(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "removeUpdateCallback",
                                       mode: .normal,
                                       context: context)
    }

    func print(_ iceP_message: Swift.String, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "print",
                                       mode: .normal,
                                       write: { ostr in
    ...
    func trace(category iceP_category: Swift.String, message iceP_message: Swift.String, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "trace",
                                       mode: .normal,
                                       write: { ostr in
    ...
    func warning(_ iceP_message: Swift.String, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "warning",
                                       mode: .normal,
                                       write: { ostr in
                                           ostr.write(iceP_message)
                                       },
    ...
    func error(_ iceP_message: Swift.String, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "error",
                                       mode: .normal,
                                       write: { ostr in
                                           ostr.write(iceP_message)
                                       },
    ...
    func waitForShutdown(context: Ice.Context? = nil) async throws {
...
private final class TestFacetPrxI: Ice.ObjectPrxI, TestFacetPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public protocol RemoteCommunicator: Ice.Dispatcher {
    ...
    func addUpdateCallback(current: Ice.Current) async throws

    func removeUpdateCallback(current: Ice.Current) async throws
...
public protocol TestFacet: Ice.Dispatcher {
...
extension RemoteCommunicator {
    ...
    public func _iceD_addUpdateCallback(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.addUpdateCallback(current: request.current)
    ...
    public func _iceD_removeUpdateCallback(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.removeUpdateCallback(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
...
extension TestFacet {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestFacetTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestFacet, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "op":
