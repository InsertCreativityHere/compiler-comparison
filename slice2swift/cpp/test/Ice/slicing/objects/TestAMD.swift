...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_SBase() -> AnyObject.Type {
        SBase.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_SBSKnownDerived() -> AnyObject.Type {
        SBSKnownDerived.self
    }
}
...
open class B: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        nonisolated(unsafe) let iceP_self = self
        iceP_self.sb = try istr.read()
        try istr.read(B.self) { iceP_self.pb = $0 }
        try istr.endSlice()
    }
...
open class D1: B {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.sd1 = try istr.read()
        try istr.read(B.self) { iceP_self.pd1 = $0 }
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public struct BSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending BSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = BSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BSeq? {
    ...
    /// Write a `BSeq` sequence to the stream.
    ///
    ...
    /// Write an optional `BSeq?` sequence to the stream.
    ///
    /// - Parameters:
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_SS1() -> AnyObject.Type {
        SS1.self
    }
}
...
open class SS1: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.s = try BSeqHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_SS2() -> AnyObject.Type {
        SS2.self
    }
}
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending SS3 {
        nonisolated(unsafe) let v = SS3()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SS3? {
...
public struct BDictHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending BDict {
        let sz = try Swift.Int(istr.readSize())
        var v = BDict()
        nonisolated(unsafe) let e = Ice.DictEntryArray<Swift.Int32, B?>(size: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `BDict` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    ...
    /// Write an optional `BDict?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_BaseException() -> AnyObject.Type {
        BaseException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_PBase() -> AnyObject.Type {
        PBase.self
    }
}
...
public struct PBaseSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending PBaseSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = PBaseSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending PBaseSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `PBaseSeq` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `PBaseSeq?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Preserved() -> AnyObject.Type {
        Preserved.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_PDerived() -> AnyObject.Type {
        PDerived.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_PNode() -> AnyObject.Type {
        PNode.self
    }
}
...
open class PNode: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(PNode.self) { iceP_self.next = $0 }
        try istr.endSlice()
    }
...
public extension TestIntfPrx {
    ...
    func SBaseAsSBase(context: Ice.Context? = nil) async throws -> SBase? {
        ...
        func read(istr: Ice.InputStream) throws -> sending SBase? {
            nonisolated(unsafe) var iceP_returnValue: SBase?
    ...
    func SBSKnownDerivedAsSBSKnownDerived(context: Ice.Context? = nil) async throws -> SBSKnownDerived? {
        ...
        func read(istr: Ice.InputStream) throws -> sending SBSKnownDerived? {
            nonisolated(unsafe) var iceP_returnValue: SBSKnownDerived?
    ...
    func checkSUnknown(_ iceP_o: Ice.Value?, context: Ice.Context? = nil) async throws {
    ...
    func paramTest1(context: Ice.Context? = nil) async throws -> (p1: B?, p2: B?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (p1: B?, p2: B?) {
            nonisolated(unsafe) var iceP_p1: B?
            try istr.read(B.self) { iceP_p1 = $0 }
            nonisolated(unsafe) var iceP_p2: B?
    ...
    func paramTest2(context: Ice.Context? = nil) async throws -> (p2: B?, p1: B?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (p2: B?, p1: B?) {
            nonisolated(unsafe) var iceP_p2: B?
            try istr.read(B.self) { iceP_p2 = $0 }
            nonisolated(unsafe) var iceP_p1: B?
            try istr.read(B.self) { iceP_p1 = $0 }
    ...
    func paramTest3(context: Ice.Context? = nil) async throws -> (returnValue: B?, p1: B?, p2: B?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: B?, p1: B?, p2: B?) {
            nonisolated(unsafe) var iceP_p1: B?
            try istr.read(B.self) { iceP_p1 = $0 }
            nonisolated(unsafe) var iceP_p2: B?
            try istr.read(B.self) { iceP_p2 = $0 }
    ...
    func paramTest4(context: Ice.Context? = nil) async throws -> (returnValue: B?, p: B?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: B?, p: B?) {
            nonisolated(unsafe) var iceP_p: B?
    ...
    func returnTest2(context: Ice.Context? = nil) async throws -> (returnValue: B?, p2: B?, p1: B?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: B?, p2: B?, p1: B?) {
            nonisolated(unsafe) var iceP_p2: B?
            try istr.read(B.self) { iceP_p2 = $0 }
            nonisolated(unsafe) var iceP_p1: B?
            try istr.read(B.self) { iceP_p1 = $0 }
    ...
    func sequenceTest(p1 iceP_p1: SS1?, p2 iceP_p2: SS2?, context: Ice.Context? = nil) async throws -> SS3 {
        ...
        func read(istr: Ice.InputStream) throws -> sending SS3 {
    ...
    func dictionaryTest(_ iceP_bin: BDict, context: Ice.Context? = nil) async throws -> (returnValue: BDict, bout: BDict) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BDict, bout: BDict) {
    ...
    func exchangePBase(_ iceP_pb: PBase?, context: Ice.Context? = nil) async throws -> PBase? {
        ...
        func read(istr: Ice.InputStream) throws -> sending PBase? {
            nonisolated(unsafe) var iceP_returnValue: PBase?
    ...
    func PBSUnknownAsPreserved(context: Ice.Context? = nil) async throws -> Preserved? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Preserved? {
            nonisolated(unsafe) var iceP_returnValue: Preserved?
    ...
    func checkPBSUnknown(_ iceP_p: Preserved?, context: Ice.Context? = nil) async throws {
    ...
    func checkPBSUnknownWithGraph(_ iceP_p: Preserved?, context: Ice.Context? = nil) async throws {
    ...
    func checkPBSUnknown2WithGraph(_ iceP_p: Preserved?, context: Ice.Context? = nil) async throws {
    ...
    func exchangePNode(_ iceP_pn: PNode?, context: Ice.Context? = nil) async throws -> PNode? {
        ...
        func read(istr: Ice.InputStream) throws -> sending PNode? {
            nonisolated(unsafe) var iceP_returnValue: PNode?
    ...
    func throwBaseAsBase(context: Ice.Context? = nil) async throws {
    ...
    func throwDerivedAsBase(context: Ice.Context? = nil) async throws {
    ...
    func throwDerivedAsDerived(context: Ice.Context? = nil) async throws {
    ...
    func throwUnknownDerivedAsBase(context: Ice.Context? = nil) async throws {
    ...
    func useForward(context: Ice.Context? = nil) async throws -> Forward? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Forward? {
            nonisolated(unsafe) var iceP_f: Forward?
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Hidden() -> AnyObject.Type {
        Hidden.self
    }
}
...
open class Hidden: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(Forward.self) { iceP_self.f = $0 }
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Forward() -> AnyObject.Type {
        Forward.self
    }
}
...
open class Forward: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(Hidden.self) { iceP_self.h = $0 }
        try istr.endSlice()
    }
...
public protocol TestIntf: Ice.Dispatcher {
    ...
    func checkSUnknown(o: sending Ice.Value?, current: Ice.Current) async throws
    ...
    func returnTest3(p1: sending B?, p2: sending B?, current: Ice.Current) async throws -> B?

    func sequenceTest(p1: sending SS1?, p2: sending SS2?, current: Ice.Current) async throws -> SS3

    func dictionaryTest(bin: sending BDict, current: Ice.Current) async throws -> (returnValue: BDict, bout: BDict)

    func exchangePBase(pb: sending PBase?, current: Ice.Current) async throws -> PBase?

    func PBSUnknownAsPreserved(current: Ice.Current) async throws -> Preserved?

    func checkPBSUnknown(p: sending Preserved?, current: Ice.Current) async throws

    func PBSUnknownAsPreservedWithGraph(current: Ice.Current) async throws -> Preserved?

    func checkPBSUnknownWithGraph(p: sending Preserved?, current: Ice.Current) async throws

    func PBSUnknown2AsPreservedWithGraph(current: Ice.Current) async throws -> Preserved?

    func checkPBSUnknown2WithGraph(p: sending Preserved?, current: Ice.Current) async throws

    func exchangePNode(pn: sending PNode?, current: Ice.Current) async throws -> PNode?
...
extension TestIntf {
    ...
    public func _iceD_sequenceTest(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_p1: SS1?
        try istr.read(SS1.self) { iceP_p1 = $0 }
        nonisolated(unsafe) var iceP_p2: SS2?
    ...
    public func _iceD_exchangePBase(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_pb: PBase?
    ...
    public func _iceD_checkPBSUnknown(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_p: Preserved?
    ...
    public func _iceD_exchangePNode(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_pn: PNode?
