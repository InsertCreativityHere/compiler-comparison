...
private final class HoldPrxI: Ice.ObjectPrxI, HoldPrx, @unchecked Sendable {
...
public extension HoldPrx {
    ...
    func putOnHold(_ iceP_delay: Swift.Int32, context: Ice.Context? = nil) async throws {
    ...
    func waitForHold(context: Ice.Context? = nil) async throws {
    ...
    ///   - context: Optional request context.
    func setOneway(value iceP_value: Swift.Int32, expected iceP_expected: Swift.Int32, context: Ice.Context? = nil) async throws {
...
public protocol Hold: Ice.Dispatcher {
    /// Puts the adapter on hold, and optionally reactivates it.
    ///
    /// - Parameters:
...
extension Hold {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Hold, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
