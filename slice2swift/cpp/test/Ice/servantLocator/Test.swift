...
public struct TestIntfDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        ...
        case "cppException":
            servant._iceD_cppException(request)
        case "ice_id":
        ...
        case "stdException":
            servant._iceD_stdException(request)
...
extension TestIntf {
    ...
    public func _iceD_stdException(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            _ = try request.inputStream.skipEmptyEncapsulation()
    ...
    public func _iceD_cppException(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            _ = try request.inputStream.skipEmptyEncapsulation()
