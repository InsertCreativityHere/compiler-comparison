...
public extension TestIntfPrx {
    ...
    func stdException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "stdException",
                                       mode: .normal,
                                       context: context)
    }

    func cppException(context: Ice.Context? = nil) async throws {
...
extension TestIntf {
    ...
    public static func dispatch(_ servant: TestIntf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "stdException":
            try await servant._iceD_stdException(request)
        case "cppException":
            try await servant._iceD_cppException(request)
    ...
    public func _iceD_stdException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.stdException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }

    public func _iceD_cppException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.cppException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
