...
public extension TestIntfPrx {
    ...
    ///
    /// - returns: `` - The result of the operation
    func stdExceptionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
    ...
    ///
    /// - returns: `` - The result of the operation
    func cppExceptionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
...
extension TestIntf {
    ...
    public func _iceD_stdException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        try self.stdException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
    ...
    public func _iceD_cppException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        try self.cppException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
