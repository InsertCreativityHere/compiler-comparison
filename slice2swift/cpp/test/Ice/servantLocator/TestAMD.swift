...
public protocol TestIntf {
    ...
    ///
    /// - returns: `` - The result of the operation
    func stdExceptionAsync(current: Ice.Current) async throws -> Swift.Void

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `` - The result of the operation
    func cppExceptionAsync(current: Ice.Current) async throws -> Swift.Void
...
extension TestIntf {
    ...
    public func _iceD_stdException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.stdExceptionAsync(
            current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
    ...
    public func _iceD_cppException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.cppExceptionAsync(
            current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
