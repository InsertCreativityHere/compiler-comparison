...
public protocol TestIntf {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func stdExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func cppExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>
...
public extension TestIntf {
    ...
    func _iceD_stdException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(stdExceptionAsync(current: current))
    }

    func _iceD_cppException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(cppExceptionAsync(current: current))
    }
