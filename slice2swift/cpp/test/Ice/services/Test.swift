...
private final class ClockPrxI: Ice.ObjectPrxI, ClockPrx, @unchecked Sendable {
...
public extension ClockPrx {
    func tick(_ iceP_time: Swift.String, context: Ice.Context? = nil) async throws {
...
extension Clock {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Clock, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
