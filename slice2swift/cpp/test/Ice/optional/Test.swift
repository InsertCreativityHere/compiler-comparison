...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_OneOptional() -> AnyObject.Type {
        OneOptional.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_MultiOptional() -> AnyObject.Type {
        MultiOptional.self
    }
}
...
open class MultiOptional: Ice.Value {
    ...
    public var defaultedString: Swift.String? = ""

    public required init() {}

    public init(a: Swift.UInt8?, b: Swift.Bool?, c: Swift.Int16?, d: Swift.Int32?, e: Swift.Int64?, f: Swift.Float?, g: Swift.Double?, h: Swift.String?, i: MyEnum?, j: MyInterfacePrx?, bs: ByteSeq?, ss: StringSeq?, iid: IntIntDict?, sid: StringIntDict?, fs: FixedStruct?, vs: VarStruct?, shs: ShortSeq?, es: MyEnumSeq?, fss: FixedStructSeq?, vss: VarStructSeq?, mips: MyInterfacePrxSeq?, ied: IntEnumDict?, ifsd: IntFixedStructDict?, ivsd: IntVarStructDict?, imipd: IntMyInterfacePrxDict?, bos: BoolSeq?, ser: Serializable?, defaultedString: Swift.String? = "") {
        self.a = a
        self.b = b
        self.c = c
        self.d = d
        ...
        self.bos = bos
        self.ser = ser
        self.defaultedString = defaultedString
    }
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.defaultedString = try istr.read(tag: 31)
        try istr.endSlice()
    }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ...
        ostr.write(tag: 31, value: self.defaultedString)
        ostr.endSlice()
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_WD() -> AnyObject.Type {
        WD.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_OptionalException() -> AnyObject.Type {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_DerivedException() -> AnyObject.Type {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_RequiredException() -> AnyObject.Type {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_F() -> AnyObject.Type {
        F.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_G() -> AnyObject.Type {
        G.self
    }
}
