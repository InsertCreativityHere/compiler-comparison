...
public let IntConst2: Swift.Int32 = 100

public let IntConst3: Swift.Int32 = 100
...
/// An `Ice.InputStream` extension to read `Enum4` enumerated values from the stream.
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - returns: `Enum4` - The enumarated value.
    func read() throws -> Enum4 {
        let rawValue: Swift.UInt8 = try read(enumMaxValue: 2)
        guard let val = Enum4(rawValue: rawValue) else {
            throw Ice.MarshalException(reason: "invalid enum value")
        }
        return val
    }
    ...
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Enum4` - The enumerated value.
    func read(tag: Swift.Int32) throws -> Enum4? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
        return try read() as Enum4
    }
}

/// An `Ice.OutputStream` extension to write `Enum4` enumerated values to the stream.
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// parameter _: `Enum4` - The enumerator to write.
    func write(_ v: Enum4) {
        write(enum: v.rawValue, maxValue: 2)
    }
    ...
    ///
    /// parameter _: `Enum4` - The enumerator to write.
    func write(tag: Swift.Int32, value: Enum4?) {
        guard let v = value else {
            return
        }
        write(tag: tag, val: v.rawValue, maxValue: 2)
...
public enum EnumExplicit2: Swift.UInt8 {
    ...
    /// EnumExplicit22
    case EnumExplicit22 = 2
    /// EnumExplicit23
    case EnumExplicit23 = 3
    public init() {
        self = .EnumExplicit21
    }
}
...
public typealias Sequence2 = [Swift.Int32]

public typealias Sequence3 = [Swift.Int32]
...
public typealias Dictionary2 = [Swift.String: Swift.Int32]
...
public typealias Dictionary3 = [Swift.String: Swift.Int32]
...
public typealias Dictionary4 = [Swift.String: Swift.Int32]

/// Helper class to read and write `Dictionary4` dictionary values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct Dictionary4Helper {
    /// Read a `Dictionary4` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `Dictionary4` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> Dictionary4 {
        let sz = try Swift.Int(istr.readSize())
        var v = Dictionary4()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    /// Read an optional `Dictionary4?` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Dictionary4` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> Dictionary4? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `Dictionary4` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `Dictionary4` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: Dictionary4) {
        ostr.write(size: v.count)
        for (key, value) in v {
            ostr.write(key)
            ostr.write(value)
    ...
    /// Wite an optional `Dictionary4?` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `Dictionary4` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, tag: Swift.Int32, value v: Dictionary4?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public struct Struct2: Swift.Hashable {
    public var str: Swift.String = ""
    public var b: Swift.Bool = false
...
public struct Struct3: Swift.Hashable {
    public var str: Swift.String = ""
    public var b: Swift.Bool = false
...
public struct Struct5: Swift.Hashable {
    public var str: Swift.String = ""
    public var b: Swift.Bool = false
...
/// An `Ice.InputStream` extension to read `Struct5` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `Struct5` structured value from the stream.
    ///
    /// - returns: `Struct5` - The structured value read from the stream.
    func read() throws -> Struct5 {
        var v = Struct5()
        v.str = try self.read()
        v.b = try self.read()
        return v
    ...
    /// Read an optional `Struct5?` structured value from the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Struct5?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> Struct5? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as Struct5
    }
}

/// An `Ice.OutputStream` extension to write `Struct5` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `Struct5` structured value to the stream.
    ///
    /// - parameter _: `Struct5` - The value to write to the stream.
    func write(_ v: Struct5) {
        self.write(v.str)
        self.write(v.b)
    }

    /// Write an optional `Struct5?` structured value to the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `Struct5?` - The value to write to the stream.
    func write(tag: Swift.Int32, value: Struct5?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
public struct Interface3Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::Interface3"]
...
public struct EmptyClass4Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::EmptyClass4"]
...
public struct EmptyClass5Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::EmptyClass5"]
...
open class Exception5: Ice.UserException {
    public required init() {}
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: Exception5.ice_staticId(), compactId: -1, last: true)
        ostr.endSlice()
    }
...
/// :nodoc:
public class Exception6_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
...
public extension Ice.ClassResolver {
    @objc static func Test_Exception6() -> Ice.UserExceptionTypeResolver {
        return Exception6_TypeResolver()
    }
}

open class Exception6: Ice.UserException {
    public var str: Swift.String = ""
    public var b: Swift.Bool = false
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: Exception6.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.str)
        ostr.write(self.b)
        ostr.endSlice()
    }
...
public struct BaseInterface9Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::BaseInterface9"]
...
public protocol Interface3Prx: Ice.ObjectPrx {}
...
///
///  - baseOp2Async: 
public protocol BaseInterface9Prx: Ice.ObjectPrx {}
...
public extension OptionalParameters2Prx {
    ...
    func op1(firstName iceP_firstName: Swift.String, emailAddress iceP_emailAddress: Swift.String? = nil, secondName iceP_secondName: Swift.String? = nil, context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "op1",
                          ...
                          write: { ostr in
                              ostr.write(iceP_firstName)
                              ostr.write(tag: 1, value: iceP_emailAddress)
                              ostr.write(tag: 2, value: iceP_secondName)
                          },
                          context: context)
    }
...
public extension OptionalParameters3Prx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func op1(firstName iceP_firstName: Swift.String, emailAddress iceP_emailAddress: Swift.String? = nil, secondName iceP_secondName: Swift.String, context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "op1",
                          mode: .Normal,
                          write: { ostr in
                              ostr.write(iceP_firstName)
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func op1Async(firstName iceP_firstName: Swift.String, emailAddress iceP_emailAddress: Swift.String? = nil, secondName iceP_secondName: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "op1",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_firstName)
...
open class EmptyClass4: Ice.Value {
    public required init() {}
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: EmptyClass4Traits.staticId, compactId: -1, last: true)
        ostr.endSlice()
    }
}
...
open class Compact2: Ice.Value {
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: Compact2Traits.staticId, compactId: 2, last: true)
        ostr.write(self.id)
        ostr.endSlice()
    }
}
...
public protocol BaseInterface9 {
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func baseOp(current: Ice.Current) throws
...
public extension OptionalParameters2 {
    func _iceD_op1(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let (iceP_firstName, iceP_emailAddress, iceP_secondName): (Swift.String, Swift.String?, Swift.String?) = try inS.read { istr in
            let iceP_firstName: Swift.String = try istr.read()
            let iceP_emailAddress: Swift.String? = try istr.read(tag: 1)
            let iceP_secondName: Swift.String? = try istr.read(tag: 2)
...
public extension OptionalParameters3 {
    func _iceD_op1(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let (iceP_firstName, iceP_emailAddress, iceP_secondName): (Swift.String, Swift.String?, Swift.String) = try inS.read { istr in
            let iceP_firstName: Swift.String = try istr.read()
            let iceP_secondName: Swift.String = try istr.read()
            let iceP_emailAddress: Swift.String? = try istr.read(tag: 1)
            return (iceP_firstName, iceP_emailAddress, iceP_secondName)
        }
