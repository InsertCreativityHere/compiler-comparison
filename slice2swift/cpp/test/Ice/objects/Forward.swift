...
private final class F2PrxI: Ice.ObjectPrxI, F2Prx, @unchecked Sendable {
...
extension F2 {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: F2, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
