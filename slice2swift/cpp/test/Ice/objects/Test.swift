...
open class Base: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.theS = try istr.read()
        iceP_self.str = try istr.read()
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_BaseEx() -> AnyObject.Type {
        BaseEx.self
    }
}
...
open class A: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(B.self) { iceP_self.theB = $0 }
        try istr.read(C.self) { iceP_self.theC = $0 }
        iceP_self.preMarshalInvoked = try istr.read()
        iceP_self.postUnmarshalInvoked = try istr.read()
        try istr.endSlice()
    }
...
open class B: A {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(A.self) { iceP_self.theA = $0 }
        try istr.endSlice()
...
private final class JPrxI: Ice.ObjectPrxI, JPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
///
/// - Throws: `Ice.LocalException` if a communication error occurs.
public func checkedCast(prx: Ice.ObjectPrx, type: JPrx.Protocol, facet: Swift.String? = nil, context: Ice.Context? = nil) async throws -> JPrx? {
    return try await JPrxI.checkedCast(prx: prx, facet: facet, context: context) as JPrxI?
}
...
public struct BaseSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending BaseSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = BaseSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BaseSeq? {
...
public enum CompactIdEnum: Swift.UInt8, Swift.Sendable {
    case First = 1
    case Second = 2
    public init() {
        self = .First
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Compact() -> AnyObject.Type {
        Compact.self
    }

    @objc static func resolveTypeId_1() -> AnyObject.Type {
        Compact.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CompactScoped() -> AnyObject.Type {
        CompactScoped.self
    }

    @objc static func resolveTypeId_2() -> AnyObject.Type {
        CompactScoped.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CompactExt() -> AnyObject.Type {
        CompactExt.self
    }

    @objc static func resolveTypeId_789() -> AnyObject.Type {
        CompactExt.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Inner_A() -> AnyObject.Type {
        InnerA.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Inner_Ex() -> AnyObject.Type {
        InnerEx.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Inner_Sub_A() -> AnyObject.Type {
        InnerSubA.self
    }
}
...
open class InnerSubA: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(InnerA.self) { iceP_self.theA = $0 }
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Inner_Sub_Ex() -> AnyObject.Type {
        InnerSubEx.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_A1() -> AnyObject.Type {
        A1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_B1() -> AnyObject.Type {
        B1.self
    }
}
...
open class B1: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(A1.self) { iceP_self.a1 = $0 }
        try istr.read(A1.self) { iceP_self.a2 = $0 }
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_D1() -> AnyObject.Type {
        D1.self
    }
}
...
open class D1: B1 {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(A1.self) { iceP_self.a3 = $0 }
        try istr.read(A1.self) { iceP_self.a4 = $0 }
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_EBase() -> AnyObject.Type {
        EBase.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_EDerived() -> AnyObject.Type {
        EDerived.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Recursive() -> AnyObject.Type {
        Recursive.self
    }
}
...
open class Recursive: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(Recursive.self) { iceP_self.v = $0 }
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_K() -> AnyObject.Type {
        K.self
    }
}
...
open class K: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read() { iceP_self.value = $0 }
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_L() -> AnyObject.Type {
        L.self
    }
}
...
public struct ValueSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ValueSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ValueSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ValueSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ValueMapHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending ValueMap {
        let sz = try Swift.Int(istr.readSize())
        var v = ValueMap()
        nonisolated(unsafe) let e = Ice.DictEntryArray<Swift.String, Ice.Value?>(size: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ValueMap? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LMapHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LMap {
        let sz = try Swift.Int(istr.readSize())
        var v = LMap()
        nonisolated(unsafe) let e = Ice.DictEntryArray<StructKey, L?>(size: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LMap? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_M() -> AnyObject.Type {
        M.self
    }
}
...
open class M: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.v = try LMapHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_F3() -> AnyObject.Type {
        F3.self
    }
}
...
open class F3: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(F1.self) { iceP_self.f1 = $0 }
        iceP_self.f2 = try istr.read(F2Prx.self)
        try istr.endSlice()
    }
...
public extension InitialPrx {
    ...
    func getB1(context: Ice.Context? = nil) async throws -> B? {
        ...
        func read(istr: Ice.InputStream) throws -> sending B? {
            nonisolated(unsafe) var iceP_returnValue: B?
    ...
    func getC(context: Ice.Context? = nil) async throws -> C? {
        ...
        func read(istr: Ice.InputStream) throws -> sending C? {
            nonisolated(unsafe) var iceP_returnValue: C?
    ...
    func setRecursive(_ iceP_p: Recursive?, context: Ice.Context? = nil) async throws {
    ...
    func setCycle(_ iceP_r: Recursive?, context: Ice.Context? = nil) async throws {
    ...
    func getAll(context: Ice.Context? = nil) async throws -> (b1: B?, b2: B?, theC: C?, theD: D?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (b1: B?, b2: B?, theC: C?, theD: D?) {
            nonisolated(unsafe) var iceP_b1: B?
            try istr.read(B.self) { iceP_b1 = $0 }
            nonisolated(unsafe) var iceP_b2: B?
            try istr.read(B.self) { iceP_b2 = $0 }
            nonisolated(unsafe) var iceP_theC: C?
            try istr.read(C.self) { iceP_theC = $0 }
            nonisolated(unsafe) var iceP_theD: D?
    ...
    func getK(context: Ice.Context? = nil) async throws -> K? {
        ...
        func read(istr: Ice.InputStream) throws -> sending K? {
            nonisolated(unsafe) var iceP_returnValue: K?
    ...
    func opValue(_ iceP_v1: Ice.Value?, context: Ice.Context? = nil) async throws -> (returnValue: Ice.Value?, v2: Ice.Value?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Ice.Value?, v2: Ice.Value?) {
            nonisolated(unsafe) var iceP_v2: Ice.Value?
    ...
    func opValueSeq(_ iceP_v1: ValueSeq, context: Ice.Context? = nil) async throws -> (returnValue: ValueSeq, v2: ValueSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ValueSeq, v2: ValueSeq) {
    ...
    func opValueMap(_ iceP_v1: ValueMap, context: Ice.Context? = nil) async throws -> (returnValue: ValueMap, v2: ValueMap) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ValueMap, v2: ValueMap) {
    ...
    func getD1(_ iceP_d1: D1?, context: Ice.Context? = nil) async throws -> D1? {
        ...
        func read(istr: Ice.InputStream) throws -> sending D1? {
            nonisolated(unsafe) var iceP_returnValue: D1?
    ...
    func throwEDerived(context: Ice.Context? = nil) async throws {
    ...
    func setG(_ iceP_theG: G?, context: Ice.Context? = nil) async throws {
    ...
    func opBaseSeq(_ iceP_inSeq: BaseSeq, context: Ice.Context? = nil) async throws -> (returnValue: BaseSeq, outSeq: BaseSeq) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BaseSeq, outSeq: BaseSeq) {
    ...
    func getCompact(context: Ice.Context? = nil) async throws -> Compact? {
        ...
        func read(istr: Ice.InputStream) throws -> sending Compact? {
            nonisolated(unsafe) var iceP_returnValue: Compact?
    ...
    func getInnerA(context: Ice.Context? = nil) async throws -> InnerA? {
        ...
        func read(istr: Ice.InputStream) throws -> sending InnerA? {
            nonisolated(unsafe) var iceP_returnValue: InnerA?
    ...
    func getInnerSubA(context: Ice.Context? = nil) async throws -> InnerSubA? {
        ...
        func read(istr: Ice.InputStream) throws -> sending InnerSubA? {
            nonisolated(unsafe) var iceP_returnValue: InnerSubA?
    ...
    func throwInnerEx(context: Ice.Context? = nil) async throws {
    ...
    func throwInnerSubEx(context: Ice.Context? = nil) async throws {
    ...
    func opM(_ iceP_v1: M?, context: Ice.Context? = nil) async throws -> (returnValue: M?, v2: M?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: M?, v2: M?) {
            nonisolated(unsafe) var iceP_v2: M?
            try istr.read(M.self) { iceP_v2 = $0 }
            nonisolated(unsafe) var iceP_returnValue: M?
    ...
    func opF1(_ iceP_f11: F1?, context: Ice.Context? = nil) async throws -> (returnValue: F1?, f12: F1?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: F1?, f12: F1?) {
            nonisolated(unsafe) var iceP_f12: F1?
            try istr.read(F1.self) { iceP_f12 = $0 }
            nonisolated(unsafe) var iceP_returnValue: F1?
    ...
    func opF2(_ iceP_f21: F2Prx?, context: Ice.Context? = nil) async throws -> (returnValue: F2Prx?, f22: F2Prx?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: F2Prx?, f22: F2Prx?) {
    ...
    func opF3(_ iceP_f31: F3?, context: Ice.Context? = nil) async throws -> (returnValue: F3?, f32: F3?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: F3?, f32: F3?) {
            nonisolated(unsafe) var iceP_f32: F3?
            try istr.read(F3.self) { iceP_f32 = $0 }
            nonisolated(unsafe) var iceP_returnValue: F3?
...
public extension TestIntfPrx {
    func opDerived(context: Ice.Context? = nil) async throws -> Base? {
        return try await _impl._invoke(operation: "opDerived",
                                       mode: .normal,
                                       read: read,
                                       context: context)

        func read(istr: Ice.InputStream) throws -> sending Base? {
            nonisolated(unsafe) var iceP_returnValue: Base?
    ...
    func throwDerived(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "throwDerived",
                                       mode: .normal,
                                       userException:{ ex in
                                           do  {
                                               throw ex
...
public protocol Initial: Ice.Dispatcher {
    ...
    func setRecursive(p: sending Recursive?, current: Ice.Current) async throws

    func setCycle(r: sending Recursive?, current: Ice.Current) async throws
    ...
    func opValue(v1: sending Ice.Value?, current: Ice.Current) async throws -> (returnValue: Ice.Value?, v2: Ice.Value?)

    func opValueSeq(v1: sending ValueSeq, current: Ice.Current) async throws -> (returnValue: ValueSeq, v2: ValueSeq)

    func opValueMap(v1: sending ValueMap, current: Ice.Current) async throws -> (returnValue: ValueMap, v2: ValueMap)

    func getD1(d1: sending D1?, current: Ice.Current) async throws -> D1?

    func throwEDerived(current: Ice.Current) async throws

    func setG(theG: sending G?, current: Ice.Current) async throws

    func opBaseSeq(inSeq: sending BaseSeq, current: Ice.Current) async throws -> (returnValue: BaseSeq, outSeq: BaseSeq)
    ...
    func opM(v1: sending M?, current: Ice.Current) async throws -> (returnValue: M?, v2: M?)

    func opF1(f11: sending F1?, current: Ice.Current) async throws -> (returnValue: F1?, f12: F1?)
    ...
    func opF3(f31: sending F3?, current: Ice.Current) async throws -> (returnValue: F3?, f32: F3?)
}

public protocol TestIntf: Ice.Dispatcher {
    func opDerived(current: Ice.Current) async throws -> Base?

    func throwDerived(current: Ice.Current) async throws
}
...
extension J {
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: J, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "ice_id":
            try await (servant as? Ice.Object ?? Self.defaultObject)._iceD_ice_id(request)
        case "ice_ids":
...
extension Initial {
    ...
    public func _iceD_setRecursive(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        nonisolated(unsafe) var iceP_p: Recursive?
    ...
    public func _iceD_setCycle(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_r: Recursive?
    ...
    public func _iceD_opValue(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_v1: Ice.Value?
    ...
    public func _iceD_getD1(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_d1: D1?
    ...
    public func _iceD_setG(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_theG: G?
    ...
    public func _iceD_opM(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_v1: M?
    ...
    public func _iceD_opF1(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_f11: F1?
    ...
    public func _iceD_opF3(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_f31: F3?
...
extension TestIntf {
    ...
    public func _iceD_opDerived(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        let result = try await self.opDerived(current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
            ostr.writePendingValues()
    ...
    public func _iceD_throwDerived(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.throwDerived(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
}
