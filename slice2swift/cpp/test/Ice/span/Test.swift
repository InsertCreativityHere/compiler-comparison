...
public protocol TestIntf {
    ...
    ///
    ///   - dataOut: `ByteSeq`
    func opByteSpan(dataIn: ByteSeq, current: Ice.Current) throws -> (returnValue: ByteSeq, dataOut: ByteSeq)
    ...
    ///
    ///   - dataOut: `ShortSeq`
    func opShortSpan(dataIn: ShortSeq, current: Ice.Current) throws -> (returnValue: ShortSeq, dataOut: ShortSeq)
    ...
    ///
    ///   - dataOut: `StringSeq`
    func opStringSpan(dataIn: StringSeq, current: Ice.Current) throws -> (returnValue: StringSeq, dataOut: StringSeq)
    ...
    ///
    ///   - dataOut: `ByteSeq?`
    func opOptionalByteSpan(dataIn: ByteSeq?, current: Ice.Current) throws -> (returnValue: ByteSeq?, dataOut: ByteSeq?)
    ...
    ///
    ///   - dataOut: `ShortSeq?`
    func opOptionalShortSpan(dataIn: ShortSeq?, current: Ice.Current) throws -> (returnValue: ShortSeq?, dataOut: ShortSeq?)
    ...
    ///
    ///   - dataOut: `StringSeq?`
    func opOptionalStringSpan(dataIn: StringSeq?, current: Ice.Current) throws -> (returnValue: StringSeq?, dataOut: StringSeq?)
...
public extension TestIntf {
    func _iceD_opByteSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opByteSpan(dataIn: iceP_dataIn, current: current)
    ...
    func _iceD_opShortSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opShortSpan(dataIn: iceP_dataIn, current: current)
    ...
    func _iceD_opStringSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opStringSpan(dataIn: iceP_dataIn, current: current)
    ...
    func _iceD_opOptionalByteSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opOptionalByteSpan(dataIn: iceP_dataIn, current: current)
    ...
    func _iceD_opOptionalShortSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opOptionalShortSpan(dataIn: iceP_dataIn, current: current)
    ...
    func _iceD_opOptionalStringSpan(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_dataOut) = try self.opOptionalStringSpan(dataIn: iceP_dataIn, current: current)
