...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test1_WstringException() -> AnyObject.Type {
        WstringException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test2_WstringException() -> AnyObject.Type {
        WstringException.self
    }
}
