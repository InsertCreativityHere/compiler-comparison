...
public struct BoolDequeListHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending BoolDequeList {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = BoolDequeList()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BoolDequeList? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension TestIntfPrx {
    ...
    func opBoolDequeList(_ iceP_inSeq: BoolDequeList, context: Ice.Context? = nil) async throws -> (returnValue: BoolDequeList, outSeq: BoolDequeList) {
        return try await _impl._invoke(operation: "opBoolDequeList",
                                       mode: .normal,
                                       write: { ostr in
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BoolDequeList, outSeq: BoolDequeList) {
    ...
    func opBoolDequeListArray(_ iceP_inSeq: BoolDequeList, context: Ice.Context? = nil) async throws -> (returnValue: BoolDequeList, outSeq: BoolDequeList) {
        return try await _impl._invoke(operation: "opBoolDequeListArray",
                                       mode: .normal,
                                       write: { ostr in
                                           BoolDequeListHelper.write(to: ostr, value: iceP_inSeq)
                                       },
...
public protocol TestIntf: Ice.Dispatcher {
    ...
    func opBoolDequeList(inSeq: BoolDequeList, current: Ice.Current) async throws -> (returnValue: BoolDequeList, outSeq: BoolDequeList)

    func opBoolDequeListArray(inSeq: BoolDequeList, current: Ice.Current) async throws -> (returnValue: BoolDequeList, outSeq: BoolDequeList)
...
extension TestIntf {
    ...
    public static func dispatch(_ servant: TestIntf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "opBoolDequeList":
            try await servant._iceD_opBoolDequeList(request)
        case "opBoolDequeListArray":
            try await servant._iceD_opBoolDequeListArray(request)
        case "opByteSeq":
    ...
    public func _iceD_opBoolDequeList(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_inSeq: BoolDequeList = try BoolDequeListHelper.read(from: istr)
        let result = try await self.opBoolDequeList(inSeq: iceP_inSeq, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_outSeq) = value
    ...
    public func _iceD_opBoolDequeListArray(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_inSeq: BoolDequeList = try BoolDequeListHelper.read(from: istr)
        let result = try await self.opBoolDequeListArray(inSeq: iceP_inSeq, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_outSeq) = value
            BoolDequeListHelper.write(to: ostr, value: iceP_outSeq)
            BoolDequeListHelper.write(to: ostr, value: iceP_returnValue)
