...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_OptionalClass() -> AnyObject.Type {
        OptionalClass.self
    }
}
...
public struct LargeStructSHelper {
    ...
    /// Write a `LargeStructS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `LargeStructS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct LargeStructSSHelper {
    ...
    /// Write a `LargeStructSS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `LargeStructSS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_MyException() -> AnyObject.Type {
        MyException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_Sub_NestedException() -> AnyObject.Type {
        SubNestedException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test2_Sub2_NestedException2() -> AnyObject.Type {
        Sub2NestedException2.self
    }
}
