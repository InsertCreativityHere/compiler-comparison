...
/// An `Ice.InputStream` extension to read `SubNestedEnum` enumerated values from the stream.
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - returns: `SubNestedEnum` - The enumarated value.
    ...
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `SubNestedEnum` - The enumerated value.
    func read(tag: Swift.Int32) throws -> SubNestedEnum? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
        return try read() as SubNestedEnum
    }
}

/// An `Ice.OutputStream` extension to write `SubNestedEnum` enumerated values to the stream.
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// parameter _: `SubNestedEnum` - The enumerator to write.
    func write(_ v: SubNestedEnum) {
        write(enum: v.rawValue, maxValue: 2)
    }
    ...
    ///
    /// parameter _: `SubNestedEnum` - The enumerator to write.
    func write(tag: Swift.Int32, value: SubNestedEnum?) {
        guard let v = value else {
            return
        }
        write(tag: tag, val: v.rawValue, maxValue: 2)
...
public struct SubNestedStruct {
    ...
    public var d: Swift.Double = 0.0
    public var str: Swift.String = ""
    public var e: SubNestedEnum = .nestedEnum1
...
/// An `Ice.InputStream` extension to read `SubNestedStruct` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `SubNestedStruct` structured value from the stream.
    ///
    /// - returns: `SubNestedStruct` - The structured value read from the stream.
    func read() throws -> SubNestedStruct {
        var v = SubNestedStruct()
        v.bo = try self.read()
        v.by = try self.read()
        v.sh = try self.read()
        v.i = try self.read()
    ...
    /// Read an optional `SubNestedStruct?` structured value from the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `SubNestedStruct?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> SubNestedStruct? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as SubNestedStruct
    }
}

/// An `Ice.OutputStream` extension to write `SubNestedStruct` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `SubNestedStruct` structured value to the stream.
    ///
    /// - parameter _: `SubNestedStruct` - The value to write to the stream.
    func write(_ v: SubNestedStruct) {
        self.write(v.bo)
        self.write(v.by)
        self.write(v.sh)
        self.write(v.i)
    ...
    /// Write an optional `SubNestedStruct?` structured value to the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `SubNestedStruct?` - The value to write to the stream.
    func write(tag: Swift.Int32, value: SubNestedStruct?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
public extension Ice.ClassResolver {
    @objc static func Test_Sub_NestedException() -> Ice.UserExceptionTypeResolver {
        return SubNestedException_TypeResolver()
    }
}
...
open class SubNestedException: Ice.UserException, @unchecked Sendable {
    ...
    ///
    /// - returns: `Swift.String` - the Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test::Sub::NestedException" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: SubNestedException.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.str)
        ostr.endSlice()
    }
...
/// An `Ice.InputStream` extension to read `Sub2NestedEnum2` enumerated values from the stream.
public extension Ice.InputStream {
    /// Read an enumerated value.
    ///
    /// - returns: `Sub2NestedEnum2` - The enumarated value.
    func read() throws -> Sub2NestedEnum2 {
        let rawValue: Swift.UInt8 = try read(enumMaxValue: 2)
        guard let val = Sub2NestedEnum2(rawValue: rawValue) else {
            throw Ice.MarshalException("invalid enum value")
        }
        return val
    }
    ...
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Sub2NestedEnum2` - The enumerated value.
    func read(tag: Swift.Int32) throws -> Sub2NestedEnum2? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
        return try read() as Sub2NestedEnum2
    }
}

/// An `Ice.OutputStream` extension to write `Sub2NestedEnum2` enumerated values to the stream.
public extension Ice.OutputStream {
    /// Writes an enumerated value to the stream.
    ///
    /// parameter _: `Sub2NestedEnum2` - The enumerator to write.
    func write(_ v: Sub2NestedEnum2) {
        write(enum: v.rawValue, maxValue: 2)
    }
    ...
    ///
    /// parameter _: `Sub2NestedEnum2` - The enumerator to write.
    func write(tag: Swift.Int32, value: Sub2NestedEnum2?) {
        guard let v = value else {
            return
        }
        write(tag: tag, val: v.rawValue, maxValue: 2)
...
public struct Sub2NestedStruct2 {
    public var bo: Swift.Bool = false
    public var by: Swift.UInt8 = 0
    public var sh: Swift.Int16 = 0
    public var i: Swift.Int32 = 0
    ...
    public var d: Swift.Double = 0.0
    public var str: Swift.String = ""
    public var e: Sub2NestedEnum2 = .nestedEnum4

    public init() {}

    public init(bo: Swift.Bool, by: Swift.UInt8, sh: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, e: Sub2NestedEnum2) {
        self.bo = bo
        self.by = by
        self.sh = sh
        self.i = i
...
/// An `Ice.InputStream` extension to read `Sub2NestedStruct2` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `Sub2NestedStruct2` structured value from the stream.
    ///
    /// - returns: `Sub2NestedStruct2` - The structured value read from the stream.
    func read() throws -> Sub2NestedStruct2 {
        var v = Sub2NestedStruct2()
        v.bo = try self.read()
        v.by = try self.read()
        v.sh = try self.read()
        v.i = try self.read()
    ...
    /// Read an optional `Sub2NestedStruct2?` structured value from the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `Sub2NestedStruct2?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> Sub2NestedStruct2? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as Sub2NestedStruct2
    }
}

/// An `Ice.OutputStream` extension to write `Sub2NestedStruct2` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `Sub2NestedStruct2` structured value to the stream.
    ///
    /// - parameter _: `Sub2NestedStruct2` - The value to write to the stream.
    func write(_ v: Sub2NestedStruct2) {
        self.write(v.bo)
        self.write(v.by)
        self.write(v.sh)
        self.write(v.i)
    ...
    /// Write an optional `Sub2NestedStruct2?` structured value to the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `Sub2NestedStruct2?` - The value to write to the stream.
    func write(tag: Swift.Int32, value: Sub2NestedStruct2?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
/// :nodoc:
public class Sub2NestedException2_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
        return Sub2NestedException2.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test2_Sub2_NestedException2() -> Ice.UserExceptionTypeResolver {
        return Sub2NestedException2_TypeResolver()
    }
}
...
open class Sub2NestedException2: Ice.UserException, @unchecked Sendable {
    ...
    ///
    /// - returns: `Swift.String` - the Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test2::Sub2::NestedException2" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: Sub2NestedException2.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.str)
        ostr.endSlice()
    }
