...
public extension TestIntfBidirPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func makeSleepAsync(aborted iceP_aborted: Swift.Bool, ms iceP_ms: Swift.Int32, target iceP_target: DelayedTestIntfPrx?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "makeSleep",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_aborted)
                                      ostr.write(iceP_ms)
...
public struct DelayedTestIntfDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        ...
        case "ice_id":
            (servant as? Ice.Object ?? DelayedTestIntfDisp.defaultObject)._iceD_ice_id(request)
        case "ice_ids":
            (servant as? Ice.Object ?? DelayedTestIntfDisp.defaultObject)._iceD_ice_ids(request)
        case "ice_isA":
            (servant as? Ice.Object ?? DelayedTestIntfDisp.defaultObject)._iceD_ice_isA(request)
        case "ice_ping":
            (servant as? Ice.Object ?? DelayedTestIntfDisp.defaultObject)._iceD_ice_ping(request)
        case "sleep":
...
public struct TestIntfBidirDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        switch request.current.operation {
        case "ice_id":
            (servant as? Ice.Object ?? TestIntfBidirDisp.defaultObject)._iceD_ice_id(request)
        case "ice_ids":
            (servant as? Ice.Object ?? TestIntfBidirDisp.defaultObject)._iceD_ice_ids(request)
        case "ice_isA":
            (servant as? Ice.Object ?? TestIntfBidirDisp.defaultObject)._iceD_ice_isA(request)
        case "ice_ping":
            (servant as? Ice.Object ?? TestIntfBidirDisp.defaultObject)._iceD_ice_ping(request)
        case "makeSleep":
            servant._iceD_makeSleep(request)
        default:
            PromiseKit.Promise(error: Ice.OperationNotExistException())
        }
    }
...
extension TestIntfBidir {
    public func _iceD_makeSleep(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            let istr = request.inputStream
            _ = try istr.startEncapsulation()
