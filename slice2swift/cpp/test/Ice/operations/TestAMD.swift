...
public struct AnotherStruct: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending AnotherStruct {
        var v = AnotherStruct()
        v.s = try self.read()
        return v
    }
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending AnotherStruct? {
...
public struct Structure: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending Structure {
        var v = Structure()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending Structure? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct MyEnumSHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumS? {
...
public struct MyClassSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyClassS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyClassS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ByteSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ByteSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = ByteSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ByteSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct BoolSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending BoolSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = BoolSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BoolSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ShortSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ShortSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = ShortSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ShortSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = IntSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LongSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LongSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = LongSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LongSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct FloatSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending FloatSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = FloatSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending FloatSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct DoubleSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending DoubleSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = DoubleSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending DoubleSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = StringSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyEnumSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = MyEnumSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyClassSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyClassSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = MyClassSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyClassSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringSSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringSSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = StringSSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringSSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyStruct: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending MyStruct {
        var v = MyStruct()
        v.i = try self.read()
        v.j = try self.read()
        return v
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending MyStruct? {
...
public struct ByteBoolDHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending ByteBoolD {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ByteBoolD? {
...
public struct ShortIntDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ShortIntD {
        let sz = try Swift.Int(istr.readSize())
        var v = ShortIntD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ShortIntD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct LongFloatDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LongFloatD {
        let sz = try Swift.Int(istr.readSize())
        var v = LongFloatD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LongFloatD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct StringStringDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringStringD {
        let sz = try Swift.Int(istr.readSize())
        var v = StringStringD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringStringD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringMyEnumDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringMyEnumD {
        let sz = try Swift.Int(istr.readSize())
        var v = StringMyEnumD()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringMyEnumD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyEnumStringDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumStringD {
        let sz = try Swift.Int(istr.readSize())
        var v = MyEnumStringD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumStringD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyStructMyEnumDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyStructMyEnumD {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyStructMyEnumD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ByteBoolDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ByteBoolDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = ByteBoolDS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ByteBoolDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ShortIntDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ShortIntDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = ShortIntDS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ShortIntDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LongFloatDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LongFloatDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = LongFloatDS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LongFloatDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringStringDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringStringDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringStringDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringMyEnumDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringMyEnumDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringMyEnumDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyEnumStringDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumStringDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumStringDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyStructMyEnumDSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyStructMyEnumDS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyStructMyEnumDS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ByteByteSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ByteByteSD {
        let sz = try Swift.Int(istr.readSize())
        var v = ByteByteSD()
        for _ in 0 ..< sz {
            let key: Swift.UInt8 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ByteByteSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct BoolBoolSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending BoolBoolSD {
        let sz = try Swift.Int(istr.readSize())
        var v = BoolBoolSD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending BoolBoolSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ShortShortSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ShortShortSD {
        let sz = try Swift.Int(istr.readSize())
        var v = ShortShortSD()
        for _ in 0 ..< sz {
            let key: Swift.Int16 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ShortShortSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct IntIntSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending IntIntSD {
        let sz = try Swift.Int(istr.readSize())
        var v = IntIntSD()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending IntIntSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LongLongSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LongLongSD {
        let sz = try Swift.Int(istr.readSize())
        var v = LongLongSD()
        for _ in 0 ..< sz {
            let key: Swift.Int64 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LongLongSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringFloatSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringFloatSD {
        let sz = try Swift.Int(istr.readSize())
        var v = StringFloatSD()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringFloatSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringDoubleSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringDoubleSD {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringDoubleSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct StringStringSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StringStringSD {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StringStringSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct MyEnumMyEnumSDHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending MyEnumMyEnumSD {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending MyEnumMyEnumSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension MyClassPrx {
    ...
    func opShortIntLong(p1 iceP_p1: Swift.Int16, p2 iceP_p2: Swift.Int32, p3 iceP_p3: Swift.Int64, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Int64, p4: Swift.Int16, p5: Swift.Int32, p6: Swift.Int64) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Int64, p4: Swift.Int16, p5: Swift.Int32, p6: Swift.Int64) {
    ...
    func opFloatDouble(p1 iceP_p1: Swift.Float, p2 iceP_p2: Swift.Double, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Double, p3: Swift.Float, p4: Swift.Double) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Double, p3: Swift.Float, p4: Swift.Double) {
    ...
    func opMyEnum(_ iceP_p1: MyEnum, context: Ice.Context? = nil) async throws -> (returnValue: MyEnum, p2: MyEnum) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyEnum, p2: MyEnum) {
    ...
    func opMyClass(_ iceP_p1: MyClassPrx?, context: Ice.Context? = nil) async throws -> (returnValue: MyClassPrx?, p2: MyClassPrx?, p3: MyClassPrx?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyClassPrx?, p2: MyClassPrx?, p3: MyClassPrx?) {
    ...
    func opStruct(p1 iceP_p1: Structure, p2 iceP_p2: Structure, context: Ice.Context? = nil) async throws -> (returnValue: Structure, p3: Structure) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Structure, p3: Structure) {
    ...
    func opByteS(p1 iceP_p1: ByteS, p2 iceP_p2: ByteS, context: Ice.Context? = nil) async throws -> (returnValue: ByteS, p3: ByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteS, p3: ByteS) {
    ...
    func opBoolS(p1 iceP_p1: BoolS, p2 iceP_p2: BoolS, context: Ice.Context? = nil) async throws -> (returnValue: BoolS, p3: BoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BoolS, p3: BoolS) {
    ...
    func opShortIntLongS(p1 iceP_p1: ShortS, p2 iceP_p2: IntS, p3 iceP_p3: LongS, context: Ice.Context? = nil) async throws -> (returnValue: LongS, p4: ShortS, p5: IntS, p6: LongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongS, p4: ShortS, p5: IntS, p6: LongS) {
    ...
    func opFloatDoubleS(p1 iceP_p1: FloatS, p2 iceP_p2: DoubleS, context: Ice.Context? = nil) async throws -> (returnValue: DoubleS, p3: FloatS, p4: DoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: DoubleS, p3: FloatS, p4: DoubleS) {
    ...
    func opStringS(p1 iceP_p1: StringS, p2 iceP_p2: StringS, context: Ice.Context? = nil) async throws -> (returnValue: StringS, p3: StringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringS, p3: StringS) {
    ...
    func opByteSS(p1 iceP_p1: ByteSS, p2 iceP_p2: ByteSS, context: Ice.Context? = nil) async throws -> (returnValue: ByteSS, p3: ByteSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteSS, p3: ByteSS) {
    ...
    func opBoolSS(p1 iceP_p1: BoolSS, p2 iceP_p2: BoolSS, context: Ice.Context? = nil) async throws -> (returnValue: BoolSS, p3: BoolSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BoolSS, p3: BoolSS) {
    ...
    func opShortIntLongSS(p1 iceP_p1: ShortSS, p2 iceP_p2: IntSS, p3 iceP_p3: LongSS, context: Ice.Context? = nil) async throws -> (returnValue: LongSS, p4: ShortSS, p5: IntSS, p6: LongSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongSS, p4: ShortSS, p5: IntSS, p6: LongSS) {
    ...
    func opFloatDoubleSS(p1 iceP_p1: FloatSS, p2 iceP_p2: DoubleSS, context: Ice.Context? = nil) async throws -> (returnValue: DoubleSS, p3: FloatSS, p4: DoubleSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: DoubleSS, p3: FloatSS, p4: DoubleSS) {
    ...
    func opStringSS(p1 iceP_p1: StringSS, p2 iceP_p2: StringSS, context: Ice.Context? = nil) async throws -> (returnValue: StringSS, p3: StringSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringSS, p3: StringSS) {
    ...
    func opStringSSS(p1 iceP_p1: StringSSS, p2 iceP_p2: StringSSS, context: Ice.Context? = nil) async throws -> (returnValue: StringSSS, p3: StringSSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringSSS, p3: StringSSS) {
    ...
    func opByteBoolD(p1 iceP_p1: ByteBoolD, p2 iceP_p2: ByteBoolD, context: Ice.Context? = nil) async throws -> (returnValue: ByteBoolD, p3: ByteBoolD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteBoolD, p3: ByteBoolD) {
    ...
    func opShortIntD(p1 iceP_p1: ShortIntD, p2 iceP_p2: ShortIntD, context: Ice.Context? = nil) async throws -> (returnValue: ShortIntD, p3: ShortIntD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortIntD, p3: ShortIntD) {
    ...
    func opLongFloatD(p1 iceP_p1: LongFloatD, p2 iceP_p2: LongFloatD, context: Ice.Context? = nil) async throws -> (returnValue: LongFloatD, p3: LongFloatD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongFloatD, p3: LongFloatD) {
    ...
    func opStringStringD(p1 iceP_p1: StringStringD, p2 iceP_p2: StringStringD, context: Ice.Context? = nil) async throws -> (returnValue: StringStringD, p3: StringStringD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringStringD, p3: StringStringD) {
    ...
    func opStringMyEnumD(p1 iceP_p1: StringMyEnumD, p2 iceP_p2: StringMyEnumD, context: Ice.Context? = nil) async throws -> (returnValue: StringMyEnumD, p3: StringMyEnumD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringMyEnumD, p3: StringMyEnumD) {
    ...
    func opMyEnumStringD(p1 iceP_p1: MyEnumStringD, p2 iceP_p2: MyEnumStringD, context: Ice.Context? = nil) async throws -> (returnValue: MyEnumStringD, p3: MyEnumStringD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyEnumStringD, p3: MyEnumStringD) {
    ...
    func opMyStructMyEnumD(p1 iceP_p1: MyStructMyEnumD, p2 iceP_p2: MyStructMyEnumD, context: Ice.Context? = nil) async throws -> (returnValue: MyStructMyEnumD, p3: MyStructMyEnumD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyStructMyEnumD, p3: MyStructMyEnumD) {
    ...
    func opByteBoolDS(p1 iceP_p1: ByteBoolDS, p2 iceP_p2: ByteBoolDS, context: Ice.Context? = nil) async throws -> (returnValue: ByteBoolDS, p3: ByteBoolDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteBoolDS, p3: ByteBoolDS) {
    ...
    func opShortIntDS(p1 iceP_p1: ShortIntDS, p2 iceP_p2: ShortIntDS, context: Ice.Context? = nil) async throws -> (returnValue: ShortIntDS, p3: ShortIntDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortIntDS, p3: ShortIntDS) {
    ...
    func opLongFloatDS(p1 iceP_p1: LongFloatDS, p2 iceP_p2: LongFloatDS, context: Ice.Context? = nil) async throws -> (returnValue: LongFloatDS, p3: LongFloatDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongFloatDS, p3: LongFloatDS) {
    ...
    func opStringStringDS(p1 iceP_p1: StringStringDS, p2 iceP_p2: StringStringDS, context: Ice.Context? = nil) async throws -> (returnValue: StringStringDS, p3: StringStringDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringStringDS, p3: StringStringDS) {
    ...
    func opStringMyEnumDS(p1 iceP_p1: StringMyEnumDS, p2 iceP_p2: StringMyEnumDS, context: Ice.Context? = nil) async throws -> (returnValue: StringMyEnumDS, p3: StringMyEnumDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringMyEnumDS, p3: StringMyEnumDS) {
    ...
    func opMyEnumStringDS(p1 iceP_p1: MyEnumStringDS, p2 iceP_p2: MyEnumStringDS, context: Ice.Context? = nil) async throws -> (returnValue: MyEnumStringDS, p3: MyEnumStringDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyEnumStringDS, p3: MyEnumStringDS) {
    ...
    func opMyStructMyEnumDS(p1 iceP_p1: MyStructMyEnumDS, p2 iceP_p2: MyStructMyEnumDS, context: Ice.Context? = nil) async throws -> (returnValue: MyStructMyEnumDS, p3: MyStructMyEnumDS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyStructMyEnumDS, p3: MyStructMyEnumDS) {
    ...
    func opByteByteSD(p1 iceP_p1: ByteByteSD, p2 iceP_p2: ByteByteSD, context: Ice.Context? = nil) async throws -> (returnValue: ByteByteSD, p3: ByteByteSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteByteSD, p3: ByteByteSD) {
    ...
    func opBoolBoolSD(p1 iceP_p1: BoolBoolSD, p2 iceP_p2: BoolBoolSD, context: Ice.Context? = nil) async throws -> (returnValue: BoolBoolSD, p3: BoolBoolSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: BoolBoolSD, p3: BoolBoolSD) {
    ...
    func opShortShortSD(p1 iceP_p1: ShortShortSD, p2 iceP_p2: ShortShortSD, context: Ice.Context? = nil) async throws -> (returnValue: ShortShortSD, p3: ShortShortSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortShortSD, p3: ShortShortSD) {
    ...
    func opIntIntSD(p1 iceP_p1: IntIntSD, p2 iceP_p2: IntIntSD, context: Ice.Context? = nil) async throws -> (returnValue: IntIntSD, p3: IntIntSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntIntSD, p3: IntIntSD) {
    ...
    func opLongLongSD(p1 iceP_p1: LongLongSD, p2 iceP_p2: LongLongSD, context: Ice.Context? = nil) async throws -> (returnValue: LongLongSD, p3: LongLongSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LongLongSD, p3: LongLongSD) {
    ...
    func opStringFloatSD(p1 iceP_p1: StringFloatSD, p2 iceP_p2: StringFloatSD, context: Ice.Context? = nil) async throws -> (returnValue: StringFloatSD, p3: StringFloatSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringFloatSD, p3: StringFloatSD) {
    ...
    func opStringDoubleSD(p1 iceP_p1: StringDoubleSD, p2 iceP_p2: StringDoubleSD, context: Ice.Context? = nil) async throws -> (returnValue: StringDoubleSD, p3: StringDoubleSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringDoubleSD, p3: StringDoubleSD) {
    ...
    func opStringStringSD(p1 iceP_p1: StringStringSD, p2 iceP_p2: StringStringSD, context: Ice.Context? = nil) async throws -> (returnValue: StringStringSD, p3: StringStringSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringStringSD, p3: StringStringSD) {
    ...
    func opMyEnumMyEnumSD(p1 iceP_p1: MyEnumMyEnumSD, p2 iceP_p2: MyEnumMyEnumSD, context: Ice.Context? = nil) async throws -> (returnValue: MyEnumMyEnumSD, p3: MyEnumMyEnumSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: MyEnumMyEnumSD, p3: MyEnumMyEnumSD) {
    ...
    func opIntS(_ iceP_s: IntS, context: Ice.Context? = nil) async throws -> IntS {
        ...
        func read(istr: Ice.InputStream) throws -> sending IntS {
            let iceP_returnValue: IntS = try istr.read()
            return iceP_returnValue
        }
    }

    func opByteSOneway(_ iceP_s: ByteS, context: Ice.Context? = nil) async throws {
    ...
    func opDoubleMarshaling(p1 iceP_p1: Swift.Double, p2 iceP_p2: DoubleS, context: Ice.Context? = nil) async throws {
    ...
    func opIdempotent(context: Ice.Context? = nil) async throws {
    ...
    func opStringS1(_ iceP_opStringS1: StringS, context: Ice.Context? = nil) async throws -> StringS {
        ...
        func read(istr: Ice.InputStream) throws -> sending StringS {
            let iceP_returnValue: StringS = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opByteBoolD1(_ iceP_opByteBoolD1: ByteBoolD, context: Ice.Context? = nil) async throws -> ByteBoolD {
        ...
        func read(istr: Ice.InputStream) throws -> sending ByteBoolD {
            let iceP_returnValue: ByteBoolD = try ByteBoolDHelper.read(from: istr)
            return iceP_returnValue
        }
    }
    ...
    func opWStringLiterals(context: Ice.Context? = nil) async throws -> WStringS {
        ...
        func read(istr: Ice.InputStream) throws -> sending WStringS {
    ...
    func opMStruct1(context: Ice.Context? = nil) async throws -> Structure {
        ...
        func read(istr: Ice.InputStream) throws -> sending Structure {
            let iceP_returnValue: Structure = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opMStruct2(_ iceP_p1: Structure, context: Ice.Context? = nil) async throws -> (returnValue: Structure, p2: Structure) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Structure, p2: Structure) {
    ...
    func opMSeq2(_ iceP_p1: StringS, context: Ice.Context? = nil) async throws -> (returnValue: StringS, p2: StringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringS, p2: StringS) {
    ...
    func opMDict1(context: Ice.Context? = nil) async throws -> StringStringD {
        ...
        func read(istr: Ice.InputStream) throws -> sending StringStringD {
            let iceP_returnValue: StringStringD = try StringStringDHelper.read(from: istr)
            return iceP_returnValue
        }
    }
    ...
    func opMDict2(_ iceP_p1: StringStringD, context: Ice.Context? = nil) async throws -> (returnValue: StringStringD, p2: StringStringD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: StringStringD, p2: StringStringD) {
...
public struct MyStruct1: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending MyStruct1 {
        var v = MyStruct1()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending MyStruct1? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
open class MyClass1: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.tesT = try istr.read()
        iceP_self.myClass = try istr.read(MyClassPrx.self)
        iceP_self.myClass1 = try istr.read()
        try istr.endSlice()
    }
...
public extension MyDerivedClassPrx {
    func opDerived(context: Ice.Context? = nil) async throws {
    ...
    func opMyClass1(_ iceP_opMyClass1: MyClass1?, context: Ice.Context? = nil) async throws -> MyClass1? {
        ...
        func read(istr: Ice.InputStream) throws -> sending MyClass1? {
            nonisolated(unsafe) var iceP_returnValue: MyClass1?
    ...
    func opMyStruct1(_ iceP_opMyStruct1: MyStruct1, context: Ice.Context? = nil) async throws -> MyStruct1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending MyStruct1 {
...
public let ws0: Swift.String = "\\"

public let ws1: Swift.String = "A"

public let ws2: Swift.String = "Ice"

public let ws3: Swift.String = "A21"

public let ws4: Swift.String = "\\u0041 \\U00000041"

public let ws5: Swift.String = "\u{ff}"

public let ws6: Swift.String = "\u{3ff}"

public let ws7: Swift.String = "\u{5f0}"

public let ws8: Swift.String = "\u{10000}"

public let ws9: Swift.String = "\u{1f34c}"

public let ws10: Swift.String = "\u{da7}"

public let wsw0: Swift.String = "\\"

public let wsw1: Swift.String = "A"

public let wsw2: Swift.String = "Ice"

public let wsw3: Swift.String = "A21"

public let wsw4: Swift.String = "\\u0041 \\U00000041"

public let wsw5: Swift.String = "\u{ff}"

public let wsw6: Swift.String = "\u{3ff}"

public let wsw7: Swift.String = "\u{5f0}"

public let wsw8: Swift.String = "\u{10000}"

public let wsw9: Swift.String = "\u{1f34c}"

public let wsw10: Swift.String = "\u{da7}"

public let wss0: Swift.String = "'\"?\\\u{0007}\u{0008}\u{000c}\n\r\t\u{000b}\u{0006}"

public let wss1: Swift.String = "'\"?\\\u{0007}\u{0008}\u{000c}\n\r\t\u{000b}\u{0006}"
...
public let wsu1: Swift.String = "\u{128}\u{178}\u{ff}\u{100}\u{1f00}\u{10194}\u{1016a}\u{10198}\u{1f340}\u{1f341}\u{1f342}\u{1f343}"

public let wsu2: Swift.String = "\u{128}\u{178}\u{ff}\u{100}\u{1f00}\u{10194}\u{1016a}\u{10198}\u{1f340}\u{1f341}\u{1f342}\u{1f343}"
...
public protocol MyDerivedClass: MyClass {
    ...
    func opMyClass1(opMyClass1: sending MyClass1?, current: Ice.Current) async throws -> MyClass1?
...
extension MyDerivedClass {
    ...
    public func _iceD_opMyClass1(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_opMyClass1: MyClass1?
