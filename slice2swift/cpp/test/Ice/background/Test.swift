...
public extension BackgroundControllerPrx {
    ...
    ///
    /// - returns: `` - The result of the operation
    func initializeSocketOperationAsync(_ iceP_status: Swift.Int32, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "initializeSocketOperation",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_status)
                                            },
