...
public extension BackgroundControllerPrx {
    ...
    func initializeSocketOperation(_ iceP_status: Swift.Int32, context: Ice.Context? = nil) async throws {
...
extension BackgroundController {
    ...
    public static func dispatch(_ servant: BackgroundController, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "initializeSocketOperation":
            try await servant._iceD_initializeSocketOperation(request)
    ...
    public func _iceD_initializeSocketOperation(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_status: Swift.Int32 = try istr.read()
        try await self.initializeSocketOperation(status: iceP_status, current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
