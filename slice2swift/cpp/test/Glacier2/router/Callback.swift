...
public extension CallbackReceiverPrx {
    ...
    func waitCallback(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "waitCallback",
                                       mode: .normal,
                                       context: context)
    }

    func callbackWithPayload(_ iceP_payload: Ice.ByteSeq, context: Ice.Context? = nil) async throws {
...
public extension CallbackPrx {
    ...
    func initiateWaitCallback(_ iceP_proxy: CallbackReceiverPrx?, context: Ice.Context? = nil) async throws {
    ...
    func initiateCallbackWithPayload(_ iceP_proxy: CallbackReceiverPrx?, context: Ice.Context? = nil) async throws {
