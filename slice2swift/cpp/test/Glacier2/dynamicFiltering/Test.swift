...
private final class BackendPrxI: Ice.ObjectPrxI, BackendPrx, @unchecked Sendable {
...
public extension BackendPrx {
    func check(context: Ice.Context? = nil) async throws {
...
public enum StateCode: Swift.UInt8, Swift.Sendable {
    case Initial = 0
    case Running = 1
    case Finished = 2
    public init() {
...
public struct TestToken: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending TestToken {
        var v = TestToken()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending TestToken? {
...
private final class TestControllerPrxI: Ice.ObjectPrxI, TestControllerPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TestControllerPrx {
    func step(currentSession iceP_currentSession: Glacier2.SessionPrx?, currentState iceP_currentState: TestToken, context: Ice.Context? = nil) async throws -> TestToken {
        ...
        func read(istr: Ice.InputStream) throws -> sending TestToken {
...
private final class TestSessionPrxI: Ice.ObjectPrxI, TestSessionPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public protocol Backend: Ice.Dispatcher {
    func check(current: Ice.Current) async throws

    func shutdown(current: Ice.Current) async throws
}

public protocol TestController: Ice.Dispatcher {
...
extension Backend {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<BackendTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Backend, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension TestController {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestControllerTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestController, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "step":
...
extension TestSession {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestSessionTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestSession, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "destroy":
