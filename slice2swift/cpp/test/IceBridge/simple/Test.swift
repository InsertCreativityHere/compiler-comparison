...
public extension CallbackPrx {
    func ping(context: Ice.Context? = nil) async throws {
    ...
    func datagram(context: Ice.Context? = nil) async throws {
...
public extension MyClassPrx {
    func callCallback(context: Ice.Context? = nil) async throws {
    ...
    func incCounter(_ iceP_expected: Swift.Int32, context: Ice.Context? = nil) async throws {
    ...
    func waitCounter(_ iceP_value: Swift.Int32, context: Ice.Context? = nil) async throws {
    ...
    func closeConnection(_ iceP_force: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func callDatagramCallback(context: Ice.Context? = nil) async throws {
