...
public protocol Initial {
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: Ice.ObjectPrx?, p3: Ice.ObjectPrx?)>` - The result of the operation
    func opOneOptionalProxyReqAsync(p1: Ice.ObjectPrx?, current: Ice.Current) -> PromiseKit.Promise<(returnValue: Ice.ObjectPrx?, p3: Ice.ObjectPrx?)>
...
public extension Initial {
    ...
    func _iceD_opOneOptionalProxyReq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opOneOptionalProxyReqAsync(p1: iceP_p1, current: current)) { (ostr, retVals) in
            let (iceP_returnValue, iceP_p3) = retVals
            ostr.write(tag: 1, value: iceP_returnValue)
            ostr.write(tag: 3, value: iceP_p3)
        }
