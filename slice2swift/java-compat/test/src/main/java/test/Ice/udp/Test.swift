...
public extension TestIntfPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func pingBiDir(_ iceP_id: Ice.Identity, context: Ice.Context? = nil) throws {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func pingBiDirAsync(_ iceP_id: Ice.Identity, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public protocol TestIntf {
    ...
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func pingBiDir(id: Ice.Identity, current: Ice.Current) throws
...
public extension TestIntf {
    ...
    func _iceD_pingBiDir(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        try self.pingBiDir(id: iceP_id, current: current)
