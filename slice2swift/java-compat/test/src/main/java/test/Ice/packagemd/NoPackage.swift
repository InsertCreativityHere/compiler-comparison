...
/// :nodoc:
public class notify_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
        return notify.self
    }
}
...
public extension Ice.ClassResolver {
    @objc static func Test1_notify() -> Ice.UserExceptionTypeResolver {
        return notify_TypeResolver()
    }
}

open class notify: Ice.UserException {
    public var i: Swift.Int32 = 0
