...
public protocol MyClass {
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: SerialSmall, o: SerialSmall)>` - The result of the operation
    func opSerialSmallJavaAsync(i: SerialSmall, current: Ice.Current) -> PromiseKit.Promise<(returnValue: SerialSmall, o: SerialSmall)>
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: SerialLarge, o: SerialLarge)>` - The result of the operation
    func opSerialLargeJavaAsync(i: SerialLarge, current: Ice.Current) -> PromiseKit.Promise<(returnValue: SerialLarge, o: SerialLarge)>
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: SerialStruct, o: SerialStruct)>` - The result of the operation
    func opSerialStructJavaAsync(i: SerialStruct, current: Ice.Current) -> PromiseKit.Promise<(returnValue: SerialStruct, o: SerialStruct)>
}
...
public extension MyClass {
    ...
    func _iceD_opSerialSmallJava(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opSerialSmallJavaAsync(i: iceP_i, current: current)) { (ostr, retVals) in
    ...
    func _iceD_opSerialLargeJava(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opSerialLargeJavaAsync(i: iceP_i, current: current)) { (ostr, retVals) in
            let (iceP_returnValue, iceP_o) = retVals
            ostr.write(iceP_o)
            ostr.write(iceP_returnValue)
        }
    ...
    func _iceD_opSerialStructJava(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opSerialStructJavaAsync(i: iceP_i, current: current)) { (ostr, retVals) in
            let (iceP_returnValue, iceP_o) = retVals
            ostr.write(iceP_o)
            ostr.write(iceP_returnValue)
        }
