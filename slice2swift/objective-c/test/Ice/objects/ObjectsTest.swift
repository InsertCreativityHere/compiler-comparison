...
public typealias ObjectSeq = [Ice.Value?]
...
public struct ObjectSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> ObjectSeq {
    ...
    ///
    /// - returns: `ObjectSeq` - The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> ObjectSeq? {
    ...
    public static func write(to ostr: Ice.OutputStream, value v: ObjectSeq) {
    ...
    ///
    /// - parameter value: `ObjectSeq` The sequence value to write to the stream.
    public static func write(to ostr: Ice.OutputStream,  tag: Swift.Int32, value v: ObjectSeq?) {
...
public typealias ObjectPrxSeq = [Ice.ObjectPrx?]

/// Helper class to read and write `ObjectPrxSeq` sequence values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct ObjectPrxSeqHelper {
    /// Read a `ObjectPrxSeq` sequence from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `ObjectPrxSeq` - The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> ObjectPrxSeq {
    ...
    /// Read an optional `ObjectPrxSeq?` sequence from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `ObjectPrxSeq` - The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> ObjectPrxSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `ObjectPrxSeq` sequence to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `ObjectPrxSeq` - The sequence value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: ObjectPrxSeq) {
        ostr.write(size: v.count)
        for item in v {
            ostr.write(item)
        }
    ...
    /// Wite an optional `ObjectPrxSeq?` sequence to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `ObjectPrxSeq` The sequence value to write to the stream.
    public static func write(to ostr: Ice.OutputStream,  tag: Swift.Int32, value v: ObjectPrxSeq?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public typealias BasePrxSeq = [Ice.ObjectPrx?]

/// Helper class to read and write `BasePrxSeq` sequence values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct BasePrxSeqHelper {
    /// Read a `BasePrxSeq` sequence from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `BasePrxSeq` - The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> BasePrxSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = BasePrxSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    /// Read an optional `BasePrxSeq?` sequence from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `BasePrxSeq` - The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> BasePrxSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `BasePrxSeq` sequence to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `BasePrxSeq` - The sequence value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: BasePrxSeq) {
        ostr.write(size: v.count)
        for item in v {
            ostr.write(item)
        }
    ...
    /// Wite an optional `BasePrxSeq?` sequence to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `BasePrxSeq` The sequence value to write to the stream.
    public static func write(to ostr: Ice.OutputStream,  tag: Swift.Int32, value v: BasePrxSeq?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public typealias ObjectDict = [Swift.String: Ice.Value?]

/// Helper class to read and write `ObjectDict` dictionary values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct ObjectDictHelper {
    /// Read a `ObjectDict` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `ObjectDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> ObjectDict {
    ...
    /// Read an optional `ObjectDict?` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `ObjectDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> ObjectDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `ObjectDict` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `ObjectDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: ObjectDict) {
        ostr.write(size: v.count)
        for (key, value) in v {
            ostr.write(key)
            ostr.write(value)
    ...
    /// Wite an optional `ObjectDict?` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `ObjectDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, tag: Swift.Int32, value v: ObjectDict?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public typealias ObjectPrxDict = [Swift.String: Ice.ObjectPrx?]

/// Helper class to read and write `ObjectPrxDict` dictionary values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct ObjectPrxDictHelper {
    /// Read a `ObjectPrxDict` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `ObjectPrxDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> ObjectPrxDict {
        let sz = try Swift.Int(istr.readSize())
        var v = ObjectPrxDict()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    /// Read an optional `ObjectPrxDict?` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `ObjectPrxDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> ObjectPrxDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `ObjectPrxDict` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `ObjectPrxDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: ObjectPrxDict) {
        ostr.write(size: v.count)
        for (key, value) in v {
            ostr.write(key)
            ostr.write(value)
    ...
    /// Wite an optional `ObjectPrxDict?` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `ObjectPrxDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, tag: Swift.Int32, value v: ObjectPrxDict?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public typealias BaseDict = [Swift.String: Base?]

/// Helper class to read and write `BaseDict` dictionary values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct BaseDictHelper {
    /// Read a `BaseDict` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `BaseDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> BaseDict {
        let sz = try Swift.Int(istr.readSize())
        var v = BaseDict()
    ...
    /// Read an optional `BaseDict?` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `BaseDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> BaseDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `BaseDict` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `BaseDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: BaseDict) {
        ostr.write(size: v.count)
        for (key, value) in v {
            ostr.write(key)
            ostr.write(value)
    ...
    /// Wite an optional `BaseDict?` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `BaseDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, tag: Swift.Int32, value v: BaseDict?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
public typealias BasePrxDict = [Swift.String: Ice.ObjectPrx?]

/// Helper class to read and write `BasePrxDict` dictionary values from
/// `Ice.InputStream` and `Ice.OutputStream`.
public struct BasePrxDictHelper {
    /// Read a `BasePrxDict` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - returns: `BasePrxDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> BasePrxDict {
        let sz = try Swift.Int(istr.readSize())
        var v = BasePrxDict()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    /// Read an optional `BasePrxDict?` dictionary from the stream.
    ///
    /// - parameter istr: `Ice.InputStream` - The stream to read from.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `BasePrxDict` - The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> BasePrxDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Wite a `BasePrxDict` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter value: `BasePrxDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, value v: BasePrxDict) {
        ostr.write(size: v.count)
        for (key, value) in v {
            ostr.write(key)
            ostr.write(value)
    ...
    /// Wite an optional `BasePrxDict?` dictionary to the stream.
    ///
    /// - parameter ostr: `Ice.OuputStream` - The stream to write to.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `BasePrxDict` - The dictionary value to write to the stream.
    public static func write(to ostr: Ice.OutputStream, tag: Swift.Int32, value v: BasePrxDict?) {
        guard let val = v else {
            return
        }
        if ostr.writeOptional(tag: tag, format: .FSize) {
...
/// Traits for Slice class `Initial`.
...
public extension InitialPrx {
    ...
    ///
    /// - parameter _: `ObjectSeq`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `ObjectSeq`
    func getObjectSeq(_ iceP_s: ObjectSeq, context: Ice.Context? = nil) throws -> ObjectSeq {
        return try _impl._invoke(operation: "getObjectSeq",
                                 mode: .Normal,
                                 write: { ostr in
                                     ObjectSeqHelper.write(to: ostr, value: iceP_s)
                                     ostr.writePendingValues()
                                 },
                                 read: { istr in
                                     let iceP_returnValue: ObjectSeq = try ObjectSeqHelper.read(from: istr)
                                     try istr.readPendingValues()
                                     return iceP_returnValue
                                 },
                                 context: context)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<ObjectSeq>` - The result of the operation
    func getObjectSeqAsync(_ iceP_s: ObjectSeq, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectSeq> {
        return _impl._invokeAsync(operation: "getObjectSeq",
                                  mode: .Normal,
                                  write: { ostr in
                                      ObjectSeqHelper.write(to: ostr, value: iceP_s)
                                      ostr.writePendingValues()
    ...
    ///
    /// - parameter _: `ObjectPrxSeq`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `ObjectPrxSeq`
    func getObjectPrxSeq(_ iceP_s: ObjectPrxSeq, context: Ice.Context? = nil) throws -> ObjectPrxSeq {
        return try _impl._invoke(operation: "getObjectPrxSeq",
                                 mode: .Normal,
                                 write: { ostr in
                                     ObjectPrxSeqHelper.write(to: ostr, value: iceP_s)
                                 },
                                 read: { istr in
                                     let iceP_returnValue: ObjectPrxSeq = try ObjectPrxSeqHelper.read(from: istr)
                                     return iceP_returnValue
                                 },
                                 context: context)
    }
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<ObjectPrxSeq>` - The result of the operation
    func getObjectPrxSeqAsync(_ iceP_s: ObjectPrxSeq, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectPrxSeq> {
        return _impl._invokeAsync(operation: "getObjectPrxSeq",
                                  mode: .Normal,
                                  write: { ostr in
                                      ObjectPrxSeqHelper.write(to: ostr, value: iceP_s)
                                  },
    ...
    ///
    /// - returns: `BaseSeq`
    func getBaseSeq(_ iceP_s: BaseSeq, context: Ice.Context? = nil) throws -> BaseSeq {
        return try _impl._invoke(operation: "getBaseSeq",
                                 mode: .Normal,
                                 write: { ostr in
                                     BaseSeqHelper.write(to: ostr, value: iceP_s)
                                     ostr.writePendingValues()
                                 },
                                 read: { istr in
                                     let iceP_returnValue: BaseSeq = try BaseSeqHelper.read(from: istr)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<BaseSeq>` - The result of the operation
    func getBaseSeqAsync(_ iceP_s: BaseSeq, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<BaseSeq> {
        return _impl._invokeAsync(operation: "getBaseSeq",
                                  mode: .Normal,
                                  write: { ostr in
                                      BaseSeqHelper.write(to: ostr, value: iceP_s)
                                      ostr.writePendingValues()
    ...
    ///
    /// - parameter _: `BasePrxSeq`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `BasePrxSeq`
    func getBasePrxSeq(_ iceP_s: BasePrxSeq, context: Ice.Context? = nil) throws -> BasePrxSeq {
        return try _impl._invoke(operation: "getBasePrxSeq",
                                 mode: .Normal,
                                 write: { ostr in
                                     BasePrxSeqHelper.write(to: ostr, value: iceP_s)
                                 },
                                 read: { istr in
                                     let iceP_returnValue: BasePrxSeq = try BasePrxSeqHelper.read(from: istr)
                                     return iceP_returnValue
                                 },
                                 context: context)
    }
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<BasePrxSeq>` - The result of the operation
    func getBasePrxSeqAsync(_ iceP_s: BasePrxSeq, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<BasePrxSeq> {
        return _impl._invokeAsync(operation: "getBasePrxSeq",
                                  mode: .Normal,
                                  write: { ostr in
                                      BasePrxSeqHelper.write(to: ostr, value: iceP_s)
                                  },
    ...
    ///
    /// - parameter _: `ObjectDict`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `ObjectDict`
    func getObjectDict(_ iceP_d: ObjectDict, context: Ice.Context? = nil) throws -> ObjectDict {
        return try _impl._invoke(operation: "getObjectDict",
                                 mode: .Normal,
                                 write: { ostr in
                                     ObjectDictHelper.write(to: ostr, value: iceP_d)
                                     ostr.writePendingValues()
                                 },
                                 read: { istr in
                                     let iceP_returnValue: ObjectDict = try ObjectDictHelper.read(from: istr)
                                     try istr.readPendingValues()
                                     return iceP_returnValue
                                 },
                                 context: context)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<ObjectDict>` - The result of the operation
    func getObjectDictAsync(_ iceP_d: ObjectDict, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectDict> {
        return _impl._invokeAsync(operation: "getObjectDict",
                                  mode: .Normal,
                                  write: { ostr in
                                      ObjectDictHelper.write(to: ostr, value: iceP_d)
                                      ostr.writePendingValues()
    ...
    ///
    /// - parameter _: `ObjectPrxDict`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `ObjectPrxDict`
    func getObjectPrxDict(_ iceP_d: ObjectPrxDict, context: Ice.Context? = nil) throws -> ObjectPrxDict {
        return try _impl._invoke(operation: "getObjectPrxDict",
                                 mode: .Normal,
                                 write: { ostr in
                                     ObjectPrxDictHelper.write(to: ostr, value: iceP_d)
                                 },
                                 read: { istr in
                                     let iceP_returnValue: ObjectPrxDict = try ObjectPrxDictHelper.read(from: istr)
                                     return iceP_returnValue
                                 },
                                 context: context)
    }
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<ObjectPrxDict>` - The result of the operation
    func getObjectPrxDictAsync(_ iceP_d: ObjectPrxDict, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectPrxDict> {
        return _impl._invokeAsync(operation: "getObjectPrxDict",
                                  mode: .Normal,
                                  write: { ostr in
                                      ObjectPrxDictHelper.write(to: ostr, value: iceP_d)
                                  },
    ...
    ///
    /// - parameter _: `BaseDict`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `BaseDict`
    func getBaseDict(_ iceP_d: BaseDict, context: Ice.Context? = nil) throws -> BaseDict {
        return try _impl._invoke(operation: "getBaseDict",
                                 mode: .Normal,
                                 write: { ostr in
                                     BaseDictHelper.write(to: ostr, value: iceP_d)
                                     ostr.writePendingValues()
                                 },
                                 read: { istr in
                                     let iceP_returnValue: BaseDict = try BaseDictHelper.read(from: istr)
                                     try istr.readPendingValues()
                                     return iceP_returnValue
                                 },
                                 context: context)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<BaseDict>` - The result of the operation
    func getBaseDictAsync(_ iceP_d: BaseDict, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<BaseDict> {
        return _impl._invokeAsync(operation: "getBaseDict",
                                  mode: .Normal,
                                  write: { ostr in
                                      BaseDictHelper.write(to: ostr, value: iceP_d)
                                      ostr.writePendingValues()
    ...
    ///
    /// - parameter _: `BasePrxDict`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `BasePrxDict`
    func getBasePrxDict(_ iceP_d: BasePrxDict, context: Ice.Context? = nil) throws -> BasePrxDict {
        return try _impl._invoke(operation: "getBasePrxDict",
                                 mode: .Normal,
                                 write: { ostr in
                                     BasePrxDictHelper.write(to: ostr, value: iceP_d)
                                 },
                                 read: { istr in
                                     let iceP_returnValue: BasePrxDict = try BasePrxDictHelper.read(from: istr)
                                     return iceP_returnValue
                                 },
                                 context: context)
    }
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<BasePrxDict>` - The result of the operation
    func getBasePrxDictAsync(_ iceP_d: BasePrxDict, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<BasePrxDict> {
        return _impl._invokeAsync(operation: "getBasePrxDict",
                                  mode: .Normal,
                                  write: { ostr in
                                      BasePrxDictHelper.write(to: ostr, value: iceP_d)
                                  },
...
public extension TestIntfPrx {
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<Base?>` - The result of the operation
    func opDerivedAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Base?> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func throwDerivedAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "throwDerived",
                                  mode: .Normal,
                                  userException:{ ex in
                                      do  {
                                          throw ex
...
/// :nodoc:
public class Initial_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
        return Initial.self
    }
}
...
public extension Ice.ClassResolver {
    @objc static func Test_Initial() -> Ice.ValueTypeResolver {
        return Initial_TypeResolver()
    }
}

open class Initial: Ice.Value {
    public required init() {}
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: InitialTraits.staticId, compactId: -1, last: true)
        ostr.endSlice()
    }
}
...
/// Dispatcher for `InitialOperations` servants.
public struct InitialDisp: Ice.Disp {
    public let servant: InitialOperations
    private static let defaultObject = Ice.ObjectI<InitialTraits>()

    public init(_ servant: InitialOperations) {
        self.servant = servant
    }
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "getBaseDict":
            return try servant._iceD_getBaseDict(incoming: request, current: current)
        case "getBasePrxDict":
            return try servant._iceD_getBasePrxDict(incoming: request, current: current)
        case "getBasePrxSeq":
            return try servant._iceD_getBasePrxSeq(incoming: request, current: current)
        case "getBaseSeq":
            return try servant._iceD_getBaseSeq(incoming: request, current: current)
        case "getC":
        ...
        case "getObjectDict":
            return try servant._iceD_getObjectDict(incoming: request, current: current)
        case "getObjectPrxDict":
            return try servant._iceD_getObjectPrxDict(incoming: request, current: current)
        case "getObjectPrxSeq":
            return try servant._iceD_getObjectPrxSeq(incoming: request, current: current)
        case "getObjectSeq":
            return try servant._iceD_getObjectSeq(incoming: request, current: current)
        case "hasF3":
...
public protocol InitialOperations {
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ...
    ///
    /// - parameter s: `ObjectSeq`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ObjectSeq`
    func getObjectSeq(s: ObjectSeq, current: Ice.Current) throws -> ObjectSeq

    ///
    /// - parameter s: `ObjectPrxSeq`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ObjectPrxSeq`
    func getObjectPrxSeq(s: ObjectPrxSeq, current: Ice.Current) throws -> ObjectPrxSeq
    ...
    ///
    /// - returns: `BaseSeq`
    func getBaseSeq(s: BaseSeq, current: Ice.Current) throws -> BaseSeq

    ///
    /// - parameter s: `BasePrxSeq`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `BasePrxSeq`
    func getBasePrxSeq(s: BasePrxSeq, current: Ice.Current) throws -> BasePrxSeq

    ///
    /// - parameter d: `ObjectDict`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ObjectDict`
    func getObjectDict(d: ObjectDict, current: Ice.Current) throws -> ObjectDict

    ///
    /// - parameter d: `ObjectPrxDict`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `ObjectPrxDict`
    func getObjectPrxDict(d: ObjectPrxDict, current: Ice.Current) throws -> ObjectPrxDict

    ///
    /// - parameter d: `BaseDict`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `BaseDict`
    func getBaseDict(d: BaseDict, current: Ice.Current) throws -> BaseDict

    ///
    /// - parameter d: `BasePrxDict`
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `BasePrxDict`
    func getBasePrxDict(d: BasePrxDict, current: Ice.Current) throws -> BasePrxDict
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "throwDerived":
            return try servant._iceD_throwDerived(incoming: request, current: current)
        default:
            throw Ice.OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
///
///  - opN: 
public extension InitialOperations {
    ...
    func _iceD_getObjectSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s: ObjectSeq = try inS.read { istr in
            let iceP_s: ObjectSeq = try ObjectSeqHelper.read(from: istr)
            try istr.readPendingValues()
            return iceP_s
        }

        let iceP_returnValue = try self.getObjectSeq(s: iceP_s, current: current)

        return inS.setResult{ ostr in
            ObjectSeqHelper.write(to: ostr, value: iceP_returnValue)
            ostr.writePendingValues()
        }
    }

    func _iceD_getObjectPrxSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s: ObjectPrxSeq = try inS.read { istr in
            let iceP_s: ObjectPrxSeq = try ObjectPrxSeqHelper.read(from: istr)
            return iceP_s
        }

        let iceP_returnValue = try self.getObjectPrxSeq(s: iceP_s, current: current)

        return inS.setResult{ ostr in
            ObjectPrxSeqHelper.write(to: ostr, value: iceP_returnValue)
        }
    }

    func _iceD_getBaseSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s: BaseSeq = try inS.read { istr in
            let iceP_s: BaseSeq = try BaseSeqHelper.read(from: istr)
            try istr.readPendingValues()
            return iceP_s
        }

        let iceP_returnValue = try self.getBaseSeq(s: iceP_s, current: current)
    ...
    func _iceD_getBasePrxSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s: BasePrxSeq = try inS.read { istr in
            let iceP_s: BasePrxSeq = try BasePrxSeqHelper.read(from: istr)
            return iceP_s
        }

        let iceP_returnValue = try self.getBasePrxSeq(s: iceP_s, current: current)

        return inS.setResult{ ostr in
            BasePrxSeqHelper.write(to: ostr, value: iceP_returnValue)
        }
    }

    func _iceD_getObjectDict(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_d: ObjectDict = try inS.read { istr in
            let iceP_d: ObjectDict = try ObjectDictHelper.read(from: istr)
            try istr.readPendingValues()
            return iceP_d
        }

        let iceP_returnValue = try self.getObjectDict(d: iceP_d, current: current)

        return inS.setResult{ ostr in
            ObjectDictHelper.write(to: ostr, value: iceP_returnValue)
            ostr.writePendingValues()
        }
    }

    func _iceD_getObjectPrxDict(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_d: ObjectPrxDict = try inS.read { istr in
            let iceP_d: ObjectPrxDict = try ObjectPrxDictHelper.read(from: istr)
            return iceP_d
        }

        let iceP_returnValue = try self.getObjectPrxDict(d: iceP_d, current: current)

        return inS.setResult{ ostr in
            ObjectPrxDictHelper.write(to: ostr, value: iceP_returnValue)
        }
    }

    func _iceD_getBaseDict(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_d: BaseDict = try inS.read { istr in
            let iceP_d: BaseDict = try BaseDictHelper.read(from: istr)
            try istr.readPendingValues()
            return iceP_d
        }

        let iceP_returnValue = try self.getBaseDict(d: iceP_d, current: current)

        return inS.setResult{ ostr in
            BaseDictHelper.write(to: ostr, value: iceP_returnValue)
            ostr.writePendingValues()
        }
    }

    func _iceD_getBasePrxDict(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_d: BasePrxDict = try inS.read { istr in
            let iceP_d: BasePrxDict = try BasePrxDictHelper.read(from: istr)
            return iceP_d
        }

        let iceP_returnValue = try self.getBasePrxDict(d: iceP_d, current: current)

        return inS.setResult{ ostr in
            BasePrxDictHelper.write(to: ostr, value: iceP_returnValue)
        }
    }
...
public extension TestIntf {
    func _iceD_opDerived(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let iceP_returnValue = try self.opDerived(current: current)
    ...
    func _iceD_throwDerived(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.throwDerived(current: current)
