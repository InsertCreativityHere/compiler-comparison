...
/// An `Ice.InputStream` extension to read `SS` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `SS` structured value from the stream.
    ///
    /// - returns: `SS` - The structured value read from the stream.
    func read() throws -> SS {
        let v = SS()
    ...
    /// Read an optional `SS?` structured value from the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `SS?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> SS? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as SS
    }
}

/// An `Ice.OutputStream` extension to write `SS` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `SS` structured value to the stream.
    ///
    /// - parameter _: `SS` - The value to write to the stream.
    func write(_ v: SS) {
        self.write(v.c1)
        self.write(v.c2)
    }

    /// Write an optional `SS?` structured value to the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `SS?` - The value to write to the stream.
    func write(tag: Swift.Int32, value: SS?) {
        if let v = value {
...
public extension TestIntfPrx {
    ...
    ///
    /// - returns: `SS`
    func sequenceTest(p1 iceP_p1: SS1?, p2 iceP_p2: SS2?, context: Ice.Context? = nil) throws -> SS {
        return try _impl._invoke(operation: "sequenceTest",
                                 ...
                                 read: { istr in
                                     let iceP_returnValue: SS = try istr.read()
                                     try istr.readPendingValues()
                                     return iceP_returnValue
                                 },
                                 context: context)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<SS>` - The result of the operation
    func sequenceTestAsync(p1 iceP_p1: SS1?, p2 iceP_p2: SS2?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<SS> {
...
public protocol TestIntf {
    ...
    ///
    /// - returns: `SS`
    func sequenceTest(p1: SS1?, p2: SS2?, current: Ice.Current) throws -> SS
    ...
    ///
    /// - returns: `Preserved?`
    func PBSUnknownAsPreservedWithGraph(current: Ice.Current) throws -> Preserved?
    ...
    ///
    /// - returns: `Preserved?`
    func PBSUnknown2AsPreservedWithGraph(current: Ice.Current) throws -> Preserved?
...
public extension TestIntf {
    ...
    func _iceD_PBSUnknownAsPreservedWithGraph(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let iceP_returnValue = try self.PBSUnknownAsPreservedWithGraph(current: current)
    ...
    func _iceD_PBSUnknown2AsPreservedWithGraph(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let iceP_returnValue = try self.PBSUnknown2AsPreservedWithGraph(current: current)
