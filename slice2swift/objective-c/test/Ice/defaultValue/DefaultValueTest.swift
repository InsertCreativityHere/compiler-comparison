...
public struct Struct1 {
    ...
    public var f: Swift.Float = 5
    public var d: Swift.Double = 6
    public var str: Swift.String = "foo bar"
    public var c: Color = Color.red
    public var noDefault: Swift.String = ""

    public init() {}

    public init(boolFalse: Swift.Bool, boolTrue: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, c: Color, noDefault: Swift.String) {
...
open class BaseEx: Ice.UserException {
    ...
    public init(boolFalse: Swift.Bool, boolTrue: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, noDefault: Swift.String) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
...
open class DerivedEx: BaseEx {
    public var c: Color = Color.green

    public required init() {
        super.init()
    }

    public init(boolFalse: Swift.Bool, boolTrue: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, noDefault: Swift.String, c: Color) {
        self.c = c
        super.init(boolFalse: boolFalse, boolTrue: boolTrue, b: b, s: s, i: i, l: l, f: f, d: d, str: str, noDefault: noDefault)
    }
