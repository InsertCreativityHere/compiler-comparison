...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "opSimpleSeq":
            return try servant._iceD_opSimpleSeq(incoming: request, current: current)
        case "shutdown":
...
public extension TestIntf {
    ...
    func _iceD_opByteSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_b1: ByteEnumSeq = try inS.read { istr in
            let iceP_b1: ByteEnumSeq = try ByteEnumSeqHelper.read(from: istr)
            return iceP_b1
        }

        let (iceP_returnValue, iceP_b2) = try self.opByteSeq(b1: iceP_b1, current: current)
    ...
    func _iceD_opShortSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s1: ShortEnumSeq = try inS.read { istr in
            let iceP_s1: ShortEnumSeq = try ShortEnumSeqHelper.read(from: istr)
            return iceP_s1
        }

        let (iceP_returnValue, iceP_s2) = try self.opShortSeq(s1: iceP_s1, current: current)
    ...
    func _iceD_opIntSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_i1: IntEnumSeq = try inS.read { istr in
            let iceP_i1: IntEnumSeq = try IntEnumSeqHelper.read(from: istr)
            return iceP_i1
        }

        let (iceP_returnValue, iceP_i2) = try self.opIntSeq(i1: iceP_i1, current: current)
    ...
    func _iceD_opSimpleSeq(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let iceP_s1: SimpleEnumSeq = try inS.read { istr in
            let iceP_s1: SimpleEnumSeq = try SimpleEnumSeqHelper.read(from: istr)
            return iceP_s1
        }

        let (iceP_returnValue, iceP_s2) = try self.opSimpleSeq(s1: iceP_s1, current: current)
