...
public struct St: Swift.Hashable {
    ...
    public init(v: Swift.String, istr: Swift.Int16, ostr: Swift.Int32, rhs: Swift.Int32) {
        self.v = v
        self.istr = istr
        self.ostr = ostr
        self.rhs = rhs
...
public extension IntfPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func upCastAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "upCast",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func ok(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "ok",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func okAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "ok",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func target(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "target",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func targetAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "target",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
    ...
    ///
    /// - parameter target: `Swift.String`
    ///
    /// - parameter proxy: `Swift.String?`
    ///
    /// - parameter ok: `Swift.String?`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func op(context iceP_context: Swift.String, current iceP_current: Swift.String, response iceP_response: Swift.String, ex iceP_ex: Swift.String, sent iceP_sent: Swift.String, cookie iceP_cookie: Swift.String, sync iceP_sync: Swift.String, result iceP_result: Swift.String, istr iceP_istr: Swift.String, ostr iceP_ostr: Swift.String, target iceP_target: Swift.String, proxy iceP_proxy: Swift.String? = nil, ok iceP_ok: Swift.String? = nil, context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "op",
                          ...
                          write: { ostr in
                              ...
                              ostr.write(tag: 2, value: iceP_ok)
                          },
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opAsync(context iceP_context: Swift.String, current iceP_current: Swift.String, response iceP_response: Swift.String, ex iceP_ex: Swift.String, sent iceP_sent: Swift.String, cookie iceP_cookie: Swift.String, sync iceP_sync: Swift.String, result iceP_result: Swift.String, istr iceP_istr: Swift.String, ostr iceP_ostr: Swift.String, target iceP_target: Swift.String, proxy iceP_proxy: Swift.String? = nil, ok iceP_ok: Swift.String? = nil, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `(context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?)`:
    ///
    ...
    ///
    ///   - ok: `Swift.String?`
    func opOut(context: Ice.Context? = nil) throws -> (context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?) {
        return try _impl._invoke(operation: "opOut",
                                 ...
                                 read: { istr in
                                     ...
                                     let iceP_target: Swift.String = try istr.read()
                                     let iceP_proxy: Swift.String? = try istr.read(tag: 1)
                                     let iceP_ok: Swift.String? = try istr.read(tag: 2)
                                     return (iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok)
                                 },
                                 context: context)
    }
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<(context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?)>` - The result of the operation
    func opOutAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?)> {
...
open class Cls: Ice.Value {
    ...
    public var stream: Swift.Int32? = nil
    public var target: Swift.String = ""

    public required init() {}

    public init(s: IntfPrx?, context: Swift.String, current: Swift.Int32, response: Swift.Int16, upCast: Swift.String, typeId: Swift.Int32, del: Swift.Int16, cookie: Swift.Int16?, ex: Swift.String, result: Swift.Int32, istr: Swift.String, ostr: Swift.String, inS: Swift.String, `in`: Swift.String, proxy: Swift.String, stream: Swift.Int32?, target: Swift.String) {
        self.s = s
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        self.target = try istr.read()
        self.cookie = try istr.read(tag: 1)
        self.stream = try istr.read(tag: 2)
        try istr.endSlice()
    }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ...
        ostr.write(self.target)
        ostr.write(tag: 1, value: self.cookie)
        ostr.write(tag: 2, value: self.stream)
        ostr.endSlice()
    }
}
...
public struct IntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "ok":
            return try servant._iceD_ok(incoming: request, current: current)
        case "op":
        ...
        case "target":
            return try servant._iceD_target(incoming: request, current: current)
        case "typeId":
...
public protocol Intf {
    ...
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func ok(current: Ice.Current) throws

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func target(current: Ice.Current) throws
    ...
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func op(context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?, current: Ice.Current) throws
    ...
    ///
    ///   - ok: `Swift.String?`
    func opOut(current: Ice.Current) throws -> (context: Swift.String, current: Swift.String, response: Swift.String, ex: Swift.String, sent: Swift.String, cookie: Swift.String, sync: Swift.String, result: Swift.String, istr: Swift.String, ostr: Swift.String, target: Swift.String, proxy: Swift.String?, ok: Swift.String?)
}
...
public extension Intf {
    ...
    func _iceD_ok(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.ok(current: current)

        return inS.setResult()
    }

    func _iceD_target(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.target(current: current)

        return inS.setResult()
    }

    func _iceD_op(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let (iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok): (Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String, Swift.String?, Swift.String?) = try inS.read { istr in
            let iceP_context: Swift.String = try istr.read()
            let iceP_current: Swift.String = try istr.read()
            let iceP_response: Swift.String = try istr.read()
            let iceP_ex: Swift.String = try istr.read()
        ...
        try self.op(context: iceP_context, current: iceP_current, response: iceP_response, ex: iceP_ex, sent: iceP_sent, cookie: iceP_cookie, sync: iceP_sync, result: iceP_result, istr: iceP_istr, ostr: iceP_ostr, target: iceP_target, proxy: iceP_proxy, ok: iceP_ok, current: current)
    ...
    func _iceD_opOut(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_context, iceP_current, iceP_response, iceP_ex, iceP_sent, iceP_cookie, iceP_sync, iceP_result, iceP_istr, iceP_ostr, iceP_target, iceP_proxy, iceP_ok) = try self.opOut(current: current)
