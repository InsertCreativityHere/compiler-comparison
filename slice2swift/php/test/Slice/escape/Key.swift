...
public enum array: Swift.UInt8, Swift.Sendable {
    case clone = 1
    public init() {
        self = .clone
    }
...
public struct endforHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending endfor {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending endfor? {
...
public struct endforeachHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending endforeach {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending endforeach? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct xor: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending xor? {
...
private final class functionPrxI: Ice.ObjectPrxI, functionPrx, @unchecked Sendable {
...
public extension functionPrx {
    func continue(declare iceP_declare: Swift.Int32, default iceP_default: Swift.Int32, context: Ice.Context? = nil) async throws {
...
private final class diePrxI: Ice.ObjectPrxI, diePrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
open class echo: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.empty = try istr.read(diePrx.self)
        try istr.endSlice()
    }
...
private final class enddeclarePrxI: Ice.ObjectPrxI, enddeclarePrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension enddeclarePrx {
    func foreach(global iceP_global: echo?, include iceP_include: functionPrx? = nil, context: Ice.Context? = nil) async throws -> (returnValue: array, new: endfor, static: endforeach?) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: array, new: endfor, static: endforeach?) {
...
public protocol function: Ice.Dispatcher {
    func continue(declare: Swift.Int32, default: Swift.Int32, current: Ice.Current) async throws
}

public protocol die: Ice.Dispatcher {
    func do(current: Ice.Current) async throws
}

public protocol enddeclare: die, function {
    func foreach(global: sending echo?, include: functionPrx?, current: Ice.Current) async throws -> (returnValue: array, new: endfor, static: endforeach?)
}

extension function {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<functionTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: function, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension die {
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: die, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "do":
...
extension enddeclare {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<enddeclareTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: enddeclare, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "do":
            try await servant._iceD_do(request)
        case "continue":
    ...
    public func _iceD_foreach(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_global: echo?
