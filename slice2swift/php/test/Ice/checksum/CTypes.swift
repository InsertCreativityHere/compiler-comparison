...
/// Traits for Slice interface `BaseInterface11`.
public struct BaseInterface11Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::BaseInterface11"]
    public static let staticId = "::Test::BaseInterface11"
}
...
///
///  - baseOp2Async: 
public protocol BaseInterface11Prx: Ice.ObjectPrx {}

private final class BaseInterface11PrxI: Ice.ObjectPrxI, BaseInterface11Prx {
    public override class func ice_staticId() -> Swift.String {
        return BaseInterface11Traits.staticId
    }
}
...
/// - parameter prx: `Ice.ObjectPrx` - The proxy to be cast.
///
/// - parameter type: `BaseInterface11Prx.Protocol` - The proxy type to cast to.
///
/// - parameter facet: `String` - The optional name of the desired facet.
///
/// - parameter context: `Ice.Context` The optional context dictionary for the remote invocation.
///
/// - returns: `BaseInterface11Prx` - A proxy with the requested type or nil if the objet does not
///   support this type.
///
/// - throws: `Ice.LocalException` if a communication error occurs.
public func checkedCast(prx: Ice.ObjectPrx, type: BaseInterface11Prx.Protocol, facet: Swift.String? = nil, context: Ice.Context? = nil) throws -> BaseInterface11Prx? {
    return try BaseInterface11PrxI.checkedCast(prx: prx, facet: facet, context: context) as BaseInterface11PrxI?
}
...
/// - parameter facet: `String` - The optional name of the desired facet
///
/// - returns: `BaseInterface11Prx` - A proxy with the requested type
public func uncheckedCast(prx: Ice.ObjectPrx, type: BaseInterface11Prx.Protocol, facet: Swift.String? = nil) -> BaseInterface11Prx {
    return BaseInterface11PrxI.uncheckedCast(prx: prx, facet: facet) as BaseInterface11PrxI
}

/// Returns the Slice type id of the interface or class associated with this proxy type.
///
/// parameter type: `BaseInterface11Prx.Protocol` -  The proxy type to retrieve the type id.
///
/// returns: `String` - The type id of the interface or class associated with this proxy type.
public func ice_staticId(_ type: BaseInterface11Prx.Protocol) -> Swift.String {
    return BaseInterface11Traits.staticId
}
...
public extension Ice.InputStream {
    /// Extracts a proxy from the stream. The stream must have been initialized with a communicator.
    ///
    /// - parameter type: `BaseInterface11Prx.Protocol` - The type of the proxy to be extracted.
    ///
    /// - returns: `BaseInterface11Prx?` - The extracted proxy
    func read(_ type: BaseInterface11Prx.Protocol) throws -> BaseInterface11Prx? {
        return try read() as BaseInterface11PrxI?
    }
    /// Extracts a proxy from the stream. The stream must have been initialized with a communicator.
    ///
    /// - parameter tag: `Int32` - The numeric tag associated with the value.
    ...
    ///
    /// - returns: `BaseInterface11Prx` - The extracted proxy.
    func read(tag: Swift.Int32, type: BaseInterface11Prx.Protocol) throws -> BaseInterface11Prx? {
        return try read(tag: tag) as BaseInterface11PrxI?
    }
}
...
///
///  - baseOp2Async: 
public extension BaseInterface11Prx {
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func baseOp(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "baseOp",
...
/// Dispatcher for `BaseInterface11` servants.
public struct BaseInterface11Disp: Ice.Disp {
    public let servant: BaseInterface11
    private static let defaultObject = Ice.ObjectI<BaseInterface11Traits>()

    public init(_ servant: BaseInterface11) {
        self.servant = servant
    }
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "baseOp2":
            return try servant._iceD_baseOp2(incoming: request, current: current)
        case "ice_id":
            return try (servant as? Object ?? BaseInterface11Disp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            return try (servant as? Object ?? BaseInterface11Disp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            return try (servant as? Object ?? BaseInterface11Disp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            return try (servant as? Object ?? BaseInterface11Disp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
            throw Ice.OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
public protocol BaseInterface11 {
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func baseOp(current: Ice.Current) throws
...
/// BaseInterface11 overview.
///
/// BaseInterface11 Methods:
///
///  - baseOp: 
///
///  - baseOp2: 
public extension BaseInterface11 {
    func _iceD_baseOp(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()
