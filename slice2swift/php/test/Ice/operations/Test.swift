...
public extension MyClassPrx {
    ...
    func opContext(context: Ice.Context? = nil) async throws -> StringStringD {
...
public extension MyDerivedClassPrx {
    ...
    func opMyStruct1(_ iceP_s: MyStruct1, context: Ice.Context? = nil) async throws -> MyStruct1 {
    ...
    func opMyClass1(_ iceP_c: MyClass1?, context: Ice.Context? = nil) async throws -> MyClass1? {
...
public protocol MyClass {
    ...
    func opContext(current: Ice.Current) async throws -> StringStringD
...
public protocol MyDerivedClass: MyClass {
    ...
    func opMyStruct1(s: MyStruct1, current: Ice.Current) async throws -> MyStruct1

    func opMyClass1(c: MyClass1?, current: Ice.Current) async throws -> MyClass1?
}
...
extension MyDerivedClass {
    ...
    public func _iceD_opMyStruct1(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_s: MyStruct1 = try istr.read()
        let result = try await self.opMyStruct1(s: iceP_s, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
        }
    ...
    public func _iceD_opMyClass1(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        _ = try istr.startEncapsulation()
        var iceP_c: MyClass1?
        try istr.read(MyClass1.self) { iceP_c = $0 }
        try istr.readPendingValues()
        let result = try await self.opMyClass1(c: iceP_c, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
            ostr.writePendingValues()
