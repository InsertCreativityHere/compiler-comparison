...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CompactPDerived() -> AnyObject.Type {
        CompactPDerived.self
    }

    @objc static func resolveTypeId_56() -> AnyObject.Type {
        CompactPDerived.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_PreservedException() -> AnyObject.Type {
        PreservedException.self
    }
}
...
public extension TestIntfPrx {
    ...
    func throwPreservedException(context: Ice.Context? = nil) async throws {
...
open class D3: B {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.sd3 = try istr.read()
        try istr.read(B.self) { iceP_self.pd3 = $0 }
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
open class PCDerived: PDerived {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.pbs = try PBaseSeqHelper.read(from: istr)
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
open class PCDerived3: PCDerived2 {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read() { iceP_self.pcd3 = $0 }
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
