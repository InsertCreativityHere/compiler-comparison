...
public extension RelayPrx {
    ...
    func knownPreservedAsBaseAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "knownPreservedAsBase",
                                            mode: .Normal,
                                            userException:{ ex in
                                                do  {
                                                    throw ex
    ...
    ///
    /// - returns: `` - The result of the operation
    func knownPreservedAsKnownPreservedAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "knownPreservedAsKnownPreserved",
                                            mode: .Normal,
                                            userException:{ ex in
                                                do  {
                                                    throw ex
    ...
    ///
    /// - returns: `` - The result of the operation
    func unknownPreservedAsBaseAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "unknownPreservedAsBase",
                                            mode: .Normal,
                                            userException:{ ex in
                                                do  {
                                                    throw ex
    ...
    ///
    /// - returns: `` - The result of the operation
    func unknownPreservedAsKnownPreservedAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "unknownPreservedAsKnownPreserved",
                                            mode: .Normal,
                                            userException:{ ex in
                                                do  {
                                                    throw ex
...
public extension TestIntfPrx {
    ...
    ///
    /// - returns: `` - The result of the operation
    func unknownMostDerived2AsBaseCompactAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "unknownMostDerived2AsBaseCompact",
                                            mode: .Normal,
                                            format: .CompactFormat,
                                            userException:{ ex in
                                                do  {
    ...
    ///
    /// - returns: `` - The result of the operation
    func relayKnownPreservedAsBaseAsync(_ iceP_r: RelayPrx?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "relayKnownPreservedAsBase",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_r)
                                            },
    ...
    ///
    /// - returns: `` - The result of the operation
    func relayKnownPreservedAsKnownPreservedAsync(_ iceP_r: RelayPrx?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "relayKnownPreservedAsKnownPreserved",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_r)
                                            },
    ...
    ///
    /// - returns: `` - The result of the operation
    func relayUnknownPreservedAsBaseAsync(_ iceP_r: RelayPrx?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "relayUnknownPreservedAsBase",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_r)
                                            },
    ...
    ///
    /// - returns: `` - The result of the operation
    func relayUnknownPreservedAsKnownPreservedAsync(_ iceP_r: RelayPrx?, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "relayUnknownPreservedAsKnownPreserved",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_r)
                                            },
