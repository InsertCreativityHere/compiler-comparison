...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_C1() -> AnyObject.Type {
        C1.self
    }
}
...
public struct C1SeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending C1Seq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = C1Seq(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending C1Seq? {
    ...
    /// Write a `C1Seq` sequence to the stream.
    ///
    ...
    /// Write an optional `C1Seq?` sequence to the stream.
    ///
    /// - Parameters:
...
public struct S1SeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending S1Seq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = S1Seq()
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending S1Seq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct C1DictHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending C1Dict {
        let sz = try Swift.Int(istr.readSize())
        var v = C1Dict()
        nonisolated(unsafe) let e = Ice.DictEntryArray<Swift.Int32, C1?>(size: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending C1Dict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `C1Dict` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    ...
    /// Write an optional `C1Dict?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct S1DictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending S1Dict {
        let sz = try Swift.Int(istr.readSize())
        var v = S1Dict()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending S1Dict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `S1Dict` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `S1Dict?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct C1SeqSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending C1SeqSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = C1SeqSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending C1SeqSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `C1SeqSeq` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `C1SeqSeq?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct S1SeqSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending S1SeqSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = S1SeqSeq()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending S1SeqSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `S1SeqSeq` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `S1SeqSeq?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S3 {
        nonisolated(unsafe) let v = S3()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S3? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S4 {
        nonisolated(unsafe) let v = S4()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S4? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S5 {
        nonisolated(unsafe) let v = S5()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S5? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S6 {
        nonisolated(unsafe) let v = S6()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S6? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S7 {
        nonisolated(unsafe) let v = S7()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S7? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending S8 {
        nonisolated(unsafe) let v = S8()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending S8? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB1() -> AnyObject.Type {
        CB1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB2() -> AnyObject.Type {
        CB2.self
    }
}
...
open class CB2: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.c1seq = try C1SeqHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB3() -> AnyObject.Type {
        CB3.self
    }
}
...
open class CB3: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.s1seq = try S1SeqHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB4() -> AnyObject.Type {
        CB4.self
    }
}
...
open class CB4: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.c1dict = try C1DictHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB5() -> AnyObject.Type {
        CB5.self
    }
}
...
open class CB5: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.s1dict = try S1DictHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB6() -> AnyObject.Type {
        CB6.self
    }
}
...
open class CB6: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.c1seqseq = try C1SeqSeqHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB7() -> AnyObject.Type {
        CB7.self
    }
}
...
open class CB7: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.s1seqseq = try S1SeqSeqHelper.read(from: istr)
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_LocalTest_CB8() -> AnyObject.Type {
        CB8.self
    }
}
...
public struct StructDict1Helper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StructDict1 {
        let sz = try Swift.Int(istr.readSize())
        var v = StructDict1()
        nonisolated(unsafe) let e = Ice.DictEntryArray<StructKey, C1?>(size: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StructDict1? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `StructDict1` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `StructDict1?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct StructDict2Helper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending StructDict2 {
        let sz = try Swift.Int(istr.readSize())
        var v = StructDict2()
        for _ in 0 ..< sz {
            let key: StructKey = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending StructDict2? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `StructDict2` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `StructDict2?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct C1DictDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending C1DictDict {
        let sz = try Swift.Int(istr.readSize())
        var v = C1DictDict()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending C1DictDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `C1DictDict` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `C1DictDict?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct S1DictDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending S1DictDict {
        let sz = try Swift.Int(istr.readSize())
        var v = S1DictDict()
        for _ in 0 ..< sz {
            let key: Swift.Int32 = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending S1DictDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `S1DictDict` dictionary to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The dictionary value to write to the stream.
    ...
    /// Write an optional `S1DictDict?` dictionary to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
