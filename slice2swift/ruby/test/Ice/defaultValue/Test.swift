...
public struct StructNoDefaults: Swift.Sendable {
    ...
    public init(bo: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, c1: Color, bs: ByteSeq, is: IntSeq, dict: IntStringDict, st: InnerStruct) {
        self.bo = bo
        self.b = b
        self.s = s
        self.i = i
