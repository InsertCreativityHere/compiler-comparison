...
public enum END: Swift.UInt8, Swift.Sendable {
    case alias = 0
    public init() {
        self = .alias
    }
...
public struct and: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending and? {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_BEGIN_next() -> AnyObject.Type {
        next.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_BEGIN_nil() -> AnyObject.Type {
        nil.self
    }
}
...
open class nil: next, @unchecked Sendable {
    ...
    public var or: and = and()

    public required init() {
        super.init()
    }

    public init(new: Swift.Int32, not: Swift.Int32, or: and) {
        self.not = not
        self.or = or
        super.init(new: new)
    }
...
private final class breakPrxI: Ice.ObjectPrxI, breakPrx, @unchecked Sendable {
...
public extension breakPrx {
    func case(_ iceP_clone: Swift.Int32, context: Ice.Context? = nil) async throws -> Swift.Int32 {
    ...
    func instance_variables(context: Ice.Context? = nil) async throws -> END {
        return try await _impl._invoke(operation: "instance_variables",
                                       mode: .normal,
                                       read: read,
                                       context: context)

        func read(istr: Ice.InputStream) throws -> sending END {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_BEGIN_display() -> AnyObject.Type {
        display.self
    }
}

open class display: Ice.Value {
    public var when: and = and()
    public var dup: breakPrx? = nil
    public var else: Swift.Int32 = 0

    public required init() {}

    public init(when: and, dup: breakPrx?, else: Swift.Int32) {
        self.when = when
        self.dup = dup
        self.else = else
    }
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.when = try istr.read()
        iceP_self.dup = try istr.read(breakPrx.self)
...
private final class elsifPrxI: Ice.ObjectPrxI, elsifPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension elsifPrx {
    func for(freeze iceP_freeze: display?, if iceP_if: breakPrx?, methods iceP_methods: Swift.Int32, context: Ice.Context? = nil) async throws -> END {
...
public struct rescueHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending rescue {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending rescue? {
...
public struct ensureHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending ensure {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ensure? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public protocol break: Ice.Dispatcher {
    func case(clone: Swift.Int32, current: Ice.Current) async throws -> Swift.Int32

    func instance_variables(current: Ice.Current) async throws -> END
}

public protocol elsif: break {
    func for(freeze: sending display?, if: breakPrx?, methods: Swift.Int32, current: Ice.Current) async throws -> END
}

extension break {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<breakTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: break, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
    ...
    public func _iceD_case(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let result = try await self.case(clone: iceP_clone, current: request.current)
    ...
    public func _iceD_instance_variables(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let result = try await self.instance_variables(current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
...
extension elsif {
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: elsif, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "case":
            try await servant._iceD_case(request)
        case "instance_variables":
    ...
    public func _iceD_for(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_freeze: display?
        ...
        let result = try await self.for(freeze: iceP_freeze, if: iceP_if, methods: iceP_methods, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let iceP_returnValue = value
            ostr.write(iceP_returnValue)
        }
