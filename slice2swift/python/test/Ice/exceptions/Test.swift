...
public extension ThrowerPrx {
    ...
    func throwModA(a iceP_a: Swift.Int32, a2 iceP_a2: Swift.Int32, context: Ice.Context? = nil) async throws -> Swift.Void {
    ...
    func throwRequestFailedException(type iceP_type: Swift.String, id iceP_id: Ice.Identity, facet iceP_facet: Swift.String, operation iceP_operation: Swift.String, context: Ice.Context? = nil) async throws -> Swift.Void {
