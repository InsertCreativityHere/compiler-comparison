...
public struct ThrowerDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "throwMarshalException":
            return try servant._iceD_throwMarshalException(incoming: request, current: current)
...
public extension Thrower {
    ...
    func _iceD_throwMarshalException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        let (iceP_returnValue, iceP_p) = try self.throwMarshalException(current: current)
