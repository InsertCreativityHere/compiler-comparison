...
public extension ThrowerPrx {
    ...
    func throwMarshalException(context: Ice.Context? = nil) async throws -> (returnValue: Swift.Int32, p: Swift.Int32) {
        return try await _impl._invoke(operation: "throwMarshalException",
                                       mode: .normal,
                                       read: read,
                                       context: context)

        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Int32, p: Swift.Int32) {
    ...
    func throwRequestFailedException(type iceP_type: Swift.String, id iceP_id: Ice.Identity, facet iceP_facet: Swift.String, operation iceP_operation: Swift.String, context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "throwRequestFailedException",
                                       mode: .normal,
                                       write: { ostr in
...
public protocol Thrower: Ice.Dispatcher {
    ...
    func throwMarshalException(current: Ice.Current) async throws -> (returnValue: Swift.Int32, p: Swift.Int32)

    func throwRequestFailedException(type: Swift.String, id: Ice.Identity, facet: Swift.String, operation: Swift.String, current: Ice.Current) async throws
}
...
extension Thrower {
    ...
    public static func dispatch(_ servant: Thrower, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "throwMarshalException":
            try await servant._iceD_throwMarshalException(request)
        case "throwRequestFailedException":
            try await servant._iceD_throwRequestFailedException(request)
        case "ice_id":
            try await (servant as? Ice.Object ?? Self.defaultObject)._iceD_ice_id(request)
        case "ice_ids":
            try await (servant as? Ice.Object ?? Self.defaultObject)._iceD_ice_ids(request)
    ...
    public func _iceD_throwMarshalException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        let result = try await self.throwMarshalException(current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
    ...
    public func _iceD_throwRequestFailedException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        ...
        try await self.throwRequestFailedException(type: iceP_type, id: iceP_id, facet: iceP_facet, operation: iceP_operation, current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
}
