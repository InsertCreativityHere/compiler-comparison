...
public extension UnexpectedObjectExceptionTestPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<AlsoEmpty?>` - The result of the operation
    func opAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<AlsoEmpty?> {
