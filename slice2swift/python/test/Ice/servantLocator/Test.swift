...
public extension TestIntfPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func pythonException(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "pythonException",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func pythonExceptionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "pythonException",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "pythonException":
            return try servant._iceD_pythonException(incoming: request, current: current)
...
public protocol TestIntf {
    ...
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func pythonException(current: Ice.Current) throws
...
public extension TestIntf {
    ...
    func _iceD_pythonException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.pythonException(current: current)
