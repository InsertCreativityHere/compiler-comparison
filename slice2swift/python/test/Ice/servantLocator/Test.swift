...
public extension TestIntfPrx {
    ...
    func pythonException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "pythonException",
                                       mode: .normal,
                                       context: context)
    }
...
public protocol TestIntf: Ice.Dispatcher {
    ...
    func pythonException(current: Ice.Current) async throws
...
extension TestIntf {
    ...
    public static func dispatch(_ servant: TestIntf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "pythonException":
            try await servant._iceD_pythonException(request)
    ...
    public func _iceD_pythonException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.pythonException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
