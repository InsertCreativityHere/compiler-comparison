...
public extension TestIntfPrx {
    ...
    ///
    /// - returns: `` - The result of the operation
    func pythonExceptionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "pythonException",
                                            mode: .Normal,
                                            context: context,
                                            sentOn: sentOn,
                                            sentFlags: sentFlags,
...
extension TestIntf {
    ...
    public func _iceD_pythonException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        try self.pythonException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
