...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_NumPy_D() -> AnyObject.Type {
        NumPyD.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_NumPy_E() -> AnyObject.Type {
        NumPyE.self
    }
}

open class NumPyE: Ice.Value {
    public var boolSeq: NumPyBoolSeq1 = NumPyBoolSeq1()
    public var byteSeq: NumPyByteSeq1 = NumPyByteSeq1()
    public var shortSeq: NumPyShortSeq1 = NumPyShortSeq1()
    public var intSeq: NumPyIntSeq1 = NumPyIntSeq1()
    public var longSeq: NumPyLongSeq1 = NumPyLongSeq1()
    public var floatSeq: NumPyFloatSeq1 = NumPyFloatSeq1()
    public var doubleSeq: NumPyDoubleSeq1 = NumPyDoubleSeq1()
    ...
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::NumPy::E" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: NumPyE.ice_staticId(), compactId: -1, last: true)
...
private final class NumPyCustomPrxI: Ice.ObjectPrxI, NumPyCustomPrx, @unchecked Sendable {
...
public extension NumPyCustomPrx {
    func opBoolSeq(_ iceP_v1: NumPyBoolSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyBoolSeq1, v2: NumPyBoolSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyBoolSeq1, v2: NumPyBoolSeq2) {
    ...
    func opByteSeq(_ iceP_v1: NumPyByteSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyByteSeq1, v2: NumPyByteSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyByteSeq1, v2: NumPyByteSeq2) {
    ...
    func opShortSeq(_ iceP_v1: NumPyShortSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyShortSeq1, v2: NumPyShortSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyShortSeq1, v2: NumPyShortSeq2) {
    ...
    func opIntSeq(_ iceP_v1: NumPyIntSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyIntSeq1, v2: NumPyIntSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyIntSeq1, v2: NumPyIntSeq2) {
    ...
    func opLongSeq(_ iceP_v1: NumPyLongSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyLongSeq1, v2: NumPyLongSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyLongSeq1, v2: NumPyLongSeq2) {
    ...
    func opFloatSeq(_ iceP_v1: NumPyFloatSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyFloatSeq1, v2: NumPyFloatSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyFloatSeq1, v2: NumPyFloatSeq2) {
    ...
    func opDoubleSeq(_ iceP_v1: NumPyDoubleSeq1, context: Ice.Context? = nil) async throws -> (returnValue: NumPyDoubleSeq1, v2: NumPyDoubleSeq2) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NumPyDoubleSeq1, v2: NumPyDoubleSeq2) {
    ...
    func opComplex128Seq(_ iceP_v1: NumPyComplex128Seq, context: Ice.Context? = nil) async throws -> NumPyComplex128Seq {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyComplex128Seq {
    ...
    func opBoolMatrix(context: Ice.Context? = nil) async throws -> NumPyBoolSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyBoolSeq1 {
            let iceP_returnValue: NumPyBoolSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opByteMatrix(context: Ice.Context? = nil) async throws -> NumPyByteSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyByteSeq1 {
            let iceP_returnValue: NumPyByteSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opShortMatrix(context: Ice.Context? = nil) async throws -> NumPyShortSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyShortSeq1 {
            let iceP_returnValue: NumPyShortSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opIntMatrix(context: Ice.Context? = nil) async throws -> NumPyIntSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyIntSeq1 {
            let iceP_returnValue: NumPyIntSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opLongMatrix(context: Ice.Context? = nil) async throws -> NumPyLongSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyLongSeq1 {
            let iceP_returnValue: NumPyLongSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opFloatMatrix(context: Ice.Context? = nil) async throws -> NumPyFloatSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyFloatSeq1 {
            let iceP_returnValue: NumPyFloatSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opDoubleMatrix(context: Ice.Context? = nil) async throws -> NumPyDoubleSeq1 {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyDoubleSeq1 {
            let iceP_returnValue: NumPyDoubleSeq1 = try istr.read()
            return iceP_returnValue
        }
    }
    ...
    func opD(_ iceP_d: NumPyD?, context: Ice.Context? = nil) async throws -> NumPyD? {
        ...
        func read(istr: Ice.InputStream) throws -> sending NumPyD? {
            nonisolated(unsafe) var iceP_returnValue: NumPyD?
...
public protocol NumPyCustom: Ice.Dispatcher {
    ...
    func opD(d: sending NumPyD?, current: Ice.Current) async throws -> NumPyD?
...
extension NumPyCustom {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<NumPyCustomTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: NumPyCustom, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
    ...
    public func _iceD_opD(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        nonisolated(unsafe) var iceP_d: NumPyD?
