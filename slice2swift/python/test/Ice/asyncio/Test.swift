...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_TestException() -> AnyObject.Type {
        TestException.self
    }
}
...
public extension TestIntfPrx {
    ...
    func throwUserException1(context: Ice.Context? = nil) async throws {
    ...
    func throwUserException2(context: Ice.Context? = nil) async throws {
    ...
    func throwUnhandledException1(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "throwUnhandledException1",
                                       mode: .normal,
                                       context: context)
    }

    func throwUnhandledException2(context: Ice.Context? = nil) async throws {
