...
public extension InitialPrx {
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32)` - The result of the operation
    func opRequiredAfterOptionalAsync(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32) {
        return try await _impl._invokeAsync(operation: "opRequiredAfterOptional",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_p1)
                                                ostr.write(iceP_p3)
    ...
    ///
    /// - returns: `(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?)` - The result of the operation
    func opOptionalAfterRequiredAsync(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32? = nil, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?) {
        return try await _impl._invokeAsync(operation: "opOptionalAfterRequired",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_p1)
                                                ostr.write(tag: 1, value: iceP_p2)
