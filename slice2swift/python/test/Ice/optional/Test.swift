...
public extension InitialPrx {
    ...
    ///
    /// - parameter p3: `Swift.Int32`
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    ///
    /// - returns: `(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32)`:
    ///
    ///   - p4: `Swift.Int32`
    ///
    ///   - p5: `Swift.Int32?`
    ///
    ///   - p6: `Swift.Int32`
    func opRequiredAfterOptional(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32, context: Ice.Context? = nil) throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32) {
        return try _impl._invoke(operation: "opRequiredAfterOptional",
                                 mode: .Normal,
                                 write: { ostr in
                                     ostr.write(iceP_p1)
                                     ostr.write(iceP_p3)
    ...
    /// - parameter sent: `((Swift.Bool) -> Swift.Void)` - Optional sent callback.
    ///
    /// - returns: `PromiseKit.Promise<(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32)>` - The result of the operation
    func opRequiredAfterOptionalAsync(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32)> {
        return _impl._invokeAsync(operation: "opRequiredAfterOptional",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_p1)
                                      ostr.write(iceP_p3)
    ...
    ///
    ///   - p6: `Swift.Int32?`
    func opOptionalAfterRequired(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32? = nil, context: Ice.Context? = nil) throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?) {
        return try _impl._invoke(operation: "opOptionalAfterRequired",
                                 mode: .Normal,
                                 write: { ostr in
                                     ostr.write(iceP_p1)
                                     ostr.write(tag: 1, value: iceP_p2)
    ...
    ///
    /// - returns: `PromiseKit.Promise<(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?)>` - The result of the operation
    func opOptionalAfterRequiredAsync(p1 iceP_p1: Swift.Int32, p2 iceP_p2: Swift.Int32? = nil, p3 iceP_p3: Swift.Int32? = nil, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?)> {
        return _impl._invokeAsync(operation: "opOptionalAfterRequired",
                                  mode: .Normal,
                                  write: { ostr in
                                      ostr.write(iceP_p1)
                                      ostr.write(tag: 1, value: iceP_p2)
...
public struct InitialDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "opOptionalAfterRequired":
            return try servant._iceD_opOptionalAfterRequired(incoming: request, current: current)
        ...
        case "opRequiredAfterOptional":
            return try servant._iceD_opRequiredAfterOptional(incoming: request, current: current)
...
public protocol Initial {
    ...
    ///
    ///   - p6: `Swift.Int32`
    func opRequiredAfterOptional(p1: Swift.Int32, p2: Swift.Int32?, p3: Swift.Int32, current: Ice.Current) throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32)
    ...
    ///
    ///   - p6: `Swift.Int32?`
    func opOptionalAfterRequired(p1: Swift.Int32, p2: Swift.Int32?, p3: Swift.Int32?, current: Ice.Current) throws -> (p4: Swift.Int32, p5: Swift.Int32?, p6: Swift.Int32?)
...
public extension Initial {
    ...
    func _iceD_opRequiredAfterOptional(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let (iceP_p1, iceP_p2, iceP_p3): (Swift.Int32, Swift.Int32?, Swift.Int32) = try inS.read { istr in
        ...
        let (iceP_p4, iceP_p5, iceP_p6) = try self.opRequiredAfterOptional(p1: iceP_p1, p2: iceP_p2, p3: iceP_p3, current: current)
    ...
    func _iceD_opOptionalAfterRequired(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        let (iceP_p1, iceP_p2, iceP_p3): (Swift.Int32, Swift.Int32?, Swift.Int32?) = try inS.read { istr in
            let iceP_p1: Swift.Int32 = try istr.read()
            let iceP_p2: Swift.Int32? = try istr.read(tag: 1)
        ...
        let (iceP_p4, iceP_p5, iceP_p6) = try self.opOptionalAfterRequired(p1: iceP_p1, p2: iceP_p2, p3: iceP_p3, current: current)
