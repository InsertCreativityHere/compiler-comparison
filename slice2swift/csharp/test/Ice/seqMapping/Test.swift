...
public struct AObjectSHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending AObjectS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = AObjectS(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AObjectS? {
...
public struct LObjectSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LObjectS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = LObjectS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read() { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LObjectS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CObjectSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CObjectS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = CObjectS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read() { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CObjectS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `CObjectS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CObjectS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct AObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AObjectPrxS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LObjectPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = LObjectPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct KObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending KObjectPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = KObjectPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending KObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct QObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending QObjectPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = QObjectPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SObjectPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = SObjectPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CObjectPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CObjectPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = CObjectPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CObjectPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `CObjectPrxS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CObjectPrxS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct S: Swift.Hashable, Swift.Sendable {
...
public struct AStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AStructS {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AStructS? {
...
public struct LStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LStructS {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = LStructS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct KStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending KStructS {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = KStructS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending KStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct QStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending QStructS {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = QStructS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct SStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SStructS {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = SStructS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct CStructSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CStructS {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = CStructS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CStructS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
    ...
    /// Write a `CStructS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CStructS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct SD: Swift.Hashable, Swift.Sendable {
    public var i: Swift.Int32 = 1

    public init() {}

    public init(i: Swift.Int32 = 1) {
        self.i = i
    }
}
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SD? {
        guard try readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try skipSize()
...
public struct AStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = AStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct LStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = LStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct KStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending KStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = KStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending KStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct QStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending QStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = QStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct SStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = SStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
...
public struct CStructSDHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CStructSD {
        let sz = try istr.readAndCheckSeqSize(minSize: 4)
        var v = CStructSD()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CStructSD? {
        guard try istr.readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try istr.skipSize()
    ...
    /// Write a `CStructSD` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CStructSD?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CV() -> AnyObject.Type {
        CV.self
    }
}
...
public struct ACVSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ACVS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ACVS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ACVS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LCVSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LCVS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = LCVS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read(CV.self) { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LCVS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
private final class IPrxI: Ice.ObjectPrxI, IPrx, @unchecked Sendable {
...
public struct AIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = AIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = LIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct KIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending KIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = KIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending KIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct QIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending QIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = QIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = SIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CIPrxSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CIPrxS {
        let sz = try istr.readAndCheckSeqSize(minSize: 2)
        var v = CIPrxS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CIPrxS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `CIPrxS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CIPrxS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_CR() -> AnyObject.Type {
        CR.self
    }
}
...
open class CR: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        try istr.read(CV.self) { iceP_self.v = $0 }
        try istr.endSlice()
    }
...
public struct ACRSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ACRS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ACRS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ACRS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LCRSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LCRS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = LCRS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read(CR.self) { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LCRS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CCRSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CCRS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = CCRS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read(CR.self) { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CCRS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `CCRS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CCRS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public enum En: Swift.UInt8, Swift.Sendable {
    case A = 0
    case B = 1
    case C = 2
    public init() {
...
public struct AEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = AEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct LEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending LEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = LEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct KEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending KEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = KEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending KEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct QEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending QEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = QEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct SEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending SEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = SEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CEnSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CEnS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = CEnS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CEnS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
    ...
    /// Write a `CEnS` sequence to the stream.
    ///
    /// - Parameter ostr: The stream to write to.
    /// - Parameter v: The sequence value to write to the stream.
    ...
    /// Write an optional `CEnS?` sequence to the stream.
    ///
    /// - Parameters:
    ///   - ostr: The stream to write to.
    ///   - tag: The numeric tag associated with the value.
...
public struct CustomCVSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CustomCVS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = CustomCVS(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
                try istr.read(CV.self) { p.pointee = $0 }
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CustomCVS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CustomIntSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CustomIntSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = CustomIntSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CustomIntSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct CustomCVSSHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending CustomCVSS {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        var v = CustomCVSS()
        v.reserveCapacity(sz)
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending CustomCVSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension MyClassPrx {
    ...
    func opAByteS(_ iceP_i: AByteS, context: Ice.Context? = nil) async throws -> (returnValue: AByteS, o: AByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AByteS, o: AByteS) {
    ...
    func opLByteS(_ iceP_i: LByteS, context: Ice.Context? = nil) async throws -> (returnValue: LByteS, o: LByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LByteS, o: LByteS) {
    ...
    func opKByteS(_ iceP_i: KByteS, context: Ice.Context? = nil) async throws -> (returnValue: KByteS, o: KByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KByteS, o: KByteS) {
    ...
    func opQByteS(_ iceP_i: QByteS, context: Ice.Context? = nil) async throws -> (returnValue: QByteS, o: QByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QByteS, o: QByteS) {
    ...
    func opSByteS(_ iceP_i: SByteS, context: Ice.Context? = nil) async throws -> (returnValue: SByteS, o: SByteS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SByteS, o: SByteS) {
    ...
    func opABoolS(_ iceP_i: ABoolS, context: Ice.Context? = nil) async throws -> (returnValue: ABoolS, o: ABoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ABoolS, o: ABoolS) {
    ...
    func opLBoolS(_ iceP_i: LBoolS, context: Ice.Context? = nil) async throws -> (returnValue: LBoolS, o: LBoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LBoolS, o: LBoolS) {
    ...
    func opKBoolS(_ iceP_i: KBoolS, context: Ice.Context? = nil) async throws -> (returnValue: KBoolS, o: KBoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KBoolS, o: KBoolS) {
    ...
    func opQBoolS(_ iceP_i: QBoolS, context: Ice.Context? = nil) async throws -> (returnValue: QBoolS, o: QBoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QBoolS, o: QBoolS) {
    ...
    func opSBoolS(_ iceP_i: SBoolS, context: Ice.Context? = nil) async throws -> (returnValue: SBoolS, o: SBoolS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SBoolS, o: SBoolS) {
    ...
    func opAShortS(_ iceP_i: AShortS, context: Ice.Context? = nil) async throws -> (returnValue: AShortS, o: AShortS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AShortS, o: AShortS) {
    ...
    func opLShortS(_ iceP_i: LShortS, context: Ice.Context? = nil) async throws -> (returnValue: LShortS, o: LShortS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LShortS, o: LShortS) {
    ...
    func opKShortS(_ iceP_i: KShortS, context: Ice.Context? = nil) async throws -> (returnValue: KShortS, o: KShortS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KShortS, o: KShortS) {
    ...
    func opQShortS(_ iceP_i: QShortS, context: Ice.Context? = nil) async throws -> (returnValue: QShortS, o: QShortS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QShortS, o: QShortS) {
    ...
    func opSShortS(_ iceP_i: SShortS, context: Ice.Context? = nil) async throws -> (returnValue: SShortS, o: SShortS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SShortS, o: SShortS) {
    ...
    func opAIntS(_ iceP_i: AIntS, context: Ice.Context? = nil) async throws -> (returnValue: AIntS, o: AIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AIntS, o: AIntS) {
    ...
    func opLIntS(_ iceP_i: LIntS, context: Ice.Context? = nil) async throws -> (returnValue: LIntS, o: LIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LIntS, o: LIntS) {
    ...
    func opKIntS(_ iceP_i: KIntS, context: Ice.Context? = nil) async throws -> (returnValue: KIntS, o: KIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KIntS, o: KIntS) {
    ...
    func opQIntS(_ iceP_i: QIntS, context: Ice.Context? = nil) async throws -> (returnValue: QIntS, o: QIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QIntS, o: QIntS) {
    ...
    func opSIntS(_ iceP_i: SIntS, context: Ice.Context? = nil) async throws -> (returnValue: SIntS, o: SIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SIntS, o: SIntS) {
    ...
    func opALongS(_ iceP_i: ALongS, context: Ice.Context? = nil) async throws -> (returnValue: ALongS, o: ALongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ALongS, o: ALongS) {
    ...
    func opLLongS(_ iceP_i: LLongS, context: Ice.Context? = nil) async throws -> (returnValue: LLongS, o: LLongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LLongS, o: LLongS) {
    ...
    func opKLongS(_ iceP_i: KLongS, context: Ice.Context? = nil) async throws -> (returnValue: KLongS, o: KLongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KLongS, o: KLongS) {
    ...
    func opQLongS(_ iceP_i: QLongS, context: Ice.Context? = nil) async throws -> (returnValue: QLongS, o: QLongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QLongS, o: QLongS) {
    ...
    func opSLongS(_ iceP_i: SLongS, context: Ice.Context? = nil) async throws -> (returnValue: SLongS, o: SLongS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SLongS, o: SLongS) {
    ...
    func opAFloatS(_ iceP_i: AFloatS, context: Ice.Context? = nil) async throws -> (returnValue: AFloatS, o: AFloatS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AFloatS, o: AFloatS) {
    ...
    func opLFloatS(_ iceP_i: LFloatS, context: Ice.Context? = nil) async throws -> (returnValue: LFloatS, o: LFloatS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LFloatS, o: LFloatS) {
    ...
    func opKFloatS(_ iceP_i: KFloatS, context: Ice.Context? = nil) async throws -> (returnValue: KFloatS, o: KFloatS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KFloatS, o: KFloatS) {
    ...
    func opQFloatS(_ iceP_i: QFloatS, context: Ice.Context? = nil) async throws -> (returnValue: QFloatS, o: QFloatS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QFloatS, o: QFloatS) {
    ...
    func opSFloatS(_ iceP_i: SFloatS, context: Ice.Context? = nil) async throws -> (returnValue: SFloatS, o: SFloatS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SFloatS, o: SFloatS) {
    ...
    func opADoubleS(_ iceP_i: ADoubleS, context: Ice.Context? = nil) async throws -> (returnValue: ADoubleS, o: ADoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ADoubleS, o: ADoubleS) {
    ...
    func opLDoubleS(_ iceP_i: LDoubleS, context: Ice.Context? = nil) async throws -> (returnValue: LDoubleS, o: LDoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LDoubleS, o: LDoubleS) {
    ...
    func opKDoubleS(_ iceP_i: KDoubleS, context: Ice.Context? = nil) async throws -> (returnValue: KDoubleS, o: KDoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KDoubleS, o: KDoubleS) {
    ...
    func opQDoubleS(_ iceP_i: QDoubleS, context: Ice.Context? = nil) async throws -> (returnValue: QDoubleS, o: QDoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QDoubleS, o: QDoubleS) {
    ...
    func opSDoubleS(_ iceP_i: SDoubleS, context: Ice.Context? = nil) async throws -> (returnValue: SDoubleS, o: SDoubleS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SDoubleS, o: SDoubleS) {
    ...
    func opAStringS(_ iceP_i: AStringS, context: Ice.Context? = nil) async throws -> (returnValue: AStringS, o: AStringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AStringS, o: AStringS) {
    ...
    func opLStringS(_ iceP_i: LStringS, context: Ice.Context? = nil) async throws -> (returnValue: LStringS, o: LStringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LStringS, o: LStringS) {
    ...
    func opKStringS(_ iceP_i: KStringS, context: Ice.Context? = nil) async throws -> (returnValue: KStringS, o: KStringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KStringS, o: KStringS) {
    ...
    func opQStringS(_ iceP_i: QStringS, context: Ice.Context? = nil) async throws -> (returnValue: QStringS, o: QStringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QStringS, o: QStringS) {
    ...
    func opSStringS(_ iceP_i: SStringS, context: Ice.Context? = nil) async throws -> (returnValue: SStringS, o: SStringS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SStringS, o: SStringS) {
    ...
    func opAObjectS(_ iceP_i: AObjectS, context: Ice.Context? = nil) async throws -> (returnValue: AObjectS, o: AObjectS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AObjectS, o: AObjectS) {
    ...
    func opLObjectS(_ iceP_i: LObjectS, context: Ice.Context? = nil) async throws -> (returnValue: LObjectS, o: LObjectS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LObjectS, o: LObjectS) {
    ...
    func opAObjectPrxS(_ iceP_i: AObjectPrxS, context: Ice.Context? = nil) async throws -> (returnValue: AObjectPrxS, o: AObjectPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AObjectPrxS, o: AObjectPrxS) {
    ...
    func opLObjectPrxS(_ iceP_i: LObjectPrxS, context: Ice.Context? = nil) async throws -> (returnValue: LObjectPrxS, o: LObjectPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LObjectPrxS, o: LObjectPrxS) {
    ...
    func opKObjectPrxS(_ iceP_i: KObjectPrxS, context: Ice.Context? = nil) async throws -> (returnValue: KObjectPrxS, o: KObjectPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KObjectPrxS, o: KObjectPrxS) {
    ...
    func opQObjectPrxS(_ iceP_i: QObjectPrxS, context: Ice.Context? = nil) async throws -> (returnValue: QObjectPrxS, o: QObjectPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QObjectPrxS, o: QObjectPrxS) {
    ...
    func opSObjectPrxS(_ iceP_i: SObjectPrxS, context: Ice.Context? = nil) async throws -> (returnValue: SObjectPrxS, o: SObjectPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SObjectPrxS, o: SObjectPrxS) {
    ...
    func opAStructS(_ iceP_i: AStructS, context: Ice.Context? = nil) async throws -> (returnValue: AStructS, o: AStructS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AStructS, o: AStructS) {
    ...
    func opLStructS(_ iceP_i: LStructS, context: Ice.Context? = nil) async throws -> (returnValue: LStructS, o: LStructS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LStructS, o: LStructS) {
    ...
    func opKStructS(_ iceP_i: KStructS, context: Ice.Context? = nil) async throws -> (returnValue: KStructS, o: KStructS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KStructS, o: KStructS) {
    ...
    func opQStructS(_ iceP_i: QStructS, context: Ice.Context? = nil) async throws -> (returnValue: QStructS, o: QStructS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QStructS, o: QStructS) {
    ...
    func opSStructS(_ iceP_i: SStructS, context: Ice.Context? = nil) async throws -> (returnValue: SStructS, o: SStructS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SStructS, o: SStructS) {
    ...
    func opAStructSD(_ iceP_i: AStructSD, context: Ice.Context? = nil) async throws -> (returnValue: AStructSD, o: AStructSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AStructSD, o: AStructSD) {
    ...
    func opLStructSD(_ iceP_i: LStructSD, context: Ice.Context? = nil) async throws -> (returnValue: LStructSD, o: LStructSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LStructSD, o: LStructSD) {
    ...
    func opKStructSD(_ iceP_i: KStructSD, context: Ice.Context? = nil) async throws -> (returnValue: KStructSD, o: KStructSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KStructSD, o: KStructSD) {
    ...
    func opQStructSD(_ iceP_i: QStructSD, context: Ice.Context? = nil) async throws -> (returnValue: QStructSD, o: QStructSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QStructSD, o: QStructSD) {
    ...
    func opSStructSD(_ iceP_i: SStructSD, context: Ice.Context? = nil) async throws -> (returnValue: SStructSD, o: SStructSD) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SStructSD, o: SStructSD) {
    ...
    func opACVS(_ iceP_i: ACVS, context: Ice.Context? = nil) async throws -> (returnValue: ACVS, o: ACVS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ACVS, o: ACVS) {
    ...
    func opLCVS(_ iceP_i: LCVS, context: Ice.Context? = nil) async throws -> (returnValue: LCVS, o: LCVS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LCVS, o: LCVS) {
    ...
    func opACRS(_ iceP_i: ACRS, context: Ice.Context? = nil) async throws -> (returnValue: ACRS, o: ACRS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ACRS, o: ACRS) {
    ...
    func opLCRS(_ iceP_i: LCRS, context: Ice.Context? = nil) async throws -> (returnValue: LCRS, o: LCRS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LCRS, o: LCRS) {
    ...
    func opAEnS(_ iceP_i: AEnS, context: Ice.Context? = nil) async throws -> (returnValue: AEnS, o: AEnS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AEnS, o: AEnS) {
    ...
    func opLEnS(_ iceP_i: LEnS, context: Ice.Context? = nil) async throws -> (returnValue: LEnS, o: LEnS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LEnS, o: LEnS) {
    ...
    func opKEnS(_ iceP_i: KEnS, context: Ice.Context? = nil) async throws -> (returnValue: KEnS, o: KEnS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KEnS, o: KEnS) {
    ...
    func opQEnS(_ iceP_i: QEnS, context: Ice.Context? = nil) async throws -> (returnValue: QEnS, o: QEnS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QEnS, o: QEnS) {
    ...
    func opSEnS(_ iceP_i: SEnS, context: Ice.Context? = nil) async throws -> (returnValue: SEnS, o: SEnS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SEnS, o: SEnS) {
    ...
    func opAIPrxS(_ iceP_i: AIPrxS, context: Ice.Context? = nil) async throws -> (returnValue: AIPrxS, o: AIPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: AIPrxS, o: AIPrxS) {
    ...
    func opLIPrxS(_ iceP_i: LIPrxS, context: Ice.Context? = nil) async throws -> (returnValue: LIPrxS, o: LIPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LIPrxS, o: LIPrxS) {
    ...
    func opKIPrxS(_ iceP_i: KIPrxS, context: Ice.Context? = nil) async throws -> (returnValue: KIPrxS, o: KIPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: KIPrxS, o: KIPrxS) {
    ...
    func opQIPrxS(_ iceP_i: QIPrxS, context: Ice.Context? = nil) async throws -> (returnValue: QIPrxS, o: QIPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: QIPrxS, o: QIPrxS) {
    ...
    func opSIPrxS(_ iceP_i: SIPrxS, context: Ice.Context? = nil) async throws -> (returnValue: SIPrxS, o: SIPrxS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SIPrxS, o: SIPrxS) {
    ...
    func opCustomIntS(_ iceP_i: CustomIntS, context: Ice.Context? = nil) async throws -> (returnValue: CustomIntS, o: CustomIntS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: CustomIntS, o: CustomIntS) {
    ...
    func opCustomCVS(_ iceP_i: CustomCVS, context: Ice.Context? = nil) async throws -> (returnValue: CustomCVS, o: CustomCVS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: CustomCVS, o: CustomCVS) {
    ...
    func opCustomIntSS(_ iceP_i: CustomIntSS, context: Ice.Context? = nil) async throws -> (returnValue: CustomIntSS, o: CustomIntSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: CustomIntSS, o: CustomIntSS) {
    ...
    func opCustomCVSS(_ iceP_i: CustomCVSS, context: Ice.Context? = nil) async throws -> (returnValue: CustomCVSS, o: CustomCVSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: CustomCVSS, o: CustomCVSS) {
...
public protocol I: Ice.Dispatcher {}
...
public protocol MyClass: Ice.Dispatcher {
    ...
    func opAObjectS(i: sending AObjectS, current: Ice.Current) async throws -> (returnValue: AObjectS, o: AObjectS)

    func opLObjectS(i: sending LObjectS, current: Ice.Current) async throws -> (returnValue: LObjectS, o: LObjectS)
    ...
    func opACVS(i: sending ACVS, current: Ice.Current) async throws -> (returnValue: ACVS, o: ACVS)

    func opLCVS(i: sending LCVS, current: Ice.Current) async throws -> (returnValue: LCVS, o: LCVS)

    func opACRS(i: sending ACRS, current: Ice.Current) async throws -> (returnValue: ACRS, o: ACRS)

    func opLCRS(i: sending LCRS, current: Ice.Current) async throws -> (returnValue: LCRS, o: LCRS)
    ...
    func opCustomCVS(i: sending CustomCVS, current: Ice.Current) async throws -> (returnValue: CustomCVS, o: CustomCVS)

    func opCustomIntSS(i: CustomIntSS, current: Ice.Current) async throws -> (returnValue: CustomIntSS, o: CustomIntSS)

    func opCustomCVSS(i: sending CustomCVSS, current: Ice.Current) async throws -> (returnValue: CustomCVSS, o: CustomCVSS)
}

extension I {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<ITraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: I, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
