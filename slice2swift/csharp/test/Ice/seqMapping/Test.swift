...
public protocol MyClass {
    ...
    ///
    ///   - o: `SerialSmall`
    func opSerialSmallCSharp(i: SerialSmall, current: Ice.Current) throws -> (returnValue: SerialSmall, o: SerialSmall)
    ...
    ///
    ///   - o: `SerialLarge`
    func opSerialLargeCSharp(i: SerialLarge, current: Ice.Current) throws -> (returnValue: SerialLarge, o: SerialLarge)
    ...
    ///
    ///   - o: `SerialStruct`
    func opSerialStructCSharp(i: SerialStruct, current: Ice.Current) throws -> (returnValue: SerialStruct, o: SerialStruct)
}
...
public extension MyClass {
    ...
    func _iceD_opSerialSmallCSharp(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_o) = try self.opSerialSmallCSharp(i: iceP_i, current: current)
    ...
    func _iceD_opSerialLargeCSharp(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_o) = try self.opSerialLargeCSharp(i: iceP_i, current: current)
    ...
    func _iceD_opSerialStructCSharp(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        let (iceP_returnValue, iceP_o) = try self.opSerialStructCSharp(i: iceP_i, current: current)
