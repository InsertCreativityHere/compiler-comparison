...
public protocol Metrics {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func failAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithUserExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithRequestFailedExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithLocalExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithUnknownExceptionAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opByteSAsync(bs: ByteSeq, current: Ice.Current) -> PromiseKit.Promise<Swift.Void>
...
public extension Metrics {
    ...
    func _iceD_opWithRequestFailedException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opWithRequestFailedExceptionAsync(current: current))
    }

    func _iceD_opWithLocalException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(opWithLocalExceptionAsync(current: current))
    }
    ...
    func _iceD_opWithUnknownException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opWithUnknownExceptionAsync(current: current))
    }
    ...
    func _iceD_opByteS(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        return inS.setResultPromise(opByteSAsync(bs: iceP_bs, current: current))
    }
