...
private final class CleanerPrxI: Ice.ObjectPrxI, CleanerPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension CleanerPrx {
    func cleanup(context: Ice.Context? = nil) async throws {
...
public protocol Cleaner: Ice.Dispatcher {
...
extension Cleaner {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<CleanerTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Cleaner, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "cleanup":
