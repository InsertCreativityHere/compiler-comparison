...
public struct Point: Swift.Hashable, Swift.Sendable {
    ...
    public var y: Swift.Int32 = 42

    public init() {}

    public init(x: Swift.Int32, y: Swift.Int32 = 42) {
        self.x = x
        self.y = y
    }
}
...
public struct PointProp: Swift.Hashable, Swift.Sendable {
    public var x: Swift.Int32 = 0
    public var y: Swift.Int32 = 42
...
/// An `Ice.InputStream` extension to read `PointProp` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `PointProp` structured value from the stream.
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending PointProp {
        var v = PointProp()
        v.x = try self.read()
        v.y = try self.read()
        return v
    ...
    /// Read an optional `PointProp?` structured value from the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending PointProp? {
        guard try readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try skipSize()
        return try read() as PointProp
    }
}

/// An `Ice.OutputStream` extension to write `PointProp` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `PointProp` structured value to the stream.
    ///
    /// - Parameter v: The value to write to the stream.
    func write(_ v: PointProp) {
        self.write(v.x)
        self.write(v.y)
    }

    /// Write an optional `PointProp?` structured value to the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The value to write to the stream.
    func write(tag: Swift.Int32, value: PointProp?) {
        if let v = value {
            if writeOptional(tag: tag, format: .VSize) {
                write(size: 8)
                write(v)
...
public struct Struct3: Swift.Sendable {
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, c1: Color = Color.red, c2: Color = Color.green, c3: Color = Color.blue, nc1: NestedColor = NestedColor.red, nc2: NestedColor = NestedColor.green, nc3: NestedColor = NestedColor.blue, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
...
public struct Struct4: Swift.Sendable {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
    public var b: Swift.UInt8 = 1
    public var s: Swift.Int16 = 2
...
open class Base: Ice.Value {
    ...
    public var zeroD: Swift.Double = 0
    public var zeroDotD: Swift.Double = 0
    public var st1: Struct1 = Struct1()

    public required init() {}

    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo \\ \"bar\n \r\n\t\u{000b}\u{000c}\u{0007}\u{0008}? \u{0007} \u{0007}", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0, st1: Struct1) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
...
open class Derived: Base {
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo \\ \"bar\n \r\n\t\u{000b}\u{000c}\u{0007}\u{0008}? \u{0007} \u{0007}", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0, st1: Struct1, c1: Color = Color.red, c2: Color = Color.green, c3: Color = Color.blue, nc1: NestedColor = NestedColor.red, nc2: NestedColor = NestedColor.green, nc3: NestedColor = NestedColor.blue) {
        self.c1 = c1
        self.c2 = c2
        self.c3 = c3
        self.nc1 = nc1
        self.nc2 = nc2
        self.nc3 = nc3
        super.init(boolFalse: boolFalse, boolTrue: boolTrue, b: b, s: s, i: i, l: l, f: f, d: d, str: str, noDefault: noDefault, zeroI: zeroI, zeroL: zeroL, zeroF: zeroF, zeroDotF: zeroDotF, zeroD: zeroD, zeroDotD: zeroDotD, st1: st1)
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_ClassProperty() -> AnyObject.Type {
        ClassProperty.self
    }
}

open class ClassProperty: Ice.Value {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
    public var b: Swift.UInt8 = 1
    public var s: Swift.Int16 = 2
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo bar", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
    ...
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::ClassProperty" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: ClassProperty.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.boolFalse)
        ostr.write(self.boolTrue)
        ostr.write(self.b)
        ostr.write(self.s)
...
public struct StructProperty: Swift.Sendable {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
    public var b: Swift.UInt8 = 1
    public var s: Swift.Int16 = 2
...
/// An `Ice.InputStream` extension to read `StructProperty` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `StructProperty` structured value from the stream.
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending StructProperty {
        var v = StructProperty()
        v.boolFalse = try self.read()
        v.boolTrue = try self.read()
        v.b = try self.read()
        v.s = try self.read()
    ...
    /// Read an optional `StructProperty?` structured value from the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending StructProperty? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as StructProperty
    }
}

/// An `Ice.OutputStream` extension to write `StructProperty` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `StructProperty` structured value to the stream.
    ///
    /// - Parameter v: The value to write to the stream.
    func write(_ v: StructProperty) {
        self.write(v.boolFalse)
        self.write(v.boolTrue)
        self.write(v.b)
        self.write(v.s)
    ...
    /// Write an optional `StructProperty?` structured value to the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The value to write to the stream.
    func write(tag: Swift.Int32, value: StructProperty?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_ExceptionProperty() -> AnyObject.Type {
        ExceptionProperty.self
    }
}

open class ExceptionProperty: Ice.UserException, @unchecked Sendable {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
    public var b: Swift.UInt8 = 1
    public var s: Swift.Int16 = 2
    ...
    /// - Returns: The Slice type ID of this exception.
    open override class func ice_staticId() -> Swift.String { "::Test::ExceptionProperty" }

    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: ExceptionProperty.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.boolFalse)
        ostr.write(self.boolTrue)
        ostr.write(self.b)
        ostr.write(self.s)
...
public struct InnerStruct2: Swift.Hashable, Swift.Sendable {
...
/// An `Ice.InputStream` extension to read `InnerStruct2` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `InnerStruct2` structured value from the stream.
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending InnerStruct2 {
        var v = InnerStruct2()
        v.a = try self.read()
        return v
    }

    /// Read an optional `InnerStruct2?` structured value from the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending InnerStruct2? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as InnerStruct2
    }
}

/// An `Ice.OutputStream` extension to write `InnerStruct2` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `InnerStruct2` structured value to the stream.
    ///
    /// - Parameter v: The value to write to the stream.
    func write(_ v: InnerStruct2) {
        self.write(v.a)
    }

    /// Write an optional `InnerStruct2?` structured value to the stream.
    ///
    /// - Parameter tag: The numeric tag associated with the value.
    /// - Parameter value: The value to write to the stream.
    func write(tag: Swift.Int32, value: InnerStruct2?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
public struct StructNoDefaults: Swift.Sendable {
    ...
    public var st2: InnerStruct2 = InnerStruct2()
    public var dict: IntStringDict = IntStringDict()

    public init() {}

    public init(bo: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, str: Swift.String, c1: Color, bs: ByteSeq, iseq: IntSeq, st: InnerStruct, st2: InnerStruct2, dict: IntStringDict) {
        self.bo = bo
        self.b = b
        self.s = s
        self.i = i
...
open class ExceptionNoDefaults: ExceptionNoDefaultsBase, @unchecked Sendable {
    ...
    public init(str: Swift.String, c1: Color, bs: ByteSeq, st: InnerStruct, st2: InnerStruct2, dict: IntStringDict) {
        self.st = st
        self.st2 = st2
        self.dict = dict
