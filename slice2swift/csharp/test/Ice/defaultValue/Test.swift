...
public struct Struct3 {
    ...
    public init(boolFalse: Swift.Bool, boolTrue: Swift.Bool, b: Swift.UInt8, s: Swift.Int16, i: Swift.Int32, l: Swift.Int64, f: Swift.Float, d: Swift.Double, c1: Color, c2: Color, c3: Color, nc1: NestedColor, nc2: NestedColor, nc3: NestedColor, zeroI: Swift.Int32, zeroL: Swift.Int64, zeroF: Swift.Float, zeroDotF: Swift.Float, zeroD: Swift.Double, zeroDotD: Swift.Double) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
...
/// Traits for Slice class`ClassProperty`.
public struct ClassPropertyTraits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::ClassProperty"]
    public static let staticId = "::Test::ClassProperty"
}
...
public extension Ice.InputStream {
    ...
    ///
    /// - returns: `StructProperty` - The structured value read from the stream.
...
public extension Ice.OutputStream {
    ...
    ///
    /// - parameter _: `StructProperty` - The value to write to the stream.
    ...
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `StructProperty?` - The value to write to the stream.
...
/// :nodoc:
public class ExceptionProperty_TypeResolver: Ice.UserExceptionTypeResolver {
    public override func type() -> Ice.UserException.Type {
        return ExceptionProperty.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test_ExceptionProperty() -> Ice.UserExceptionTypeResolver {
        return ExceptionProperty_TypeResolver()
    }
}

open class ExceptionProperty: Ice.UserException {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
    public var b: Swift.UInt8 = 1
    public var s: Swift.Int16 = 2
...
public extension Ice.InputStream {
    ...
    ///
    /// - returns: `InnerStruct2` - The structured value read from the stream.
...
public extension Ice.OutputStream {
    ...
    ///
    /// - parameter _: `InnerStruct2` - The value to write to the stream.
    ...
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `InnerStruct2?` - The value to write to the stream.
...
/// :nodoc:
public class ClassProperty_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
...
public extension Ice.ClassResolver {
    @objc static func Test_ClassProperty() -> Ice.ValueTypeResolver {
        return ClassProperty_TypeResolver()
    }
}
...
open class ClassProperty: Ice.Value {
    ...
    /// - returns: `String` - The Slice type ID of the most-derived interface supported by this object
    open override func ice_id() -> Swift.String {
        return ClassPropertyTraits.staticId
    }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: ClassPropertyTraits.staticId, compactId: -1, last: true)
        ostr.write(self.boolFalse)
        ostr.write(self.boolTrue)
        ostr.write(self.b)
        ostr.write(self.s)
