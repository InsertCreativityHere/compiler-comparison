...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_InvalidPointException() -> AnyObject.Type {
        InvalidPointException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_InvalidLengthException() -> AnyObject.Type {
        InvalidLengthException.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_OtherException() -> AnyObject.Type {
        OtherException.self
    }
}
