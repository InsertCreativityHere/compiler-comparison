...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_NoNamespace_C1() -> AnyObject.Type {
        C1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_NoNamespace_C2() -> AnyObject.Type {
        C2.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_NoNamespace_E1() -> AnyObject.Type {
        E1.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_NoNamespace_E2() -> AnyObject.Type {
        E2.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_NoNamespace_notify() -> AnyObject.Type {
        notify.self
    }
}
