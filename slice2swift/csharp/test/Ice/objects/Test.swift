...
/// Traits for Slice class`IBase`.
public struct IBaseTraits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::IBase"]
    public static let staticId = "::Test::IBase"
}

/// Traits for Slice class`IDerived`.
public struct IDerivedTraits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::IBase", "::Test::IDerived"]
    public static let staticId = "::Test::IDerived"
}

/// Traits for Slice class`IDerived2`.
public struct IDerived2Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::IBase", "::Test::IDerived2"]
    public static let staticId = "::Test::IDerived2"
}

/// Traits for Slice class`I2`.
public struct I2Traits: Ice.SliceTraits {
    public static let staticIds = ["::Ice::Object", "::Test::I2"]
    public static let staticId = "::Test::I2"
}
...
public struct SC1: Swift.Hashable {
...
/// An `Ice.InputStream` extension to read `SC1` structured values from the stream.
public extension Ice.InputStream {
    /// Read a `SC1` structured value from the stream.
    ///
    /// - returns: `SC1` - The structured value read from the stream.
    func read() throws -> SC1 {
        var v = SC1()
        v.id = try self.read()
        return v
    }

    /// Read an optional `SC1?` structured value from the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - returns: `SC1?` - The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> SC1? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
        return try read() as SC1
    }
}

/// An `Ice.OutputStream` extension to write `SC1` structured values from the stream.
public extension Ice.OutputStream {
    /// Write a `SC1` structured value to the stream.
    ///
    /// - parameter _: `SC1` - The value to write to the stream.
    func write(_ v: SC1) {
        self.write(v.id)
    }

    /// Write an optional `SC1?` structured value to the stream.
    ///
    /// - parameter tag: `Swift.Int32` - The numeric tag associated with the value.
    ///
    /// - parameter value: `SC1?` - The value to write to the stream.
    func write(tag: Swift.Int32, value: SC1?) {
        if let v = value {
            if writeOptional(tag: tag, format: .FSize) {
                let pos = startSize()
                write(v)
...
/// :nodoc:
public class IBase_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
        return IBase.self
    }
}
...
public extension Ice.ClassResolver {
    @objc static func Test_IBase() -> Ice.ValueTypeResolver {
        return IBase_TypeResolver()
    }
}

open class IBase: Ice.Value {
    public var id: Swift.String = ""
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IBaseTraits.staticId, compactId: -1, last: true)
        ostr.write(self.id)
        ostr.endSlice()
    }
}
...
/// :nodoc:
public class IDerived_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
        return IDerived.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test_IDerived() -> Ice.ValueTypeResolver {
        return IDerived_TypeResolver()
    }
}

open class IDerived: IBase {
    public var name: Swift.String = ""
    ...
    /// - returns: `String` - The Slice type ID of the most-derived interface supported by this object
    open override func ice_id() -> Swift.String {
        return IDerivedTraits.staticId
    }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IDerivedTraits.staticId, compactId: -1, last: false)
        ostr.write(self.name)
        ostr.endSlice()
        super._iceWriteImpl(to: ostr);
    }
...
/// :nodoc:
public class IDerived2_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
        return IDerived2.self
    }
}

public extension Ice.ClassResolver {
    @objc static func Test_IDerived2() -> Ice.ValueTypeResolver {
        return IDerived2_TypeResolver()
    }
}

open class IDerived2: IBase {
    /// Returns the Slice type ID of the most-derived interface supported by this object.
    ///
    /// - returns: `String` - The Slice type ID of the most-derived interface supported by this object
    open override func ice_id() -> Swift.String {
        return IDerived2Traits.staticId
    }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IDerived2Traits.staticId, compactId: -1, last: false)
        ostr.endSlice()
        super._iceWriteImpl(to: ostr);
    }
}
...
/// :nodoc:
public class I2_TypeResolver: Ice.ValueTypeResolver {
    public override func type() -> Ice.Value.Type {
        return I2.self
    }
}
...
public extension Ice.ClassResolver {
    @objc static func Test_I2() -> Ice.ValueTypeResolver {
        return I2_TypeResolver()
    }
}

open class I2: Ice.Value {
    public required init() {}
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: I2Traits.staticId, compactId: -1, last: true)
        ostr.endSlice()
    }
}
