...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_IBase() -> AnyObject.Type {
        IBase.self
    }
}
...
open class IBase: Ice.Value {
    ...
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::IBase" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IBase.ice_staticId(), compactId: -1, last: true)
        ostr.write(self.id)
        ostr.endSlice()
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_IDerived() -> AnyObject.Type {
        IDerived.self
    }
}
...
open class IDerived: IBase {
    ...
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::IDerived" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IDerived.ice_staticId(), compactId: -1, last: false)
        ostr.write(self.name)
        ostr.endSlice()
        super._iceWriteImpl(to: ostr);
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_IDerived2() -> AnyObject.Type {
        IDerived2.self
    }
}
...
open class IDerived2: IBase {
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::IDerived2" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: IDerived2.ice_staticId(), compactId: -1, last: false)
        ostr.endSlice()
        super._iceWriteImpl(to: ostr);
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_I2() -> AnyObject.Type {
        I2.self
    }
}
...
open class I2: Ice.Value {
    /// - Returns: The Slice type ID of the interface supported by this object.
    open override class func ice_staticId() -> Swift.String { "::Test::I2" }
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ostr.startSlice(typeId: I2.ice_staticId(), compactId: -1, last: true)
        ostr.endSlice()
    }
}
...
public struct SC1: Swift.Hashable, Swift.Sendable {
    public var id: Swift.String = ""
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending SC1? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
