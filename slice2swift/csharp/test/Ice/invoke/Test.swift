...
public extension MyClassPrx {
    func opOneway(context: Ice.Context? = nil) async throws {
    ...
    func opString(_ iceP_s1: Swift.String, context: Ice.Context? = nil) async throws -> (returnValue: Swift.String, s2: Swift.String) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.String, s2: Swift.String) {
    ...
    func opException(context: Ice.Context? = nil) async throws {
