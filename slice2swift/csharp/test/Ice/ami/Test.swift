...
public extension TestIntfPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func opAsyncDispatch(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "opAsyncDispatch",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opAsyncDispatchAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "opAsyncDispatch",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
    ...
    ///
    /// - returns: `Swift.Int32`
    func opWithResultAsyncDispatch(context: Ice.Context? = nil) throws -> Swift.Int32 {
        return try _impl._invoke(operation: "opWithResultAsyncDispatch",
                                 mode: .Normal,
                                 read: { istr in
                                     let iceP_returnValue: Swift.Int32 = try istr.read()
                                     return iceP_returnValue
    ...
    ///
    /// - returns: `PromiseKit.Promise<Swift.Int32>` - The result of the operation
    func opWithResultAsyncDispatchAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Int32> {
        return _impl._invokeAsync(operation: "opWithResultAsyncDispatch",
                                  mode: .Normal,
                                  read: { istr in
                                      let iceP_returnValue: Swift.Int32 = try istr.read()
                                      return iceP_returnValue
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func opWithUEAsyncDispatch(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "opWithUEAsyncDispatch",
                          mode: .Normal,
                          userException:{ ex in
                              do  {
                                  throw ex
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithUEAsyncDispatchAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "opWithUEAsyncDispatch",
                                  mode: .Normal,
                                  userException:{ ex in
                                      do  {
                                          throw ex
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "opAsyncDispatch":
            return try servant._iceD_opAsyncDispatch(incoming: request, current: current)
        case "opBatch":
        ...
        case "opWithResultAsyncDispatch":
            return try servant._iceD_opWithResultAsyncDispatch(incoming: request, current: current)
        case "opWithUE":
            return try servant._iceD_opWithUE(incoming: request, current: current)
        case "opWithUEAsyncDispatch":
            return try servant._iceD_opWithUEAsyncDispatch(incoming: request, current: current)
        case "pingBiDir":
...
public protocol TestIntf {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opAsyncDispatchAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<Swift.Int32>` - The result of the operation
    func opWithResultAsyncDispatchAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Int32>

    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func opWithUEAsyncDispatchAsync(current: Ice.Current) -> PromiseKit.Promise<Swift.Void>
...
public extension TestIntf {
    ...
    func _iceD_opAsyncDispatch(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(opAsyncDispatchAsync(current: current))
    }

    func _iceD_opWithResultAsyncDispatch(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(opWithResultAsyncDispatchAsync(current: current)) { (ostr, retVals) in
            let iceP_returnValue = retVals
            ostr.write(iceP_returnValue)
        }
    }

    func _iceD_opWithUEAsyncDispatch(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(opWithUEAsyncDispatchAsync(current: current))
    }
