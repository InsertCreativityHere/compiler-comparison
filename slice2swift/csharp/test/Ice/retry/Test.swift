...
private final class RetryPrxI: Ice.ObjectPrxI, RetryPrx, @unchecked Sendable {
...
public extension RetryPrx {
    func op(_ iceP_kill: Swift.Bool, context: Ice.Context? = nil) async throws {
    ...
    func opNotIdempotent(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "opNotIdempotent",
                                       mode: .normal,
                                       context: context)
    }

    func sleep(_ iceP_delay: Swift.Int32, context: Ice.Context? = nil) async throws {
...
public protocol Retry: Ice.Dispatcher {
...
extension Retry {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Retry, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
