...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_User_UserInfo() -> AnyObject.Type {
        UserInfo.self
    }
}
...
public extension RegistryPrx {
    func getUserInfo(_ iceP_id: Swift.String, context: Ice.Context? = nil) async throws -> UserInfo? {
        ...
        func read(istr: Ice.InputStream) throws -> sending UserInfo? {
            nonisolated(unsafe) var iceP_returnValue: UserInfo?
