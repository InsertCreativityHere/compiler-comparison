...
public extension TestIntfPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func csException(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "csException",
                          mode: .Normal,
                          context: context)
    }
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "csException":
            return try servant._iceD_csException(incoming: request, current: current)
        case "ice_id":
...
public extension TestIntf {
    ...
    func _iceD_csException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        return inS.setResultPromise(csExceptionAsync(current: current))
    }
