...
public extension TestIntfPrx {
    ...
    func csException(context: Ice.Context? = nil) async throws {
        return try await _impl._invoke(operation: "csException",
                                       mode: .normal,
                                       context: context)
    }
...
public protocol TestIntf: Ice.Dispatcher {
    ...
    func csException(current: Ice.Current) async throws
...
extension TestIntf {
    ...
    public func _iceD_csException(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        _ = try request.inputStream.skipEmptyEncapsulation()
        try await self.csException(current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
