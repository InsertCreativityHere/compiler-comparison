...
public struct NVHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending NV {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NV? {
...
public struct NRHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NR {
        let sz = try Swift.Int(istr.readSize())
        var v = NR()
        for _ in 0 ..< sz {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NR? {
...
public struct NDVHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDV {
        let sz = try Swift.Int(istr.readSize())
        var v = NDV()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDV? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct NDRHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDR {
        let sz = try Swift.Int(istr.readSize())
        var v = NDR()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDR? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct NDAISHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDAIS {
        let sz = try Swift.Int(istr.readSize())
        var v = NDAIS()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDAIS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct NDGISHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDGIS {
        let sz = try Swift.Int(istr.readSize())
        var v = NDGIS()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDGIS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct NDASSHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDASS {
        let sz = try Swift.Int(istr.readSize())
        var v = NDASS()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDASS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct NDGSSHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NDGSS {
        let sz = try Swift.Int(istr.readSize())
        var v = NDGSS()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NDGSS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension MyClassPrx {
    ...
    func opNV(_ iceP_i: NV, context: Ice.Context? = nil) async throws -> (returnValue: NV, o: NV) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NV, o: NV) {
    ...
    func opNR(_ iceP_i: NR, context: Ice.Context? = nil) async throws -> (returnValue: NR, o: NR) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NR, o: NR) {
    ...
    func opNDV(_ iceP_i: NDV, context: Ice.Context? = nil) async throws -> (returnValue: NDV, o: NDV) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDV, o: NDV) {
    ...
    func opNDR(_ iceP_i: NDR, context: Ice.Context? = nil) async throws -> (returnValue: NDR, o: NDR) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDR, o: NDR) {
    ...
    func opNDAIS(_ iceP_i: NDAIS, context: Ice.Context? = nil) async throws -> (returnValue: NDAIS, o: NDAIS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDAIS, o: NDAIS) {
    ...
    func opNDGIS(_ iceP_i: NDGIS, context: Ice.Context? = nil) async throws -> (returnValue: NDGIS, o: NDGIS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDGIS, o: NDGIS) {
    ...
    func opNDASS(_ iceP_i: NDASS, context: Ice.Context? = nil) async throws -> (returnValue: NDASS, o: NDASS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDASS, o: NDASS) {
    ...
    func opNDGSS(_ iceP_i: NDGSS, context: Ice.Context? = nil) async throws -> (returnValue: NDGSS, o: NDGSS) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: NDGSS, o: NDGSS) {
