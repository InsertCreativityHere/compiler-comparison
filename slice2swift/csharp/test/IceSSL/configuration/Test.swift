...
public extension ServerPrx {
    ...
    func checkCipher(_ iceP_cipher: Swift.String, context: Ice.Context? = nil) async throws {
...
private final class PingablePrxI: Ice.ObjectPrxI, PingablePrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public protocol Pingable: Ice.Dispatcher {
...
extension Server {
    ...
    public static func dispatch(_ servant: Server, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "checkCipher":
            try await servant._iceD_checkCipher(request)
        case "ice_id":
    ...
    public func _iceD_checkCipher(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        try request.current.checkNonIdempotent()
        let istr = request.inputStream
        _ = try istr.startEncapsulation()
        let iceP_cipher: Swift.String = try istr.read()
        try await self.checkCipher(cipher: iceP_cipher, current: request.current)
        return request.current.makeEmptyOutgoingResponse()
    }
}
...
extension Pingable {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<PingableTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Pingable, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "ping":
