...
private final class DelayedTestIntfPrxI: Ice.ObjectPrxI, DelayedTestIntfPrx, @unchecked Sendable {
...
private final class TestIntfBidirPrxI: Ice.ObjectPrxI, TestIntfBidirPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TestIntfBidirPrx {
    func makeSleep(aborted iceP_aborted: Swift.Bool, ms iceP_ms: Swift.Int32, target iceP_target: DelayedTestIntfPrx?, context: Ice.Context? = nil) async throws {
...
public protocol DelayedTestIntf: Ice.Dispatcher {
...
public protocol TestIntfBidir: Ice.Dispatcher {
...
extension DelayedTestIntf {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<DelayedTestIntfTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: DelayedTestIntf, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension TestIntfBidir {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TestIntfBidirTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TestIntfBidir, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "makeSleep":
