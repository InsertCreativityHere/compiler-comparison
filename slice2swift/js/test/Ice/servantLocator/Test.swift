...
public extension TestIntfPrx {
    ...
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func jsException(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "jsException",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func jsExceptionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "jsException",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
...
public struct TestIntfDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "jsException":
            return try servant._iceD_jsException(incoming: request, current: current)
        case "localException":
...
public extension TestIntf {
    ...
    func _iceD_jsException(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.jsException(current: current)
