...
public enum ByteEnum: Swift.UInt8, Swift.Sendable {
    case benum1 = 0
    case benum2 = 1
    case benum3 = 10
    case benum4 = 11
...
public enum ShortEnum: Swift.Int32, Swift.Sendable {
    case senum1 = 3
    case senum2 = 4
    case senum3 = 10
    case senum4 = 11
...
public enum IntEnum: Swift.Int32, Swift.Sendable {
    case ienum1 = 0
    case ienum2 = 1
    case ienum3 = 10
    case ienum4 = 11
...
public enum SimpleEnum: Swift.UInt8, Swift.Sendable {
    case red = 0
    case green = 1
    case blue = 2
    public init() {
...
public extension TestIntfPrx {
    func opByte(_ iceP_b1: ByteEnum, context: Ice.Context? = nil) async throws -> (returnValue: ByteEnum, b2: ByteEnum) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ByteEnum, b2: ByteEnum) {
    ...
    func opShort(_ iceP_s1: ShortEnum, context: Ice.Context? = nil) async throws -> (returnValue: ShortEnum, s2: ShortEnum) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: ShortEnum, s2: ShortEnum) {
    ...
    func opInt(_ iceP_i1: IntEnum, context: Ice.Context? = nil) async throws -> (returnValue: IntEnum, i2: IntEnum) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: IntEnum, i2: IntEnum) {
    ...
    func opSimple(_ iceP_s1: SimpleEnum, context: Ice.Context? = nil) async throws -> (returnValue: SimpleEnum, s2: SimpleEnum) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: SimpleEnum, s2: SimpleEnum) {
