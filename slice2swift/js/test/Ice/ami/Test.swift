...
public extension TestIntfPrx {
    ...
    ///
    /// - returns: `` - The result of the operation
    func pingBidDirAsync(_ iceP_id: Ice.Identity, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) async throws -> Swift.Void {
        return try await _impl._invokeAsync(operation: "pingBidDir",
                                            mode: .Normal,
                                            write: { ostr in
                                                ostr.write(iceP_id)
                                            },
