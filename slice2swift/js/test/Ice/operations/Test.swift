...
public typealias WStringS = [Swift.String]
...
public extension MyClassPrx {
    ...
    func opWStringLiterals(context: Ice.Context? = nil) async throws -> WStringS {
        return try await _impl._invoke(operation: "opWStringLiterals",
                                       mode: .normal,
                                       read: { istr in
                                           let iceP_returnValue: WStringS = try istr.read()
                                           return iceP_returnValue
                                       },
                                       context: context)
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Test_MyClass1() -> AnyObject.Type {
        MyClass1.self
    }
}
...
public struct MyClassDisp: Ice.Dispatcher {
    ...
    public func dispatch(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        case "opWStringLiterals":
            try await servant._iceD_opWStringLiterals(request)
        case "opMStruct1":
...
public protocol MyClass {
    ...
    func opWStringLiterals(current: Ice.Current) async throws -> WStringS
