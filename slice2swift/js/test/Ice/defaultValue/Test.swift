...
public struct Struct3: Swift.Sendable {
    public var boolFalse: Swift.Bool = false
    public var boolTrue: Swift.Bool = true
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending Struct3 {
        var v = Struct3()
        v.boolFalse = try self.read()
        v.boolTrue = try self.read()
        v.b = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending Struct3? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
open class Base: Ice.Value {
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo \\ \"bar\n \r\n\t\u{000b}\u{000c}\u{0007}\u{0008}?", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0) {
        self.boolFalse = boolFalse
        self.boolTrue = boolTrue
        self.b = b
        self.s = s
...
open class Derived: Base {
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo \\ \"bar\n \r\n\t\u{000b}\u{000c}\u{0007}\u{0008}?", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0, c1: Color = Color.red, c2: Color = Color.green, c3: Color = Color.blue, nc1: NestedColor = NestedColor.red, nc2: NestedColor = NestedColor.green, nc3: NestedColor = NestedColor.blue) {
        self.c1 = c1
        self.c2 = c2
        self.c3 = c3
        self.nc1 = nc1
...
open class DerivedEx: BaseEx, @unchecked Sendable {
    ...
    public init(boolFalse: Swift.Bool = false, boolTrue: Swift.Bool = true, b: Swift.UInt8 = 1, s: Swift.Int16 = 2, i: Swift.Int32 = 3, l: Swift.Int64 = 4, f: Swift.Float = 5.1, d: Swift.Double = 6.2, str: Swift.String = "foo \\ \"bar\n \r\n\t\u{000b}\u{000c}\u{0007}\u{0008}?", noDefault: Swift.String, zeroI: Swift.Int32 = 0, zeroL: Swift.Int64 = 0, zeroF: Swift.Float = 0, zeroDotF: Swift.Float = 0, zeroD: Swift.Double = 0, zeroDotD: Swift.Double = 0, c1: Color = ConstColor1, c2: Color = ConstColor2, c3: Color = ConstColor3, nc1: NestedColor = ConstNestedColor1, nc2: NestedColor = ConstNestedColor2, nc3: NestedColor = ConstNestedColor3) {
        self.c1 = c1
        self.c2 = c2
        self.c3 = c3
        self.nc1 = nc1
...
open class ClassNoDefaults: ClassNoDefaultsBase {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.dict = try IntStringDictHelper.read(from: istr)
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
