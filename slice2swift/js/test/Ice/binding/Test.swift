...
private final class RemoteObjectAdapterPrxI: Ice.ObjectPrxI, RemoteObjectAdapterPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension RemoteObjectAdapterPrx {
    ...
    func deactivate(context: Ice.Context? = nil) async throws {
...
public extension RemoteCommunicatorPrx {
    func createObjectAdapter(name iceP_name: Swift.String, endpoints iceP_endpoints: Swift.String, context: Ice.Context? = nil) async throws -> RemoteObjectAdapterPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending RemoteObjectAdapterPrx? {
            let iceP_returnValue: RemoteObjectAdapterPrx? = try istr.read(RemoteObjectAdapterPrx.self)
            return iceP_returnValue
        }
    }

    func deactivateObjectAdapter(_ iceP_adapter: RemoteObjectAdapterPrx?, context: Ice.Context? = nil) async throws {
...
public protocol RemoteObjectAdapter: Ice.Dispatcher {
...
extension RemoteObjectAdapter {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<RemoteObjectAdapterTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: RemoteObjectAdapter, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "getTestIntf":
