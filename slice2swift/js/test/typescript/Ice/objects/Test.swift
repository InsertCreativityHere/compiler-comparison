...
public struct JDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        ...
        case "doI":
            return try servant._iceD_doI(incoming: request, current: current)
        case "doJ":
            return try servant._iceD_doJ(incoming: request, current: current)
        case "ice_id":
...
///  - doI: 
public extension I {
    func _iceD_doI(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()

        try self.doI(current: current)
...
///  - doJ: 
public extension J {
    func _iceD_doJ(incoming inS: Ice.Incoming, current: Ice.Current) throws -> PromiseKit.Promise<Ice.OutputStream>? {
        try inS.readEmptyParams()
