...
public extension IPrx {
    ...
    func doI(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "doI",
                          mode: .Normal,
                          context: context)
    }
    ...
    func doIAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "doI",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
...
public extension JPrx {
    ///
    /// - parameter context: `Ice.Context` - Optional request context.
    func doJ(context: Ice.Context? = nil) throws {
        try _impl._invoke(operation: "doJ",
                          mode: .Normal,
                          context: context)
    }
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func doJAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = nil, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
        return _impl._invokeAsync(operation: "doJ",
                                  mode: .Normal,
                                  context: context,
                                  sentOn: sentOn,
                                  sentFlags: sentFlags,
...
public protocol I {
    ...
    func doI(current: Ice.Current) throws
}
...
public protocol J: I {
    ///
    /// - parameter current: `Ice.Current` - The Current object for the dispatch.
    func doJ(current: Ice.Current) throws
}
...
///  - doI: 
extension I {
    public func _iceD_doI(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            _ = try request.inputStream.skipEmptyEncapsulation()

            try self.doI(current: request.current)
...
///  - doJ: 
extension J {
    public func _iceD_doJ(_ request: Ice.IncomingRequest) -> PromiseKit.Promise<Ice.OutgoingResponse> {
        do {
            _ = try request.inputStream.skipEmptyEncapsulation()

            try self.doJ(current: request.current)
            return PromiseKit.Promise.value(request.current.makeEmptyOutgoingResponse())
        } catch {
            return PromiseKit.Promise(error: error)
        }
