...
public struct break: Swift.Hashable {
    ...
    public init(while: Swift.Int32, constructor: Swift.String) {
        self.while = while
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_await_delete() -> AnyObject.Type {
        delete.self
    }
}
...
open class delete: Ice.Value {
    ...
    public init(else: casePrx?, export: Swift.Int32, clone: Swift.String) {
        self.else = else
        self.export = export
        self.clone = clone
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_await_fixed() -> AnyObject.Type {
        fixed.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_await_foreach() -> AnyObject.Type {
        foreach.self
    }
}
...
public extension explicitPrx {
    func in(internal iceP_internal: break, new iceP_new: typeofPrx?, null iceP_null: delete?, override iceP_override: Swift.Int32, context: Ice.Context? = nil) async throws -> var {
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_await_package() -> AnyObject.Type {
        package.self
    }
}
...
open class package: Ice.Value {
    ...
    public init(for: break?, goto: var?, null: explicitPrx?, internal: while?, debugger: Swift.String?) {
        self.for = for
        self.goto = goto
        self.null = null
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        self.null = try istr.read(tag: 3, type: explicitPrx.self)
    ...
    open override func _iceWriteImpl(to ostr: Ice.OutputStream) {
        ...
        ostr.write(tag: 3, value: self.null)
...
public extension optionalParamsPrx {
    func in(goto iceP_goto: var? = nil, if iceP_if: explicitPrx? = nil, internal iceP_internal: while? = nil, context: Ice.Context? = nil) async throws -> (returnValue: break?, namespace: Swift.String?, null: explicitPrx?) {
        return try await _impl._invoke(operation: "in",
                                       mode: .normal,
                                       write: { ostr in
                                       ...
                                       read: { istr in
                                           ...
                                           return (iceP_returnValue, iceP_namespace, iceP_null)
                                       },
                                       context: context)
    }

    func continue(goto iceP_goto: var? = nil, if iceP_if: explicitPrx? = nil, internal iceP_internal: while? = nil, context: Ice.Context? = nil) async throws -> (returnValue: break?, namespace: Swift.String?, null: explicitPrx?) {
...
public protocol explicit: typeof, case {
    func in(internal: break, new: typeofPrx?, null: delete?, override: Swift.Int32, current: Ice.Current) async throws -> var
}
...
public protocol optionalParams {
    func in(goto: var?, if: explicitPrx?, internal: while?, current: Ice.Current) async throws -> (returnValue: break?, namespace: Swift.String?, null: explicitPrx?)

    func continue(goto: var?, if: explicitPrx?, internal: while?, current: Ice.Current) async throws -> (returnValue: break?, namespace: Swift.String?, null: explicitPrx?)
}
...
extension explicit {
    public func _iceD_in(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let result = try await self.in(internal: iceP_internal, new: iceP_new, null: iceP_null, override: iceP_override, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
...
extension optionalParams {
    public func _iceD_in(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let result = try await self.in(goto: iceP_goto, if: iceP_if, internal: iceP_internal, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_namespace, iceP_null) = value
    ...
    public func _iceD_continue(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        let iceP_if: explicitPrx? = try istr.read(tag: 3, type: explicitPrx.self)
        let iceP_internal: while? = try whileHelper.read(from: istr, tag: 5)
        let result = try await self.continue(goto: iceP_goto, if: iceP_if, internal: iceP_internal, current: request.current)
        return request.current.makeOutgoingResponse(result, formatType: nil) { ostr, value in 
            let (iceP_returnValue, iceP_namespace, iceP_null) = value
            ostr.write(tag: 1, value: iceP_returnValue)
            ostr.write(tag: 7, value: iceP_namespace)
