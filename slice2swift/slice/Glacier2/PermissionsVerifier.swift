...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_Glacier2_PermissionDeniedException() -> AnyObject.Type {
...
private final class PermissionsVerifierPrxI: Ice.ObjectPrxI, PermissionsVerifierPrx, @unchecked Sendable {
...
public extension PermissionsVerifierPrx {
    ...
    ///
    /// - Throws:
    ///   - PermissionDeniedException Thrown when the user access is denied. This exception can be thrown
    ...
    func checkPermissions(userId iceP_userId: Swift.String, password iceP_password: Swift.String, context: Ice.Context? = nil) async throws -> (returnValue: Swift.Bool, reason: Swift.String) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: Swift.Bool, reason: Swift.String) {
...
private final class SSLPermissionsVerifierPrxI: Ice.ObjectPrxI, SSLPermissionsVerifierPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
/// Represents an object that checks user permissions. The Glacier2 router and other services use a
/// ``PermissionsVerifierPrx`` proxy when the user is authenticated using a user ID and password.
public protocol PermissionsVerifier: Ice.Dispatcher {
    /// Checks if a user is authorized to establish a session.
    ///
    /// - Parameters:
    ///   - userId: The user ID.
...
/// Represents an object that checks user permissions. The Glacier2 router and other services use an
/// ``SSLPermissionsVerifierPrx`` proxy when the user is authenticated through an SSL certificate.
public protocol SSLPermissionsVerifier: Ice.Dispatcher {
    /// Checks if a user is authorized to establish a session.
    ///
    /// - Parameters:
...
extension PermissionsVerifier {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<PermissionsVerifierTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: PermissionsVerifier, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension SSLPermissionsVerifier {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<SSLPermissionsVerifierTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: SSLPermissionsVerifier, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "authorize":
