...
public struct LinkInfo: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending LinkInfo {
        var v = LinkInfo()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending LinkInfo? {
...
public struct LinkInfoSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending LinkInfoSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending LinkInfoSeq? {
...
public struct QoSHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending QoS {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending QoS? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
private final class TopicPrxI: Ice.ObjectPrxI, TopicPrx, @unchecked Sendable {
...
public extension TopicPrx {
    ...
    ///   - context: Optional request context.
    func unsubscribe(_ iceP_subscriber: Ice.ObjectPrx?, context: Ice.Context? = nil) async throws {
    ...
    func getLinkInfoSeq(context: Ice.Context? = nil) async throws -> LinkInfoSeq {
        ...
        func read(istr: Ice.InputStream) throws -> sending LinkInfoSeq {
...
public struct TopicDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending TopicDict {
        let sz = try Swift.Int(istr.readSize())
        var v = TopicDict()
        for _ in 0 ..< sz {
            let key: Swift.String = try istr.read()
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending TopicDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
private final class TopicManagerPrxI: Ice.ObjectPrxI, TopicManagerPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension TopicManagerPrx {
    ...
    func create(_ iceP_name: Swift.String, context: Ice.Context? = nil) async throws -> TopicPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending TopicPrx? {
    ...
    func retrieveAll(context: Ice.Context? = nil) async throws -> TopicDict {
        ...
        func read(istr: Ice.InputStream) throws -> sending TopicDict {
...
///
/// FinderPrx Methods:
///  - getTopicManager: Gets a proxy to the associated ``TopicManagerPrx``.
///  - getTopicManagerAsync: Gets a proxy to the associated ``TopicManagerPrx``.
public protocol FinderPrx: Ice.ObjectPrx {}

private final class FinderPrxI: Ice.ObjectPrxI, FinderPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension FinderPrx {
    ...
    func getTopicManager(context: Ice.Context? = nil) async throws -> TopicManagerPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending TopicManagerPrx? {
...
/// Represents an IceStorm topic. Publishers publish data to a topic (via the topic's publisher object), and
/// subscribers subscribe to a topic.
public protocol Topic: Ice.Dispatcher {
    /// Gets the name of this topic.
    ///
...
/// Represents an object that manages topics.
public protocol TopicManager: Ice.Dispatcher {
    /// Creates a new topic.
    ///
    /// - Parameters:
...
/// Finder proxy `IceStorm/Finder:tcp -h somehost -p 4061` to get the TopicManager proxy
/// `MyIceStorm/TopicManager:tcp -h somehost -p 4061`.
public protocol Finder: Ice.Dispatcher {
    /// Gets a proxy to the associated ``TopicManagerPrx``. The proxy might point to several replicas.
    ///
    /// - Parameter current: The Current object for the dispatch.
    ///
...
extension Topic {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Topic, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension TopicManager {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<TopicManagerTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: TopicManager, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "create":
...
extension Finder {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<FinderTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Finder, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
