...
///  - foundLocator: Provides a reply to a ``LookupPrx/findLocator(instanceName:reply:context:)`` request.
///  - foundLocatorAsync: Provides a reply to a ``LookupPrx/findLocator(instanceName:reply:context:)`` request.
...
public extension LookupReplyPrx {
    /// Provides a reply to a ``LookupPrx/findLocator(instanceName:reply:context:)`` request.
    ///
    /// - Parameters:
    ///   - iceP_prx: The proxy of the locator.
    ///   - context: Optional request context.
    func foundLocator(_ iceP_prx: Ice.LocatorPrx?, context: Ice.Context? = nil) async throws {
...
public extension LookupPrx {
    ...
    ///   - context: Optional request context.
    func findLocator(instanceName iceP_instanceName: Swift.String, reply iceP_reply: LookupReplyPrx?, context: Ice.Context? = nil) async throws {
