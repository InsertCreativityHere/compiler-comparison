...
/// proxy to this object with the locator registry. See ``LocatorRegistryPrx/setServerProcessProxy(id:proxy:context:)``.
///
/// ProcessPrx Methods:
...
internal final class ProcessPrxI: ObjectPrxI, ProcessPrx, @unchecked Sendable {
...
public extension ProcessPrx {
    ...
    func shutdown(context: Context? = nil) async throws {
    ...
    func writeMessage(message iceP_message: Swift.String, fd iceP_fd: Swift.Int32, context: Context? = nil) async throws {
...
/// A server application managed by a locator implementation such as IceGrid hosts a Process object and registers a
/// proxy to this object with the locator registry. See ``LocatorRegistryPrx/setServerProcessProxy(id:proxy:context:)``.
public protocol Process: Dispatcher {
    /// Initiates a graceful shutdown of the server application.
    ///
...
extension Process {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Process, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
