...
public struct ObjectSeqHelper {
    ...
    public static func read(from istr: InputStream) throws -> sending ObjectSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ObjectSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending ObjectSeq? {
...
public struct ObjectProxySeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream) throws -> sending ObjectProxySeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending ObjectProxySeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
