...
public struct PropertyDictHelper {
    ...
    public static func read(from istr: InputStream) throws -> sending PropertyDict {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending PropertyDict? {
