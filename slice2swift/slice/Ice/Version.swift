...
public struct ProtocolVersion: Swift.Hashable, Swift.Sendable {
...
public extension InputStream {
    ...
    func read() throws -> sending ProtocolVersion {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ProtocolVersion? {
...
public struct EncodingVersion: Swift.Hashable, Swift.Sendable {
...
public extension InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending EncodingVersion {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending EncodingVersion? {
        guard try readOptional(tag: tag, expectedFormat: .VSize) else {
            return nil
        }
        try skipSize()
