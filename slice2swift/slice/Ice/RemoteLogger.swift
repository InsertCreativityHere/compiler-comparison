...
public struct LogMessage: Swift.Hashable {
    ...
    /// The date and time when the `RemoteLogger` received this message, expressed as the number of
...
public extension RemoteLoggerPrx {
    ...
    func initialize(prefix iceP_prefix: Swift.String, logMessages iceP_logMessages: LogMessageSeq, context: Context? = nil) async throws -> Swift.Void {
...
/// Represents the admin facet that allows an Ice application the attach its `RemoteLogger` to the local
