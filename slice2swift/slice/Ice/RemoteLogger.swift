...
public enum LogMessageType: Swift.UInt8, Swift.Sendable {
    /// The ``RemoteLoggerPrx`` received a print message.
    case printMessage = 0
    /// The ``RemoteLoggerPrx`` received a trace message.
    case traceMessage = 1
    /// The ``RemoteLoggerPrx`` received a warning message.
    case warningMessage = 2
    /// The ``RemoteLoggerPrx`` received an error message.
    case errorMessage = 3
    public init() {
        self = .printMessage
    }
...
public struct LogMessageTypeSeqHelper {
    ...
    public static func read(from istr: InputStream) throws -> sending LogMessageTypeSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending LogMessageTypeSeq? {
...
public struct LogMessage: Swift.Hashable, Swift.Sendable {
    /// The type of message sent to the ``RemoteLoggerPrx``.
    public var type: LogMessageType = .printMessage
    /// The date and time when the ``RemoteLoggerPrx`` received this message, expressed as the number of
...
public extension InputStream {
    ...
    func read() throws -> sending LogMessage {
        var v = LogMessage()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending LogMessage? {
...
public struct LogMessageSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream) throws -> sending LogMessageSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending LogMessageSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
///  - initialize: Attaches a remote logger to the local logger.
///  - initializeAsync: Attaches a remote logger to the local logger.
///  - log: Logs a LogMessage.
///  - logAsync: Logs a LogMessage.
public protocol RemoteLoggerPrx: ObjectPrx {}

internal final class RemoteLoggerPrxI: ObjectPrxI, RemoteLoggerPrx, @unchecked Sendable {
...
public extension RemoteLoggerPrx {
    ...
    func initialize(prefix iceP_prefix: Swift.String, logMessages iceP_logMessages: LogMessageSeq, context: Context? = nil) async throws {
    ...
    ///
    /// ## Remarks
    /// ``RemoteLoggerPrx/log(_:context:)`` may be called by ``LoggerAdminPrx`` before ``RemoteLoggerPrx/initialize(prefix:logMessages:context:)``.
    func log(_ iceP_message: LogMessage, context: Context? = nil) async throws {
...
public extension DefaultSliceLoader {
    @objc static func resolveTypeId_Ice_RemoteLoggerAlreadyAttachedException() -> AnyObject.Type {
        RemoteLoggerAlreadyAttachedException.self
    }
}
...
internal final class LoggerAdminPrxI: ObjectPrxI, LoggerAdminPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension LoggerAdminPrx {
    ...
    ///
    /// - Throws:
    ///   - RemoteLoggerAlreadyAttachedException Thrown if this remote logger is already attached to this admin
    ///     object.
    func attachRemoteLogger(prx iceP_prx: RemoteLoggerPrx?, messageTypes iceP_messageTypes: LogMessageTypeSeq, traceCategories iceP_traceCategories: StringSeq, messageMax iceP_messageMax: Swift.Int32, context: Context? = nil) async throws {
    ...
    func getLog(messageTypes iceP_messageTypes: LogMessageTypeSeq, traceCategories iceP_traceCategories: StringSeq, messageMax iceP_messageMax: Swift.Int32, context: Context? = nil) async throws -> (returnValue: LogMessageSeq, prefix: Swift.String) {
        ...
        func read(istr: Ice.InputStream) throws -> sending (returnValue: LogMessageSeq, prefix: Swift.String) {
...
/// Represents an Ice object that accepts log messages. It's called by the implementation of ``LoggerAdminPrx``.
public protocol RemoteLogger: Dispatcher {
    /// Attaches a remote logger to the local logger.
    ///
    /// - Parameters:
    ///   - prefix: The prefix of the associated local Logger.
    ...
    func initialize(prefix: Swift.String, logMessages: LogMessageSeq, current: Current) async throws
...
extension RemoteLogger {
    private static var defaultObject: Object {
        DefaultObject<RemoteLoggerTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: RemoteLogger, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "init":
            try await servant._iceD_initialize(request)
        case "log":
    ...
    public func _iceD_initialize(_ request: Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        ...
        try await self.initialize(prefix: iceP_prefix, logMessages: iceP_logMessages, current: request.current)
...
extension LoggerAdmin {
    private static var defaultObject: Object {
        DefaultObject<LoggerAdminTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: LoggerAdmin, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
