...
internal final class PropertiesAdminPrxI: ObjectPrxI, PropertiesAdminPrx, @unchecked Sendable {
...
public extension PropertiesAdminPrx {
    ...
    func getPropertiesForPrefix(_ iceP_prefix: Swift.String, context: Context? = nil) async throws -> PropertyDict {
        ...
        func read(istr: Ice.InputStream) throws -> sending PropertyDict {
    ...
    ///   - context: Optional request context.
    func setProperties(_ iceP_newProperties: PropertyDict, context: Context? = nil) async throws {
...
/// Provides remote access to the properties of a communicator.
public protocol PropertiesAdmin: Dispatcher {
    /// Gets a property by key.
    ///
    /// - Parameters:
...
extension PropertiesAdmin {
    private static var defaultObject: Object {
        DefaultObject<PropertiesAdminTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: PropertiesAdmin, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
