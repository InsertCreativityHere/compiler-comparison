...
public struct ContextHelper {
    ...
    public static func read(from istr: InputStream) throws -> sending Context {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: InputStream, tag: Swift.Int32) throws -> sending Context? {
