...
public enum SampleEvent: Swift.UInt8, Swift.Sendable {
...
public struct SampleEventSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending SampleEventSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending SampleEventSeq? {
