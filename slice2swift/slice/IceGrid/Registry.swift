...
public enum LoadSample: Swift.UInt8, Swift.Sendable {
    /// Sample every minute.
    case loadSample1 = 0
...
private final class QueryPrxI: Ice.ObjectPrxI, QueryPrx, @unchecked Sendable {
...
public extension QueryPrx {
    ...
    func findAllObjectsByType(_ iceP_type: Swift.String, context: Ice.Context? = nil) async throws -> Ice.ObjectProxySeq {
        ...
        func read(istr: Ice.InputStream) throws -> sending Ice.ObjectProxySeq {
...
private final class RegistryPrxI: Ice.ObjectPrxI, RegistryPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension RegistryPrx {
    ...
    func createAdminSession(userId iceP_userId: Swift.String, password iceP_password: Swift.String, context: Ice.Context? = nil) async throws -> AdminSessionPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending AdminSessionPrx? {
    ...
    /// send heartbeats (using ACM) or call ``SessionPrx/keepAlive(context:)`` (resp. ``AdminSessionPrx/keepAlive(context:)``) to keep
...
private final class LocatorPrxI: Ice.ObjectPrxI, LocatorPrx, @unchecked Sendable {
    public override class func ice_staticId() -> Swift.String {
...
public extension LocatorPrx {
    ...
    func getLocalRegistry(context: Ice.Context? = nil) async throws -> RegistryPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending RegistryPrx? {
    ...
    func getLocalQuery(context: Ice.Context? = nil) async throws -> QueryPrx? {
        ...
        func read(istr: Ice.InputStream) throws -> sending QueryPrx? {
...
/// Finds well-known Ice objects registered with the IceGrid registry.
public protocol Query: Ice.Dispatcher {
    /// Finds a well-known object by identity.
    ///
    /// - Parameters:
    ///   - id: The identity.
...
/// Represents the main entry point into the IceGrid registry service. It provides operations to create sessions
/// with the registry.
public protocol Registry: Ice.Dispatcher {
    /// Creates a client session.
    ///
    /// - Parameters:
    ///   - userId: The user ID.
...
extension Query {
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Query, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
...
extension Registry {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<RegistryTraits>()
    }
    ...
    ///   - request: The incoming request.
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: Registry, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
        switch request.current.operation {
        case "createSession":
...
extension Locator {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<LocatorTraits>()
    }
