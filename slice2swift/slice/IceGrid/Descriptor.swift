...
public struct PropertyDescriptor: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    func read() throws -> sending PropertyDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending PropertyDescriptor? {
...
public struct PropertyDescriptorSeqHelper {
    ...
    public static func read(from istr: Ice.InputStream) throws -> sending PropertyDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending PropertyDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct PropertySetDescriptor: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending PropertySetDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending PropertySetDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct PropertySetDescriptorDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending PropertySetDescriptorDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending PropertySetDescriptorDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ObjectDescriptor: Swift.Hashable, Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ObjectDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ObjectDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ObjectDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ObjectDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ObjectDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct AdapterDescriptor: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending AdapterDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending AdapterDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct AdapterDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending AdapterDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending AdapterDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_CommunicatorDescriptor() -> AnyObject.Type {
        CommunicatorDescriptor.self
    }
}
...
open class CommunicatorDescriptor: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.adapters = try AdapterDescriptorSeqHelper.read(from: istr)
        iceP_self.propertySet = try istr.read()
        iceP_self.logs = try istr.read()
        iceP_self.description = try istr.read()
        try istr.endSlice()
    }
...
public struct DistributionDescriptor: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending DistributionDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending DistributionDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_ServerDescriptor() -> AnyObject.Type {
...
open class ServerDescriptor: CommunicatorDescriptor {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        ...
        iceP_self.iceVersion = try istr.read()
        ...
        iceP_self.applicationDistrib = try istr.read()
        iceP_self.distrib = try istr.read()
        iceP_self.allocatable = try istr.read()
...
public struct ServerDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ServerDescriptorSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ServerDescriptorSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ServerDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_ServiceDescriptor() -> AnyObject.Type {
...
public struct ServiceDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ServiceDescriptorSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 1)
        nonisolated(unsafe) var v = ServiceDescriptorSeq(repeating: nil, count: sz)
        for i in 0 ..< sz {
            try Swift.withUnsafeMutablePointer(to: &v[i]) { p in
                nonisolated(unsafe) let p = p
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ServiceDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public struct ServerInstanceDescriptor: Swift.Sendable {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ServerInstanceDescriptor {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ServerInstanceDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ServerInstanceDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ServerInstanceDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ServerInstanceDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending TemplateDescriptor {
        nonisolated(unsafe) let v = TemplateDescriptor()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending TemplateDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct TemplateDescriptorDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending TemplateDescriptorDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending TemplateDescriptorDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ServiceInstanceDescriptor {
        nonisolated(unsafe) let v = ServiceInstanceDescriptor()
        v.template = try self.read()
        v.parameterValues = try StringStringDictHelper.read(from: self)
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ServiceInstanceDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ServiceInstanceDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ServiceInstanceDescriptorSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 5)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ServiceInstanceDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_IceBoxDescriptor() -> AnyObject.Type {
        IceBoxDescriptor.self
    }
}
...
open class IceBoxDescriptor: ServerDescriptor {
    ...
    public init(adapters: AdapterDescriptorSeq, propertySet: PropertySetDescriptor, logs: Ice.StringSeq, description: Swift.String, id: Swift.String, exe: Swift.String, iceVersion: Swift.String, pwd: Swift.String, options: Ice.StringSeq, envs: Ice.StringSeq, activation: Swift.String, activationTimeout: Swift.String, deactivationTimeout: Swift.String, applicationDistrib: Swift.Bool = false, distrib: DistributionDescriptor, allocatable: Swift.Bool, user: Swift.String, services: ServiceInstanceDescriptorSeq) {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.services = try ServiceInstanceDescriptorSeqHelper.read(from: istr)
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending NodeDescriptor {
        nonisolated(unsafe) let v = NodeDescriptor()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending NodeDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct NodeDescriptorDictHelper {
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NodeDescriptorDict {
        let sz = try Swift.Int(istr.readSize())
    ...
    ///
    /// - Returns: The dictionary read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NodeDescriptorDict? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_LoadBalancingPolicy() -> AnyObject.Type {
        LoadBalancingPolicy.self
    }
}
...
open class LoadBalancingPolicy: Ice.Value {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.nReplicas = try istr.read()
        try istr.endSlice()
    }
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_RandomLoadBalancingPolicy() -> AnyObject.Type {
        RandomLoadBalancingPolicy.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_OrderedLoadBalancingPolicy() -> AnyObject.Type {
        OrderedLoadBalancingPolicy.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_RoundRobinLoadBalancingPolicy() -> AnyObject.Type {
        RoundRobinLoadBalancingPolicy.self
    }
}
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_AdaptiveLoadBalancingPolicy() -> AnyObject.Type {
        AdaptiveLoadBalancingPolicy.self
    }
}
...
open class AdaptiveLoadBalancingPolicy: LoadBalancingPolicy {
    ...
    open override func _iceReadImpl(from istr: Ice.InputStream) throws {
        _ = try istr.startSlice()
        nonisolated(unsafe) let iceP_self = self
        iceP_self.loadSample = try istr.read()
        try istr.endSlice()
        try super._iceReadImpl(from: istr);
    }
...
public final class ReplicaGroupDescriptor {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ReplicaGroupDescriptor {
        nonisolated(unsafe) let v = ReplicaGroupDescriptor()
        v.id = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ReplicaGroupDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ReplicaGroupDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ReplicaGroupDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ReplicaGroupDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ApplicationDescriptor {
        nonisolated(unsafe) let v = ApplicationDescriptor()
        v.name = try self.read()
        v.variables = try StringStringDictHelper.read(from: self)
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ApplicationDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct ApplicationDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending ApplicationDescriptorSeq {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending ApplicationDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_BoxedString() -> AnyObject.Type {
        BoxedString.self
    }
}
...
public final class NodeUpdateDescriptor {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending NodeUpdateDescriptor {
        nonisolated(unsafe) let v = NodeUpdateDescriptor()
        v.name = try self.read()
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending NodeUpdateDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
...
public struct NodeUpdateDescriptorSeqHelper {
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream) throws -> sending NodeUpdateDescriptorSeq {
        let sz = try istr.readAndCheckSeqSize(minSize: 10)
    ...
    ///
    /// - Returns: The sequence read from the stream.
    public static func read(from istr: Ice.InputStream, tag: Swift.Int32) throws -> sending NodeUpdateDescriptorSeq? {
        guard try istr.readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try istr.skip(4)
...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_BoxedDistributionDescriptor() -> AnyObject.Type {
        BoxedDistributionDescriptor.self
    }
}
...
public final class ApplicationUpdateDescriptor {
...
public extension Ice.InputStream {
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read() throws -> sending ApplicationUpdateDescriptor {
        nonisolated(unsafe) let v = ApplicationUpdateDescriptor()
        v.name = try self.read()
        try self.read(BoxedString.self) { v.description = $0 }
    ...
    ///
    /// - Returns: The structured value read from the stream.
    func read(tag: Swift.Int32) throws -> sending ApplicationUpdateDescriptor? {
        guard try readOptional(tag: tag, expectedFormat: .FSize) else {
            return nil
        }
        try skip(4)
