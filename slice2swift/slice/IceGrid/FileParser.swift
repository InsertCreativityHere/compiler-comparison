...
public extension Ice.DefaultSliceLoader {
    @objc static func resolveTypeId_IceGrid_ParseException() -> AnyObject.Type {
        ParseException.self
    }
}
...
private final class FileParserPrxI: Ice.ObjectPrxI, FileParserPrx, @unchecked Sendable {
...
public extension FileParserPrx {
    ...
    ///
    /// - Parameters:
    ///   - iceP_xmlFile: The full path to the file.
...
/// `icegridadmin` provides a ``FileParserPrx`` object to transform XML files into ``ApplicationDescriptor``
/// objects.
public protocol FileParser: Ice.Dispatcher {
    /// Parses a file.
    ///
    /// - Parameters:
...
extension FileParser {
    private static var defaultObject: Ice.Object {
        Ice.DefaultObject<FileParserTraits>()
    }
    ...
    /// - Returns: The outgoing response.
    public static func dispatch(_ servant: FileParser, request: sending Ice.IncomingRequest) async throws -> Ice.OutgoingResponse {
