...
Test.StructNoDefaults = class {
    constructor(bo = false, b = 0, s = 0, i = 0, l = 0n, f = 0.0, d = 0.0, str = "", c1 = Test.Color.red, bs = null, iseq = null, isDict = null, st = new Test.InnerStruct()) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
...
Test.ExceptionNoDefaults = class extends Test.ExceptionNoDefaultsBase {
    constructor(str, c1, bs, st = new Test.InnerStruct(), isDict = null) {
        super(str, c1, bs);
        this.st = st;
        this.isDict = isDict;
    }
