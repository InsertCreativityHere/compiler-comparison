...
Ice.defineOperations(
    ...
    iceC_Test_MA_IA_ids,
    "::Test::MA::IA", {
        "iaop": [, 0, , ["Test.MA.IAPrx"], [["Test.MA.IAPrx"]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::Test::MB::IB1", {
        "ib1op": [, 0, , ["Test.MB.IB1Prx"], [["Test.MB.IB1Prx"]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::Test::MB::IB2", {
        "ib2op": [, 0, , ["Test.MB.IB2Prx"], [["Test.MB.IB2Prx"]], , , , ]
    });
...
Ice.defineOperations(
    ...
    iceC_Test_MA_IC_ids,
    "::Test::MA::IC", {
        "icop": [, 0, , ["Test.MA.ICPrx"], [["Test.MA.ICPrx"]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::Test::Initial", {
        "shutdown": [, 0, , , , , , , ],
        "iaop": [, 0, , ["Test.MA.IAPrx"], , , , , ],
        "ib1op": [, 0, , ["Test.MB.IB1Prx"], , , , , ],
        "ib2op": [, 0, , ["Test.MB.IB2Prx"], , , , , ],
        "icop": [, 0, , ["Test.MA.ICPrx"], , , , , ]
    });
