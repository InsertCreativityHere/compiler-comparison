...
Test.IntSeqSeqHelper = Ice.StreamHelpers.generateSeqHelper(Test.IntSeqHelper, false);

Test.DerivedSeqHelper = Ice.StreamHelpers.generateSeqHelper(Ice.ObjectHelper, false, "Test.Derived");
...
Test.StructNoDefaults = class {
    constructor(bo = false, b = 0, s = 0, i = 0, l = 0n, f = 0.0, d = 0.0, str = "", c1 = Test.Color.red, bs = null, is = null, st = new Test.InnerStruct(), dict = null, derivedSeq = null, intSeqSeq = null) {
        this.bo = bo;
        this.b = b;
        this.s = s;
        this.i = i;
    ...
    _write(ostr) {
        ...
        Test.DerivedSeqHelper.write(ostr, this.derivedSeq);
        Test.IntSeqSeqHelper.write(ostr, this.intSeqSeq);
    }
    ...
    _read(istr) {
        ...
        this.derivedSeq = Test.DerivedSeqHelper.read(istr);
        this.intSeqSeq = Test.IntSeqSeqHelper.read(istr);
    }
