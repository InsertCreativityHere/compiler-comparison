...
Test.MyEnumListHelper = Ice.StreamHelpers.generateSeqHelper(Test.MyEnum._helper, false);

Test.LargeStructListHelper = Ice.StreamHelpers.generateSeqHelper(Test.LargeStruct, false);

Test.MyClassListHelper = Ice.StreamHelpers.generateSeqHelper(Ice.ObjectHelper, false, "Test.MyClass");

Test.MyInterfaceProxyListHelper = Ice.StreamHelpers.generateSeqHelper(Test.MyInterfacePrx, false);

Test.ShortLinkedListHelper = Ice.StreamHelpers.generateSeqHelper(Ice.ShortHelper, true);

Test.IntLinkedListHelper = Ice.StreamHelpers.generateSeqHelper(Ice.IntHelper, true);

Test.MyEnumLinkedListHelper = Ice.StreamHelpers.generateSeqHelper(Test.MyEnum._helper, false);

Test.LargeStructLinkedListHelper = Ice.StreamHelpers.generateSeqHelper(Test.LargeStruct, false);

Test.LongStackHelper = Ice.StreamHelpers.generateSeqHelper(Ice.LongHelper, true);

Test.FloatStackHelper = Ice.StreamHelpers.generateSeqHelper(Ice.FloatHelper, true);

Test.LargeStructStackHelper = Ice.StreamHelpers.generateSeqHelper(Test.LargeStruct, false);

Test.MyInterfaceProxyStackHelper = Ice.StreamHelpers.generateSeqHelper(Test.MyInterfacePrx, false);

Test.ObjectStackHelper = Ice.StreamHelpers.generateSeqHelper(Ice.ObjectHelper, false, "Ice.Value");

Test.MyClassStackHelper = Ice.StreamHelpers.generateSeqHelper(Ice.ObjectHelper, false, "Test.MyClass");

Test.DoubleQueueHelper = Ice.StreamHelpers.generateSeqHelper(Ice.DoubleHelper, true);

Test.StringQueueHelper = Ice.StreamHelpers.generateSeqHelper(Ice.StringHelper, false);

Test.LargeStructQueueHelper = Ice.StreamHelpers.generateSeqHelper(Test.LargeStruct, false);

Test.StringSListHelper = Ice.StreamHelpers.generateSeqHelper(Ice.StringSeqHelper, false);

Test.StringSStackHelper = Ice.StreamHelpers.generateSeqHelper(Ice.StringSeqHelper, false);

[Test.SortedStringStringD, Test.SortedStringStringDHelper] = Ice.defineDictionary(Ice.StringHelper, Ice.StringHelper, false, undefined);
