...
Ice.defineClass(Test.InvalidPointException, "::Test::InvalidPointException");
...
Ice.defineClass(Test.InvalidLengthException, "::Test::InvalidLengthException");

Test.OtherException = class extends Ice.UserException {
    constructor(x = 0, y = 0, z = 0, b = false) {
        super();
        this.x = x;
        this.y = y;
        this.z = z;
...
Ice.defineClass(Test.OtherException, "::Test::OtherException");
...
Ice.defineClass(Test.Pen, "::Test::Pen");
