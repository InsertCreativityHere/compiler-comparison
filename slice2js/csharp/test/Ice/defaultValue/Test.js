...
Test.Struct3 = class
{
    constructor(boolFalse = false, boolTrue = true, b = 1, s = 2, i = 3, l = new Ice.Long(0, 4), f = 5.1, d = 6.2, c1 = Test.Color.red, c2 = Test.Color.green, c3 = Test.Color.blue, nc1 = Test.Nested.Color.red, nc2 = Test.Nested.Color.green, nc3 = Test.Nested.Color.blue, zeroI = 0, zeroL = new Ice.Long(0, 0), zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0)
    {
        this.boolFalse = boolFalse;
        this.boolTrue = boolTrue;
        this.b = b;
...
{
    constructor(boolFalse = false, boolTrue = true, b = 1, s = 2, i = 3, l = new Ice.Long(0, 4), f = 5.1, d = 6.2, str = "foo bar", noDefault = "", zeroI = 0, zeroL = new Ice.Long(0, 0), zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0)
    {
        super();
        this.boolFalse = boolFalse;
        this.boolTrue = boolTrue;
...
Ice.defineValue(Test.ClassProperty, "::Test::ClassProperty");
...
{
    constructor(boolFalse = false, boolTrue = true, b = 1, s = 2, i = 3, l = new Ice.Long(0, 4), f = 5.1, d = 6.2, str = "foo bar", noDefault = "", zeroI = 0, zeroL = new Ice.Long(0, 0), zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0, _cause = "")
    {
        super(_cause);
        this.boolFalse = boolFalse;
        this.boolTrue = boolTrue;
...
{
    constructor(bo = false, b = 0, s = 0, i = 0, l = new Ice.Long(0, 0), f = 0.0, d = 0.0, str = "", c1 = Test.Color.red, bs = null, iseq = null, st = new Test.InnerStruct(), st2 = new Test.InnerStruct2(), dict = null)
    {
        this.bo = bo;
        this.b = b;
        this.s = s;
