...
(function(module, require, exports)
{
    ...
    Slice.defineSequence(Test, "StructSHelper", "Test.Structure", false);

    Test.Struct2 = class
    {
        constructor(b = false, i = 0, f = 0.0, d = 0.0, by = 0, sh = 0, l = new Ice.Long(0, 0), ss = null, dict = null, seq = null)
        {
            this.b = b;
            this.i = i;
            this.f = f;
        ...
        _write(ostr)
        {
            ...
            Test.StructSHelper.write(ostr, this.ss);
            Test.ByteBoolDHelper.write(ostr, this.dict);
            Test.MyEnumSSHelper.write(ostr, this.seq);
        }
        ...
        _read(istr)
        {
            ...
            this.ss = Test.StructSHelper.read(istr);
            this.dict = Test.ByteBoolDHelper.read(istr);
            this.seq = Test.MyEnumSSHelper.read(istr);
        }
    ...
    Slice.defineSequence(Test, "ASHelper", "Ice.ObjectHelper", false, "Test.A");
    ...
    Slice.defineOperations(Test.MyClass, Test.MyClassPrx, iceC_Test_MyClass_ids, 1,
    {
        ...
        "opMyEnumS": [, , , , ["Test.MyEnumSHelper"], [["Test.MyEnumSHelper"], ["Test.MyEnumSHelper"]], [["Test.MyEnumSHelper"]], , , ],
        "opMyClassS": [, , , , ["Test.MyClassSHelper"], [["Test.MyClassSHelper"], ["Test.MyClassSHelper"]], [["Test.MyClassSHelper"]], , , ],
        ...
        "getNSNullStringSeq": [, , , , ["Test.StringSHelper"], , , , , ],
        "getNSNullASeq": [, , , , ["Test.ASHelper"], , , , , true],
        "getNSNullStructSeq": [, , , , ["Test.StructSHelper"], , , , , ],
        "getNSNullStringSeqSeq": [, , , , ["Test.StringSSHelper"], , , , , ],
        "getNSNullStringStringDict": [, , , , ["Test.StringStringDHelper"], , , , , ],
        "putNSNullStringStringDict": [, , , , , [["Test.StringStringDHelper"]], , , , ],
        "putNSNullShortIntDict": [, , , , , [["Test.ShortIntDHelper"]], , , , ],
        "putNSNullStringMyEnumDict": [, , , , , [["Test.StringMyEnumDHelper"]], , , , ]
    });
