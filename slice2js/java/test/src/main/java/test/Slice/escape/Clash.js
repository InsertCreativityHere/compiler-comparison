...
{
    constructor(s = null, context = "", current = 0, response = 0, typeId = 0, del = 0, cookie = undefined, ex = "", result = 0, istr = "", ostr = "", inS = "", in = "", proxy = "", obj = 0, getCookie = 0)
    {
        super();
        this.s = s;
...
Clash.St = class
{
    constructor(v = "", istr = 0, ostr = 0, rhs = 0, hashCode = "")
    {
        this.v = v;
        this.istr = istr;
        this.ostr = ostr;
