...
Test.IntListHelper = Ice.StreamHelpers.generateSeqHelper(Ice.IntHelper, true);
...
Test.S2 = class {
    constructor(bo = false, by = 0, sh = 0, i = 0, l = 0n, f = 0.0, d = 0.0, str = "", ss = null, il = null, sd = null, s = new Test.S1(), cls = null, prx = null) {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
        this.i = i;
