...
Ice.defineClass(Test.Common.Config, "::Test::Common::Config");
...
Ice.defineClass(Test.Common.OptionOverrides, "::Test::Common::OptionOverrides");
...
Ice.defineClass(Test.Common.TestCaseNotExistException, "::Test::Common::TestCaseNotExistException");
...
Ice.defineClass(Test.Common.TestCaseFailedException, "::Test::Common::TestCaseFailedException");
...
Ice.defineOperations(
    ...
    "::Test::Common::TestCase", {
        "startServerSide": [, 0, , [7], [["Test.Common.Config", true]], ,
        [
            Test.Common.TestCaseFailedException
        ], true, ],
        "stopServerSide": [, 0, , [7], [[1]], ,
        [
            Test.Common.TestCaseFailedException
        ], , ],
        "runClientSide": [, 0, , [7], [[7], ["Test.Common.Config", true]], ,
        [
            Test.Common.TestCaseFailedException
        ], true, ],
        "destroy": [, 0, , , , , , , ]
...
Ice.defineOperations(
    ...
    "::Test::Common::Controller", {
        "runTestCase": [, 0, , ["Test.Common.TestCasePrx"], [[7], [7], [7], [7]], ,
        [
            Test.Common.TestCaseNotExistException
        ], , ],
        "getOptionOverrides": [, 0, , ["Test.Common.OptionOverrides", true], , , , , true],
        "getTestSuites": [, 0, , [Test.Common.StringSeqHelper], [[7]], , , , ],
        "getHost": [, 0, , [7], [[7], [1]], , , , ]
    });
...
Ice.defineClass(Test.Common.ProcessFailedException, "::Test::Common::ProcessFailedException");
...
Ice.defineOperations(
    ...
    "::Test::Common::ProcessController", {
        "start": [, 0, , ["Test.Common.ProcessPrx"], [[7], [7], [Test.Common.StringSeqHelper]], ,
        [
            Test.Common.ProcessFailedException
        ], , ],
        "getHost": [, 0, , [7], [[7], [1]], , , , ]
...
Ice.defineOperations(
    ...
    "::Test::Common::ProcessControllerRegistry", {
        "setProcessController": [, 0, , , [["Test.Common.ProcessControllerPrx"]], , , , ]
    });
