...
Ice.defineClass(IceStormElection.ObserverInconsistencyException, "::IceStormElection::ObserverInconsistencyException");
...
Ice.defineOperations(
    ...
    "::IceStormElection::ReplicaObserver",
    {
        "init": [, 0, , , [[IceStormElection.LogUpdate], [IceStormElection.TopicContentSeqHelper]], ,
        [
            IceStormElection.ObserverInconsistencyException
        ], , ],
        "createTopic": [, 0, , , [[IceStormElection.LogUpdate], [7]], ,
        [
            IceStormElection.ObserverInconsistencyException
        ], , ],
        "destroyTopic": [, 0, , , [[IceStormElection.LogUpdate], [7]], ,
        [
            IceStormElection.ObserverInconsistencyException
        ], , ],
        "addSubscriber": [, 0, , , [[IceStormElection.LogUpdate], [7], [IceStorm.SubscriberRecord]], ,
        [
            IceStormElection.ObserverInconsistencyException
        ], , ],
        "removeSubscriber": [, 0, , , [[IceStormElection.LogUpdate], [7], [Ice.IdentitySeqHelper]], ,
        [
            IceStormElection.ObserverInconsistencyException
        ], , ]
    });
...
Ice.defineOperations(
    ...
    "::IceStormElection::TopicManagerSync",
    {
        "getContent": [, 0, , , , [[IceStormElection.LogUpdate], [IceStormElection.TopicContentSeqHelper]], , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceStormElection::Node",
    {
        "invitation": [, 0, , , [[3], [7]], , , , ],
        "ready": [, 0, , , [[3], [7], [9], [3], [4]], , , , ],
        "accept": [, 0, , , [[3], [7], [Ice.IntSeqHelper], [9], [IceStormElection.LogUpdate], [3]], , , , ],
