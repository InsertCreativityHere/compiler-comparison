...
import { 
    DataStorm as DataStorm__________slice_DataStorm_SampleEvent, } from "../../../slice/DataStorm/SampleEvent.js"

const DataStorm = {
    ...DataStorm__________slice_DataStorm_SampleEvent,
};
...
{
    constructor(id = 0n, keyId = 0n, keyValue = null, timestamp = 0n, tag = 0n, event = DataStorm.SampleEvent.Add, value = null)
    {
        this.id = id;
        this.keyId = keyId;
...
{
    constructor(id = 0n, samples = null)
    {
        this.id = id;
...
{
    constructor(id = 0n, name = "", value = null)
    {
        this.id = id;
        this.name = name;
        this.value = value;
...
{
    constructor(id = 0n, name = "", elements = null, tags = null)
    {
        this.id = id;
        this.name = name;
...
Ice.defineClass(DataStormContract.ElementConfig, "::DataStormContract::ElementConfig", 1);
...
{
    constructor(id = 0n, config = null, lastIds = null)
    {
        this.id = id;
        this.config = config;
...
{
    constructor(elements = null, id = 0n, name = "", value = null, peerId = 0n, peerName = "")
    {
        this.elements = elements;
        this.id = id;
        this.name = name;
...
{
    constructor(id = 0n, config = null, lastIds = null, samples = null, peerId = 0n)
    {
        this.id = id;
        this.config = config;
        this.lastIds = lastIds;
...
Ice.defineOperations(
    ...
    "::DataStormContract::Session",
    {
        "announceTopics": [, 0, , , [[DataStormContract.TopicInfoSeqHelper], [1]], , , , ],
        "attachTopic": [, 0, , , [[DataStormContract.TopicSpec]], , , , ],
        "detachTopic": [, 0, , , [[4]], , , , ],
        "attachTags": [, 0, , , [[4], [DataStormContract.ElementInfoSeqHelper], [1]], , , , ],
        "detachTags": [, 0, , , [[4], [Ice.LongSeqHelper]], , , , ],
        "announceElements": [, 0, , , [[4], [DataStormContract.ElementInfoSeqHelper]], , , , ],
        "attachElements": [, 0, , , [[4], [DataStormContract.ElementSpecSeqHelper], [1]], , , true, ],
        "attachElementsAck": [, 0, , , [[4], [DataStormContract.ElementSpecAckSeqHelper]], , , true, ],
        "detachElements": [, 0, , , [[4], [Ice.LongSeqHelper]], , , , ],
        "initSamples": [, 0, , , [[4], [DataStormContract.DataSamplesSeqHelper]], , , , ],
        "disconnected": [, 0, , , , , , , ]
    });
...
Ice.defineOperations(
    ...
    "::DataStormContract::SubscriberSession",
    {
        "s": [, 0, , , [[4], [4], [DataStormContract.DataSample]], , , , ]
    });

/**
 * The reason for the session creation failure.
 **/
DataStormContract.SessionCreationError = Ice.defineEnum([
    ['AlreadyConnected', 0], ['NodeShutdown', 1], ['SessionNotFound', 2], ['Internal', 3]]);

/**
 * Throws when the session cannot be created.
 **/
DataStormContract.SessionCreationException = class extends Ice.UserException
{
    constructor(error = DataStormContract.SessionCreationError.AlreadyConnected, _cause = "")
    {
        super(_cause);
        this.error = error;
    }
    ...
    {
        DataStormContract.SessionCreationError._write(ostr, this.error);
    }

    _readMemberImpl(istr)
    {
        this.error = DataStormContract.SessionCreationError._read(istr);
    }
};

Ice.defineClass(DataStormContract.SessionCreationException, "::DataStormContract::SessionCreationException");
...
Ice.defineOperations(
    ...
    "::DataStormContract::Node",
    {
        "initiateCreateSession": [, 0, , , [["DataStormContract.NodePrx"]], ,
        [
            DataStormContract.SessionCreationException
        ], , ],
        "createSession": [, 0, , , [["DataStormContract.NodePrx"], ["DataStormContract.SubscriberSessionPrx"], [1]], ,
        [
            DataStormContract.SessionCreationException
        ], , ],
        "confirmCreateSession": [, 0, , , [["DataStormContract.NodePrx"], ["DataStormContract.PublisherSessionPrx"]], ,
        [
            DataStormContract.SessionCreationException
        ], , ]
    });
...
Ice.defineOperations(
    ...
    "::DataStormContract::Lookup",
    {
        ...
        "createSession": [, 0, , ["DataStormContract.NodePrx"], [["DataStormContract.NodePrx"]], , , , ]
    });
