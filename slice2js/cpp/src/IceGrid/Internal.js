...
Ice.defineClass(IceGrid.InternalDbEnvDescriptor, "::IceGrid::InternalDbEnvDescriptor");
...
Ice.defineClass(IceGrid.InternalAdapterDescriptor, "::IceGrid::InternalAdapterDescriptor");
...
Ice.defineClass(IceGrid.InternalServerDescriptor, "::IceGrid::InternalServerDescriptor");
...
Ice.defineClass(IceGrid.AdapterActiveException, "::IceGrid::AdapterActiveException");

IceGrid.AdapterNotActiveException = class extends Ice.UserException {
    constructor(activatable = false) {
        super();
...
Ice.defineClass(IceGrid.AdapterNotActiveException, "::IceGrid::AdapterNotActiveException");
...
Ice.defineClass(IceGrid.AdapterExistsException, "::IceGrid::AdapterExistsException");
...
Ice.defineOperations(
    ...
    "::IceGrid::Server", {
        ...
        "checkUpdate": [, 0, , [1], [["IceGrid.InternalServerDescriptor", true], [1]], ,
        [
...
Ice.defineOperations(
    ...
    "::IceGrid::ReplicaObserver", {
        "replicaInit": [, 0, , , [[IceGrid.InternalRegistryPrxSeqHelper]], , , , ],
        "replicaAdded": [, 0, , , [["IceGrid.InternalRegistryPrx"]], , , , ],
        "replicaRemoved": [, 0, , , [["IceGrid.InternalRegistryPrx"]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::Node", {
        ...
        "registerWithReplica": [, 0, , , [["IceGrid.InternalRegistryPrx"]], , , , ],
        "getName": [, 2, , [7], , , , , ],
        "getHostname": [, 2, , [7], , , , , ],
...
Ice.defineClass(IceGrid.NodeActiveException, "::IceGrid::NodeActiveException");
...
Ice.defineOperations(
    ...
    "::IceGrid::NodeSession", {
        "keepAlive": [, 0, , , [[IceGrid.LoadInfo]], , , , ],
        "setReplicaObserver": [, 0, , , [["IceGrid.ReplicaObserverPrx"]], , , , ],
        "getTimeout": [, 2, , [3], , , , , ],
        "getObserver": [, 2, , ["IceGrid.NodeObserverPrx"], , , , , ],
        "loadServers": [, 2, , , , , , , ],
        "getServers": [, 2, , [Ice.StringSeqHelper], , , , , ],
        "waitForApplicationUpdate": [, 0, , , [[7], [3]], , , , ],
        "destroy": [, 0, , , , , , , ]
    });
...
Ice.defineClass(IceGrid.ReplicaActiveException, "::IceGrid::ReplicaActiveException");
...
Ice.defineOperations(
    ...
    "::IceGrid::ReplicaSession", {
        ...
        "setAdapterDirectProxy": [, 2, , , [[7], [7], [8]], ,
        [
            IceGrid.AdapterNotExistException,
            IceGrid.AdapterExistsException
        ], , ],
        "receivedUpdate": [, 0, , , [[IceGrid.TopicName._helper], [3], [7]], , , , ],
        "destroy": [, 0, , , , , , , ]
    });
...
Ice.defineClass(IceGrid.InternalNodeInfo, "::IceGrid::InternalNodeInfo");
...
Ice.defineClass(IceGrid.InternalReplicaInfo, "::IceGrid::InternalReplicaInfo");
...
Ice.defineOperations(
    ...
    "::IceGrid::InternalRegistry", {
        "registerNode": [, 0, , ["IceGrid.NodeSessionPrx"], [["IceGrid.InternalNodeInfo", true], ["IceGrid.NodePrx"], [IceGrid.LoadInfo]], ,
        [
            IceGrid.NodeActiveException,
            IceGrid.PermissionDeniedException
        ], true, ],
        "registerReplica": [, 0, , ["IceGrid.ReplicaSessionPrx"], [["IceGrid.InternalReplicaInfo", true], ["IceGrid.InternalRegistryPrx"]], ,
        [
