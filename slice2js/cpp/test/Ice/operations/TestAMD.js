...
(function(module, require, exports)
{
    ...
    let M = _ModuleRegistry.module("M");
    ...
    Slice.defineValue(M.A, iceC_M_A_ids[1], false);

    const iceC_M_Intf_ids = [
        "::Ice::Object",
        "::M::Intf"
    ];

    M.Intf = class extends Ice.Object
    {
    };

    M.IntfPrx = class extends Ice.ObjectPrx
    {
    };

    Slice.defineOperations(M.Intf, M.IntfPrx, iceC_M_Intf_ids, 1,
    {
        "opIntf": [, , , , , , , , , ]
    });
    ...
    Slice.defineValue(M.B, iceC_M_B_ids[2], false);

    M.BDisp = class extends Ice.Object
    {
        static get _iceImplements()
        {
            return [
    ...
    M.BPrx = class extends Ice.ObjectPrx
    {
        static get _implements()
        {
            return [
    ...
    Slice.defineOperations(M.BDisp, M.BPrx, iceC_M_B_ids, 2,
    {
        "opB": [, , , , , , , , , ]
    });
    exports.Test = Test;
