...
Ice.defineStruct(Test.ClassStruct, true, false);
...
{
    constructor(bo = false, by = 0, sh = 0, i = 0, l = 0n, f = 0.0, d = 0.0, str = "", e = Test.Sub.NestedEnum.nestedEnum1)
    {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
...
Ice.defineClass(Test.Sub.NestedException, "::Test::Sub::NestedException");
...
{
    constructor(bo = false, by = 0, sh = 0, i = 0, l = 0n, f = 0.0, d = 0.0, str = "", e = Test2.Sub2.NestedEnum2.nestedEnum4)
    {
        this.bo = bo;
        this.by = by;
        this.sh = sh;
...
Ice.defineClass(Test2.Sub2.NestedException2, "::Test2::Sub2::NestedException2");
