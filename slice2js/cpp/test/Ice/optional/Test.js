...
Test.MultiOptional = class extends Ice.Value
{
    ...
    _iceWriteMemberImpl(ostr)
    {
        ...
        Ice.StringHelper.writeOptional(ostr, 31, this.defaultedString);
    }
    ...
    _iceReadMemberImpl(istr)
    {
        ...
        this.defaultedString = Ice.StringHelper.readOptional(istr, 31);
    }
};
