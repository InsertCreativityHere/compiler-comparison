...
Ice.defineClass(Test.OneOptional, "::Test::OneOptional");
...
Ice.defineClass(Test.MultiOptional, "::Test::MultiOptional");
...
Ice.defineClass(Test.OptionalException, "::Test::OptionalException");

Test.DerivedException = class extends Test.OptionalException {
    constructor(req, a, b, d1 = "", ss = "test", d2 = "") {
        super(req, a, b);
        this.d1 = d1;
        this.ss = ss;
        this.d2 = d2;
...
Ice.defineClass(Test.DerivedException, "::Test::DerivedException");

Test.RequiredException = class extends Test.OptionalException {
    constructor(req, a, b, ss = "test") {
        super(req, a, b);
        this.ss = ss;
    }
...
Ice.defineClass(Test.RequiredException, "::Test::RequiredException");
...
Ice.defineOperations(
    ...
    "::Test::Initial", {
        "shutdown": [, 0, , , , , , , ],
        "pingPong": [, 0, , [9, true], [[9, true]], , , true, true],
        "opOptionalException": [, 0, , , [[3, , 1], [7, , 2]], ,
        [
            Test.OptionalException
        ], , ],
        "opDerivedException": [, 0, , , [[3, , 1], [7, , 2]], ,
        [
            Test.OptionalException
        ], , ],
        "opRequiredException": [, 0, , , [[3, , 1], [7, , 2]], ,
        [
            Test.OptionalException
        ], , ],
        "opByte": [, 0, , [0, , 1], [[0, , 2]], [[0, , 3]], , , ],
        "opBool": [, 0, , [1, , 1], [[1, , 2]], [[1, , 3]], , , ],
        "opShort": [, 0, , [2, , 1], [[2, , 2]], [[2, , 3]], , , ],
        "opInt": [, 0, , [3, , 1], [[3, , 2]], [[3, , 3]], , , ],
        "opLong": [, 0, , [4, , 3], [[4, , 1]], [[4, , 2]], , , ],
        "opFloat": [, 0, , [5, , 1], [[5, , 2]], [[5, , 3]], , , ],
        "opDouble": [, 0, , [6, , 1], [[6, , 2]], [[6, , 3]], , , ],
        "opString": [, 0, , [7, , 1], [[7, , 2]], [[7, , 3]], , , ],
        "opMyEnum": [, 0, , [Test.MyEnum._helper, , 1], [[Test.MyEnum._helper, , 2]], [[Test.MyEnum._helper, , 3]], , , ],
        "opSmallStruct": [, 0, , [Test.SmallStruct, , 1], [[Test.SmallStruct, , 2]], [[Test.SmallStruct, , 3]], , , ],
        "opFixedStruct": [, 0, , [Test.FixedStruct, , 1], [[Test.FixedStruct, , 2]], [[Test.FixedStruct, , 3]], , , ],
        "opVarStruct": [, 0, , [Test.VarStruct, , 1], [[Test.VarStruct, , 2]], [[Test.VarStruct, , 3]], , , ],
        "opMyInterfaceProxy": [, 0, , ["Test.MyInterfacePrx", , 1], [["Test.MyInterfacePrx", , 2]], [["Test.MyInterfacePrx", , 3]], , , ],
        "opOneOptional": [, 0, , ["Test.OneOptional", true], [["Test.OneOptional", true]], [["Test.OneOptional", true]], , true, true],
        "opByteSeq": [, 0, , [Test.ByteSeqHelper, , 1], [[Test.ByteSeqHelper, , 2]], [[Test.ByteSeqHelper, , 3]], , , ],
        "opBoolSeq": [, 0, , [Test.BoolSeqHelper, , 1], [[Test.BoolSeqHelper, , 2]], [[Test.BoolSeqHelper, , 3]], , , ],
        "opShortSeq": [, 0, , [Test.ShortSeqHelper, , 1], [[Test.ShortSeqHelper, , 2]], [[Test.ShortSeqHelper, , 3]], , , ],
        "opIntSeq": [, 0, , [Test.IntSeqHelper, , 1], [[Test.IntSeqHelper, , 2]], [[Test.IntSeqHelper, , 3]], , , ],
        "opLongSeq": [, 0, , [Test.LongSeqHelper, , 1], [[Test.LongSeqHelper, , 2]], [[Test.LongSeqHelper, , 3]], , , ],
        "opFloatSeq": [, 0, , [Test.FloatSeqHelper, , 1], [[Test.FloatSeqHelper, , 2]], [[Test.FloatSeqHelper, , 3]], , , ],
        "opDoubleSeq": [, 0, , [Test.DoubleSeqHelper, , 1], [[Test.DoubleSeqHelper, , 2]], [[Test.DoubleSeqHelper, , 3]], , , ],
        "opStringSeq": [, 0, , [Test.StringSeqHelper, , 1], [[Test.StringSeqHelper, , 2]], [[Test.StringSeqHelper, , 3]], , , ],
        "opSmallStructSeq": [, 0, , [Test.SmallStructSeqHelper, , 1], [[Test.SmallStructSeqHelper, , 2]], [[Test.SmallStructSeqHelper, , 3]], , , ],
        "opSmallStructList": [, 0, , [Test.SmallStructListHelper, , 1], [[Test.SmallStructListHelper, , 2]], [[Test.SmallStructListHelper, , 3]], , , ],
        "opFixedStructSeq": [, 0, , [Test.FixedStructSeqHelper, , 1], [[Test.FixedStructSeqHelper, , 2]], [[Test.FixedStructSeqHelper, , 3]], , , ],
        "opFixedStructList": [, 0, , [Test.FixedStructListHelper, , 1], [[Test.FixedStructListHelper, , 2]], [[Test.FixedStructListHelper, , 3]], , , ],
        "opVarStructSeq": [, 0, , [Test.VarStructSeqHelper, , 1], [[Test.VarStructSeqHelper, , 2]], [[Test.VarStructSeqHelper, , 3]], , , ],
        "opSerializable": [, 0, , [Test.SerializableHelper, , 1], [[Test.SerializableHelper, , 2]], [[Test.SerializableHelper, , 3]], , , ],
        "opIntIntDict": [, 0, , [Test.IntIntDictHelper, , 1], [[Test.IntIntDictHelper, , 2]], [[Test.IntIntDictHelper, , 3]], , , ],
        "opStringIntDict": [, 0, , [Test.StringIntDictHelper, , 1], [[Test.StringIntDictHelper, , 2]], [[Test.StringIntDictHelper, , 3]], , , ],
        "opClassAndUnknownOptional": [, 0, , , [["Test.A", true]], , , true, ],
        "opG": [, 0, , ["Test.G", true], [["Test.G", true]], , , true, true],
        "opVoid": [, 0, , , , , , , ],
        "opMStruct1": [, 0, , [Test.SmallStruct, , 1], , , , , ],
        "opMStruct2": [, 0, , [Test.SmallStruct, , 1], [[Test.SmallStruct, , 2]], [[Test.SmallStruct, , 3]], , , ],
        "opMSeq1": [, 0, , [Test.StringSeqHelper, , 1], , , , , ],
        "opMSeq2": [, 0, , [Test.StringSeqHelper, , 1], [[Test.StringSeqHelper, , 2]], [[Test.StringSeqHelper, , 3]], , , ],
        "opMDict1": [, 0, , [Test.StringIntDictHelper, , 1], , , , , ],
        "opMDict2": [, 0, , [Test.StringIntDictHelper, , 1], [[Test.StringIntDictHelper, , 2]], [[Test.StringIntDictHelper, , 3]], , , ],
        "supportsJavaSerializable": [, 0, , [1], , , , , ]
    });
