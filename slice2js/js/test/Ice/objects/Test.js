...
Ice.defineClass(Test.Compact, "::Test::Compact", 1);
...
Ice.defineClass(Test.CompactExt, "::Test::CompactExt", 789);
...
Ice.defineClass(Test.A1, "::Test::A1");
...
Ice.defineClass(Test.B1, "::Test::B1");
...
Ice.defineClass(Test.D1, "::Test::D1");
...
Ice.defineClass(Test.EBase, "::Test::EBase");
...
Ice.defineClass(Test.EDerived, "::Test::EDerived");
...
Ice.defineClass(Test.Inner.A, "::Test::Inner::A");
...
Ice.defineClass(Test.Inner.Ex, "::Test::Inner::Ex");
...
Ice.defineClass(Test.Inner.Sub.A, "::Test::Inner::Sub::A");
...
Ice.defineClass(Test.Inner.Sub.Ex, "::Test::Inner::Sub::Ex");
...
Ice.defineClass(Test.Recursive, "::Test::Recursive");
...
Ice.defineClass(Test.F3, "::Test::F3");
...
Ice.defineOperations(
    ...
    {
        "shutdown": [, 0, , , , , , , ],
        "getB1": [, 0, , ["Test.B", true], , , , , true],
        "getB2": [, 0, , ["Test.B", true], , , , , true],
        "getC": [, 0, , ["Test.C", true], , , , , true],
        "getD": [, 0, , ["Test.D", true], , , , , true],
        "setRecursive": [, 0, , , [["Test.Recursive", true]], , , true, ],
        "setCycle": [, 0, , , [["Test.Recursive", true]], , , true, ],
        "acceptsClassCycles": [, 0, , [1], , , , , ],
        "getMB": [, 0, , ["Test.B", true], , , , , true],
        "getAMDMB": [, 0, , ["Test.B", true], , , , , true],
        "getAll": [, 0, , , , [["Test.B", true], ["Test.B", true], ["Test.C", true], ["Test.D", true]], , , true],
        "getK": [, 0, , ["Test.K", true], , , , , true],
        "opValue": [, 0, , [10, true], [[10, true]], [[10, true]], , true, true],
        "opValueSeq": [, 0, , [Test.ValueSeqHelper], [[Test.ValueSeqHelper]], [[Test.ValueSeqHelper]], , true, true],
        "opValueMap": [, 0, , [Test.ValueMapHelper], [[Test.ValueMapHelper]], [[Test.ValueMapHelper]], , true, true],
        "getD1": [, 0, , ["Test.D1", true], [["Test.D1", true]], , , true, true],
        "throwEDerived": [, 0, , , , ,
        [
            Test.EDerived
        ], , ],
        "setG": [, 0, , , [["Test.G", true]], , , true, ],
        "opBaseSeq": [, 0, , [Test.BaseSeqHelper], [[Test.BaseSeqHelper]], [[Test.BaseSeqHelper]], , true, true],
        "getCompact": [, 0, , ["Test.Compact", true], , , , , true],
        "getInnerA": [, 0, , ["Test.Inner.A", true], , , , , true],
        "getInnerSubA": [, 0, , ["Test.Inner.Sub.A", true], , , , , true],
        "throwInnerEx": [, 0, , , , ,
        [
            Test.Inner.Ex
        ], , ],
        ...
        "opM": [, 0, , ["Test.M", true], [["Test.M", true]], [["Test.M", true]], , true, true],
        "opF1": [, 0, , ["Test.F1", true], [["Test.F1", true]], [["Test.F1", true]], , true, true],
        "opF2": [, 0, , ["Test.F2Prx"], [["Test.F2Prx"]], [["Test.F2Prx"]], , , ],
        "opF3": [, 0, , ["Test.F3", true], [["Test.F3", true]], [["Test.F3", true]], , true, true],
        "hasF3": [, 0, , [1], , , , , ]
    });
...
Ice.defineClass(Test.Empty, "::Test::Empty");
...
Ice.defineClass(Test.AlsoEmpty, "::Test::AlsoEmpty");
...
Ice.defineClass(Test.COneMember, "::Test::COneMember");
...
Ice.defineClass(Test.CTwoMembers, "::Test::CTwoMembers");
...
Ice.defineClass(Test.EOneMember, "::Test::EOneMember");
...
Ice.defineClass(Test.ETwoMembers, "::Test::ETwoMembers");
