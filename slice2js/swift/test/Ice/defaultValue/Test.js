...
Test.Struct1 = class {
    constructor(boolFalse = false, boolTrue = true, b = 254, s = 16000, i = 3, l = 4n, f = 5.1, d = 6.2, str = "foo \\ \"bar\n \r\n\t\v\f\u0007\b? \u0007 \u0007", c1 = Test.Color.red, c2 = Test.Color.green, c3 = Test.Color.blue, nc1 = Test.Nested.Color.red, nc2 = Test.Nested.Color.green, nc3 = Test.Nested.Color.blue, noDefault = "", zeroI = 0, zeroL = 0n, zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0) {
...
Test.Struct3 = class {
    constructor(boolFalse = false, boolTrue = true, b = 1, s = 2, i = 3, l = 4n, f = 5.1, d = 6.2, str = "foo \\ \"bar\n \r\n\t\v\f\u0007\b? \u0007 \u0007", c1 = Test.Color.red, c2 = Test.Color.green, c3 = Test.Color.blue, nc1 = Test.Nested.Color.red, nc2 = Test.Nested.Color.green, nc3 = Test.Nested.Color.blue, noDefault = "", zeroI = 0, zeroL = 0n, zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0) {
        this.boolFalse = boolFalse;
        this.boolTrue = boolTrue;
        this.b = b;
        this.s = s;
...
Ice.defineStruct(Test.Struct4, true, true);

Test.Base = class extends Ice.Value {
    constructor(boolFalse = false, boolTrue = true, b = 1, s = 2, i = 3, l = 4n, f = 5.1, d = 6.2, str = "foo \\ \"bar\n \r\n\t\v\f\u0007\b? \u0007 \u0007", noDefault = "", zeroI = 0, zeroL = 0n, zeroF = 0, zeroDotF = 0, zeroD = 0, zeroDotD = 0) {
        super();
        this.boolFalse = boolFalse;
        this.boolTrue = boolTrue;
        this.b = b;
...
Ice.defineClass(Test.BaseEx, "::Test::BaseEx");

Test.DerivedEx = class extends Test.BaseEx {
    constructor(boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD, c1 = Test.ConstColor1, c2 = Test.ConstColor2, c3 = Test.ConstColor3, nc1 = Test.ConstNestedColor1, nc2 = Test.ConstNestedColor2, nc3 = Test.ConstNestedColor3) {
        super(boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD);
        this.c1 = c1;
        this.c2 = c2;
        this.c3 = c3;
