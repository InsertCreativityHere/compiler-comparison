...
import { 
    IceGrid as IceGrid___Descriptor, } from "./Descriptor.js"
import { 
...
IceGrid.ApplicationInfo = class {
    constructor(uuid = "", createTime = 0n, createUser = "", updateTime = 0n, updateUser = "", revision = 0, descriptor = new IceGrid.ApplicationDescriptor()) {
        this.uuid = uuid;
...
IceGrid.ApplicationUpdateInfo = class {
    constructor(updateTime = 0n, updateUser = "", revision = 0, descriptor = new IceGrid.ApplicationUpdateDescriptor()) {
        this.updateTime = updateTime;
        this.updateUser = updateUser;
        this.revision = revision;
        this.descriptor = descriptor;
...
Ice.defineOperations(
    ...
    "::IceGrid::Admin", {
        "addApplication": [, 0, , , [[IceGrid.ApplicationDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException
        ], true, ],
        "syncApplication": [, 0, , , [[IceGrid.ApplicationDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException,
            IceGrid.ApplicationNotExistException
        ], true, ],
        "updateApplication": [, 0, , , [[IceGrid.ApplicationUpdateDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException,
            IceGrid.ApplicationNotExistException
        ], true, ],
        "syncApplicationWithoutRestart": [, 0, , , [[IceGrid.ApplicationDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException,
            IceGrid.ApplicationNotExistException
        ], true, ],
        "updateApplicationWithoutRestart": [, 0, , , [[IceGrid.ApplicationUpdateDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException,
            IceGrid.ApplicationNotExistException
        ], true, ],
        "removeApplication": [, 0, , , [[7]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.DeploymentException,
            IceGrid.ApplicationNotExistException
        ], , ],
        "instantiateServer": [, 0, , , [[7], [7], [IceGrid.ServerInstanceDescriptor]], ,
        [
            IceGrid.AccessDeniedException,
            IceGrid.ApplicationNotExistException,
            IceGrid.DeploymentException
        ...
        "addObjectWithType": [, 0, , , [[8], [7]], ,
        [
            IceGrid.ObjectExistsException,
            IceGrid.DeploymentException
        ], , ],
        "removeObject": [, 0, , , [[Ice.Identity]], ,
        [
            IceGrid.ObjectNotRegisteredException,
            IceGrid.DeploymentException
        ], , ],
...
Ice.defineOperations(
    ...
    "::IceGrid::FileIterator", {
        "read": [, 0, , [1], [[3]], [[Ice.StringSeqHelper]],
        [
...
Ice.defineOperations(
    ...
    "::IceGrid::RegistryObserver", {
        "registryInit": [, 0, , , [[IceGrid.RegistryInfoSeqHelper]], , , , ],
        "registryUp": [, 0, , , [[IceGrid.RegistryInfo]], , , , ],
        "registryDown": [, 0, , , [[7]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::NodeObserver", {
        "nodeInit": [, 0, , , [[IceGrid.NodeDynamicInfoSeqHelper]], , , , ],
        "nodeUp": [, 0, , , [[IceGrid.NodeDynamicInfo]], , , , ],
        "nodeDown": [, 0, , , [[7]], , , , ],
        "updateServer": [, 0, , , [[7], [IceGrid.ServerDynamicInfo]], , , , ],
        "updateAdapter": [, 0, , , [[7], [IceGrid.AdapterDynamicInfo]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::ApplicationObserver", {
        "applicationInit": [, 0, , , [[3], [IceGrid.ApplicationInfoSeqHelper]], , , true, ],
        "applicationAdded": [, 0, , , [[3], [IceGrid.ApplicationInfo]], , , true, ],
        "applicationRemoved": [, 0, , , [[3], [7]], , , , ],
        "applicationUpdated": [, 0, , , [[3], [IceGrid.ApplicationUpdateInfo]], , , true, ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::AdapterObserver", {
        "adapterInit": [, 0, , , [[IceGrid.AdapterInfoSeqHelper]], , , , ],
        "adapterAdded": [, 0, , , [[IceGrid.AdapterInfo]], , , , ],
        "adapterUpdated": [, 0, , , [[IceGrid.AdapterInfo]], , , , ],
        "adapterRemoved": [, 0, , , [[7]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::ObjectObserver", {
        "objectInit": [, 0, , , [[IceGrid.ObjectInfoSeqHelper]], , , , ],
        "objectAdded": [, 0, , , [[IceGrid.ObjectInfo]], , , , ],
        "objectUpdated": [, 0, , , [[IceGrid.ObjectInfo]], , , , ],
        "objectRemoved": [, 0, , , [[Ice.Identity]], , , , ]
    });
...
Ice.defineOperations(
    ...
    "::IceGrid::AdminSession", {
        ...
        "getReplicaName": [, 2, , [7], , , , , ],
        "openServerLog": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.ServerNotExistException,
            IceGrid.NodeUnreachableException,
        ...
        "openServerStdErr": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.ServerNotExistException,
            IceGrid.NodeUnreachableException,
        ...
        "openServerStdOut": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.ServerNotExistException,
            IceGrid.NodeUnreachableException,
        ...
        "openNodeStdErr": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.NodeNotExistException,
            IceGrid.NodeUnreachableException
        ], , ],
        "openNodeStdOut": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.NodeNotExistException,
            IceGrid.NodeUnreachableException
        ], , ],
        "openRegistryStdErr": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.RegistryNotExistException,
            IceGrid.RegistryUnreachableException
        ], , ],
        "openRegistryStdOut": [, 0, , ["IceGrid.FileIteratorPrx"], [[7], [3]], ,
        [
            IceGrid.FileNotAvailableException,
            IceGrid.RegistryNotExistException,
            IceGrid.RegistryUnreachableException
