...
IceMX.TopicMetrics = class extends IceMX.Metrics {
    constructor(id, total, current, totalLifetime, failures, published = 0n, forwarded = 0n) {
...
Ice.defineClass(IceMX.TopicMetrics, "::IceMX::TopicMetrics");
...
IceMX.SubscriberMetrics = class extends IceMX.Metrics {
    constructor(id, total, current, totalLifetime, failures, queued = 0, outstanding = 0, delivered = 0n) {
        super(id, total, current, totalLifetime, failures);
        this.queued = queued;
...
Ice.defineClass(IceMX.SubscriberMetrics, "::IceMX::SubscriberMetrics");
