...
class TestIntfPrx(ObjectPrx):
    ...
    def opAsyncDispatch(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_opAsyncDispatch.invoke(self, ((), context))

    def opAsyncDispatchAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_opAsyncDispatch.invokeAsync(self, ((), context))

    def opWithResultAsyncDispatch(self, context: dict[str, str] | None = None) -> int:
        return TestIntf._op_opWithResultAsyncDispatch.invoke(self, ((), context))

    def opWithResultAsyncDispatchAsync(self, context: dict[str, str] | None = None) -> Awaitable[int]:
        return TestIntf._op_opWithResultAsyncDispatch.invokeAsync(self, ((), context))

    def opWithUEAsyncDispatch(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_opWithUEAsyncDispatch.invoke(self, ((), context))

    def opWithUEAsyncDispatchAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_opWithUEAsyncDispatch.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_opAsyncDispatch: IcePy.Operation
    _op_opWithResultAsyncDispatch: IcePy.Operation
    _op_opWithUEAsyncDispatch: IcePy.Operation
    ...
    @abstractmethod
    def opAsyncDispatch(self, current: Current) -> None | Awaitable[None]:
        pass

    @abstractmethod
    def opWithResultAsyncDispatch(self, current: Current) -> int | Awaitable[int]:
        pass

    @abstractmethod
    def opWithUEAsyncDispatch(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_opAsyncDispatch = IcePy.Operation(
    "opAsyncDispatch",
    "opAsyncDispatch",
    OperationMode.Normal,
    None,
...
TestIntf._op_opWithResultAsyncDispatch = IcePy.Operation(
...
TestIntf._op_opWithUEAsyncDispatch = IcePy.Operation(
