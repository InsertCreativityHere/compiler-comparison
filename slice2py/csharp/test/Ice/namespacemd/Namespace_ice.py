...
if "C1" not in _M_WithNamespace.__dict__:
    ...
    class C1(Ice.Value):
        ...
        def __repr__(self):
            return f"WithNamespace.C1({Ice.Util.format_fields(i=self.i)})"
...
if "C2" not in _M_WithNamespace.__dict__:
    ...
    class C2(_M_WithNamespace.C1):
        ...
        def __repr__(self):
            return f"WithNamespace.C2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "E1" not in _M_WithNamespace.__dict__:
    ...
    class E1(Ice.UserException):
        ...
        def __repr__(self):
            return f"WithNamespace.E1({Ice.Util.format_fields(i=self.i)})"
...
if "E2" not in _M_WithNamespace.__dict__:
    ...
    class E2(_M_WithNamespace.E1):
        ...
        def __repr__(self):
            return f"WithNamespace.E2({Ice.Util.format_fields(i=self.i, l=self.l)})"
