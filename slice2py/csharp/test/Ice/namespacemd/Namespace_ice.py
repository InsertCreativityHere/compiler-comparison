...
if 'C1' not in _M_WithNamespace.__dict__:
    _M_WithNamespace.C1 = Ice.createTempClass()
    class C1(Ice.Value):
    ...
    _M_WithNamespace._t_C1 = IcePy.defineValue('::WithNamespace::C1', C1, -1, (), False, False, None, (('i', (), IcePy._t_int, False, 0),))
...
if 'C2' not in _M_WithNamespace.__dict__:
    _M_WithNamespace.C2 = Ice.createTempClass()
    ...
    _M_WithNamespace._t_C2 = IcePy.defineValue('::WithNamespace::C2', C2, -1, (), False, False, _M_WithNamespace._t_C1, (('l', (), IcePy._t_long, False, 0),))
...
if 'E1' not in _M_WithNamespace.__dict__:
    _M_WithNamespace.E1 = Ice.createTempClass()
    ...
    _M_WithNamespace._t_E1 = IcePy.defineException('::WithNamespace::E1', E1, (), False, None, (('i', (), IcePy._t_int, False, 0),))
...
if 'E2' not in _M_WithNamespace.__dict__:
    _M_WithNamespace.E2 = Ice.createTempClass()
    ...
    _M_WithNamespace._t_E2 = IcePy.defineException('::WithNamespace::E2', E2, (), False, _M_WithNamespace._t_E1, (('l', (), IcePy._t_long, False, 0),))
