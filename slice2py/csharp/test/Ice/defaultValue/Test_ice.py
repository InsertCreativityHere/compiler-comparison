...
if "Struct3" not in _M_Test.__dict__:
    ...
    class Struct3(object):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, c1=_M_Test.Color.red, c2=_M_Test.Color.green, c3=_M_Test.Color.blue, nc1=_M_Test.Nested.Color.red, nc2=_M_Test.Nested.Color.green, nc3=_M_Test.Nested.Color.blue, zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0):
            self.boolFalse = boolFalse
            self.boolTrue = boolTrue
            self.b = b
            self.s = s
        ...
        def __repr__(self):
            return f"Test.Struct3({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Struct4" not in _M_Test.__dict__:
    ...
    class Struct4(object):
        ...
        def __repr__(self):
            return f"Test.Struct4({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Base" not in _M_Test.__dict__:
    ...
    class Base(Ice.Value):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo \\ \"bar\n \r\n\t\v\f\a\b? \a \a", noDefault="", zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, st1=None):
            ...
            self.zeroD = zeroD
            self.zeroDotD = zeroDotD
            self.st1 = st1 if st1 is not None else _M_Test.Struct1()
    ...
    _M_Test._t_Base = IcePy.defineValue("::Test::Base", Base, -1, (), False, None, (
        ...
        ("st1", (), _M_Test._t_Struct1, False, 0)
    ))
...
if "Derived" not in _M_Test.__dict__:
    ...
    class Derived(_M_Test.Base):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo \\ \"bar\n \r\n\t\v\f\a\b? \a \a", noDefault="", zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, st1=None, c1=_M_Test.Color.red, c2=_M_Test.Color.green, c3=_M_Test.Color.blue, nc1=_M_Test.Nested.Color.red, nc2=_M_Test.Nested.Color.green, nc3=_M_Test.Nested.Color.blue):
            _M_Test.Base.__init__(self, boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD, st1)
            self.c1 = c1
            self.c2 = c2
            self.c3 = c3
            self.nc1 = nc1
        ...
        def __repr__(self):
            return f"Test.Derived({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD, st1=self.st1, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3)})"
...
if "ClassProperty" not in _M_Test.__dict__:
    _M_Test._t_ClassProperty = IcePy.declareValue("::Test::ClassProperty")

if "ClassProperty" not in _M_Test.__dict__:
    _M_Test.ClassProperty = None
    class ClassProperty(Ice.Value):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo bar", noDefault="", zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0):
            self.boolFalse = boolFalse
            self.boolTrue = boolTrue
            self.b = b
            self.s = s
        ...
        def __repr__(self):
            return f"Test.ClassProperty({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"

    _M_Test._t_ClassProperty = IcePy.defineValue("::Test::ClassProperty", ClassProperty, -1, (), False, None, (
        ("boolFalse", (), IcePy._t_bool, False, 0),
        ("boolTrue", (), IcePy._t_bool, False, 0),
        ("b", (), IcePy._t_byte, False, 0),
        ("s", (), IcePy._t_short, False, 0),
    ...
    ClassProperty._ice_type = _M_Test._t_ClassProperty

    _M_Test.ClassProperty = ClassProperty
    del ClassProperty

if "StructProperty" not in _M_Test.__dict__:
    _M_Test.StructProperty = None
    class StructProperty(object):
        ...
        def __eq__(self, other):
            if other is None:
                return False
            elif not isinstance(other, _M_Test.StructProperty):
                return NotImplemented
            else:
                if self.boolFalse != other.boolFalse:
                    return False
        ...
        def __repr__(self):
            return f"Test.StructProperty({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"

        def __str__(self):
            return repr(self)

    _M_Test._t_StructProperty = IcePy.defineStruct("::Test::StructProperty", StructProperty, (), (
        ("boolFalse", (), IcePy._t_bool),
        ("boolTrue", (), IcePy._t_bool),
        ("b", (), IcePy._t_byte),
        ("s", (), IcePy._t_short),
    ...
    _M_Test.StructProperty = StructProperty
    del StructProperty

if "ExceptionProperty" not in _M_Test.__dict__:
    _M_Test.ExceptionProperty = None
    class ExceptionProperty(Ice.UserException):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo bar", noDefault="", zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0):
            self.boolFalse = boolFalse
            self.boolTrue = boolTrue
            self.b = b
        ...
        def __repr__(self):
            return f"Test.ExceptionProperty({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"

        _ice_id = "::Test::ExceptionProperty"

    _M_Test._t_ExceptionProperty = IcePy.defineException("::Test::ExceptionProperty", ExceptionProperty, (), None, (
        ("boolFalse", (), IcePy._t_bool, False, 0),
        ("boolTrue", (), IcePy._t_bool, False, 0),
        ("b", (), IcePy._t_byte, False, 0),
        ("s", (), IcePy._t_short, False, 0),
    ...
    ExceptionProperty._ice_type = _M_Test._t_ExceptionProperty

    _M_Test.ExceptionProperty = ExceptionProperty
    del ExceptionProperty
...
if "InnerStruct" not in _M_Test.__dict__:
    ...
    class InnerStruct(object):
        ...
        def __repr__(self):
            return f"Test.InnerStruct({Ice.Util.format_fields(a=self.a)})"
...
if "InnerStruct2" not in _M_Test.__dict__:
    _M_Test.InnerStruct2 = None
    class InnerStruct2(object):
        def __init__(self, a=""):
            self.a = a
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_Test.InnerStruct2):
                return NotImplemented
            else:
                if self.a is None or other.a is None:
                    if self.a != other.a:
        ...
        def __repr__(self):
            return f"Test.InnerStruct2({Ice.Util.format_fields(a=self.a)})"

        def __str__(self):
            return repr(self)

    _M_Test._t_InnerStruct2 = IcePy.defineStruct("::Test::InnerStruct2", InnerStruct2, (), (("a", (), IcePy._t_string),))

    _M_Test.InnerStruct2 = InnerStruct2
    del InnerStruct2

if "StructNoDefaults" not in _M_Test.__dict__:
    _M_Test.StructNoDefaults = None
    class StructNoDefaults(object):
        def __init__(self, bo=False, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str="", c1=_M_Test.Color.red, bs=None, iseq=None, st=None, st2=None, dict=None):
            self.bo = bo
            self.b = b
            self.s = s
            self.i = i
            ...
            self.st2 = st2 if st2 is not None else _M_Test.InnerStruct2()
            self.dict = dict
        ...
        def __eq__(self, other):
            if other is None:
                ...
                if self.bs != other.bs:
                    return False
                if self.iseq != other.iseq:
                    return False
                if self.st != other.st:
                    return False
                if self.st2 != other.st2:
                    return False
        ...
        def __repr__(self):
            return f"Test.StructNoDefaults({Ice.Util.format_fields(bo=self.bo, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, c1=self.c1, bs=self.bs, iseq=self.iseq, st=self.st, st2=self.st2, dict=self.dict)})"
    ...
    _M_Test._t_StructNoDefaults = IcePy.defineStruct("::Test::StructNoDefaults", StructNoDefaults, (), (
        ...
        ("iseq", (), _M_Test._t_IntSeq),
        ("st", (), _M_Test._t_InnerStruct),
        ("st2", (), _M_Test._t_InnerStruct2),
...
if "ExceptionNoDefaultsBase" not in _M_Test.__dict__:
    ...
    class ExceptionNoDefaultsBase(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.ExceptionNoDefaultsBase({Ice.Util.format_fields(str=self.str, c1=self.c1, bs=self.bs)})"
...
if "ExceptionNoDefaults" not in _M_Test.__dict__:
    ...
    class ExceptionNoDefaults(_M_Test.ExceptionNoDefaultsBase):
        def __init__(self, str="", c1=_M_Test.Color.red, bs=None, st=None, st2=None, dict=None):
        ...
        def __repr__(self):
            return f"Test.ExceptionNoDefaults({Ice.Util.format_fields(str=self.str, c1=self.c1, bs=self.bs, st=self.st, st2=self.st2, dict=self.dict)})"
    ...
    _M_Test._t_ExceptionNoDefaults = IcePy.defineException("::Test::ExceptionNoDefaults", ExceptionNoDefaults, (), _M_Test._t_ExceptionNoDefaultsBase, (
        ...
        ("st2", (), _M_Test._t_InnerStruct2, False, 0),
...
if "ClassNoDefaultsBase" not in _M_Test.__dict__:
    ...
    class ClassNoDefaultsBase(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.ClassNoDefaultsBase({Ice.Util.format_fields(str=self.str, c1=self.c1, bs=self.bs)})"
...
if "ClassNoDefaults" not in _M_Test.__dict__:
    ...
    class ClassNoDefaults(_M_Test.ClassNoDefaultsBase):
        ...
        def __repr__(self):
            return f"Test.ClassNoDefaults({Ice.Util.format_fields(str=self.str, c1=self.c1, bs=self.bs, st=self.st, st2=self.st2, dict=self.dict)})"
