...
if 'ClassProperty' not in _M_Test.__dict__:
    _M_Test.ClassProperty = Ice.createTempClass()
    class ClassProperty(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_ClassProperty)

        __repr__ = __str__

    _M_Test._t_ClassProperty = IcePy.defineValue('::Test::ClassProperty', ClassProperty, -1, (), False, False, None, (
        ('boolFalse', (), IcePy._t_bool, False, 0),
        ('boolTrue', (), IcePy._t_bool, False, 0),
        ('b', (), IcePy._t_byte, False, 0),
        ('s', (), IcePy._t_short, False, 0),
...
if 'StructProperty' not in _M_Test.__dict__:
    _M_Test.StructProperty = Ice.createTempClass()
    class StructProperty(object):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_StructProperty)
...
if 'ExceptionProperty' not in _M_Test.__dict__:
    _M_Test.ExceptionProperty = Ice.createTempClass()
    ...
    _M_Test._t_ExceptionProperty = IcePy.defineException('::Test::ExceptionProperty', ExceptionProperty, (), False, None, (
        ('boolFalse', (), IcePy._t_bool, False, 0),
        ('boolTrue', (), IcePy._t_bool, False, 0),
        ('b', (), IcePy._t_byte, False, 0),
        ('s', (), IcePy._t_short, False, 0),
...
if 'InnerStruct2' not in _M_Test.__dict__:
    _M_Test.InnerStruct2 = Ice.createTempClass()
    class InnerStruct2(object):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_InnerStruct2)
...
if 'StructNoDefaults' not in _M_Test.__dict__:
    ...
    class StructNoDefaults(object):
        def __init__(self, bo=False, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str='', c1=_M_Test.Color.red, bs=None, iseq=None, st=Ice._struct_marker, st2=Ice._struct_marker, dict=None):
            self.bo = bo
            self.b = b
            self.s = s
            self.i = i
            ...
            if st is Ice._struct_marker:
                ...
                self.st = st
            if st2 is Ice._struct_marker:
                self.st2 = _M_Test.InnerStruct2()
            else:
                self.st2 = st2
            self.dict = dict
...
if 'ExceptionNoDefaults' not in _M_Test.__dict__:
    ...
    class ExceptionNoDefaults(_M_Test.ExceptionNoDefaultsBase):
        def __init__(self, str='', c1=_M_Test.Color.red, bs=None, st=Ice._struct_marker, st2=Ice._struct_marker, dict=None):
