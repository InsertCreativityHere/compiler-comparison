...
from Test.RemoteCommunicatorFactory_forward import _Test_RemoteCommunicatorFactoryPrx_t
...
if TYPE_CHECKING:
    ...
    from Test.RemoteCommunicator import RemoteCommunicatorPrx
...
RemoteCommunicatorFactory._op_createCommunicator = IcePy.Operation(
    ...
    (),
    ((), _Test_RemoteCommunicatorPrx_t, False, 0),
    ())
...
__all__ = ["RemoteCommunicatorFactory", "RemoteCommunicatorFactoryPrx", "_Test_RemoteCommunicatorFactoryPrx_t"]
