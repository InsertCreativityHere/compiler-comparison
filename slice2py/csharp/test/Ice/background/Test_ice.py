...
_M_Test._t_Background = IcePy.defineValue('::Test::Background', Ice.Value, -1, (), False, True, None, ())
...
_M_Test._t_BackgroundController = IcePy.defineValue('::Test::BackgroundController', Ice.Value, -1, (), False, True, None, ())
