...
class PriorityPrx(ObjectPrx):
    ...
    def getPriority(self, context: dict[str, str] | None = None) -> str:
        return Priority._op_getPriority.invoke(self, ((), context))

    def getPriorityAsync(self, context: dict[str, str] | None = None) -> Awaitable[str]:
...
class Priority(Object, ABC):
    ...
    @abstractmethod
    def getPriority(self, current: Current) -> str | Awaitable[str]:
        pass
