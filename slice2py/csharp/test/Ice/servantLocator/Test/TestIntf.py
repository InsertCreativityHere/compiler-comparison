...
class TestIntfPrx(ObjectPrx):
    ...
    def csException(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_csException.invoke(self, ((), context))

    def csExceptionAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_csException.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_csException: IcePy.Operation
    ...
    @abstractmethod
    def csException(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_csException = IcePy.Operation(
    "csException",
    "csException",
    OperationMode.Normal,
    None,
