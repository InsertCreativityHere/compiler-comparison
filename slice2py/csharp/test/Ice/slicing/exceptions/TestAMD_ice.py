...
if "Base" not in _M_Test.__dict__:
    ...
    class Base(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.Base({Ice.Util.format_fields(b=self.b)})"
...
if "KnownDerived" not in _M_Test.__dict__:
    ...
    class KnownDerived(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.KnownDerived({Ice.Util.format_fields(b=self.b, kd=self.kd)})"
...
if "KnownIntermediate" not in _M_Test.__dict__:
    ...
    class KnownIntermediate(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.KnownIntermediate({Ice.Util.format_fields(b=self.b, ki=self.ki)})"
...
if "KnownMostDerived" not in _M_Test.__dict__:
    ...
    class KnownMostDerived(_M_Test.KnownIntermediate):
        ...
        def __repr__(self):
            return f"Test.KnownMostDerived({Ice.Util.format_fields(b=self.b, ki=self.ki, kmd=self.kmd)})"
...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    TestIntf._op_baseAsBase = IcePy.Operation("baseAsBase", "baseAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_unknownDerivedAsBase = IcePy.Operation("unknownDerivedAsBase", "unknownDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.CompactFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownDerivedAsBase = IcePy.Operation("knownDerivedAsBase", "knownDerivedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownDerivedAsKnownDerived = IcePy.Operation("knownDerivedAsKnownDerived", "knownDerivedAsKnownDerived", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownDerived,))
    TestIntf._op_unknownIntermediateAsBase = IcePy.Operation("unknownIntermediateAsBase", "unknownIntermediateAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownIntermediateAsBase = IcePy.Operation("knownIntermediateAsBase", "knownIntermediateAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownMostDerivedAsBase = IcePy.Operation("knownMostDerivedAsBase", "knownMostDerivedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownIntermediateAsKnownIntermediate = IcePy.Operation("knownIntermediateAsKnownIntermediate", "knownIntermediateAsKnownIntermediate", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_knownMostDerivedAsKnownIntermediate = IcePy.Operation("knownMostDerivedAsKnownIntermediate", "knownMostDerivedAsKnownIntermediate", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_knownMostDerivedAsKnownMostDerived = IcePy.Operation("knownMostDerivedAsKnownMostDerived", "knownMostDerivedAsKnownMostDerived", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownMostDerived,))
    TestIntf._op_unknownMostDerived1AsBase = IcePy.Operation("unknownMostDerived1AsBase", "unknownMostDerived1AsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_unknownMostDerived1AsKnownIntermediate = IcePy.Operation("unknownMostDerived1AsKnownIntermediate", "unknownMostDerived1AsKnownIntermediate", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_unknownMostDerived2AsBase = IcePy.Operation("unknownMostDerived2AsBase", "unknownMostDerived2AsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
