...
if 'Enum2' not in _M_Test.__dict__:
    ...
    Enum2.Enum24 = Enum2("Enum24", 3)
    Enum2._enumerators = { 0:Enum2.Enum21, 1:Enum2.Enum22, 2:Enum2.Enum23, 3:Enum2.Enum24 }
...
if 'Enum3' not in _M_Test.__dict__:
    ...
    Enum3.Enum32 = Enum3("Enum32", 0)
    Enum3.Enum33 = Enum3("Enum33", 1)
    Enum3._enumerators = { 0:Enum3.Enum32, 1:Enum3.Enum33 }
...
if 'EnumExplicit1' not in _M_Test.__dict__:
    ...
    EnumExplicit1._enumerators = { 1:EnumExplicit1.EnumExplicit11, 3:EnumExplicit1.EnumExplicit13, 2:EnumExplicit1.EnumExplicit12 }
...
if 'EnumExplicit2' not in _M_Test.__dict__:
    ...
    EnumExplicit2.EnumExplicit22 = EnumExplicit2("EnumExplicit22", 3)
    EnumExplicit2.EnumExplicit23 = EnumExplicit2("EnumExplicit23", 4)
    EnumExplicit2._enumerators = { 1:EnumExplicit2.EnumExplicit21, 3:EnumExplicit2.EnumExplicit22, 4:EnumExplicit2.EnumExplicit23 }
...
if 'EnumExplicit3' not in _M_Test.__dict__:
    ...
    EnumExplicit3._enumerators = { 1:EnumExplicit3.EnumExplicit31, 2:EnumExplicit3.EnumExplicit32 }
...
if 'Enum4' not in _M_Test.__dict__:
    ...
    class Enum4(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_Enum4)

        __repr__ = __str__

    _M_Test._t_Enum4 = IcePy.defineValue('::Test::Enum4', Enum4, -1, (), False, False, None, ())
    Enum4._ice_type = _M_Test._t_Enum4
...
if '_t_Sequence2' not in _M_Test.__dict__:
    _M_Test._t_Sequence2 = IcePy.defineSequence('::Test::Sequence2', (), IcePy._t_short)

if 'Sequence3' not in _M_Test.__dict__:
    _M_Test.Sequence3 = Ice.createTempClass()
    class Sequence3(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_Sequence3)

        __repr__ = __str__

    _M_Test._t_Sequence3 = IcePy.defineValue('::Test::Sequence3', Sequence3, -1, (), False, False, None, ())
    Sequence3._ice_type = _M_Test._t_Sequence3

    _M_Test.Sequence3 = Sequence3
    del Sequence3
...
if '_t_Dictionary2' not in _M_Test.__dict__:
    _M_Test._t_Dictionary2 = IcePy.defineDictionary('::Test::Dictionary2', (), IcePy._t_long, IcePy._t_int)

if '_t_Dictionary3' not in _M_Test.__dict__:
    _M_Test._t_Dictionary3 = IcePy.defineDictionary('::Test::Dictionary3', (), IcePy._t_string, IcePy._t_bool)

if 'Dictionary4' not in _M_Test.__dict__:
    _M_Test.Dictionary4 = Ice.createTempClass()
    class Dictionary4(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_Dictionary4)

        __repr__ = __str__

    _M_Test._t_Dictionary4 = IcePy.defineValue('::Test::Dictionary4', Dictionary4, -1, (), False, False, None, ())
    Dictionary4._ice_type = _M_Test._t_Dictionary4

    _M_Test.Dictionary4 = Dictionary4
    del Dictionary4
...
if 'Struct2' not in _M_Test.__dict__:
    ...
    class Struct2(object):
        def __init__(self, str='', b=False, f=0.0):
            self.str = str
            self.b = b
            self.f = f
...
if 'Struct4' not in _M_Test.__dict__:
    ...
    _M_Test._t_Struct4 = IcePy.defineStruct('::Test::Struct4', Struct4, (), (('b', (), IcePy._t_bool),))
...
if 'Struct5' not in _M_Test.__dict__:
    ...
    _M_Test._t_Struct5 = IcePy.defineValue('::Test::Struct5', Struct5, -1, (), False, False, None, ())
    Struct5._ice_type = _M_Test._t_Struct5
...
if 'Interface2' not in _M_Test.__dict__:
    ...
    class Interface2(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_Interface2)

        __repr__ = __str__

    _M_Test._t_Interface2 = IcePy.defineValue('::Test::Interface2', Interface2, -1, (), False, False, None, ())
    Interface2._ice_type = _M_Test._t_Interface2
...
if 'Interface3Prx' not in _M_Test.__dict__:
    ...
    class Interface3Prx(_M_Test.Interface1Prx):
    ...
    class Interface3(_M_Test.Interface1):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::Interface1', '::Test::Interface3')
    ...
    _M_Test._t_Interface3Disp = IcePy.defineClass('::Test::Interface3', Interface3, (), None, (_M_Test._t_Interface1Disp,))
...
if 'Interface4Prx' not in _M_Test.__dict__:
    ...
    class Interface4Prx(Ice.ObjectPrx):
        ...
        def opInterface4(self, context=None):
            return _M_Test.Interface4._op_opInterface4.invoke(self, ((), context))

        def opInterface4Async(self, context=None):
            return _M_Test.Interface4._op_opInterface4.invokeAsync(self, ((), context))

        def begin_opInterface4(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Interface4._op_opInterface4.begin(self, ((), _response, _ex, _sent, context))

        def end_opInterface4(self, _r):
            return _M_Test.Interface4._op_opInterface4.end(self, _r)
    ...
    class Interface4(Ice.Object):
        ...
        def opInterface4(self, current=None):
            raise NotImplementedError("servant method 'opInterface4' not implemented")
    ...
    Interface4._op_opInterface4 = IcePy.Operation('opInterface4', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
...
if 'EmptyClass2' not in _M_Test.__dict__:
    ...
    _M_Test._t_EmptyClass2 = IcePy.defineValue('::Test::EmptyClass2', EmptyClass2, -1, (), False, False, None, (('d', (), IcePy._t_double, False, 0),))
...
if 'EmptyClass3Prx' not in _M_Test.__dict__:
    _M_Test.EmptyClass3Prx = Ice.createTempClass()
    class EmptyClass3Prx(Ice.ObjectPrx):

        def newOp(self, context=None):
            return _M_Test.EmptyClass3Disp._op_newOp.invoke(self, ((), context))

        def newOpAsync(self, context=None):
            return _M_Test.EmptyClass3Disp._op_newOp.invokeAsync(self, ((), context))

        def begin_newOp(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.EmptyClass3Disp._op_newOp.begin(self, ((), _response, _ex, _sent, context))

        def end_newOp(self, _r):
            return _M_Test.EmptyClass3Disp._op_newOp.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_Test.EmptyClass3Prx.ice_checkedCast(proxy, '::Test::EmptyClass3', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_Test.EmptyClass3Prx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::Test::EmptyClass3'
    _M_Test._t_EmptyClass3Prx = IcePy.defineProxy('::Test::EmptyClass3', EmptyClass3Prx)

    _M_Test.EmptyClass3Prx = EmptyClass3Prx
    del EmptyClass3Prx

    _M_Test.EmptyClass3Disp = Ice.createTempClass()
    class EmptyClass3Disp(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::EmptyClass3')
        ...
        def newOp(self, current=None):
            raise NotImplementedError("servant method 'newOp' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_EmptyClass3Disp)

        __repr__ = __str__

    _M_Test._t_EmptyClass3Disp = IcePy.defineClass('::Test::EmptyClass3', EmptyClass3Disp, (), None, ())
    EmptyClass3Disp._ice_type = _M_Test._t_EmptyClass3Disp

    EmptyClass3Disp._op_newOp = IcePy.Operation('newOp', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())

    _M_Test.EmptyClass3Disp = EmptyClass3Disp
    del EmptyClass3Disp

if 'EmptyClass4' not in _M_Test.__dict__:
    _M_Test.EmptyClass4 = Ice.createTempClass()
    class EmptyClass4(_M_Test.EmptyClass1):
        def __init__(self):
            _M_Test.EmptyClass1.__init__(self)
    ...
    _M_Test._t_EmptyClass4 = IcePy.defineValue('::Test::EmptyClass4', EmptyClass4, -1, (), False, False, _M_Test._t_EmptyClass1, ())
...
if 'SimpleClass2Prx' not in _M_Test.__dict__:
    _M_Test.SimpleClass2Prx = Ice.createTempClass()
    class SimpleClass2Prx(Ice.ObjectPrx):

        def newOp(self, context=None):
            return _M_Test.SimpleClass2Disp._op_newOp.invoke(self, ((), context))

        def newOpAsync(self, context=None):
            return _M_Test.SimpleClass2Disp._op_newOp.invokeAsync(self, ((), context))

        def begin_newOp(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.SimpleClass2Disp._op_newOp.begin(self, ((), _response, _ex, _sent, context))

        def end_newOp(self, _r):
            return _M_Test.SimpleClass2Disp._op_newOp.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_Test.SimpleClass2Prx.ice_checkedCast(proxy, '::Test::SimpleClass2', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_Test.SimpleClass2Prx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::Test::SimpleClass2'
    _M_Test._t_SimpleClass2Prx = IcePy.defineProxy('::Test::SimpleClass2', SimpleClass2Prx)

    _M_Test.SimpleClass2Prx = SimpleClass2Prx
    del SimpleClass2Prx

    _M_Test.SimpleClass2Disp = Ice.createTempClass()
    class SimpleClass2Disp(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::SimpleClass2')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_SimpleClass2Disp)

        __repr__ = __str__

    _M_Test._t_SimpleClass2Disp = IcePy.defineClass('::Test::SimpleClass2', SimpleClass2Disp, (), None, ())
    SimpleClass2Disp._ice_type = _M_Test._t_SimpleClass2Disp

    SimpleClass2Disp._op_newOp = IcePy.Operation('newOp', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())

    _M_Test.SimpleClass2Disp = SimpleClass2Disp
    del SimpleClass2Disp

if 'SimpleClass3' not in _M_Test.__dict__:
    _M_Test.SimpleClass3 = Ice.createTempClass()
    class SimpleClass3(Ice.Value):
        def __init__(self, str='', g=0.0):
            self.str = str
            self.g = g
...
if 'SimpleClass4' not in _M_Test.__dict__:
    ...
    class SimpleClass4(Ice.Value):
        def __init__(self, str='', f=0.0, b=False):
            self.str = str
            self.f = f
            self.b = b
...
if 'SimpleClass5' not in _M_Test.__dict__:
    ...
    _M_Test._t_SimpleClass5 = IcePy.defineValue('::Test::SimpleClass5', SimpleClass5, -1, (), False, False, None, (('str', (), IcePy._t_string, False, 0),))
...
if 'Exception4' not in _M_Test.__dict__:
    ...
    _M_Test._t_Exception4 = IcePy.defineException('::Test::Exception4', Exception4, (), False, None, (('b', (), IcePy._t_bool, False, 0),))
...
if 'Exception5' not in _M_Test.__dict__:
    ...
    class Exception5(_M_Test.Exception1):
        def __init__(self, str='', b=False):
            _M_Test.Exception1.__init__(self, str, b)
    ...
    _M_Test._t_Exception5 = IcePy.defineException('::Test::Exception5', Exception5, (), False, _M_Test._t_Exception1, ())
...
if 'Exception6' not in _M_Test.__dict__:
    ...
    class Exception6(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_Exception6)

        __repr__ = __str__

    _M_Test._t_Exception6 = IcePy.defineValue('::Test::Exception6', Exception6, -1, (), False, False, None, ())
...
if 'OptionalEx1' not in _M_Test.__dict__:
    ...
    class OptionalEx1(Ice.UserException):
        def __init__(self, firstName='', emailAddress=Ice.Unset, secondName=Ice.Unset):
            self.firstName = firstName
            self.emailAddress = emailAddress
            self.secondName = secondName
...
if 'OptionalEx2' not in _M_Test.__dict__:
    ...
    class OptionalEx2(Ice.UserException):
        def __init__(self, firstName='', secondName=Ice.Unset, emailAddress=''):
            self.firstName = firstName
            self.secondName = secondName
            self.emailAddress = emailAddress
    ...
    _M_Test._t_OptionalEx2 = IcePy.defineException('::Test::OptionalEx2', OptionalEx2, (), False, None, (
        ('firstName', (), IcePy._t_string, False, 0),
        ('secondName', (), IcePy._t_string, True, 1),
        ('emailAddress', (), IcePy._t_string, False, 0)
    ))
...
if 'OptionalEx3' not in _M_Test.__dict__:
    ...
    class OptionalEx3(Ice.UserException):
        def __init__(self, firstName='', secondName=Ice.Unset, emailAddress=Ice.Unset, phoneNumber=Ice.Unset):
            self.firstName = firstName
            self.secondName = secondName
            self.emailAddress = emailAddress
    ...
    _M_Test._t_OptionalEx3 = IcePy.defineException('::Test::OptionalEx3', OptionalEx3, (), False, None, (
        ...
        ('secondName', (), IcePy._t_string, True, 1),
        ('emailAddress', (), IcePy._t_string, True, 2),
        ('phoneNumber', (), IcePy._t_string, True, 3)
    ))
...
if 'OptionalEx4' not in _M_Test.__dict__:
    ...
    _M_Test._t_OptionalEx4 = IcePy.defineException('::Test::OptionalEx4', OptionalEx4, (), False, None, (
        ('firstName', (), IcePy._t_string, False, 0),
        ('secondName', (), IcePy._t_string, True, 2),
...
if 'BaseInterface2Prx' not in _M_Test.__dict__:
    ...
    BaseInterface2._op_baseOp = IcePy.Operation('baseOp', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), IcePy._t_int, False, 0), ())
...
if 'BaseInterface3Prx' not in _M_Test.__dict__:
    ...
    class BaseInterface3Prx(Ice.ObjectPrx):
        ...
        def baseOp(self, o, context=None):
            return _M_Test.BaseInterface3._op_baseOp.invoke(self, ((o, ), context))

        def baseOpAsync(self, o, context=None):
            return _M_Test.BaseInterface3._op_baseOp.invokeAsync(self, ((o, ), context))

        def begin_baseOp(self, o, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.BaseInterface3._op_baseOp.begin(self, ((o, ), _response, _ex, _sent, context))
    ...
    class BaseInterface3(Ice.Object):
        ...
        def baseOp(self, o, current=None):
            raise NotImplementedError("servant method 'baseOp' not implemented")
    ...
    BaseInterface3._op_baseOp = IcePy.Operation('baseOp', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_Value, False, 0),), (), None, ())
...
if 'BaseInterface4Prx' not in _M_Test.__dict__:
    ...
    BaseInterface4._op_baseOp2 = IcePy.Operation('baseOp2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (((), IcePy._t_string, False, 0),), None, (_M_Test._t_Exception1, _M_Test._t_Exception2))
...
if 'BaseInterface5Prx' not in _M_Test.__dict__:
    ...
    class BaseInterface5Prx(Ice.ObjectPrx):
        ...
        def baseOp2(self, i, s, context=None):
            return _M_Test.BaseInterface5._op_baseOp2.invoke(self, ((i, s), context))

        def baseOp2Async(self, i, s, context=None):
            return _M_Test.BaseInterface5._op_baseOp2.invokeAsync(self, ((i, s), context))

        def begin_baseOp2(self, i, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.BaseInterface5._op_baseOp2.begin(self, ((i, s), _response, _ex, _sent, context))
    ...
    class BaseInterface5(Ice.Object):
        ...
        def baseOp2(self, i, s, current=None):
            raise NotImplementedError("servant method 'baseOp2' not implemented")
...
if 'BaseInterface6Prx' not in _M_Test.__dict__:
    ...
    class BaseInterface6Prx(Ice.ObjectPrx):
        ...
        def baseOp2(self, context=None):
            return _M_Test.BaseInterface6._op_baseOp2.invoke(self, ((), context))

        def baseOp2Async(self, context=None):
            return _M_Test.BaseInterface6._op_baseOp2.invokeAsync(self, ((), context))

        def begin_baseOp2(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.BaseInterface6._op_baseOp2.begin(self, ((), _response, _ex, _sent, context))
    ...
    BaseInterface6._op_baseOp2 = IcePy.Operation('baseOp2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (((), IcePy._t_string, False, 0),), None, (_M_Test._t_Exception1,))
...
if 'BaseInterface7Prx' not in _M_Test.__dict__:
    ...
    BaseInterface7._op_baseOp2 = IcePy.Operation('baseOp2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (((), IcePy._t_string, False, 0),), None, ())
...
if 'BaseInterface9Prx' not in _M_Test.__dict__:
    ...
    class BaseInterface9Prx(_M_Test.Interface1Prx):
    ...
    class BaseInterface9(_M_Test.Interface1):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::BaseInterface9', '::Test::Interface1')
    ...
    _M_Test._t_BaseInterface9Disp = IcePy.defineClass('::Test::BaseInterface9', BaseInterface9, (), None, (_M_Test._t_Interface1Disp,))
...
if 'BaseInterface10Prx' not in _M_Test.__dict__:
    ...
    class BaseInterface10Prx(_M_Test.Interface1Prx):
    ...
    class BaseInterface10(_M_Test.Interface1):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::BaseInterface10', '::Test::Interface1')
    ...
    _M_Test._t_BaseInterface10Disp = IcePy.defineClass('::Test::BaseInterface10', BaseInterface10, (), None, (_M_Test._t_Interface1Disp,))
...
if 'Compact2' not in _M_Test.__dict__:
    ...
    _M_Test._t_Compact2 = IcePy.defineValue('::Test::Compact2', Compact2, 3, (), False, False, None, (('id', (), IcePy._t_int, False, 0),))
...
if 'OptionalParameters1Prx' not in _M_Test.__dict__:
    ...
    class OptionalParameters1Prx(Ice.ObjectPrx):
        ...
        def op1(self, firstName, emailAddress=Ice.Unset, secondName=Ice.Unset, context=None):
            return _M_Test.OptionalParameters1._op_op1.invoke(self, ((firstName, emailAddress, secondName), context))

        def op1Async(self, firstName, emailAddress, secondName, context=None):
            return _M_Test.OptionalParameters1._op_op1.invokeAsync(self, ((firstName, emailAddress, secondName), context))

        def begin_op1(self, firstName, emailAddress, secondName, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.OptionalParameters1._op_op1.begin(self, ((firstName, emailAddress, secondName), _response, _ex, _sent, context))
    ...
    OptionalParameters1._op_op1 = IcePy.Operation('op1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, True, 2), ((), IcePy._t_string, True, 1)), (), None, ())
...
if 'OptionalParameters2Prx' not in _M_Test.__dict__:
    ...
    OptionalParameters2._op_op1 = IcePy.Operation('op1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, True, 2), ((), IcePy._t_string, True, 1)), (), None, ())
...
if 'OptionalParameters3Prx' not in _M_Test.__dict__:
    ...
    class OptionalParameters3Prx(Ice.ObjectPrx):
        ...
        def op1(self, firstName, emailAddress, secondName=Ice.Unset, context=None):
    ...
    OptionalParameters3._op_op1 = IcePy.Operation('op1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, True, 1)), (), None, ())
...
if 'OptionalReturn2Prx' not in _M_Test.__dict__:
    ...
    OptionalReturn2._op_op = IcePy.Operation('op', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), IcePy._t_int, False, 0), ())
