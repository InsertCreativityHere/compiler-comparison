...
if "ByteEnum" not in _M_Test.__dict__:
    ...
    class ByteEnum(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.ByteEnum._enumerators:
                return f"Test.ByteEnum.{self._name}"
            else:
                return f"Test.ByteEnum({self._name!r}, {self._value!r})"
...
if "ShortEnum" not in _M_Test.__dict__:
    ...
    class ShortEnum(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.ShortEnum._enumerators:
                return f"Test.ShortEnum.{self._name}"
            else:
                return f"Test.ShortEnum({self._name!r}, {self._value!r})"
...
if "IntEnum" not in _M_Test.__dict__:
    ...
    class IntEnum(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.IntEnum._enumerators:
                return f"Test.IntEnum.{self._name}"
            else:
                return f"Test.IntEnum({self._name!r}, {self._value!r})"
...
if "SimpleEnum" not in _M_Test.__dict__:
    ...
    class SimpleEnum(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.SimpleEnum._enumerators:
                return f"Test.SimpleEnum.{self._name}"
            else:
                return f"Test.SimpleEnum({self._name!r}, {self._value!r})"
...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    TestIntf._op_opByte = IcePy.Operation("opByte", "opByte", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteEnum, False, 0),), (((), _M_Test._t_ByteEnum, False, 0),), ((), _M_Test._t_ByteEnum, False, 0), ())
    TestIntf._op_opShort = IcePy.Operation("opShort", "opShort", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ShortEnum, False, 0),), (((), _M_Test._t_ShortEnum, False, 0),), ((), _M_Test._t_ShortEnum, False, 0), ())
    TestIntf._op_opInt = IcePy.Operation("opInt", "opInt", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntEnum, False, 0),), (((), _M_Test._t_IntEnum, False, 0),), ((), _M_Test._t_IntEnum, False, 0), ())
    TestIntf._op_opSimple = IcePy.Operation("opSimple", "opSimple", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SimpleEnum, False, 0),), (((), _M_Test._t_SimpleEnum, False, 0),), ((), _M_Test._t_SimpleEnum, False, 0), ())
    TestIntf._op_opByteSeq = IcePy.Operation("opByteSeq", "opByteSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteEnumSeq, False, 0),), (((), _M_Test._t_ByteEnumSeq, False, 0),), ((), _M_Test._t_ByteEnumSeq, False, 0), ())
    TestIntf._op_opShortSeq = IcePy.Operation("opShortSeq", "opShortSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ShortEnumSeq, False, 0),), (((), _M_Test._t_ShortEnumSeq, False, 0),), ((), _M_Test._t_ShortEnumSeq, False, 0), ())
    TestIntf._op_opIntSeq = IcePy.Operation("opIntSeq", "opIntSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntEnumSeq, False, 0),), (((), _M_Test._t_IntEnumSeq, False, 0),), ((), _M_Test._t_IntEnumSeq, False, 0), ())
    TestIntf._op_opSimpleSeq = IcePy.Operation("opSimpleSeq", "opSimpleSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SimpleEnumSeq, False, 0),), (((), _M_Test._t_SimpleEnumSeq, False, 0),), ((), _M_Test._t_SimpleEnumSeq, False, 0), ())
