...
if 'TEstNv' not in _M_Test.__dict__:
    _M_Test.TEstNv = Ice.createTempClass()
    class TEstNv(object):
        ...
        def __eq__(self, other):
            if other is None:
                return False
            elif not isinstance(other, _M_Test.TEstNv):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_TEstNv)

        __repr__ = __str__

    _M_Test._t_TEstNv = IcePy.defineStruct('::Test::TEstNv', TEstNv, (), (
        ('d', (), _M_Test._t_NV),
        ('s', (), _M_Test._t_IntSeq)
    ))

    _M_Test.TEstNv = TEstNv
    del TEstNv
...
if 'MyClassPrx' not in _M_Test.__dict__:
    ...
    MyClass._op_opNV = IcePy.Operation('opNV', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NV, False, 0),), (((), _M_Test._t_NV, False, 0),), ((), _M_Test._t_NV, False, 0), ())
    MyClass._op_opNR = IcePy.Operation('opNR', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NR, False, 0),), (((), _M_Test._t_NR, False, 0),), ((), _M_Test._t_NR, False, 0), ())
    MyClass._op_opNDV = IcePy.Operation('opNDV', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDV, False, 0),), (((), _M_Test._t_NDV, False, 0),), ((), _M_Test._t_NDV, False, 0), ())
    MyClass._op_opNDR = IcePy.Operation('opNDR', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDR, False, 0),), (((), _M_Test._t_NDR, False, 0),), ((), _M_Test._t_NDR, False, 0), ())
    MyClass._op_opNDAIS = IcePy.Operation('opNDAIS', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDAIS, False, 0),), (((), _M_Test._t_NDAIS, False, 0),), ((), _M_Test._t_NDAIS, False, 0), ())
    MyClass._op_opNDGIS = IcePy.Operation('opNDGIS', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDGIS, False, 0),), (((), _M_Test._t_NDGIS, False, 0),), ((), _M_Test._t_NDGIS, False, 0), ())
    MyClass._op_opNDASS = IcePy.Operation('opNDASS', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDASS, False, 0),), (((), _M_Test._t_NDASS, False, 0),), ((), _M_Test._t_NDASS, False, 0), ())
    MyClass._op_opNDGSS = IcePy.Operation('opNDGSS', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_NDGSS, False, 0),), (((), _M_Test._t_NDGSS, False, 0),), ((), _M_Test._t_NDGSS, False, 0), ())
