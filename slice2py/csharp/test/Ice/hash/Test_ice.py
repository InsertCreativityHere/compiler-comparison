...
if "InvalidPointException" not in _M_Test.__dict__:
    ...
    class InvalidPointException(_M_Test.BaseException):
        ...
        def __repr__(self):
            return f"Test.InvalidPointException({Ice.Util.format_fields(index=self.index)})"
...
if "InvalidLengthException" not in _M_Test.__dict__:
    ...
    class InvalidLengthException(_M_Test.BaseException):
        ...
        def __repr__(self):
            return f"Test.InvalidLengthException({Ice.Util.format_fields(length=self.length)})"
...
if "OtherException" not in _M_Test.__dict__:
    ...
    class OtherException(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.OtherException({Ice.Util.format_fields(x=self.x, y=self.y, z=self.z, b=self.b)})"
...
if "PointF" not in _M_Test.__dict__:
    ...
    class PointF(object):
        ...
        def __repr__(self):
            return f"Test.PointF({Ice.Util.format_fields(x=self.x, y=self.y, z=self.z)})"
...
if "PointD" not in _M_Test.__dict__:
    ...
    class PointD(object):
        ...
        def __repr__(self):
            return f"Test.PointD({Ice.Util.format_fields(x=self.x, y=self.y, z=self.z)})"
...
if "Point" not in _M_Test.__dict__:
    ...
    class Point(object):
        ...
        def __repr__(self):
            return f"Test.Point({Ice.Util.format_fields(x=self.x, y=self.y)})"
...
if "Polyline" not in _M_Test.__dict__:
    ...
    class Polyline(object):
        ...
        def __repr__(self):
            return f"Test.Polyline({Ice.Util.format_fields(vertices=self.vertices)})"
...
if "Color" not in _M_Test.__dict__:
    ...
    class Color(object):
        ...
        def __repr__(self):
            return f"Test.Color({Ice.Util.format_fields(r=self.r, g=self.g, b=self.b, a=self.a)})"
...
if "ColorPalette" not in _M_Test.__dict__:
    ...
    class ColorPalette(object):
        ...
        def __repr__(self):
            return f"Test.ColorPalette({Ice.Util.format_fields(colors=self.colors)})"
...
if "Pen" not in _M_Test.__dict__:
    ...
    class Pen(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Pen({Ice.Util.format_fields(thickness=self.thickness, color=self.color)})"
...
if "Draw" not in _M_Test.__dict__:
    ...
    class Draw(object):
        ...
        def __repr__(self):
            return f"Test.Draw({Ice.Util.format_fields(backgroundColor=self.backgroundColor, pen=self.pen, shared=self.shared)})"
