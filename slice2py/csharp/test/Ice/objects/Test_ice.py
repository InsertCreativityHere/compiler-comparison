...
if 'IBase' not in _M_Test.__dict__:
    ...
    class IBase(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_IBase)
...
if 'IDerived' not in _M_Test.__dict__:
    ...
    class IDerived(_M_Test.IBase):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_IDerived)
...
if 'IDerived2' not in _M_Test.__dict__:
    ...
    class IDerived2(_M_Test.IBase):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_IDerived2)
...
if 'I2' not in _M_Test.__dict__:
    ...
    class I2(Ice.Value):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_I2)
...
if 'SC1' not in _M_Test.__dict__:
    ...
    class SC1(object):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Test._t_SC1)
