...
if "IBase" not in _M_Test.__dict__:
    _M_Test._t_IBase = IcePy.declareValue("::Test::IBase")

if "IBase" not in _M_Test.__dict__:
    _M_Test.IBase = None
    class IBase(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.IBase({Ice.Util.format_fields(id=self.id)})"

    _M_Test._t_IBase = IcePy.defineValue("::Test::IBase", IBase, -1, (), False, None, (("id", (), IcePy._t_string, False, 0),))
    IBase._ice_type = _M_Test._t_IBase

    _M_Test.IBase = IBase
    del IBase

if "IDerived" not in _M_Test.__dict__:
    _M_Test._t_IDerived = IcePy.declareValue("::Test::IDerived")

if "IDerived" not in _M_Test.__dict__:
    _M_Test.IDerived = None
    class IDerived(_M_Test.IBase):
        def __init__(self, id="", name=""):
            _M_Test.IBase.__init__(self, id)
            self.name = name
        ...
        def __repr__(self):
            return f"Test.IDerived({Ice.Util.format_fields(id=self.id, name=self.name)})"

    _M_Test._t_IDerived = IcePy.defineValue("::Test::IDerived", IDerived, -1, (), False, _M_Test._t_IBase, (("name", (), IcePy._t_string, False, 0),))
    IDerived._ice_type = _M_Test._t_IDerived

    _M_Test.IDerived = IDerived
    del IDerived

if "IDerived2" not in _M_Test.__dict__:
    _M_Test._t_IDerived2 = IcePy.declareValue("::Test::IDerived2")

if "IDerived2" not in _M_Test.__dict__:
    _M_Test.IDerived2 = None
    class IDerived2(_M_Test.IBase):
        def __init__(self, id=""):
            _M_Test.IBase.__init__(self, id)
        ...
        def __repr__(self):
            return f"Test.IDerived2({Ice.Util.format_fields(id=self.id)})"

    _M_Test._t_IDerived2 = IcePy.defineValue("::Test::IDerived2", IDerived2, -1, (), False, _M_Test._t_IBase, ())
    IDerived2._ice_type = _M_Test._t_IDerived2

    _M_Test.IDerived2 = IDerived2
    del IDerived2

if "I2" not in _M_Test.__dict__:
    _M_Test._t_I2 = IcePy.declareValue("::Test::I2")
...
if "I2" not in _M_Test.__dict__:
    ...
    _M_Test._t_I2 = IcePy.defineValue("::Test::I2", I2, -1, (), False, None, ())
    I2._ice_type = _M_Test._t_I2
...
if "S1" not in _M_Test.__dict__:
    ...
    class S1(object):
        ...
        def __repr__(self):
            return f"Test.S1({Ice.Util.format_fields(id=self.id)})"

        def __str__(self):
            return repr(self)

    _M_Test._t_S1 = IcePy.defineStruct("::Test::S1", S1, (), (("id", (), IcePy._t_int),))

    _M_Test.S1 = S1
    del S1

if "SC1" not in _M_Test.__dict__:
    _M_Test.SC1 = None
    class SC1(object):
        def __init__(self, id=""):
            self.id = id
        ...
        def __compare(self, other):
            if other is None:
                return 1
            elif not isinstance(other, _M_Test.SC1):
                return NotImplemented
            else:
                if self.id is None or other.id is None:
                    if self.id != other.id:
        ...
        def __repr__(self):
            return f"Test.SC1({Ice.Util.format_fields(id=self.id)})"

        def __str__(self):
            return repr(self)

    _M_Test._t_SC1 = IcePy.defineStruct("::Test::SC1", SC1, (), (("id", (), IcePy._t_string),))
