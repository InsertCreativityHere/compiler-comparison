...
if 'IBase' not in _M_Test.__dict__:
    _M_Test.IBase = Ice.createTempClass()
    ...
    _M_Test._t_IBase = IcePy.defineValue('::Test::IBase', IBase, -1, (), False, False, None, (('id', (), IcePy._t_string, False, 0),))
...
if 'IDerived' not in _M_Test.__dict__:
    _M_Test.IDerived = Ice.createTempClass()
    ...
    _M_Test._t_IDerived = IcePy.defineValue('::Test::IDerived', IDerived, -1, (), False, False, _M_Test._t_IBase, (('name', (), IcePy._t_string, False, 0),))
...
if 'IDerived2' not in _M_Test.__dict__:
    _M_Test.IDerived2 = Ice.createTempClass()
    ...
    _M_Test._t_IDerived2 = IcePy.defineValue('::Test::IDerived2', IDerived2, -1, (), False, False, _M_Test._t_IBase, ())
...
if 'I2' not in _M_Test.__dict__:
    _M_Test.I2 = Ice.createTempClass()
    class I2(Ice.Value):
        def __init__(self):
            pass
    ...
    _M_Test._t_I2 = IcePy.defineValue('::Test::I2', I2, -1, (), False, False, None, ())
...
if 'SC1' not in _M_Test.__dict__:
    _M_Test.SC1 = Ice.createTempClass()
    class SC1(object):
        def __init__(self, id=''):
            self.id = id
