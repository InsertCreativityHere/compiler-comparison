...
if "IntfPrx" not in _M_Clash.__dict__:
    ...
    class IntfPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Clash.IntfPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Clash.IntfPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Clash.IntfPrx, proxy, facet)
    ...
    class Intf(Ice.Object):
        ...
        def response(self, current):
            raise NotImplementedError("servant method 'response' not implemented")

        def typeId(self, current):
            raise NotImplementedError("servant method 'typeId' not implemented")

        def del(self, current):
            raise NotImplementedError("servant method 'del' not implemented")

        def cookie(self, current):
        ...
        def inS(self, current):
            raise NotImplementedError("servant method 'inS' not implemented")

        def istr(self, current):
            raise NotImplementedError("servant method 'istr' not implemented")

        def obj(self, current):
            raise NotImplementedError("servant method 'obj' not implemented")

        def op(self, context, current, response, ex, sent, cookie, sync, result, istr, ostr, proxy, obj, current_):
            raise NotImplementedError("servant method 'op' not implemented")

        def opOut(self, current_):
            raise NotImplementedError("servant method 'opOut' not implemented")

    Intf._op_context = IcePy.Operation("context", "context", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_current = IcePy.Operation("current", "current", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_response = IcePy.Operation("response", "response", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_typeId = IcePy.Operation("typeId", "typeId", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_del = IcePy.Operation("del", "del", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_cookie = IcePy.Operation("cookie", "cookie", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_sync = IcePy.Operation("sync", "sync", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_inS = IcePy.Operation("inS", "inS", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_istr = IcePy.Operation("istr", "istr", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_obj = IcePy.Operation("obj", "obj", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Intf._op_op = IcePy.Operation("op", "op", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, True, 1), ((), IcePy._t_int, True, 2)), (), None, ())
    Intf._op_opOut = IcePy.Operation("opOut", "opOut", Ice.OperationMode.Normal, None, (), (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, True, 1), ((), IcePy._t_int, True, 2)), None, ())
...
if "Cls" not in _M_Clash.__dict__:
    _M_Clash.Cls = None
    class Cls(Ice.Value):
        def __init__(self, s=None, context="", current=0, response=0, typeId=0, del=0, cookie=None, ex="", result=0, istr="", ostr="", inS="", in="", proxy="", obj=0, getCookie=0, clone=""):
            self.s = s
        ...
        def __repr__(self):
            return f"Clash.Cls({Ice.Util.format_fields(s=self.s, context=self.context, current=self.current, response=self.response, typeId=self.typeId, del=self.del, cookie=self.cookie, ex=self.ex, result=self.result, istr=self.istr, ostr=self.ostr, inS=self.inS, in=self.in, proxy=self.proxy, obj=self.obj, getCookie=self.getCookie, clone=self.clone)})"
...
if "St" not in _M_Clash.__dict__:
    ...
    class St(object):
        ...
        def __repr__(self):
            return f"Clash.St({Ice.Util.format_fields(v=self.v, istr=self.istr, ostr=self.ostr, rhs=self.rhs, hashCode=self.hashCode, clone=self.clone)})"
...
if "Ex" not in _M_Clash.__dict__:
    ...
    class Ex(Ice.UserException):
        ...
        def __repr__(self):
            return f"Clash.Ex({Ice.Util.format_fields(istr=self.istr, ostr=self.ostr, cause=self.cause)})"
