...
if "SubscriberRecordKey" not in _M_IceStorm.__dict__:
    ...
    class SubscriberRecordKey(object):
        ...
        def __repr__(self):
            return f"IceStorm.SubscriberRecordKey({Ice.Util.format_fields(topic=self.topic, id=self.id)})"
...
if "SubscriberRecord" not in _M_IceStorm.__dict__:
    ...
    class SubscriberRecord(object):
        ...
        def __repr__(self):
            return f"IceStorm.SubscriberRecord({Ice.Util.format_fields(topicName=self.topicName, id=self.id, link=self.link, obj=self.obj, theQoS=self.theQoS, cost=self.cost, theTopic=self.theTopic)})"
