...
import DataStorm_SampleEvent_ice
...
if "ClearHistoryPolicy" not in _M_DataStormContract.__dict__:
    ...
    class ClearHistoryPolicy(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_DataStormContract.ClearHistoryPolicy._enumerators:
                return f"DataStormContract.ClearHistoryPolicy.{self._name}"
            else:
                return f"DataStormContract.ClearHistoryPolicy({self._name!r}, {self._value!r})"
...
if "DataSample" not in _M_DataStormContract.__dict__:
    ...
    class DataSample(object):
        ...
        def __repr__(self):
            return f"DataStormContract.DataSample({Ice.Util.format_fields(id=self.id, keyId=self.keyId, keyValue=self.keyValue, timestamp=self.timestamp, tag=self.tag, event=self.event, value=self.value)})"
...
if "DataSamples" not in _M_DataStormContract.__dict__:
    ...
    class DataSamples(object):
        ...
        samples : list[DataStormContract.DataSample]
        ...
        def __repr__(self):
            return f"DataStormContract.DataSamples({Ice.Util.format_fields(id=self.id, samples=self.samples)})"
...
if "ElementInfo" not in _M_DataStormContract.__dict__:
    ...
    class ElementInfo(object):
        ...
        def __repr__(self):
            return f"DataStormContract.ElementInfo({Ice.Util.format_fields(id=self.id, name=self.name, value=self.value)})"
...
if "TopicInfo" not in _M_DataStormContract.__dict__:
    ...
    class TopicInfo(object):
        ...
        def __repr__(self):
            return f"DataStormContract.TopicInfo({Ice.Util.format_fields(name=self.name, ids=self.ids)})"
...
if "TopicSpec" not in _M_DataStormContract.__dict__:
    ...
    class TopicSpec(object):
        ...
        name : str
            The name of the topic.
        elements : list[DataStormContract.ElementInfo]
            The topic's keys and filters.
        tags : list[DataStormContract.ElementInfo]
        ...
        def __repr__(self):
            return f"DataStormContract.TopicSpec({Ice.Util.format_fields(id=self.id, name=self.name, elements=self.elements, tags=self.tags)})"
...
if "FilterInfo" not in _M_DataStormContract.__dict__:
    ...
    class FilterInfo(object):
        ...
        def __repr__(self):
            return f"DataStormContract.FilterInfo({Ice.Util.format_fields(name=self.name, criteria=self.criteria)})"
...
if "ElementConfig" not in _M_DataStormContract.__dict__:
    ...
    class ElementConfig(Ice.Value):
        ...
        def __repr__(self):
            return f"DataStormContract.ElementConfig({Ice.Util.format_fields(facet=self.facet, sampleFilter=self.sampleFilter, name=self.name, priority=self.priority, sampleCount=self.sampleCount, sampleLifetime=self.sampleLifetime, clearHistory=self.clearHistory)})"
...
if "ElementData" not in _M_DataStormContract.__dict__:
    ...
    class ElementData(object):
        ...
        def __repr__(self):
            return f"DataStormContract.ElementData({Ice.Util.format_fields(id=self.id, config=self.config, lastIds=self.lastIds)})"
...
if "ElementSpec" not in _M_DataStormContract.__dict__:
    ...
    class ElementSpec(object):
        ...
        Attributes
        ----------
        elements : list[DataStormContract.ElementData]
        ...
        def __repr__(self):
            return f"DataStormContract.ElementSpec({Ice.Util.format_fields(elements=self.elements, id=self.id, name=self.name, value=self.value, peerId=self.peerId, peerName=self.peerName)})"
...
if "ElementDataAck" not in _M_DataStormContract.__dict__:
    ...
    class ElementDataAck(object):
        ...
        def __repr__(self):
            return f"DataStormContract.ElementDataAck({Ice.Util.format_fields(id=self.id, config=self.config, lastIds=self.lastIds, samples=self.samples, peerId=self.peerId)})"
...
if "ElementSpecAck" not in _M_DataStormContract.__dict__:
    ...
    class ElementSpecAck(object):
        ...
        Attributes
        ----------
        elements : list[DataStormContract.ElementDataAck]
        ...
        def __repr__(self):
            return f"DataStormContract.ElementSpecAck({Ice.Util.format_fields(elements=self.elements, id=self.id, name=self.name, value=self.value, peerId=self.peerId, peerName=self.peerName)})"
...
if "SessionPrx" not in _M_DataStormContract.__dict__:
    ...
    class SessionPrx(Ice.ObjectPrx):
        ...
        def announceTopics(self, topics, initialize, context=None):
            ...
            Parameters
            ----------
            topics : list[DataStormContract.TopicInfo]
        ...
        def attachElements(self, topicId, elements, initialize, context=None):
            ...
            topicId : int
                The unique identifier for the topic to which the elements belong.
            elements : list[DataStormContract.ElementSpec]
        ...
        def attachElementsAck(self, topicId, elements, context=None):
            ...
            topicId : int
                The unique identifier for the topic to which the elements belong.
            elements : list[DataStormContract.ElementSpecAck]
        ...
        def initSamples(self, topicId, samples, context=None):
            ...
            topicId : int
                The unique identifier for the topic.
            samples : list[DataStormContract.DataSamples]
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_DataStormContract.SessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_DataStormContract.SessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_DataStormContract.SessionPrx, proxy, facet)
    ...
    class Session(Ice.Object):
        ...
        def announceTopics(self, topics, initialize, current):
            """
            Announces topics to the peer during session establishment or when adding new topics.
        ...
        def attachTopic(self, topic, current):
            """
            This operation is invoked if the session is interested in the announced topic. Which occurs when:
        ...
        def detachTopic(self, topicId, current):
            """
            Detaches a topic from the session, typically called when the topic is destroyed.
        ...
        def attachTags(self, topicId, tags, initialize, current):
            """
            Attaches the specified tags to the subscriber of a topic.
        ...
        def detachTags(self, topicId, tags, current):
            """
            Detaches tags from the session.
        ...
        def announceElements(self, topicId, elements, current):
            """
            Announces elements associated with a topic to the peer.
        ...
        def attachElements(self, topicId, elements, initialize, current):
            """
            Attaches the specified elements to the subscribers of a topic.
        ...
        def attachElementsAck(self, topicId, elements, current):
            """
            Acknowledges the attachment of elements to the session in response to a previous attachElements request.
        ...
        def detachElements(self, topicId, elements, current):
            """
            Instructs the peer to detach specific elements associated with a topic.
        ...
        def initSamples(self, topicId, samples, current):
            """
            Initializes the subscriber with the publisher queued samples for a topic during session establishment.
    ...
    Session._op_announceTopics = IcePy.Operation("announceTopics", "announceTopics", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_TopicInfoSeq, False, 0), ((), IcePy._t_bool, False, 0)), (), None, ())
    Session._op_attachTopic = IcePy.Operation("attachTopic", "attachTopic", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_TopicSpec, False, 0),), (), None, ())
    Session._op_detachTopic = IcePy.Operation("detachTopic", "detachTopic", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0),), (), None, ())
    Session._op_attachTags = IcePy.Operation("attachTags", "attachTags", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_ElementInfoSeq, False, 0), ((), IcePy._t_bool, False, 0)), (), None, ())
    Session._op_detachTags = IcePy.Operation("detachTags", "detachTags", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_Ice._t_LongSeq, False, 0)), (), None, ())
    Session._op_announceElements = IcePy.Operation("announceElements", "announceElements", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_ElementInfoSeq, False, 0)), (), None, ())
    Session._op_attachElements = IcePy.Operation("attachElements", "attachElements", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_ElementSpecSeq, False, 0), ((), IcePy._t_bool, False, 0)), (), None, ())
    Session._op_attachElementsAck = IcePy.Operation("attachElementsAck", "attachElementsAck", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_ElementSpecAckSeq, False, 0)), (), None, ())
    Session._op_detachElements = IcePy.Operation("detachElements", "detachElements", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_Ice._t_LongSeq, False, 0)), (), None, ())
    Session._op_initSamples = IcePy.Operation("initSamples", "initSamples", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_DataSamplesSeq, False, 0)), (), None, ())
    Session._op_disconnected = IcePy.Operation("disconnected", "disconnected", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "PublisherSessionPrx" not in _M_DataStormContract.__dict__:
    ...
    class PublisherSessionPrx(_M_DataStormContract.SessionPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_DataStormContract.PublisherSessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_DataStormContract.PublisherSessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_DataStormContract.PublisherSessionPrx, proxy, facet)
...
if "SubscriberSessionPrx" not in _M_DataStormContract.__dict__:
    ...
    class SubscriberSessionPrx(_M_DataStormContract.SessionPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_DataStormContract.SubscriberSessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_DataStormContract.SubscriberSessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_DataStormContract.SubscriberSessionPrx, proxy, facet)
    ...
    class SubscriberSession(_M_DataStormContract.Session):
        ...
        def s(self, topicId, elementId, sample, current):
            """
            Queue a sample with the subscribers of the topic element.
    ...
    SubscriberSession._op_s = IcePy.Operation("s", "s", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, False, 0), ((), IcePy._t_long, False, 0), ((), _M_DataStormContract._t_DataSample, False, 0)), (), None, ())

    _M_DataStormContract.SubscriberSession = SubscriberSession
    del SubscriberSession

if "SessionCreationError" not in _M_DataStormContract.__dict__:
    _M_DataStormContract.SessionCreationError = None
    class SessionCreationError(Ice.EnumBase):
        """
        ...
        def __repr__(self):
            if self._value in _M_DataStormContract.SessionCreationError._enumerators:
                return f"DataStormContract.SessionCreationError.{self._name}"
            else:
                return f"DataStormContract.SessionCreationError({self._name!r}, {self._value!r})"

    SessionCreationError.AlreadyConnected = SessionCreationError("AlreadyConnected", 0)
    SessionCreationError.NodeShutdown = SessionCreationError("NodeShutdown", 1)
    SessionCreationError.SessionNotFound = SessionCreationError("SessionNotFound", 2)
    SessionCreationError.Internal = SessionCreationError("Internal", 3)
    SessionCreationError._enumerators = { 0:SessionCreationError.AlreadyConnected, 1:SessionCreationError.NodeShutdown, 2:SessionCreationError.SessionNotFound, 3:SessionCreationError.Internal }

    _M_DataStormContract._t_SessionCreationError = IcePy.defineEnum("::DataStormContract::SessionCreationError", SessionCreationError, (), SessionCreationError._enumerators)

    _M_DataStormContract.SessionCreationError = SessionCreationError
    del SessionCreationError

if "SessionCreationException" not in _M_DataStormContract.__dict__:
    _M_DataStormContract.SessionCreationException = None
    class SessionCreationException(Ice.UserException):
        """
        Throws when the session cannot be created.
        """
        def __init__(self, error=_M_DataStormContract.SessionCreationError.AlreadyConnected):
            self.error = error

        def __repr__(self):
            return f"DataStormContract.SessionCreationException({Ice.Util.format_fields(error=self.error)})"

        _ice_id = "::DataStormContract::SessionCreationException"

    _M_DataStormContract._t_SessionCreationException = IcePy.defineException("::DataStormContract::SessionCreationException", SessionCreationException, (), None, (("error", (), _M_DataStormContract._t_SessionCreationError, False, 0),))
    SessionCreationException._ice_type = _M_DataStormContract._t_SessionCreationException

    _M_DataStormContract.SessionCreationException = SessionCreationException
    del SessionCreationException
...
if "NodePrx" not in _M_DataStormContract.__dict__:
    ...
    class NodePrx(Ice.ObjectPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_DataStormContract.NodePrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_DataStormContract.NodePrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_DataStormContract.NodePrx, proxy, facet)
    ...
    class Node(Ice.Object):
        ...
        def initiateCreateSession(self, publisher, current):
            """
            Initiate the creation of a publisher session with a node, after the target node has announced a topic
            reader for which this node has a corresponding topic writer.
        ...
        def createSession(self, subscriber, session, fromRelay, current):
            """
            Initiates the creation of a subscriber session with a node. The subscriber node sends this request to a
            publisher node in one of the following scenarios:
        ...
        def confirmCreateSession(self, publisher, session, current):
            """
            Confirm the creation of a publisher session with a node.
    ...
    Node._op_initiateCreateSession = IcePy.Operation("initiateCreateSession", "initiateCreateSession", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_NodePrx, False, 0),), (), None, (_M_DataStormContract._t_SessionCreationException,))
    Node._op_createSession = IcePy.Operation("createSession", "createSession", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_NodePrx, False, 0), ((), _M_DataStormContract._t_SubscriberSessionPrx, False, 0), ((), IcePy._t_bool, False, 0)), (), None, (_M_DataStormContract._t_SessionCreationException,))
    Node._op_confirmCreateSession = IcePy.Operation("confirmCreateSession", "confirmCreateSession", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_NodePrx, False, 0), ((), _M_DataStormContract._t_PublisherSessionPrx, False, 0)), (), None, (_M_DataStormContract._t_SessionCreationException,))
...
if "LookupPrx" not in _M_DataStormContract.__dict__:
    ...
    class LookupPrx(Ice.ObjectPrx):
        ...
        def createSessionAsync(self, node, context=None):
            ...
            Returns
            -------
            awaitable of (DataStormContract.NodePrx or None)
                A proxy to this node. The proxy is never null.
            """
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_DataStormContract.LookupPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_DataStormContract.LookupPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_DataStormContract.LookupPrx, proxy, facet)
    ...
    class Lookup(Ice.Object):
        ...
        def announceTopicReader(self, topic, subscriber, current):
            """
            Announce a topic reader.
        ...
        def announceTopicWriter(self, topic, node, current):
            """
            Announce a topic writer.
        ...
        def announceTopics(self, readers, writers, node, current):
            """
            Announce a set of topic readers and writers.
        ...
        def createSession(self, node, current):
            """
            Establish a connection between this node and the caller node.
            ...
            Returns
            -------
            (DataStormContract.NodePrx or None) or awaitable of (DataStormContract.NodePrx or None)
                A proxy to this node. The proxy is never null.
            """
            raise NotImplementedError("servant method 'createSession' not implemented")

    Lookup._op_announceTopicReader = IcePy.Operation("announceTopicReader", "announceTopicReader", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), _M_DataStormContract._t_NodePrx, False, 0)), (), None, ())
    Lookup._op_announceTopicWriter = IcePy.Operation("announceTopicWriter", "announceTopicWriter", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), _M_DataStormContract._t_NodePrx, False, 0)), (), None, ())
    Lookup._op_announceTopics = IcePy.Operation("announceTopics", "announceTopics", Ice.OperationMode.Idempotent, None, (), (((), _M_Ice._t_StringSeq, False, 0), ((), _M_Ice._t_StringSeq, False, 0), ((), _M_DataStormContract._t_NodePrx, False, 0)), (), None, ())
    Lookup._op_createSession = IcePy.Operation("createSession", "createSession", Ice.OperationMode.Normal, None, (), (((), _M_DataStormContract._t_NodePrx, False, 0),), (), ((), _M_DataStormContract._t_NodePrx, False, 0), ())
