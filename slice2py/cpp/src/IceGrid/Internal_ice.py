...
if "InternalDbEnvDescriptor" not in _M_IceGrid.__dict__:
    ...
    class InternalDbEnvDescriptor(Ice.Value):
        ...
        def __repr__(self):
            return f"IceGrid.InternalDbEnvDescriptor({Ice.Util.format_fields(name=self.name, properties=self.properties)})"
...
if "InternalAdapterDescriptor" not in _M_IceGrid.__dict__:
    ...
    class InternalAdapterDescriptor(Ice.Value):
        ...
        def __repr__(self):
            return f"IceGrid.InternalAdapterDescriptor({Ice.Util.format_fields(id=self.id, serverLifetime=self.serverLifetime)})"
...
if "InternalServerDescriptor" not in _M_IceGrid.__dict__:
    ...
    class InternalServerDescriptor(Ice.Value):
        ...
        def __repr__(self):
            return f"IceGrid.InternalServerDescriptor({Ice.Util.format_fields(id=self.id, application=self.application, uuid=self.uuid, revision=self.revision, sessionId=self.sessionId, exe=self.exe, pwd=self.pwd, user=self.user, activation=self.activation, activationTimeout=self.activationTimeout, deactivationTimeout=self.deactivationTimeout, processRegistered=self.processRegistered, options=self.options, envs=self.envs, logs=self.logs, adapters=self.adapters, dbEnvs=self.dbEnvs, properties=self.properties, services=self.services)})"
...
if "AdapterActiveException" not in _M_IceGrid.__dict__:
    ...
    class AdapterActiveException(Ice.UserException):
        ...
        def __repr__(self):
            return f"IceGrid.AdapterActiveException()"
...
if "AdapterNotActiveException" not in _M_IceGrid.__dict__:
    ...
    class AdapterNotActiveException(Ice.UserException):
        ...
        def __repr__(self):
            return f"IceGrid.AdapterNotActiveException({Ice.Util.format_fields(activatable=self.activatable)})"
...
if "AdapterPrx" not in _M_IceGrid.__dict__:
    ...
    class AdapterPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.AdapterPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.AdapterPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.AdapterPrx, proxy, facet)
    ...
    class Adapter(Ice.Object):
        ...
        def getDirectProxy(self, current):
            """
            Get the adapter direct proxy. The adapter direct proxy is a proxy created with the object adapter. The proxy
            contains the last known adapter endpoints.
        ...
        def setDirectProxy(self, proxy, current):
            """
            Set the direct proxy for this adapter.
    ...
    Adapter._op_activate = IcePy.Operation("activate", "activate", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_ObjectPrx, False, 0), ())
    Adapter._op_getDirectProxy = IcePy.Operation("getDirectProxy", "getDirectProxy", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_ObjectPrx, False, 0), (_M_IceGrid._t_AdapterNotActiveException,))
    Adapter._op_setDirectProxy = IcePy.Operation("setDirectProxy", "setDirectProxy", Ice.OperationMode.Normal, None, (), (((), IcePy._t_ObjectPrx, False, 0),), (), None, (_M_IceGrid._t_AdapterActiveException,))
...
if "AdapterExistsException" not in _M_IceGrid.__dict__:
    ...
    class AdapterExistsException(Ice.UserException):
        ...
        def __repr__(self):
            return f"IceGrid.AdapterExistsException({Ice.Util.format_fields(id=self.id)})"
...
if "FileReaderPrx" not in _M_IceGrid.__dict__:
    ...
    class FileReaderPrx(Ice.ObjectPrx):
        ...
        def readAsync(self, filename, pos, size, context=None):
            ...
            Returns
            -------
            awaitable of tuple of (bool, int, list[str])
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.FileReaderPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.FileReaderPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.FileReaderPrx, proxy, facet)
    ...
    class FileReader(Ice.Object):
        ...
        def getOffsetFromEnd(self, filename, lines, current):
            """
            Count the number of given lines from the end of the file and return the file offset.
        ...
        def read(self, filename, pos, size, current):
            """
            Read lines (or size bytes) at the specified position from the given file.
            ...
            Returns
            -------
            tuple of (bool, int, list[str]) or awaitable of tuple of (bool, int, list[str])
    ...
    FileReader._op_getOffsetFromEnd = IcePy.Operation("getOffsetFromEnd", "getOffsetFromEnd", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0)), (), ((), IcePy._t_long, False, 0), (_M_IceGrid._t_FileNotAvailableException,))
    FileReader._op_read = IcePy.Operation("read", "read", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_long, False, 0), ((), IcePy._t_int, False, 0)), (((), IcePy._t_long, False, 0), ((), _M_Ice._t_StringSeq, False, 0)), ((), IcePy._t_bool, False, 0), (_M_IceGrid._t_FileNotAvailableException,))
...
if "ServerPrx" not in _M_IceGrid.__dict__:
    ...
    class ServerPrx(_M_IceGrid.FileReaderPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.ServerPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.ServerPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.ServerPrx, proxy, facet)
    ...
    class Server(_M_IceGrid.FileReader):
        ...
        def checkUpdate(self, svr, noRestart, current):
            """
            Check if the given server can be loaded on this node.
        ...
        def setEnabled(self, enable, current):
            """
            Enable or disable the server.
        ...
        def sendSignal(self, signal, current):
            """
            Send signal to the server
        ...
        def setProcess(self, proc, current):
            """
            Set the process proxy.
    ...
    Server._op_start = IcePy.Operation("start", "start", Ice.OperationMode.Normal, None, (), (), (), None, (_M_IceGrid._t_ServerStartException,))
    Server._op_stop = IcePy.Operation("stop", "stop", Ice.OperationMode.Normal, None, (), (), (), None, (_M_IceGrid._t_ServerStopException,))
    Server._op_checkUpdate = IcePy.Operation("checkUpdate", "checkUpdate", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalServerDescriptor, False, 0), ((), IcePy._t_bool, False, 0)), (), ((), IcePy._t_bool, False, 0), (_M_IceGrid._t_DeploymentException,))
    Server._op_setEnabled = IcePy.Operation("setEnabled", "setEnabled", Ice.OperationMode.Normal, None, (), (((), IcePy._t_bool, False, 0),), (), None, ())
    Server._op_isEnabled = IcePy.Operation("isEnabled", "isEnabled", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
    Server._op_sendSignal = IcePy.Operation("sendSignal", "sendSignal", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, False, 0),), (), None, (_M_IceGrid._t_BadSignalException,))
    Server._op_writeMessage = IcePy.Operation("writeMessage", "writeMessage", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0)), (), None, ())
    Server._op_getState = IcePy.Operation("getState", "getState", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_IceGrid._t_ServerState, False, 0), ())
    Server._op_getPid = IcePy.Operation("getPid", "getPid", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    Server._op_setProcess = IcePy.Operation("setProcess", "setProcess", Ice.OperationMode.Normal, None, (), (((), _M_Ice._t_ProcessPrx, False, 0),), (), None, ())
...
if "ReplicaObserverPrx" not in _M_IceGrid.__dict__:
    ...
    class ReplicaObserverPrx(Ice.ObjectPrx):
        ...
        def replicaInit(self, replicas, context=None):
            ...
            Parameters
            ----------
            replicas : list[(IceGrid.InternalRegistryPrx or None)]
            context : dict[str, str]
                The request context for the invocation.
            """
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.ReplicaObserverPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.ReplicaObserverPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.ReplicaObserverPrx, proxy, facet)
    ...
    class ReplicaObserver(Ice.Object):
        ...
        def replicaInit(self, replicas, current):
            """
            Initialization of the replica observer.
        ...
        def replicaAdded(self, replica, current):
            """
            Notification that a replica has been added. The node should establish a session with this new replica.
        ...
        def replicaRemoved(self, replica, current):
            """
            Notification that a replica has been removed. The node should destroy the session to this replica.
    ...
    ReplicaObserver._op_replicaInit = IcePy.Operation("replicaInit", "replicaInit", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalRegistryPrxSeq, False, 0),), (), None, ())
    ReplicaObserver._op_replicaAdded = IcePy.Operation("replicaAdded", "replicaAdded", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalRegistryPrx, False, 0),), (), None, ())
    ReplicaObserver._op_replicaRemoved = IcePy.Operation("replicaRemoved", "replicaRemoved", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalRegistryPrx, False, 0),), (), None, ())
...
if "NodePrx" not in _M_IceGrid.__dict__:
    ...
    class NodePrx(_M_IceGrid.FileReaderPrx, _M_IceGrid.ReplicaObserverPrx):
        ...
        def loadServer(self, svr, replicaName, context=None):
            ...
            Returns
            -------
            tuple of ((IceGrid.ServerPrx or None), dict[str, (IceGrid.AdapterPrx or None)], int, int)
            
                A tuple containing:
                    - (IceGrid.ServerPrx or None)
                    - dict[str, (IceGrid.AdapterPrx or None)]
                    - int
                    - int
            """
        ...
        def loadServerAsync(self, svr, replicaName, context=None):
            ...
            Returns
            -------
            awaitable of tuple of ((IceGrid.ServerPrx or None), dict[str, (IceGrid.AdapterPrx or None)], int, int)
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.NodePrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.NodePrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.NodePrx, proxy, facet)
    ...
    class Node(_M_IceGrid.FileReader, _M_IceGrid.ReplicaObserver):
        ...
        def loadServer(self, svr, replicaName, current):
            """
            Load the given server. If the server resources weren't already created (database environment directories,
            property files, etc), they will be created. The returned proxy is never null.
            ...
            Returns
            -------
            tuple of ((IceGrid.ServerPrx or None), dict[str, (IceGrid.AdapterPrx or None)], int, int) or awaitable of tuple of ((IceGrid.ServerPrx or None), dict[str, (IceGrid.AdapterPrx or None)], int, int)
        ...
        def loadServerWithoutRestart(self, svr, replicaName, current):
            """
            Load the given server and ensure the server won't be restarted. If the server resources weren't already created
            (database environment directories, property files, etc), they will be created. If the server can't be updated
            without a restart, a DeploymentException is raised. The returned proxy is never null.
        ...
        def destroyServer(self, name, uuid, revision, replicaName, current):
            """
            Destroy the given server.
        ...
        def destroyServerWithoutRestart(self, name, uuid, revision, replicaName, current):
            """
            Destroy the server if it's not active.
        ...
        def registerWithReplica(self, replica, current):
            """
            Establish a session to the given replica, this method only returns once the registration was attempted (unlike
            replicaAdded below).
        ...
        def getProcessorSocketCount(self, current):
            """
            Get the number of processor sockets for the machine where this node is running.
    ...
    Node._op_loadServer = IcePy.Operation("loadServer", "loadServer", Ice.OperationMode.Idempotent, None, (), (((), _M_IceGrid._t_InternalServerDescriptor, False, 0), ((), IcePy._t_string, False, 0)), (((), _M_IceGrid._t_AdapterPrxDict, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), ((), _M_IceGrid._t_ServerPrx, False, 0), (_M_IceGrid._t_DeploymentException,))
    Node._op_loadServerWithoutRestart = IcePy.Operation("loadServerWithoutRestart", "loadServerWithoutRestart", Ice.OperationMode.Idempotent, None, (), (((), _M_IceGrid._t_InternalServerDescriptor, False, 0), ((), IcePy._t_string, False, 0)), (((), _M_IceGrid._t_AdapterPrxDict, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), ((), _M_IceGrid._t_ServerPrx, False, 0), (_M_IceGrid._t_DeploymentException,))
    Node._op_destroyServer = IcePy.Operation("destroyServer", "destroyServer", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_string, False, 0)), (), None, (_M_IceGrid._t_DeploymentException,))
    Node._op_destroyServerWithoutRestart = IcePy.Operation("destroyServerWithoutRestart", "destroyServerWithoutRestart", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_string, False, 0)), (), None, (_M_IceGrid._t_DeploymentException,))
    Node._op_registerWithReplica = IcePy.Operation("registerWithReplica", "registerWithReplica", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalRegistryPrx, False, 0),), (), None, ())
    Node._op_getName = IcePy.Operation("getName", "getName", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    Node._op_getHostname = IcePy.Operation("getHostname", "getHostname", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    Node._op_getLoad = IcePy.Operation("getLoad", "getLoad", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_IceGrid._t_LoadInfo, False, 0), ())
    Node._op_getProcessorSocketCount = IcePy.Operation("getProcessorSocketCount", "getProcessorSocketCount", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    Node._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Idempotent, None, (), (), (), None, ())
...
if "NodeActiveException" not in _M_IceGrid.__dict__:
    ...
    class NodeActiveException(Ice.UserException):
        ...
        def __repr__(self):
            return f"IceGrid.NodeActiveException()"
...
if "NodeSessionPrx" not in _M_IceGrid.__dict__:
    ...
    class NodeSessionPrx(Ice.ObjectPrx):
        ...
        def getObserverAsync(self, context=None):
            ...
            Returns
            -------
            awaitable of (IceGrid.NodeObserverPrx or None)
            """
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.NodeSessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.NodeSessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.NodeSessionPrx, proxy, facet)
    ...
    class NodeSession(Ice.Object):
        ...
        def keepAlive(self, load, current):
            """
            The node call this method to keep the session alive.
        ...
        def setReplicaObserver(self, observer, current):
            """
            Set the replica observer. The node calls this method when it's ready to receive notifications for the replicas.
            It only calls this for the session with the master.
        ...
        def getObserver(self, current):
            ...
            Returns
            -------
            (IceGrid.NodeObserverPrx or None) or awaitable of (IceGrid.NodeObserverPrx or None)
            """
            raise NotImplementedError("servant method 'getObserver' not implemented")

        def loadServers(self, current):
            """
            Ask the registry to load the servers on the node.
        ...
        def waitForApplicationUpdate(self, application, revision, current):
            """
            Wait for the application update to complete (the application is completely updated once all the registry
            replicas have been updated). This is used by the node to ensure that before to start a server all the
            replicas have the up-to-date descriptor of the server.
    ...
    NodeSession._op_keepAlive = IcePy.Operation("keepAlive", "keepAlive", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_LoadInfo, False, 0),), (), None, ())
    NodeSession._op_setReplicaObserver = IcePy.Operation("setReplicaObserver", "setReplicaObserver", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_ReplicaObserverPrx, False, 0),), (), None, ())
    NodeSession._op_getTimeout = IcePy.Operation("getTimeout", "getTimeout", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    NodeSession._op_getObserver = IcePy.Operation("getObserver", "getObserver", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_IceGrid._t_NodeObserverPrx, False, 0), ())
    NodeSession._op_loadServers = IcePy.Operation("loadServers", "loadServers", Ice.OperationMode.Idempotent, None, (), (), (), None, ())
    NodeSession._op_getServers = IcePy.Operation("getServers", "getServers", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_Ice._t_StringSeq, False, 0), ())
    NodeSession._op_waitForApplicationUpdate = IcePy.Operation("waitForApplicationUpdate", "waitForApplicationUpdate", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0)), (), None, ())
    NodeSession._op_destroy = IcePy.Operation("destroy", "destroy", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "ReplicaActiveException" not in _M_IceGrid.__dict__:
    ...
    class ReplicaActiveException(Ice.UserException):
        ...
        def __repr__(self):
            return f"IceGrid.ReplicaActiveException()"
...
if "TopicName" not in _M_IceGrid.__dict__:
    ...
    class TopicName(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_IceGrid.TopicName._enumerators:
                return f"IceGrid.TopicName.{self._name}"
            else:
                return f"IceGrid.TopicName({self._name!r}, {self._value!r})"
...
if "DatabaseObserverPrx" not in _M_IceGrid.__dict__:
    ...
    class DatabaseObserverPrx(_M_IceGrid.ApplicationObserverPrx, _M_IceGrid.ObjectObserverPrx, _M_IceGrid.AdapterObserverPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.DatabaseObserverPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.DatabaseObserverPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.DatabaseObserverPrx, proxy, facet)
...
if "ReplicaSessionPrx" not in _M_IceGrid.__dict__:
    ...
    class ReplicaSessionPrx(Ice.ObjectPrx):
        ...
        def setEndpoints(self, endpoints, context=None):
            ...
            Parameters
            ----------
            endpoints : dict[str, (Ice.ObjectPrx or None)]
            context : dict[str, str]
                The request context for the invocation.
            """
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.ReplicaSessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.ReplicaSessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.ReplicaSessionPrx, proxy, facet)
    ...
    class ReplicaSession(Ice.Object):
        ...
        def setDatabaseObserver(self, dbObs, serials, current):
            """
            Set the database observer. Once the observer is subscribed, it will receive the database and database updates.
        ...
        def setEndpoints(self, endpoints, current):
            """
            This method sets the endpoints of the replica. This allows the master to create proxies with multiple endpoints
            for replicated objects (e.g.: IceGrid::Query object).
        ...
        def registerWellKnownObjects(self, objects, current):
            """
            Registers the replica well-known objects with the master.
        ...
        def setAdapterDirectProxy(self, adapterId, replicaGroupId, proxy, current):
            """
            Set the adapter direct proxy of the given adapter in the master. This is used to support dynamic registration
            with the locator registry interface.
        ...
        def receivedUpdate(self, name, serial, failure, current):
            """
            Notify the master that an update was received. The master might wait for replication updates to be received by
            all the replicas before to continue.
    ...
    ReplicaSession._op_keepAlive = IcePy.Operation("keepAlive", "keepAlive", Ice.OperationMode.Normal, None, (), (), (), None, ())
    ReplicaSession._op_getTimeout = IcePy.Operation("getTimeout", "getTimeout", Ice.OperationMode.Idempotent, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    ReplicaSession._op_setDatabaseObserver = IcePy.Operation("setDatabaseObserver", "setDatabaseObserver", Ice.OperationMode.Idempotent, None, (), (((), _M_IceGrid._t_DatabaseObserverPrx, False, 0), ((), _M_IceGrid._t_StringLongDict, True, 1)), (), None, (_M_IceGrid._t_ObserverAlreadyRegisteredException, _M_IceGrid._t_DeploymentException))
    ReplicaSession._op_setEndpoints = IcePy.Operation("setEndpoints", "setEndpoints", Ice.OperationMode.Idempotent, None, (), (((), _M_IceGrid._t_StringObjectProxyDict, False, 0),), (), None, ())
    ReplicaSession._op_registerWellKnownObjects = IcePy.Operation("registerWellKnownObjects", "registerWellKnownObjects", Ice.OperationMode.Idempotent, None, (), (((), _M_IceGrid._t_ObjectInfoSeq, False, 0),), (), None, ())
    ReplicaSession._op_setAdapterDirectProxy = IcePy.Operation("setAdapterDirectProxy", "setAdapterDirectProxy", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_ObjectPrx, False, 0)), (), None, (_M_IceGrid._t_AdapterNotExistException, _M_IceGrid._t_AdapterExistsException))
    ReplicaSession._op_receivedUpdate = IcePy.Operation("receivedUpdate", "receivedUpdate", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_TopicName, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_string, False, 0)), (), None, ())
    ReplicaSession._op_destroy = IcePy.Operation("destroy", "destroy", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "InternalNodeInfo" not in _M_IceGrid.__dict__:
    ...
    class InternalNodeInfo(Ice.Value):
        ...
        def __repr__(self):
            return f"IceGrid.InternalNodeInfo({Ice.Util.format_fields(name=self.name, os=self.os, hostname=self.hostname, release=self.release, version=self.version, machine=self.machine, nProcessors=self.nProcessors, dataDir=self.dataDir, iceSoVersion=self.iceSoVersion)})"
...
if "InternalReplicaInfo" not in _M_IceGrid.__dict__:
    ...
    class InternalReplicaInfo(Ice.Value):
        ...
        def __repr__(self):
            return f"IceGrid.InternalReplicaInfo({Ice.Util.format_fields(name=self.name, hostname=self.hostname)})"
...
if "InternalRegistryPrx" not in _M_IceGrid.__dict__:
    ...
    class InternalRegistryPrx(_M_IceGrid.FileReaderPrx):
        ...
        def registerNodeAsync(self, info, prx, loadInf, context=None):
            ...
            Returns
            -------
            awaitable of (IceGrid.NodeSessionPrx or None)
                The node session proxy.
            """
        ...
        def registerReplicaAsync(self, info, prx, context=None):
            ...
            Returns
            -------
            awaitable of (IceGrid.ReplicaSessionPrx or None)
                The replica session proxy.
            """
        ...
        def getNodesAsync(self, context=None):
            ...
            Returns
            -------
            awaitable of list[(IceGrid.NodePrx or None)]
            """
        ...
        def getReplicas(self, context=None):
            ...
            Returns
            -------
            list[(IceGrid.InternalRegistryPrx or None)]
            """
        ...
        def getReplicasAsync(self, context=None):
            ...
            Returns
            -------
            awaitable of list[(IceGrid.InternalRegistryPrx or None)]
            """
        ...
        def getApplications(self, context=None):
            ...
            Returns
            -------
            tuple of (list[IceGrid.ApplicationInfo], int)
            
                A tuple containing:
                    - list[IceGrid.ApplicationInfo]
                    - int
            """
        ...
        def getApplicationsAsync(self, context=None):
            ...
            Returns
            -------
            awaitable of tuple of (list[IceGrid.ApplicationInfo], int)
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_IceGrid.InternalRegistryPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_IceGrid.InternalRegistryPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_IceGrid.InternalRegistryPrx, proxy, facet)
    ...
    class InternalRegistry(_M_IceGrid.FileReader):
        ...
        def registerNode(self, info, prx, loadInf, current):
            """
            Register a node with the registry. If a node with the same name is already registered,
            this operation overrides the existing registration only when the previously
            registered node is not active.
            ...
            Returns
            -------
            (IceGrid.NodeSessionPrx or None) or awaitable of (IceGrid.NodeSessionPrx or None)
                The node session proxy.
        ...
        def registerReplica(self, info, prx, current):
            """
            Register a replica with the registry. If a replica with the same name is already registered,
            this operation overrides the existing registration only when the previously
            registered node is not active.
            ...
            Returns
            -------
            (IceGrid.ReplicaSessionPrx or None) or awaitable of (IceGrid.ReplicaSessionPrx or None)
                The replica session proxy.
        ...
        def registerWithReplica(self, prx, current):
            """
            Create a session with the given registry replica. This method returns only once the session creation has been
            attempted.
        ...
        def getNodes(self, current):
            ...
            Returns
            -------
            list[(IceGrid.NodePrx or None)] or awaitable of list[(IceGrid.NodePrx or None)]
            """
            raise NotImplementedError("servant method 'getNodes' not implemented")

        def getReplicas(self, current):
            """
            Return the proxies of all the registry replicas known by this registry.
            ...
            Returns
            -------
            list[(IceGrid.InternalRegistryPrx or None)] or awaitable of list[(IceGrid.InternalRegistryPrx or None)]
            """
            raise NotImplementedError("servant method 'getReplicas' not implemented")

        def getApplications(self, current):
            """
            Return applications, adapters, objects from this replica.
            ...
            Returns
            -------
            tuple of (list[IceGrid.ApplicationInfo], int) or awaitable of tuple of (list[IceGrid.ApplicationInfo], int)
    ...
    InternalRegistry._op_registerNode = IcePy.Operation("registerNode", "registerNode", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalNodeInfo, False, 0), ((), _M_IceGrid._t_NodePrx, False, 0), ((), _M_IceGrid._t_LoadInfo, False, 0)), (), ((), _M_IceGrid._t_NodeSessionPrx, False, 0), (_M_IceGrid._t_NodeActiveException, _M_IceGrid._t_PermissionDeniedException))
    InternalRegistry._op_registerReplica = IcePy.Operation("registerReplica", "registerReplica", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalReplicaInfo, False, 0), ((), _M_IceGrid._t_InternalRegistryPrx, False, 0)), (), ((), _M_IceGrid._t_ReplicaSessionPrx, False, 0), (_M_IceGrid._t_ReplicaActiveException, _M_IceGrid._t_PermissionDeniedException))
    InternalRegistry._op_registerWithReplica = IcePy.Operation("registerWithReplica", "registerWithReplica", Ice.OperationMode.Normal, None, (), (((), _M_IceGrid._t_InternalRegistryPrx, False, 0),), (), None, ())
    InternalRegistry._op_getNodes = IcePy.Operation("getNodes", "getNodes", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_IceGrid._t_NodePrxSeq, False, 0), ())
    InternalRegistry._op_getReplicas = IcePy.Operation("getReplicas", "getReplicas", Ice.OperationMode.Idempotent, None, (), (), (), ((), _M_IceGrid._t_InternalRegistryPrxSeq, False, 0), ())
    InternalRegistry._op_getApplications = IcePy.Operation("getApplications", "getApplications", Ice.OperationMode.Idempotent, None, (), (), (((), IcePy._t_long, False, 0),), ((), _M_IceGrid._t_ApplicationInfoSeq, False, 0), ())
    InternalRegistry._op_getAdapters = IcePy.Operation("getAdapters", "getAdapters", Ice.OperationMode.Idempotent, None, (), (), (((), IcePy._t_long, False, 0),), ((), _M_IceGrid._t_AdapterInfoSeq, False, 0), ())
    InternalRegistry._op_getObjects = IcePy.Operation("getObjects", "getObjects", Ice.OperationMode.Idempotent, None, (), (), (((), IcePy._t_long, False, 0),), ((), _M_IceGrid._t_ObjectInfoSeq, False, 0), ())
    InternalRegistry._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Idempotent, None, (), (), (), None, ())
