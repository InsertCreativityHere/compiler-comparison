...
if "BackgroundControllerPrx" not in _M_Test.__dict__:
    ...
    class BackgroundController(Ice.Object):
        ...
        def initializeSocketOperation(self, status, current):
    ...
    BackgroundController._op_initializeSocketOperation = IcePy.Operation("initializeSocketOperation", "initializeSocketOperation", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
