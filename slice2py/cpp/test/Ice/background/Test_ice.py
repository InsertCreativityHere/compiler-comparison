...
if 'BackgroundControllerPrx' not in _M_Test.__dict__:
    ...
    class BackgroundControllerPrx(Ice.ObjectPrx):
        ...
        def initializeSocketOperation(self, status, context=None):
            return _M_Test.BackgroundController._op_initializeSocketOperation.invoke(self, ((status, ), context))

        def initializeSocketOperationAsync(self, status, context=None):
            return _M_Test.BackgroundController._op_initializeSocketOperation.invokeAsync(self, ((status, ), context))

        def begin_initializeSocketOperation(self, status, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.BackgroundController._op_initializeSocketOperation.begin(self, ((status, ), _response, _ex, _sent, context))

        def end_initializeSocketOperation(self, _r):
            return _M_Test.BackgroundController._op_initializeSocketOperation.end(self, _r)
    ...
    class BackgroundController(Ice.Object):
        ...
        def initializeSocketOperation(self, status, current=None):
            raise NotImplementedError("servant method 'initializeSocketOperation' not implemented")
