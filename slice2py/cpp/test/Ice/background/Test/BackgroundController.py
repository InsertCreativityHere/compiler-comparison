...
class BackgroundControllerPrx(ObjectPrx):
    ...
    def initializeSocketOperation(self, status: int, context: dict[str, str] | None = None) -> None:
        return BackgroundController._op_initializeSocketOperation.invoke(self, ((status, ), context))

    def initializeSocketOperationAsync(self, status: int, context: dict[str, str] | None = None) -> Awaitable[None]:
        return BackgroundController._op_initializeSocketOperation.invokeAsync(self, ((status, ), context))
...
class BackgroundController(Object, ABC):
    ...
    _op_initializeSocketOperation: IcePy.Operation
    ...
    @abstractmethod
    def initializeSocketOperation(self, status: int, current: Current) -> None | Awaitable[None]:
        pass
...
BackgroundController._op_initializeSocketOperation = IcePy.Operation(
