...
class RetryPrx(ObjectPrx):
    ...
    def sleep(self, delay: int, context: dict[str, str] | None = None) -> None:
        return Retry._op_sleep.invoke(self, ((delay, ), context))

    def sleepAsync(self, delay: int, context: dict[str, str] | None = None) -> Awaitable[None]:
        return Retry._op_sleep.invokeAsync(self, ((delay, ), context))
...
class Retry(Object, ABC):
    ...
    @abstractmethod
    def sleep(self, delay: int, current: Current) -> None | Awaitable[None]:
        pass
...
Retry._op_sleep = IcePy.Operation(
    "sleep",
    "sleep",
    OperationMode.Idempotent,
    None,
