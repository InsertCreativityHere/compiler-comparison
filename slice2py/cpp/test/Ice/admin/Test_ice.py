...
if 'RemoteCommunicatorPrx' not in _M_Test.__dict__:
    ...
    RemoteCommunicator._op_addUpdateCallback = IcePy.Operation('addUpdateCallback', Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    RemoteCommunicator._op_removeUpdateCallback = IcePy.Operation('removeUpdateCallback', Ice.OperationMode.Normal, False, None, (), (), (), None, ())
