...
if 'RemoteCommunicatorPrx' not in _M_Test.__dict__:
    ...
    class RemoteCommunicator(Ice.Object):
        ...
        def addUpdateCallback(self, current=None):
            raise NotImplementedError("servant method 'addUpdateCallback' not implemented")

        def removeUpdateCallback(self, current=None):
    ...
    RemoteCommunicator._op_addUpdateCallback = IcePy.Operation('addUpdateCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    RemoteCommunicator._op_removeUpdateCallback = IcePy.Operation('removeUpdateCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
