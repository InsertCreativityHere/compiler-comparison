...
class RemoteCommunicatorPrx(ObjectPrx):
    ...
    def addUpdateCallback(self, context: dict[str, str] | None = None) -> None:
        return RemoteCommunicator._op_addUpdateCallback.invoke(self, ((), context))

    def addUpdateCallbackAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return RemoteCommunicator._op_addUpdateCallback.invokeAsync(self, ((), context))

    def removeUpdateCallback(self, context: dict[str, str] | None = None) -> None:
        return RemoteCommunicator._op_removeUpdateCallback.invoke(self, ((), context))

    def removeUpdateCallbackAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return RemoteCommunicator._op_removeUpdateCallback.invokeAsync(self, ((), context))
...
class RemoteCommunicator(Object, ABC):
    ...
    _op_addUpdateCallback: IcePy.Operation
    _op_removeUpdateCallback: IcePy.Operation
    ...
    @abstractmethod
    def addUpdateCallback(self, current: Current) -> None | Awaitable[None]:
        pass

    @abstractmethod
    def removeUpdateCallback(self, current: Current) -> None | Awaitable[None]:
        pass
...
RemoteCommunicator._op_addUpdateCallback = IcePy.Operation(
    "addUpdateCallback",
    "addUpdateCallback",
    OperationMode.Normal,
    None,
...
RemoteCommunicator._op_removeUpdateCallback = IcePy.Operation(
