...
if "E" not in _M_Test.__dict__:
    ...
    class E(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.E({Ice.Util.format_fields(data=self.data)})"
...
if "ThrowerPrx" not in _M_Test.__dict__:
    ...
    Thrower._op_throwE = IcePy.Operation("throwE", "throwE", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_E,))
