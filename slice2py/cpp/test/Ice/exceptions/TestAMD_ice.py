...
if 'E' not in _M_Test.__dict__:
    ...
    _M_Test._t_E = IcePy.defineException('::Test::E', E, (), False, None, (('data', (), IcePy._t_string, False, 0),))
...
if 'F' not in _M_Test.__dict__:
    ...
    _M_Test._t_F = IcePy.defineException('::Test::F', F, (), False, None, (('data', (), IcePy._t_string, False, 0),))
...
if 'ThrowerPrx' not in _M_Test.__dict__:
    ...
    class ThrowerPrx(Ice.ObjectPrx):
        ...
        def begin_throwE(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Thrower._op_throwE.begin(self, ((), _response, _ex, _sent, context))

        def end_throwE(self, _r):
            return _M_Test.Thrower._op_throwE.end(self, _r)
        ...
        def begin_throwF(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Thrower._op_throwF.begin(self, ((), _response, _ex, _sent, context))
    ...
    Thrower._op_throwModA = IcePy.Operation('throwModA', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test.Mod._t_A,))
