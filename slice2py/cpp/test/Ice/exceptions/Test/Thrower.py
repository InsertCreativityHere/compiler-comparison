...
class ThrowerPrx(ObjectPrx):
    ...
    def throwE(self, context: dict[str, str] | None = None) -> None:
        return Thrower._op_throwE.invoke(self, ((), context))

    def throwEAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return Thrower._op_throwE.invokeAsync(self, ((), context))
...
class Thrower(Object, ABC):
    ...
    @abstractmethod
    def throwE(self, current: Current) -> None | Awaitable[None]:
        pass
...
Thrower._op_throwE = IcePy.Operation(
    "throwE",
    "throwE",
    OperationMode.Normal,
    None,
