...
if 'MyClassPrx' not in _M_Test.__dict__:
    ...
    MyClass._op_opWStringLiterals = IcePy.Operation('opWStringLiterals', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (), (), ((), _M_Test._t_WStringS, False, 0), ())
