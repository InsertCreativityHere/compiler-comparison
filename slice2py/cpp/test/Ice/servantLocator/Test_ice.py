...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    TestIntf._op_stdException = IcePy.Operation('stdException', Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    TestIntf._op_cppException = IcePy.Operation('cppException', Ice.OperationMode.Normal, False, None, (), (), (), None, ())
