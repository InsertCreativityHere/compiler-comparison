...
class TestIntfPrx(ObjectPrx):
    ...
    def stdException(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_stdException.invoke(self, ((), context))

    def stdExceptionAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_stdException.invokeAsync(self, ((), context))

    def cppException(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_cppException.invoke(self, ((), context))

    def cppExceptionAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_cppException.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_stdException: IcePy.Operation
    _op_cppException: IcePy.Operation
    ...
    @abstractmethod
    def stdException(self, current: Current) -> None | Awaitable[None]:
        pass

    @abstractmethod
    def cppException(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_stdException = IcePy.Operation(
    "stdException",
    "stdException",
    OperationMode.Normal,
    None,
...
TestIntf._op_cppException = IcePy.Operation(
    "cppException",
    "cppException",
    OperationMode.Normal,
    None,
