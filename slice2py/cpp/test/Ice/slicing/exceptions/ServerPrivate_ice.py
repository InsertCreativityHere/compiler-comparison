...
if "UnknownDerived" not in _M_Test.__dict__:
    ...
    class UnknownDerived(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.UnknownDerived({Ice.Util.format_fields(b=self.b, ud=self.ud)})"
...
if "UnknownIntermediate" not in _M_Test.__dict__:
    ...
    class UnknownIntermediate(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.UnknownIntermediate({Ice.Util.format_fields(b=self.b, ui=self.ui)})"
...
if "UnknownMostDerived1" not in _M_Test.__dict__:
    ...
    class UnknownMostDerived1(_M_Test.KnownIntermediate):
        ...
        def __repr__(self):
            return f"Test.UnknownMostDerived1({Ice.Util.format_fields(b=self.b, ki=self.ki, umd1=self.umd1)})"
...
if "UnknownMostDerived2" not in _M_Test.__dict__:
    ...
    class UnknownMostDerived2(_M_Test.UnknownIntermediate):
        ...
        def __repr__(self):
            return f"Test.UnknownMostDerived2({Ice.Util.format_fields(b=self.b, ui=self.ui, umd2=self.umd2)})"
