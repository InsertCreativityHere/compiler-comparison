...
if "Color" not in _M_Test.__dict__:
    ...
    class Color(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.Color._enumerators:
                return f"Test.Color.{self._name}"
            else:
                return f"Test.Color({self._name!r}, {self._value!r})"
...
if "Color" not in _M_Test.Nested.__dict__:
    ...
    class Color(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.Nested.Color._enumerators:
                return f"Test.Nested.Color.{self._name}"
            else:
                return f"Test.Nested.Color({self._name!r}, {self._value!r})"
...
if "Struct1" not in _M_Test.__dict__:
    ...
    class Struct1(object):
        ...
        def __repr__(self):
            return f"Test.Struct1({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Struct2" not in _M_Test.__dict__:
    ...
    class Struct2(object):
        ...
        def __repr__(self):
            return f"Test.Struct2({Ice.Util.format_fields(boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Struct3" not in _M_Test.__dict__:
    ...
    class Struct3(object):
        ...
        def __repr__(self):
            return f"Test.Struct3({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Base" not in _M_Test.__dict__:
    ...
    class Base(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Base({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "Derived" not in _M_Test.__dict__:
    ...
    class Derived(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.Derived({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3)})"
...
if "BaseEx" not in _M_Test.__dict__:
    ...
    class BaseEx(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.BaseEx({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD)})"
...
if "DerivedEx" not in _M_Test.__dict__:
    ...
    class DerivedEx(_M_Test.BaseEx):
        def __init__(self, boolFalse=False, boolTrue=True, b=1, s=2, i=3, l=4, f=5.1, d=6.2, str="foo \\ \"bar\n \r\n\t\v\f\a\b? \a \a", noDefault="", zeroI=0, zeroL=0, zeroF=0, zeroDotF=0, zeroD=0, zeroDotD=0, c1=_M_Test.ConstColor1, c2=_M_Test.ConstColor2, c3=_M_Test.ConstColor3, nc1=_M_Test.ConstNestedColor1, nc2=_M_Test.ConstNestedColor2, nc3=_M_Test.ConstNestedColor3):
        ...
        def __repr__(self):
            return f"Test.DerivedEx({Ice.Util.format_fields(boolFalse=self.boolFalse, boolTrue=self.boolTrue, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, noDefault=self.noDefault, zeroI=self.zeroI, zeroL=self.zeroL, zeroF=self.zeroF, zeroDotF=self.zeroDotF, zeroD=self.zeroD, zeroDotD=self.zeroDotD, c1=self.c1, c2=self.c2, c3=self.c3, nc1=self.nc1, nc2=self.nc2, nc3=self.nc3)})"
