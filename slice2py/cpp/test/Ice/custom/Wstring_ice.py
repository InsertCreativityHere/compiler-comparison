...
if 'WstringStruct' not in _M_Test1.__dict__:
    _M_Test1.WstringStruct = Ice.createTempClass()
...
if 'WstringException' not in _M_Test1.__dict__:
    _M_Test1.WstringException = Ice.createTempClass()
...
if 'WstringClassPrx' not in _M_Test1.__dict__:
    ...
    _M_Test1.WstringClass = Ice.createTempClass()
    ...
    WstringClass._op_opString = IcePy.Operation('opString', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (((), IcePy._t_string, False, 0),), ((), IcePy._t_string, False, 0), ())
    WstringClass._op_opStruct = IcePy.Operation('opStruct', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test1._t_WstringStruct, False, 0),), (((), _M_Test1._t_WstringStruct, False, 0),), ((), _M_Test1._t_WstringStruct, False, 0), ())
    WstringClass._op_throwExcept = IcePy.Operation('throwExcept', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, (_M_Test1._t_WstringException,))
...
if 'WstringStruct' not in _M_Test2.__dict__:
    _M_Test2.WstringStruct = Ice.createTempClass()
    class WstringStruct(object):
        def __init__(self, s=''):
            self.s = s
...
if 'WstringException' not in _M_Test2.__dict__:
    _M_Test2.WstringException = Ice.createTempClass()
    class WstringException(Ice.UserException):
        def __init__(self, reason=''):
            self.reason = reason
...
if 'WstringClassPrx' not in _M_Test2.__dict__:
    ...
    _M_Test2.WstringClass = Ice.createTempClass()
    class WstringClass(Ice.Object):
    ...
    WstringClass._op_opString = IcePy.Operation('opString', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (((), IcePy._t_string, False, 0),), ((), IcePy._t_string, False, 0), ())
    WstringClass._op_opStruct = IcePy.Operation('opStruct', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test2._t_WstringStruct, False, 0),), (((), _M_Test2._t_WstringStruct, False, 0),), ((), _M_Test2._t_WstringStruct, False, 0), ())
    WstringClass._op_throwExcept = IcePy.Operation('throwExcept', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, (_M_Test2._t_WstringException,))
