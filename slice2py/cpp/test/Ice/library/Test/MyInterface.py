...
from Test.UserError import _Test_UserError_t
...
class MyInterfacePrx(ObjectPrx):
    ...
    def op(self, throwIt: bool, context: dict[str, str] | None = None) -> None:
        return MyInterface._op_op.invoke(self, ((throwIt, ), context))

    def opAsync(self, throwIt: bool, context: dict[str, str] | None = None) -> Awaitable[None]:
        return MyInterface._op_op.invokeAsync(self, ((throwIt, ), context))
...
class MyInterface(Object, ABC):
    ...
    @abstractmethod
    def op(self, throwIt: bool, current: Current) -> None | Awaitable[None]:
        pass
