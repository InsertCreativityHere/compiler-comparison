...
from Test.DelayedTestIntf import DelayedTestIntf
...
class TestIntfPrx(DelayedTestIntfPrx):
...
class TestIntf(DelayedTestIntf, ABC):

    _ice_ids: Sequence[str] = ("::Ice::Object", "::Test::DelayedTestIntf", "::Test::TestIntf", )
