...
if "DelayedTestIntfPrx" not in _M_Test.__dict__:
    ...
    class DelayedTestIntfPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.DelayedTestIntfPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.DelayedTestIntfPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.DelayedTestIntfPrx, proxy, facet)
    ...
    DelayedTestIntf._op_sleep = IcePy.Operation("sleep", "sleep", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
...
if "TestIntfBidirPrx" not in _M_Test.__dict__:
    ...
    class TestIntfBidirPrx(Ice.ObjectPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.TestIntfBidirPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.TestIntfBidirPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.TestIntfBidirPrx, proxy, facet)
    ...
    class TestIntfBidir(Ice.Object):
        ...
        def makeSleep(self, aborted, ms, target, current):
            raise NotImplementedError("servant method 'makeSleep' not implemented")

    TestIntfBidir._op_makeSleep = IcePy.Operation("makeSleep", "makeSleep", Ice.OperationMode.Normal, None, (), (((), IcePy._t_bool, False, 0), ((), IcePy._t_int, False, 0), ((), _M_Test._t_DelayedTestIntfPrx, False, 0)), (), None, ())
