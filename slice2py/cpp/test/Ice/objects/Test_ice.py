...
if "BaseEx" not in _M_Test.__dict__:
    ...
    class BaseEx(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.BaseEx({Ice.Util.format_fields(reason=self.reason)})"
...
if "CompactIdEnum" not in _M_Test.__dict__:
    ...
    class CompactIdEnum(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.CompactIdEnum._enumerators:
                return f"Test.CompactIdEnum.{self._name}"
            else:
                return f"Test.CompactIdEnum({self._name!r}, {self._value!r})"
...
if "CompactScoped" not in _M_Test.__dict__:
    _M_Test._t_CompactScoped = IcePy.declareValue("::Test::CompactScoped")

if "CompactScoped" not in _M_Test.__dict__:
    _M_Test.CompactScoped = None
...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    class TestIntf(Ice.Object):
        ...
        def throwDerived(self, current):
            raise NotImplementedError("servant method 'throwDerived' not implemented")

    TestIntf._op_opDerived = IcePy.Operation("opDerived", "opDerived", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_Base, False, 0), ())
    TestIntf._op_throwDerived = IcePy.Operation("throwDerived", "throwDerived", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_BaseEx,))
