...
from Inner.Test.Inner2.MyInterface_forward import _Inner_Test_Inner2_MyInterfacePrx_t
...
__all__ = ["MyInterface", "MyInterfacePrx", "_Inner_Test_Inner2_MyInterfacePrx_t"]
