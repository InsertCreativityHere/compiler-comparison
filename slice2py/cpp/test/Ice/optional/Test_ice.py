...
if "MultiOptional" not in _M_Test.__dict__:
    ...
    class MultiOptional(Ice.Value):
        def __init__(self, a=None, b=None, c=None, d=None, e=None, f=None, g=None, h=None, i=None, j=None, bs=None, ss=None, iid=None, sid=None, fs=None, vs=None, shs=None, es=None, fss=None, vss=None, mips=None, ied=None, ifsd=None, ivsd=None, imipd=None, bos=None, ser=None, defaultedString=""):
            self.a = a
            self.b = b
            self.c = c
            self.d = d
    ...
    _M_Test._t_MultiOptional = IcePy.defineValue("::Test::MultiOptional", MultiOptional, -1, (), False, None, (
        ...
        ("defaultedString", (), IcePy._t_string, True, 31)
    ))
