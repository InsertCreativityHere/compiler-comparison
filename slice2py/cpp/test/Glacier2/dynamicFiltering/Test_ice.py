...
if "BackendPrx" not in _M_Test.__dict__:
    ...
    Backend._op_check = IcePy.Operation("check", "check", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "StateCode" not in _M_Test.__dict__:
    ...
    class StateCode(Ice.EnumBase):
        ...
        def __repr__(self):
            if self._value in _M_Test.StateCode._enumerators:
                return f"Test.StateCode.{self._name}"
            else:
                return f"Test.StateCode({self._name!r}, {self._value!r})"
...
if "TestToken" not in _M_Test.__dict__:
    ...
    class TestToken(object):
        ...
        def __repr__(self):
            return f"Test.TestToken({Ice.Util.format_fields(expectedResult=self.expectedResult, description=self.description, code=self.code, config=self.config, caseIndex=self.caseIndex, testReference=self.testReference)})"
...
if "TestControllerPrx" not in _M_Test.__dict__:
    ...
    class TestControllerPrx(Ice.ObjectPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.TestControllerPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.TestControllerPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.TestControllerPrx, proxy, facet)
    ...
    class TestController(Ice.Object):
        ...
        def step(self, currentSession, currentState, current):
            raise NotImplementedError("servant method 'step' not implemented")

        def shutdown(self, current):
            raise NotImplementedError("servant method 'shutdown' not implemented")

    TestController._op_step = IcePy.Operation("step", "step", Ice.OperationMode.Normal, None, (), (((), _M_Glacier2._t_SessionPrx, False, 0), ((), _M_Test._t_TestToken, False, 0)), (((), _M_Test._t_TestToken, False, 0),), None, ())
    TestController._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "TestSessionPrx" not in _M_Test.__dict__:
    ...
    class TestSessionPrx(_M_Glacier2.SessionPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.TestSessionPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.TestSessionPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.TestSessionPrx, proxy, facet)
    ...
    TestSession._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Normal, None, (), (), (), None, ())
