...
if "StructValue" not in _M_Test.__dict__:
    ...
    class StructValue(object):
        ...
        def __repr__(self):
            return f"Test.StructValue({Ice.Util.format_fields(firstName=self.firstName, lastName=self.lastName, age=self.age)})"
...
if "Extended" not in _M_Test.__dict__:
    ...
    class Extended(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.Extended({Ice.Util.format_fields(b=self.b, e=self.e)})"
