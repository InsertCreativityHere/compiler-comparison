...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    class TestIntf(Ice.Object):
        ...
        def getReplicaId(self, current):
            raise NotImplementedError("servant method 'getReplicaId' not implemented")

        def getReplicaIdAndShutdown(self, current):
            raise NotImplementedError("servant method 'getReplicaIdAndShutdown' not implemented")

    TestIntf._op_getReplicaId = IcePy.Operation("getReplicaId", "getReplicaId", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    TestIntf._op_getReplicaIdAndShutdown = IcePy.Operation("getReplicaIdAndShutdown", "getReplicaIdAndShutdown", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_string, False, 0), ())
