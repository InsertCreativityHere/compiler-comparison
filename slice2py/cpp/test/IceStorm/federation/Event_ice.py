...
_M_Test._t_Event = IcePy.defineValue('::Test::Event', Ice.Value, -1, (), False, True, None, ())

if 'EventPrx' not in _M_Test.__dict__:
    _M_Test.EventPrx = Ice.createTempClass()
    class EventPrx(Ice.ObjectPrx):

        def pub(self, data, context=None):
            return _M_Test.Event._op_pub.invoke(self, ((data, ), context))

        def pubAsync(self, data, context=None):
            return _M_Test.Event._op_pub.invokeAsync(self, ((data, ), context))

        def begin_pub(self, data, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Event._op_pub.begin(self, ((data, ), _response, _ex, _sent, context))
    ...
    class Event(Ice.Object):
        ...
        def pub(self, data, current=None):
    ...
    Event._op_pub = IcePy.Operation('pub', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, ())
