...
class EventPrx(ObjectPrx):
    ...
    def pub(self, data: str, context: dict[str, str] | None = None) -> None:
        return Event._op_pub.invoke(self, ((data, ), context))

    def pubAsync(self, data: str, context: dict[str, str] | None = None) -> Awaitable[None]:
        return Event._op_pub.invokeAsync(self, ((data, ), context))
...
class Event(Object, ABC):
    ...
    @abstractmethod
    def pub(self, data: str, current: Current) -> None | Awaitable[None]:
        pass
