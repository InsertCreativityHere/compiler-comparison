...
if "CallbackPrx" not in _M_Test.__dict__:
    ...
    class Callback(Ice.Object):
        ...
        def getCount(self, current):
            raise NotImplementedError("servant method 'getCount' not implemented")

        def datagram(self, current):
            raise NotImplementedError("servant method 'datagram' not implemented")

        def getDatagramCount(self, current):
            raise NotImplementedError("servant method 'getDatagramCount' not implemented")

    Callback._op_ping = IcePy.Operation("ping", "ping", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Callback._op_getCount = IcePy.Operation("getCount", "getCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    Callback._op_datagram = IcePy.Operation("datagram", "datagram", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Callback._op_getDatagramCount = IcePy.Operation("getDatagramCount", "getDatagramCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
...
if "MyClassPrx" not in _M_Test.__dict__:
    ...
    class MyClass(Ice.Object):
        ...
        def callDatagramCallback(self, current):
            raise NotImplementedError("servant method 'callDatagramCallback' not implemented")

        def getCallbackDatagramCount(self, current):
            raise NotImplementedError("servant method 'getCallbackDatagramCount' not implemented")

        def shutdown(self, current):
            raise NotImplementedError("servant method 'shutdown' not implemented")

    MyClass._op_callCallback = IcePy.Operation("callCallback", "callCallback", Ice.OperationMode.Normal, None, (), (), (), None, ())
    MyClass._op_getCallbackCount = IcePy.Operation("getCallbackCount", "getCallbackCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    MyClass._op_incCounter = IcePy.Operation("incCounter", "incCounter", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
    MyClass._op_waitCounter = IcePy.Operation("waitCounter", "waitCounter", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
    MyClass._op_getConnectionCount = IcePy.Operation("getConnectionCount", "getConnectionCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    MyClass._op_getConnectionInfo = IcePy.Operation("getConnectionInfo", "getConnectionInfo", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_string, False, 0), ())
    MyClass._op_closeConnection = IcePy.Operation("closeConnection", "closeConnection", Ice.OperationMode.Normal, None, (), (((), IcePy._t_bool, False, 0),), (), None, ())
    MyClass._op_datagram = IcePy.Operation("datagram", "datagram", Ice.OperationMode.Normal, None, (), (), (), None, ())
    MyClass._op_getDatagramCount = IcePy.Operation("getDatagramCount", "getDatagramCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    MyClass._op_callDatagramCallback = IcePy.Operation("callDatagramCallback", "callDatagramCallback", Ice.OperationMode.Normal, None, (), (), (), None, ())
    MyClass._op_getCallbackDatagramCount = IcePy.Operation("getCallbackDatagramCount", "getCallbackDatagramCount", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_int, False, 0), ())
