...
class TestIntfPrx(ObjectPrx):
    ...
    def getAdapterId(self, context: dict[str, str] | None = None) -> str:
        return TestIntf._op_getAdapterId.invoke(self, ((), context))

    def getAdapterIdAsync(self, context: dict[str, str] | None = None) -> Awaitable[str]:
        return TestIntf._op_getAdapterId.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_getAdapterId: IcePy.Operation
    ...
    @abstractmethod
    def getAdapterId(self, current: Current) -> str | Awaitable[str]:
        pass

TestIntf._op_getAdapterId = IcePy.Operation(
    "getAdapterId",
    "getAdapterId",
