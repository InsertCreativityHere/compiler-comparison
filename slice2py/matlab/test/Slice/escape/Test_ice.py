...
if 'bitand' not in _M_classdef._break.__dict__:
    _M_classdef._break.bitand = Ice.createTempClass()
...
if 'bitor' not in _M_classdef._break.__dict__:
    _M_classdef._break.bitor = Ice.createTempClass()
    class bitor(object):
...
if 'logical' not in _M_classdef._break.__dict__:
    _M_classdef._break.logical = Ice.createTempClass()
...
if 'xor' not in _M_classdef._break.__dict__:
    _M_classdef._break.xor = Ice.createTempClass()
...
if '_try' not in _M_classdef._break.__dict__:
    _M_classdef._break._try = Ice.createTempClass()
...
if 'properties' not in _M_classdef._break.__dict__:
    _M_classdef._break.properties = Ice.createTempClass()
...
if 'persistent' not in _M_classdef._break.__dict__:
    _M_classdef._break.persistent = Ice.createTempClass()
...
if '_global' not in _M_classdef._break.__dict__:
    _M_classdef._break._global = Ice.createTempClass()
...
if 'elseifPrx' not in _M_classdef._break.__dict__:
    ...
    _M_classdef._break.elseif = Ice.createTempClass()
