...
if "BaseClass" not in _M_Test.__dict__:
    ...
    class BaseClass(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.BaseClass({Ice.Util.format_fields(bc=self.bc)})"
...
if "RelayPrx" not in _M_Test.__dict__:
    ...
    class RelayPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.RelayPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.RelayPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.RelayPrx, proxy, facet)
    ...
    class Relay(Ice.Object):
        ...
        def knownPreservedAsBase(self, current):
            raise NotImplementedError("servant method 'knownPreservedAsBase' not implemented")

        def knownPreservedAsKnownPreserved(self, current):
            raise NotImplementedError("servant method 'knownPreservedAsKnownPreserved' not implemented")

        def unknownPreservedAsBase(self, current):
            raise NotImplementedError("servant method 'unknownPreservedAsBase' not implemented")

        def unknownPreservedAsKnownPreserved(self, current):
            raise NotImplementedError("servant method 'unknownPreservedAsKnownPreserved' not implemented")

    Relay._op_knownPreservedAsBase = IcePy.Operation("knownPreservedAsBase", "knownPreservedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    Relay._op_knownPreservedAsKnownPreserved = IcePy.Operation("knownPreservedAsKnownPreserved", "knownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownPreserved,))
    Relay._op_unknownPreservedAsBase = IcePy.Operation("unknownPreservedAsBase", "unknownPreservedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    Relay._op_unknownPreservedAsKnownPreserved = IcePy.Operation("unknownPreservedAsKnownPreserved", "unknownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownPreserved,))
...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    class TestIntf(Ice.Object):
        ...
        def unknownMostDerived2AsBaseCompact(self, current):
    ...
    TestIntf._op_unknownDerivedAsBase = IcePy.Operation("unknownDerivedAsBase", "unknownDerivedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    ...
    TestIntf._op_unknownMostDerived2AsBaseCompact = IcePy.Operation("unknownMostDerived2AsBaseCompact", "unknownMostDerived2AsBaseCompact", Ice.OperationMode.Normal, Ice.FormatType.CompactFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownPreservedAsBase = IcePy.Operation("knownPreservedAsBase", "knownPreservedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownPreservedAsKnownPreserved = IcePy.Operation("knownPreservedAsKnownPreserved", "knownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownPreserved,))
    TestIntf._op_relayKnownPreservedAsBase = IcePy.Operation("relayKnownPreservedAsBase", "relayKnownPreservedAsBase", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_RelayPrx, False, 0),), (), None, (_M_Test._t_Base,))
    TestIntf._op_relayKnownPreservedAsKnownPreserved = IcePy.Operation("relayKnownPreservedAsKnownPreserved", "relayKnownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_RelayPrx, False, 0),), (), None, (_M_Test._t_KnownPreserved,))
    TestIntf._op_unknownPreservedAsBase = IcePy.Operation("unknownPreservedAsBase", "unknownPreservedAsBase", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_unknownPreservedAsKnownPreserved = IcePy.Operation("unknownPreservedAsKnownPreserved", "unknownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_KnownPreserved,))
    TestIntf._op_relayUnknownPreservedAsBase = IcePy.Operation("relayUnknownPreservedAsBase", "relayUnknownPreservedAsBase", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_RelayPrx, False, 0),), (), None, (_M_Test._t_Base,))
    TestIntf._op_relayUnknownPreservedAsKnownPreserved = IcePy.Operation("relayUnknownPreservedAsKnownPreserved", "relayUnknownPreservedAsKnownPreserved", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_RelayPrx, False, 0),), (), None, (_M_Test._t_KnownPreserved,))
...
if "PreservedClass" not in _M_Test.__dict__:
    ...
    class PreservedClass(_M_Test.BaseClass):
        ...
        def __repr__(self):
            return f"Test.PreservedClass({Ice.Util.format_fields(bc=self.bc, pc=self.pc)})"
...
if "Preserved1" not in _M_Test.__dict__:
    ...
    class Preserved1(_M_Test.KnownPreservedDerived):
        ...
        def __repr__(self):
            return f"Test.Preserved1({Ice.Util.format_fields(b=self.b, kp=self.kp, kpd=self.kpd, p1=self.p1)})"
...
if "Preserved2" not in _M_Test.__dict__:
    ...
    class Preserved2(_M_Test.Preserved1):
        ...
        def __repr__(self):
            return f"Test.Preserved2({Ice.Util.format_fields(b=self.b, kp=self.kp, kpd=self.kpd, p1=self.p1, p2=self.p2)})"
