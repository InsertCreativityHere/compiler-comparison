...
from Test.KnownDerived import _Test_KnownDerived_t

from Test.KnownIntermediate import _Test_KnownIntermediate_t

from Test.KnownMostDerived import _Test_KnownMostDerived_t
...
if TYPE_CHECKING:
    ...
    from Test.Relay import RelayPrx
...
class TestIntfPrx(ObjectPrx):
    ...
    def unknownMostDerived2AsBaseCompact(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_unknownMostDerived2AsBaseCompact.invoke(self, ((), context))

    def unknownMostDerived2AsBaseCompactAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_unknownMostDerived2AsBaseCompact.invokeAsync(self, ((), context))

    def knownPreservedAsBase(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_knownPreservedAsBase.invoke(self, ((), context))

    def knownPreservedAsBaseAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_knownPreservedAsBase.invokeAsync(self, ((), context))

    def knownPreservedAsKnownPreserved(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_knownPreservedAsKnownPreserved.invoke(self, ((), context))

    def knownPreservedAsKnownPreservedAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_knownPreservedAsKnownPreserved.invokeAsync(self, ((), context))

    def relayKnownPreservedAsBase(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_relayKnownPreservedAsBase.invoke(self, ((r, ), context))

    def relayKnownPreservedAsBaseAsync(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_relayKnownPreservedAsBase.invokeAsync(self, ((r, ), context))

    def relayKnownPreservedAsKnownPreserved(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_relayKnownPreservedAsKnownPreserved.invoke(self, ((r, ), context))

    def relayKnownPreservedAsKnownPreservedAsync(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_relayKnownPreservedAsKnownPreserved.invokeAsync(self, ((r, ), context))

    def unknownPreservedAsBase(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_unknownPreservedAsBase.invoke(self, ((), context))

    def unknownPreservedAsBaseAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_unknownPreservedAsBase.invokeAsync(self, ((), context))

    def unknownPreservedAsKnownPreserved(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_unknownPreservedAsKnownPreserved.invoke(self, ((), context))

    def unknownPreservedAsKnownPreservedAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_unknownPreservedAsKnownPreserved.invokeAsync(self, ((), context))

    def relayUnknownPreservedAsBase(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_relayUnknownPreservedAsBase.invoke(self, ((r, ), context))

    def relayUnknownPreservedAsBaseAsync(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_relayUnknownPreservedAsBase.invokeAsync(self, ((r, ), context))

    def relayUnknownPreservedAsKnownPreserved(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_relayUnknownPreservedAsKnownPreserved.invoke(self, ((r, ), context))

    def relayUnknownPreservedAsKnownPreservedAsync(self, r: RelayPrx | None, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_relayUnknownPreservedAsKnownPreserved.invokeAsync(self, ((r, ), context))
...
class TestIntf(Object, ABC):
    ...
    _op_unknownMostDerived2AsBaseCompact: IcePy.Operation
    _op_knownPreservedAsBase: IcePy.Operation
    _op_knownPreservedAsKnownPreserved: IcePy.Operation
    _op_relayKnownPreservedAsBase: IcePy.Operation
    _op_relayKnownPreservedAsKnownPreserved: IcePy.Operation
    _op_unknownPreservedAsBase: IcePy.Operation
    _op_unknownPreservedAsKnownPreserved: IcePy.Operation
    _op_relayUnknownPreservedAsBase: IcePy.Operation
    _op_relayUnknownPreservedAsKnownPreserved: IcePy.Operation
    ...
    @abstractmethod
    def unknownMostDerived2AsBaseCompact(self, current: Current) -> None | Awaitable[None]:
        pass
    ...
    @abstractmethod
    def relayKnownPreservedAsBase(self, r: RelayPrx | None, current: Current) -> None | Awaitable[None]:
        pass

    @abstractmethod
    def relayKnownPreservedAsKnownPreserved(self, r: RelayPrx | None, current: Current) -> None | Awaitable[None]:
        pass
    ...
    @abstractmethod
    def relayUnknownPreservedAsBase(self, r: RelayPrx | None, current: Current) -> None | Awaitable[None]:
        pass

    @abstractmethod
    def relayUnknownPreservedAsKnownPreserved(self, r: RelayPrx | None, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_unknownMostDerived2AsBaseCompact = IcePy.Operation(
...
TestIntf._op_knownPreservedAsBase = IcePy.Operation(
...
TestIntf._op_knownPreservedAsKnownPreserved = IcePy.Operation(
...
TestIntf._op_relayKnownPreservedAsBase = IcePy.Operation(
    "relayKnownPreservedAsBase",
    "relayKnownPreservedAsBase",
    OperationMode.Normal,
    None,
    (),
    (((), _Test_RelayPrx_t, False, 0),),
    (),
    None,
    (_Test_Base_t,))

TestIntf._op_relayKnownPreservedAsKnownPreserved = IcePy.Operation(
...
TestIntf._op_unknownPreservedAsBase = IcePy.Operation(
...
TestIntf._op_unknownPreservedAsKnownPreserved = IcePy.Operation(
...
TestIntf._op_relayUnknownPreservedAsBase = IcePy.Operation(
...
TestIntf._op_relayUnknownPreservedAsKnownPreserved = IcePy.Operation(
