...
if "S" not in _M_Test.__dict__:
    ...
    class S(object):
        ...
        def __repr__(self):
            return f"Test.S({Ice.Util.format_fields(str=self.str)})"
...
if "Base" not in _M_Test.__dict__:
    ...
    class Base(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Base({Ice.Util.format_fields(theS=self.theS, str=self.str)})"
...
if "A" not in _M_Test.__dict__:
    ...
    class A(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.A({Ice.Util.format_fields(theB=self.theB, theC=self.theC, preMarshalInvoked=self.preMarshalInvoked, postUnmarshalInvoked=self.postUnmarshalInvoked)})"
...
if "B" not in _M_Test.__dict__:
    ...
    class B(_M_Test.A):
        ...
        def __repr__(self):
            return f"Test.B({Ice.Util.format_fields(theB=self.theB, theC=self.theC, preMarshalInvoked=self.preMarshalInvoked, postUnmarshalInvoked=self.postUnmarshalInvoked, theA=self.theA)})"
...
if "C" not in _M_Test.__dict__:
    ...
    class C(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.C({Ice.Util.format_fields(theB=self.theB, preMarshalInvoked=self.preMarshalInvoked, postUnmarshalInvoked=self.postUnmarshalInvoked)})"
...
if "D" not in _M_Test.__dict__:
    ...
    class D(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.D({Ice.Util.format_fields(theA=self.theA, theB=self.theB, theC=self.theC, preMarshalInvoked=self.preMarshalInvoked, postUnmarshalInvoked=self.postUnmarshalInvoked)})"
...
if "G" not in _M_Test.__dict__:
    ...
    class G(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.G({Ice.Util.format_fields(theS=self.theS, str=self.str)})"
...
if "A" not in _M_Test.Inner.__dict__:
    ...
    class A(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Inner.A({Ice.Util.format_fields(theA=self.theA)})"
...
if "Ex" not in _M_Test.Inner.__dict__:
    ...
    class Ex(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.Inner.Ex({Ice.Util.format_fields(reason=self.reason)})"
...
if "A" not in _M_Test.Inner.Sub.__dict__:
    ...
    class A(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Inner.Sub.A({Ice.Util.format_fields(theA=self.theA)})"
...
if "Ex" not in _M_Test.Inner.Sub.__dict__:
    ...
    class Ex(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.Inner.Sub.Ex({Ice.Util.format_fields(reason=self.reason)})"
...
if "A1" not in _M_Test.__dict__:
    ...
    class A1(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.A1({Ice.Util.format_fields(name=self.name)})"
...
if "B1" not in _M_Test.__dict__:
    ...
    class B1(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.B1({Ice.Util.format_fields(a1=self.a1, a2=self.a2)})"
...
if "D1" not in _M_Test.__dict__:
    ...
    class D1(_M_Test.B1):
        ...
        def __repr__(self):
            return f"Test.D1({Ice.Util.format_fields(a1=self.a1, a2=self.a2, a3=self.a3, a4=self.a4)})"
...
if "EBase" not in _M_Test.__dict__:
    ...
    class EBase(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.EBase({Ice.Util.format_fields(a1=self.a1, a2=self.a2)})"
...
if "EDerived" not in _M_Test.__dict__:
    ...
    class EDerived(_M_Test.EBase):
        ...
        def __repr__(self):
            return f"Test.EDerived({Ice.Util.format_fields(a1=self.a1, a2=self.a2, a3=self.a3, a4=self.a4)})"
...
if "Recursive" not in _M_Test.__dict__:
    ...
    class Recursive(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Recursive({Ice.Util.format_fields(v=self.v)})"
...
if "K" not in _M_Test.__dict__:
    ...
    class K(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.K({Ice.Util.format_fields(value=self.value)})"
...
if "L" not in _M_Test.__dict__:
    ...
    class L(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.L({Ice.Util.format_fields(data=self.data)})"
...
if "StructKey" not in _M_Test.__dict__:
    ...
    class StructKey(object):
        ...
        def __repr__(self):
            return f"Test.StructKey({Ice.Util.format_fields(i=self.i, s=self.s)})"
...
if "M" not in _M_Test.__dict__:
    ...
    class M(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.M({Ice.Util.format_fields(v=self.v)})"
...
if "F3" not in _M_Test.__dict__:
    ...
    class F3(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.F3({Ice.Util.format_fields(f1=self.f1, f2=self.f2)})"
...
if "InitialPrx" not in _M_Test.__dict__:
    ...
    class Initial(Ice.Object):
        ...
        def setRecursive(self, p, current):
    ...
    Initial._op_getB1 = IcePy.Operation("getB1", "getB1", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_B, False, 0), ())
    Initial._op_getB2 = IcePy.Operation("getB2", "getB2", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_B, False, 0), ())
    Initial._op_getC = IcePy.Operation("getC", "getC", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_C, False, 0), ())
    Initial._op_getD = IcePy.Operation("getD", "getD", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_D, False, 0), ())
    Initial._op_setRecursive = IcePy.Operation("setRecursive", "setRecursive", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_Recursive, False, 0),), (), None, ())
    Initial._op_setCycle = IcePy.Operation("setCycle", "setCycle", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_Recursive, False, 0),), (), None, ())
    Initial._op_acceptsClassCycles = IcePy.Operation("acceptsClassCycles", "acceptsClassCycles", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
    Initial._op_getMB = IcePy.Operation("getMB", "getMB", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_B, False, 0), ())
    Initial._op_getAMDMB = IcePy.Operation("getAMDMB", "getAMDMB", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_B, False, 0), ())
    Initial._op_getAll = IcePy.Operation("getAll", "getAll", Ice.OperationMode.Normal, None, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0), ((), _M_Test._t_C, False, 0), ((), _M_Test._t_D, False, 0)), None, ())
    Initial._op_getK = IcePy.Operation("getK", "getK", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_K, False, 0), ())
    Initial._op_opValue = IcePy.Operation("opValue", "opValue", Ice.OperationMode.Normal, None, (), (((), IcePy._t_Value, False, 0),), (((), IcePy._t_Value, False, 0),), ((), IcePy._t_Value, False, 0), ())
    Initial._op_opValueSeq = IcePy.Operation("opValueSeq", "opValueSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ValueSeq, False, 0),), (((), _M_Test._t_ValueSeq, False, 0),), ((), _M_Test._t_ValueSeq, False, 0), ())
    Initial._op_opValueMap = IcePy.Operation("opValueMap", "opValueMap", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ValueMap, False, 0),), (((), _M_Test._t_ValueMap, False, 0),), ((), _M_Test._t_ValueMap, False, 0), ())
    Initial._op_getD1 = IcePy.Operation("getD1", "getD1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_D1, False, 0),), (), ((), _M_Test._t_D1, False, 0), ())
    Initial._op_throwEDerived = IcePy.Operation("throwEDerived", "throwEDerived", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_EDerived,))
    Initial._op_setG = IcePy.Operation("setG", "setG", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_G, False, 0),), (), None, ())
    Initial._op_opBaseSeq = IcePy.Operation("opBaseSeq", "opBaseSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_BaseSeq, False, 0),), (((), _M_Test._t_BaseSeq, False, 0),), ((), _M_Test._t_BaseSeq, False, 0), ())
    Initial._op_getCompact = IcePy.Operation("getCompact", "getCompact", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_Compact, False, 0), ())
    Initial._op_getInnerA = IcePy.Operation("getInnerA", "getInnerA", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test.Inner._t_A, False, 0), ())
    Initial._op_getInnerSubA = IcePy.Operation("getInnerSubA", "getInnerSubA", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test.Inner.Sub._t_A, False, 0), ())
    Initial._op_throwInnerEx = IcePy.Operation("throwInnerEx", "throwInnerEx", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test.Inner._t_Ex,))
    Initial._op_throwInnerSubEx = IcePy.Operation("throwInnerSubEx", "throwInnerSubEx", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test.Inner.Sub._t_Ex,))
    Initial._op_opM = IcePy.Operation("opM", "opM", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_M, False, 0),), (((), _M_Test._t_M, False, 0),), ((), _M_Test._t_M, False, 0), ())
    Initial._op_opF1 = IcePy.Operation("opF1", "opF1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_F1, False, 0),), (((), _M_Test._t_F1, False, 0),), ((), _M_Test._t_F1, False, 0), ())
    Initial._op_opF2 = IcePy.Operation("opF2", "opF2", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_F2Prx, False, 0),), (((), _M_Test._t_F2Prx, False, 0),), ((), _M_Test._t_F2Prx, False, 0), ())
    Initial._op_opF3 = IcePy.Operation("opF3", "opF3", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_F3, False, 0),), (((), _M_Test._t_F3, False, 0),), ((), _M_Test._t_F3, False, 0), ())
    Initial._op_hasF3 = IcePy.Operation("hasF3", "hasF3", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
...
if "UnexpectedObjectExceptionTestPrx" not in _M_Test.__dict__:
    ...
    class UnexpectedObjectExceptionTestPrx(Ice.ObjectPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.UnexpectedObjectExceptionTestPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.UnexpectedObjectExceptionTestPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.UnexpectedObjectExceptionTestPrx, proxy, facet)
    ...
    UnexpectedObjectExceptionTest._op_op = IcePy.Operation("op", "op", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_Empty, False, 0), ())
...
if "COneMember" not in _M_Test.__dict__:
    ...
    class COneMember(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.COneMember({Ice.Util.format_fields(e=self.e)})"
...
if "CTwoMembers" not in _M_Test.__dict__:
    ...
    class CTwoMembers(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.CTwoMembers({Ice.Util.format_fields(e1=self.e1, e2=self.e2)})"
...
if "EOneMember" not in _M_Test.__dict__:
    ...
    class EOneMember(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.EOneMember({Ice.Util.format_fields(e=self.e)})"
...
if "ETwoMembers" not in _M_Test.__dict__:
    ...
    class ETwoMembers(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.ETwoMembers({Ice.Util.format_fields(e1=self.e1, e2=self.e2)})"
...
if "SOneMember" not in _M_Test.__dict__:
    ...
    class SOneMember(object):
        ...
        def __repr__(self):
            return f"Test.SOneMember({Ice.Util.format_fields(e=self.e)})"
...
if "STwoMembers" not in _M_Test.__dict__:
    ...
    class STwoMembers(object):
        ...
        def __repr__(self):
            return f"Test.STwoMembers({Ice.Util.format_fields(e1=self.e1, e2=self.e2)})"
