...
if "C1" not in _M_LocalTest.__dict__:
    _M_LocalTest._t_C1 = IcePy.declareValue("::LocalTest::C1")
...
if "C1" not in _M_LocalTest.__dict__:
    ...
    class C1(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.C1({Ice.Util.format_fields(i=self.i)})"
...
if "S1" not in _M_LocalTest.__dict__:
    ...
    class S1(object):
        ...
        def __repr__(self):
            return f"LocalTest.S1({Ice.Util.format_fields(c1=self.c1)})"
...
if "S2" not in _M_LocalTest.__dict__:
    ...
    class S2(object):
        ...
        def __repr__(self):
            return f"LocalTest.S2({Ice.Util.format_fields(s1=self.s1)})"
...
if "S3" not in _M_LocalTest.__dict__:
    ...
    class S3(object):
        ...
        def __repr__(self):
            return f"LocalTest.S3({Ice.Util.format_fields(c1seq=self.c1seq)})"
...
if "S4" not in _M_LocalTest.__dict__:
    ...
    class S4(object):
        ...
        def __repr__(self):
            return f"LocalTest.S4({Ice.Util.format_fields(s1seq=self.s1seq)})"
...
if "S5" not in _M_LocalTest.__dict__:
    ...
    class S5(object):
        ...
        def __repr__(self):
            return f"LocalTest.S5({Ice.Util.format_fields(c1dict=self.c1dict)})"
...
if "S6" not in _M_LocalTest.__dict__:
    ...
    class S6(object):
        ...
        def __repr__(self):
            return f"LocalTest.S6({Ice.Util.format_fields(s1dict=self.s1dict)})"
...
if "S7" not in _M_LocalTest.__dict__:
    ...
    class S7(object):
        ...
        def __repr__(self):
            return f"LocalTest.S7({Ice.Util.format_fields(c1seqseq=self.c1seqseq)})"
...
if "S8" not in _M_LocalTest.__dict__:
    ...
    class S8(object):
        ...
        def __repr__(self):
            return f"LocalTest.S8({Ice.Util.format_fields(s1seqseq=self.s1seqseq)})"
...
if "CB1" not in _M_LocalTest.__dict__:
    ...
    class CB1(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB1({Ice.Util.format_fields(s1=self.s1)})"
...
if "CB2" not in _M_LocalTest.__dict__:
    ...
    class CB2(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB2({Ice.Util.format_fields(c1seq=self.c1seq)})"
...
if "CB3" not in _M_LocalTest.__dict__:
    ...
    class CB3(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB3({Ice.Util.format_fields(s1seq=self.s1seq)})"
...
if "CB4" not in _M_LocalTest.__dict__:
    ...
    class CB4(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB4({Ice.Util.format_fields(c1dict=self.c1dict)})"
...
if "CB5" not in _M_LocalTest.__dict__:
    ...
    class CB5(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB5({Ice.Util.format_fields(s1dict=self.s1dict)})"
...
if "CB6" not in _M_LocalTest.__dict__:
    ...
    class CB6(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB6({Ice.Util.format_fields(c1seqseq=self.c1seqseq)})"
...
if "CB7" not in _M_LocalTest.__dict__:
    ...
    class CB7(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB7({Ice.Util.format_fields(s1seqseq=self.s1seqseq)})"
...
if "CB8" not in _M_LocalTest.__dict__:
    ...
    class CB8(Ice.Value):
        ...
        def __repr__(self):
            return f"LocalTest.CB8({Ice.Util.format_fields(s1=self.s1, c1seq=self.c1seq, s1dict=self.s1dict)})"
...
if "StructKey" not in _M_LocalTest.__dict__:
    ...
    class StructKey(object):
        ...
        def __repr__(self):
            return f"LocalTest.StructKey({Ice.Util.format_fields(i=self.i, j=self.j)})"
