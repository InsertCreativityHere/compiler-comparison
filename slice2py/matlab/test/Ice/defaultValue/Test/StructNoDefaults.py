...
from Test.DerivedSeq import _Test_DerivedSeq_t
...
from Test.IntSeqSeq import _Test_IntSeqSeq_t
...
if TYPE_CHECKING:
    from Test.Derived import Derived
...
class StructNoDefaults:
    ...
    derivedSeq: list[Derived | None] = field(default_factory=list)
    intSeqSeq: list[list[int]] = field(default_factory=list)
...
_Test_StructNoDefaults_t = IcePy.defineStruct(
    ...
    (
        ...
        ("derivedSeq", (), _Test_DerivedSeq_t),
        ("intSeqSeq", (), _Test_IntSeqSeq_t)
    ))
