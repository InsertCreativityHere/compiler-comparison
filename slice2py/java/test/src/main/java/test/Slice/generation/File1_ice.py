...
if 'Interface1Prx' not in _M_Test.__dict__:
    ...
    class Interface1Prx(Ice.ObjectPrx):
        ...
        def begin_method(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Interface1._op_method.begin(self, ((), _response, _ex, _sent, context))

        def end_method(self, _r):
            return _M_Test.Interface1._op_method.end(self, _r)
    ...
    Interface1._op_method = IcePy.Operation('method', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
...
if 'Class1' not in _M_Test2.__dict__:
    _M_Test2.Class1 = Ice.createTempClass()
