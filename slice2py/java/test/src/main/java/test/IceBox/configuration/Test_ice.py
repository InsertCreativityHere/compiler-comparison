...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    TestIntf._op_getProperty = IcePy.Operation('getProperty', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), IcePy._t_string, False, 0), ())
    TestIntf._op_getArgs = IcePy.Operation('getArgs', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_Ice._t_StringSeq, False, 0), ())
