...
class BackgroundControllerPrx(ObjectPrx):
    ...
    def initializeSocketStatus(self, status: int, context: dict[str, str] | None = None) -> None:
        return BackgroundController._op_initializeSocketStatus.invoke(self, ((status, ), context))

    def initializeSocketStatusAsync(self, status: int, context: dict[str, str] | None = None) -> Awaitable[None]:
        return BackgroundController._op_initializeSocketStatus.invokeAsync(self, ((status, ), context))
...
class BackgroundController(Object, ABC):
    ...
    _op_initializeSocketStatus: IcePy.Operation
    ...
    @abstractmethod
    def initializeSocketStatus(self, status: int, current: Current) -> None | Awaitable[None]:
        pass
...
BackgroundController._op_initializeSocketStatus = IcePy.Operation(
