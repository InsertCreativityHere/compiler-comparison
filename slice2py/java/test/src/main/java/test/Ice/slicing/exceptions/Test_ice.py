...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    TestIntf._op_baseAsBase = IcePy.Operation("baseAsBase", "baseAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_unknownDerivedAsBase = IcePy.Operation("unknownDerivedAsBase", "unknownDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownDerivedAsBase = IcePy.Operation("knownDerivedAsBase", "knownDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownDerivedAsKnownDerived = IcePy.Operation("knownDerivedAsKnownDerived", "knownDerivedAsKnownDerived", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_KnownDerived,))
    TestIntf._op_unknownIntermediateAsBase = IcePy.Operation("unknownIntermediateAsBase", "unknownIntermediateAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownIntermediateAsBase = IcePy.Operation("knownIntermediateAsBase", "knownIntermediateAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownMostDerivedAsBase = IcePy.Operation("knownMostDerivedAsBase", "knownMostDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_knownIntermediateAsKnownIntermediate = IcePy.Operation("knownIntermediateAsKnownIntermediate", "knownIntermediateAsKnownIntermediate", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_knownMostDerivedAsKnownIntermediate = IcePy.Operation("knownMostDerivedAsKnownIntermediate", "knownMostDerivedAsKnownIntermediate", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_knownMostDerivedAsKnownMostDerived = IcePy.Operation("knownMostDerivedAsKnownMostDerived", "knownMostDerivedAsKnownMostDerived", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_KnownMostDerived,))
    TestIntf._op_unknownMostDerived1AsBase = IcePy.Operation("unknownMostDerived1AsBase", "unknownMostDerived1AsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
    TestIntf._op_unknownMostDerived1AsKnownIntermediate = IcePy.Operation("unknownMostDerived1AsKnownIntermediate", "unknownMostDerived1AsKnownIntermediate", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_KnownIntermediate,))
    TestIntf._op_unknownMostDerived2AsBase = IcePy.Operation("unknownMostDerived2AsBase", "unknownMostDerived2AsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_Base,))
