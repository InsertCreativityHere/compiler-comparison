...
if "LargeStruct" not in _M_Test.__dict__:
    ...
    class LargeStruct(object):
        ...
        def __repr__(self):
            return f"Test.LargeStruct({Ice.Util.format_fields(bo=self.bo, by=self.by, sh=self.sh, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, e=self.e, p=self.p, ss=self.ss)})"
...
if "OptionalClass" not in _M_Test.__dict__:
    ...
    class OptionalClass(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.OptionalClass({Ice.Util.format_fields(bo=self.bo, by=self.by, sh=self.sh, i=self.i, s=self.s, enumS4=self.enumS4, byteBoolD6=self.byteBoolD6, shortIntD7=self.shortIntD7, enum8=self.enum8, intSeq12=self.intSeq12, byteSeq13=self.byteSeq13, stringSeq14=self.stringSeq14, p15=self.p15)})"
...
if "MyClass" not in _M_Test.__dict__:
    ...
    class MyClass(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.MyClass({Ice.Util.format_fields(c=self.c, prx=self.prx, o=self.o, s=self.s, seq1=self.seq1, seq2=self.seq2, seq3=self.seq3, seq4=self.seq4, seq5=self.seq5, seq6=self.seq6, seq7=self.seq7, seq8=self.seq8, seq9=self.seq9, seq10=self.seq10, d=self.d)})"
...
if "MyException" not in _M_Test.__dict__:
    ...
    class MyException(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.MyException({Ice.Util.format_fields(c=self.c)})"
