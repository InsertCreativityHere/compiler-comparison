...
from .DiamondClass import DiamondClass
from .DiamondClass import DiamondClassPrx
from .DiamondClass_forward import _Test_DiamondClassPrx_t
...
from .MyOtherDerivedClass import MyOtherDerivedClass
from .MyOtherDerivedClass import MyOtherDerivedClassPrx
from .MyOtherDerivedClass_forward import _Test_MyOtherDerivedClassPrx_t
from .S import S
...
__all__ = [
    ...
    "_Test_MyOtherDerivedClassPrx_t",
    "S",
    "_Test_S_t"
]
