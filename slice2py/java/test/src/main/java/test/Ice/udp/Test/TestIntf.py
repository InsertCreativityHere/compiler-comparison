...
class TestIntfPrx(ObjectPrx):
    ...
    def pingBiDir(self, id: Identity, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_pingBiDir.invoke(self, ((id, ), context))

    def pingBiDirAsync(self, id: Identity, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_pingBiDir.invokeAsync(self, ((id, ), context))
...
class TestIntf(Object, ABC):
    ...
    @abstractmethod
    def pingBiDir(self, id: Identity, current: Current) -> None | Awaitable[None]:
        pass
