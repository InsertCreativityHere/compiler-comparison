...
if "C1" not in _M_Test1.__dict__:
    ...
    class C1(Ice.Value):
        ...
        def __repr__(self):
            return f"Test1.C1({Ice.Util.format_fields(i=self.i)})"
...
if "C2" not in _M_Test1.__dict__:
    ...
    class C2(_M_Test1.C1):
        ...
        def __repr__(self):
            return f"Test1.C2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "E1" not in _M_Test1.__dict__:
    ...
    class E1(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test1.E1({Ice.Util.format_fields(i=self.i)})"
...
if "E2" not in _M_Test1.__dict__:
    ...
    class E2(_M_Test1.E1):
        ...
        def __repr__(self):
            return f"Test1.E2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "notify" not in _M_Test1.__dict__:
    _M_Test1.notify = None
    class notify(Ice.UserException):
        def __init__(self, i=0):
            self.i = i

        def __repr__(self):
            return f"Test1.notify({Ice.Util.format_fields(i=self.i)})"
