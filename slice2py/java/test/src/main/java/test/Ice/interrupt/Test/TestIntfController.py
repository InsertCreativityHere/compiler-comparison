...
from Test.CannotInterruptException import _Test_CannotInterruptException_t
...
class TestIntfControllerPrx(ObjectPrx):
    ...
    def interrupt(self, context: dict[str, str] | None = None) -> None:
        return TestIntfController._op_interrupt.invoke(self, ((), context))

    def interruptAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntfController._op_interrupt.invokeAsync(self, ((), context))
...
class TestIntfController(Object, ABC):
    ...
    @abstractmethod
    def interrupt(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntfController._op_interrupt = IcePy.Operation(
    "interrupt",
    "interrupt",
    OperationMode.Normal,
    None,
