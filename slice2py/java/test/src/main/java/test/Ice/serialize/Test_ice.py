...
if "Struct1" not in _M_Test.__dict__:
    ...
    class Struct1(object):
        ...
        def __repr__(self):
            return f"Test.Struct1({Ice.Util.format_fields(bo=self.bo, by=self.by, sh=self.sh, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, e=self.e, p=self.p)})"
...
if "Base" not in _M_Test.__dict__:
    ...
    class Base(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Base({Ice.Util.format_fields(b=self.b, o=self.o, s=self.s, seq1=self.seq1, seq2=self.seq2, seq3=self.seq3, seq4=self.seq4, d1=self.d1, d2=self.d2, d3=self.d3, d4=self.d4)})"
...
if "Derived" not in _M_Test.__dict__:
    ...
    class Derived(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.Derived({Ice.Util.format_fields(b=self.b, o=self.o, s=self.s, seq1=self.seq1, seq2=self.seq2, seq3=self.seq3, seq4=self.seq4, d1=self.d1, d2=self.d2, d3=self.d3, d4=self.d4, p=self.p)})"
...
if "Ex" not in _M_Test.__dict__:
    ...
    class Ex(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.Ex({Ice.Util.format_fields(s=self.s, b=self.b)})"
...
if "InitialPrx" not in _M_Test.__dict__:
    ...
    class Initial(Ice.Object):
        ...
        def getStruct1(self, current):
            raise NotImplementedError("servant method 'getStruct1' not implemented")

        def getBase(self, current):
            raise NotImplementedError("servant method 'getBase' not implemented")

        def getEx(self, current):
            raise NotImplementedError("servant method 'getEx' not implemented")

        def shutdown(self, current):
            raise NotImplementedError("servant method 'shutdown' not implemented")

    Initial._op_getStruct1 = IcePy.Operation("getStruct1", "getStruct1", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_ByteS, False, 0), ())
    Initial._op_getBase = IcePy.Operation("getBase", "getBase", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_ByteS, False, 0), ())
    Initial._op_getEx = IcePy.Operation("getEx", "getEx", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_ByteS, False, 0), ())
