...
if 'MyObjectPrx' not in _M_Test.__dict__:
    ...
    MyObject._op_amdBadSystemAdd = IcePy.Operation('amdBadSystemAdd', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), ((), IcePy._t_int, False, 0), ())
