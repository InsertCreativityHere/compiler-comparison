...
if "SBSUnknownDerived" not in _M_Test.__dict__:
    ...
    class SBSUnknownDerived(_M_Test.SBase):
        ...
        def __repr__(self):
            return f"Test.SBSUnknownDerived({Ice.Util.format_fields(sb=self.sb, sbsud=self.sbsud)})"
...
if "SUnknown" not in _M_Test.__dict__:
    ...
    class SUnknown(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.SUnknown({Ice.Util.format_fields(su=self.su, cycle=self.cycle)})"
...
if "D2" not in _M_Test.__dict__:
    ...
    class D2(_M_Test.B):
        ...
        def __repr__(self):
            return f"Test.D2({Ice.Util.format_fields(sb=self.sb, pb=self.pb, sd2=self.sd2, pd2=self.pd2)})"
...
if "D4" not in _M_Test.__dict__:
    ...
    class D4(_M_Test.B):
        ...
        def __repr__(self):
            return f"Test.D4({Ice.Util.format_fields(sb=self.sb, pb=self.pb, p1=self.p1, p2=self.p2)})"
...
if "UnknownDerivedException" not in _M_Test.__dict__:
    ...
    class UnknownDerivedException(_M_Test.BaseException):
        ...
        def __repr__(self):
            return f"Test.UnknownDerivedException({Ice.Util.format_fields(sbe=self.sbe, pb=self.pb, sude=self.sude, pd2=self.pd2)})"
...
if "MyClass" not in _M_Test.__dict__:
    ...
    class MyClass(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.MyClass({Ice.Util.format_fields(i=self.i)})"
...
if "PSUnknown" not in _M_Test.__dict__:
    ...
    class PSUnknown(_M_Test.Preserved):
        ...
        def __repr__(self):
            return f"Test.PSUnknown({Ice.Util.format_fields(pi=self.pi, ps=self.ps, psu=self.psu, graph=self.graph, cl=self.cl)})"
...
if "PSUnknown2" not in _M_Test.__dict__:
    ...
    class PSUnknown2(_M_Test.Preserved):
        ...
        def __repr__(self):
            return f"Test.PSUnknown2({Ice.Util.format_fields(pi=self.pi, ps=self.ps, pb=self.pb)})"
...
if "PSUnknownException" not in _M_Test.__dict__:
    ...
    class PSUnknownException(_M_Test.PreservedException):
        ...
        def __repr__(self):
            return f"Test.PSUnknownException({Ice.Util.format_fields(p=self.p)})"
