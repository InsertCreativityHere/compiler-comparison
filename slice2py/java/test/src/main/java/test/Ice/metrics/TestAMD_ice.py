...
if 'MetricsPrx' not in _M_Test.__dict__:
    ...
    Metrics._op_opWithUnknownException = IcePy.Operation('opWithUnknownException', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    Metrics._op_opByteS = IcePy.Operation('opByteS', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (((), _M_Test._t_ByteSeq, False, 0),), (), None, ())
