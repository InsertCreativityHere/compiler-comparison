...
if "BackgroundControllerPrx" not in _M_Test.__dict__:
    ...
    class BackgroundController(Ice.Object):
        ...
        def initializeSocketStatus(self, status, current):
    ...
    BackgroundController._op_initializeSocketStatus = IcePy.Operation("initializeSocketStatus", "initializeSocketStatus", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
