...
if 'BackgroundControllerPrx' not in _M_Test.__dict__:
    ...
    class BackgroundControllerPrx(Ice.ObjectPrx):
        ...
        def initializeSocketStatus(self, status, context=None):
            return _M_Test.BackgroundController._op_initializeSocketStatus.invoke(self, ((status, ), context))

        def initializeSocketStatusAsync(self, status, context=None):
            return _M_Test.BackgroundController._op_initializeSocketStatus.invokeAsync(self, ((status, ), context))

        def begin_initializeSocketStatus(self, status, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.BackgroundController._op_initializeSocketStatus.begin(self, ((status, ), _response, _ex, _sent, context))

        def end_initializeSocketStatus(self, _r):
            return _M_Test.BackgroundController._op_initializeSocketStatus.end(self, _r)
    ...
    class BackgroundController(Ice.Object):
        ...
        def initializeSocketStatus(self, status, current=None):
            raise NotImplementedError("servant method 'initializeSocketStatus' not implemented")
    ...
    BackgroundController._op_initializeSocketStatus = IcePy.Operation('initializeSocketStatus', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
