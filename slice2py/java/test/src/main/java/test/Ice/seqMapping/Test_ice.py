...
if "MyClassPrx" not in _M_Test.__dict__:
    ...
    MyClass._op_opSerialSmallJava = IcePy.Operation("opSerialSmallJava", "opSerialSmallJava", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SerialSmall, False, 0),), (((), _M_Test._t_SerialSmall, False, 0),), ((), _M_Test._t_SerialSmall, False, 0), ())
    MyClass._op_opSerialLargeJava = IcePy.Operation("opSerialLargeJava", "opSerialLargeJava", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SerialLarge, False, 0),), (((), _M_Test._t_SerialLarge, False, 0),), ((), _M_Test._t_SerialLarge, False, 0), ())
    MyClass._op_opSerialStructJava = IcePy.Operation("opSerialStructJava", "opSerialStructJava", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SerialStruct, False, 0),), (((), _M_Test._t_SerialStruct, False, 0),), ((), _M_Test._t_SerialStruct, False, 0), ())
...
if "Foo" not in _M_Test.__dict__:
    ...
    class Foo(object):
        ...
        def __repr__(self):
            return f"Test.Foo({Ice.Util.format_fields(SLmem=self.SLmem, SLSmem=self.SLSmem)})"
...
if "Bar" not in _M_Test.__dict__:
    ...
    class Bar(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.Bar({Ice.Util.format_fields(SLmem=self.SLmem, SLSmem=self.SLSmem)})"
...
if "Baz" not in _M_Test.__dict__:
    ...
    class Baz(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Baz({Ice.Util.format_fields(SLmem=self.SLmem, SLSmem=self.SLSmem)})"
