...
class TestIntfPrx(ObjectPrx):
    ...
    def resetMaxConcurrentDispatches(self, context: dict[str, str] | None = None) -> int:
        return TestIntf._op_resetMaxConcurrentDispatches.invoke(self, ((), context))

    def resetMaxConcurrentDispatchesAsync(self, context: dict[str, str] | None = None) -> Awaitable[int]:
        return TestIntf._op_resetMaxConcurrentDispatches.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_resetMaxConcurrentDispatches: IcePy.Operation
    ...
    @abstractmethod
    def resetMaxConcurrentDispatches(self, current: Current) -> int | Awaitable[int]:
        pass
...
TestIntf._op_resetMaxConcurrentDispatches = IcePy.Operation(
