...
if "MyClassPrx" not in _M_Test.__dict__:
    ...
    MyClass._op_getContext = IcePy.Operation("getContext", "getContext", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Ice._t_Context, False, 0), ())
...
if "MyDerivedClassPrx" not in _M_Test.__dict__:
    ...
    MyDerivedClass._op_echo = IcePy.Operation("echo", "echo", Ice.OperationMode.Normal, None, (), (((), IcePy._t_ObjectPrx, False, 0),), (), ((), IcePy._t_ObjectPrx, False, 0), ())
...
if "MyOtherDerivedClassPrx" not in _M_Test.__dict__:
    ...
    class MyOtherDerivedClassPrx(_M_Test.MyClassPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.MyOtherDerivedClassPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.MyOtherDerivedClassPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.MyOtherDerivedClassPrx, proxy, facet)
...
if "DiamondClassPrx" not in _M_Test.__dict__:
    ...
    class DiamondClassPrx(_M_Test.MyDerivedClassPrx, _M_Test.MyOtherDerivedClassPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.DiamondClassPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.DiamondClassPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.DiamondClassPrx, proxy, facet)
