...
if "RetryPrx" not in _M_Test.__dict__:
    ...
    class RetryPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.RetryPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.RetryPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.RetryPrx, proxy, facet)
    ...
    class Retry(Ice.Object):
        ...
        def op(self, kill, current):
            raise NotImplementedError("servant method 'op' not implemented")

        def opIdempotent(self, c, current):
            raise NotImplementedError("servant method 'opIdempotent' not implemented")

        def opNotIdempotent(self, current):
            raise NotImplementedError("servant method 'opNotIdempotent' not implemented")

        def sleep(self, delay, current):
            raise NotImplementedError("servant method 'sleep' not implemented")

        def shutdown(self, current):
            raise NotImplementedError("servant method 'shutdown' not implemented")

    Retry._op_op = IcePy.Operation("op", "op", Ice.OperationMode.Normal, None, (), (((), IcePy._t_bool, False, 0),), (), None, ())
    Retry._op_opIdempotent = IcePy.Operation("opIdempotent", "opIdempotent", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_int, False, 0),), (), ((), IcePy._t_int, False, 0), ())
    Retry._op_opNotIdempotent = IcePy.Operation("opNotIdempotent", "opNotIdempotent", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Retry._op_sleep = IcePy.Operation("sleep", "sleep", Ice.OperationMode.Idempotent, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
    Retry._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Idempotent, None, (), (), (), None, ())
