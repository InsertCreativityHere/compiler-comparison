...
if 'InitialPrx' not in _M_Test.__dict__:
    ...
    Initial._op_opMyInterfaceProxyReq = IcePy.Operation('opMyInterfaceProxyReq', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, None, (), (((), _M_Test._t_MyInterfacePrx, True, 2),), (((), _M_Test._t_MyInterfacePrx, True, 3),), ((), _M_Test._t_MyInterfacePrx, True, 1), ())
