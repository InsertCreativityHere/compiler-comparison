...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    TestIntf._op_requestFailedException = IcePy.Operation('requestFailedException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_unknownUserException = IcePy.Operation('unknownUserException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_unknownLocalException = IcePy.Operation('unknownLocalException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_unknownException = IcePy.Operation('unknownException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_localException = IcePy.Operation('localException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_javaException = IcePy.Operation('javaException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_unknownExceptionWithServantException = IcePy.Operation('unknownExceptionWithServantException', Ice.OperationMode.Normal, True, None, (), (), (), None, ())
    TestIntf._op_impossibleException = IcePy.Operation('impossibleException', Ice.OperationMode.Normal, True, None, (), (((), IcePy._t_bool, False, 0),), (), ((), IcePy._t_string, False, 0), (_M_Test._t_TestImpossibleException,))
    TestIntf._op_intfUserException = IcePy.Operation('intfUserException', Ice.OperationMode.Normal, True, None, (), (((), IcePy._t_bool, False, 0),), (), ((), IcePy._t_string, False, 0), (_M_Test._t_TestIntfUserException, _M_Test._t_TestImpossibleException))
    TestIntf._op_asyncResponse = IcePy.Operation('asyncResponse', Ice.OperationMode.Normal, True, None, (), (), (), None, (_M_Test._t_TestIntfUserException, _M_Test._t_TestImpossibleException))
    TestIntf._op_asyncException = IcePy.Operation('asyncException', Ice.OperationMode.Normal, True, None, (), (), (), None, (_M_Test._t_TestIntfUserException, _M_Test._t_TestImpossibleException))
