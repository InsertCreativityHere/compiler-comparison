...
if 'A' not in _M_Test.__dict__:
    ...
    class A(Ice.Value):
        def __init__(self, requiredA=0, mc=Ice.Unset, mb=Ice.Unset, ma=Ice.Unset):
...
if 'B' not in _M_Test.__dict__:
    ...
    class B(_M_Test.A):
        def __init__(self, requiredA=0, mc=Ice.Unset, mb=Ice.Unset, ma=Ice.Unset, requiredB=0, md=Ice.Unset):
            _M_Test.A.__init__(self, requiredA, mc, mb, ma)
...
if 'C' not in _M_Test.__dict__:
    ...
    class C(_M_Test.B):
        def __init__(self, requiredA=0, mc=Ice.Unset, mb=Ice.Unset, ma=Ice.Unset, requiredB=0, md=Ice.Unset, ss='', ms=Ice.Unset):
            _M_Test.B.__init__(self, requiredA, mc, mb, ma, requiredB, md)
            self.ss = ss
            self.ms = ms
...
if 'DerivedException' not in _M_Test.__dict__:
    ...
    class DerivedException(_M_Test.OptionalException):
        def __init__(self, req=False, a=5, b=Ice.Unset, o=Ice.Unset, d1="d1", ss="test", o2=Ice.Unset, d2="d2"):
