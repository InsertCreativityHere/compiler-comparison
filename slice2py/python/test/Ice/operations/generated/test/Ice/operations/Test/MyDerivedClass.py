...
from generated.test.Ice.operations.Test.MyDerivedClass_forward import _generated_test_Ice_operations_Test_MyDerivedClassPrx_t
...
from generated.test.Ice.operations.Test.MyStruct1 import _generated_test_Ice_operations_Test_MyStruct1_t
...
if TYPE_CHECKING:
    ...
    from generated.test.Ice.operations.Test.MyClass1 import MyClass1
    ...
    from generated.test.Ice.operations.Test.MyStruct1 import MyStruct1
...
class MyDerivedClassPrx(MyClassPrx):
    ...
    def opMyClass1(self, opMyClass1: MyClass1 | None, context: dict[str, str] | None = None) -> MyClass1 | None:
        return MyDerivedClass._op_opMyClass1.invoke(self, ((opMyClass1, ), context))

    def opMyClass1Async(self, opMyClass1: MyClass1 | None, context: dict[str, str] | None = None) -> Awaitable[MyClass1 | None]:
        return MyDerivedClass._op_opMyClass1.invokeAsync(self, ((opMyClass1, ), context))

    def opMyStruct1(self, opMyStruct1: MyStruct1, context: dict[str, str] | None = None) -> MyStruct1:
        return MyDerivedClass._op_opMyStruct1.invoke(self, ((opMyStruct1, ), context))

    def opMyStruct1Async(self, opMyStruct1: MyStruct1, context: dict[str, str] | None = None) -> Awaitable[MyStruct1]:
        return MyDerivedClass._op_opMyStruct1.invokeAsync(self, ((opMyStruct1, ), context))
...
class MyDerivedClass(MyClass, ABC):
    ...
    @abstractmethod
    def opMyClass1(self, opMyClass1: MyClass1 | None, current: Current) -> MyClass1 | None | Awaitable[MyClass1 | None]:
        pass

    @abstractmethod
    def opMyStruct1(self, opMyStruct1: MyStruct1, current: Current) -> MyStruct1 | Awaitable[MyStruct1]:
        pass
...
MyDerivedClass._op_opMyClass1 = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_operations_Test_MyClass1_t, False, 0),),
    (),
    ((), _generated_test_Ice_operations_Test_MyClass1_t, False, 0),
    ())
...
MyDerivedClass._op_opMyStruct1 = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_operations_Test_MyStruct1_t, False, 0),),
    (),
    ((), _generated_test_Ice_operations_Test_MyStruct1_t, False, 0),
    ())

__all__ = ["MyDerivedClass", "MyDerivedClassPrx", "_generated_test_Ice_operations_Test_MyDerivedClassPrx_t"]
