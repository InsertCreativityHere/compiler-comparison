...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    TestIntf._op_transient = IcePy.Operation('transient', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    TestIntf._op_deactivate = IcePy.Operation('deactivate', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
