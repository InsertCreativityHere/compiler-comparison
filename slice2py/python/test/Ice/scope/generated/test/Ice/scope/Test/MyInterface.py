...
MyInterface._op_opMyEnum = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_scope_Test_MyEnum_t, False, 0),),
    (),
    ((), _generated_test_Ice_scope_Test_MyEnum_t, False, 0),
    ())
...
MyInterface._op_opMyOtherStruct = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_scope_Test_MyOtherStruct_t, False, 0),),
    (),
    ((), _generated_test_Ice_scope_Test_MyOtherStruct_t, False, 0),
    ())
...
MyInterface._op_opMyOtherClass = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_scope_Test_MyOtherClass_t, False, 0),),
    (),
    ((), _generated_test_Ice_scope_Test_MyOtherClass_t, False, 0),
    ())
...
__all__ = ["MyInterface", "MyInterfacePrx", "_generated_test_Ice_scope_Test_MyInterfacePrx_t"]
