...
_generated_test_Ice_scope_Test_MyClass_t = IcePy.defineValue(
    "::Test::MyClass",
    MyClass,
    -1,
    (),
    False,
    None,
    (("s", (), _generated_test_Ice_scope_Test_MyStruct_t, False, 0),))

setattr(MyClass, '_ice_type', _generated_test_Ice_scope_Test_MyClass_t)

__all__ = ["MyClass", "_generated_test_Ice_scope_Test_MyClass_t"]
