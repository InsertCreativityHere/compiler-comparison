...
from generated.test.Ice.thread.Test.RemoteCommunicatorFactory_forward import _generated_test_Ice_thread_Test_RemoteCommunicatorFactoryPrx_t
...
if TYPE_CHECKING:
    ...
    from generated.test.Ice.thread.Test.RemoteCommunicator import RemoteCommunicatorPrx
...
RemoteCommunicatorFactory._op_createCommunicator = IcePy.Operation(
    ...
    (),
    ((), _generated_test_Ice_thread_Test_RemoteCommunicatorPrx_t, False, 0),
    ())
...
__all__ = ["RemoteCommunicatorFactory", "RemoteCommunicatorFactoryPrx", "_generated_test_Ice_thread_Test_RemoteCommunicatorFactoryPrx_t"]
