...
if "OneOptional" not in _M_Test.__dict__:
    ...
    class OneOptional(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.OneOptional({Ice.Util.format_fields(a=self.a)})"
...
if "MyInterfacePrx" not in _M_Test.__dict__:
    ...
    MyInterface._op_op = IcePy.Operation("op", "op", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "SmallStruct" not in _M_Test.__dict__:
    ...
    class SmallStruct(object):
        ...
        def __repr__(self):
            return f"Test.SmallStruct({Ice.Util.format_fields(m=self.m)})"
...
if "FixedStruct" not in _M_Test.__dict__:
    ...
    class FixedStruct(object):
        ...
        def __repr__(self):
            return f"Test.FixedStruct({Ice.Util.format_fields(m=self.m)})"
...
if "VarStruct" not in _M_Test.__dict__:
    ...
    class VarStruct(object):
        ...
        def __repr__(self):
            return f"Test.VarStruct({Ice.Util.format_fields(m=self.m)})"
...
if "_t_SmallStructList" not in _M_Test.__dict__:
    _M_Test._t_SmallStructList = IcePy.defineSequence("::Test::SmallStructList", ("python:seq:tuple",), _M_Test._t_SmallStruct)
...
if "_t_FixedStructList" not in _M_Test.__dict__:
    _M_Test._t_FixedStructList = IcePy.defineSequence("::Test::FixedStructList", ("python:seq:tuple",), _M_Test._t_FixedStruct)
...
if "MultiOptional" not in _M_Test.__dict__:
    ...
    class MultiOptional(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.MultiOptional({Ice.Util.format_fields(a=self.a, b=self.b, c=self.c, d=self.d, e=self.e, f=self.f, g=self.g, h=self.h, i=self.i, j=self.j, bs=self.bs, ss=self.ss, iid=self.iid, sid=self.sid, fs=self.fs, vs=self.vs, shs=self.shs, es=self.es, fss=self.fss, vss=self.vss, mips=self.mips, ied=self.ied, ifsd=self.ifsd, ivsd=self.ivsd, imipd=self.imipd, bos=self.bos, ser=self.ser)})"
...
if "A" not in _M_Test.__dict__:
    ...
    class A(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.A({Ice.Util.format_fields(requiredA=self.requiredA, ma=self.ma, mb=self.mb, mc=self.mc)})"
...
if "B" not in _M_Test.__dict__:
    ...
    class B(_M_Test.A):
        ...
        def __repr__(self):
            return f"Test.B({Ice.Util.format_fields(requiredA=self.requiredA, ma=self.ma, mb=self.mb, mc=self.mc, requiredB=self.requiredB, md=self.md)})"
...
if "C" not in _M_Test.__dict__:
    ...
    class C(_M_Test.B):
        ...
        def __repr__(self):
            return f"Test.C({Ice.Util.format_fields(requiredA=self.requiredA, ma=self.ma, mb=self.mb, mc=self.mc, requiredB=self.requiredB, md=self.md, ss=self.ss, ms=self.ms)})"
...
if "WD" not in _M_Test.__dict__:
    ...
    class WD(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.WD({Ice.Util.format_fields(a=self.a, s=self.s)})"
...
if "OptionalException" not in _M_Test.__dict__:
    ...
    class OptionalException(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.OptionalException({Ice.Util.format_fields(req=self.req, a=self.a, b=self.b)})"
...
if "DerivedException" not in _M_Test.__dict__:
    ...
    class DerivedException(_M_Test.OptionalException):
        ...
        def __repr__(self):
            return f"Test.DerivedException({Ice.Util.format_fields(req=self.req, a=self.a, b=self.b, d1=self.d1, ss=self.ss, d2=self.d2)})"
...
if "RequiredException" not in _M_Test.__dict__:
    ...
    class RequiredException(_M_Test.OptionalException):
        ...
        def __repr__(self):
            return f"Test.RequiredException({Ice.Util.format_fields(req=self.req, a=self.a, b=self.b, ss=self.ss)})"
...
if "E" not in _M_Test.__dict__:
    ...
    class E(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.E({Ice.Util.format_fields(fse=self.fse)})"
...
if "F" not in _M_Test.__dict__:
    ...
    class F(_M_Test.E):
        ...
        def __repr__(self):
            return f"Test.F({Ice.Util.format_fields(fse=self.fse, fsf=self.fsf)})"
...
if "G1" not in _M_Test.__dict__:
    ...
    class G1(object):
        ...
        def __repr__(self):
            return f"Test.G1({Ice.Util.format_fields(a=self.a)})"
...
if "G2" not in _M_Test.__dict__:
    ...
    class G2(object):
        ...
        def __repr__(self):
            return f"Test.G2({Ice.Util.format_fields(a=self.a)})"
...
if "G" not in _M_Test.__dict__:
    ...
    class G(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.G({Ice.Util.format_fields(gg1Opt=self.gg1Opt, gg2=self.gg2, gg2Opt=self.gg2Opt, gg1=self.gg1)})"
...
if "InitialPrx" not in _M_Test.__dict__:
    ...
    class InitialPrx(Ice.ObjectPrx):
        ...
        def opRequiredAfterOptional(self, p1, p2, p3, context=None):
            return _M_Test.Initial._op_opRequiredAfterOptional.invoke(self, ((p1, p2, p3), context))

        def opRequiredAfterOptionalAsync(self, p1, p2, p3, context=None):
            return _M_Test.Initial._op_opRequiredAfterOptional.invokeAsync(self, ((p1, p2, p3), context))

        def opOptionalAfterRequired(self, p1, p2=None, p3=None, context=None):
            return _M_Test.Initial._op_opOptionalAfterRequired.invoke(self, ((p1, p2, p3), context))

        def opOptionalAfterRequiredAsync(self, p1, p2, p3, context=None):
            return _M_Test.Initial._op_opOptionalAfterRequired.invokeAsync(self, ((p1, p2, p3), context))
    ...
    class Initial(Ice.Object):
        ...
        def opRequiredAfterOptional(self, p1, p2, p3, current):
            raise NotImplementedError("servant method 'opRequiredAfterOptional' not implemented")

        def opOptionalAfterRequired(self, p1, p2, p3, current):
            raise NotImplementedError("servant method 'opOptionalAfterRequired' not implemented")
    ...
    Initial._op_pingPong = IcePy.Operation("pingPong", "pingPong", Ice.OperationMode.Normal, None, (), (((), IcePy._t_Value, False, 0),), (), ((), IcePy._t_Value, False, 0), ())
    Initial._op_opOptionalException = IcePy.Operation("opOptionalException", "opOptionalException", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, True, 1), ((), IcePy._t_string, True, 2)), (), None, (_M_Test._t_OptionalException,))
    Initial._op_opDerivedException = IcePy.Operation("opDerivedException", "opDerivedException", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, True, 1), ((), IcePy._t_string, True, 2)), (), None, (_M_Test._t_OptionalException,))
    Initial._op_opRequiredException = IcePy.Operation("opRequiredException", "opRequiredException", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, True, 1), ((), IcePy._t_string, True, 2)), (), None, (_M_Test._t_OptionalException,))
    Initial._op_opByte = IcePy.Operation("opByte", "opByte", Ice.OperationMode.Normal, None, (), (((), IcePy._t_byte, True, 2),), (((), IcePy._t_byte, True, 3),), ((), IcePy._t_byte, True, 1), ())
    Initial._op_opBool = IcePy.Operation("opBool", "opBool", Ice.OperationMode.Normal, None, (), (((), IcePy._t_bool, True, 2),), (((), IcePy._t_bool, True, 3),), ((), IcePy._t_bool, True, 1), ())
    Initial._op_opShort = IcePy.Operation("opShort", "opShort", Ice.OperationMode.Normal, None, (), (((), IcePy._t_short, True, 2),), (((), IcePy._t_short, True, 3),), ((), IcePy._t_short, True, 1), ())
    Initial._op_opInt = IcePy.Operation("opInt", "opInt", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, True, 2),), (((), IcePy._t_int, True, 3),), ((), IcePy._t_int, True, 1), ())
    Initial._op_opLong = IcePy.Operation("opLong", "opLong", Ice.OperationMode.Normal, None, (), (((), IcePy._t_long, True, 1),), (((), IcePy._t_long, True, 2),), ((), IcePy._t_long, True, 3), ())
    Initial._op_opFloat = IcePy.Operation("opFloat", "opFloat", Ice.OperationMode.Normal, None, (), (((), IcePy._t_float, True, 2),), (((), IcePy._t_float, True, 3),), ((), IcePy._t_float, True, 1), ())
    Initial._op_opDouble = IcePy.Operation("opDouble", "opDouble", Ice.OperationMode.Normal, None, (), (((), IcePy._t_double, True, 2),), (((), IcePy._t_double, True, 3),), ((), IcePy._t_double, True, 1), ())
    Initial._op_opString = IcePy.Operation("opString", "opString", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, True, 2),), (((), IcePy._t_string, True, 3),), ((), IcePy._t_string, True, 1), ())
    Initial._op_opMyEnum = IcePy.Operation("opMyEnum", "opMyEnum", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_MyEnum, True, 2),), (((), _M_Test._t_MyEnum, True, 3),), ((), _M_Test._t_MyEnum, True, 1), ())
    Initial._op_opSmallStruct = IcePy.Operation("opSmallStruct", "opSmallStruct", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SmallStruct, True, 2),), (((), _M_Test._t_SmallStruct, True, 3),), ((), _M_Test._t_SmallStruct, True, 1), ())
    Initial._op_opFixedStruct = IcePy.Operation("opFixedStruct", "opFixedStruct", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_FixedStruct, True, 2),), (((), _M_Test._t_FixedStruct, True, 3),), ((), _M_Test._t_FixedStruct, True, 1), ())
    Initial._op_opVarStruct = IcePy.Operation("opVarStruct", "opVarStruct", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_VarStruct, True, 2),), (((), _M_Test._t_VarStruct, True, 3),), ((), _M_Test._t_VarStruct, True, 1), ())
    Initial._op_opMyInterfaceProxy = IcePy.Operation("opMyInterfaceProxy", "opMyInterfaceProxy", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_MyInterfacePrx, True, 2),), (((), _M_Test._t_MyInterfacePrx, True, 3),), ((), _M_Test._t_MyInterfacePrx, True, 1), ())
    Initial._op_opOneOptional = IcePy.Operation("opOneOptional", "opOneOptional", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_OneOptional, False, 0),), (((), _M_Test._t_OneOptional, False, 0),), ((), _M_Test._t_OneOptional, False, 0), ())
    Initial._op_opByteSeq = IcePy.Operation("opByteSeq", "opByteSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteSeq, True, 2),), (((), _M_Test._t_ByteSeq, True, 3),), ((), _M_Test._t_ByteSeq, True, 1), ())
    Initial._op_opBoolSeq = IcePy.Operation("opBoolSeq", "opBoolSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_BoolSeq, True, 2),), (((), _M_Test._t_BoolSeq, True, 3),), ((), _M_Test._t_BoolSeq, True, 1), ())
    Initial._op_opShortSeq = IcePy.Operation("opShortSeq", "opShortSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ShortSeq, True, 2),), (((), _M_Test._t_ShortSeq, True, 3),), ((), _M_Test._t_ShortSeq, True, 1), ())
    Initial._op_opIntSeq = IcePy.Operation("opIntSeq", "opIntSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntSeq, True, 2),), (((), _M_Test._t_IntSeq, True, 3),), ((), _M_Test._t_IntSeq, True, 1), ())
    Initial._op_opLongSeq = IcePy.Operation("opLongSeq", "opLongSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_LongSeq, True, 2),), (((), _M_Test._t_LongSeq, True, 3),), ((), _M_Test._t_LongSeq, True, 1), ())
    Initial._op_opFloatSeq = IcePy.Operation("opFloatSeq", "opFloatSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_FloatSeq, True, 2),), (((), _M_Test._t_FloatSeq, True, 3),), ((), _M_Test._t_FloatSeq, True, 1), ())
    Initial._op_opDoubleSeq = IcePy.Operation("opDoubleSeq", "opDoubleSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_DoubleSeq, True, 2),), (((), _M_Test._t_DoubleSeq, True, 3),), ((), _M_Test._t_DoubleSeq, True, 1), ())
    Initial._op_opStringSeq = IcePy.Operation("opStringSeq", "opStringSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringSeq, True, 2),), (((), _M_Test._t_StringSeq, True, 3),), ((), _M_Test._t_StringSeq, True, 1), ())
    Initial._op_opSmallStructSeq = IcePy.Operation("opSmallStructSeq", "opSmallStructSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SmallStructSeq, True, 2),), (((), _M_Test._t_SmallStructSeq, True, 3),), ((), _M_Test._t_SmallStructSeq, True, 1), ())
    Initial._op_opSmallStructList = IcePy.Operation("opSmallStructList", "opSmallStructList", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SmallStructList, True, 2),), (((), _M_Test._t_SmallStructList, True, 3),), ((), _M_Test._t_SmallStructList, True, 1), ())
    Initial._op_opFixedStructSeq = IcePy.Operation("opFixedStructSeq", "opFixedStructSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_FixedStructSeq, True, 2),), (((), _M_Test._t_FixedStructSeq, True, 3),), ((), _M_Test._t_FixedStructSeq, True, 1), ())
    Initial._op_opFixedStructList = IcePy.Operation("opFixedStructList", "opFixedStructList", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_FixedStructList, True, 2),), (((), _M_Test._t_FixedStructList, True, 3),), ((), _M_Test._t_FixedStructList, True, 1), ())
    Initial._op_opVarStructSeq = IcePy.Operation("opVarStructSeq", "opVarStructSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_VarStructSeq, True, 2),), (((), _M_Test._t_VarStructSeq, True, 3),), ((), _M_Test._t_VarStructSeq, True, 1), ())
    Initial._op_opSerializable = IcePy.Operation("opSerializable", "opSerializable", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_Serializable, True, 2),), (((), _M_Test._t_Serializable, True, 3),), ((), _M_Test._t_Serializable, True, 1), ())
    Initial._op_opIntIntDict = IcePy.Operation("opIntIntDict", "opIntIntDict", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntIntDict, True, 2),), (((), _M_Test._t_IntIntDict, True, 3),), ((), _M_Test._t_IntIntDict, True, 1), ())
    Initial._op_opStringIntDict = IcePy.Operation("opStringIntDict", "opStringIntDict", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringIntDict, True, 2),), (((), _M_Test._t_StringIntDict, True, 3),), ((), _M_Test._t_StringIntDict, True, 1), ())
    Initial._op_opClassAndUnknownOptional = IcePy.Operation("opClassAndUnknownOptional", "opClassAndUnknownOptional", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_A, False, 0),), (), None, ())
    Initial._op_opRequiredAfterOptional = IcePy.Operation("opRequiredAfterOptional", "opRequiredAfterOptional", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, True, 1), ((), IcePy._t_int, False, 0)), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, True, 2), ((), IcePy._t_int, False, 0)), None, ())
    Initial._op_opOptionalAfterRequired = IcePy.Operation("opOptionalAfterRequired", "opOptionalAfterRequired", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, True, 1), ((), IcePy._t_int, True, 2)), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, True, 3), ((), IcePy._t_int, True, 4)), None, ())
    Initial._op_opG = IcePy.Operation("opG", "opG", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_G, False, 0),), (), ((), _M_Test._t_G, False, 0), ())
    Initial._op_opVoid = IcePy.Operation("opVoid", "opVoid", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Initial._op_opMStruct1 = IcePy.Operation("opMStruct1", "opMStruct1", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_SmallStruct, True, 1), ())
    Initial._op_opMStruct2 = IcePy.Operation("opMStruct2", "opMStruct2", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_SmallStruct, True, 2),), (((), _M_Test._t_SmallStruct, True, 3),), ((), _M_Test._t_SmallStruct, True, 1), ())
    Initial._op_opMSeq1 = IcePy.Operation("opMSeq1", "opMSeq1", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_StringSeq, True, 1), ())
    Initial._op_opMSeq2 = IcePy.Operation("opMSeq2", "opMSeq2", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringSeq, True, 2),), (((), _M_Test._t_StringSeq, True, 3),), ((), _M_Test._t_StringSeq, True, 1), ())
    Initial._op_opMDict1 = IcePy.Operation("opMDict1", "opMDict1", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_StringIntDict, True, 1), ())
    Initial._op_opMDict2 = IcePy.Operation("opMDict2", "opMDict2", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringIntDict, True, 2),), (((), _M_Test._t_StringIntDict, True, 3),), ((), _M_Test._t_StringIntDict, True, 1), ())
    Initial._op_supportsJavaSerializable = IcePy.Operation("supportsJavaSerializable", "supportsJavaSerializable", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
