...
if "A" not in _M_Test.Mod.__dict__:
    ...
    class A(_M_Test.A):
        ...
        def __repr__(self):
            return f"Test.Mod.A({Ice.Util.format_fields(aMem=self.aMem, a2Mem=self.a2Mem)})"
...
if "ThrowerPrx" not in _M_Test.__dict__:
    ...
    class Thrower(Ice.Object):
        ...
        def throwRequestFailedException(self, type, id, facet, operation, current):
    ...
    Thrower._op_supportsAssertException = IcePy.Operation("supportsAssertException", "supportsAssertException", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
    ...
    Thrower._op_throwModA = IcePy.Operation("throwModA", "throwModA", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test.Mod._t_A,))
    ...
    Thrower._op_throwAssertException = IcePy.Operation("throwAssertException", "throwAssertException", Ice.OperationMode.Normal, None, (), (), (), None, ())
    ...
    Thrower._op_throwAfterResponse = IcePy.Operation("throwAfterResponse", "throwAfterResponse", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Thrower._op_throwAfterException = IcePy.Operation("throwAfterException", "throwAfterException", Ice.OperationMode.Normal, None, (), (), (), None, (_M_Test._t_A,))
    Thrower._op_throwMarshalException = IcePy.Operation("throwMarshalException", "throwMarshalException", Ice.OperationMode.Normal, None, (), (), (((), IcePy._t_int, False, 0),), ((), IcePy._t_int, False, 0), ())
    Thrower._op_throwRequestFailedException = IcePy.Operation("throwRequestFailedException", "throwRequestFailedException", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, False, 0), ((), _M_Ice._t_Identity, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0)), (), None, ())
