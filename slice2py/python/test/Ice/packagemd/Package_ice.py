...
if "C1" not in _M_testpkg.Test2.__dict__:
    ...
    class C1(Ice.Value):
        ...
        def __repr__(self):
            return f"testpkg.Test2.C1({Ice.Util.format_fields(i=self.i)})"
...
if "C2" not in _M_testpkg.Test2.__dict__:
    ...
    class C2(_M_testpkg.Test2.C1):
        ...
        def __repr__(self):
            return f"testpkg.Test2.C2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "E1" not in _M_testpkg.Test2.__dict__:
    ...
    class E1(Ice.UserException):
        ...
        def __repr__(self):
            return f"testpkg.Test2.E1({Ice.Util.format_fields(i=self.i)})"
...
if "E2" not in _M_testpkg.Test2.__dict__:
    ...
    class E2(_M_testpkg.Test2.E1):
        ...
        def __repr__(self):
            return f"testpkg.Test2.E2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "C1" not in _M_modpkg.Test3.__dict__:
    ...
    class C1(Ice.Value):
        ...
        def __repr__(self):
            return f"modpkg.Test3.C1({Ice.Util.format_fields(i=self.i)})"
...
if "C2" not in _M_modpkg.Test3.__dict__:
    ...
    class C2(_M_modpkg.Test3.C1):
        ...
        def __repr__(self):
            return f"modpkg.Test3.C2({Ice.Util.format_fields(i=self.i, l=self.l)})"
...
if "E1" not in _M_modpkg.Test3.__dict__:
    ...
    class E1(Ice.UserException):
        ...
        def __repr__(self):
            return f"modpkg.Test3.E1({Ice.Util.format_fields(i=self.i)})"
...
if "E2" not in _M_modpkg.Test3.__dict__:
    ...
    class E2(_M_modpkg.Test3.E1):
        ...
        def __repr__(self):
            return f"modpkg.Test3.E2({Ice.Util.format_fields(i=self.i, l=self.l)})"
