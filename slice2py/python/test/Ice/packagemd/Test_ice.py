...
if 'InitialPrx' not in _M_Test.__dict__:
    ...
    Initial._op_throwTest1Def = IcePy.Operation('throwTest1Def', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, (_M_Test1._t__def,))
    Initial._op_getTest2C2AsC1 = IcePy.Operation('getTest2C2AsC1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_testpkg.Test2._t_C1, False, 0), ())
    Initial._op_getTest2C2AsC2 = IcePy.Operation('getTest2C2AsC2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_testpkg.Test2._t_C2, False, 0), ())
    Initial._op_throwTest2E2AsE1 = IcePy.Operation('throwTest2E2AsE1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, (_M_testpkg.Test2._t_E1,))
    Initial._op_throwTest2E2AsE2 = IcePy.Operation('throwTest2E2AsE2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, (_M_testpkg.Test2._t_E2,))
    Initial._op_getTest3C2AsC1 = IcePy.Operation('getTest3C2AsC1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_modpkg.Test3._t_C1, False, 0), ())
    Initial._op_getTest3C2AsC2 = IcePy.Operation('getTest3C2AsC2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_modpkg.Test3._t_C2, False, 0), ())
    Initial._op_throwTest3E2AsE1 = IcePy.Operation('throwTest3E2AsE1', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, (_M_modpkg.Test3._t_E1,))
    Initial._op_throwTest3E2AsE2 = IcePy.Operation('throwTest3E2AsE2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, (_M_modpkg.Test3._t_E2,))
