...
from generated.test.Ice.ami.Test.TestIntfException import _generated_test_Ice_ami_Test_TestIntfException_t

from generated.test.Ice.ami.Test.TestIntf_forward import _generated_test_Ice_ami_Test_TestIntfPrx_t
...
if TYPE_CHECKING:
    ...
    from generated.test.Ice.ami.Test.PingReply import PingReplyPrx
...
TestIntf._op_opWithUE = IcePy.Operation(
    ...
    (),
    None,
    (_generated_test_Ice_ami_Test_TestIntfException_t,))
...
TestIntf._op_pingBiDir = IcePy.Operation(
    ...
    None,
    (),
    (((), _generated_test_Ice_ami_Test_PingReplyPrx_t, False, 0),),
    (),
    None,
    ())

__all__ = ["TestIntf", "TestIntfPrx", "_generated_test_Ice_ami_Test_TestIntfPrx_t"]
