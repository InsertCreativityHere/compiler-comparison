...
from generated.test.Ice.objects.client_private.Test.UnexpectedObjectExceptionTest_forward import _generated_test_Ice_objects_client_private_Test_UnexpectedObjectExceptionTestPrx_t
...
UnexpectedObjectExceptionTest._op_op = IcePy.Operation(
    ...
    (),
    (),
    ((), _generated_test_Ice_objects_Test_Empty_t, False, 0),
    ())

__all__ = ["UnexpectedObjectExceptionTest", "UnexpectedObjectExceptionTestPrx", "_generated_test_Ice_objects_client_private_Test_UnexpectedObjectExceptionTestPrx_t"]
