...
if "StructNoDefaults" not in _M_Test.__dict__:
    ...
    class StructNoDefaults(object):
        def __init__(self, bo=False, b=0, s=0, i=0, l=0, f=0.0, d=0.0, str="", c1=_M_Test.Color.red, bs=None, iseq=None, dict=None, st=None):
            self.bo = bo
            self.b = b
            self.s = s
            self.i = i
        ...
        def __repr__(self):
            return f"Test.StructNoDefaults({Ice.Util.format_fields(bo=self.bo, b=self.b, s=self.s, i=self.i, l=self.l, f=self.f, d=self.d, str=self.str, c1=self.c1, bs=self.bs, iseq=self.iseq, dict=self.dict, st=self.st)})"
...
if "ExceptionNoDefaults" not in _M_Test.__dict__:
    ...
    class ExceptionNoDefaults(_M_Test.ExceptionNoDefaultsBase):
        ...
        def __repr__(self):
            return f"Test.ExceptionNoDefaults({Ice.Util.format_fields(str=self.str, c1=self.c1, bs=self.bs, st=self.st, dict=self.dict)})"
