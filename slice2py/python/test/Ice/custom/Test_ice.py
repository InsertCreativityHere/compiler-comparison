...
if "S" not in _M_Test.__dict__:
    ...
    class S(object):
        ...
        def __repr__(self):
            return f"Test.S({Ice.Util.format_fields(b1=self.b1, b2=self.b2, b3=self.b3, b4=self.b4, s1=self.s1, s2=self.s2, s3=self.s3, s4=self.s4)})"
...
if "C" not in _M_Test.__dict__:
    ...
    class C(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.C({Ice.Util.format_fields(b1=self.b1, b2=self.b2, b3=self.b3, b4=self.b4, s1=self.s1, s2=self.s2, s3=self.s3, s4=self.s4)})"
...
if "D" not in _M_Test.__dict__:
    ...
    class D(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.D({Ice.Util.format_fields(boolSeq=self.boolSeq, byteSeq=self.byteSeq, shortSeq=self.shortSeq, intSeq=self.intSeq, longSeq=self.longSeq, floatSeq=self.floatSeq, doubleSeq=self.doubleSeq)})"
...
if "CustomPrx" not in _M_Test.__dict__:
    ...
    class CustomPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.CustomPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.CustomPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.CustomPrx, proxy, facet)
    ...
    Custom._op_opByteString1 = IcePy.Operation("opByteString1", "opByteString1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteString, False, 0),), (((), _M_Test._t_ByteString, False, 0),), ((), _M_Test._t_ByteString, False, 0), ())
    Custom._op_opByteString2 = IcePy.Operation("opByteString2", "opByteString2", Ice.OperationMode.Normal, None, ("python:seq:tuple",), ((("python:seq:list",), _M_Test._t_ByteString, False, 0),), ((("python:seq:list",), _M_Test._t_ByteString, False, 0),), ((), _M_Test._t_ByteString, False, 0), ())
    Custom._op_opByteList1 = IcePy.Operation("opByteList1", "opByteList1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteList, False, 0),), (((), _M_Test._t_ByteList, False, 0),), ((), _M_Test._t_ByteList, False, 0), ())
    Custom._op_opByteList2 = IcePy.Operation("opByteList2", "opByteList2", Ice.OperationMode.Normal, None, ("python:seq:default",), ((("python:seq:tuple",), _M_Test._t_ByteList, False, 0),), ((("python:seq:tuple",), _M_Test._t_ByteList, False, 0),), ((), _M_Test._t_ByteList, False, 0), ())
    Custom._op_opStringList1 = IcePy.Operation("opStringList1", "opStringList1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringList, False, 0),), (((), _M_Test._t_StringList, False, 0),), ((), _M_Test._t_StringList, False, 0), ())
    Custom._op_opStringList2 = IcePy.Operation("opStringList2", "opStringList2", Ice.OperationMode.Normal, None, ("python:seq:tuple",), ((("python:seq:tuple",), _M_Test._t_StringList, False, 0),), ((("python:seq:tuple",), _M_Test._t_StringList, False, 0),), ((), _M_Test._t_StringList, False, 0), ())
    Custom._op_opStringTuple1 = IcePy.Operation("opStringTuple1", "opStringTuple1", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_StringTuple, False, 0),), (((), _M_Test._t_StringTuple, False, 0),), ((), _M_Test._t_StringTuple, False, 0), ())
    Custom._op_opStringTuple2 = IcePy.Operation("opStringTuple2", "opStringTuple2", Ice.OperationMode.Normal, None, ("python:seq:list",), ((("python:seq:list",), _M_Test._t_StringTuple, False, 0),), ((("python:seq:default",), _M_Test._t_StringTuple, False, 0),), ((), _M_Test._t_StringTuple, False, 0), ())
    Custom._op_sendS = IcePy.Operation("sendS", "sendS", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_S, False, 0),), (), None, ())
    Custom._op_sendC = IcePy.Operation("sendC", "sendC", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_C, False, 0),), (), None, ())
    Custom._op_opBoolSeq = IcePy.Operation("opBoolSeq", "opBoolSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_BoolSeq1, False, 0),), (((), _M_Test._t_BoolSeq2, False, 0),), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opByteSeq = IcePy.Operation("opByteSeq", "opByteSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ByteSeq1, False, 0),), (((), _M_Test._t_ByteSeq2, False, 0),), ((), _M_Test._t_ByteSeq1, False, 0), ())
    Custom._op_opShortSeq = IcePy.Operation("opShortSeq", "opShortSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_ShortSeq1, False, 0),), (((), _M_Test._t_ShortSeq2, False, 0),), ((), _M_Test._t_ShortSeq1, False, 0), ())
    Custom._op_opIntSeq = IcePy.Operation("opIntSeq", "opIntSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntSeq1, False, 0),), (((), _M_Test._t_IntSeq2, False, 0),), ((), _M_Test._t_IntSeq1, False, 0), ())
    Custom._op_opLongSeq = IcePy.Operation("opLongSeq", "opLongSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_LongSeq1, False, 0),), (((), _M_Test._t_LongSeq2, False, 0),), ((), _M_Test._t_LongSeq1, False, 0), ())
    Custom._op_opFloatSeq = IcePy.Operation("opFloatSeq", "opFloatSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_FloatSeq1, False, 0),), (((), _M_Test._t_FloatSeq2, False, 0),), ((), _M_Test._t_FloatSeq1, False, 0), ())
    Custom._op_opDoubleSeq = IcePy.Operation("opDoubleSeq", "opDoubleSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_DoubleSeq1, False, 0),), (((), _M_Test._t_DoubleSeq2, False, 0),), ((), _M_Test._t_DoubleSeq1, False, 0), ())
    Custom._op_opBogusArrayNotExistsFactory = IcePy.Operation("opBogusArrayNotExistsFactory", "opBogusArrayNotExistsFactory", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusArrayNotExistsFactory",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opBogusArrayThrowFactory = IcePy.Operation("opBogusArrayThrowFactory", "opBogusArrayThrowFactory", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusArrayThrowFactory",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opBogusArrayType = IcePy.Operation("opBogusArrayType", "opBogusArrayType", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusArrayType",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opBogusArrayNoneFactory = IcePy.Operation("opBogusArrayNoneFactory", "opBogusArrayNoneFactory", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusArrayNoneFactory",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opBogusArraySignatureFactory = IcePy.Operation("opBogusArraySignatureFactory", "opBogusArraySignatureFactory", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusArraySignatureFactory",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opBogusArrayNoCallableFactory = IcePy.Operation("opBogusArrayNoCallableFactory", "opBogusArrayNoCallableFactory", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNoCallableFactory",), (), (), ((), _M_Test._t_BoolSeq1, False, 0), ())
    Custom._op_opD = IcePy.Operation("opD", "opD", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_D, False, 0),), (), ((), _M_Test._t_D, False, 0), ())
    Custom._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Normal, None, (), (), (), None, ())
