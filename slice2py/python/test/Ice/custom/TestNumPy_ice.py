...
if "D" not in _M_Test.NumPy.__dict__:
    ...
    class D(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.NumPy.D({Ice.Util.format_fields(boolSeq=self.boolSeq, byteSeq=self.byteSeq, shortSeq=self.shortSeq, intSeq=self.intSeq, longSeq=self.longSeq, floatSeq=self.floatSeq, doubleSeq=self.doubleSeq)})"
...
if "CustomPrx" not in _M_Test.NumPy.__dict__:
    ...
    class CustomPrx(Ice.ObjectPrx):
        ...
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.NumPy.CustomPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.NumPy.CustomPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.NumPy.CustomPrx, proxy, facet)
    ...
    Custom._op_opBoolSeq = IcePy.Operation("opBoolSeq", "opBoolSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_BoolSeq1, False, 0),), (((), _M_Test.NumPy._t_BoolSeq2, False, 0),), ((), _M_Test.NumPy._t_BoolSeq1, False, 0), ())
    Custom._op_opByteSeq = IcePy.Operation("opByteSeq", "opByteSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_ByteSeq1, False, 0),), (((), _M_Test.NumPy._t_ByteSeq2, False, 0),), ((), _M_Test.NumPy._t_ByteSeq1, False, 0), ())
    Custom._op_opShortSeq = IcePy.Operation("opShortSeq", "opShortSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_ShortSeq1, False, 0),), (((), _M_Test.NumPy._t_ShortSeq2, False, 0),), ((), _M_Test.NumPy._t_ShortSeq1, False, 0), ())
    Custom._op_opIntSeq = IcePy.Operation("opIntSeq", "opIntSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_IntSeq1, False, 0),), (((), _M_Test.NumPy._t_IntSeq2, False, 0),), ((), _M_Test.NumPy._t_IntSeq1, False, 0), ())
    Custom._op_opLongSeq = IcePy.Operation("opLongSeq", "opLongSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_LongSeq1, False, 0),), (((), _M_Test.NumPy._t_LongSeq2, False, 0),), ((), _M_Test.NumPy._t_LongSeq1, False, 0), ())
    Custom._op_opFloatSeq = IcePy.Operation("opFloatSeq", "opFloatSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_FloatSeq1, False, 0),), (((), _M_Test.NumPy._t_FloatSeq2, False, 0),), ((), _M_Test.NumPy._t_FloatSeq1, False, 0), ())
    Custom._op_opDoubleSeq = IcePy.Operation("opDoubleSeq", "opDoubleSeq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_DoubleSeq1, False, 0),), (((), _M_Test.NumPy._t_DoubleSeq2, False, 0),), ((), _M_Test.NumPy._t_DoubleSeq1, False, 0), ())
    Custom._op_opComplex128Seq = IcePy.Operation("opComplex128Seq", "opComplex128Seq", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_Complex128Seq, False, 0),), (), ((), _M_Test.NumPy._t_Complex128Seq, False, 0), ())
    Custom._op_opBoolMatrix = IcePy.Operation("opBoolMatrix", "opBoolMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_BoolSeq1, False, 0), ())
    Custom._op_opByteMatrix = IcePy.Operation("opByteMatrix", "opByteMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_ByteSeq1, False, 0), ())
    Custom._op_opShortMatrix = IcePy.Operation("opShortMatrix", "opShortMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_ShortSeq1, False, 0), ())
    Custom._op_opIntMatrix = IcePy.Operation("opIntMatrix", "opIntMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_IntSeq1, False, 0), ())
    Custom._op_opLongMatrix = IcePy.Operation("opLongMatrix", "opLongMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_LongSeq1, False, 0), ())
    Custom._op_opFloatMatrix = IcePy.Operation("opFloatMatrix", "opFloatMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_FloatSeq1, False, 0), ())
    Custom._op_opDoubleMatrix = IcePy.Operation("opDoubleMatrix", "opDoubleMatrix", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myNumPyMatrix3x3",), (), (), ((), _M_Test.NumPy._t_DoubleSeq1, False, 0), ())
    Custom._op_opBogusNumpyArrayType = IcePy.Operation("opBogusNumpyArrayType", "opBogusNumpyArrayType", Ice.OperationMode.Normal, None, ("python:memoryview:Custom.myBogusNumpyArrayType",), (), (), ((), _M_Test.NumPy._t_BoolSeq1, False, 0), ())
    Custom._op_opD = IcePy.Operation("opD", "opD", Ice.OperationMode.Normal, None, (), (((), _M_Test.NumPy._t_D, False, 0),), (), ((), _M_Test.NumPy._t_D, False, 0), ())
