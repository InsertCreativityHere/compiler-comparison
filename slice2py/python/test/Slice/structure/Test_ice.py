...
if "S1" not in _M_Test.__dict__:
    ...
    class S1(object):
        ...
        def __repr__(self):
            return f"Test.S1({Ice.Util.format_fields(name=self.name)})"
...
if "S2" not in _M_Test.__dict__:
    ...
    class S2(object):
        ...
        def __repr__(self):
            return f"Test.S2({Ice.Util.format_fields(bo=self.bo, by=self.by, sh=self.sh, i=self.i, l=self.l, str=self.str, seq=self.seq, s=self.s)})"
...
if "C" not in _M_Test.__dict__:
    ...
    class C(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.C({Ice.Util.format_fields(name=self.name)})"
...
if "S3" not in _M_Test.__dict__:
    ...
    class S3(object):
        ...
        def __repr__(self):
            return f"Test.S3({Ice.Util.format_fields(obj=self.obj, sd=self.sd, prx=self.prx)})"
