...
if 'TimeoutPrx' not in _M_Test.__dict__:
    ...
    class TimeoutPrx(Ice.ObjectPrx):
        ...
        def begin_op(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Timeout._op_op.begin(self, ((), _response, _ex, _sent, context))

        def end_op(self, _r):
            return _M_Test.Timeout._op_op.end(self, _r)
        ...
        def begin_sendData(self, seq, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Timeout._op_sendData.begin(self, ((seq, ), _response, _ex, _sent, context))

        def end_sendData(self, _r):
            return _M_Test.Timeout._op_sendData.end(self, _r)
        ...
        def begin_sleep(self, to, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Timeout._op_sleep.begin(self, ((to, ), _response, _ex, _sent, context))

        def end_sleep(self, _r):
            return _M_Test.Timeout._op_sleep.end(self, _r)
    ...
    Timeout._op_op = IcePy.Operation('op', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    Timeout._op_sendData = IcePy.Operation('sendData', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_ByteSeq, False, 0),), (), None, ())
    Timeout._op_sleep = IcePy.Operation('sleep', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
...
if 'ControllerPrx' not in _M_Test.__dict__:
    ...
    class ControllerPrx(Ice.ObjectPrx):
        ...
        def begin_holdAdapter(self, to, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Controller._op_holdAdapter.begin(self, ((to, ), _response, _ex, _sent, context))

        def end_holdAdapter(self, _r):
            return _M_Test.Controller._op_holdAdapter.end(self, _r)
        ...
        def begin_resumeAdapter(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.Controller._op_resumeAdapter.begin(self, ((), _response, _ex, _sent, context))

        def end_resumeAdapter(self, _r):
            return _M_Test.Controller._op_resumeAdapter.end(self, _r)
    ...
    Controller._op_holdAdapter = IcePy.Operation('holdAdapter', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
    Controller._op_resumeAdapter = IcePy.Operation('resumeAdapter', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
