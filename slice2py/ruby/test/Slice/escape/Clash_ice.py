...
if "IntfPrx" not in _M_Clash.__dict__:
    ...
    class IntfPrx(Ice.ObjectPrx):
        ...
        def op(self, context, current, response, ex, sent, cookie, sync, result, istr, ostr, proxy=None, context_=None):
    ...
    class Intf(Ice.Object):
        ...
        def op(self, context, current, response, ex, sent, cookie, sync, result, istr, ostr, proxy, current_):
    ...
    Intf._op_upCast = IcePy.Operation("upCast", "upCast", Ice.OperationMode.Normal, None, (), (), (), None, ())
...
if "Cls" not in _M_Clash.__dict__:
    _M_Clash.Cls = None
    class Cls(Ice.Value):
        def __init__(self, s=None, context="", current=0, response=0, upCast="", typeId=0, del=0, cookie=None, ex="", result=0, istr="", ostr="", inS="", in="", proxy=""):
            self.s = s
        ...
        def __repr__(self):
            return f"Clash.Cls({Ice.Util.format_fields(s=self.s, context=self.context, current=self.current, response=self.response, upCast=self.upCast, typeId=self.typeId, del=self.del, cookie=self.cookie, ex=self.ex, result=self.result, istr=self.istr, ostr=self.ostr, inS=self.inS, in=self.in, proxy=self.proxy)})"
...
if "St" not in _M_Clash.__dict__:
    ...
    class St(object):
        ...
        def __repr__(self):
            return f"Clash.St({Ice.Util.format_fields(v=self.v, istr=self.istr, ostr=self.ostr, rhs=self.rhs, other=self.other)})"
...
if "Ex" not in _M_Clash.__dict__:
    ...
    class Ex(Ice.UserException):
        ...
        def __repr__(self):
            return f"Clash.Ex({Ice.Util.format_fields(istr=self.istr, ostr=self.ostr)})"
