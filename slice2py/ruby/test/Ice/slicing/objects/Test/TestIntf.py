...
from Test.BDict import _Test_BDict_t
...
from Test.DerivedException import _Test_DerivedException_t
...
from Test.SS3 import _Test_SS3_t
...
class TestIntfPrx(ObjectPrx):
    ...
    def throwPreservedException(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_throwPreservedException.invoke(self, ((), context))

    def throwPreservedExceptionAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_throwPreservedException.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_throwPreservedException: IcePy.Operation
    ...
    @abstractmethod
    def throwPreservedException(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_SBSKnownDerivedAsSBSKnownDerived = IcePy.Operation(
    ...
    (),
    (),
    ((), _Test_SBSKnownDerived_t, False, 0),
    ())
...
TestIntf._op_paramTest1 = IcePy.Operation(
    ...
    (),
    (),
    (((), _Test_B_t, False, 0), ((), _Test_B_t, False, 0)),
    None,
    ())
...
TestIntf._op_sequenceTest = IcePy.Operation(
    ...
    FormatType.SlicedFormat,
    (),
    (((), _Test_SS1_t, False, 0), ((), _Test_SS2_t, False, 0)),
    (),
    ((), _Test_SS3_t, False, 0),
    ())
...
TestIntf._op_throwPreservedException = IcePy.Operation(
