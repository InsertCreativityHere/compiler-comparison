...
_M_Test._t_Server = IcePy.defineValue('::Test::Server', Ice.Value, -1, (), False, True, None, ())

if 'ServerPrx' not in _M_Test.__dict__:
    _M_Test.ServerPrx = Ice.createTempClass()
    ...
    _M_Test.Server = Ice.createTempClass()
...
_M_Test._t_ServerFactory = IcePy.defineValue('::Test::ServerFactory', Ice.Value, -1, (), False, True, None, ())

if 'ServerFactoryPrx' not in _M_Test.__dict__:
    _M_Test.ServerFactoryPrx = Ice.createTempClass()
    ...
    _M_Test.ServerFactory = Ice.createTempClass()
    ...
    ServerFactory._op_createServer = IcePy.Operation('createServer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_Properties, False, 0),), (), ((), _M_Test._t_ServerPrx, False, 0), ())
    ServerFactory._op_destroyServer = IcePy.Operation('destroyServer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_ServerPrx, False, 0),), (), None, ())
    ServerFactory._op_shutdown = IcePy.Operation('shutdown', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
