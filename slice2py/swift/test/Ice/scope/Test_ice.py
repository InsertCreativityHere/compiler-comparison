...
if '_t_S1Seq' not in _M_Test.__dict__:
    _M_Test._t_S1Seq = IcePy.defineSequence('::Test::S1Seq', (), _M_Test._t_S1)

if '_t_S1Map' not in _M_Test.__dict__:
...
if 'IPrx' not in _M_Test.__dict__:
    ...
    I._op_opS1Seq = IcePy.Operation('opS1Seq', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_S1Seq, False, 0),), (), ((), _M_Test._t_S1Seq, False, 0), ())
    I._op_opS1Map = IcePy.Operation('opS1Map', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_S1Map, False, 0),), (), ((), _M_Test._t_S1Map, False, 0), ())
