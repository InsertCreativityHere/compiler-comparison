...
from Inner.NoPrefix.MyInterface_forward import _Inner_NoPrefix_MyInterfacePrx_t
...
if TYPE_CHECKING:
    ...
    from Inner.NoPrefix.MyClass import MyClass
...
IcePy.defineProxy("::Inner::NoPrefix::MyInterface", MyInterfacePrx)

class MyInterface(Object, ABC):

    _ice_ids: Sequence[str] = ("::Ice::Object", "::Inner::NoPrefix::MyInterface", )
...
MyInterface._op_opMyClass = IcePy.Operation(
    ...
    None,
    (),
    (((), _Inner_NoPrefix_MyClass_t, False, 0),),
    (((), _Inner_NoPrefix_MyClass_t, False, 0),),
    ((), _Inner_NoPrefix_MyClass_t, False, 0),
    ())

__all__ = ["MyInterface", "MyInterfacePrx", "_Inner_NoPrefix_MyInterfacePrx_t"]
