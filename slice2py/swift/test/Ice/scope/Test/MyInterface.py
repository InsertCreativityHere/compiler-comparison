...
class MyInterfacePrx(ObjectPrx):
    ...
    def opMyOtherStructSeq(self, myOtherStructSeq: Sequence[MyOtherStruct], context: dict[str, str] | None = None) -> list[MyOtherStruct]:
        return MyInterface._op_opMyOtherStructSeq.invoke(self, ((myOtherStructSeq, ), context))

    def opMyOtherStructSeqAsync(self, myOtherStructSeq: Sequence[MyOtherStruct], context: dict[str, str] | None = None) -> Awaitable[list[MyOtherStruct]]:
        return MyInterface._op_opMyOtherStructSeq.invokeAsync(self, ((myOtherStructSeq, ), context))

    def opMyOtherStructMap(self, myOtherStructMap: Mapping[str, MyOtherStruct], context: dict[str, str] | None = None) -> dict[str, MyOtherStruct]:
        return MyInterface._op_opMyOtherStructMap.invoke(self, ((myOtherStructMap, ), context))

    def opMyOtherStructMapAsync(self, myOtherStructMap: Mapping[str, MyOtherStruct], context: dict[str, str] | None = None) -> Awaitable[dict[str, MyOtherStruct]]:
        return MyInterface._op_opMyOtherStructMap.invokeAsync(self, ((myOtherStructMap, ), context))
...
class MyInterface(Object, ABC):
    ...
    _op_opMyOtherStructSeq: IcePy.Operation
    _op_opMyOtherStructMap: IcePy.Operation
    ...
    @abstractmethod
    def opMyOtherStructSeq(self, myOtherStructSeq: list[MyOtherStruct], current: Current) -> Sequence[MyOtherStruct] | Awaitable[Sequence[MyOtherStruct]]:
        pass

    @abstractmethod
    def opMyOtherStructMap(self, myOtherStructMap: dict[str, MyOtherStruct], current: Current) -> Mapping[str, MyOtherStruct] | Awaitable[Mapping[str, MyOtherStruct]]:
        pass
...
MyInterface._op_opMyOtherStructSeq = IcePy.Operation(
    "opMyOtherStructSeq",
    "opMyOtherStructSeq",
    OperationMode.Normal,
    None,
    (),
    (((), _Test_MyOtherStructSeq_t, False, 0),),
    (),
    ((), _Test_MyOtherStructSeq_t, False, 0),
    ())

MyInterface._op_opMyOtherStructMap = IcePy.Operation(
    "opMyOtherStructMap",
    "opMyOtherStructMap",
    OperationMode.Normal,
    None,
    (),
    (((), _Test_MyOtherStructMap_t, False, 0),),
    (),
    ((), _Test_MyOtherStructMap_t, False, 0),
    ())
