...
class TestIntfPrx(ObjectPrx):
    ...
    def opWithResultAndUE(self, context: dict[str, str] | None = None) -> int:
        return TestIntf._op_opWithResultAndUE.invoke(self, ((), context))

    def opWithResultAndUEAsync(self, context: dict[str, str] | None = None) -> Awaitable[int]:
        return TestIntf._op_opWithResultAndUE.invokeAsync(self, ((), context))
    ...
    def opWithArgs(self, context: dict[str, str] | None = None) -> tuple[int, int, int, int, int, int, int, int, int, int, int]:
        return TestIntf._op_opWithArgs.invoke(self, ((), context))

    def opWithArgsAsync(self, context: dict[str, str] | None = None) -> Awaitable[tuple[int, int, int, int, int, int, int, int, int, int, int]]:
        return TestIntf._op_opWithArgs.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_opWithResultAndUE: IcePy.Operation
    _op_opBatch: IcePy.Operation
    _op_opWithArgs: IcePy.Operation
    ...
    @abstractmethod
    def opWithResultAndUE(self, current: Current) -> int | Awaitable[int]:
        pass
    ...
    @abstractmethod
    def opWithArgs(self, current: Current) -> tuple[int, int, int, int, int, int, int, int, int, int, int] | Awaitable[tuple[int, int, int, int, int, int, int, int, int, int, int]]:
        pass
...
TestIntf._op_opWithResultAndUE = IcePy.Operation(
    "opWithResultAndUE",
    "opWithResultAndUE",
    OperationMode.Normal,
    None,
...
TestIntf._op_opWithArgs = IcePy.Operation(
    "opWithArgs",
    "opWithArgs",
    OperationMode.Normal,
    None,
    (),
    (),
    (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)),
    None,
    ())
