...
class InitialPrx(ObjectPrx):
    ...
    def opCustomString(self, p1: str | None = None, context: dict[str, str] | None = None) -> tuple[str | None, str | None]:
        return Initial._op_opCustomString.invoke(self, ((p1, ), context))

    def opCustomStringAsync(self, p1: str | None = None, context: dict[str, str] | None = None) -> Awaitable[tuple[str | None, str | None]]:
        return Initial._op_opCustomString.invokeAsync(self, ((p1, ), context))
    ...
    def opSerializable(self, p1: Sequence[int] | bytes | None = None, context: dict[str, str] | None = None) -> tuple[bytes | None, bytes | None]:
        return Initial._op_opSerializable.invoke(self, ((p1, ), context))

    def opSerializableAsync(self, p1: Sequence[int] | bytes | None = None, context: dict[str, str] | None = None) -> Awaitable[tuple[bytes | None, bytes | None]]:
        return Initial._op_opSerializable.invokeAsync(self, ((p1, ), context))
    ...
    def opCustomIntStringDict(self, p1: Mapping[int, str] | None = None, context: dict[str, str] | None = None) -> tuple[dict[int, str] | None, dict[int, str] | None]:
        return Initial._op_opCustomIntStringDict.invoke(self, ((p1, ), context))

    def opCustomIntStringDictAsync(self, p1: Mapping[int, str] | None = None, context: dict[str, str] | None = None) -> Awaitable[tuple[dict[int, str] | None, dict[int, str] | None]]:
        return Initial._op_opCustomIntStringDict.invokeAsync(self, ((p1, ), context))
...
class Initial(Object, ABC):
    ...
    _op_opCustomString: IcePy.Operation
    ...
    _op_opSerializable: IcePy.Operation
    _op_opIntIntDict: IcePy.Operation
    _op_opStringIntDict: IcePy.Operation
    _op_opCustomIntStringDict: IcePy.Operation
    ...
    @abstractmethod
    def opCustomString(self, p1: str | None, current: Current) -> tuple[str | None, str | None] | Awaitable[tuple[str | None, str | None]]:
        pass
    ...
    @abstractmethod
    def opSerializable(self, p1: bytes | None, current: Current) -> tuple[Sequence[int] | bytes | None, Sequence[int] | bytes | None] | Awaitable[tuple[Sequence[int] | bytes | None, Sequence[int] | bytes | None]]:
        pass
    ...
    @abstractmethod
    def opCustomIntStringDict(self, p1: dict[int, str] | None, current: Current) -> tuple[Mapping[int, str] | None, Mapping[int, str] | None] | Awaitable[tuple[Mapping[int, str] | None, Mapping[int, str] | None]]:
        pass
...
Initial._op_opCustomString = IcePy.Operation(
    "opCustomString",
    "opCustomString",
    OperationMode.Normal,
    None,
...
Initial._op_opSerializable = IcePy.Operation(
    "opSerializable",
    "opSerializable",
    OperationMode.Normal,
    None,
    (),
    (((), _Test_Serializable_t, True, 2),),
    (((), _Test_Serializable_t, True, 3),),
    ((), _Test_Serializable_t, True, 1),
    ())
...
Initial._op_opCustomIntStringDict = IcePy.Operation(
    "opCustomIntStringDict",
    "opCustomIntStringDict",
    OperationMode.Normal,
    None,
    (),
    (((), _Test_IntStringDict_t, True, 2),),
    (((), _Test_IntStringDict_t, True, 3),),
    ((), _Test_IntStringDict_t, True, 1),
    ())
