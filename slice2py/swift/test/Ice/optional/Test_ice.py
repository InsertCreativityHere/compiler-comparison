...
if "InitialPrx" not in _M_Test.__dict__:
    ...
    class Initial(Ice.Object):
        ...
        def opCustomString(self, p1, current):
        ...
        def opCustomIntStringDict(self, p1, current):
    ...
    Initial._op_opCustomString = IcePy.Operation("opCustomString", "opCustomString", Ice.OperationMode.Normal, None, (), (((), IcePy._t_string, True, 2),), (((), IcePy._t_string, True, 3),), ((), IcePy._t_string, True, 1), ())
    ...
    Initial._op_opCustomIntStringDict = IcePy.Operation("opCustomIntStringDict", "opCustomIntStringDict", Ice.OperationMode.Normal, None, (), (((), _M_Test._t_IntStringDict, True, 2),), (((), _M_Test._t_IntStringDict, True, 3),), ((), _M_Test._t_IntStringDict, True, 1), ())
