...
_Test_OptionalException_t = IcePy.defineException(
...
setattr(OptionalException, '_ice_type', _Test_OptionalException_t)

__all__ = ["OptionalException", "_Test_OptionalException_t"]
