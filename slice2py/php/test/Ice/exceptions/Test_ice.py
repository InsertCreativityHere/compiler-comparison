...
if "A" not in _M_Test.__dict__:
    ...
    class A(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.A({Ice.Util.format_fields(aMem=self.aMem)})"
...
if "B" not in _M_Test.__dict__:
    ...
    class B(_M_Test.A):
        ...
        def __repr__(self):
            return f"Test.B({Ice.Util.format_fields(aMem=self.aMem, bMem=self.bMem)})"
...
if "C" not in _M_Test.__dict__:
    ...
    class C(_M_Test.B):
        ...
        def __repr__(self):
            return f"Test.C({Ice.Util.format_fields(aMem=self.aMem, bMem=self.bMem, cMem=self.cMem)})"
...
if "D" not in _M_Test.__dict__:
    ...
    class D(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.D({Ice.Util.format_fields(dMem=self.dMem)})"
...
if "ThrowerPrx" not in _M_Test.__dict__:
    ...
    class ThrowerPrx(Ice.ObjectPrx):
        ...
        def throwDispatchException(self, replyStatus, context=None):
            return _M_Test.Thrower._op_throwDispatchException.invoke(self, ((replyStatus, ), context))

        def throwDispatchExceptionAsync(self, replyStatus, context=None):
            return _M_Test.Thrower._op_throwDispatchException.invokeAsync(self, ((replyStatus, ), context))

        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.ThrowerPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.ThrowerPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.ThrowerPrx, proxy, facet)
    ...
    class Thrower(Ice.Object):
        ...
        def throwDispatchException(self, replyStatus, current):
            raise NotImplementedError("servant method 'throwDispatchException' not implemented")

    Thrower._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Thrower._op_supportsUndeclaredExceptions = IcePy.Operation("supportsUndeclaredExceptions", "supportsUndeclaredExceptions", Ice.OperationMode.Normal, None, (), (), (), ((), IcePy._t_bool, False, 0), ())
    Thrower._op_throwAasA = IcePy.Operation("throwAasA", "throwAasA", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, (_M_Test._t_A,))
    Thrower._op_throwAorDasAorD = IcePy.Operation("throwAorDasAorD", "throwAorDasAorD", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, (_M_Test._t_A, _M_Test._t_D))
    Thrower._op_throwBasA = IcePy.Operation("throwBasA", "throwBasA", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test._t_A,))
    Thrower._op_throwCasA = IcePy.Operation("throwCasA", "throwCasA", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test._t_A,))
    Thrower._op_throwBasB = IcePy.Operation("throwBasB", "throwBasB", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test._t_B,))
    Thrower._op_throwCasB = IcePy.Operation("throwCasB", "throwCasB", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test._t_B,))
    Thrower._op_throwCasC = IcePy.Operation("throwCasC", "throwCasC", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Test._t_C,))
    Thrower._op_throwUndeclaredA = IcePy.Operation("throwUndeclaredA", "throwUndeclaredA", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0),), (), None, ())
    Thrower._op_throwUndeclaredB = IcePy.Operation("throwUndeclaredB", "throwUndeclaredB", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, ())
    Thrower._op_throwUndeclaredC = IcePy.Operation("throwUndeclaredC", "throwUndeclaredC", Ice.OperationMode.Normal, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), None, ())
    Thrower._op_throwLocalException = IcePy.Operation("throwLocalException", "throwLocalException", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Thrower._op_throwNonIceException = IcePy.Operation("throwNonIceException", "throwNonIceException", Ice.OperationMode.Normal, None, (), (), (), None, ())
    Thrower._op_throwMemoryLimitException = IcePy.Operation("throwMemoryLimitException", "throwMemoryLimitException", Ice.OperationMode.Normal, None, (), (((), _M_Ice._t_ByteSeq, False, 0),), (), ((), _M_Ice._t_ByteSeq, False, 0), ())
    Thrower._op_throwLocalExceptionIdempotent = IcePy.Operation("throwLocalExceptionIdempotent", "throwLocalExceptionIdempotent", Ice.OperationMode.Idempotent, None, (), (), (), None, ())
    Thrower._op_throwDispatchException = IcePy.Operation("throwDispatchException", "throwDispatchException", Ice.OperationMode.Normal, None, (), (((), IcePy._t_byte, False, 0),), (), None, ())
...
if "WrongOperationPrx" not in _M_Test.__dict__:
    ...
    class WrongOperationPrx(Ice.ObjectPrx):
        ...
        @staticmethod
        def checkedCast(proxy, facet=None, context=None):
            return Ice.checkedCast(_M_Test.WrongOperationPrx, proxy, facet, context)

        @staticmethod
        def checkedCastAsync(proxy, facet=None, context=None):
            return Ice.checkedCastAsync(_M_Test.WrongOperationPrx, proxy, facet, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return Ice.uncheckedCast(_M_Test.WrongOperationPrx, proxy, facet)
    ...
    class WrongOperation(Ice.Object):
        ...
        def noSuchOperation(self, current):
            raise NotImplementedError("servant method 'noSuchOperation' not implemented")

    WrongOperation._op_noSuchOperation = IcePy.Operation("noSuchOperation", "noSuchOperation", Ice.OperationMode.Normal, None, (), (), (), None, ())
