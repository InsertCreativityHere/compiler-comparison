...
if "MyClassPrx" not in _M_Test.__dict__:
    ...
    MyClass._op_opContext = IcePy.Operation("opContext", "opContext", Ice.OperationMode.Normal, None, (), (), (), ((), _M_Test._t_StringStringD, False, 0), ())
