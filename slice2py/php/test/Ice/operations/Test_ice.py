...
if 'MyDerivedClassPrx' not in _M_Test.__dict__:
    ...
    class MyDerivedClassPrx(_M_Test.MyClassPrx):
        ...
        def begin_opMyStruct1(self, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.MyDerivedClass._op_opMyStruct1.begin(self, ((s, ), _response, _ex, _sent, context))
        ...
        def begin_opMyClass1(self, c, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.MyDerivedClass._op_opMyClass1.begin(self, ((c, ), _response, _ex, _sent, context))
