...
if 'LookupReplyPrx' not in _M_IceLocatorDiscovery.__dict__:
    ...
    LookupReply._op_foundLocator = IcePy.Operation('foundLocator', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Ice._t_LocatorPrx, False, 0),), (), None, ())
...
if 'LookupPrx' not in _M_IceLocatorDiscovery.__dict__:
    ...
    Lookup._op_findLocator = IcePy.Operation('findLocator', Ice.OperationMode.Idempotent, Ice.OperationMode.Nonmutating, False, None, (), (((), IcePy._t_string, False, 0), ((), _M_IceLocatorDiscovery._t_LookupReplyPrx, False, 0)), (), None, ())
