...
from await.System.Test_forward import _await_System_TestPrx_t
...
IcePy.defineProxy("::await::System::Test", TestPrx)

class Test(Object, ABC):

    _ice_ids: Sequence[str] = ("::Ice::Object", "::await::System::Test", )
...
__all__ = ["Test", "TestPrx", "_await_System_TestPrx_t"]
