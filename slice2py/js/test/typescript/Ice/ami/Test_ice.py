...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    class TestIntfPrx(Ice.ObjectPrx):
        ...
        def begin_pingBidDir(self, id, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_pingBidDir.begin(self, ((id, ), _response, _ex, _sent, context))

        def end_pingBidDir(self, _r):
            return _M_Test.TestIntf._op_pingBidDir.end(self, _r)
