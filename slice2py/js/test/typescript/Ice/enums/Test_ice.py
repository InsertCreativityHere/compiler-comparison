...
if 'ByteEnum' not in _M_Test.__dict__:
    _M_Test.ByteEnum = Ice.createTempClass()
...
if 'ShortEnum' not in _M_Test.__dict__:
    _M_Test.ShortEnum = Ice.createTempClass()
...
if 'IntEnum' not in _M_Test.__dict__:
    _M_Test.IntEnum = Ice.createTempClass()
...
if 'SimpleEnum' not in _M_Test.__dict__:
    _M_Test.SimpleEnum = Ice.createTempClass()
...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    class TestIntfPrx(Ice.ObjectPrx):
        ...
        def begin_opByte(self, b1, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_opByte.begin(self, ((b1, ), _response, _ex, _sent, context))
        ...
        def begin_opShort(self, s1, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_opShort.begin(self, ((s1, ), _response, _ex, _sent, context))
        ...
        def begin_opInt(self, i1, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_opInt.begin(self, ((i1, ), _response, _ex, _sent, context))
        ...
        def begin_opSimple(self, s1, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_opSimple.begin(self, ((s1, ), _response, _ex, _sent, context))

        def end_opSimple(self, _r):
            return _M_Test.TestIntf._op_opSimple.end(self, _r)
    ...
    TestIntf._op_opByte = IcePy.Operation('opByte', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_ByteEnum, False, 0),), (((), _M_Test._t_ByteEnum, False, 0),), ((), _M_Test._t_ByteEnum, False, 0), ())
    TestIntf._op_opShort = IcePy.Operation('opShort', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_ShortEnum, False, 0),), (((), _M_Test._t_ShortEnum, False, 0),), ((), _M_Test._t_ShortEnum, False, 0), ())
    TestIntf._op_opInt = IcePy.Operation('opInt', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_IntEnum, False, 0),), (((), _M_Test._t_IntEnum, False, 0),), ((), _M_Test._t_IntEnum, False, 0), ())
    TestIntf._op_opSimple = IcePy.Operation('opSimple', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_Test._t_SimpleEnum, False, 0),), (((), _M_Test._t_SimpleEnum, False, 0),), ((), _M_Test._t_SimpleEnum, False, 0), ())
