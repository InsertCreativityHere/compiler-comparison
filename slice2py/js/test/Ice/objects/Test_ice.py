...
if 'IPrx' not in _M_Test.__dict__:
    ...
    class IPrx(Ice.ObjectPrx):
        ...
        def doI(self, context=None):
            return _M_Test.I._op_doI.invoke(self, ((), context))

        def doIAsync(self, context=None):
            return _M_Test.I._op_doI.invokeAsync(self, ((), context))

        def begin_doI(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.I._op_doI.begin(self, ((), _response, _ex, _sent, context))

        def end_doI(self, _r):
            return _M_Test.I._op_doI.end(self, _r)
    ...
    class I(Ice.Object):
        ...
        def doI(self, current=None):
            raise NotImplementedError("servant method 'doI' not implemented")
...
if 'JPrx' not in _M_Test.__dict__:
    ...
    class JPrx(_M_Test.IPrx):
        ...
        def doJ(self, context=None):
            return _M_Test.J._op_doJ.invoke(self, ((), context))

        def doJAsync(self, context=None):
            return _M_Test.J._op_doJ.invokeAsync(self, ((), context))

        def begin_doJ(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.J._op_doJ.begin(self, ((), _response, _ex, _sent, context))

        def end_doJ(self, _r):
            return _M_Test.J._op_doJ.end(self, _r)
    ...
    class J(_M_Test.I):
        ...
        def doJ(self, current=None):
            raise NotImplementedError("servant method 'doJ' not implemented")
...
if 'HPrx' not in _M_Test.__dict__:
    ...
    class HPrx(_M_Test.IPrx):

        def doH(self, context=None):
            return _M_Test.HDisp._op_doH.invoke(self, ((), context))

        def doHAsync(self, context=None):
            return _M_Test.HDisp._op_doH.invokeAsync(self, ((), context))

        def begin_doH(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.HDisp._op_doH.begin(self, ((), _response, _ex, _sent, context))

        def end_doH(self, _r):
            return _M_Test.HDisp._op_doH.end(self, _r)

        def doH2(self, context=None):
            return _M_Test.HDisp._op_doH2.invoke(self, ((), context))

        def doH2Async(self, context=None):
            return _M_Test.HDisp._op_doH2.invokeAsync(self, ((), context))

        def begin_doH2(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.HDisp._op_doH2.begin(self, ((), _response, _ex, _sent, context))

        def end_doH2(self, _r):
            return _M_Test.HDisp._op_doH2.end(self, _r)
    ...
    _M_Test.HDisp = Ice.createTempClass()
    class HDisp(_M_Test.I):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Test::H', '::Test::I')
        ...
        def doH(self, current=None):
            raise NotImplementedError("servant method 'doH' not implemented")

        def doH2(self, current=None):
            raise NotImplementedError("servant method 'doH2' not implemented")
    ...
    _M_Test._t_HDisp = IcePy.defineClass('::Test::H', HDisp, (), None, (_M_Test._t_IDisp,))
    HDisp._ice_type = _M_Test._t_HDisp

    HDisp._op_doH = IcePy.Operation('doH', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    HDisp._op_doH2 = IcePy.Operation('doH2', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
