...
class BPrx(ObjectPrx):
    ...
    def opB(self, context: dict[str, str] | None = None) -> None:
        return B._op_opB.invoke(self, ((), context))

    def opBAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return B._op_opB.invokeAsync(self, ((), context))
...
class B(Object, ABC):
    ...
    @abstractmethod
    def opB(self, current: Current) -> None | Awaitable[None]:
        pass
