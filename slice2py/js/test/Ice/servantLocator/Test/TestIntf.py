...
class TestIntfPrx(ObjectPrx):
    ...
    def jsException(self, context: dict[str, str] | None = None) -> None:
        return TestIntf._op_jsException.invoke(self, ((), context))

    def jsExceptionAsync(self, context: dict[str, str] | None = None) -> Awaitable[None]:
        return TestIntf._op_jsException.invokeAsync(self, ((), context))
...
class TestIntf(Object, ABC):
    ...
    _op_jsException: IcePy.Operation
    ...
    @abstractmethod
    def jsException(self, current: Current) -> None | Awaitable[None]:
        pass
...
TestIntf._op_jsException = IcePy.Operation(
    "jsException",
    "jsException",
    OperationMode.Normal,
    None,
