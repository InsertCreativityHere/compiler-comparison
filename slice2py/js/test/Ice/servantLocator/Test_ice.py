...
if 'TestIntfPrx' not in _M_Test.__dict__:
    ...
    class TestIntfPrx(Ice.ObjectPrx):
        ...
        def begin_jsException(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_Test.TestIntf._op_jsException.begin(self, ((), _response, _ex, _sent, context))

        def end_jsException(self, _r):
            return _M_Test.TestIntf._op_jsException.end(self, _r)
    ...
    TestIntf._op_jsException = IcePy.Operation('jsException', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
