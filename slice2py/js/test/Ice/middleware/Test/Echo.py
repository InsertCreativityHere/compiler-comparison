...
class EchoPrx(ObjectPrx):
    ...
    def supportsCompress(self, context: dict[str, str] | None = None) -> bool:
        return Echo._op_supportsCompress.invoke(self, ((), context))

    def supportsCompressAsync(self, context: dict[str, str] | None = None) -> Awaitable[bool]:
        return Echo._op_supportsCompress.invokeAsync(self, ((), context))
...
Echo._op_supportsCompress = IcePy.Operation(
    "supportsCompress",
    "supportsCompress",
    OperationMode.Normal,
    None,
