...
class MyInterfacePrx(ObjectPrx):
    ...
    def opMyClassSeq(self, s1: Sequence[MyClass | None], context: dict[str, str] | None = None) -> tuple[list[MyClass | None], list[MyClass | None]]:
        return MyInterface._op_opMyClassSeq.invoke(self, ((s1, ), context))

    def opMyClassSeqAsync(self, s1: Sequence[MyClass | None], context: dict[str, str] | None = None) -> Awaitable[tuple[list[MyClass | None], list[MyClass | None]]]:
        return MyInterface._op_opMyClassSeq.invokeAsync(self, ((s1, ), context))
...
class MyInterface(Object, ABC):
    ...
    @abstractmethod
    def opMyClassSeq(self, s1: list[MyClass | None], current: Current) -> tuple[Sequence[MyClass | None], Sequence[MyClass | None]] | Awaitable[tuple[Sequence[MyClass | None], Sequence[MyClass | None]]]:
        pass
