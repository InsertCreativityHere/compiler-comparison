...
if "SBase" not in _M_Test.__dict__:
    _M_Test._t_SBase = IcePy.declareValue("::Test::SBase")
...
if "SBase" not in _M_Test.__dict__:
    ...
    class SBase(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.SBase({Ice.Util.format_fields(sb=self.sb)})"
...
if "SBSKnownDerived" not in _M_Test.__dict__:
    _M_Test._t_SBSKnownDerived = IcePy.declareValue("::Test::SBSKnownDerived")
...
if "SBSKnownDerived" not in _M_Test.__dict__:
    ...
    class SBSKnownDerived(_M_Test.SBase):
        ...
        def __repr__(self):
            return f"Test.SBSKnownDerived({Ice.Util.format_fields(sb=self.sb, sbskd=self.sbskd)})"
...
if "B" not in _M_Test.__dict__:
    ...
    class B(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.B({Ice.Util.format_fields(sb=self.sb, pb=self.pb)})"
...
if "D1" not in _M_Test.__dict__:
    ...
    class D1(_M_Test.B):
        ...
        def __repr__(self):
            return f"Test.D1({Ice.Util.format_fields(sb=self.sb, pb=self.pb, sd1=self.sd1, pd1=self.pd1)})"
...
if "SS1" not in _M_Test.__dict__:
    ...
    class SS1(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.SS1({Ice.Util.format_fields(s=self.s)})"
...
if "SS2" not in _M_Test.__dict__:
    ...
    class SS2(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.SS2({Ice.Util.format_fields(s=self.s)})"
...
if "SS3" not in _M_Test.__dict__:
    ...
    class SS3(object):
        ...
        def __repr__(self):
            return f"Test.SS3({Ice.Util.format_fields(c1=self.c1, c2=self.c2)})"
...
if "BaseException" not in _M_Test.__dict__:
    ...
    class BaseException(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.BaseException({Ice.Util.format_fields(sbe=self.sbe, pb=self.pb)})"
...
if "DerivedException" not in _M_Test.__dict__:
    ...
    class DerivedException(_M_Test.BaseException):
        ...
        def __repr__(self):
            return f"Test.DerivedException({Ice.Util.format_fields(sbe=self.sbe, pb=self.pb, sde=self.sde, pd1=self.pd1)})"
...
if "PBase" not in _M_Test.__dict__:
    _M_Test._t_PBase = IcePy.declareValue("::Test::PBase")
...
if "PBase" not in _M_Test.__dict__:
    ...
    class PBase(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.PBase({Ice.Util.format_fields(pi=self.pi)})"
...
if "Preserved" not in _M_Test.__dict__:
    _M_Test._t_Preserved = IcePy.declareValue("::Test::Preserved")
...
if "Preserved" not in _M_Test.__dict__:
    ...
    class Preserved(_M_Test.PBase):
        ...
        def __repr__(self):
            return f"Test.Preserved({Ice.Util.format_fields(pi=self.pi, ps=self.ps)})"
...
if "PDerived" not in _M_Test.__dict__:
    ...
    class PDerived(_M_Test.Preserved):
        ...
        def __repr__(self):
            return f"Test.PDerived({Ice.Util.format_fields(pi=self.pi, ps=self.ps, pb=self.pb)})"
...
if "CompactPDerived" not in _M_Test.__dict__:
    ...
    class CompactPDerived(_M_Test.Preserved):
        ...
        def __repr__(self):
            return f"Test.CompactPDerived({Ice.Util.format_fields(pi=self.pi, ps=self.ps, pb=self.pb)})"
...
if "PNode" not in _M_Test.__dict__:
    ...
    class PNode(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.PNode({Ice.Util.format_fields(next=self.next)})"
...
if "PreservedException" not in _M_Test.__dict__:
    ...
    class PreservedException(Ice.UserException):
        ...
        def __repr__(self):
            return f"Test.PreservedException()"
...
if "TestIntfPrx" not in _M_Test.__dict__:
    ...
    class TestIntf(Ice.Object):
        ...
        def checkSUnknown(self, o, current):
        ...
        def throwPreservedException(self, current):
    ...
    TestIntf._op_SBaseAsObject = IcePy.Operation("SBaseAsObject", "SBaseAsObject", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), IcePy._t_Value, False, 0), ())
    TestIntf._op_SBaseAsSBase = IcePy.Operation("SBaseAsSBase", "SBaseAsSBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_SBase, False, 0), ())
    TestIntf._op_SBSKnownDerivedAsSBase = IcePy.Operation("SBSKnownDerivedAsSBase", "SBSKnownDerivedAsSBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_SBase, False, 0), ())
    TestIntf._op_SBSKnownDerivedAsSBSKnownDerived = IcePy.Operation("SBSKnownDerivedAsSBSKnownDerived", "SBSKnownDerivedAsSBSKnownDerived", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_SBSKnownDerived, False, 0), ())
    TestIntf._op_SBSUnknownDerivedAsSBase = IcePy.Operation("SBSUnknownDerivedAsSBase", "SBSUnknownDerivedAsSBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_SBase, False, 0), ())
    TestIntf._op_SBSUnknownDerivedAsSBaseCompact = IcePy.Operation("SBSUnknownDerivedAsSBaseCompact", "SBSUnknownDerivedAsSBaseCompact", Ice.OperationMode.Normal, Ice.FormatType.CompactFormat, (), (), (), ((), _M_Test._t_SBase, False, 0), ())
    TestIntf._op_SUnknownAsObject = IcePy.Operation("SUnknownAsObject", "SUnknownAsObject", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), IcePy._t_Value, False, 0), ())
    TestIntf._op_checkSUnknown = IcePy.Operation("checkSUnknown", "checkSUnknown", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), IcePy._t_Value, False, 0),), (), None, ())
    TestIntf._op_oneElementCycle = IcePy.Operation("oneElementCycle", "oneElementCycle", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_twoElementCycle = IcePy.Operation("twoElementCycle", "twoElementCycle", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_D1AsB = IcePy.Operation("D1AsB", "D1AsB", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_D1AsD1 = IcePy.Operation("D1AsD1", "D1AsD1", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_D1, False, 0), ())
    TestIntf._op_D2AsB = IcePy.Operation("D2AsB", "D2AsB", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_paramTest1 = IcePy.Operation("paramTest1", "paramTest1", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), None, ())
    TestIntf._op_paramTest2 = IcePy.Operation("paramTest2", "paramTest2", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), None, ())
    TestIntf._op_paramTest3 = IcePy.Operation("paramTest3", "paramTest3", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_paramTest4 = IcePy.Operation("paramTest4", "paramTest4", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0),), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_returnTest1 = IcePy.Operation("returnTest1", "returnTest1", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_returnTest2 = IcePy.Operation("returnTest2", "returnTest2", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_returnTest3 = IcePy.Operation("returnTest3", "returnTest3", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_B, False, 0), ((), _M_Test._t_B, False, 0)), (), ((), _M_Test._t_B, False, 0), ())
    TestIntf._op_sequenceTest = IcePy.Operation("sequenceTest", "sequenceTest", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_SS1, False, 0), ((), _M_Test._t_SS2, False, 0)), (), ((), _M_Test._t_SS3, False, 0), ())
    TestIntf._op_dictionaryTest = IcePy.Operation("dictionaryTest", "dictionaryTest", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_BDict, False, 0),), (((), _M_Test._t_BDict, False, 0),), ((), _M_Test._t_BDict, False, 0), ())
    TestIntf._op_exchangePBase = IcePy.Operation("exchangePBase", "exchangePBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_PBase, False, 0),), (), ((), _M_Test._t_PBase, False, 0), ())
    TestIntf._op_PBSUnknownAsPreserved = IcePy.Operation("PBSUnknownAsPreserved", "PBSUnknownAsPreserved", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_Preserved, False, 0), ())
    TestIntf._op_checkPBSUnknown = IcePy.Operation("checkPBSUnknown", "checkPBSUnknown", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_Preserved, False, 0),), (), None, ())
    TestIntf._op_PBSUnknownAsPreservedWithGraph = IcePy.Operation("PBSUnknownAsPreservedWithGraph", "PBSUnknownAsPreservedWithGraph", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_Preserved, False, 0), ())
    TestIntf._op_checkPBSUnknownWithGraph = IcePy.Operation("checkPBSUnknownWithGraph", "checkPBSUnknownWithGraph", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_Preserved, False, 0),), (), None, ())
    TestIntf._op_PBSUnknown2AsPreservedWithGraph = IcePy.Operation("PBSUnknown2AsPreservedWithGraph", "PBSUnknown2AsPreservedWithGraph", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), ((), _M_Test._t_Preserved, False, 0), ())
    TestIntf._op_checkPBSUnknown2WithGraph = IcePy.Operation("checkPBSUnknown2WithGraph", "checkPBSUnknown2WithGraph", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_Preserved, False, 0),), (), None, ())
    TestIntf._op_exchangePNode = IcePy.Operation("exchangePNode", "exchangePNode", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (((), _M_Test._t_PNode, False, 0),), (), ((), _M_Test._t_PNode, False, 0), ())
    TestIntf._op_throwBaseAsBase = IcePy.Operation("throwBaseAsBase", "throwBaseAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_BaseException,))
    TestIntf._op_throwDerivedAsBase = IcePy.Operation("throwDerivedAsBase", "throwDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_BaseException,))
    TestIntf._op_throwDerivedAsDerived = IcePy.Operation("throwDerivedAsDerived", "throwDerivedAsDerived", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_DerivedException,))
    TestIntf._op_throwUnknownDerivedAsBase = IcePy.Operation("throwUnknownDerivedAsBase", "throwUnknownDerivedAsBase", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_BaseException,))
    TestIntf._op_throwPreservedException = IcePy.Operation("throwPreservedException", "throwPreservedException", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, (_M_Test._t_PreservedException,))
    TestIntf._op_useForward = IcePy.Operation("useForward", "useForward", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (((), _M_Test._t_Forward, False, 0),), None, ())
    TestIntf._op_shutdown = IcePy.Operation("shutdown", "shutdown", Ice.OperationMode.Normal, Ice.FormatType.SlicedFormat, (), (), (), None, ())
...
if "Hidden" not in _M_Test.__dict__:
    ...
    class Hidden(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Hidden({Ice.Util.format_fields(f=self.f)})"
...
if "Forward" not in _M_Test.__dict__:
    ...
    class Forward(Ice.Value):
        ...
        def __repr__(self):
            return f"Test.Forward({Ice.Util.format_fields(h=self.h)})"
