...
if "KnownPreserved" not in _M_Test.__dict__:
    ...
    class KnownPreserved(_M_Test.Base):
        ...
        def __repr__(self):
            return f"Test.KnownPreserved({Ice.Util.format_fields(b=self.b, kp=self.kp)})"
...
if "KnownPreservedDerived" not in _M_Test.__dict__:
    ...
    class KnownPreservedDerived(_M_Test.KnownPreserved):
        ...
        def __repr__(self):
            return f"Test.KnownPreservedDerived({Ice.Util.format_fields(b=self.b, kp=self.kp, kpd=self.kpd)})"
