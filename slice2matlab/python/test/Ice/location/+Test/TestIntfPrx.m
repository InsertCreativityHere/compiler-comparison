classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %   TestIntfPrx Methods:
    %     getHello
    %     getHelloAsync - An asynchronous getHello.
    %     getReplicatedHello
    %     getReplicatedHelloAsync - An asynchronous getReplicatedHello.
    %     migrateHello
    %     migrateHelloAsync - An asynchronous migrateHello.
    %     shutdown
    ...
    methods
        ...
        function returnValue = getHello(obj, context)
            %GETHELLO
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %   Output Arguments
            %     returnValue
            %       Test.HelloPrx scalar | empty array of Test.HelloPrx
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            is_ = obj.iceInvoke('getHello', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = Test.HelloPrx.ice_read(is_);
            is_.endEncapsulation();
        end

        function future = getHelloAsync(obj, context)
            %GETHELLOASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            future = obj.iceInvokeAsync('getHello', 0, true, [], 1, @unmarshal, {}, context);
        end

        function returnValue = getReplicatedHello(obj, context)
            %GETREPLICATEDHELLO
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('getReplicatedHello', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = Test.HelloPrx.ice_read(is_);
            is_.endEncapsulation();
        end

        function future = getReplicatedHelloAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also getReplicatedHello, Ice.Future.
            ...
            future = obj.iceInvokeAsync('getReplicatedHello', 0, true, [], 1, @unmarshal, {}, context);
        end

        function migrateHello(obj, context)
            %MIGRATEHELLO
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('migrateHello', 0, false, [], false, {}, context);
        end

        function future = migrateHelloAsync(obj, context)
            %MIGRATEHELLOASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also migrateHello, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('migrateHello', 0, false, [], 0, [], {}, context);
        end
    end
