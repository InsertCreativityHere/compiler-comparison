classdef ThrowerPrx < Ice.ObjectPrx
    ...
    %     throwMarshalExceptionAsync - An asynchronous throwMarshalException.
    ...
    %     throwRequestFailedExceptionAsync - An asynchronous throwRequestFailedException.
    %     throwUndeclaredA
    ...
    methods
        ...
        function [returnValue, p] = throwMarshalException(obj, context)
            %THROWMARSHALEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('throwMarshalException', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            p = is_.readInt();
        ...
        function future = throwMarshalExceptionAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also throwMarshalException, Ice.Future.
            ...
            future = obj.iceInvokeAsync('throwMarshalException', 0, true, [], 2, @unmarshal, {}, context);
        end

        function throwRequestFailedException(obj, type, id, facet, operation, context)
            %THROWREQUESTFAILEDEXCEPTION
            %
            %   Input Arguments
            %     type
            ...
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('throwRequestFailedException', 0, false, os_, false, {}, context);
        end

        function future = throwRequestFailedExceptionAsync(obj, type, id, facet, operation, context)
            ...
            %       Ice.Future scalar
            %
            %   See also throwRequestFailedException, Ice.Future.
            ...
            os_.writeString(operation);
            obj.iceEndWriteParams(os_);
            future = obj.iceInvokeAsync('throwRequestFailedException', 0, false, os_, 0, [], {}, context);
        end
    end
