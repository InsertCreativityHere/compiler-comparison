classdef (Sealed) StructNoDefaults
    ...
    %       obj = Test.StructNoDefaults(bo, b, s, i, l, f, d, str, c1, bs, iseq, isDict, st)
    %
    ...
    methods
        function obj = StructNoDefaults(bo, b, s, i, l, f, d, str, c1, bs, iseq, isDict, st)
            if nargin > 0
    ...
    methods (Static)
        function r = ice_read(is)
            ...
            r.isDict = Test.IntStringDict.read(is);
        ...
        function ice_write(os, v)
            ...
            Test.IntStringDict.write(os, v.isDict);
