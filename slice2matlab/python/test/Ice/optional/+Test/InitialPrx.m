...
classdef InitialPrx < Ice.ObjectPrx
    methods
        ...
        function [p4, p5, p6] = opRequiredAfterOptional(obj, p1, p2, p3, varargin)
            % opRequiredAfterOptional
            %
            % Parameters:
            %   p1 (int32)
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opRequiredAfterOptional', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            p4 = is_.readInt();
            p6 = is_.readInt();
            p5 = is_.readIntOpt(2);
        ...
        function r_ = opRequiredAfterOptionalAsync(obj, p1, p2, p3, varargin)
            % opRequiredAfterOptionalAsync
            %
            % Parameters:
            %   p1 (int32)
            ...
            r_ = obj.iceInvokeAsync('opRequiredAfterOptional', 0, true, os_, 3, @unmarshal, {}, varargin{:});
        end
        function [p4, p5, p6] = opOptionalAfterRequired(obj, p1, p2, p3, varargin)
            % opOptionalAfterRequired
            %
            % Parameters:
            %   p1 (int32)
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opOptionalAfterRequired', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            p4 = is_.readInt();
            p5 = is_.readIntOpt(3);
            p6 = is_.readIntOpt(4);
        ...
        function r_ = opOptionalAfterRequiredAsync(obj, p1, p2, p3, varargin)
            % opOptionalAfterRequiredAsync
            %
            % Parameters:
            %   p1 (int32)
