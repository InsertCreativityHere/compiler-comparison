classdef InitialPrx < Ice.ObjectPrx
    ...
    %     opOptionalAfterRequiredAsync - An asynchronous opOptionalAfterRequired.
    %     opOptionalException
    %     opOptionalExceptionAsync - An asynchronous opOptionalException.
    %     opRequiredAfterOptional
    %     opRequiredAfterOptionalAsync - An asynchronous opRequiredAfterOptional.
    %     opRequiredException
    ...
    methods
        ...
        function [p4, p5, p6] = opRequiredAfterOptional(obj, p1, p2, p3, context)
            %OPREQUIREDAFTEROPTIONAL
            %
            %   Input Arguments
            %     p1
            ...
            os_.writeInt(p1);
            os_.writeInt(p3);
            os_.writeIntOpt(1, p2);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opRequiredAfterOptional', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            p4 = is_.readInt();
            p6 = is_.readInt();
            p5 = is_.readIntOpt(2);
        ...
        function future = opRequiredAfterOptionalAsync(obj, p1, p2, p3, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opRequiredAfterOptional, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opRequiredAfterOptional', 0, true, os_, 3, @unmarshal, {}, context);
        end

        function [p4, p5, p6] = opOptionalAfterRequired(obj, p1, p2, p3, context)
            %OPOPTIONALAFTERREQUIRED
            %
            %   Input Arguments
            %     p1
            ...
            os_.writeInt(p1);
            os_.writeIntOpt(1, p2);
            os_.writeIntOpt(2, p3);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opOptionalAfterRequired', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            p4 = is_.readInt();
            p5 = is_.readIntOpt(3);
            p6 = is_.readIntOpt(4);
        ...
        function future = opOptionalAfterRequiredAsync(obj, p1, p2, p3, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opOptionalAfterRequired, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opOptionalAfterRequired', 0, true, os_, 3, @unmarshal, {}, context);
        end
