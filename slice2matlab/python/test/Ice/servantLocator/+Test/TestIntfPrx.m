...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function pythonException(obj, varargin)
            % pythonException
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            
            obj.iceInvoke('pythonException', 0, false, [], false, {}, varargin{:});
        end
        function r_ = pythonExceptionAsync(obj, varargin)
            % pythonExceptionAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('pythonException', 0, false, [], 0, [], {}, varargin{:});
        end
