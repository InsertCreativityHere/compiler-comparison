classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     pythonException
    %     pythonExceptionAsync - An asynchronous pythonException.
    ...
    methods
        ...
        function pythonException(obj, context)
            %PYTHONEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('pythonException', 0, false, [], false, {}, context);
        end

        function future = pythonExceptionAsync(obj, context)
            %PYTHONEXCEPTIONASYNC
            %
            %   Input Arguments
            %     context - The request context.
            %       unconfigured dictionary (default) | dictionary(string, string) scalar
            ...
            %       Ice.Future scalar
            %
            %   See also pythonException, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('pythonException', 0, false, [], 0, [], {}, context);
        end
