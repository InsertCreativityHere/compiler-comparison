classdef UnexpectedObjectExceptionTestPrx < Ice.ObjectPrx
    ...
    methods
        function returnValue = op(obj, context)
            ...
            %   Output Arguments
            %     returnValue
            %       Test.AlsoEmpty scalar | empty array of Test.AlsoEmpty
            ...
            is_.readValue(@(v) returnValue_h_.set(v), 'Test.AlsoEmpty');
        ...
        function future = opAsync(obj, context)
            ...
            function varargout = unmarshal(is_)
                ...
                is_.readValue(@(v) returnValue.set(v), 'Test.AlsoEmpty');
                is_.readPendingValues();
                is_.endEncapsulation();
