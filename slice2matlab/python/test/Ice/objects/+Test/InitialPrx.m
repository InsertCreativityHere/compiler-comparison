classdef InitialPrx < Ice.ObjectPrx
    ...
    %     getInnerA
    %     getInnerAAsync - An asynchronous getInnerA.
    %     getInnerSubA
    %     getInnerSubAAsync - An asynchronous getInnerSubA.
    %     getK
    ...
    %     throwInnerEx
    %     throwInnerExAsync - An asynchronous throwInnerEx.
    %     throwInnerSubEx
    %     throwInnerSubExAsync - An asynchronous throwInnerSubEx.
    %
    ...
    methods
        ...
        function returnValue = getInnerA(obj, context)
            %GETINNERA
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('getInnerA', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue_h_ = IceInternal.ValueHolder();
            is_.readValue(@(v) returnValue_h_.set(v), 'Test.Inner.A');
            is_.readPendingValues();
            is_.endEncapsulation();
            returnValue = returnValue_h_.value;
        end

        function future = getInnerAAsync(obj, context)
            %GETINNERAASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            function varargout = unmarshal(is_)
                is_.startEncapsulation();
                returnValue = IceInternal.ValueHolder();
                is_.readValue(@(v) returnValue.set(v), 'Test.Inner.A');
                is_.readPendingValues();
                is_.endEncapsulation();
                varargout{1} = returnValue.value;
            end
            future = obj.iceInvokeAsync('getInnerA', 0, true, [], 1, @unmarshal, {}, context);
        end

        function returnValue = getInnerSubA(obj, context)
            %GETINNERSUBA
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %   Output Arguments
            %     returnValue
            %       Test.Inner.Sub.A scalar | empty array of Test.Inner.Sub.A
            
            arguments
                obj (1, 1) Test.InitialPrx
                context (1, 1) dictionary = dictionary
            end
            is_ = obj.iceInvoke('getInnerSubA', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue_h_ = IceInternal.ValueHolder();
            is_.readValue(@(v) returnValue_h_.set(v), 'Test.Inner.Sub.A');
            is_.readPendingValues();
            is_.endEncapsulation();
            returnValue = returnValue_h_.value;
        end

        function future = getInnerSubAAsync(obj, context)
            %GETINNERSUBAASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also getInnerSubA, Ice.Future.
            ...
            function varargout = unmarshal(is_)
                is_.startEncapsulation();
                returnValue = IceInternal.ValueHolder();
                is_.readValue(@(v) returnValue.set(v), 'Test.Inner.Sub.A');
                is_.readPendingValues();
                is_.endEncapsulation();
                varargout{1} = returnValue.value;
            end
            future = obj.iceInvokeAsync('getInnerSubA', 0, true, [], 1, @unmarshal, {}, context);
        end

        function throwInnerEx(obj, context)
            %THROWINNEREX
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('throwInnerEx', 0, true, [], false, Test.InitialPrx.throwInnerEx_ex_, context);
        end

        function future = throwInnerExAsync(obj, context)
            %THROWINNEREXASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also throwInnerEx, Ice.Future.
            
            arguments
                obj (1, 1) Test.InitialPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('throwInnerEx', 0, true, [], 0, [], Test.InitialPrx.throwInnerEx_ex_, context);
        end

        function throwInnerSubEx(obj, context)
            %THROWINNERSUBEX
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('throwInnerSubEx', 0, true, [], false, Test.InitialPrx.throwInnerSubEx_ex_, context);
        end

        function future = throwInnerSubExAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also throwInnerSubEx, Ice.Future.
            
            arguments
                obj (1, 1) Test.InitialPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('throwInnerSubEx', 0, true, [], 0, [], Test.InitialPrx.throwInnerSubEx_ex_, context);
        end
