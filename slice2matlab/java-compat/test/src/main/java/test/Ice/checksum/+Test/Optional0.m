% Optional0   Summary of Optional0
%
% Optional0 Properties:
%   firstName
%   secondName
%   emailAddress
...
classdef Optional0 < Ice.Value
    ...
    methods
        function obj = Optional0(firstName, secondName, emailAddress)
            if nargin == 0
                obj.firstName = '';
    ...
    methods(Access=protected)
        function iceWriteImpl(obj, os)
            os.startSlice('::Test::Optional0', -1, true);
