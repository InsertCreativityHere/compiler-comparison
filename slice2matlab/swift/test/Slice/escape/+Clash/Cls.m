classdef Cls < Ice.Value
    ...
    %     Syntax
    %       obj = Clash.Cls()
    %       obj = Clash.Cls(s, context, current, response, upCast, typeId, del, cookie, ex, result, istr, ostr, inS, proxy)
    %
    ...
    methods
        function obj = Cls(s, context, current, response, upCast, typeId, del, cookie, ex, result, istr, ostr, inS, proxy)
            if nargin > 0
