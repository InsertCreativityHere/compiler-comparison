classdef InitialPrx < Ice.ObjectPrx
    ...
    %     opCustomIntStringDictAsync - An asynchronous opCustomIntStringDict.
    %     opCustomString
    %     opCustomStringAsync - An asynchronous opCustomString.
    %     opDerivedException
    ...
    methods
        ...
        function [returnValue, p3] = opCustomString(obj, p1, context)
            %OPCUSTOMSTRING
            %
            %   Input Arguments
            %     p1
            ...
            os_.writeStringOpt(2, p1);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opCustomString', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readStringOpt(1);
            p3 = is_.readStringOpt(3);
            is_.endEncapsulation();
        ...
        function future = opCustomStringAsync(obj, p1, context)
            %OPCUSTOMSTRINGASYNC
            %
            %   Input Arguments
            %     p1
            ...
            %       Ice.Future scalar
            %
            %   See also opCustomString, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opCustomString', 0, true, os_, 2, @unmarshal, {}, context);
        end
        ...
        function [returnValue, p3] = opCustomIntStringDict(obj, p1, context)
            %OPCUSTOMINTSTRINGDICT
            %
            %   Input Arguments
            %     p1
            %       int32, string) scalar | Ice.Unset
            %     context - The request context.
            %       unconfigured dictionary (default) | dictionary(string, string) scalar
            %
            %   Output Arguments
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opCustomIntStringDict', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            returnValue = Test.IntStringDict.readOpt(is_, 1);
            p3 = Test.IntStringDict.readOpt(is_, 3);
            is_.endEncapsulation();
        end

        function future = opCustomIntStringDictAsync(obj, p1, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opCustomIntStringDict, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opCustomIntStringDict', 0, true, os_, 2, @unmarshal, {}, context);
        end
