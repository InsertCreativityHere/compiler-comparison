...
classdef MyInterfacePrx < Ice.ObjectPrx
    methods
        ...
        function [result, c2] = opMyClass(obj, c1, varargin)
            ...
            is_.readValue(@(v) result_h_.set(v), 'Inner.NoPrefix.MyClass');
        ...
        function r_ = opMyClassAsync(obj, c1, varargin)
            ...
            function varargout = unmarshal(is_)
                ...
                is_.readValue(@(v) result.set(v), 'Inner.NoPrefix.MyClass');
                is_.readPendingValues();
                is_.endEncapsulation();
    ...
    methods(Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Inner.NoPrefix.MyInterfacePrx) - A proxy for this type, or an empty array if the object does not support this type.
        ...
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Inner.NoPrefix.MyInterfacePrx) - A proxy for this type.
