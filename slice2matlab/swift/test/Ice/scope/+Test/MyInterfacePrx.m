classdef MyInterfacePrx < Ice.ObjectPrx
    ...
    %     opMyOtherStructMap
    %     opMyOtherStructMapAsync - An asynchronous opMyOtherStructMap.
    %     opMyOtherStructSeq
    %     opMyOtherStructSeqAsync - An asynchronous opMyOtherStructSeq.
    %     opMyStruct
    ...
    methods
        ...
        function [returnValue, s2] = opMyClassSeq(obj, s1, context)
            %OPMYCLASSSEQ
            %
            %   Input Arguments
            %     s1
        ...
        function future = opMyClassSeqAsync(obj, s1, context)
            ...
            function varargout = unmarshal(is_)
                ...
                varargout{2} = Test.MyClassSeq.convert(s2);
            end
        ...
        function returnValue = opMyOtherStructSeq(obj, myOtherStructSeq, context)
            %OPMYOTHERSTRUCTSEQ
            %
            %   Input Arguments
            %     myOtherStructSeq
            ...
            os_ = obj.iceStartWriteParams([]);
            Test.MyOtherStructSeq.write(os_, myOtherStructSeq);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyOtherStructSeq', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            returnValue = Test.MyOtherStructSeq.read(is_);
            is_.endEncapsulation();
        end

        function future = opMyOtherStructSeqAsync(obj, myOtherStructSeq, context)
            %OPMYOTHERSTRUCTSEQASYNC
            %
            %   Input Arguments
            %     myOtherStructSeq
            %       Test.MyOtherStruct vector
            ...
            %       Ice.Future scalar
            %
            %   See also opMyOtherStructSeq, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opMyOtherStructSeq', 0, true, os_, 1, @unmarshal, {}, context);
        end

        function returnValue = opMyOtherStructMap(obj, myOtherStructMap, context)
            %OPMYOTHERSTRUCTMAP
            %
            %   Input Arguments
            %     myOtherStructMap
            ...
            arguments
                obj (1, 1) Test.MyInterfacePrx
                myOtherStructMap (1, 1) dictionary
                context (1, 1) dictionary = dictionary
            end
            os_ = obj.iceStartWriteParams([]);
            Test.MyOtherStructMap.write(os_, myOtherStructMap);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyOtherStructMap', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            returnValue = Test.MyOtherStructMap.read(is_);
            is_.endEncapsulation();
        end

        function future = opMyOtherStructMapAsync(obj, myOtherStructMap, context)
            %OPMYOTHERSTRUCTMAPASYNC
            %
            %   Input Arguments
            %     myOtherStructMap
            %       string, Test.MyOtherStruct) scalar
            ...
            %       Ice.Future scalar
            %
            %   See also opMyOtherStructMap, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opMyOtherStructMap', 0, true, os_, 1, @unmarshal, {}, context);
        end
