classdef (Sealed) Struct3
    %STRUCT3
    %
    %   Creation
    %     Syntax
    %       obj = Test.Struct3()
    %       obj = Test.Struct3(boolFalse, boolTrue, b, s, i, l, f, d, str, c1, c2, c3, nc1, nc2, nc3, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
    %
    ...
    methods
        function obj = Struct3(boolFalse, boolTrue, b, s, i, l, f, d, str, c1, c2, c3, nc1, nc2, nc3, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
            if nargin > 0
                assert(nargin == 22, 'Invalid number of arguments');
