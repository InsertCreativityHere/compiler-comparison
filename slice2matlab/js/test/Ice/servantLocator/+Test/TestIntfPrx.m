...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function jsException(obj, varargin)
            obj.iceInvoke('jsException', 0, false, [], false, {}, varargin{:});
        end
        function r_ = jsExceptionAsync(obj, varargin)
            r_ = obj.iceInvokeAsync('jsException', 0, false, [], 0, [], {}, varargin{:});
        end
