classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     jsException
    %     jsExceptionAsync - An asynchronous jsException.
    %     localException
    ...
    methods
        ...
        function jsException(obj, context)
            %JSEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('jsException', 0, false, [], false, {}, context);
        end

        function future = jsExceptionAsync(obj, context)
            %JSEXCEPTIONASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also jsException, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('jsException', 0, false, [], 0, [], {}, context);
        end
