...
classdef IPrx < Ice.ObjectPrx
    ...
    methods(Static)
        function id = ice_staticId()
            id = '::Inner::Test::Inner2::I';
        end
        function r = ice_read(is)
            r = is.readProxy('Inner.Test.Inner2.IPrx');
        end
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Inner.Test.Inner2.IPrx) - A proxy for this type, or an empty array if the object does not support this type.
            r = Ice.ObjectPrx.iceCheckedCast(p, Inner.Test.Inner2.IPrx.ice_staticId(), 'Inner.Test.Inner2.IPrx', varargin{:});
        end
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Inner.Test.Inner2.IPrx) - A proxy for this type.
            r = Ice.ObjectPrx.iceUncheckedCast(p, 'Inner.Test.Inner2.IPrx', varargin{:});
        end
    end
    methods(Hidden=true)
