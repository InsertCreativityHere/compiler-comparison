classdef MultiOptional < Ice.Value
    ...
    %       obj = Test.MultiOptional(a, b, c, d, e, f, g, h, i, j, bs, ss, iid, sid, fs, vs, shs, es, fss, vss, mips, ied, ifsd, ivsd, imipd, bos, ser)
    %
