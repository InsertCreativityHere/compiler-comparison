classdef (Sealed) StructNoDefaults
    ...
    %       obj = Test.StructNoDefaults(bo, b, s, i, l, f, d, str, c1, bs, is, st, dict, derivedSeq, intSeqSeq)
    %
    ...
    methods
        function obj = StructNoDefaults(bo, b, s, i, l, f, d, str, c1, bs, is, st, dict, derivedSeq, intSeqSeq)
            if nargin > 0
                ...
                obj.st = st;
                obj.dict = dict;
                obj.derivedSeq = derivedSeq;
                obj.intSeqSeq = intSeqSeq;
            end
        end
        ...
        function obj = ice_convert(obj)
            obj.derivedSeq = Test.DerivedSeq.convert(obj.derivedSeq);
        end
    end
    methods (Static)
        function r = ice_read(is)
            ...
            r.derivedSeq = Test.DerivedSeq.read(is);
            r.intSeqSeq = Test.IntSeqSeq.read(is);
        end
        function ice_write(os, v)
            ...
            Test.DerivedSeq.write(os, v.derivedSeq);
            Test.IntSeqSeq.write(os, v.intSeqSeq);
        end
    end
end
