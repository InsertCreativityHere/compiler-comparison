classdef TestPrx < Ice.ObjectPrx
    ...
    %   Creation
    %     Syntax
    %       prx = System.TestPrx(communicator, proxyString)
    %
    %     Input Arguments
    ...
    %     checkedCast - Contacts the remote server to check if the target object implements Slice interface ::System::Test.
    ...
    methods (Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            %   Output Arguments
            %     r - A System.TestPrx scalar if the target object implements Slice interface 
            %       ::System::Test; otherwise, an empty array of System.TestPrx.
            %
            arguments
        ...
        function r = uncheckedCast(p, varargin)
            %UNCHECKEDCAST Creates a System.TestPrx from another proxy without any validation.
            %
            %   Input Arguments
            %     p - The source proxy.
            %       Ice.ObjectPrx scalar | empty array of Ice.ObjectPrx
            ...
            %
            %   Output Arguments
            %     r - A new System.TestPrx scalar, or an empty array when p is an empty array.
            %
            arguments
                p Ice.ObjectPrx {mustBeScalarOrEmpty}
            end
