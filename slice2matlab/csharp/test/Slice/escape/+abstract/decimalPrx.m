...
classdef decimalPrx < Ice.ObjectPrx
    methods
        function default(obj, varargin)
            ...
            obj.iceInvoke('default', 0, true, [], false, abstract.decimalPrx.default_ex_, varargin{:});
        end
        function r_ = defaultAsync(obj, varargin)
            ...
            r_ = obj.iceInvokeAsync('default', 0, true, [], 0, [], abstract.decimalPrx.default_ex_, varargin{:});
        end
    end
    methods(Static)
