...
classdef MyClassPrx < Ice.ObjectPrx
    methods
        ...
        function [result, o] = opSerialSmallCSharp(obj, i, varargin)
            % opSerialSmallCSharp
            %
            % Parameters:
            %   i (Test.SerialSmall)
            ...
            os_.writeByteSeq(i);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opSerialSmallCSharp', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            o = is_.readByteSeq();
            result = is_.readByteSeq();
            is_.endEncapsulation();
        end
        function r_ = opSerialSmallCSharpAsync(obj, i, varargin)
            % opSerialSmallCSharpAsync
            %
            % Parameters:
            %   i (Test.SerialSmall)
            ...
            r_ = obj.iceInvokeAsync('opSerialSmallCSharp', 0, true, os_, 2, @unmarshal, {}, varargin{:});
        end
        function [result, o] = opSerialLargeCSharp(obj, i, varargin)
            % opSerialLargeCSharp
            %
            % Parameters:
            %   i (Test.SerialLarge)
            ...
            os_.writeByteSeq(i);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opSerialLargeCSharp', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            o = is_.readByteSeq();
            result = is_.readByteSeq();
            is_.endEncapsulation();
        end
        function r_ = opSerialLargeCSharpAsync(obj, i, varargin)
            % opSerialLargeCSharpAsync
            %
            % Parameters:
            %   i (Test.SerialLarge)
            ...
            r_ = obj.iceInvokeAsync('opSerialLargeCSharp', 0, true, os_, 2, @unmarshal, {}, varargin{:});
        end
        function [result, o] = opSerialStructCSharp(obj, i, varargin)
            % opSerialStructCSharp
            %
            % Parameters:
            %   i (Test.SerialStruct)
            ...
            os_.writeByteSeq(i);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opSerialStructCSharp', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            o = is_.readByteSeq();
            result = is_.readByteSeq();
            is_.endEncapsulation();
        end
        function r_ = opSerialStructCSharpAsync(obj, i, varargin)
            % opSerialStructCSharpAsync
            %
            % Parameters:
            %   i (Test.SerialStruct)
            ...
            r_ = obj.iceInvokeAsync('opSerialStructCSharp', 0, true, os_, 2, @unmarshal, {}, varargin{:});
        end
    end
    methods(Static)
