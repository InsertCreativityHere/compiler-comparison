classdef (Sealed) Struct3
    ...
    %     Syntax
    %       obj = Test.Struct3()
    %       obj = Test.Struct3(boolFalse, boolTrue, b, s, i, l, f, d, c1, c2, c3, nc1, nc2, nc3, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
    %
    ...
    methods
        function obj = Struct3(boolFalse, boolTrue, b, s, i, l, f, d, c1, c2, c3, nc1, nc2, nc3, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
            if nargin > 0
