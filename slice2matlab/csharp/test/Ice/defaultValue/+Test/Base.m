classdef Base < Ice.Value
    ...
    %     Syntax
    %       obj = Test.Base()
    %       obj = Test.Base(boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD, st1)
    %
    ...
    properties
        ...
        % ST1
        %   Test.Struct1 scalar
        st1 Test.Struct1 {mustBeScalarOrEmpty} = Test.Struct1.empty
    end
    methods
        function obj = Base(boolFalse, boolTrue, b, s, i, l, f, d, str, noDefault, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD, st1)
            if nargin > 0
    ...
    methods (Access = protected)
        function iceWriteImpl(obj, os)
            ...
            Test.Struct1.ice_write(os, obj.st1);
            os.endSlice();
        end
        function iceReadImpl(obj, is)
            ...
            obj.st1 = Test.Struct1.ice_read(is);
            is.endSlice();
        end
    end
    methods (Static)
