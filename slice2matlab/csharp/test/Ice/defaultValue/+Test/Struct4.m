classdef (Sealed) Struct4
    ...
    %     Syntax
    %       obj = Test.Struct4()
    %       obj = Test.Struct4(boolFalse, boolTrue, b, s, i, l, f, d, c1, c2, c3, nc1, nc2, nc3, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
    %
    ...
    methods
        function obj = Struct4(boolFalse, boolTrue, b, s, i, l, f, d, c1, c2, c3, nc1, nc2, nc3, zeroI, zeroL, zeroF, zeroDotF, zeroD, zeroDotD)
            if nargin > 0
