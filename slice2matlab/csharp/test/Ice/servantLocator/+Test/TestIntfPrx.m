...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function result = impossibleException(obj, shouldThrow, varargin)
        ...
        function r_ = impossibleExceptionAsync(obj, shouldThrow, varargin)
            os_ = obj.iceStartWriteParams([]);
            os_.writeBool(shouldThrow);
            obj.iceEndWriteParams(os_);
        ...
        function result = intfUserException(obj, shouldThrow, varargin)
            os_ = obj.iceStartWriteParams([]);
            os_.writeBool(shouldThrow);
            obj.iceEndWriteParams(os_);
        ...
        function r_ = intfUserExceptionAsync(obj, shouldThrow, varargin)
            os_ = obj.iceStartWriteParams([]);
            os_.writeBool(shouldThrow);
            obj.iceEndWriteParams(os_);
            function varargout = unmarshal(is_)
