classdef ThrowerPrx < Ice.ObjectPrx
    ...
    %     throwModA
    %     throwModAAsync - An asynchronous throwModA.
    ...
    methods
        ...
        function throwModA(obj, a, a2, context)
            %THROWMODA
            %
            %   Input Arguments
            %     a
            ...
            os_.writeInt(a2);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('throwModA', 0, true, os_, false, Test.ThrowerPrx.throwModA_ex_, context);
        end

        function future = throwModAAsync(obj, a, a2, context)
            %THROWMODAASYNC
            %
            %   Input Arguments
            %     a
            ...
            os_.writeInt(a2);
            obj.iceEndWriteParams(os_);
            future = obj.iceInvokeAsync('throwModA', 0, true, os_, 0, [], Test.ThrowerPrx.throwModA_ex_, context);
        end
