...
classdef BaseInterface5Prx < Ice.ObjectPrx
    methods
        ...
        function s = baseOp2(obj, i, varargin)
            ...
            is_ = obj.iceInvoke('baseOp2', 0, true, os_, true, Test.BaseInterface5Prx.baseOp2_ex_, varargin{:});
        ...
        function r_ = baseOp2Async(obj, i, varargin)
            ...
            r_ = obj.iceInvokeAsync('baseOp2', 0, true, os_, 1, @unmarshal, Test.BaseInterface5Prx.baseOp2_ex_, varargin{:});
        end
    end
    methods(Static)
