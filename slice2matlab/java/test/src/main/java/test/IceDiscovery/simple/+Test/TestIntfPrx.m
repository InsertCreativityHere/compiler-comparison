...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        function result = getAdapterId(obj, varargin)
            % getAdapterId
            %
            % Parameters:
            ...
            is_ = obj.iceInvoke('getAdapterId', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = is_.readString();
            is_.endEncapsulation();
        end
        function r_ = getAdapterIdAsync(obj, varargin)
            % getAdapterIdAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('getAdapterId', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
    end
    methods(Static)
