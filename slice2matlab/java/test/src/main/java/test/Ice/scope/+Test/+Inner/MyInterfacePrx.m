...
classdef MyInterfacePrx < Ice.ObjectPrx
    ...
    methods(Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Test.Inner.MyInterfacePrx) - A proxy for this type, or an empty array if the object does not support this type.
        ...
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Test.Inner.MyInterfacePrx) - A proxy for this type.
