classdef (Sealed) LargeStruct
    %LARGESTRUCT
    %
    %   Creation
    %     Syntax
    %       obj = Test.LargeStruct()
    %       obj = Test.LargeStruct(bo, by, sh, i, l, f, d, str, e, p, ss)
    %
    ...
    properties
        ...
        p Test.MyInterfacePrx {mustBeScalarOrEmpty} = Test.MyInterfacePrx.empty
