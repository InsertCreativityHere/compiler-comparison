...
classdef InitialPrx < Ice.ObjectPrx
    methods
        ...
        function throwTest1Notify(obj, varargin)
            % throwTest1Notify
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            
            obj.iceInvoke('throwTest1Notify', 0, true, [], false, Test.InitialPrx.throwTest1Notify_ex_, varargin{:});
        end
        function r_ = throwTest1NotifyAsync(obj, varargin)
            % throwTest1NotifyAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('throwTest1Notify', 0, true, [], 0, [], Test.InitialPrx.throwTest1Notify_ex_, varargin{:});
        end
