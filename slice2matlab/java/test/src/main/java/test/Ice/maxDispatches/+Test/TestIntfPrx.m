classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     resetMaxConcurrentDispatchesAsync - An asynchronous resetMaxConcurrentDispatches.
    %     shutdown
    ...
    methods
        ...
        function returnValue = resetMaxConcurrentDispatches(obj, context)
            %RESETMAXCONCURRENTDISPATCHES
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('resetMaxConcurrentDispatches', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readInt();
            is_.endEncapsulation();
        end

        function future = resetMaxConcurrentDispatchesAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also resetMaxConcurrentDispatches, Ice.Future.
            ...
            future = obj.iceInvokeAsync('resetMaxConcurrentDispatches', 0, true, [], 1, @unmarshal, {}, context);
        end
