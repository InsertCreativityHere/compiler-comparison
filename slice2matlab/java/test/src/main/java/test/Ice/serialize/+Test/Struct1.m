classdef (Sealed) Struct1
    %STRUCT1
    %
    %   Creation
    %     Syntax
    %       obj = Test.Struct1()
    %       obj = Test.Struct1(bo, by, sh, i, l, f, d, str, e, p)
    %
    ...
    properties
        ...
        % P
        %   Test.InitialPrx scalar | empty array of Test.InitialPrx
        p Test.InitialPrx {mustBeScalarOrEmpty} = Test.InitialPrx.empty
    end
    methods
