classdef MyClass < Ice.Value
    ...
    %     Syntax
    %       obj = Test.MyClass()
    %       obj = Test.MyClass(c, prx, o, s, seq1, seq2, seq3, seq4, seq5, seq6, seq7, seq8, seq9, seq10, d)
    %
    ...
    properties
        ...
        % PRX
        %   Test.MyInterfacePrx scalar | empty array of Test.MyInterfacePrx
        prx Test.MyInterfacePrx {mustBeScalarOrEmpty} = Test.MyInterfacePrx.empty
    ...
    methods
        function obj = MyClass(c, prx, o, s, seq1, seq2, seq3, seq4, seq5, seq6, seq7, seq8, seq9, seq10, d)
            if nargin > 0
    ...
    methods (Access = protected)
        ...
        function iceReadImpl(obj, is)
            ...
            obj.prx = Test.MyInterfacePrx.ice_read(is);
