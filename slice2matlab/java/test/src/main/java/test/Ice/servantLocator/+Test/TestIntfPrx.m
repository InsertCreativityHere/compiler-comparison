classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     javaException
    %     javaExceptionAsync - An asynchronous javaException.
    %     localException
    ...
    methods
        ...
        function javaException(obj, context)
            %JAVAEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('javaException', 0, false, [], false, {}, context);
        end

        function future = javaExceptionAsync(obj, context)
            %JAVAEXCEPTIONASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also javaException, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('javaException', 0, false, [], 0, [], {}, context);
        end
