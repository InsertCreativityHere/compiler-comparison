...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function javaException(obj, varargin)
            % javaException
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            
            obj.iceInvoke('javaException', 0, false, [], false, {}, varargin{:});
        end
        function r_ = javaExceptionAsync(obj, varargin)
            % javaExceptionAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('javaException', 0, false, [], 0, [], {}, varargin{:});
        end
