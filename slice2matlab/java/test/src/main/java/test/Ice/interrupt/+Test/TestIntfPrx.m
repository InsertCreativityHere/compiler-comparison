classdef TestIntfPrx < Ice.ObjectPrx
    ...
    methods
        ...
        function sleep(obj, to, context)
            ...
            obj.iceInvoke('sleep', 0, true, os_, false, Test.TestIntfPrx.sleep_ex_, context);
        end
        ...
        function future = sleepAsync(obj, to, context)
            ...
            os_.writeInt(to);
            obj.iceEndWriteParams(os_);
            future = obj.iceInvokeAsync('sleep', 0, true, os_, 0, [], Test.TestIntfPrx.sleep_ex_, context);
        end
