classdef MyDerivedClassPrx < Test.MyClassPrx
    ...
    methods
        ...
        function returnValue = opMyStruct1(obj, s, context)
            %OPMYSTRUCT1
            %
            %   Input Arguments
            %     s
        ...
        function future = opMyStruct1Async(obj, s, context)
            %OPMYSTRUCT1ASYNC
            %
            %   Input Arguments
            %     s
        ...
        function returnValue = opMyClass1(obj, c, context)
            %OPMYCLASS1
            %
            %   Input Arguments
            %     c
            ...
            arguments
                obj (1, 1) Test.MyDerivedClassPrx
                c Test.MyClass1 {mustBeScalarOrEmpty}
                context (1, 1) dictionary = dictionary
            end
            os_ = obj.iceStartWriteParams([]);
            os_.writeValue(c);
        ...
        function future = opMyClass1Async(obj, c, context)
            %OPMYCLASS1ASYNC
            %
            %   Input Arguments
            %     c
