classdef InitialPrx < Ice.ObjectPrx
    ...
    %     opSerializable
    %     opSerializableAsync - An asynchronous opSerializable.
    %     opShort
    ...
    methods
        ...
        function [returnValue, p3] = opSerializable(obj, p1, context)
            %OPSERIALIZABLE
            %
            %   Input Arguments
            %     p1
            ...
            os_.writeByteSeqOpt(2, p1);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opSerializable', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readByteSeqOpt(1);
            p3 = is_.readByteSeqOpt(3);
            is_.endEncapsulation();
        ...
        function future = opSerializableAsync(obj, p1, context)
            %OPSERIALIZABLEASYNC
            %
            %   Input Arguments
            %     p1
            ...
            %       Ice.Future scalar
            %
            %   See also opSerializable, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opSerializable', 0, true, os_, 2, @unmarshal, {}, context);
        end
