...
classdef IPrx < Ice.ObjectPrx
    ...
    methods(Static)
        ...
        function r = ice_read(is)
            r = is.readProxy('Test.Inner.IPrx');
        end
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Test.Inner.IPrx) - A proxy for this type, or an empty array if the object does not support this type.
            r = Ice.ObjectPrx.iceCheckedCast(p, Test.Inner.IPrx.ice_staticId(), 'Test.Inner.IPrx', varargin{:});
        end
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Test.Inner.IPrx) - A proxy for this type.
            r = Ice.ObjectPrx.iceUncheckedCast(p, 'Test.Inner.IPrx', varargin{:});
        end
    end
    methods(Hidden=true)
