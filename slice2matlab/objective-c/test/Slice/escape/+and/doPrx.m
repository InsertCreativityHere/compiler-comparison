...
classdef doPrx < and.charPrx & and.breakPrx & and.switchPrx
    methods
    end
    methods(Static)
    ...
    methods(Hidden=true)
        function obj = doPrx(communicator, encoding, impl, bytes)
            obj = obj@and.charPrx(communicator, encoding, impl, bytes);
            obj = obj@and.breakPrx(communicator, encoding, impl, bytes);
            obj = obj@and.switchPrx(communicator, encoding, impl, bytes);
        end
    end
end
