...
% Generated from TimeoutTest.ice by slice2matlab version 3.7.10
...
classdef TimeoutPrx < Ice.ObjectPrx
    ...
    methods(Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Test.TimeoutPrx) - A proxy for this type, or an empty array if the object does not support this type.
        ...
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Test.TimeoutPrx) - A proxy for this type.
