...
% Generated from FaultToleranceTest.ice by slice2matlab version 3.7.10
...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function abort(obj, varargin)
            ...
            obj.iceInvoke('abort', 0, false, [], false, {}, varargin{:});
        end
        function r_ = abortAsync(obj, varargin)
            % abortAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('abort', 0, false, [], 0, [], {}, varargin{:});
        end
        function idempotentAbort(obj, varargin)
            % idempotentAbort
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
        ...
        function r_ = pidAsync(obj, varargin)
            % pidAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
