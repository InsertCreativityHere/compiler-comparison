...
classdef EPrx < Ice.ObjectPrx
    methods
        ...
        function r_ = callEAsync(obj, varargin)
            ...
            r_ = obj.iceInvokeAsync('callE', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
    end
    methods(Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            % Returns (Test.EPrx) - A proxy for this type, or an empty array if the object does not support this type.
        ...
        function r = uncheckedCast(p, varargin)
            ...
            %   facet - The optional name of the desired facet.
            %
            % Returns (Test.EPrx) - A proxy for this type.
            r = Ice.ObjectPrx.iceUncheckedCast(p, 'Test.EPrx', varargin{:});
        end
    end
    methods(Hidden=true)
        function obj = EPrx(communicator, encoding, impl, bytes)
