...
%   opMDict2Async
%   getNSNullStringSeq
%   getNSNullStringSeqAsync
%   getNSNullASeq
%   getNSNullASeqAsync
%   getNSNullStructSeq
%   getNSNullStructSeqAsync
%   getNSNullStringSeqSeq
%   getNSNullStringSeqSeqAsync
%   getNSNullStringStringDict
%   getNSNullStringStringDictAsync
%   putNSNullStringStringDict
%   putNSNullStringStringDictAsync
%   putNSNullShortIntDict
%   putNSNullShortIntDictAsync
%   putNSNullStringMyEnumDict
%   putNSNullStringMyEnumDictAsync
...
classdef MyClassPrx < Ice.ObjectPrx
    methods
        ...
        function [result, p3] = opMyEnumS(obj, p1, p2, varargin)
            % opMyEnumS
            %
            % Parameters:
            %   p1 (Test.MyEnumS)
            ...
            os_ = obj.iceStartWriteParams([]);
            Test.MyEnumS.write(os_, p1);
            Test.MyEnumS.write(os_, p2);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyEnumS', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            p3 = Test.MyEnumS.read(is_);
            result = Test.MyEnumS.read(is_);
            is_.endEncapsulation();
        end
        function r_ = opMyEnumSAsync(obj, p1, p2, varargin)
            % opMyEnumSAsync
            %
            % Parameters:
            %   p1 (Test.MyEnumS)
            ...
            r_ = obj.iceInvokeAsync('opMyEnumS', 0, true, os_, 2, @unmarshal, {}, varargin{:});
        end
        function [result, p3] = opMyClassS(obj, p1, p2, varargin)
            % opMyClassS
            %
            % Parameters:
            %   p1 (Test.MyClassS)
            ...
            %
            % Returns:
            %   result (Test.MyClassS)
            %   p3 (Test.MyClassS)
            
            os_ = obj.iceStartWriteParams([]);
            Test.MyClassS.write(os_, p1);
            Test.MyClassS.write(os_, p2);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyClassS', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            p3 = Test.MyClassS.read(is_);
            result = Test.MyClassS.read(is_);
            is_.endEncapsulation();
        end
        function r_ = opMyClassSAsync(obj, p1, p2, varargin)
            % opMyClassSAsync
            %
            % Parameters:
            %   p1 (Test.MyClassS)
            ...
            r_ = obj.iceInvokeAsync('opMyClassS', 0, true, os_, 2, @unmarshal, {}, varargin{:});
        end
        ...
        function result = getNSNullStringSeq(obj, varargin)
            % getNSNullStringSeq
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            is_ = obj.iceInvoke('getNSNullStringSeq', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = is_.readStringSeq();
            is_.endEncapsulation();
        end
        function r_ = getNSNullStringSeqAsync(obj, varargin)
            % getNSNullStringSeqAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('getNSNullStringSeq', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
        function result = getNSNullASeq(obj, varargin)
            % getNSNullASeq
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            is_ = obj.iceInvoke('getNSNullASeq', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = Test.AS.read(is_);
            is_.readPendingValues();
            is_.endEncapsulation();
            result = Test.AS.convert(result);
        end
        function r_ = getNSNullASeqAsync(obj, varargin)
            % getNSNullASeqAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            function varargout = unmarshal(is_)
                ...
                is_.readPendingValues();
                is_.endEncapsulation();
                varargout{1} = Test.AS.convert(result);
            end
            r_ = obj.iceInvokeAsync('getNSNullASeq', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
        function result = getNSNullStructSeq(obj, varargin)
            % getNSNullStructSeq
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            %
            % Returns (Test.StructS)
            
            is_ = obj.iceInvoke('getNSNullStructSeq', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = Test.StructS.read(is_);
            is_.endEncapsulation();
        end
        function r_ = getNSNullStructSeqAsync(obj, varargin)
            % getNSNullStructSeqAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('getNSNullStructSeq', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
        function result = getNSNullStringSeqSeq(obj, varargin)
            % getNSNullStringSeqSeq
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            %
            % Returns (Test.StringSS)
            
            is_ = obj.iceInvoke('getNSNullStringSeqSeq', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = Test.StringSS.read(is_);
            is_.endEncapsulation();
        end
        function r_ = getNSNullStringSeqSeqAsync(obj, varargin)
            % getNSNullStringSeqSeqAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('getNSNullStringSeqSeq', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
        function result = getNSNullStringStringDict(obj, varargin)
            % getNSNullStringStringDict
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            is_ = obj.iceInvoke('getNSNullStringStringDict', 0, true, [], true, {}, varargin{:});
            is_.startEncapsulation();
            result = Test.StringStringD.read(is_);
            is_.endEncapsulation();
        end
        function r_ = getNSNullStringStringDictAsync(obj, varargin)
            % getNSNullStringStringDictAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('getNSNullStringStringDict', 0, true, [], 1, @unmarshal, {}, varargin{:});
        end
        function putNSNullStringStringDict(obj, d, varargin)
            % putNSNullStringStringDict
            %
            % Parameters:
            %   d (containers.Map)
            ...
            os_ = obj.iceStartWriteParams([]);
            Test.StringStringD.write(os_, d);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('putNSNullStringStringDict', 0, false, os_, false, {}, varargin{:});
        end
        function r_ = putNSNullStringStringDictAsync(obj, d, varargin)
            % putNSNullStringStringDictAsync
            %
            % Parameters:
            %   d (containers.Map)
            ...
            Test.StringStringD.write(os_, d);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('putNSNullStringStringDict', 0, false, os_, 0, [], {}, varargin{:});
        end
        function putNSNullShortIntDict(obj, d, varargin)
            % putNSNullShortIntDict
            %
            % Parameters:
            %   d (containers.Map)
            ...
            os_ = obj.iceStartWriteParams([]);
            Test.ShortIntD.write(os_, d);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('putNSNullShortIntDict', 0, false, os_, false, {}, varargin{:});
        end
        function r_ = putNSNullShortIntDictAsync(obj, d, varargin)
            % putNSNullShortIntDictAsync
            %
            % Parameters:
            %   d (containers.Map)
            ...
            Test.ShortIntD.write(os_, d);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('putNSNullShortIntDict', 0, false, os_, 0, [], {}, varargin{:});
        end
        function putNSNullStringMyEnumDict(obj, d, varargin)
            % putNSNullStringMyEnumDict
            %
            % Parameters:
            %   d (containers.Map)
            ...
            os_ = obj.iceStartWriteParams([]);
            Test.StringMyEnumD.write(os_, d);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('putNSNullStringMyEnumDict', 0, false, os_, false, {}, varargin{:});
        end
        function r_ = putNSNullStringMyEnumDictAsync(obj, d, varargin)
            % putNSNullStringMyEnumDictAsync
            %
            % Parameters:
            %   d (containers.Map)
            ...
            Test.StringMyEnumD.write(os_, d);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('putNSNullStringMyEnumDict', 0, false, os_, 0, [], {}, varargin{:});
        end
    end
    methods(Static)
