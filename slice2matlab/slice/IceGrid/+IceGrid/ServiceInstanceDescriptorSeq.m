...
classdef (Hidden) ServiceInstanceDescriptorSeq
    %SERVICEINSTANCEDESCRIPTORSEQ Marshaling and unmarshaling support code for sequence<::IceGrid::ServiceInstanceDescriptor>.
    %
