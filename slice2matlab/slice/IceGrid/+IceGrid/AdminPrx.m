...
classdef AdminPrx < Ice.ObjectPrx
    ...
    properties(Constant,Access=private)
        ...
        getNodeLoad_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
        getNodeInfo_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
        getNodeAdmin_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
        getNodeProcessorSocketCount_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
        shutdownNode_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
        getNodeHostname_ex_ = { 'IceGrid.NodeUnreachableException', 'IceGrid.NodeNotExistException' }
