...
classdef AdminPrx < Ice.ObjectPrx
    ...
    properties(Constant,Access=private)
        ...
        syncApplication_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        updateApplication_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        syncApplicationWithoutRestart_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        updateApplicationWithoutRestart_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        removeApplication_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        instantiateServer_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ApplicationNotExistException', 'IceGrid.AccessDeniedException' }
        ...
        stopServer_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.ServerStopException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException' }
        sendSignal_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.NodeUnreachableException', 'IceGrid.BadSignalException', 'IceGrid.ServerNotExistException' }
        getAdapterInfo_ex_ = { 'IceGrid.AdapterNotExistException' }
        removeAdapter_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.AdapterNotExistException' }
