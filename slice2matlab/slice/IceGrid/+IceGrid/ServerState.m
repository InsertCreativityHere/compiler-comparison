...
classdef ServerState < uint8
    enumeration
        % Inactive   Summary of Inactive
        %
        % The server is not running.
        Inactive (0)
        
        % Activating   Summary of Activating
        %
        ...
        % ActivationTimedOut   Summary of ActivationTimedOut
        %
        % The server activation timed out.
        ActivationTimedOut (2)
        
        % Active   Summary of Active
        %
        % The server is running.
        Active (3)
        
        % Deactivating   Summary of Deactivating
        %
        % The server is being deactivated.
        Deactivating (4)
        
        % Destroying   Summary of Destroying
        %
        % The server is being destroyed.
        Destroying (5)
        
        % Destroyed   Summary of Destroyed
        %
