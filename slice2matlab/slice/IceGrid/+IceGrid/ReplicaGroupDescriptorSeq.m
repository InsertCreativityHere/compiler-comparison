...
classdef (Hidden) ReplicaGroupDescriptorSeq
    %REPLICAGROUPDESCRIPTORSEQ Marshaling and unmarshaling support code for sequence<::IceGrid::ReplicaGroupDescriptor>.
    %
