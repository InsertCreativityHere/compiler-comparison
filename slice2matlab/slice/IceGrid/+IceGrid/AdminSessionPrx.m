...
classdef AdminSessionPrx < Glacier2.SessionPrx
    ...
    properties(Constant,Access=private)
        ...
        openServerLog_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException', 'IceGrid.FileNotAvailableException' }
        openServerStdErr_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException', 'IceGrid.FileNotAvailableException' }
        openServerStdOut_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException', 'IceGrid.FileNotAvailableException' }
