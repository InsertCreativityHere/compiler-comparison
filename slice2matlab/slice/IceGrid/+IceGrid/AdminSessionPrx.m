...
classdef AdminSessionPrx < Glacier2.SessionPrx
    ...
    properties(Constant,Access=private)
        ...
        openServerLog_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.FileNotAvailableException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException' }
        openServerStdErr_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.FileNotAvailableException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException' }
        openServerStdOut_ex_ = { 'IceGrid.DeploymentException', 'IceGrid.FileNotAvailableException', 'IceGrid.NodeUnreachableException', 'IceGrid.ServerNotExistException' }
