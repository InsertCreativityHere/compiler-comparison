...
classdef QueryPrx < Ice.ObjectPrx
    methods
        function result = findObjectById(obj, id, varargin)
            ...
            %
            % Returns (Ice.ObjectPrx) - A proxy to the well-known object, or null if no such object is registered.
        ...
        function result = findObjectByType(obj, type, varargin)
            ...
            %   context (containers.Map) - Optional request context.
            %
            % Returns (Ice.ObjectPrx) - A proxy to a well-known object with the specified type, or null if no such object is registered.
        ...
        function result = findAllObjectsByType(obj, type, varargin)
            ...
            %   context (containers.Map) - Optional request context.
            %
            % Returns (Ice.ObjectProxySeq) - A list of proxies to the well-known objects with the specified type. Can be empty.
        ...
        function result = findAllReplicas(obj, proxy, varargin)
            ...
            %
            % Parameters:
            %   proxy (Ice.ObjectPrx) - A proxy that identifies the well-known object.
            %   context (containers.Map) - Optional request context.
            %
            % Returns (Ice.ObjectProxySeq) - A list of proxies  to the replicas of the well-known object specified by @p proxy. Can be empty.
