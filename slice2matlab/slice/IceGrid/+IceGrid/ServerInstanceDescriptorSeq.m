...
classdef (Hidden) ServerInstanceDescriptorSeq
    %SERVERINSTANCEDESCRIPTORSEQ Marshaling and unmarshaling support code for sequence<::IceGrid::ServerInstanceDescriptor>.
    %
