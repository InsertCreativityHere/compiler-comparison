...
%   foundObjectById - Provides a reply to a Lookup.findObjectById request.
%   foundObjectByIdAsync - Provides a reply to a Lookup.findObjectById request.
%   foundAdapterById - Provides a reply to a Lookup.findAdapterById request.
%   foundAdapterByIdAsync - Provides a reply to a Lookup.findAdapterById request.
...
classdef LookupReplyPrx < Ice.ObjectPrx
    methods
        ...
        function foundAdapterById(obj, id, prx, isReplicaGroup, varargin)
            ...
            %   isReplicaGroup (logical) - Indicates whether the adapter is a member of a replica group.
            %   context (containers.Map) - Optional request context.
