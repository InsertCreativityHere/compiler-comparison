...
%   type - The type of message sent to the {@link RemoteLogger}.
%   timestamp - The date and time when the {@link RemoteLogger} received this message, expressed as the number of microseconds since the Unix Epoch (00:00:00 UTC on 1 January 1970)
...
classdef LogMessage
    properties
        ...
        % timestamp - The date and time when the {@link RemoteLogger} received this message, expressed as the number of microseconds
