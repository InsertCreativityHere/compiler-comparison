...
classdef TopicManagerPrx < Ice.ObjectPrx
    methods
        function result = create(obj, name, varargin)
            ...
            %
            % Returns (IceStorm.TopicPrx) - A proxy to the new topic object. The returned proxy is never null.
            %
            % Exceptions:
        ...
        function result = retrieve(obj, name, varargin)
            ...
            %   context (containers.Map) - Optional request context.
            %
            % Returns (IceStorm.TopicPrx) - A proxy to the topic object. The returned proxy is never null.
            %
            % Exceptions:
