...
classdef NodePrx < Ice.ObjectPrx
    methods
        function initiateCreateSession(obj, publisher, varargin)
            ...
            obj.iceInvoke('initiateCreateSession', 0, true, os_, false, DataStormContract.NodePrx.initiateCreateSession_ex_, varargin{:});
        end
        function r_ = initiateCreateSessionAsync(obj, publisher, varargin)
            ...
            os_.writeProxy(publisher);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('initiateCreateSession', 0, true, os_, 0, [], DataStormContract.NodePrx.initiateCreateSession_ex_, varargin{:});
        end
        function createSession(obj, subscriber, session, fromRelay, varargin)
            ...
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('createSession', 0, true, os_, false, DataStormContract.NodePrx.createSession_ex_, varargin{:});
        end
        function r_ = createSessionAsync(obj, subscriber, session, fromRelay, varargin)
            ...
            os_.writeBool(fromRelay);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('createSession', 0, true, os_, 0, [], DataStormContract.NodePrx.createSession_ex_, varargin{:});
        end
        function confirmCreateSession(obj, publisher, session, varargin)
            ...
            os_.writeProxy(session);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('confirmCreateSession', 0, true, os_, false, DataStormContract.NodePrx.confirmCreateSession_ex_, varargin{:});
        end
        function r_ = confirmCreateSessionAsync(obj, publisher, session, varargin)
            ...
            os_.writeProxy(session);
            obj.iceEndWriteParams(os_);
            r_ = obj.iceInvokeAsync('confirmCreateSession', 0, true, os_, 0, [], DataStormContract.NodePrx.confirmCreateSession_ex_, varargin{:});
        end
    end
    methods(Static)
