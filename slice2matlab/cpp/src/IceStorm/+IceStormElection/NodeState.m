...
classdef NodeState < uint8
    enumeration
        % NodeStateInactive   Summary of NodeStateInactive
        %
        % The node is inactive and awaiting an election.
        NodeStateInactive (0)
        
        % NodeStateElection   Summary of NodeStateElection
        %
        % The node is electing a leader.
        NodeStateElection (1)
        
        % NodeStateReorganization   Summary of NodeStateReorganization
        %
        % The replica group is reorganizing.
        NodeStateReorganization (2)
        
        % NodeStateNormal   Summary of NodeStateNormal
        %
