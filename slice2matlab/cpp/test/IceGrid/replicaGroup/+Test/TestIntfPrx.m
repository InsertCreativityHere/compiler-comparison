classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %   TestIntfPrx Methods:
    %     getReplicaId
    %     getReplicaIdAsync - An asynchronous getReplicaId.
    %     getReplicaIdAndShutdown
    %     getReplicaIdAndShutdownAsync - An asynchronous getReplicaIdAndShutdown.
    %
    ...
    methods
        function returnValue = getReplicaId(obj, context)
            %GETREPLICAID
            %
            %   Input Arguments
            ...
            is_ = obj.iceInvoke('getReplicaId', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readString();
            is_.endEncapsulation();
        end

        function future = getReplicaIdAsync(obj, context)
            %GETREPLICAIDASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also getReplicaId, Ice.Future.
            ...
            future = obj.iceInvokeAsync('getReplicaId', 0, true, [], 1, @unmarshal, {}, context);
        end

        function returnValue = getReplicaIdAndShutdown(obj, context)
            %GETREPLICAIDANDSHUTDOWN
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('getReplicaIdAndShutdown', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readString();
            is_.endEncapsulation();
        end

        function future = getReplicaIdAndShutdownAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also getReplicaIdAndShutdown, Ice.Future.
            ...
            future = obj.iceInvokeAsync('getReplicaIdAndShutdown', 0, true, [], 1, @unmarshal, {}, context);
        end
    end
