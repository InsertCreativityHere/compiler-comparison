...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        function result = getServerFile(obj, path, varargin)
            % getServerFile
            %
            % Parameters:
            %   path (char)
            ...
            is_ = obj.iceInvoke('getServerFile', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            result = is_.readString();
            is_.endEncapsulation();
        end
        function r_ = getServerFileAsync(obj, path, varargin)
            % getServerFileAsync
            %
            % Parameters:
            %   path (char)
            ...
            r_ = obj.iceInvokeAsync('getServerFile', 0, true, os_, 1, @unmarshal, {}, varargin{:});
        end
        function result = getApplicationFile(obj, path, varargin)
            % getApplicationFile
            %
            % Parameters:
            %   path (char)
            ...
            os_.writeString(path);
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('getApplicationFile', 0, true, os_, true, {}, varargin{:});
            is_.startEncapsulation();
            result = is_.readString();
            is_.endEncapsulation();
        end
        function r_ = getApplicationFileAsync(obj, path, varargin)
            % getApplicationFileAsync
            %
            % Parameters:
            %   path (char)
            ...
            r_ = obj.iceInvokeAsync('getApplicationFile', 0, true, os_, 1, @unmarshal, {}, varargin{:});
        end
    end
    methods(Static)
