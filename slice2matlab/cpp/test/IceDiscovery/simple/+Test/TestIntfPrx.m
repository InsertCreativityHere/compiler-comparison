classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %   TestIntfPrx Methods:
    %     getAdapterId
    %     getAdapterIdAsync - An asynchronous getAdapterId.
    %
    ...
    methods
        function returnValue = getAdapterId(obj, context)
            %GETADAPTERID
            %
            %   Input Arguments
            ...
            is_ = obj.iceInvoke('getAdapterId', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readString();
            is_.endEncapsulation();
        end

        function future = getAdapterIdAsync(obj, context)
            %GETADAPTERIDASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also getAdapterId, Ice.Future.
            ...
            future = obj.iceInvokeAsync('getAdapterId', 0, true, [], 1, @unmarshal, {}, context);
        end
    end
