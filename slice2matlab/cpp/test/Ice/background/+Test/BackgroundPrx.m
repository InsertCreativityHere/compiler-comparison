classdef BackgroundPrx < Ice.ObjectPrx
    ...
    %   Creation
    %     Syntax
    %       prx = Test.BackgroundPrx(communicator, proxyString)
    %
    %     Input Arguments
    ...
    %
    %   BackgroundPrx Static Methods:
    %     checkedCast - Contacts the remote server to check if the target object implements Slice interface ::Test::Background.
    %     uncheckedCast - Creates a BackgroundPrx from another proxy without any validation.
    %
    ...
    methods (Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            %   Output Arguments
            %     r - A Test.BackgroundPrx scalar if the target object implements Slice interface 
            %       ::Test::Background; otherwise, an empty array of Test.BackgroundPrx.
            %
            arguments
        ...
        function r = uncheckedCast(p, varargin)
            %UNCHECKEDCAST Creates a Test.BackgroundPrx from another proxy without any validation.
            %
            %   Input Arguments
            %     p - The source proxy.
            %       Ice.ObjectPrx scalar | empty array of Ice.ObjectPrx
            ...
            %
            %   Output Arguments
            %     r - A new Test.BackgroundPrx scalar, or an empty array when p is an empty array.
            %
            arguments
                p Ice.ObjectPrx {mustBeScalarOrEmpty}
            end
