classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     transient
    %     transientAsync - An asynchronous transient.
    %
    ...
    methods
        function transient(obj, context)
            %TRANSIENT
            %
            %   Input Arguments
            ...
            obj.iceInvoke('transient', 0, false, [], false, {}, context);
        end

        function future = transientAsync(obj, context)
            %TRANSIENTASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also transient, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('transient', 0, false, [], 0, [], {}, context);
        end
