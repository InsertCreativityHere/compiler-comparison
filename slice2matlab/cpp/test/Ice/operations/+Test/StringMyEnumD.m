...
classdef (Hidden) StringMyEnumD
    %STRINGMYENUMD Marshaling and unmarshaling support code for dictionary<string, ::Test::MyEnum>.
    %
    ...
    methods (Static)
        ...
        function r = read(is)
            sz = is.readSize();
            r = configureDictionary('char', 'Test.MyEnum');
            for i = 1:sz
                k = is.readString();
