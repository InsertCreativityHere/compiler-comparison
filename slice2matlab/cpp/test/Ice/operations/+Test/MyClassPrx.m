classdef MyClassPrx < Ice.ObjectPrx
    ...
    %     opByteSOneway
    %     opByteSOnewayAsync - An asynchronous opByteSOneway.
    %     opByteSOnewayCallCount
    %     opByteSOnewayCallCountAsync - An asynchronous opByteSOnewayCallCount.
    %     opByteSS
    ...
    %     opDoubleMarshaling
    %     opDoubleMarshalingAsync - An asynchronous opDoubleMarshaling.
    %     opFloat1
    ...
    %     opMStruct1 - Tests the marshaled-result metadata with a simple return value.
    %     opMStruct1Async - An asynchronous opMStruct1.
    %     opMStruct2 - Tests the marshaled-result metadata.
    ...
    %     opMyStructMyEnumD
    %     opMyStructMyEnumDAsync - An asynchronous opMyStructMyEnumD.
    %     opMyStructMyEnumDS
    %     opMyStructMyEnumDSAsync - An asynchronous opMyStructMyEnumDS.
    %     opShort1
    ...
    %     opStringSSS
    %     opStringSSSAsync - An asynchronous opStringSSS.
    %     opStringStringD
    ...
    %     opWStringLiterals
    %     opWStringLiteralsAsync - An asynchronous opWStringLiterals.
    %     shutdown
    ...
    methods
        ...
        function [returnValue, p3] = opStringSSS(obj, p1, p2, context)
            %OPSTRINGSSS
            %
            %   Input Arguments
            %     p1
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opStringSSS', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            p3 = Test.StringSSS.read(is_);
            returnValue = Test.StringSSS.read(is_);
            is_.endEncapsulation();
        end

        function future = opStringSSSAsync(obj, p1, p2, context)
            %OPSTRINGSSSASYNC
            %
            %   Input Arguments
            %     p1
            ...
            %       Ice.Future scalar
            %
            %   See also opStringSSS, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opStringSSS', 0, true, os_, 2, @unmarshal, {}, context);
        end
        ...
        function [returnValue, p3] = opMyStructMyEnumD(obj, p1, p2, context)
            %OPMYSTRUCTMYENUMD
            %
            %   Input Arguments
            %     p1
            %       Test.MyStruct, Test.MyEnum) scalar
            %     p2
            %       Test.MyStruct, Test.MyEnum) scalar
            %     context - The request context.
            %       unconfigured dictionary (default) | dictionary(string, string) scalar
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyStructMyEnumD', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            p3 = Test.MyStructMyEnumD.read(is_);
            returnValue = Test.MyStructMyEnumD.read(is_);
            is_.endEncapsulation();
        end

        function future = opMyStructMyEnumDAsync(obj, p1, p2, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opMyStructMyEnumD, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opMyStructMyEnumD', 0, true, os_, 2, @unmarshal, {}, context);
        end
        ...
        function [returnValue, p3] = opMyStructMyEnumDS(obj, p1, p2, context)
            %OPMYSTRUCTMYENUMDS
            %
            %   Input Arguments
            %     p1
            ...
            obj.iceEndWriteParams(os_);
            is_ = obj.iceInvoke('opMyStructMyEnumDS', 0, true, os_, true, {}, context);
            is_.startEncapsulation();
            p3 = Test.MyStructMyEnumDS.read(is_);
            returnValue = Test.MyStructMyEnumDS.read(is_);
            is_.endEncapsulation();
        end

        function future = opMyStructMyEnumDSAsync(obj, p1, p2, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opMyStructMyEnumDS, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opMyStructMyEnumDS', 0, true, os_, 2, @unmarshal, {}, context);
        end
        ...
        function opByteSOneway(obj, s, context)
            %OPBYTESONEWAY
            %
            %   Input Arguments
            %     s
            ...
            os_.writeByteSeq(s);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('opByteSOneway', 0, false, os_, false, {}, context);
        end

        function future = opByteSOnewayAsync(obj, s, context)
            %OPBYTESONEWAYASYNC
            %
            %   Input Arguments
            %     s
            ...
            %       Ice.Future scalar
            %
            %   See also opByteSOneway, Ice.Future.
            ...
            os_.writeByteSeq(s);
            obj.iceEndWriteParams(os_);
            future = obj.iceInvokeAsync('opByteSOneway', 0, false, os_, 0, [], {}, context);
        end

        function returnValue = opByteSOnewayCallCount(obj, context)
            %OPBYTESONEWAYCALLCOUNT
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('opByteSOnewayCallCount', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readInt();
            is_.endEncapsulation();
        end

        function future = opByteSOnewayCallCountAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opByteSOnewayCallCount, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opByteSOnewayCallCount', 0, true, [], 1, @unmarshal, {}, context);
        end
        ...
        function opDoubleMarshaling(obj, p1, p2, context)
            %OPDOUBLEMARSHALING
            %
            %   Input Arguments
            %     p1
            ...
            os_.writeDoubleSeq(p2);
            obj.iceEndWriteParams(os_);
            obj.iceInvoke('opDoubleMarshaling', 0, false, os_, false, {}, context);
        end

        function future = opDoubleMarshalingAsync(obj, p1, p2, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opDoubleMarshaling, Ice.Future.
            ...
            os_.writeDoubleSeq(p2);
            obj.iceEndWriteParams(os_);
            future = obj.iceInvokeAsync('opDoubleMarshaling', 0, false, os_, 0, [], {}, context);
        end
        ...
        function returnValue = opWStringLiterals(obj, context)
            %OPWSTRINGLITERALS
            %
            %   Input Arguments
            %     context - The request context.
            ...
            is_ = obj.iceInvoke('opWStringLiterals', 0, true, [], true, {}, context);
            is_.startEncapsulation();
            returnValue = is_.readStringSeq();
            is_.endEncapsulation();
        end

        function future = opWStringLiteralsAsync(obj, context)
            ...
            %       Ice.Future scalar
            %
            %   See also opWStringLiterals, Ice.Future.
            ...
            future = obj.iceInvokeAsync('opWStringLiterals', 0, true, [], 1, @unmarshal, {}, context);
        end
        ...
        function future = opMStruct1Async(obj, context)
            %OPMSTRUCT1ASYNC Tests the marshaled-result metadata with a simple return value.
            %
            %   Input Arguments
            %     context - The request context.
            %       unconfigured dictionary (default) | dictionary(string, string) scalar
        ...
        function [returnValue, p2] = opMStruct2(obj, p1, context)
            ...
            %
            %   Output Arguments
            %     returnValue - Another struct.
            %       Test.Structure scalar
            %     p2 - The output struct.
            %       Test.Structure scalar
        ...
        function future = opMStruct2Async(obj, p1, context)
            %OPMSTRUCT2ASYNC Tests the marshaled-result metadata.
            %
            %   Input Arguments
            %     p1 - The input struct.
            %       Test.Structure scalar
