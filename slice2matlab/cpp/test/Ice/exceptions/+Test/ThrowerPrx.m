classdef ThrowerPrx < Ice.ObjectPrx
    ...
    %     throwE
    %     throwEAsync - An asynchronous throwE.
    %     throwLocalException
    ...
    methods
        ...
        function throwE(obj, context)
            ...
            obj.iceInvoke('throwE', 0, true, [], false, Test.ThrowerPrx.throwE_ex_, context);
        end

        function future = throwEAsync(obj, context)
            %THROWEASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also throwE, Ice.Future.
            
            arguments
                obj (1, 1) Test.ThrowerPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('throwE', 0, true, [], 0, [], Test.ThrowerPrx.throwE_ex_, context);
        end
    end
