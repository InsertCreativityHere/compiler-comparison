classdef MyInterfacePrx < Ice.ObjectPrx
    ...
    %   Creation
    %     Syntax
    %       prx = Test.Inner.Inner2.MyInterfacePrx(communicator, proxyString)
    %
    %     Input Arguments
    ...
    %     checkedCast - Contacts the remote server to check if the target object implements Slice interface ::Test::Inner::Inner2::MyInterface.
    ...
    methods
        function [returnValue, s2] = opMyStruct(obj, s1, context)
            ...
            arguments
                obj (1, 1) Test.Inner.Inner2.MyInterfacePrx
    ...
    methods (Static)
        ...
        function r = checkedCast(p, varargin)
            ...
            %
            %   Output Arguments
            %     r - A Test.Inner.Inner2.MyInterfacePrx scalar if the target object implements Slice interface 
            %       ::Test::Inner::Inner2::MyInterface; otherwise, an empty array of Test.Inner.Inner2.MyInterfacePrx.
            %
            arguments
        ...
        function r = uncheckedCast(p, varargin)
            %UNCHECKEDCAST Creates a Test.Inner.Inner2.MyInterfacePrx from another proxy without any validation.
            %
            %   Input Arguments
            %     p - The source proxy.
            %       Ice.ObjectPrx scalar | empty array of Ice.ObjectPrx
            ...
            %
            %   Output Arguments
            %     r - A new Test.Inner.Inner2.MyInterfacePrx scalar, or an empty array when p is an empty array.
            %
            arguments
                p Ice.ObjectPrx {mustBeScalarOrEmpty}
            end
