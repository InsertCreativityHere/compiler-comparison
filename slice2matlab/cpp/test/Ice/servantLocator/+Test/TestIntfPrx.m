classdef TestIntfPrx < Ice.ObjectPrx
    ...
    %     cppException
    %     cppExceptionAsync - An asynchronous cppException.
    %     impossibleException
    ...
    %     stdException
    %     stdExceptionAsync - An asynchronous stdException.
    %     unknownException
    ...
    methods
        ...
        function stdException(obj, context)
            %STDEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('stdException', 0, false, [], false, {}, context);
        end

        function future = stdExceptionAsync(obj, context)
            %STDEXCEPTIONASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also stdException, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('stdException', 0, false, [], 0, [], {}, context);
        end

        function cppException(obj, context)
            %CPPEXCEPTION
            %
            %   Input Arguments
            %     context - The request context.
            ...
            obj.iceInvoke('cppException', 0, false, [], false, {}, context);
        end

        function future = cppExceptionAsync(obj, context)
            %CPPEXCEPTIONASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also cppException, Ice.Future.
            
            arguments
                obj (1, 1) Test.TestIntfPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('cppException', 0, false, [], 0, [], {}, context);
        end
