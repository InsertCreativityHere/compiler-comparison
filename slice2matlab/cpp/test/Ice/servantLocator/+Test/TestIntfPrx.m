...
classdef TestIntfPrx < Ice.ObjectPrx
    methods
        ...
        function stdException(obj, varargin)
            % stdException
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            
            obj.iceInvoke('stdException', 0, false, [], false, {}, varargin{:});
        end
        function r_ = stdExceptionAsync(obj, varargin)
            % stdExceptionAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('stdException', 0, false, [], 0, [], {}, varargin{:});
        end
        function cppException(obj, varargin)
            % cppException
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            
            obj.iceInvoke('cppException', 0, false, [], false, {}, varargin{:});
        end
        function r_ = cppExceptionAsync(obj, varargin)
            % cppExceptionAsync
            %
            % Parameters:
            %   context (containers.Map) - Optional request context.
            ...
            r_ = obj.iceInvokeAsync('cppException', 0, false, [], 0, [], {}, varargin{:});
        end
