classdef BackendPrx < Ice.ObjectPrx
    ...
    %   BackendPrx Methods:
    %     check
    %     checkAsync - An asynchronous check.
    %     shutdown
    ...
    methods
        function check(obj, context)
            ...
            obj.iceInvoke('check', 0, false, [], false, {}, context);
        end

        function future = checkAsync(obj, context)
            %CHECKASYNC
            %
            %   Input Arguments
            %     context - The request context.
            ...
            %       Ice.Future scalar
            %
            %   See also check, Ice.Future.
            
            arguments
                obj (1, 1) Test.BackendPrx
                context (1, 1) dictionary = dictionary
            end
            future = obj.iceInvokeAsync('check', 0, false, [], 0, [], {}, context);
        end
