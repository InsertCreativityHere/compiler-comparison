classdef (Sealed) TestToken
    %TESTTOKEN
    %
    %   Creation
    %     Syntax
    %       obj = Test.TestToken()
    %       obj = Test.TestToken(expectedResult, description, code, config, caseIndex, testReference)
    %
    ...
    properties
        ...
        % CODE
        %   Test.StateCode scalar
        code (1, 1) Test.StateCode
